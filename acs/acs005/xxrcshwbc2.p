/* xxrcshwbc2.p  - SHIPPER WORKBENCH - SUB PROGRAM - ADD ITEM                   */
...
/* $Revision: 1.115.1.5 $   BY: Dan Herman            DATE: 09/07/05 ECO: *P40X* */
...
/*zy*/      if part_qty > sod_qty_ord - sod_qty_ship then do:
/*zy*/          {pxmsg.i &MSGNUM=25070 &ERRORLEVEL=3}
/*zy*/           undo INV_DETAIL,retry INV_DETAIL.
/*zy*/           next-prompt part_qty with frame a.
/*zy*/      end.
      if not so_sched then
