...
/*zy*/ if can-find(first xxso_mstr no-lock 
/*zy*/             where xxso_domain = global_domain
/*zy*/               and xxso_nbr = input so_nbr) 
/*zy*/   and not can-find (first so_mstr no-lock 
/*zy*/                     where so_domain = global_domain
/*zy*/                       and so_nbr = input so_nbr) then do:
/*zy*/      run p-mfmsg (input 80502, input 3).
/*zy*/			undo,retry.
/*zy*/ end.
