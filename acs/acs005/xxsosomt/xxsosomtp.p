...
/*zy*//* define variable mc-error-number like msg_nbr no-undo. */
...
do on error undo, retry with frame b:
   ...
   if del-yn then do:
/*zy*/if can-find(first xxso_mstr no-lock where xxso_domain = global_domain
/*zy*/              and xxso_nbr = so_nbr) or
/*zy*/   can-find(first xxsod_det no-lock  where xxso_domain = global_domain
/*zy*/              and xxsod_nbr = so_nbr)
/*zy*/then do:
/*zy*/        {pxmsg.i &MSGNUM=624 &ERRORLEVEL=3}
/*zy*/        undo setb, retry setb.
/*zy*/end.
/*zy*/for each sod_det no-lock where sod_domain = global_domain
/*zy*/     and sod_nbr = so_nbr :
/*zy*/     if sod_qty_inv <> 0 then do:
/*zy*/             {pxmsg.i &MSGNUM=604 &ERRORLEVEL=3}
/*zy*/             undo setb, retry setb.
/*zy*/     end.   /* if sod_qty_inv <> 0 */
/*zy*/     if sod_qty_ship <> 0 then do:
/*zy*/             {pxmsg.i &MSGNUM=2862 &ERRORLEVEL=3}
/*zy*/             undo setb, retry setb.
/*zy*/     end.
/*zy*/end.
/*zy*/if can-find(first tr_hist no-lock where tr_domain = global_domain
/*zy*/             and tr_nbr = so_nbr and tr_type = "iss-so")
/*zy*/then do:
/*zy*/  {pxmsg.i &MSGNUM=80501 &ERRORLEVEL=3}
/*zy*/   undo setb, retry setb.
/*zy*/end.
/*zy*/run cpso2xx(so_nbr).
