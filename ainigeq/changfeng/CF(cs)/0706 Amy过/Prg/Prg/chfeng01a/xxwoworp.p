...
/* REVISION: eB2.std LAST MODIFIED: 03/18/06    BY: Kaine Zhang   *chfeng01a* */
...
repeat on error undo, retry:
   ...
   no-lock by wo_nbr with frame b width 133 no-attr-space:
      ...
      display
         ...
         wo_part     format "x(24)"
         wo_qty_comp
         /*chfeng01a*  wo_qty_rjct  */
         qty_open
         /*chfeng01a*  wo_ord_date column-label "Ord Date!Rel Date"  */
         /*chfeng01a*/ wo_rel_date column-label "Rel Date"
         wo_due_date
         wo_so_job
         /*chfeng01a*  wo_vend  */
         wo_status.
       ...
       * ***********************chfeng01a E Del********************** */
		...
		PUT
			wo_batch AT 1
			(pt_desc1 + pt_desc2) FORMAT "x(48)" AT 20
			.
		/* ***********************chfeng01a E Add********************** */
   ...
   /*chfeng01a*  {mfrtrail.i}  */
	
	  /*chfeng01a*/  {mfreset.i}
	  /*chfeng01a*/  {mfgrptrm.i}
