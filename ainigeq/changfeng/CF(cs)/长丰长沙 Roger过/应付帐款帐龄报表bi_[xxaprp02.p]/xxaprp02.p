...
/* $Revision: 1.42 $ BY: Bill Jiang       DATE: 03/21/07 ECO: *SS - 20070321.1* */
/* $Revision: 1.42 $ BY: Bill Jiang       DATE: 03/23/07 ECO: *SS - 20070323.1* */
/* BY: Micho Yang         DATE: 05/23/07 ECO: *SS - 20070523.1*  */
/* SS - 100701.1  By: Roger Xiao */ /*change from eb21sp3(minth) to changfeng eb2sp9 */
/*-Revision end---------------------------------------------------------------*/
...
/******************** SS - 20070523.1 - B ********************/
DEFINE VARIABLE vodate3 LIKE ap_effdate.
/******************** SS - 20070523.1 - E ********************/

/* SS - 20070321.1 - B */
DEF VAR v_curr_rct AS DECIMAL.
DEF VAR v_curr_end AS DECIMAL.
DEF VAR v_base_rct AS DECIMAL.
...
DEFINE VARIABLE vodate2 LIKE ap_effdate.
DEFINE VARIABLE i1 AS INTEGER.
DEFINE VARIABLE base_age AS DECIMAL EXTENT 10.
DEFINE TEMP-TABLE tt1
   FIELD tt1_vend LIKE ap_vend
   FIELD tt1_curr LIKE ap_curr
   ...
   field tt1_curr_rct_mth as decimal 
   field tt1_base_rct_mth as decimal 
   INDEX i1 IS UNIQUE tt1_vend tt1_curr
   .
/* SS - 20070321.1 - E */
...
repeat:
   ...
   */
   ...
   {mfrtrail.i}
   */
	PUT UNFORMATTED "#def REPORTPATH=$/csqad/xxaprp02" SKIP.
   ...
   EMPTY TEMP-TABLE tta6apvorp0402.
   {gprun.i ""a6apvorp0402.p"" "(
      INPUT vend,
      INPUT vend1,
      INPUT vdtype,
      INPUT vdtype1,
   ...
   FOR EACH tta6apvorp0402:
      IF tta6apvorp0402_ap_curr <> et_report_curr THEN DO:
         RUN curr_conv(
            INPUT et_report_curr,
            INPUT tta6apvorp0402_ap_curr,
            INPUT vodate1,
            INPUT tta6apvorp0402_et_curr_amt,
            OUTPUT tta6apvorp0402_et_base_amt
            ).
         base_age[9] = 0.
         base_age[10] = 0.
         DO i1 = 1 TO 8:
            base_age[i1] = tta6apvorp0402_et_age_amt[i1].
            base_age[9] = base_age[9] + base_age[i1].
         END.
         DO i1 = 1 TO 7:
            tta6apvorp0402_et_age_amt[i1] = round(tta6apvorp0402_et_base_amt / base_age[9] * base_age[i1],2).
            base_age[10] = base_age[10] + tta6apvorp0402_et_age_amt[i1].
         END.
         tta6apvorp0402_et_age_amt[8] = tta6apvorp0402_et_base_amt - base_age[10].
      END.
   END.

   FOR EACH tta6apvorp0402 NO-LOCK
      BREAK BY tta6apvorp0402_ap_vend
      BY tta6apvorp0402_ap_curr
      :
      ACCUMULATE tta6apvorp0402_et_base_amt (TOTAL BY tta6apvorp0402_ap_vend BY tta6apvorp0402_ap_curr).
      ACCUMULATE tta6apvorp0402_et_curr_amt (TOTAL BY tta6apvorp0402_ap_vend BY tta6apvorp0402_ap_curr).
      ACCUMULATE tta6apvorp0402_et_age_amt (TOTAL BY tta6apvorp0402_ap_vend BY tta6apvorp0402_ap_curr).
      IF LAST-OF(tta6apvorp0402_ap_curr) THEN DO:
         CREATE tt1.
         ASSIGN
            tt1_vend = tta6apvorp0402_ap_vend
            tt1_curr = tta6apvorp0402_ap_curr
            tt1_base_end = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_base_amt)
            tt1_curr_end = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_curr_amt)
            tt1_base_age[1] = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_age_amt[1])
            tt1_base_age[2] = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_age_amt[2])
            tt1_base_age[3] = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_age_amt[3])
            tt1_base_age[4] = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_age_amt[4])
            tt1_base_age[5] = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_age_amt[5])
            tt1_base_age[6] = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_age_amt[6])
            tt1_base_age[7] = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_age_amt[7]) +  (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_age_amt[8])
            .
      END.
   END.

   /* 期初 */
   vodate2 = DATE(1,1,YEAR(vodate1)) - 1.
   EMPTY TEMP-TABLE tta6apvorp0402.
   {gprun.i ""a6apvorp0402.p"" "(
      INPUT vend,
      INPUT vend1,
   ...
   FOR EACH tta6apvorp0402 NO-LOCK
      ...
      ACCUMULATE tta6apvorp0402_et_curr_amt (TOTAL BY tta6apvorp0402_ap_vend BY tta6apvorp0402_ap_curr).
      IF LAST-OF(tta6apvorp0402_ap_curr) THEN DO:
         FIND FIRST tt1 WHERE tt1_vend = tta6apvorp0402_ap_vend AND tt1_curr = tta6apvorp0402_ap_curr NO-LOCK NO-ERROR.
         ...
         END.
         ASSIGN
            tt1_base_beg = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_base_amt)
            tt1_curr_beg = (ACCUMULATE TOTAL BY tta6apvorp0402_ap_curr tta6apvorp0402_et_curr_amt)
            .
      END.
   END.
   ...
   /* 当月收款额 */
   define var v_mth_bg as date .
   v_mth_bg = date(month(vodate1),1,year(vodate1)).
   EMPTY TEMP-TABLE tta6apvniq01.
   {gprun.i ""a6apvniq01.p"" "(
      INPUT vend,
      INPUT vend1,
      INPUT v_mth_bg,
      INPUT vodate1,
   ...
   for each tta6apvniq01
      where tta6apvniq01_ap_acct >= acct
        and tta6apvniq01_ap_acct <= acct1
        and tta6apvniq01_ap_sub >= sub
        and tta6apvniq01_ap_sub <= sub1
        and tta6apvniq01_ap_cc >= cc
        and tta6apvniq01_ap_cc <= cc1 
        and ( tta6apvniq01_ap_type = "vo" and tta6apvniq01_ap_base_amt > 0) 
      break by tta6apvniq01_ap_vend by tta6apvniq01_ap_curr :                                          
      accumulate (tta6apvniq01_ap_base_amt - tta6apvniq01_amt_open) (total by tta6apvniq01_ap_vend by tta6apvniq01_ap_curr).
      if last-of(tta6apvniq01_ap_curr) then do:
             find tt1 where tt1_vend = tta6apvniq01_ap_vend and tt1_curr = tta6apvniq01_ap_curr no-lock no-error.
             if not available tt1 then do:
                create tt1.
                assign
                   tt1_vend = tta6apvniq01_ap_vend
                   tt1_curr = tta6apvniq01_ap_curr
                   .
             end.
             assign
                tt1_curr_rct_mth = (accumulate total by tta6apvniq01_ap_curr (tta6apvniq01_ap_base_amt - tta6apvniq01_amt_open))
                .
              IF tta6apvniq01_ap_curr <> et_report_curr THEN DO:
                 RUN curr_conv(
                    INPUT et_report_curr,
                    INPUT tta6apvniq01_ap_curr,
                    INPUT vodate1,
                    INPUT tt1_curr_rct_mth,
                    OUTPUT tt1_base_rct_mth
                    ).
              END.
      end.
   end.
   ...
   {gprun.i ""a6apvniq01.p"" "(
      ...
      INPUT et_report_curr
       ...
       /*
   PUT "tta6apvniq01 " skip.
   FOR EACH tta6apvniq01 :
       EXPORT DELIMITER ";" tta6apvniq01 .
   END.  */

   FOR EACH tta6apvniq01
      /* SS - 20070323.1 - B */
       /*
      WHERE tta6apvniq01_ap_type <> "CK"
      */
      WHERE tta6apvniq01_ap_acct >= acct
        AND tta6apvniq01_ap_acct <= acct1
        AND tta6apvniq01_ap_sub >= sub
        ...
        AND ( tta6apvniq01_ap_type = "vo" AND tta6apvniq01_ap_base_amt > 0) 
      /* SS - 20070323.1 - E */
      BREAK BY tta6apvniq01_ap_vend
      BY tta6apvniq01_ap_curr
      :                                          
      ACCUMULATE tta6apvniq01_ap_base_amt (TOTAL BY tta6apvniq01_ap_vend BY tta6apvniq01_ap_curr).
      IF LAST-OF(tta6apvniq01_ap_curr) THEN DO:
         FIND tt1 WHERE tt1_vend = tta6apvniq01_ap_vend AND tt1_curr = tta6apvniq01_ap_curr NO-LOCK NO-ERROR.
         IF NOT AVAILABLE tt1 THEN DO:
            CREATE tt1.
         ...
         END.
         ASSIGN
            tt1_curr_activity = (ACCUMULATE TOTAL BY tta6apvniq01_ap_curr tta6apvniq01_ap_base_amt)
            .
      END.
   END.

   /******************** SS - 20070523.1 - B ********************/
   FOR EACH tta6apvniq01 BREAK BY tta6apvniq01_ap_effdate:
       IF FIRST(tta6apvniq01_ap_effdate) THEN DO:
           /* MESSAGE STRING(tta6apvniq01_ap_effdate) VIEW-AS ALERT-BOX. */
           vodate3 = tta6apvniq01_ap_effdate .
       END.
   END.
   /******************** SS - 20070523.1 - E ********************/
   ...
   FOR EACH tt1:
      ...
      IF tt1_curr_activity <> 0 THEN DO:
         /******************** SS - 20070523.1 - B ********************/
          /*
         ASSIGN
            tt1_turnover = ROUND(((tt1_base_beg + tt1_base_end) / 2 * (vodate1 - vodate2 + 1) / tt1_curr_activity),2)
            .  */
         ASSIGN
            tt1_turnover = ROUND(((tt1_base_beg + tt1_base_end) / 2 * (vodate1 - vodate3 + 1) / tt1_curr_activity),2)
            . 
         /******************** SS - 20070523.1 - E ********************/
      END.
   END.
   ...
   v_age7 = 0.
   v_curr_activity = 0 .
   FOR EACH tt1 WHERE ( tt1_curr_beg <> 0 OR tt1_curr_end <> 0 OR 
                        tt1_base_beg <> 0 OR tt1_base_end <> 0 OR
                        tt1_base_age[1] <> 0 OR tt1_base_age[2] <> 0 OR
                        tt1_base_age[3] <> 0 OR tt1_base_age[4] <> 0 OR 
                        tt1_base_age[5] <> 0 OR tt1_base_age[6] <> 0 OR 
                        tt1_base_age[7] <> 0 )
      ,EACH vd_mstr NO-LOCK
      WHERE  vd_addr = tt1_vend
      AND vd_type >= vdtype
      AND vd_type <= vdtype1
      ...
      :
      v_curr_rct = v_curr_rct + tt1_curr_rct_mth .
      v_curr_end = v_curr_end + tt1_curr_end .
      v_base_rct = v_base_rct + tt1_base_rct_mth .
      ...
      PUT UNFORMATTED 
        ...
        tt1_base_age[7]  ";"
        v_domain_name    ";"
        string(year(vodate1)) + "/" + string(month(vodate1)) + "/" + string(day(vodate1))
        SKIP
        .               
        i = i + 1.
   END.
