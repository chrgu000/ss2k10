   ...
   with frame a
      ...
      if frame-field = "cust"
         then do for ar_mstr:
            ...
            {mfnp.i ar_mstr cust  " ar_mstr.ar_bill
      ...
      */
      ...
      for each ar_mstr
         where  (  
            ...
            ar_bill = cust
            */
            ar_mstr.ar_bill >= cust AND ar_bill <= cust1
            /* SS - 20070323.1 - E */
         ...
         then do:
            ...
            */
            ...
            then do:
               ...
               for each ard_det
                     fields( ard_nbr ard_ref ard_type)
                     where  (  ard_det.ard_ref    =
                     ar_nbr
                  ...
                  for first armstr
                     fields( ar_amt ar_applied ar_base_amt
