...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[库存标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1200 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V1300L.
        /* LOGICAL SKIP END */
                display "[库存标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V1310L.
        /* LOGICAL SKIP END */
                display "[库存标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1310 no-box.
...
and tr_site = V1002 
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[库存标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V1510L.
        /* LOGICAL SKIP END */
                display "[库存标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9020 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9030 no-box.
...
If AVAILABLE ( pt_mstr )  then
        av9030 = if pt_avg_int <> 0 and pt_avg_int <> 90 then "玂借戳:" + trim ( string ( pt_avg_int ) ) + "る" else "".
       IF INDEX(ts9030,"&D") <> 0  THEN DO:
       TS9030 = substring(TS9030, 1, Index(TS9030 , "&D") - 1) + av9030 
       + SUBSTRING( ts9030 , index(ts9030 ,"&D") + length("&D"), LENGTH(ts9030) - ( index(ts9030 ,"&D" ) + length("&D") - 1 ) ).
       END.
