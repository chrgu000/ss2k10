...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[自制标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9020 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9030 no-box.
