...
IF OkToRun = yes THEN  RUN    xsinv99.p.
   ...
   IF NOT (V1170 = "71" OR V1100 = "71" ) THEN LEAVE V1171LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1170 = "".
RUN CheckSecurity (INPUT "xsshp10.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes THEN  RUN    xsshp10.p.
        leave V1171L.
        /* LOGICAL SKIP END */
                display "#条码# *" + upper(substring(DBNAME, 4))
   ...
   IF NOT (V1170 = "72" OR V1100 = "72" ) THEN LEAVE V1172LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1170 = "".
RUN CheckSecurity (INPUT "xssorjt10.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes THEN  RUN    xssorjt10.p.
        leave V1172L.
        /* LOGICAL SKIP END */
                display "#条码# *" + upper(substring(DBNAME, 4))
   ...
   IF NOT (V1170 = "73" OR V1100 = "73" ) THEN LEAVE V1173LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1170 = "".
RUN CheckSecurity (INPUT "xsshp30.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes THEN  RUN    xsshp30.p.
        leave V1173L.
        /* LOGICAL SKIP END */
                display "#条码# *" + upper(substring(DBNAME, 4))
   ...
   IF NOT (V1170 = "74" OR V1100 = "74" ) THEN LEAVE V1174LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1170 = "".
RUN CheckSecurity (INPUT "xscars01.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes THEN  RUN    xscars01.p.
        leave V1174L.
        /* LOGICAL SKIP END */
                display "#条码# *" + upper(substring(DBNAME, 4))
