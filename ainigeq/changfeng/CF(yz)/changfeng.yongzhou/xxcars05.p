...
define variable sSeat like xcard_seat no-undo.
define variable sPart like xcard_part no-undo.
define variable sLot like xcard_lot no-undo.
...
form
    sSeat           label "Seat"
    xcard_part      label "Part"
    xcard_lot       label "Lot"
    xcard_seq       label "Ln"
    xcard_status    label "T"
with frame c down width 80 title gettermlabel("ss_zlgl_000017", 20).
...
repeat on endkey undo, leave:
    ...
    repeat on endkey undo, leave
        on error undo, retry:
        {xxrepmt05viewbc.i}
        {xxcars05updatebarcode.i}

        {xxcars05updateseat.i}
    end.
