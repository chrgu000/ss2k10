...
form
    ...
    t1_1 format "->>>>>>9.9<<" column-label "股份退"
    t1_3 format "->>>>>>9.9<<" column-label "入库"
    t1_4 format "->>>>>>9.9<<" column-label "料单入库"
    t1_2 format "->>>>>>9.9<<" column-label "销售"
    t1_5 format "->>>>>>9.9<<" column-label "企业自用"
    t1_6 format "->>>>>>9.9<<" column-label "其他"
