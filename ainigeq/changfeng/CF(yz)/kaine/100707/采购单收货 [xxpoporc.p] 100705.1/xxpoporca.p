...
/* SS - 100706.1 - B */
define variable sLotSerial as character no-undo.
/* SS - 100706.1 - E */
   ...
   repeat:
      ...
      do transaction:
         ...
         do on error undo, retry:
            ...
            /* SS - 100706.1 - B */
            {gprun.i ""xxgetporcvlotser.p"" "(input mfguser, input line, input po_vend, output sLotSerial)"}
            if sLotSerial <> "" then do:
                lotserial = sLotSerial.
