...
REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存查询-按库位]"   format "x(20)" skip with fram F1300 no-box.

                /* LABEL 1 - START */ 
                display " 料品:" + V1300 format "x(20)" skip with fram F1300 no-box.
                /* LABEL 1 - END */ 
...
If AVAILABLE ( pt_mstr ) then
                ...
                display "按E退出 或 输入? "  format "x(20)" skip
	 ...
	 V1400 = "".
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存查询-按库位]"   format "x(20)" skip with fram F1400 no-box.

                /* LABEL 1 - START */ 
                display " 库位?"    format "x(20)" skip with fram F1400 no-box.
                /* LABEL 1 - END */ 
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP END */
                ...
                /* LABEL 2 - START */ 
                  ...
                  display " 库位:  数量:" format "x(20)" skip with fram F1500 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP END */
                ...
                /* LABEL 2 - START */ 
                  ...
                  display " 库位:  数量:" format "x(20)" skip with fram F1600 no-box.
                /* LABEL 2 - END */
