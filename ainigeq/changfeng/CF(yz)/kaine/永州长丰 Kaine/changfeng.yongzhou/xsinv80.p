...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
...
If AVAILABLE (so_mstr) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1110 no-box.
...
If AVAILABLE (sod_det) and string ( sod_line ) = V1205 then
        leave V1205L.
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1205 no-box.
...
If AVAILABLE (sod_det) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If AVAILABLE (cp_mstr) then
        ...
        IF NOT AVAILABLE SOD_DET then do:
                display skip "料品不对应" @ WMESSAGE NO-LABEL with fram F1300.
                pause 0 before-hide.
                undo, retry.
        end.
         /*  ---- Valid Check ---- END */
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 no-box.
...
If AVAILABLE (cp_mstr) then
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
   ...
   pause 0 before-hide.
     ...
     REPEAT:
        ...
        leave V9109L.
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9109 no-box.
   ...
   IF NOT (V9010 = "A" ) THEN LEAVE V9110LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
...
If AVAILABLE (so_mstr) then
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V9120L.
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
...
IF 1 <> 1 THEN
        leave V9130L.
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
...
If AVAILABLE ( pt_mstr )  then
   ...
   IF NOT (V9010 = "A" AND ( decimal ( V9110 ) * decimal ( V9120 )  <> decimal ( V1600 ) ) ) THEN LEAVE V9140LMAINLOOP.
     ...
     REPEAT:
        ...
        leave V9140L.
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9140 no-box.
...
If AVAILABLE (so_mstr) then
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V9150L.
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9150 no-box.
...
IF 1 <> 1 THEN
        leave V9160L.
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9160 no-box.
...
If AVAILABLE ( pt_mstr )  then
   ...
   IF NOT (V9010 = "M" ) THEN LEAVE V9170LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9170 no-box.
...
If AVAILABLE (so_mstr) then
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9180 no-box.
...
IF 1 <> 1 THEN
        leave V9190L.
        /* LOGICAL SKIP END */
                display "[销售标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9190 no-box.
