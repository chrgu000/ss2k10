...
do transaction on endkey undo, leave:
    for each t1_tmp:
        ...
        if available(tr_hist) then do:
            ...
            sMessage = t1_lot + "发运失败,整体取消".
            undo bc-so-iss-lp, leave bc-so-iss-lp.
        end.
    end.
    sMessage = sSodNbr + "," + sSodPart + ",销售发运成功".
end.
