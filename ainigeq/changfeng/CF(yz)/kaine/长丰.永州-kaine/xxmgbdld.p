...
/******************************************************************************/
/* SS - 090902.1 By: Kaine Zhang */

/* SS - 090902.1 - RNB
[090902.1]
[36.15.1], perform slow.
[090902.1]
SS - 090902.1 - RNE */
         ...
         then do:
            do transaction:
               ...
               repeat on error undo:
                  ...
                  /* SS - 090902.1 - B */
                  do while true:
                    next_id = next-value(mf_sq04).
                    if not(can-find(first bdl_mstr no-lock where bdl_source = "" and bdl_id = next_id use-index bdl_id))
                    then leave.
                  end.
                  /* SS - 090902.1 - E */
