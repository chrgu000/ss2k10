...
/*  *      so_ship        skip (1)                                        */
/*  *N0JM*/                                                               */
/* /*N0JM*/ getTermLabel("SOLD_TO",20) + ": " +                           */
/* /*N0JM*/ so_cust at 8 format "x(30)"                                   */
/* /*N0JM*/ getTermLabel("SHIP_TO",20) + ": " +                           */
/* /*N0JM*/ so_ship at 46 format "x(30)" skip (1)                         */
/*         billto[1]      at 8                                            */
/*         shipto[1]      at 46                                           */
/*         billto[2]      at 8                                            */
/*         shipto[2]      at 46                                           */
...
/*         shipto[5]      at 46                                           */
/*         billto[6]      at 8                                            */
/*         shipto[6]      at 46 skip (2)                                  */
/****************************** SS - Micho 20060320 E *************************/

            header         skip (3)
            company[1]     AT 4 
              getTermLabelRt("BANNER_PACKING_LIST",30) to 79 format "x(30)"             
            company[2]     AT 4
            company[6] + " " + company[3] + " " + company[4] AT 4
              getTermLabelRtColon("ORDER_NUMBER",18) to 61 format "x(18)" so_nbr         at 63
              getTermLabelRtColon("PAGE",5) + STRING(page-number - pages,">>9") to 80
            getTermLabelRtColon("ORDER_DATE",18) to 61 format "x(18)" so_ord_date    at 63  
            getTermLabelRtColon("PRINT_DATE",18) to 61 format "x(18)" today          at 63 SKIP(1)
            
            getTermLabel("SOLD_TO",20) + ": " + so_cust at 8 format "x(30)"
              getTermLabel("SHIP_TO",20) + ": " + so_ship at 46 format "x(30)" 
            billto[1]  AT 8 
              shipto[1] AT 46
            billto[2]  AT 8
              shipto[2] AT 46
            billto[6] + " " + billto[3] + " " + billto[4] AT 8
              shipto[6] + " " + shipto[3] + " " + shipto[4] AT 46 SKIP(1)
            "批次号:"      AT 2
              "车型编码:"  AT 30
              "车型名称:"  AT 60 SKIP(1)
            "台量:"        AT 2
...
/*F322*/ /* Altered form for the addition of two salespersons. */
     form
        so_slspsn[1] colon 15    label {&sopka01_i_7}
