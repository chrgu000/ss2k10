...
/* $Revision: 1.11.1.14 $   BY: Micho Yang     DATE: 03/20/06 ECO: *SS - Micho 20060320* */
/******************************************************************************/
...
DEFINE            VARIABLE vd_attn     LIKE ad_attn.
DEFINE            VARIABLE vship_phone LIKE ad_phone.
DEFINE            VARIABLE vship_attn  LIKE ad_attn.
...
for each prh_hist
   ...
   form
      ...
      "货物发往: " + received_at_site at 5 format "x(20)"
      "供应商: "   + l_vend at 46  format "x(40)" 
      vendor[1]      AT 5
      shipto[1]      AT 46 
      ...
      "联系人:"      AT 5 vd_attn AT 13 FORMAT "x(8)" 
