...
define shared temp-table xxreq_det
...
*/
	 xxreqnbr = "".
	 for each xxreq_det where xxreq_sel <> "" and xxreq_vend = inpvend no-lock:
	 	xxreqnbr = xxreq_nbr.
...
/*SS 20080418 - B*/
					if inptype = "so" then do:
						find last po_mstr where po_domain = global_domain and po_nbr begins "pj" no-lock no-error.
						if not avail po_mstr then ponbr = "PJ0001".
						else ponbr = "PJ" + string(int(substring(po_nbr,3)) + 1,"9999").
					end.
/*SS 20080418 - E*/
