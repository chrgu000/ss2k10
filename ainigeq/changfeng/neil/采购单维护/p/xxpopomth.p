...
/* Revision: 1.21.1.9       BY: Poonam Bahl       DATE:03/09/00   ECO: *N059* */ /* Revision: 1.21.1.10      BY: Mark Brown        DATE:09/04/00   ECO: *N0RC* */
...
/* Revision: 1.21.1.20.1.3  BY: Priyank Khandare  DATE: 10/26/04  ECO: *P2R5* */
/* $Revision: 1.21.1.20.1.4 $ BY: Alok Gupta  DATE: 11/26/04  ECO: *P2WZ* */
...
do on error undo, retry:
   ...
   if c-application-mode <> "API"
   then do:
      display pod_pur_cost pod_disc_pct with frame c.
/*SS 20080630 - B*/
/*
      update
