...
define variable receive like mfc_logical label "Receive" initial no.
/* ss 20061024.1 - e */
{&WOWOISRC-P-TAG6}
...
title color normal (getFrameTitle("CO/BY-PRODUCTS_RECEIPT_OPTIONS",42))
width 50 attr-space.
...
/* ss 20061024.1 - b */      
      ...
      {gprun.i ""xxwoisrc01.p"" "(input Yes)"}
/* ss 20061024.1 - e */
      ...
      then
         undo, retry.
      /*V8+*/
      /*V8! if outta_here then undo, retry. */
   end. /* IF issue */
