...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
           display "#条码# *" + upper(substring(DBNAME, 4)) + "*"
   ...
   IF NOT (V1110 = "11" OR V1100 = "11" ) THEN LEAVE V1111LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1110 = "".
        RUN CheckSecurity (INPUT "xswor10.p" , INPUT global_userid 
        								  ,OUTPUT okToRun , OUTPUT Execname ).
        IF OkToRun = yes then RUN    xswor10.p.
        leave V1111L.
        /* LOGICAL SKIP END */
     END.
     PV1111 = V1111.
   ...
   IF NOT (V1110 = "12" OR V1100 = "12" ) THEN LEAVE V1112LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1110 = "".
RUN CheckSecurity (INPUT "xswor20.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes then RUN    xswor20.p.
        leave V1112L.
        /* LOGICAL SKIP END */
                display "#条码# *" + upper(substring(DBNAME, 4))
   ...
   IF NOT (V1110 = "13" OR V1100 = "13" ) THEN LEAVE V1113LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1110 = "".
RUN CheckSecurity (INPUT "xsinmov10.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes then RUN    xsinmov10.p.
        leave V1113L.
        /* LOGICAL SKIP END */
                display "#条码# *" + upper(substring(DBNAME, 4))
   ...
   END.
    ...
    REPEAT:
        ...
        RUN CheckSecurity (INPUT "xssoiss10.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
        IF OkToRun = yes then RUN    xssoiss10.p.
    ...
    REPEAT:
        ...
        RUN CheckSecurity (INPUT "xsintmp10.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
        IF OkToRun = yes then RUN    xsintmp10.p.
    ...
    REPEAT:
        ...
        RUN CheckSecurity (INPUT "xsintmp20.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
        IF OkToRun = yes then RUN    xsintmp20.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1100 = "menumenu3" ) THEN LEAVE V1130LMAINLOOP.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1130 = "menumenu31" OR V1100 = "menumenu31" ) THEN LEAVE V1131LMAINLOOP.
...
IF OkToRun = yes then RUN    xswoi10.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1130 = "menumenu32" OR V1100 = "menumenu32" ) THEN LEAVE V1132LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1130 = "".
RUN CheckSecurity (INPUT "xswri10.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes THEN RUN     xswri10.p.
        leave V1132L.
        /* LOGICAL SKIP END */
                display "#条码# *" + upper(substring(DBNAME, 4))
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1130 = "menumenu33" OR V1100 = "menumenu33" ) THEN LEAVE V1133LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1130 = "".
RUN CheckSecurity (INPUT "xswor10.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes THEN     	RUN  xswor10.p.
        leave V1133L.
        /* LOGICAL SKIP END */
                display "#条码# *" + upper(substring(DBNAME, 4))
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1130 = "menumenu34" OR V1100 = "menumenu34" ) THEN LEAVE V1134LMAINLOOP.
     /* START  LINE :1134  1.3.4 座椅入库  */
     V1134L:
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1130 = "".
RUN CheckSecurity (INPUT "xsworjt10.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes THEN  RUN    xsworjt10.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1130 = "menumenu35" OR V1100 = "menumenu35" ) THEN LEAVE V1135LMAINLOOP.
...
IF OkToRun = yes then RUN    xswor03.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1130 = "menumenu36" OR V1100 = "menumenu36" ) THEN LEAVE V1136LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xsinv98.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1100 = "menumenu4" ) THEN LEAVE V1140LMAINLOOP.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1140 = "menumenu41" OR V1100 = "menumenu41" ) THEN LEAVE V1141LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xsinv41.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1140 = "menumenu42" OR V1100 = "menumenu42" ) THEN LEAVE V1142LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xsinv42.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1140 = "menumenu43" OR V1100 = "menumenu43" ) THEN LEAVE V1143LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xsinv43.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1140 = "menumenu44" OR V1100 = "menumenu44" ) THEN LEAVE V1144LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xsinv44.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1100 = "menumenu5" ) THEN LEAVE V1150LMAINLOOP.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1150 = "menumenu51" OR V1100 = "menumenu51" ) THEN LEAVE V1151LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xslap03.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1150 = "menumenu52" OR V1100 = "menumenu52" ) THEN LEAVE V1152LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xslap04.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1150 = "menumenu53" OR V1100 = "menumenu53" ) THEN LEAVE V1153LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xslap05.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1150 = "menumenu54" OR V1100 = "menumenu54" ) THEN LEAVE V1154LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xslap08.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1150 = "menumenu55" OR V1100 = "menumenu55" ) THEN LEAVE V1155LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xswor04.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1150 = "menumenu56" OR V1100 = "menumenu56" ) THEN LEAVE V1156LMAINLOOP.
...
IF OkToRun = yes THEN  RUN    xslap07.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1150 = "menumenu57" OR V1100 = "menumenu57" ) THEN LEAVE V1157LMAINLOOP.
     /* START  LINE :1157  1.5.7 VI 自制标签入库  */
     V1157L:
     REPEAT:
...
IF OkToRun = yes THEN  RUN    xswor03.p.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1100 = "menumenu6" ) THEN LEAVE V1160LMAINLOOP.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1100 = "menumenu7" ) THEN LEAVE V1170LMAINLOOP.
   ...
   /* 110317.1 todo open this menu ... */
   IF NOT (V1100 = "menumenu8" ) THEN LEAVE V1180LMAINLOOP.
   ...
   pause 0 before-hide.
    ...
    V999LOOP:
    REPEAT:
        IF NOT (V1100 = "999" ) THEN LEAVE V999LOOP.

        hide all.
        RUN CheckSecurity (INPUT "xssysinfo.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
        IF OkToRun = yes then RUN    xssysinfo.p.
