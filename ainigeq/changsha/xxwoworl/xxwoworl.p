...
/* SS - 100623.1 - RNB
[100701.1]
309库位的库存,需计算,而不是用户填写.
[100701.1]
[100623.1]
ref #  CF客户化需求20100622.xls
qq message#
    kaine 09:58:15
    你见到李炜崟,叫他给我个电话吧.
    他要求里的车间库位/车间库存,是固定住309/用户填;还是随工单有数据的,我跟他确认下.
...
/*-110719.1-------------------------------------------------------------------
  Purpose:输入发料套数计算并列印出需求套数并列印出最小订单量
  Parameters: NONE
  Memo: NONE
------------------------------------------------------------------------------*/
...
/*17YJ*/ define new shared variable sets like wo_qty_ord.
