...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[批號庫存查詢]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[批號庫存查詢]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[批號庫存查詢]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[批號庫存查詢]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
...
If AVAILABLE ( ld_det ) then
                L15104 = "數量:" + trim(LD_LOC) + "/" + trim(string(LD_QTY_OH))  + ( if ld_ref = "" then "" else "/" + trim ( ld_ref ) ) .
                else L15104 = "" . 
