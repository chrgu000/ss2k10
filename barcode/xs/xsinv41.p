...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1320 no-box.
        ...
        /* CHECK FOR NUMBER VARIABLE START  */
        /* CHECK FOR NUMBER VARIABLE  END */
        find first LOC_MSTR where LOC_LOC = V1320 AND LOC_SITE = V1002  no-lock no-error.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
        ...
        display skip "^" @ WMESSAGE NO-LABEL with fram F1500.
            ...
            THEN DO:
                  IF recid(LD_DET) = ? THEN find first LD_DET where 
                              LD_PART = V1300 AND LD_LOC  = V1320 AND LD_QTY_OH <> 0 AND LD_SITE = V1002 AND LD_REF  = "" AND  
                              LD_LOT >=  INPUT V1500
                               no-lock no-error.
                  ELSE find next LD_DET where 
                              LD_PART = V1300 AND LD_LOC  = V1320 AND LD_QTY_OH <> 0 AND LD_SITE = V1002 AND LD_REF  = ""  
                               no-lock no-error.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 no-box.
                ...
                /* LABEL 4 - START */ 
                find first ld_det where ld_part = V1300 and ld_loc = V1320 and ld_lot = V1500
and ld_site =V1002  and ld_ref = "" and ld_qty_oh <> 0 use-index ld_part_lot no-lock no-error.
If AVAILABLE ( ld_det ) then
                L16004 = "現有庫存:" + trim(V1320) + "/" + string ( ld_qty_oh ) .
                else L16004 = "" . 
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 no-box.
                ...
                /* LABEL 3 - START */ 
                L17003 = "庫位:" + trim ( V1320 ) + "/" + trim( V1600 ) .
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.

                /* LABEL 1 - START */ 
                find last tr_hist where 
tr_date = today     and 
tr_trnbr > integer ( V9000 ) and 
tr_loc  = V1320     and  tr_type = "CYC-RCNT"  and 
...
tr_date = today     and 
tr_trnbr > integer ( V9000 ) and 
tr_loc  = V1320     and  tr_type = "CYC-RCNT"  and  tr_site = V1002      and tr_part = V1300     and tr_serial = V1500   and 
tr_time  + 15 >= TIME 
use-index tr_date_trn no-lock no-error.
If AVAILABLE ( tr_hist ) then
...
If NOT AVAILABLE ( tr_hist ) then
   ...
   IF NOT (V9010 = "Y" AND V1700 = "Y" ) THEN LEAVE V9110LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
...
If AVAILABLE ( pt_mstr ) then
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[周期盤點]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
