...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[交易查詢]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     /* START  LINE :1400  交易明細[Transaction Detail]  */
     V1400L:
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[交易查詢]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1400 no-box.
...
If AVAILABLE ( tr_hist ) then
     ...
     END.
     PV1400 = V1400.
     /* END    LINE :1400  交易明細[Transaction Detail]  */
   ...
   V1600LMAINLOOP:
   REPEAT:
     /* START  LINE :1600  交易明細[Next Transaction NBR]  */
     V1600L:
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find prev tr_hist no-lock no-error.
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[交易查詢]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 no-box.
     ...
     END.
     PV1600 = V1600.
     /* END    LINE :1600  交易明細[Next Transaction NBR]  */


   /* Additional Labels Format */
     /* START  LINE :1800  交易明細[Next]  */
     V1800L:
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[交易查詢]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1800 no-box.
