...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[標準標簽列印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[標準標簽列印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If available pt_mstr then
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[標準標簽列印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[標準標簽列印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[標準標簽列印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[標準標簽列印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9020 no-box.
   ...
   wtm_num = V9020.
   /* Additional Labels Format */
     /* START  LINE :9025  標簽格式[Label Format]  */
     V9025L:
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[標準標簽列印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9025 no-box.
     ...
     END.
     PV9025 = V9025.
     /* END    LINE :9025  標簽格式[Label Format]  */
...
If AVAILABLE ( upd_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[標準標簽列印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9030 no-box.
   ...
   /* Additional Labels Format */
     ...
     INPUT FROM VALUE(LabelsPath + "lap03" + trim ( wtm_fm ) ).
