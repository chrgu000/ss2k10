...
/* CANCEL PRINT JOBS */
/* Generate date / time  2007-2-26 16:13:47 */
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[取消打印列隊]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
...
If AVAILABLE ( prd_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[取消打印列隊]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9030 no-box.

                /* LABEL 1 - START */ 
                L90301 = "UNIX/LINUX打印機?" .
        ...
        display skip "^" @ WMESSAGE NO-LABEL with fram F9030.
            ...
            PRD_DESC @ V9030 "邏輯打印機 :" + PRD_DEV @ WMESSAGE NO-LABEL with fram F9030.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        unix value ("lprm -   " +﹛trim (V9030) ).
IF 1 = 1 THEN
        leave V9040L.
        /* LOGICAL SKIP END */
                display "[取消打印列隊]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9040 no-box.
