...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xslap08wtimeout" no-lock no-error. /*  Timeout - Program Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[自制標簽補打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制標簽補打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制標簽補打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制標簽補打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
        ...
        /* CHECK FOR NUMBER VARIABLE START  */
        /* CHECK FOR NUMBER VARIABLE  END */
        find first LD_DET where LD_PART = V1300 AND LD_SITE = V1002  no-lock no-error.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制標簽補打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制標簽補打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9020 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[自制標簽補打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9030 no-box.
   ...
   /* Additional Labels Format */
     ...
     INPUT FROM VALUE(LabelsPath + "lap08" + trim ( wtm_fm ) ).
