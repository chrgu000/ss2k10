...
/* BARCODE SYSTEM */
/* Generate date / time  2007-11-27 10:40:13 */
...
IF OkToRun = yes THEN  RUN    xsinv41.p.
   ...
   IF NOT (V1140 = "42" OR V1100 = "42" ) THEN LEAVE V1142LMAINLOOP.
     /* START  LINE :1142  1.4.2 初盘(BY LOC)  */
     V1142L:
     REPEAT:
