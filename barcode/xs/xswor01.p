...
REPEAT:
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* CHECK FOR NUMBER VARIABLE START  */
        /* CHECK FOR NUMBER VARIABLE  END */
        find first WO_MSTR where WO_NBR = V1100 AND WO_SITE = V1002 AND INDEX("AR",WO_STATUS) <> 0 AND ( substring (WO_SO_JOB,1,2) = "SA" OR substring ( WO_SO_JOB ,1,2) = "RA" )  NO-ERROR NO-WAIT.
