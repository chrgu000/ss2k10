 ...
 {mfdtitle.i "b+ "}    
      ...
      form
         skip(1)
         trdate         label "轉倉日期" colon 18
         trdate1        label {t001.i} colon 49 skip (2)

         "使用說明:"								at 2 skip
	 "1) 該報表顯示滿足以下條件資料:"					at 2 skip
	 "   A) 從HK轉移到SJ的交易, TYPE = ISS-TR AND TR_LOC = HM0001 "		at 2 skip 
	 "   B) 批號 = 採購單收貨批號    OR 轉倉單前8碼 = 收貨單號      "       at 2 skip(1)
	 "2) 該報表不更新任何MFG/PRO資料                            "           at 2 skip(1)
	 "3) 由於數據量問題，該報表的運行時間約1分鐘(1天的轉倉資料) "           at 2 skip(1)  
         "4) Sort By 生效日期 + RM單"                                           at 2 skip  


      with frame a side-labels width 80 attr-space.
      form 
         header
         "貨物檢驗單(香港轉倉)" at 59 skip(1)
	 "轉倉日期從:" trdate  "   至:  " trdate1     "    檢驗編碼: " at 80 skip(2)
