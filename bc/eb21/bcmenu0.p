...
if available code_mstr then do:
   for first mnd_det fields(mnd_nbr mnd_select)
      where mnd_nbr = code_value
        and mnd_select = 0
      no-lock :
 ...
 /*              proclabel[21] proclabel[22] proclabel[23] proclabel[24] */
         ...
         do on error undo with frame bb:
            ...
            then do:
               ...
               then do:
                  if periods = 1 then assign thismenu = getBcRootMenu(). /* "0". */
                  else
                  assign
               ...
               if mnd_nbr = "0" or mnd_nbr = getBcRootMenu() then
   ...
   repeat:
      ...
      if selection = getTermLabel("YES",1) then quit.
