...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
/*  Sam Song 20100318 End */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1305 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 no-box.
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
...
If AVAILABLE ( ld_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1520 no-box.
...
If NOT AVAILABLE ld_det THEN
        leave V1525L.
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1525 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 no-box.
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移-车间]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
