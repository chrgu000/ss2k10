...
define variable vtitle as character format "x(40)".
...
REPEAT:
     ...
     REPEAT:
        ...
        assign vtitle = "[库存转移库位优先]" + "*" + TRIM(V1002).
        /* LOGICAL SKIP START */
        IF aPASS = "Y" then
        leave V1002L.
        /* LOGICAL SKIP END */
                display  vtitle skip with fram F1002 no-box.
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display vtitle skip with fram F1100 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1300  as char format "x(50)" initial "M08209-557-1-CK".
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display vtitle skip with fram F1300 no-box.
...
/*  Sam Song 20100319 End */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display vtitle skip with fram F1305 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display vtitle skip with fram F1410 no-box.
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display vtitle skip with fram F1500 no-box.
...
LD_SITE = V1002 AND LD_REF = "" AND
   ...
   if substring ( V1500 ,1,1 ) = "S" then V1500 = substring (V1500,2,18).
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display vtitle skip with fram F1510 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        for each qad_wkfl no-lock where qad_key1 = "xsinv69.i,locstat"
             ...
             if i = 2 then do:
                ...
                assign L15203 = L15201.
             end.
             else if i = 4 then do:
                assign L15204 = L15201.
             end.
             else if i = 5 then do:
                assign L15205 = L15201.
             end.
             else if i = 6 then do:
...
If NOT AVAILABLE ld_det THEN
        leave V1525L.
        /* LOGICAL SKIP END */
                display vtitle skip with fram F1525 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display vtitle skip with fram F1600 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display vtitle skip with fram F1700 no-box.
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display vtitle skip with fram F9000 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display vtitle skip with fram F9010 no-box.
...
If NOT AVAILABLE ( tr_hist ) then
   ...
   pause 0 before-hide.
     ...
     REPEAT:
        ...
        leave V9015L.
        /* LOGICAL SKIP END */
                display vtitle skip with fram F9015 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display vtitle skip with fram F9110 no-box.
...
if V9120 = ? THEN
        leave V9120L.
        /* LOGICAL SKIP END */
                display vtitle skip with fram F9120 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        leave V9130L.
        /* LOGICAL SKIP END */
                display vtitle skip with fram F9130 no-box.
...
If AVAILABLE ( pt_mstr )  then
   ...
   */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display vtitle skip with fram F9140 no-box.
...
IF 1 = 1 THEN
        leave V9150L.
        /* LOGICAL SKIP END */
                display vtitle skip with fram F9150 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        leave V9160L.
        /* LOGICAL SKIP END */
                display vtitle skip with fram F9160 no-box.
