	...
	FIND FIRST cp_mstr WHERE  cp_cust=trim(V1003x) AND xxxsod_part = cp_cust_part NO-LOCK NO-ERROR.
     ...
     END FUNCTION.
        ...
        /* LOGICAL SKIP END */
                ...
                ss - 110402.1 -e */
        /* ss - 110402.1 -b */
        display "[销售订单发货n-110402.1]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
...
find first cm_mstr where cm_addr=trim(V1003) no-lock no-error.
if avail cm_mstr then assign tmpsonbr=substring(cm_sort,1,2).  /* 110402.1 -b  客户开头*/
...
/* SS 090912.1 - E */
       ...
       /* ss - 110402. 1-b 
   /* SS - 20081118.1 - E */
      assign tmpsonbr = tmpsonbr + substring(xxsod_type,1,1). /* 类型 w,m */
      ASSIGN tmpsonbr =tmpsonbr + substring(v_ord_date,4,1). /* 年 */
      ...
      /* 月 */
      assign tmpsonbr =tmpsonbr + substring(xxsod_project,1,1).  /* 类型 m/s (mp,sp) */
/* SS 090804.1 - B */
/*
      assign tmpsonbr =tmpsonbr + string(xxsod_week).
*/
      assign tmpsonbr =tmpsonbr + string(day(date(xxsod_due_date1))).  /* 日期 */
/* SS 090804.1 - E */     
      ss - 110402.1 -e */
       /* ss - 110402.1 -b */  
       /* tmpsonbr 已经客户开头了 */
