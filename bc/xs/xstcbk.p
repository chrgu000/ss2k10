...
repeat:
  hide all.
  assign tcnbr = "".
  display "[台车回收n]"   + "*" + TRIM ( wDefSite ) + vernbr  format "x(40)" skip(6) with fram framea1 no-box.

  /* LABEL 4 - END */
  display "输入台车号或按E退出"       format "x(40)" skip
