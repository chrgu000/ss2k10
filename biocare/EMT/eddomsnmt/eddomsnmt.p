...
*/
define variable fldname  like code_fldname initial "SO-DOMSN".
/* SS - 121211.1 - E */

/* DISPLAY SELECTION FORM */
form
   code_value label "DOMAIN" colon 25 format "x(8)"
   skip(1)
   code_desc     colon 25 format "x(2)"
...
repeat with frame a:
   ...
   if not input code_value > "" then do:
 	...
 	find first dom_mstr where dom_domain = input code_value no-lock no-error.
