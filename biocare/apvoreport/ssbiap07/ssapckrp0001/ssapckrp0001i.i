...
/* $Revision: 1.42 $   BY: Bill Jiang      DATE: 04/17/07   ECO: *SS - 20070417.1* */
/*-Revision end---------------------------------------------------------------*/
   ...
   ap_ref no-lock
      ...
      */
      ...
      then do:
         ...
         */
         CREATE ttssapckrp0001.
         ASSIGN
            ttssapckrp0001_ap_batch = ap_mstr.ap_batch

            ttssapckrp0001_ck_bank = ck_bank
            ttssapckrp0001_ck_nbr = ck_nbr
            ttssapckrp0001_ck_ref = ck_ref
            ttssapckrp0001_ap_vend = ap_mstr.ap_vend
            ttssapckrp0001_name = NAME
            ttssapckrp0001_ap_date = ap_mstr.ap_date
            ttssapckrp0001_ap_effdate = ap_mstr.ap_effdate
            ttssapckrp0001_ap_curr = ap_mstr.ap_curr

            ttssapckrp0001_ap_ex_rate = ap_mstr.ap_ex_rate
            ttssapckrp0001_ap_ex_rate2 = ap_mstr.ap_ex_rate2

            ttssapckrp0001_ap_entity = ap_mstr.ap_entity
            ttssapckrp0001_ap_acct = ap_mstr.ap_acct
            ttssapckrp0001_ap_sub = ap_mstr.ap_sub
            ttssapckrp0001_ap_cc = ap_mstr.ap_cc
            ttssapckrp0001_ckstatus = ckstatus
            ttssapckrp0001_base_disp_amt = base_disp_amt

            ttssapckrp0001_ap_entity1 = apmstr.ap_entity
            ttssapckrp0001_ckd_voucher = ckd_voucher
            ttssapckrp0001_ckd_type = ckd_type
            ttssapckrp0001_order = order
            ttssapckrp0001_rmks = rmks
            ttssapckrp0001_invoice = invoice
            ttssapckrp0001_ckd_acct = ckd_acct
            ttssapckrp0001_ckd_sub = ckd_sub
            ttssapckrp0001_ckd_cc = ckd_cc
            ttssapckrp0001_base_ckd_amt = base_ckd_amt
            ttssapckrp0001_base_disc = base_disc

            ttssapckrp0001_ap_disc_acct = ap_mstr.ap_disc_acct
            ttssapckrp0001_ap_disc_sub = ap_mstr.ap_disc_sub
            ttssapckrp0001_ap_disc_cc = ap_mstr.ap_disc_cc

            ttssapckrp0001_ckd_amt = ckd_amt
            ttssapckrp0001_ckd_disc = ckd_disc

            ttssapckrp0001_disp_amt = ap_mstr.ap_amt
             .

         if ap_rmk <> "" then DO:
            assign
               ttssapckrp0001_ap_rmk = ap_mstr.ap_rmk
               .
         END.
         if ckstatus = "void" then DO:
            ASSIGN
               ttssapckrp0001_ck_voideff  = ck_voideff
               .
         END.
         /* SS - 20070417.1 - E */
