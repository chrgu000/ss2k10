      ...
      FOR FIRST ttssapckrp0001 NO-LOCK WHERE 
         ...
         assign 
            tt1_cr_amt = ttssapckrp0001_base_disc
            .
               
         IF ac_curr <> base_curr THEN DO:
            ASSIGN
               tt1_curramt = ABS(ttssapckrp0001_ckd_disc)
