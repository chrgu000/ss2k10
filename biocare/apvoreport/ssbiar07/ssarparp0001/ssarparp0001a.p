...
/* $Revision: 1.19.1.34 $           BY: Bill Jiang       DATE: 08/17/07 ECO: *SS - 20070817.1*  */
/* $Revision: 1.19.1.34 $           BY: Bill Jiang       DATE: 02/21/08 ECO: *SS - 20080221.1*  */
      ...
      */
      ...
      ar_nbr no-lock
         ...
         if not summary then do with frame e:
            /* SS - 20070817.1 - B */
            CREATE ttssarparp0001.
            ASSIGN
               /* SS - 20080221.1 - B */
               ttssarparp0001_ar_nbr = ar_mstr.ar_nbr
               /* SS - 20080221.1 - E */
               ttssarparp0001_ar_batch = ar_mstr.ar_batch

               ttssarparp0001_ar_check = ar_mstr.ar_check
               ttssarparp0001_ar_bank = ar_mstr.ar_bank
               ttssarparp0001_ar_po = ar_mstr.ar_po
               ttssarparp0001_ar_type = ar_mstr.ar_type

               ttssarparp0001_ar_date = ar_mstr.ar_date
               ttssarparp0001_ar_entity = ar_mstr.ar_entity
               ttssarparp0001_ar_acct = ar_mstr.ar_acct
               ttssarparp0001_ar_sub = ar_mstr.ar_sub
               ttssarparp0001_ar_cc = ar_mstr.ar_cc

               ttssarparp0001_ar_bill = ar_mstr.ar_bill
               ttssarparp0001_ad_name = NAME
               ttssarparp0001_ex_rate_relation1 = ex_rate_relation1
               ttssarparp0001_ar_ex_rate = ar_mstr.ar_ex_rate
               ttssarparp0001_ar_ex_rate2 = ar_mstr.ar_ex_rate2
               ttssarparp0001_ar_effdate = ar_mstr.ar_effdate
               ttssarparp0001_ar_disc_acct = ar_mstr.ar_disc_acct
               ttssarparp0001_ar_disc_sub = ar_mstr.ar_disc_sub
               ttssarparp0001_ar_disc_cc = ar_mstr.ar_disc_cc
               ttssarparp0001_ex_rate_relation2 = ex_rate_relation2
               .
            /*
            if not (base_rpt = "" and not mixed_rpt) then 
               ASSIGN
               ttssarparp0001_ar_curr = ar_mstr.ar_curr
               .
            else
               ASSIGN 
                  ttssarparp0001_ar_curr = base_curr
                  .
            */
            ASSIGN
               ttssarparp0001_ar_curr = ar_mstr.ar_curr
            ...
            if base_rpt = "" and not mixed_rpt THEN do:
               ASSIGN
                  ttssarparp0001_ar_amt = (- base_amt)
                  .
            end.
            ELSE do:
                ASSIGN
                    ttssarparp0001_ar_amt = (- ar_mstr.ar_amt)
                    .
            end.
            */
            ASSIGN
               ttssarparp0001_ar_base_amt = (- base_amt)
               ttssarparp0001_ar_amt = (- ar_mstr.ar_amt)
               .
            /* SS - 20070817.1 - E */
            ...
            */
            IF ard_type = "N" OR ard_type = "U" THEN
                ASSIGN
                ttssarparp0001_ard_ref = ard_tax
                .
            ELSE
                ASSIGN
                ttssarparp0001_ard_ref = ard_ref
                .

            ASSIGN
                ttssarparp0001_ard_type = ard_type
                ttssarparp0001_ard_type_desc = TYPE
                ttssarparp0001_ard_entity = ard_entity
                ttssarparp0001_ard_acct = ard_acct
                ttssarparp0001_ard_sub = ard_sub
                ttssarparp0001_ard_cc = ard_cc
                .
            ...
            then do:
                ASSIGN
                    ...
                    .
                ASSIGN
                    ttssarparp0001_disp_curr = DISP_curr
                    ttssarparp0001_ard_amt = ard_amt
                    ttssarparp0001_ard_disc = ard_disc
                    .
            end.
            else
               do:
                ASSIGN
                    ttssarparp0001_disp_curr = DISP_curr
                    ttssarparp0001_ard_amt = base_damt
                    ttssarparp0001_ard_disc = base_disc
                    .
            end.
            */
            if (base_rpt = ""
            ...
            ASSIGN
               ...
               ttssarparp0001_ard_amt = ard_amt
               ttssarparp0001_ard_disc = ard_disc
               ttssarparp0001_ard_base_amt = base_damt
               ttssarparp0001_ard_base_disc = base_disc
               .
            /* SS - 20070817.1 - E */
            ...
            if ard_type <> "N" then do:
               ...
               then
                  ...
                  */
                  ASSIGN ttssarparp0001_aramt = (ard_amt + ard_disc).
                  /* SS - 20070817.1 - E */
               else
                  /* SS - 20070817.1 - B */
                  /*
                  display aramt.
                  */
                  ASSIGN ttssarparp0001_aramt = aramt.
                  /* SS - 20070817.1 - E */
               accumulate (ard_amt + ard_disc) (total).
               accumulate aramt (total).
               */
               ASSIGN 
                  ttssarparp0001_aramt = (ard_amt + ard_disc)
                  ttssarparp0001_base_aramt = aramt
                  .
            end.
            /* SS - 20070817.1 - B */
            /*
            ...
            */
            ELSE ASSIGN ttssarparp0001_aramt = 0.
            /* SS - 20070817.1 - E */
            ...
            then do:
               ...
               then do:
                  ...
                  then
                     ...
                     */
                     ASSIGN ttssarparp0001_unamt = (ard_amt - c_appl_amt).
                     /* SS - 20070817.1 - E */
                  else
                     /* SS - 20070817.1 - B */
                     /*
                     display unamt.
                     */
                     ASSIGN ttssarparp0001_unamt = unamt.
                     /* SS - 20070817.1 - E */
                  ...
                  */
                  ASSIGN 
                     ttssarparp0001_unamt = (ard_amt - c_appl_amt)
                     ttssarparp0001_base_unamt = unamt
                     .
                  ...
                  then
                     ...
                     */
                     ASSIGN ttssarparp0001_unamt = ard_amt.
                     /* SS - 20070817.1 - E */
                  else
                     /* SS - 20070817.1 - B */
                     /*
            ...
            if ard_type = "N" then do:
               ...
               if base_rpt = ""
                  ...
                  /* SS - 20070817.1 - B */
                  /*
                  display ard_amt @ nonamt.
                  */
                  ASSIGN ttssarparp0001_nonamt = ard_amt.
                  /* SS - 20070817.1 - E */
               else 
                  /* SS - 20070817.1 - B */
                  /*
                  display nonamt.
                  */
                  ASSIGN ttssarparp0001_nonamt = nonamt.
                  /* SS - 20070817.1 - E */
               accumulate c_nonamt (total).
               accumulate nonamt (total).
               */
               ASSIGN 
                  ttssarparp0001_nonamt = ard_amt
                  ttssarparp0001_base_nonamt = nonamt
                  .
            end.
            /* SS - 20070817.1 - B */
            /*
            ...
            down 1.
            */
            else ASSIGN ttssarparp0001_nonamt = 0.
            /* SS - 20070817.1 - E */
         end.
      ...
      if last(ar_mstr.ar_nbr) then do:  /* report totals */
         ...
         {&ARPARPA-P-TAG60}
            ...
            display
               ...
               accum total (accum total base_damt) @ base_damt
               accum total (accum total base_disc) @ base_disc
               accum total (accum total aramt) @ aramt
               accum total (accum total unamt) @ unamt
               accum total (accum total nonamt) @ nonamt.
            {&ARPARPA-P-TAG61}
