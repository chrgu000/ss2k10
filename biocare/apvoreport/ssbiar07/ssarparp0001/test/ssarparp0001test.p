...
/* $Revision: 1.19.1.19 $         BY: Bill Jiang       DATE: 08/17/07   ECO: *SS - 20070817.1* */
/*-Revision end---------------------------------------------------------------*/
...
repeat:
   ...
   */
   ...
   EXPORT DELIMITER ";" "ar_batch" "ar_check" "ar_bank" "ar_po" "ar_type" "ar_date" "ar_entity" "ar_acct" "ar_sub" "ar_cc" "ar_bill" "ad_name" "ex_rate_relation1" "ar_ex_rate" "ar_ex_rate2" "ar_effdate" "ar_disc_acct" "ar_disc_sub" "ar_disc_cc" "ex_rate_relation2" "ar_curr" "ar_amt" "ar_base_amt" "ard_ref" "ard_type" "ard_type_desc" "ard_entity" "ard_acct" "ard_sub" "ard_cc" "disp_curr" "ard_amt" "ard_base_amt" "ard_disc" "ard_base_disc" "aramt" "base_aramt" "unamt" "base_unamt" "nonamt" "base_nonamt" "ar_nbr".
   FOR EACH ttssarparp0001:
      EXPORT DELIMITER ";" ttssarparp0001.
   END.
