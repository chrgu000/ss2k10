...
/* $Revision: 1.19.1.19 $         BY: Bill Jiang       DATE: 08/17/07   ECO: *SS - 20080719.1* */
...
/* SS - 20130101.1 - E */
   ...
   */
   ...
   PUT unformatted     "ExcelFile;ssbiar07" SKIP.
   PUT unformatted     "SaveFile;" + "ssbiar07" + "-" + string(today, "99999999") + "-" + replace(string(time, "HH:MM:SS"), ":", "")  SKIP.
   ...
   FOR EACH ttssarparp0001
      ...
      */
      ...
      ASSIGN
         ...
         tt1_desc = ttssarparp0001_ard_type + ttssarparp0001_ard_ref
         tt1_ascp  = ac_code
         tt1_as_desc = ac_desc
         .
      ...
      */
      ...
      IF LAST-OF(ttssarparp0001_ar_nbr) THEN DO:
         ...
         /* 8 - 银行 */
         FIND FIRST bk_mstr WHERE bk_domain = GLOBAL_domain AND bk_code = ttssarparp0001_ar_bank NO-LOCK NO-ERROR.
