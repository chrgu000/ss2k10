/* $Revision: eb2.1sp5    BY: Bill Jiang     DATE: 06/06/08   ECO: *SS - 090427.1*      */
/* $Revision: eb2.1sp5    BY: Bill Jiang     DATE: 07/19/08   ECO: *SS - 090427.1*      */
...
/* SS - 20130101.1 - E */
   ...
   {gprun.i ""xxbifa05gltr.p""}

   IF posted_only = NO THEN DO:
      {gprun.i ""xxbifa05glt.p""}
   END. /* posted_only = no */
   ...
   */
   /* SS - 20130101.1 - E */
	...
	/*输出到EXCEL*/
	/* SS - 20130101.1 - B */
   PUT unformatted     "ExcelFile;ssbifa05" SKIP.
   PUT unformatted     "SaveFile;" + "ssbifa05" + "-" + string(today, "99999999") + "-" + replace(string(time, "HH:MM:SS"), ":", "")  SKIP.
