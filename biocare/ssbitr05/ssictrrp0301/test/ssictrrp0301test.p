...
/* $Revision: 1.28 $ BY: Bill Jiang        DATE: 04/16/07 ECO: *SS - 20070416.1* */
/* $Revision: 1.28 $ BY: Bill Jiang        DATE: 04/24/08 ECO: *SS - 20080424.1* */
...
repeat:
  ...
  */
   {wbrp06.i &command = update
       &fields = "  part part1 
       nbr nbr1 so_job so_job1 lot lot1 loc loc1
       efdate efdate1 glref glref1
    entity entity1
        acct acct1 sub sub1 cc cc1 proj proj1 trdate trdate1 trtype
        " &frm = "a"}
   /* SS - 20070416.1 - E */
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssictrrp0301.
    ...
    {gprun.i ""ssictrrp0301.p"" "(
     ...
     EXPORT DELIMITER ";" "tr_effdate" "tr_trnbr" "trgl_type" "tr_nbr" "trgl_gl_ref" "trgl_dr_acct" "trgl_dr_sub" "trgl_dr_cc" "trgl_dr_proj" "trgl_dr_amt" "trgl_cr_acct" "trgl_cr_sub" "trgl_cr_cc" "trgl_cr_proj" "trgl_cr_amt" "tr_part" "si_entity" "tr_rmks" "tr_line" "tr_site" "tr_prod_line" "tr_lot" "tr_date" "tr_type" "tr_loc" "tr_qty_loc" "wo_part".
     FOR EACH ttssictrrp0301:
         EXPORT DELIMITER ";" ttssictrrp0301.
     END.
