...
/* SS - YYMMDD.1 – RNB
【 YYMMDD.1 】
1.更改为EXCELREPORT方式输出。
2.更改会计单位名称显示为ad_mstr的值。
【 YYMMDD.1 】
SS - YYMMDD.1 - RNE */
...
/*N0QH*/    if budgflag[2] then assign
			...
			*/
		   PUT UNFORMATTED "ExcelFile;sscbsr1" SKIP.
			PUT UNFORMATTED "SaveFile;sscbsr1" + "-" + string(today, "99999999") + "-" + replace(string(time, "HH:MM:SS"), ":", "") SKIP.
			/*
