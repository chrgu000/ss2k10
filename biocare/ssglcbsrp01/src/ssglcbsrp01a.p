...
/* $Revision: 1.21 $          BY: Priya Idnani          DATE: 12/01/05 ECO: *P4B1* */
/* $Revision: 1.21 $          BY: Bill Jiang          DATE: 08/15/07 ECO: *SS - 20070815.1* */
/*-Revision end---------------------------------------------------------------*/
...
for first fm_mstr
   fields( fm_domain fm_desc fm_dr_cr fm_fpos fm_header fm_page_brk
           fm_skip fm_sums_into fm_total fm_type fm_underln)
   use-index fm_fpos
    where fm_mstr.fm_domain = global_domain and  fm_type = "B"
   ...
   */
   ...
   for first fm_mstr
      fields( fm_domain fm_desc fm_dr_cr fm_fpos fm_header fm_page_brk
              fm_skip fm_sums_into fm_total fm_type fm_underln)
      use-index fm_fpos
       where fm_mstr.fm_domain = global_domain and  fm_sums_into = fpos
