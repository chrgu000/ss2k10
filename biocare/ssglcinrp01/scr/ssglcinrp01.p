...
define new shared variable level      as integer format ">9" initial 99
                                      label "Level" no-undo.
define new shared variable varflag    like mfc_logical initial 
   /* SS - 20070816.1 - B */
   /*
   true
   */
...
define new shared variable prtflag    like mfc_logical initial 
   /* SS - 20070816.1 - B */
   /*
   yes 
   */
...
/* SS - 20070816.1 - E */
   ...
   {wbrp06.i &command = update &fields = "  entity entity1 cname
        ...
        enddt [ 2 ] budget [ 2 ] budgetcode [ 2 ]  sub when
