...
/* Revision: 1.62.1.75.1.1          BY: Reena Ambavi          DATE: 09/27/05  ECO: *P42Z* */
/* Revision: 1.62.1.75.1.3          BY: Dilip Manawat         DATE: 07/11/06  ECO: *P4X1* */
/* Revision: 1.62.1.75.1.4  BY: Abhijit Gupta   DATE: 09/18/06  ECO: *P55T* */
/* Revision: 1.62.1.75.1.5  BY: Abhijit Gupta   DATE: 10/30/06  ECO: *P5CB* */
/* Revision: 1.62.1.75.1.6  BY: Sundeep Kalla   DATE: 02/01/07  ECO: *P5N2* */
/* $Revision: 1.62.1.75.1.7 $      BY: Sarita Gonsalves     DATE:08/29/07 ECO: *P663* */
/*-Revision end---------------------------------------------------------------*/
/*****************************************************************************/
...
define new shared variable l_round_amt  like ar_base_applied.
...
define shared variable disc_amt      like ard_disc.
...
repeat with frame d on endkey undo, leave:
   ...
   then do:
      ...
      if available armstr and armstr.ar_effdate > ar_mstr.ar_effdate
      then do:
         {pxmsg.i &MSGNUM=7665 &ERRORLEVEL=2}
         ...
         then do:
            ...
            do on error undo, retry:
               ...
               do on error undo, retry:
                  ...
                  then do:
/*chk*/                 run p_pxmsg(input 3061,input 3).
/*chk*/                 next-prompt ard_entity
/*chk*/                 with frame d.
/*chk*/                 undo, retry.
      ...
      then do:
         ...
         then do:
            ...
            then do:
               ...
               cust_bal = cust_bal - tmpamt - l_round_amt.
