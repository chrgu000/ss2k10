...
repeat with frame a:
   ...
   batchdelete = "".
   display v_key_book02 @ usrw_key1.
   ...
   do on error undo, retry:
      ...
      editing:
         ...
         {mfnp05.i usrw_wkfl
             usrw_index1
            " usrw_key1 = v_key_book02 "
             usrw_key2
            " input usrw_key2 "}

         if recno <> ? then
            display usrw_key1 usrw_key2 usrw_key3 usrw_logfld[1].
   ...
   find usrw_wkfl where usrw_key1 = v_key_book02 and
                        usrw_key2 = input usrw_key2 no-error.

   if not available usrw_wkfl then do:
      {pxmsg.i &MSGNUM=1 &ERRORLEVEL=1}
      create usrw_wkfl.
      assign usrw_key1 = v_key_book02
             usrw_key2.
