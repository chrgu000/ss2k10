...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1200 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
...
If AVAILABLE ( tag_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1605 no-box.
...
If AVAILABLE ( tag_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1608 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1620 no-box.
...
If 1 = 1 then
                L16201 = If AVAILABLE ( tag_mstr ) then "實盤數?[" + trim ( pt_um ) + "] 已盤:" + string ( tag_cnt_qty) else "實盤數?[" + trim ( pt_um ) + "]未盤" .
                else L16201 = "" . 
                ...
                /* LABEL 3 - START */ 
                L16203 = "批號:" + Trim(V1500) .
                display L16203          format "x(40)" skip with fram F1620 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                L16204 = "標簽/庫位:" + ( if V1605 = "" then "自動" else V1605 )  + "[" + trim (V1608) + "]/" + trim ( V1200 ) .
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 no-box.
                ...
                Find first pt_mstr where pt_part = V1300  no-lock no-error.
If AVAILABLE ( pt_mstr ) then
                L17003 = "庫位/數量:" + trim ( V1200 ) + "/" + trim( V1620 ) + "[" + trim(pt_um) + "]" .
                else L17003 = "" . 
                ...
                /* LABEL 4 - START */ 
                L17004 = "對應TAG NO: " + ( if V1605 = "" then "自動獲取" else TRIM ( V1605 ) ) .
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
...
If NOT AVAILABLE ( tag_mstr ) then
   ...
   IF NOT (V9010 = "Y" AND V1700 = "Y" ) THEN LEAVE V9110LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
...
If AVAILABLE ( pt_mstr ) then
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盤(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
