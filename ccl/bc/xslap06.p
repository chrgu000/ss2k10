...
/*********************************joy del 05/07/2009****************************/
        ...
        IF NOT AVAILABLE SOD_DET then do:
                display skip "訂單有誤,請查詢1" @ WMESSAGE NO-LABEL with fram F1105.
                pause 0 before-hide.
                undo, retry.
        end.
/*********************************joy del 05/07/2009****************************
	...
	IF not (substring(V1105,1,2) = "SA" or substring(V1105,1,2) = "RA" ) THEN DO:
                display skip "訂單有誤,請查詢2" @ WMESSAGE NO-LABEL with fram F1105.
                pause 0 before-hide.
                undo, retry.
        end.
         /*  ---- Valid Check ---- END */
