...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
...
If AVAILABLE ( wo_mstr )  and  wo_lot = V1103 then
        leave V1103L.
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1103 no-box.
...
If AVAILABLE ( wo_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1104 no-box.
...
If AVAILABLE ( wo_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1105 no-box.
...
If AVAILABLE ( ih_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1106 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1110 no-box.
...
If V1111<>"" then
        ...
        /* --FIRST TIME SKIP -- END  */
                ...
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1111 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1310 no-box.
...
If AVAILABLE ( pt_mstr ) then
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1320 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1330 no-box.
...
{xsgetsoseqno.i}
	...
	V1335 = V1335 + trim(V1320) + trim(V1330).
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1335 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
...
If AVAILABLE ( pt_mstr ) then
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9020 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9025 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[销售POST标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9030 no-box.
