...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
...
If AVAILABLE ( wo_mstr )  and  wo_lot = V1103 then
        leave V1103L.
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1103 no-box.
...
If V1104<>"" then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1104 no-box.
...
IF INDEX("ABCDEFGHIJKLMNOPQRSTUVWXYZ",SUBSTRING (wo_so_job,LENGTH(wo_so_job),1 )) <> 0 THEN V1105 = SUBSTRING (wo_so_job,1,LENGTH(wo_so_job) - 1 ).
        ...
        leave V1105L.
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1105 no-box.
...
If  V1106<>"" then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1106 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1107 no-box.
...
If avail wo_mstr then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1108 no-box.
...
display skip "料号不存在" @ WMESSAGE NO-LABEL with fram F1108.
                pause 0 before-hide.
                Undo, retry.
...
If  AVAILABLE ( so_mstr )  then
        ...
        leave V1109L.
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1109 no-box.
...
If V1111<>"" then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1111 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1112 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1113 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1114 no-box.
...
End. */
   ...
   /* Additional Labels Format */
     /* START  LINE :1115  发货日期[Ship Date]  */
     V1115L:
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1115 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9020 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9025 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签打印]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9030 no-box.
