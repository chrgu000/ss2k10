   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        IF not (V1128="d" or V1128="n") THEN DO:
                display skip "班次只能是D或N" @ WMESSAGE NO-LABEL with fram F1128.
                pause 0 before-hide.
                undo, retry.
        end.
         /*  ---- Valid Check ---- END */
   ...
   IF NOT (V1129="Y" ) THEN LEAVE V1130LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP END */
                ...
                /* LABEL 4 - START */ 
                L11304 = "n-内箱标签w-外箱标签p-packing list" .
...
if V1131<>"" then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[NEW成品标签打印]"   + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1131 no-box.
