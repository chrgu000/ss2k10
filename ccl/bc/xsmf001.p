...
IF OkToRun = yes THEN  RUN    xslap91.p.
 ...
 /* ss - 111013.1 -b
   ...
   REPEAT:
   /*Logical Enter Cycle1185    */
   IF NOT (V1190 = "91" OR V1100 = "91" ) THEN LEAVE V1192LMAINLOOP.
     /* START  LINE :1192  1.9.1 FWD LABEL */
     V1192L:
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1190 = "".
RUN CheckSecurity (INPUT "xssor001.p" , INPUT global_userid , OUTPUT okToRun , OUTPUT Execname ).
IF OkToRun = yes THEN  RUN    xssor001.p.
        leave V1192L.
        /* LOGICAL SKIP END */
...
ss - 111013.1 -e */
   ...
   REPEAT:
   /*Logical Enter Cycle1185    */
   IF NOT (V1190 = "92" OR V1100 = "91" ) THEN LEAVE V1192LMAINLOOP.
     /* START  LINE :1192  1.9.1 FWD LABEL */
     V1192L:
     REPEAT:
