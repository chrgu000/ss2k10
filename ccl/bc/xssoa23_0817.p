...
END FUNCTION.
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
...
If AVAILABLE ( so_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1105 no-box.
   ...
   /* Additional Labels Format */
     /* START  LINE :1203  预计发货日期[SHIPPMENT DATE]  */
     V1203L:
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1203 no-box.
     ...
     END.
     PV1203 = V1203.
     /* END    LINE :1203  预计发货日期[SHIPPMENT DATE]  */
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If AVAILABLE (sod_det) and string ( sod_line ) = V1305 then
        leave V1305L.
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1305 no-box.
...
If NOT AVAILABLE (lad_det) THEN
        leave V1309L.
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1309 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
...
If MinLot <> ""  then
                L15003 = "库存/SO:" + trim(string(MinQty)) + "/" +  (If AVAILABLE ( sod_det ) then string ( sod_qty_ord - sod_qty_ship ) else "0"  ) .
                else L15003 = "" . 
        ...
        display skip "^" @ WMESSAGE NO-LABEL with fram F1500.
            ...
            LD_LOT @ V1500 (IF LD_REF = "" THEN "可" ELSE "已" ) + "备SO/Q:" + GETSONBR(LD_LOT,V1300) + "/" + trim(string(LD_QTY_OH)) + "/" + trim ( LD_LOC ) @ WMESSAGE NO-LABEL with fram F1500.
                  else   do :
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1505 no-box.
                ...
                /* LABEL 3 - START */ 
                L15053 = "订单/项:" + trim ( V1100 ) + "/" + trim ( V1305 ) .
            ...
            THEN DO:
                  ...
                  ELSE find next LD_DET where 
                              LD_PART = V1300 AND LD_LOT =  V1500 AND LD_QTY_OH <> 0  AND LD_SITE = V1002 AND ( LD_REF = "" OR LD_REF = V1100)  
                               no-lock no-error.
                  IF AVAILABLE LD_DET then display skip 
            LD_LOC @ V1505 (IF LD_REF = "" THEN "可" ELSE "已" ) + "备L/Q:" + LD_LOT + "/" + trim(string(LD_QTY_OH)) @ WMESSAGE NO-LABEL with fram F1505.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 no-box.
  ...
  DECIMAL ( V1600 ) > 0 and ld_ref = "" and ld_qty_oh >= DECIMAL ( V1600 )
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 no-box.
                ...
                /* LABEL 3 - START */ 
                L17003 = "库位:" + trim ( V1505 ) + "/" + trim( V1600 ) .
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 no-box.
...
IF 1 = 1 THEN
        leave V9005L.
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9005 no-box.
...
IF 1 = 2 THEN
        leave V9010L.
        /* LOGICAL SKIP END */
                display "[销售备料LOT]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
