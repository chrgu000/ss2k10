   FUNCTION CALLBYLAP91 RETURNS CHARACTER (
...
DO: 
                            ...
                            /* wResult = "IPS 230-240~*373W*1/2HP 50Hz 1ph". */
                            w-w = 0.
                            wResult = "".
                            DO i = 1 to length(wPramar1).
                               ...
                               IF substring(wPramar1,i,1) = "*" THEN w-w = w-w + 1.
                            END.
                            IF LENGTH(wResult) = 12 THEN wResult = "  " + wResult.
...
DO:
               /* Parmar1 is Date Return WMMYY*/
                ...
                /*xxx*/ if length(aakk) = 1 then aakk = "0" + aakk.
...
DO:
               ...
               */
               FIND LAST QAD_WKFL where QAD_KEY1 = "BARCODE_MODEL_WEEKDAY_WEEK_YEAR_START_END" 
                                    and index ( QAD_KEY2 ,trim(wPramar1) ) <> 0  no-error.
/*        20080806  and QAD_KEY2 >= trim(wPramar1)  no-error.   */
...
DO:
              ...
              */
                   FIND LAST QAD_WKFL where QAD_KEY1 = "BARCODE_MODEL_WEEKDAY_WEEK_YEAR_START_END" 
                                        and index ( QAD_KEY2 ,trim(wPramar4) ) <> 0  no-error.

/*	20080806        		and QAD_KEY2 >= trim(wPramar4)  no-error.               */
...
/*
    ...
    /* DISPLAY  CALLBYLAP91 ("FWD-050SS-A-923456","","1") FORMAT "x(30)". */
    DISPLAY  CALLBYLAP91 ("FWD-0550SSA-1@21280","","6","") FORMAT "x(40)". 
    DISPLAY  CALLBYLAP91 ("FWD-0550SSA-1@21280@008@010","WO321","7","FWD-0550SSA-1@21280") FORMAT "x(40)". 
