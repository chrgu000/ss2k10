...
EXPORT DELIMITER ","
 "bk_code"	 "bk_Desc"	 "ad_sort"	 "ad_date"	 "ad_lang"	 "ad_line1"	 "ad_line2"	 "ad_line3"	 "ad_city"	 "ad_state"	 "ad_zip"	 "ad_format"	 "ad_ctry"	 "ad_county"	 "string(ad_attn)"	 "string(ad_attn2)"	 "string(ad_phone)"	 "string(ad_ext)"	 "string(ad_phone2)"	 "string(ad_ext2)"	 "string(ad_fax)"	 "string(ad_fax2)"	 "bk_check"	 "bk_curr"	 "bk_bk_acct1"	 "bk_bk_acct2"	 "bk_entity"	 "bk_acct"	 "bk_sub"	 "bk_cc"	 "bk_pip_acc"	 "bk_pip_sub"	 "bk_pip_cc"	 "bk_user1"	 "bk_dftar_Acc"	 "bk_dftar_sub"	 "bk_dftar_cc"	 "bk_bkchg_acc"	 "bk_bkchg_sub"	 "bk_bkchg_cc"	 "bk_disc_acc"	 "bk_disc_sub"	 "bk_disc_cc"	 "bk_ddft_acc"	 "bk_ddft_sub"	 "bk_ddft_cc"	 "bk_dftap_acc"	 "bk_dftap_sub"	 "bk_dftap_cc"	 "bk_bktx_acc"	 "bk_bktx_sub"	 "bk_bktx_cc"	 "bk_cdft_acc"	 "bk_cdft_sub"	 "bk_cdft_cc"	 "bk_edft_acc"	 "bk_edft_sub"	 "bk_edft_cc"	 "ad_gst_id"	 "ad_pst_id"	 "ad_vat_reg"	 "ad_edi_std"	 "ad_edi_level"	 "ad_edi_id"	 "ad_edi_tpid."
