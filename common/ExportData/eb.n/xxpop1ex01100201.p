...
/**********************************************************************************************/
        ...
        OUTPUT TO VALUE(m_filename).
                  EXPORT DELIMITER ","
 "pc_list"	 "pc_curr"	 "pc_prod_line"	 "pc_part"	 "pc_um"	 "pc_start"	 "pc_expire"	 "pc_amt_type"	 "pc_min_qty[1]"	 "pc_amt[1]"	 "pc_min_qty[2]"	 "pc_amt[2]"	 "pc_min_qty[3]"	 "pc_amt[3]"	 "pc_min_qty[4]"	 "pc_amt[4]"	 "pc_min_qty[5]"	 "pc_amt[5]"	 "pc_min_qty[6]"	 "pc_amt[6]"	 "pc_min_qty[7]"	 "pc_amt[7]"	 "pc_min_qty[8]"	 "pc_amt[8]"	 "pc_min_qty[9]"	 "pc_amt[9]"	 "pc_min_qty[10]"	 "pc_amt[10]"	 "pc_min_qty[11]"	 "pc_amt[11]"	 "pc_min_qty[12]"	 "pc_amt[12]"	 "pc_min_qty[13]"	 "pc_amt[13]"	 "pc_min_qty[14]"	 "pc_amt[14]"	 "pc_min_qty[15]"	 "pc_amt[15]."
