...
/**********************************************************************************************/
        ...
        OUTPUT TO VALUE(m_filename).
	               EXPORT DELIMITER ","
		  "pt_part"	 "pt_um"	 "pt_desc1"	 "pt_desc2"	 "pt_prod_line"	 "pt_added"	 "pt_dsgn_grp"	 "pt_promo"	 "pt_part_type"	 "pt_status"	 "pt_group"	 "pt_draw"	 "pt_rev"	 "pt_drwg_loc"	 "pt_drwg_size"	 "pt_break_cat."
