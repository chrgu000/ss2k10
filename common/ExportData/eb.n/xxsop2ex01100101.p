/*xxsop2ex.p ---- Program to DownLoad So Price List  Master (1.10.1.1) -    Eb                */
...
/**********************************************************************************************/
               ...
               &SCOPED-DEFINE xxsop2ex_p_1  "Extraction File Name"
               &SCOPED-DEFINE xxsop2ex_p_2  "ERROR: Blank Filename Not Allowed"   
               ...
               FORM
               SKIP(1)
               m_filename VALIDATE( m_filename <> "", {&xxsop2ex_p_2} ) LABEL {&xxsop2ex_p_1}
               WITH FRAME a SIDE-LABELS TITLE "SO Price List Master Extraction(LQC)" WIDTH 80.
