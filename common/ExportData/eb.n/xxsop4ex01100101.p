/*xxsop4ex.p ---- Program to DownLoad So Price List  Master (1.10.1.1) -    Eb                */
...
/* Parameters : Amount type   = Feight Terms                                                  */              
/*              Qty type      = Quantity                                                      */
/*              Comb Type     = Combinable                                                    */
/**********************************************************************************************/
/* PROCEDURE NAME           : xxsop4ex.p                                                      */
...
/**********************************************************************************************/
               ...
               &SCOPED-DEFINE xxsop4ex_p_1  "Extraction File Name"
               &SCOPED-DEFINE xxsop4ex_p_2  "ERROR: Blank Filename Not Allowed"   
               ...
               FORM
               SKIP(1)
               m_filename  VALIDATE( m_filename <> "", {&xxsop4ex_p_2} ) LABEL {&xxsop4ex_p_1}
               WITH FRAME a SIDE-LABELS TITLE "SO Price List Master Extraction(FQC)" WIDTH 80.
               ...
               EXPORT DELIMITER ","
	        "pi_list"	 "pi_cs_code"	 "pi_part_code"	 "pi_curr"	 "pi_um"	 "pi_start"	 "pi_expire"	 "pi_desc"	 "pi_amt_type"	 "pi_qty_type"	 "pi_comb_type"	 "pi_min_net"	 "pi_max_qty"	 "pi_break_cat"	 "pi_confg"	 "pi_manual"	 "pi_max_ord"	 "pi_disc_seq"	 "pi_print"

	       .
               /* Amt  Type = Freight Terms  */
               /* Qty  Type = Quantity       */
               /* Comb Type = Combinable     */
