/*xxsop5ex.p ---- Program to DownLoad So Price List  Master (1.10.1.1) -    Eb                */
...
/* Parameters : Amount type   = Freight Terms                                                 */              
/*              Qty type      = Amount                                                        */
/*              Comb Type     = Combinable                                                    */
/**********************************************************************************************/
/* PROCEDURE NAME           : xxsop5ex.p                                                      */
...
/**********************************************************************************************/
               ...
               &SCOPED-DEFINE xxsop5ex_p_1  "Extraction File Name"
               &SCOPED-DEFINE xxsop5ex_p_2  "ERROR: Blank Filename Not Allowed"   
               ...
               FORM
               SKIP(1)
               m_filename VALIDATE( m_filename <> "", {&xxsop5ex_p_2} ) LABEL {&xxsop5ex_p_1}
               WITH FRAME a SIDE-LABELS TITLE "SO Price List Master Extraction(FAC)" WIDTH 80.
               ...
               EXPORT DELIMITER ","
	        "pi_list"	 "pi_cs_code"	 "pi_part_code"	 "pi_curr"	 "pi_um"	 "pi_start"	 "pi_expire"	 "pi_desc"	 "pi_amt_type"	 "pi_qty_type"	 "pi_comb_type"	 "pi_min_net"	 "pi_max_qty"	 "pi_break_cat"	 "pi_confg"	 "pi_manual"	 "pi_max_ord"	 "pi_disc_seq"	 "pi_print"	 "m_cmtyn"	 "pid_qty"	 "pid_fr_terms."

	       .
               /*Amt  Type = Feight Terms */
               /*Qty  Type = Amount       */
               /*Comb Type = Combinable   */
