/*xxuomex.p ----  Program to DownLoad Unit Of Measure Master (1.13)     Eb                    */
...
/**********************************************************************************************/
        ...
        WITH FRAME a SIDE-LABELS TITLE "Uint Of Measure Extraction" WIDTH 80.
       ...
       {pxmsg.i &MSGNUM = 9000 &ERRORLEVEL = 1}
        ...
        OUTPUT TO VALUE(m_filename).
          EXPORT DELIMITER ","
           "um_um"	 "um_alt_um"	 "um_part"	 "um_conv."

	  .
           FOR EACH um_mstr NO-LOCK : 
                  EXPORT DELIMITER ","
                             um_um
                             um_alt_um
                             um_part
