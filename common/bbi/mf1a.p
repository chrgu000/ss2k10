/* GUI CONVERTED from mf1a.p (converter v1.78) Fri May 22 02:27:26 2009 */
...
/*  Revision: 1.123.1.7  BY: Fred Yeadon    DATE: 03/20/08        ECO: *Q1J8* */
/*  Revision: 1.123.1.8  BY: Rijoy Ravindran  DATE: 09/24/08      ECO: *Q1TX* */
/* $Revision: 1.123.1.9 $          BY: John Corda     DATE: 05/22/09        ECO: *Q2XG* */
/*-Revision end---------------------------------------------------------------*/
/******************************************************************************/
...
{pxgblmgr.i &NOSHARED}
&SCOPED-DEFINE MFDECLRE_I mfdeclre.i
{{&MFDECLRE_I}}
