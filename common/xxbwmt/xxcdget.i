/* xxcdget.i Retrieve the cd_det records for a Utility Program                */
/* Copyright 1986-2007 QAD Inc., Carpinteria, CA, USA.                        */
/* All rights reserved worldwide.  This is an unpublished work.               */
/* Retrieve the cd_det records for a Utility Program                          */
/* The parameter {2} indicates which type of records to retrieve              */
...
/* $Revision: 1.18 $   BY: Ashim Mishra       DATE: 06/08/07  ECO: *P5VW*     */
/*-Revision end---------------------------------------------------------------*/
/******************************************************************************/
...
/* If {3} is not passed then it is 0, otherwise, there is a second page */
...
repeat xcnt = 0 to integer("{3}"):
   ...
   then do:
      ...
      repeat cntr = 1 to last-cmmt:
         display
            util-cmmt[cntr] @ blank-cmmt
         with frame disp-cmmts.
         if cntr <> last-cmmt
         then
            down 1
            with frame disp-cmmts.
      end. /* REPEAT cntr = 1 to last-cmmt: */
