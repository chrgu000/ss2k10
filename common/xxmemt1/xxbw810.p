...
find first brw_mstr exclusive-lock where brw_mstr.brw_name = 'xx810' no-error.
if not available brw_mstr then do:
          create brw_mstr.
          assign brw_mstr.brw_name = 'xx810'.
end.
assign brw_mstr.brw_desc = 'MENU_DETAIL'.
assign brw_mstr.brw_view = 'usrw_wkfl'
       brw_mstr.brw_filter    = 'usrw_domain = "xxmemt1.p" and usrw_key1 = global_userid'
