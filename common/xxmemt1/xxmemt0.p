...
/* Environment: Progress:10.1C   QAD:eb2sp12    Interface:Character          */
...
repeat with frame frame-a:
   prompt-for cdref editing:
      {mfnp05.i usrw_wkfl usrw_index1 " usrw_key1 = global_userid " 
   ...
   update mndnbr[1] sel[1] exec[1]  sortkey[1] dsc[1]
    ...
    do on error undo, retry:
      ...
      if lastkey = keycode("F5") or lastkey = keycode("CTRL-D") then do:
         ...
         find first usrw_wkfl exclusive-lock where usrw_key1 = global_userid
    ...
    if yn then do:
        for first usrw_wkfl exclusive-lock where usrw_key1 = global_userid and 
                  usrw_key2 = cdref: end.
