/* GUI CONVERTED from chcfacrp.p (converter v1.71) Sun Oct 21 21:39:25 2007 */
...
&SCOPED-DEFINE PP_GUI_CONVERT_MODE REPORT
      ...
      {mfdtitle.i "A "}
      define variable cas_cf_code like xcf_ac_code. 
      define variable cas_cf_code1 like xcf_ac_code. 
...
/*GUI*/   mainloop: do on error undo, return error on endkey undo, return error:
         ...
         for each xcf_mstr where xcf_ac_code >= cas_cf_code 
                             and xcf_ac_code <= cas_cf_code1
                             and xcf_domain = global_domain
                    no-lock with frame d:

             FORM /*GUI*/     xcf_ac_code xcf_sub xcf_cc xcf_pro
                     xcf_active
                     with STREAM-IO /*GUI*/  frame d width 140. 

             /* SET EXTERNAL LABELS */
             setFrameLabels(frame d:handle).

             display xcf_ac_code xcf_sub xcf_cc xcf_pro
                     xcf_active
