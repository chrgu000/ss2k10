...
{xxporcld.i "new"}
{gpcdget.i "UT"}
define variable vusrwkey1 as character initial "xxporcld.p.cimload".
form
   skip(1)
   flhload colon 14  view-as fill-in size 40 by 1 skip(1)
   errload colon 14  view-as fill-in size 40 by 1 skip(1)
...
repeat:
   ...
   update flhload errload cloadfile with frame a.

   {wbrp06.i &command = update &fields = " flhload errload cloadfile "
             &frm = "a"}
