         ...
         break by tr_part by tr_site by tr_loc BY tr_serial /* ss - 130321.1 -e */:
          ...
          /* ss - 130321.1 -e */
            ...
            then do:
               ...
               find first t_lddet
                  where t_lddet.t_lddet_part = tr_part
               ...
               then do:
                  create t_lddet.
                  assign
                     t_lddet.t_lddet_site = tr_site
                     t_lddet.t_lddet_part = tr_part
                     t_lddet.t_lddet_loc  = tr_loc
                     t_lddet.t_lddet_qty  = 0
                      /* ss - 130321.1 -b */
                       t_lddet.t_lddet_lot = tr_serial
            ...
            then do:
               ...
               no-lock:
                  ...
                  then do:
                     ...
                     for first trhist
                         fields(tr_trnbr tr_qty_loc tr_rev tr_type tr_effdate tr_serial tr_ref)
                         where trhist.tr_domain = global_domain
