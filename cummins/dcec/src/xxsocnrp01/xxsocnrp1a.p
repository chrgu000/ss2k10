/* GUI CONVERTED from socnrp1a.p (converter v1.78) Fri Oct 29 14:38:03 2004 */
...
with STREAM-IO /*GUI*/  frame xref_header side-labels width 132 no-box.
...
with STREAM-IO /*GUI*/  frame detail down width 132 attr-space.
...
with STREAM-IO /*GUI*/  frame currency side-labels width 132 no-box.
...
with STREAM-IO /*GUI*/  frame errors width 132 attr-space.
...
for each temp0: delete temp0. end.
...
/*   down 1 with frame detail.                                              */
   ...
   assign t0_site        = cncix_site
          t0_si_desc     = site_description
          t0_sod_nbr     = cncix_so_nbr
          t0_sod_ln      = cncix_sod_line
          t0_cust        = cncix_cust
          t0_cm_desc     = cust_description
          t0_shipto      = cncix_shipto
          t0_st_desc     = ship_description
          t0_part        = cncix_part
          t0_pt_desc     = part_description
          t0_po          = cncix_po
          t0_max_days    = max_aging_days
          t0_loc         = cncix_current_loc
          t0_lot         = cncix_lotser
          t0_ref         = cncix_ref
          t0_auth        = cncix_auth
          t0_stock       = cncix_qty_stock
          t0_um          = cncix_stock_um
          t0_qty_ship    = cncix_qty_ship
          t0_asn_shipper = cncix_asn_shipper
...
/*         qoh_base_curr                                                     */
/*         gl_base_curr                                                      */
/*      with frame currency STREAM-IO /*GUI*/ .                              */
/*                                                                           */
/*      display                                                              */
/*         curr_error1 when (curr_error1 <> "")                              */
/*         curr_error2 when (curr_error2 <> "")                              */
/*      with frame errors STREAM-IO /*GUI*/ .                                */
   end.
