...
/* $Revision: 1.41.1.1 $ BY:Bill Jiang            DATE: 03/22/08     ECO: *SS - 20080322.1* */
/*-Revision end---------------------------------------------------------------*/
      ...
      = ap_ref
         ...
         if available prh_hist then do:
            ...
            */
            ...
            ASSIGN
               ttssapvorp0001_prh_receiver = prh_receiver
               ttssapvorp0001_prh_line = prh_line
               ttssapvorp0001_prh_nbr = prh_nbr
               ttssapvorp0001_prh_part = prh_part
               ...
               ttssapvorp0001_inv_amt = inv_amt
               ttssapvorp0001_vo_curr = vo_curr
               ttssapvorp0001_pvod_trans_qty = pvod_trans_qty
               .
            /*
            ASSIGN
