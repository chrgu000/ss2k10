/* xxwowomt.p - WORK ORDER MAINTENANCE                                        */
...
/* $Revision: 1.32.3.4 $     BY: Deepa  Mathew       DATE: 09/30/08  ECO: *Q1TB*    */
/*-Revision end---------------------------------------------------------------*/
...
/*ss 20130320 同一个工单号码可以自动跳工单ID                             *320*/
{mfdtitle.i "320"}
{cxcustom.i "WOWOMT.P"}
...
repeat:
   ...
   do transaction:
      ...
      if wo_nbr:MODIFIED     = true
         and wo_lot:MODIFIED = true
      then do:
         if input wo_nbr  <> ""
            and input wo_lot <> ""
         then
         ...
         else if input wo_nbr <> ""
         then 
/*320             for first wo_mstr                                          */
/*320               use-index wo_nbr                                         */
/*320               using  wo_nbr                                            */
/*320               where wo_mstr.wo_domain = global_domain                  */
/*320            no-lock:                                                    */
/*320            end. /* FOR FIRST wo_mstr */                                */
/*320*/    .
         if input wo_lot <> ""
         then
            for first wo_mstr
