/* GUI CONVERTED from apvorp.p (converter v1.78) Fri Oct 29 14:36:00 2004 */
...
/*GUI*/ {mfguirpb.i &flds=" batch batch1 ref ref1 votype votype1 entity entity1 vend vend1 vdtype vdtype1 apdate apdate1 effdate effdate1 open_only only_ers show_conf show_unconf show_vph summary sort_by_vend gltrans base_rpt mixed_rpt {&APVORP-P-TAG3} "} /*Drive the Report*/
