/* GUI CONVERTED from apvorp04.p (converter v1.78) Wed Jul 22 04:41:57 2009 */
...
/* Revision: 1.44.1.3 BY: Sundeep Kalla            DATE: 01/03/08 ECO: *P6H9* */
/* Revision: 1.44.1.5  BY: Amandeep Saini          DATE: 03/25/08 ECO: *P6PJ* */
/* Revision: 1.44.1.5  BY: Pratik Dave             DATE: 09/16/08 ECO: *P70M* */
/* $Revision: 1.44.1.6 $  BY: Nafees Khan             DATE: 07/22/09 ECO: *Q337* */
...
define variable age_by as character format "x(3)"
 ...
 /* *SS-20120820.1*   */    define variable l_msg as character no-undo.
...
vend colon 15
 ...
 /* *SS-20120820.1*  -e  */ 
   ...
   vodate1        colon 30
   age_by         colon 30 
 /* *SS-20120820.1*   */      validate((lookup(age_by,"DUE,EFF,INV") <> 0), l_msg)
   base_rpt       colon 30
 ...
 */
      invdate AT 16 FORMAT "99/99/99"
      effdate AT 25   FORMAT "99/99/99"
      vo_mstr.vo_cr_terms  AT 34 FORMAT "x(8)"
      et_age_amt[1]  AT 49  format "->>>>>,>>>,>>9.99"
/* *SS-20120820.1*  -e  */  
      et_age_amt[2]       format "->>>>>,>>>,>>9.99"
      et_age_amt[3]       format "->>>>>,>>>,>>9.99"
      et_age_amt[4]       format "->>>>>,>>>,>>9.99"
      et_base_amt         format "->>>>>,>>>,>>9.99"
   with STREAM-IO /*GUI*/  frame c width 132 no-labels no-attr-space no-box down.
   {&APVORP04-P-TAG45}
   {&APVORP04-P-TAG7}
   ...
   FORM /*GUI*/ 
      l_label1
      to 40
 /* *SS-20120820.1*    */      et_age_amt[1] to 49 format "->>>>>,>>>,>>9.99"
      et_age_amt[2]       format "->>>>>,>>>,>>9.99"
      et_age_amt[3]       format "->>>>>,>>>,>>9.99"
      et_age_amt[4]       format "->>>>>,>>>,>>9.99"
      et_base_amt         format "->>>>>,>>>,>>9.99"
   with STREAM-IO /*GUI*/  frame e width 132 no-labels no-attr-space no-box down.
 ...
 /* *SS-20120820.1*   */   and (ap_acct >= acct and ap_acct <= acct1)       
            and (ap_type = "VO")
...
PROCEDURE ip-param-init:
 ...
 /* *SS-20120820.1*   */  if acct1 = hi_char then acct1 = "".
   {&APVORP04-P-TAG61}
   do i = 1 to 4:
...
PROCEDURE ip-param-quoter:
   ...
   {mfquoter.i ref            }
   {mfquoter.i ref1           }
 /* *SS-20120820.1*   */  {mfquoter.i acct       }
 /* *SS-20120820.1*   */  {mfquoter.i acct1      }
   {mfquoter.i votype         }
   {mfquoter.i votype1        }
   {mfquoter.i lstype         }
   {mfquoter.i vodate1        }
 ...
 /* *SS-20120820.1*   */  if acct1 = "" THEN acct1 = hi_char.
   {&APVORP04-P-TAG64}
...
PROCEDURE ip-disp-voucher:
 ...
 /* *SS-20120820.1*       down 1 with frame c.  */ 
