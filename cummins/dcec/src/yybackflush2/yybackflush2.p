...
REPEAT:
   ...
   IF yn = NO THEN DO:
            ...
            PUT "-------------------- ------------------------------- --------    -------- ------   ----" SKIP.
            FOR EACH tr_hist use-index tr_type where tr_domain = global_domain
                and tr_type ="rct-wo" and (tr_effdate >= effdate and tr_effdate <= effdate1) 
                AND tr_loc ="FG" 
   ...
   IF yn = YES THEN DO:
            ...
            FOR EACH tr_hist use-index tr_type where tr_domain = global_domain 
                ...
                and (tr_site = site or site = "") AND tr_loc ="FG"
                and (tr_date >= flushdate and tr_date <= flushdate1) 
