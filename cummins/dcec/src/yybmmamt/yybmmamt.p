/* GUI CONVERTED from bmmamt.p (converter v1.78) Thu Dec 30 19:59:03 2010 */
...
define variable lines as integer.
 /* *SS-20120824.1*   */  def var msg-nbr as inte. 
...
bom_parent     colon 27
   bomdesc  colon 27
 /* *SS-20120824.1*   */   bom__chr01 colon 27 label   "地点"                 /*kevin*/
 /* *SS-20120824.1*   */   bom__chr02 colon 27 label "对应零件" format "x(18)"             /*kevin*/
...
/*GUI*/ if global-beam-me-up then undo, leave.
   ...
   editing:
      ...
      if recno <> ? then do:
         ...
         display bom_parent
 /* *SS-20120824.1*   */            bom__chr01 bom__chr02                 /*kevin*/
            bomdesc
            bom_batch_um.
...
/*added by kevin, 10/16/2003*/
           /*tfq    set bom__chr01 with frame a.*/
               ...
               find si_mstr no-lock where si_mstr.si_domain = global_domain and si_site = bom__chr01 no-error.
