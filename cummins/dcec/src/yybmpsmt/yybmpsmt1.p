/* GUI CONVERTED from yybmpsmt1.p (converter v1.78) Wed Apr 10 23:04:55 2013 */
...
/*********************************************************/
/*410 增加BOM零件工序有效性检查 不允许修改工序外其他资料不允许新增删除资料 */
/* DISPLAY TITLE */
{mfdtitle.i "410.1"}
...
/*410*/ if input ps_op <> 0 then do:
/*410*/     find opm_mstr where opm_mstr.opm_domain = global_domain
/*410*/                    and  opm_std_op = input ps_op no-lock no-error.
/*410*/     if not available opm_mstr then do:
/*410*/        message "错误:标准工序不存在,请重新输入!" view-as alert-box error.
/*410*/        next-prompt ps_op with frame b.
/*410*/        undo,retry.
/*410*/     end.
/*410*/  end.
...
/*GUI*/ if global-beam-me-up then undo, leave.
 /*LASTKEY <> KEYCODE("F5")*/
         ...
         if c-application-mode <> "API" then do:
            ...
            then do:
/*410*/          del-yn = no.
/*410*/          {pxmsg.i &MSGNUM = 1021 &ERRORLEVEL = 3}

               /* 11 - Please confirm delete */
/*410           {pxmsg.i &MSGNUM = 11                                       */
/*410                    &ERRORLEVEL = {&INFORMATION-RESULT}                */
/*410                    &CONFIRM = del-yn                                  */
/*410           }                                                           */
