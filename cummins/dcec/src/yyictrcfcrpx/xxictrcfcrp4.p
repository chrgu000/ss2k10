...
put skip(1) "零件号码" format "x(19)" "描述" format "x(25)" "产线" format 'x(6)' "A" format "x(2)" "保管员" format 'x(9)'
...
put pt_part " " pt_desc2 " " pt_prod_line "  " pt_abc " " in__qadc01 " " in_user1 " " bgqty " " std_as_of_from " " bgqty_amt  " " 
	rctpo " " rctpo_amt " "
