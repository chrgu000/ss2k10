...
define temp-table tt_glt no-undo
   ...
   field tt_amt      as decimal format "->>,>>>,>>>,>>>,>>>,>>>,>>9.99<<<" /*  like gltw_amt */
...
FORM /*GUI*/ 
   ...
   format "->>>,>>>,>>>,>>9.99<<<<<<<<"
with STREAM-IO /*GUI*/  frame b down width 300 no-box.
...
/*GUI*/ RECT-FRAME:HEIGHT-PIXELS in frame a = FRAME a:HEIGHT-PIXELS - RECT-FRAME:Y in frame a - 2.
   ...
   FORM /*GUI*/  header
      skip(1)
   with STREAM-IO /*GUI*/  frame a1 page-top width 300.
   view frame a1.
...
PROCEDURE p_tt_glt_display:
   ...
   define variable l_dr_amt       as decimal format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<" label "Debit Amount"  no-undo.
   define variable l_cr_amt       as decimal  format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<" label "Credit Amount" no-undo.
   ...
   FORM /*GUI*/ 
      ...
      skip (1)
   with STREAM-IO /*GUI*/  frame jrnl width 300 page-top.
   ...
   FORM /*GUI*/ 
      ...
      l_dr_amt
      l_cr_amt
   with STREAM-IO /*GUI*/  frame jrnldet width 332 down no-box.
   ...
   do with frame jrnldet:
      ...
      for each tt_glt
         ...
         break by tt_entity
               ...
               by tt_effdate
         {&ICTRRP03-P-TAG43}
         with frame jrnldet width 300 down no-box:
         {&ICTRRP03-P-TAG44}
         ...
         if l_dr_amt <> 0
         then
            display l_dr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<" WITH STREAM-IO /*GUI*/ .

         if l_cr_amt <> 0
         then
            display l_cr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<" WITH STREAM-IO /*GUI*/ .
...
/*GUI*/ {mfguichk.i } /*Replace mfrpchk*/
         ...
         then do:
            underline
               ...
               l_cr_amt.
            display
               accum total by tt_sub l_dr_amt @ l_dr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<"
               accum total by tt_sub l_cr_amt @ l_cr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<" WITH STREAM-IO /*GUI*/ .
            down 1.
         ...
         then do:
            underline
               ...
               l_cr_amt.
            display
               accum total by tt_acc l_dr_amt @ l_dr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<"
               accum total by tt_acc l_cr_amt @ l_cr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<" WITH STREAM-IO /*GUI*/ .
            down 1.
         ...
         then do:
            ...
            underline
               ...
               l_cr_amt.
            display
               accum total by tt_entity l_dr_amt @ l_dr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<"
               accum total by tt_entity l_cr_amt @ l_cr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<" WITH STREAM-IO /*GUI*/ .
            down 1.
         ...
         then do:
            underline
               ...
               l_cr_amt.
            display
               accum total l_dr_amt @ l_dr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<"
               accum total l_cr_amt @ l_cr_amt format ">>>,>>>,>>>,>>>,>>>,>>>,>>9.9<<<<<" WITH STREAM-IO /*GUI*/ .
