...
/*W001*/
            ...
            strTmp = trim(substr(xxppif_content,26,25)).
                ...
                put stream batchdata unformatted '"EA" ' .
                strTmp = trim(substr(xxppif_content,26,24)).
                put stream batchdata unformatted '"' strTmp '" '.
/*yuna*/        strTmp = trim(substr(xxppif_content,121)).
/*yuna*/        put stream batchdata unformatted '"' strTmp '" ' skip.
                find first pt_mstr no-lock where pt_domain = global_domain and pt_part = exec_part no-error.
                if available pt_mstr then do:
                   put stream batchdata unformatted '-'.
                end.
                else do:
                   put stream batchdata unformatted '"8888"'.
                end.
                put stream batchdata unformatted " - - - ".
