define variable v_cncu_batch        like    cncu_batch.
define variable v_cncu_eff_date     like    cncu_eff_date.
define variable v_cncu_shipto       like    cncu_shipto.
define variable v_shipto_name       like    ad_name.
define variable v_cncu_cust         like    cncu_cust.
define variable v_cust_name         like    ad_name.
       
define temp-table tmp_t
