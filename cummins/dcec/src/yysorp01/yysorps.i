...
/*cj*/    chExcelWorkbook:Worksheets(1):Cells(iLine,3) = soregion + "-" + socmtype .
      ...
      chExcelWorkbook:Worksheets(1):Cells(iLine,9) = string(socon).
      chExcelWorkbook:Worksheets(1):Cells(iLine,10) = soconloc.
...
/*-------------------------
      ...
      use-index so_cust:
        ...
        and sod_part >= part and sod_part <= part1
          ...
          chExcelWorkbook:Worksheets(1):Cells(iLine,9) = so_consignment.
          chExcelWorkbook:Worksheets(1):Cells(iLine,10) = so_consign_loc.
