...
/* *SS-20120927.1*        sodstdcost @ sod_det.sod_std_cost  */
...
/*GUI*/ if global-beam-me-up then undo, leave.
      ...
      set
         sod_det.sod_loc
/* *SS-20120927.1*           sod_det.sod_std_cost    when (not available pt_mstr)  */
         sod_det.sod_serial
 ...
 */
 /* *SS-20120927.1*      {gprun.i ""yygpfrlwt.p""   */        
             /*tfq*/   {gprun.i ""gpfrlwt.p""
                  "(input so_curr,
                    ...
                    input sod_det.sod_fr_list, input sod_det.sod_part,
                    input detqty, input sod_det.sod_site,
                    input sod_det.sod_type, input sod_det.sod_um,
                    input calc_fr,
                    input disp_fr,
                    input sod_det.sod_nbr,
                    input sod_det.sod_line,
