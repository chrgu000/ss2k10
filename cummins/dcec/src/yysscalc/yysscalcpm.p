/* GUI CONVERTED from xxsscalpm.p (converter v1.78) Thu Nov  8 15:26:41 2012 */
...
FORM /*GUI*/
 ...
 SKIP(.1)  /*GUI*/
   usrw_key2 colon 25 format "x(28)" label "Key" skip(1)
   usrw_intfld[1] colon 25 label "Month"
