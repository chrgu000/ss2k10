...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brMain cWin _STRUCTURED
  QUERY brMain NO-LOCK DISPLAY
      tr_hist.tr_site FORMAT "x(8)":U WIDTH 4.33
      tr_hist.tr_trnbr FORMAT ">>>>>>>>":U
      tr_hist.tr_type FORMAT "x(8)":U WIDTH 4.78
      tr_hist.tr_nbr FORMAT "x(18)":U WIDTH 5.56
      tr_hist.tr_line FORMAT ">>>>9":U
      tr_hist.tr_ship_id COLUMN-LABEL "Ship NO" FORMAT "x(20)":U
            WIDTH 7.11
      tr_hist.tr_rmks FORMAT "x(10)":U WIDTH 5.56
      tr_hist.tr_lot FORMAT "x(8)":U WIDTH 4.56
      tr_hist.tr_ref FORMAT "x(8)":U WIDTH 5.56
      tr_hist.tr_loc COLUMN-LABEL "Loc" FORMAT "x(8)":U WIDTH 3.56
      tr_hist.tr_date FORMAT "99/99/99":U WIDTH 6.56
      STRING (tr_hist.tr_time,"hh:mm:ss") COLUMN-LABEL "Time" WIDTH 6.56
      tr_hist.tr_effdate FORMAT "99/99/99":U WIDTH 6.56
      tr_hist.tr_part FORMAT "x(15)":U WIDTH 8.11
      tr_hist.tr_um FORMAT "x(2)":U WIDTH 2.56
      tr_hist.tr_addr FORMAT "x(8)":U WIDTH 8.56
      tr_hist.tr_qty_chg FORMAT "->,>>>,>>9.9<<<<<<<<":U
      tr_hist.tr_qty_loc FORMAT "->,>>>,>>9.9<<<<<<<<":U
      tr_hist.tr_qty_req FORMAT "->,>>>,>>9.9<<<<<<<<":U
      tr_hist.tr_qty_short FORMAT "->,>>>,>>9.9<<<<<<<<":U WIDTH 7.56
      tr_hist.tr_begin_qoh FORMAT "->,>>>,>>9.9<<<<<<<<":U
      tr_hist.tr_loc_begin FORMAT "->,>>>,>>9.9<<<<<<<<":U
      tr_hist.tr_status FORMAT "x(8)":U
      tr_hist.tr_serial FORMAT "x(18)":U WIDTH 4.78
      ...
      tr_hist.tr_price FORMAT "->>>,>>>,>>9.99<<<":U WIDTH 6.33
      tr_hist.tr_cprice COLUMN-LABEL "CPrice" FORMAT ">>>>,>>>,>>9.99<<<":U
            WIDTH 6.11
      tr_hist.tr_gl_amt FORMAT "->>>>>,>>9.99":U WIDTH 7.33
      tr_hist.tr_mtl_std FORMAT "->>>,>>>,>>9.99<<<":U WIDTH 7.11
      tr_hist.tr_bdn_std FORMAT "->>>,>>>,>>9.99<<<":U WIDTH 7
      tr_hist.tr_lbr_std FORMAT "->>>,>>>,>>9.99<<<":U WIDTH 5.78
      tr_hist.tr_sub_std FORMAT "->>>,>>>,>>9.99<<<":U WIDTH 7.89
      tr_hist.tr_ovh_std FORMAT ">>>>,>>>,>>9.99<<<":U WIDTH 6.56
      ...
      tr_hist.tr_batch FORMAT "x(18)":U WIDTH 6.56
      ...
      tr_hist.tr_vend_date FORMAT "99/99/99":U WIDTH 6.67
      tr_hist.tr_vend_lot FORMAT "x(18)":U WIDTH 8.22
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 96.78 BY 17.68 ROW-HEIGHT-CHARS .79 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME fMain
     btQry AT ROW 1.27 COL 84
     fiSite AT ROW 1.36 COL 4.89 COLON-ALIGNED
     fiTrans AT ROW 1.36 COL 15.67 COLON-ALIGNED
     fiOrder AT ROW 1.36 COL 27.67 COLON-ALIGNED
     fiPart AT ROW 1.36 COL 41.22 COLON-ALIGNED
     filot AT ROW 1.36 COL 56.11 COLON-ALIGNED
     fiType AT ROW 1.36 COL 71 COLON-ALIGNED
     btPrint AT ROW 2.73 COL 84
     tgDate AT ROW 2.95 COL 2
     fiStart AT ROW 2.95 COL 6.22 COLON-ALIGNED
     fiEnd AT ROW 2.95 COL 17.56 COLON-ALIGNED
     fiShip AT ROW 2.95 COL 32 COLON-ALIGNED
     fiLoc AT ROW 2.95 COL 45 COLON-ALIGNED
     fiAddr AT ROW 2.95 COL 55.22 COLON-ALIGNED
     fiUser AT ROW 2.95 COL 67.56 COLON-ALIGNED
     btSum AT ROW 4.18 COL 84.11
     rdOrder AT ROW 4.27 COL 32 NO-LABEL
     tgEffDate AT ROW 4.32 COL 2
     fiEffStart AT ROW 4.32 COL 6.11 COLON-ALIGNED
     fiEffEnd AT ROW 4.32 COL 17.56 COLON-ALIGNED
     brMain AT ROW 5.68 COL 1.22
     "排序" VIEW-AS TEXT
          SIZE 3 BY .68 AT ROW 4.55 COL 28.67
...
"tr_hist.tr_site" ? ? "character" ? ? ? ? ? ? no ? no no "4.33" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = qaddb.tr_hist.tr_trnbr
     _FldNameList[3]   > qaddb.tr_hist.tr_type
"tr_hist.tr_type" ? ? "character" ? ? ? ? ? ? no ? no no "4.78" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > qaddb.tr_hist.tr_nbr
"tr_hist.tr_nbr" ? ? "character" ? ? ? ? ? ? no ? no no "5.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_ship_id" "Ship NO" ? "character" ? ? ? ? ? ? no ? no no "7.11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > qaddb.tr_hist.tr_rmks
"tr_hist.tr_rmks" ? ? "character" ? ? ? ? ? ? no ? no no "5.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > qaddb.tr_hist.tr_lot
"tr_hist.tr_lot" ? ? "character" ? ? ? ? ? ? no ? no no "4.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > qaddb.tr_hist.tr_ref
"tr_hist.tr_ref" ? ? "character" ? ? ? ? ? ? no ? no no "5.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > qaddb.tr_hist.tr_loc
"tr_hist.tr_loc" "Loc" ? "character" ? ? ? ? ? ? no ? no no "3.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > qaddb.tr_hist.tr_date
"tr_hist.tr_date" ? ? "date" ? ? ? ? ? ? no ? no no "6.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > "_<CALC>"
"STRING (tr_hist.tr_time,""hh:mm:ss"")" "Time" ? ? ? ? ? ? ? ? no ? no no "6.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > qaddb.tr_hist.tr_effdate
"tr_hist.tr_effdate" ? ? "date" ? ? ? ? ? ? no ? no no "6.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > qaddb.tr_hist.tr_part
"tr_hist.tr_part" ? "x(15)" "character" ? ? ? ? ? ? no ? no no "8.11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > qaddb.tr_hist.tr_um
"tr_hist.tr_um" ? ? "character" ? ? ? ? ? ? no ? no no "2.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > qaddb.tr_hist.tr_addr
"tr_hist.tr_addr" ? ? "character" ? ? ? ? ? ? no ? no no "8.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_qty_short" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_serial" ? ? "character" ? ? ? ? ? ? no ? no no "4.78" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_price" ? ? "decimal" ? ? ? ? ? ? no ? no no "6.33" no no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[33]   > qaddb.tr_hist.tr_cprice
"tr_hist.tr_cprice" "CPrice" ? "decimal" ? ? ? ? ? ? no ? no no "6.11" no no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[34]   > qaddb.tr_hist.tr_gl_amt
"tr_hist.tr_gl_amt" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.33" no no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[35]   > qaddb.tr_hist.tr_mtl_std
"tr_hist.tr_mtl_std" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.11" no no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_lbr_std" ? ? "decimal" ? ? ? ? ? ? no ? no no "5.78" no no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[38]   > qaddb.tr_hist.tr_sub_std
"tr_hist.tr_sub_std" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.89" no no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[39]   > qaddb.tr_hist.tr_ovh_std
"tr_hist.tr_ovh_std" ? ? "decimal" ? ? ? ? ? ? no ? no no "6.56" no no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_batch" ? ? "character" ? ? ? ? ? ? no ? no no "6.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_vend_date" ? ? "date" ? ? ? ? ? ? no ? no no "6.67" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[52]   > qaddb.tr_hist.tr_vend_lot
"tr_hist.tr_vend_lot" ? ? "character" ? ? ? ? ? ? no ? no no "8.22" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_xslspsn2" "Xalespsn2" ? "character" ? ? ? ? ? ? no ? no no "6.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_slspsn[2]" "Salespsn[2]" ? "character" ? ? ? ? ? ? no ? no no "6.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[59]   > qaddb.tr_hist.tr_slspsn[3]
"tr_hist.tr_slspsn[3]" "Salespsn[3]" ? "character" ? ? ? ? ? ? no ? no no "6.89" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[60]   > qaddb.tr_hist.tr_slspsn[4]
"tr_hist.tr_slspsn[4]" "Salespsn[4]" ? "character" ? ? ? ? ? ? no ? no no "6.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[61]   > qaddb.tr_hist.tr_xcr_acct
"tr_hist.tr_xcr_acct" "Cr Acct" ? "character" ? ? ? ? ? ? no ? no no "6.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_xcr_proj" "Cr Project" ? "character" ? ? ? ? ? ? no ? no no "7.11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[64]   > qaddb.tr_hist.tr_xdr_acct
"tr_hist.tr_xdr_acct" "Dr Acct" ? "character" ? ? ? ? ? ? no ? no no "7.56" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"tr_hist.tr_xdr_proj" "Dr Project" ? "character" ? ? ? ? ? ? no ? no no "7.11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL brMain cWin
ON LEFT-MOUSE-DBLCLICK OF brMain IN FRAME fMain
DO:
    ...
    OPEN QUERY querybrowse1 FOR EACH tr_hist no-lock.
    DO ibrowse = 1 TO  brMain:NUM-SELECTED-ROWS IN FRAME fmain :
        method-return = brMain:FETCH-SELECTED-ROW(ibrowse).
        ASSIGN trnbr = tr_trnbr.
    END.
    FOR EACH tr_hist NO-LOCK WHERE tr_domain = GLOBAL_domain 
         AND tr_trnbr = trnbr WITH FRAM ss:
        DISPLAY tr_hist  WITH 4 COLUMNS VIEW-AS DIALOG-BOX WITH WIDTH 130 STREAM-IO.
        COLOR DISPLAY INPUT tr_trnbr tr_type tr_part tr_nbr tr_so_job tr_rmks.
        COLOR DISPLAY MESSAGE tr_site tr_loc tr_lot tr_ref tr_qty_loc tr_qty_chg.
        pause 100.
    END. 
END.
...
/*    OUTPUT TO VALUE(myFile).                         */
  ...
  hQuery:GET-FIRST().
      hExcel:Worksheets("Sheet1"):Cells(1,1) = "记录号".
      hExcel:Worksheets("Sheet1"):Cells(1,2) = "料号".
      hExcel:Worksheets("Sheet1"):Cells(1,3) = "地点".
      hExcel:Worksheets("Sheet1"):Cells(1,4) = "库位".
      hExcel:Worksheets("Sheet1"):Cells(1,5) = "批/序".
      hExcel:Worksheets("Sheet1"):Cells(1,6) = "单号".
      hExcel:Worksheets("Sheet1"):Cells(1,7) = "客户单/工作".
      hExcel:Worksheets("Sheet1"):Cells(1,8) = "数量".
      hExcel:Worksheets("Sheet1"):Cells(1,9) = "交易类型".
      hExcel:Worksheets("Sheet1"):Cells(1,10) = "料号说明".
      hExcel:Worksheets("Sheet1"):Cells(1,11) = "项次".
      hExcel:Worksheets("Sheet1"):Cells(1,12) = "日期".
      hExcel:Worksheets("Sheet1"):Cells(1,13) = "生效日期".
      hExcel:Worksheets("Sheet1"):Cells(1,14) = "厂商/客户".
      hExcel:Worksheets("Sheet1"):Cells(1,15) = "备注".
      hExcel:Worksheets("Sheet1"):Cells(1,16) = "用户ID".
      hExcel:Worksheets("Sheet1"):Cells(1,17) = "用户".
  ...
  REPEAT:
      ...
      IF AVAIL usr_mstr THEN
       ...
       hExcel:Worksheets("Sheet1"):Cells(i,1) = "'" + string(tr_trnbr).
       hExcel:Worksheets("Sheet1"):Cells(i,2) = "'" + tr_part.
       hExcel:Worksheets("Sheet1"):Cells(i,3) = "'" +  tr_site .
       hExcel:Worksheets("Sheet1"):Cells(i,4) = "'" +  tr_LOC .
       hExcel:Worksheets("Sheet1"):Cells(i,5) = "'" +  tr_serial .
       hExcel:Worksheets("Sheet1"):Cells(i,6) = "'" +  tr_nbr.
       hExcel:Worksheets("Sheet1"):Cells(i,7) = "'" +  tr_so_job.
       hExcel:Worksheets("Sheet1"):Cells(i,8) = tr_qty_loc .
       hExcel:Worksheets("Sheet1"):Cells(i,9) = "'" +  tr_type.
       hExcel:Worksheets("Sheet1"):Cells(i,10) = "'" + desc1.
       hExcel:Worksheets("Sheet1"):Cells(i,11) = tr_line .
       hExcel:Worksheets("Sheet1"):Cells(i,12) = "'" + string(tr_date).
       hExcel:Worksheets("Sheet1"):Cells(i,13) = "'" + string(tr_effdate).
       hExcel:Worksheets("Sheet1"):Cells(i,14) = "'" + tr_addr .
       hExcel:Worksheets("Sheet1"):Cells(i,15) = "'" + tr_rmks .
       hExcel:Worksheets("Sheet1"):Cells(i,16) = "'" + tr_userid.
       hExcel:Worksheets("Sheet1"):Cells(i,17) = "'" + username .
...
DO:
  ...
  hQuery = brMain:QUERY.
  if fiTrans <> "" then do:
     Sqlstr = 'FOR EACH qaddb.tr_hist no-lock WHERE tr_domain = "' + global_domain + '" and tr_trnbr = integer("' + fiTrans + '")'. 
  end.
  else do:
