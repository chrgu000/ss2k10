...
*************************************************************************/
    ...
    for each yyinvo_mstr no-lock where /*ss2012-8-16 b*/ yyinvo_domain = global_domain and /*ss2012-8-16 e*/
                 yyinvo_part >= part and yyinvo_part <= part1
	...
	create tttt.
	   ...
	   tttt_qty = yyinvo_qty.
	for first pt_mstr where /*ss2012-8-16 b*/ pt_domain = global_domain and /*ss2012-8-16 e*/ pt_part = yyinvo_part no-lock:
		assign tttt_pl = yyinvo_part_pl
		       tttt_desc1 = pt_desc1
		       tttt_desc2 = pt_desc2.
	end.
	for first yyvarated_det where /*ss2012-8-16 b*/ yyvarated_domain = global_domain and /*ss2012-8-16 e*/ yyvarated_year = iyear
