...
/* LAST MODIFIED: 10/13/2009     BY: Leo Zhou          *CLZ*/
...
/*GUI*/ RECT-FRAME:HEIGHT-PIXELS in frame a = FRAME a:HEIGHT-PIXELS - RECT-FRAME:Y in frame a - 2.
    ...
    FOR EACH wo_mstr NO-LOCK
        ...
        AND  (wo_type = "C" or wo_type = "E")   /*CLZ*/
        AND   wo_status = "C"
...
PROCEDURE xxpro-chk-exist:
    ...
    p_results = "".
    FIND LAST xxwobmvm_mstr WHERE xxwobmvm_domain = global_domain and xxwobmvm_woid = p_woid NO-LOCK NO-ERROR.
...
PROCEDURE xxpro-cal-del:
    ...
    FOR EACH xxwobmvm_mstr WHERE xxwobmvm_domain = global_domain and xxwobmvm_woid = wo_lot:
        DELETE xxwobmvm_mstr.
    END.
    FOR EACH xxwobmvd_det WHERE xxwobmvd_domain = global_domain and xxwobmvd_woid = wo_lot:
        DELETE xxwobmvd_det.
    END.
    FOR EACH xxwobmvr_det WHERE xxwobmvr_domain = global_domain and xxwobmvr_woid = wo_lot:
        DELETE xxwobmvr_det.
    END.
END PROCEDURE.
...
PROCEDURE xxpro-cal-cwoh:
    ...
    FIND FIRST wo_mstr WHERE recid(wo_mstr) = p_recid NO-LOCK NO-ERROR.
    IF NOT AVAILABLE wo_mstr THEN LEAVE.
    FIND FIRST xxwobmvm_mstr WHERE xxwobmvm_domain = global_domain and xxwobmvm_woid = wo_lot NO-ERROR.
    IF NOT AVAILABLE xxwobmvm_mstr THEN DO:
        CREATE xxwobmvm_mstr. xxwobmvm_domain = global_domain.
...
PROCEDURE xxpro-cal-cwor:
    ...
    /*new logical*/
    FOR EACH xxtr_hist WHERE xxtr_domain = global_domain and xxtr_key1 = wo_lot NO-LOCK:
        FIND FIRST tr_hist WHERE tr_domain = global_domain and tr_trnbr = xxtr_trnbr NO-LOCK NO-ERROR.
        ...
        IF tr_type = "RCT-WO" AND tr_part = wo_part THEN DO:
            ...
            FIND FIRST xxwobmvr_det 
                WHERE xxwobmvr_domain = global_domain
                AND   xxwobmvr_woid = tr_lot
            ...
            IF NOT AVAILABLE xxwobmvr_det THEN DO:
                CREATE xxwobmvr_det. xxwobmvr_domain = global_domain.
            ...
            FOR EACH trgl_det NO-LOCK WHERE trgl_domain = global_domain and trgl_trnbr = tr_trnbr:
                IF trgl_type = "MTHD CHG" THEN DO:
                    /*xxwobmvm_var_det[6] = xxwobmvm_var_det[6] + trgl_gl_amt.*/
                    xxwobmvm_var_det[7] = xxwobmvm_var_det[7] + trgl_gl_amt. /*james20070720*/
                END.
            END.
        END.
...
PROCEDURE xxpro-cal-cwod:
    ...
    FIND FIRST wo_mstr WHERE recid(wo_mstr) = p_recid NO-LOCK NO-ERROR.
    IF NOT AVAILABLE wo_mstr THEN LEAVE.
    FIND FIRST xxwobmvm_mstr WHERE xxwobmvm_domain = global_domain 
    			 AND xxwobmvm_woid = wo_lot NO-ERROR.
    IF NOT AVAILABLE xxwobmvm_mstr THEN LEAVE.
    FIND LAST xxwobmfm_mstr WHERE xxwobmfm_domain = global_domain 
    		AND xxwobmfm_part = xxwobmvm_part
    ...
    FOR EACH wod_det NO-LOCK 
        WHERE wo_domain = global_domain and wod_lot = wo_lot:
        FIND FIRST xxwobmvd_det 
            WHERE xxwobmvd_domain = global_domain 
            AND   xxwobmvd_woid = wod_lot
    ...
    FOR EACH xxwobmvd_det WHERE xxwobmvd_domain = global_domain and xxwobmvd_woid = wo_lot:
        ...
        /*james*20070720*beg*/ /*sometime system error casue wo close create mmv-x to consume mvuse*/
        IF (xxwobmvd_act_qty - xxwobmvd_cwo_qty) * xxwobmvd_cwo_cost <> xxwobmvd_var_det[1] THEN DO:
            ASSIGN xxwobmvd_var_det[5] = - xxwobmvd_var_det[1] + (xxwobmvd_act_qty - xxwobmvd_cwo_qty) * xxwobmvd_cwo_cost.
        END.
        /*james*20070720*end*/
        ...
        /*james*20070720*/ xxwobmvd_var_tot = xxwobmvd_var_tot + xxwobmvd_var_det[5].
        /*james*20070720*/ ASSIGN xxwobmvm_var_det[6] = xxwobmvm_var_det[6] + xxwobmvd_var_det[5].

    END.
    /*header variance*/
    /*ASSIGN xxwobmvm_var_det[5] = xxwobmvm_var_det[6] - xxwobmvm_var_det[3] - xxwobmvm_var_det[4].*/
    /*james*20070720*/ ASSIGN xxwobmvm_var_det[5] = xxwobmvm_var_det[7] - xxwobmvm_var_det[3] - xxwobmvm_var_det[4] + xxwobmvm_var_det[6].
