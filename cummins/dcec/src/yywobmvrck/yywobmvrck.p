...
/*GUI*/ RECT-FRAME:HEIGHT-PIXELS in frame a = FRAME a:HEIGHT-PIXELS - RECT-FRAME:Y in frame a - 2.
    ...
    FOR EACH wo_mstr NO-LOCK
        WHERE  /* *SS-20120816.1*   */ wo_mstr.wo_domain = global_domain and 
	wo_type = "C"
        /*AND   wo_status = "C"*/
        ...
        END.
        ELSE DO:
            FIND FIRST xxwobmvm_mstr WHERE /* *SS-20120816.1*   */ xxwobmvm_mstr.xxwobmvm_domain = global_domain and xxwobmvm_woid = wo_lot NO-LOCK NO-ERROR.
