...
/*J240**     find ac_mstr where ac_domain = global_domain and 
									ac_code = asc_acc no-lock no-error. **/
            for first ac_mstr fields (ac_domain ac_code ac_curr ac_type ac_active ac_desc)
/*J240*/            no-lock where ac_domain = global_domain and ac_code = asc_acc: end.
 ...
 ** END DELETE   **                                      **M0D6*/
          ...
          fm268 */
            ...
            /* fm268  DISPLAY
                   ...
                   d_act
                   d_end
                with frame pdetail.  fm268 期初 活动 期末 fm268*/
