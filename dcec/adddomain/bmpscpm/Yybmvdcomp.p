...
/*added by kevin, 11/12/2003*/
               if can-find (first ps_mstr where ps_par = part1 and ps__chr01 <> input site1) 
               then do:
...
/*added by kevin, 10/22/2003 - for copy ps by selection*/
        ...
        {gprun.i ""yybmpkiqa.p"" "(input part1,
            ...
            find xxptmp_mstr where xxptmp_par = part1 and xxptmp_comp = pkpart
            ...
            for each xxptmp_mstr  where xxptmp_par = part1 and xxptmp_site = site1:
...
/************tfq added end*************************************/
 ...
 /*added by kevin, 10/23/2003*/
          ...
          for each pkdet no-lock : 
          find first xxptmp_mstr where xxptmp_par = part1 and xxptmp_site = site1 and xxptmp_comp = pkpart  no-lock no-error .
