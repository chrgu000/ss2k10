...
repeat:
    ...
    FOR EACH vd_mstr NO-LOCK WHERE /* *SS-20120815.1*   */ vd_mstr.vd_domain = global_domain and vd_addr >= vd AND vd_addr <= vd1 :
    ...
    /*GUI*/ {mfguichk.i } /*Replace mfrpchk*/
            ...
            IF ap_type = "CK" THEN DO :
                FIND FIRST ckd_det NO-LOCK WHERE /* *SS-20120815.1*  */ ckd_det.ckd_domain = global_domain and ckd_ref = ap_ref AND (ckd_acct = "6666666" OR ckd_acct = "9999999") NO-ERROR .
