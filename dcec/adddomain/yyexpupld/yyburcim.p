...
rok1 = NO .
FIND FIRST gl_ctrl  /* *SS-20121009.1* */ where gl_ctrl.gl_domain = global_domain NO-LOCK NO-ERROR .
curr = gl_base_curr .
...
rok2 = YES .
FIND FIRST CODE_mstr NO-LOCK WHERE /* *SS-20121009.1* */ CODE_mstr.code_domain = global_domain and  CODE_fldname = "allbur" NO-ERROR .
IF NOT AVAILABLE CODE_mstr THEN rok2 = NO .
ELSE DO :
    FIND ac_mstr NO-LOCK WHERE /* *SS-20121009.1* */ ac_mstr.ac_domain = global_domain and  ac_code = CODE_value NO-ERROR .
    IF NOT AVAILABLE ac_mstr THEN rok2 = NO .
    FIND cc_mstr NO-LOCK WHERE /* *SS-20121009.1* */ cc_mstr.cc_domain = global_domain and cc_ctr = CODE_cmmt
...
FOR EACH data NO-LOCK BREAK BY data_sub BY data_cc :
    IF FIRST-OF(data_cc) THEN DO :
        ...
        FIND CODE_mstr NO-LOCK WHERE /* *SS-20121009.1* */ CODE_mstr.code_domain = global_domain and CODE_fldname = codecc
