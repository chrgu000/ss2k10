...
/****************tfq added end*******************/ 
   ...
   repeat on endkey undo mainloop, retry mainloop:
      ...
      /* tfq added begin in 2005/06/20 ****/
		  ...
		  dr_acct = entry(1,code_cmmt,',').
		  cr_acct = entry(1,code_cmmt,',').
		  dr_sub  = entry(2,code_cmmt,',').
		  cr_sub  = entry(2,code_cmmt,',').
		  dr_cc   = entry(3,code_cmmt,',').
		  cr_cc   = entry(3,code_cmmt,',').
		  dr_proj = entry(4,code_cmmt,',').
		  cr_proj = entry(4,code_cmmt,',').
