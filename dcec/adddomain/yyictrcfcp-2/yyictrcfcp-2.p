  ...
  *****************************/
    ...
    for
       /* each tmp_site no-lock, */
        each in_mstr fields(in_domain in_site in_gl_set in_part in_qty_oh in__qadc01 in_qty_nonet in_user1 in_gl_cost_site in_cur_set) USE-INDEX in_site where /*(in_site >= site and in_site <= site1) and*/
        ...
        each pt_mstr fields(pt_part pt_part pt_prod_line pt_abc pt_part_type pt_group pt_desc1 pt_desc2) USE-INDEX pt_part where pt_part = in_part and
