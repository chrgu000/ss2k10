/* GUI CONVERTED from solinfrm.i (converter v1.78) Fri Nov 26 03:02:53 2004 */
...
desc1           colon  5    label {&solinfrm_i_17} format "x(24)"
        view-as fill-in size 22 by 1 space(.5)   
   sod_acct        colon 42
   ...
   sod_dsc_project             no-label
        view-as fill-in size 9 by 1 space(.5)   
   /*ROW 3  ============================================================= */
/* *SS-20120927.1*      base_curr       at 4        no-label no-attr-space
