/* GUI CONVERTED from sosomt1.p (converter v1.78) Wed Jan 13 15:46:23 2010 */
...
do:
 ...
 /* *SS-20120927.1*           {sosomt02.i}  /* FORM DEFINITIONS FOR SHARED FRAMES A AND B */  */
 /* *SS-20120927.1*     */  /*tfq*/    {yysosomt02.i}  /* FORM DEFINITIONS FOR SHARED FRAMES A AND B */  
 ...
 /* *SS-20120927.1*             {gprun.i ""sosomta1.p""   */  
 /* *SS-20120927.1*   */           {gprun.i ""yysosomta1.p""    
            "(input this-is-rma,
              output return_int,
              output rma-recno)"}
...
/* *SS-20120927.1*           {gprun.i ""sosomtc.p"" "(input this-is-rma)"}  */
/* *SS-20120927.1*  */ /*tfq*/  {gprun.i ""yysosomtc.p"" "(input this-is-rma)"}
