/* GUI CONVERTED from sosomta1.p (converter v1.78) Tue Dec 14 00:50:49 2010 */
...
/* Revision: 1.71.1.14   BY: Deepa Mathew         DATE: 08/12/08  ECO: *P6Z3* */
/* Revision: 1.71.1.15   BY: Archana Kirtane      DATE: 05/13/09  ECO: *Q2VW* */
...
/* *SS-20120927.1*   {sosomt02.i}  */ 
/* *SS-20120927.1*  */ {yysosomt02.i}   
...
/*GUI*/ RECT-FRAME-LABEL:SCREEN-VALUE in frame b = F-b-title.
    ...
    /*tfq*/	if so_userid <> global_userid then do:
    /*tfq*/		message "您不是该订单的创建者，不能维护该订单！" view-as alert-box.
    /*tfq*/		next-prompt frame a so_nbr.
    /*tfq*/		undo, retry.
    /*tfq*/	end.
...
/* *SS-20120927.1*  */  /*tfq*/	sotrcust = so_cust.  
