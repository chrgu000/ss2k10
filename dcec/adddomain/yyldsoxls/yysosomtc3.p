/* GUI CONVERTED from sosomtc3.p (converter v1.78) Mon Sep 22 15:06:32 2008 */
...
/*GUI*/ if global-beam-me-up then undo, leave.
   ...
   undo_trl2 = true.
/* *SS-20120927.1*     {gprun.i ""sosotrle.p""}  */ 
/* *SS-20120927.1*  */   /*tfq*/ {gprun.i ""yysosotrle.p""}
/*GUI*/ if global-beam-me-up then undo, leave.
 ...
 *      THE SALES ORDER WAS ORIGINALLY A CREDIT.                    */
   ...
   /* When qty type = amount, show the message */
   for each pih_hist where pih_domain = global_domain
      and pih_doc_type = 1
      and pih_nbr      = so_nbr
      and pih_qty_type = "2"
   no-lock:
...
/*GUI*/ if global-beam-me-up then undo, leave.
   ...
   for first mfc_ctrl
   fields( mfc_domain mfc_decimal mfc_field)
...
/*GUI*/ if global-beam-me-up then undo, leave.
   ...
   if so_stat = "" then do:
/* *SS-20120927.1*  */ 
 /* *SS-20120927.1*       base_amt = ord_amt. */
