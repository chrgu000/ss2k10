/* GUI CONVERTED from sosomtp.p (converter v1.78) Fri Apr 13 04:21:13 2012 */
...
/* Revision: 1.61.1.5 BY: Naseem Torgal           DATE: 04/03/07  ECO: *Q13J* */
/* Revision: 1.61.1.6 BY: Dilip Manawat           DATE: 07/24/08  ECO: *P6XN* */
/* Revision: 1.61.1.9 BY: Ajit Philip             DATE: 07/25/08  ECO: *Q1Q3* */
/* Revision: 1.61.1.11   BY: Chi Liu              DATE: 02/20/09  ECO: *Q28Z* */
/* Revision: 1.61.1.13   BY: Prajakta Patil.      DATE: 04/08/09  ECO: *Q2PR* */
/* Revision: 1.61.1.16   BY: Prabu M              DATE: 07/15/09  ECO: *Q352* */
/* Revision: 1.61.1.17   BY: Mukesh Singh         DATE: 04/16/10  ECO: *Q40R* */
/* Revision: 1.61.1.18   BY: Trupti Khairnar      DATE: 07/16/10  ECO: *Q482* */
...
/* *SS-20120927.1*   {sosomt02.i}  /* Form definitions for shared frames a & b */ */
/* *SS-20120927.1*  */  /*tfq*/  {yysosomt02.i}
/*V8+*/
      ...
      if frame-field = "so_po" then do:
         ...
         then do:
            ...
            then do:
               ...
               if not batchrun and not {gpiswrap.i}
               then
                  pause.
      ...
      then do:
         ...
         no-lock:
            ...
            if available si_mstr
               and si_db <> global_db
            then do:
               {gprun.i ""gpmdas.p"" "(input si_db, output l_err_flag)"}
/*GUI*/ if global-beam-me-up then undo, leave.
...
/* *SS-20120927.1* -b */
   ...
   /*lb01---*/
		if new so_mstr then do:
			...
			find first code_mstr no-lock where code_mstr.code_domain = global_domain and code_fldname = "zz-soslspsn-ctrl"
