...
/*GUI*/ if global-beam-me-up then undo, leave.
    ...
    /*  {gprun.i ""poporca3.p""}*/   /*judy change default loc to in_user1*/
      {gprun.i ""yypoporca3.p""}
/*GUI*/ if global-beam-me-up then undo, leave.
...
/*GUI*/ if global-beam-me-up then undo, leave.
 ...
 /*S777* added  07/02/28 */
               FOR FIRST IN_mstr fields(in_part in_site in_abc) 
                   WHERE IN_part = pt_part AND IN_site = pod_site NO-LOCK:
               END.
               IF ((NOT AVAILABLE IN_mstr) OR in_abc = "") THEN DO:
                  MESSAGE "产品ABC分类为空" VIEW-AS ALERT-BOX BUTTONS OK.
                  UNDO locloop, RETRY.
               END.
