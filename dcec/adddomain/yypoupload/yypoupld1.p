...
find in_mstr where in_domain = global_domain and in_site = xxsite and in_part = xxpart no-lock no-error.
    ...
    /*LB01*/               end. 
     ...
     do:
        ...
        errmsg = "供应商不存在" .
          ...
          do:
                 find first exr_rate where exr_domain = global_domain and (today >= exr_start_date and today <= exr_end_date) and
                 ...
                 find first isd_det where isd_domain = global_domain and isd_status = pt_status and (isd_tr_type = "add-po"
