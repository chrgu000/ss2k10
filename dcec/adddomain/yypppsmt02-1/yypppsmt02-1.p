/* GUI CONVERTED from pppsmt02.p (converter v1.78) Mon Nov 28 05:10:44 2011 */
...
/* Revision: 1.22.2.18.2.16  BY:Tushar Shetty    DATE: 06/28/11  ECO: *Q4VY* */
/* $Revision: 1.22.2.18.2.17 $ BY: Ambrose A       DATE: 11/25/11  ECO: *Q54Q* */
            ...
            then do:
               {pxrun.i &PROC    = 'validateBomFormulaId' &PROGRAM = 'ppitxr.p'
                  &PARAM   = "(input ptp_part,
                               input ptp_bom_code,
                               input ptp_bom_codesv,
                               input ptp_pm_code,
                               input ptp_pm_codesv,
                               input ptp_network,
                               input ptp_networksv,
                               input ptp_joint_type)"
                  &NOAPPERROR = true
                  &CATCHERROR = true}
