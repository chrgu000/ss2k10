    ...
    update site part with frame a editing:
        if frame-field = "site" then do:
            ...
            apply lastkey.
                 ...
                 find si_mstr no-lock where /*ss2012-8-17 b*/ si_domain = global_domain and /*ss2012-8-17 e*/ si_site = site no-error.
...
/*J034*/          end.
     ...
     find pt_mstr where /*ss2012-8-17 b*/ pt_domain = global_domain and /*ss2012-8-17 e*/ pt_part = part  no-lock no-error.
...
/*GUI*/ if global-beam-me-up then undo, leave.
  ...
  do on error undo, retry:
     ...
     prompt-for xxptmp_comp with frame b editing:
        ...
        if recno <> ? then do:
            find pt_mstr where /*ss2012-8-17 b*/ pt_domain = global_domain and /*ss2012-8-17 e*/ pt_part = xxptmp_comp no-lock no-error.
            if available pt_mstr then do:
                compdesc1 = pt_desc1.
                compdesc2 = pt_desc2.
            end.
            find ad_mstr where /*ss2012-8-17 b*/ ad_domain = global_domain and /*ss2012-8-17 e*/ /*ad_type = "supplier" and*/ ad_addr = xxptmp_vend
								no-lock no-error.
            if available ad_mstr then vendname = ad_name.
            find ad_mstr where /*ss2012-8-17 b*/ ad_domain = global_domain and /*ss2012-8-17 e*/ /*ad_type = "customer" and*/ ad_addr = xxptmp_cust
							no-lock no-error.
     ...
     find pt_mstr where /*ss2012-8-17 b*/ pt_domain = global_domain and /*ss2012-8-17 e*/ pt_part = input xxptmp_comp  no-lock no-error.
     if not available pt_mstr then do:
        /*tfq {mfmsg.i 16 3}*/
         {pxmsg.i
               &MSGNUM=16
 ...
 /*tfq added begin for bom validation****/
    ...
    /*tfq added end for bom validation****/
     ...
     find first xxptmp_mstr where  /*ss2012-8-17 b*/ xxptmp_domain = global_domain and /*ss2012-8-17 e*/
     ...
     find ad_mstr where /*ss2012-8-17 b*/ ad_domain = global_domain and /*ss2012-8-17 e*/ /*ad_type = "supplier" and*/ ad_addr = xxptmp_vend
					no-lock no-error.
     if available ad_mstr then vendname = ad_name.
     find ad_mstr where /*ss2012-8-17 e*/ ad_domain = global_domain and /*ss2012-8-17 e*/ /*ad_type = "customer" and*/ ad_addr = xxptmp_cust
				no-lock no-error.
     if available ad_mstr then custname = ad_name.
     ...
     /*tfq  added for vendor validation*/
      xxptmp_vend validate(can-find(first ad_mstr where /*ss2012-8-17 b*/ ad_domain = global_domain and /*ss2012-8-17 e*/ ad_addr = input xxptmp_vend and ad_coc_reg <> "x" 
