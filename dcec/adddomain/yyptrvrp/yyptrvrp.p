...
{mfphead.i}
 ...
 FOR EACH tr_hist
     WHERE  /* *SS-20120815.1*   */ tr_hist.tr_domain = global_domain and  tr_type = "CST-ADJ" AND tr_effdate >= effdate AND tr_effdate <= effdate1 NO-LOCK,
     FIRST trgl_det FIELDS(trgl_trnbr trgl_dr_acct trgl_cr_acct trgl_gl_ref)
     WHERE /* *SS-20120815.1*   */ trgl_det.trgl_domain = global_domain and trgl_trnbr = tr_trnbr AND 
