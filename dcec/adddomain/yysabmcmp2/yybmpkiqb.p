...
/*H100*/    and ((op = pkop) or (op = 0))) :
		...
		/*ss-20120904-cosesa*/
                find first ps_mstr where ps_mstr.ps_domain = global_domain and ps_par = pkpart no-lock no-error .
	...
	/*ss-20120904-cosesa*/
        find first pt_mstr where pt_mstr.pt_domain = global_domain and pt_part = pkpart no-lock no-error .
