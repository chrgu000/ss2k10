...
repeat:
	...
	find first glc_cal where /*ss2012-8-16 b*/ glc_domain = global_domain and /*ss2012-8-16 e*/
	                         glc_year = v_year and glc_per = v_period 
				 no-lock no-error.
	...
	v_line = 0.
	if v_update then do:
		for each yycsvar_mstr where /*ss2012-8-16 b*/ yycsvar_domain = global_domain and /*ss2012-8-16 e*/
		        yycsvar_part = v_part
			and yycsvar_year = v_year
			and yycsvar_per = v_period:
			assign yycsvar_variance[23] = 0.
		end.
		for each yyinvi_mstr where /*ss2012-8-16 b*/ yyinvi_domain = global_domain and /*ss2012-8-16 e*/
		        yyinvi_year = v_year
	...
	repeat:
		...
		find first pt_mstr where /*ss2012-8-16 b*/ pt_domain = global_domain and /*ss2012-8-16 e*/ pt_part = v_part no-lock no-error.
		create td.
		...
		if v_update then do:
			find first yycsvar_mstr where /*ss2012-8-16 b*/ yycsvar_domain = global_domain and /*ss2012-8-16 e*/
			         yycsvar_part = v_part
				and yycsvar_year = v_year
			...
			find first yyinvi_mstr where /*ss2012-8-16 b*/ yyinvi_domain = global_domain and /*ss2012-8-16 e*/
			         yyinvi_year = v_year
				and yyinvi_per = v_period
