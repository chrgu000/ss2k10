...
define variable varacct1 like gltr_acc label "差异帐户".
...
so_var_wo = gltr_amt.
   ...
   for each pt_mstr where /* *SS-20120815.1* */ pt_mstr.pt_domain = global_domain and (pt_prod_line >= line and pt_prod_line <= line1)
