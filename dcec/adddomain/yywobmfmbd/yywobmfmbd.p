...
FORM
    ...
    SKIP
    v_line1 COLON 20
    v_line2 COLON 45 LABEL "To"
    SKIP
    v_type1 COLON 20
    v_type2 COLON 45 LABEL "To"
    SKIP
    v_group1 COLON 20
    v_group2 COLON 45 LABEL "To"
    SKIP
    v_date COLON 30
    SKIP
...
PROCEDURE xxpro-bud-ttx9:
    ...
    FOR EACH pt_mstr NO-LOCK 
        ...
        FIND FIRST IN_mstr WHERE in_domain = global_domain and
        					 IN_part = pt_part AND IN_site = v_site NO-LOCK NO-ERROR.
        IF NOT AVAILABLE IN_mstr THEN NEXT.
        FIND FIRST ptp_det WHERE ptp_domain = global_domain and
        					 ptp_part = pt_part AND ptp_site = v_site NO-LOCK NO-ERROR.
...
PROCEDURE xxpro-process:
	...
	{gprun.i ""yywobmspt.p"" "(INPUT ttx9_site,INPUT ttx9_part, INPUT ttx9_bomcode, INPUT v_date)"}
    END.
END PROCEDURE.
...
PROCEDURE xxpro-report:
    ...
    IF v_dispdet = YES THEN DO:
        ...
        FOR EACH ttx9 WHERE	ttx9_chk_cwo = NO AND ttx9_chk_bom = NO:
            FOR EACH xxwobmfm_mstr WHERE xxwobmfm_domain = global_domain
            		 AND xxwobmfm_part = ttx9_part AND xxwobmfm_site = ttx9_site 
            	   AND xxwobmfm_version = ttx9_version:
                DISP 
