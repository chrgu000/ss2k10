...
PROCEDURE xxpro-update:
    ...
    FIND FIRST usrw_wkfl WHERE  /* *SS-20120919.1*   */ usrw_wkfl.usrw_domain = global_domain and  usrw_key1 = "xxut2" AND usrw_key2 = inp_key NO-ERROR.
    IF NOT AVAILABLE usrw_wkfl THEN DO:
        CREATE usrw_wkfl.
        ASSIGN 
/* *SS-20120919.1*   */ usrw_wkfl.usrw_domain = global_domain	       
	       usrw_key1 = "xxut2" 
               usrw_key2 = inp_key.
    END.
