...
/* ********** End Translatable Strings Definitions ********* */
          ...
          define new shared variable ccflag like mfc_logical INIT YES
             label {&glabrp_p_7}  no-undo.
          define new shared variable subflag like mfc_logical INIT YES
...
/*J240*/      no-lock where en_domain = global_domain and en_entity = current_entity: end.
...
/*J240**       find glc_cal where glc_domain = global_domain and glc_year = yr and            **/
 ...
 * /*J240*/    no-lock where glc_domain = global_domain and glc_year = yr and glc_per = 1: end.
 *
...
*               find first glt_det where glt_domain = global_domain and
...
*J240**********************************************************************/
/*J240*/   if can-find (first glt_det where glt_domain = global_domain and
																	    glt_entity >= entity and
...
/*J240*/   then do:
           ...
           {gprun.i ""zzglabrpa.p""} /*fm268 2005-01-22*/
           {gprun.i ""zzdcectodfl.p""} /*fm268 2005-01-22*/
