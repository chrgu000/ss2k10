...
procedure CHECK_DATA:
        for each xxppif_log where xxppif_err = 99 and substr(xxppif__chr01,1,1) = "0":
        ...
        /*4.Cummins Item or Parent Item 12-23 */    
            ...
            if lookup(xxppif_tr_code,"PDIA,PDIC,SOIA,SOIC") > 0 then do:
               ...
               if avail pt_mstr and lookup(xxppif_tr_code,"PDIA,SOIA") > 0 then do:
        ...
        /*7.MRP Action Code 51 & PDIA PDIC*/
            if lookup(xxppif_tr_code,"PDIA,PDIC") > 0 then do:
            		...
            		find first code_mstr no-lock where code_fldname = "51" and code_value = strTmp use-index code_fldval no-error.
        ...
        /*8.Make/Buy 52 & PDIA PDIC*/
            if lookup(xxppif_tr_code,"PDIA,PDIC") > 0 then do:
            		...
            		find first code_mstr no-lock where code_fldname = "52" and code_value = strTmp use-index code_fldval no-error.
                   if available code_mstr then do:
...
***/
            ...
            do while lastkey >= 0 or lastkey = -2:
                ...
                find first xxppif_buff where xxppif_buff.xxppif_tr_id >= trid_begin
