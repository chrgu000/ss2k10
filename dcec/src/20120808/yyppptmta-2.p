...
/* REVISION: eb2+sp7  retrofit: 2005/06/23   BY:taofengqin *tfq*     */
{mfdeclre.i}
{gplabel.i} /* EXTERNAL LABEL INCLUDE */
/*tfq {cxcustom.i "PPPTMTA.P"} */
/*tfq {cxcustom.i "YYPPPTMTA.P"} */
...
setFrameLabels(frame a:handle).
 ...
 FORM  
  {ppptmta2.i}
with frame a1 
side-labels width 80 attr-space  /*GUI*/.
...
/*V8!       .
         ...
         if new_part then do:
            undo_all = yes.
    /*tfq        {gprun.i ""ppptmta1.p""} */
        /*tfq*/        {gprun.i ""yyppptmta1-2.p""}     
            if not regen_add
