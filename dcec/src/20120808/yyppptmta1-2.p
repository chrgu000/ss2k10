...
/* $Revision: 1.34.4.2 $      BY: Jyoti Thatte          DATE: 08/28/03   ECO: *P106*  */

/******************************************************************************//* All patch markers and commented out code have been removed from the source *//* code below. For all future modifications to this file, any code which is   *//* no longer required should be deleted and no in-line patch markers should   *//* be added.  The ECO marker should only be included in the Revision History. *//******************************************************************************/
...
/* REVISION:eb2+sp7 retrofit: 2005/06/23   BY: Tao fengqin      */
...
do transaction on endkey undo, leave:
   ...
   do on error undo, retry with frame a1:
     ...
     /*tfq    pt_prod_line    */
      ...
      /* READ THE PRODUCT LINE MASTER RECORD DEPENDING */
      /* UPON THE LOCK AND WAIT FLAG                   */
      {pxrun.i
         &PROC       = 'processRead'
         &PROGRAM    = 'ppprxr.p'
         &PARAM      = "(input  pt_prod_line,
      ...
      then do:
         ...
         /* 248 - pl_mstr RECORD BEING MODIFIED. PLEASE WAIT */
         {pxmsg.i &MSGNUM     = 248
