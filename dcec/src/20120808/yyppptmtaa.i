...
* Include file */
/* Revision: eb2+sp7  BY: tao fengqin retrofit  DATE: 2005/06/23 ECO: *tfq* */

/* Form Statement used with ppptmta.p. It includes the variable
* Batchdelete used to perform delete during CIM. */
/*tfq    {cxcustom.i "PPPTMTAA.I"} */
/*tfq */   {cxcustom.i "yyPPPTMTAA.I"}
{&PPPTMTAA-I-TAG1}
/*tfq pt_part        colon 18 */
/*tfq*/ pt_part        colon 16 format "x(16)"  
   ...
   pt_um          colon 18
   pt_desc2          at 54 no-label skip(.4)
   /*V8! view-as fill-in size 26 by 1 */
   {&PPPTMTAA-I-TAG2}
