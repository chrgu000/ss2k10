...
/*GL93*/ side-labels width 80 attr-space NO-BOX THREE-D /*GUI*/.
 ...
 F-b-title = getFrameTitle("ITEM_INVENTORY_DATA",28) /*tfq " 零件库存数据 "*/ .
...
/*GL93*/ side-labels width 80 attr-space NO-BOX THREE-D /*GUI*/.
 ...
 F-c-title = getFrameTitle("ITEM_PLANNING_DATA",26) /*tfq" 零件计划数据 "*/ .
         ...
         if recno <> ? then do:
            ...
            if ppform = "c" then do:
               ...
               display inmstr4.in_mrp when (available inmstr4) @
                  ...
                  pt_op_yield
                  pt_yield_pct
                  pt_run pt_setup /*roger*/ pt__dec01
                  btb-type
                  pt__qad15
                  pt_network
                  pt_routing
...
/*V8!       .
   ...
   /*tfq   {gprun.i ""ppptmtc.p""} */
   /*roger*/       {gprun.i ""yyptmtc.p""}
      if not regen_add
