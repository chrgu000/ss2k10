/* GUI CONVERTED from sosopk.p (converter v1.76) Wed May 22 11:23:38 2002 */
...
PROCEDURE p_packlist:
   ...
   if false then do:
  /*judy 07/07/05*/   /* {gprun.i ""sopk01.p""}*/
  /*judy 07/07/05*/    {gprun.i ""yysopk01.p""}
   end.

  /*judy 07/07/05*/   /*  {gprun.i """sopk"" + run_file + "".p""" "(input update_yn)"}  */
  /*judy 07/07/05*/     {gprun.i """yysopk"" + run_file + "".p""" "(input update_yn)"}  
