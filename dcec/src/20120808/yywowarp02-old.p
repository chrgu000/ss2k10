...
nbr            colon 15
	    ...
	    xxkeeper        colon 15 
	    xxkeeper1      label {t001.i} colon 49 skip (1)
...
/*GUI*/ procedure p-enable-ui:
	    ...
	    if xxkeeper1 = hi_char then xxkeeper1 = "".	 /*judy*/
        pageno = 1.	 
...
/*GUI*/ procedure p-report-quote:
	    ...
	    {mfquoter.i part   }
	    {mfquoter.i part1  }
	    {mfquoter.i xxkeeper  }  /*judy*/
	    {mfquoter.i xxkeeper1 }  /*judy*/
	    {mfquoter.i lot    }
...
procedure p-report: 
   {gpprtrpa.i  "printer" 132}
    ...
    and (wo_lot = lot or lot = "") :
  	   ...
  	   NO-LOCK /*,
     each in_mstr where in_site = wod_site and in_part = wod_part
	  and in__qadc01 >= xxkeeper and in__qadc01 <= xxkeeper1*/
	  break by wo_nbr by wod_lot by wod_part :	    
      IF xxkeeper <>  ""  OR  xxkeeper1 <> ""  THEN DO:
