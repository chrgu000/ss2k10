...
/*J1JQ /*J078*/   ptp_pm_code when (pt_pm_code <> "F") */                  
                  ...
                  ptp_mfg_lead ptp_pur_lead
                  ptp_ins_rqd ptp_ins_lead ptp_cum_lead
                  ptp_network
                  ptp_routing validate(input ptp_pm_code <> "m" or input ptp_routing <> "" or pt_group = "M","工艺流程代码不允许为空")
                  ptp_bom_code validate(input ptp_pm_code <> "m" or input ptp_bom_code <> "" or pt_group = "M","产品结构代码不允许为空")
/*F782            ptp_rev  */
                  ptp_iss_pol
                  ptp_phantom 
                  ptp_ord_min ptp_ord_max
