...
repeat:
  ...
  set parent1
	...
	chExcelWorkbook:Worksheets(1):Range("E2"):Comment:Text("QAD:" + chr(10) + desc1 + chr(10) + desc11).
	chExcelWorkbook:Worksheets(1):Range("F2"):AddComment.
	chExcelWorkbook:Worksheets(1):Range("F2"):Comment:Text("QAD:" + chr(10) + desc2 + chr(10) + desc12).
