...
/* REVISION: 8.5         MODIFIED: 10/21/03      BY: Kevin             */
        ...
        def new shared var sel-yn as logic initial "No".                    /*kevin*/
         ...
         define new shared buffer ps_from for ps_mstr.
...
/*J1QF*/                    if bom_desc = "" then assign
                                   /*desc3     = pt_desc1.*/                  /*marked by kevin*/
...
/*added by kevin, 10/23/2003*/
          ...
          else {gprun.i ""zzbmpscpm2.p""}           /*For copy between the two different site*/
...
/*marked by kevin,10/23/2003, and copy code to program zzbmpscpm1.p
            found_any = no.
