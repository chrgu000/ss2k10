...
*/
   ...
   for each tr_hist where (tr_nbr >= nbr and tr_nbr <= nbr1 and tr_nbr <> "")
   ...
   and (tr_program = "zzicmtrtr.p") /*2004-09-06 10:48*/
   exclusive-lock ,
   
   each in_mstr where in_site = tr_hist.tr_site 
