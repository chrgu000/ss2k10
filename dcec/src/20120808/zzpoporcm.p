...
/*G0JV** Begin section moved from poporcm.i */
/**         form
	       ent_exch colon 15
	       space(2)
...
/*G0JV** End section moved from poporcm.i */
...
/*F0F5*     ADDED THE FOLLOWING TO USE POPORCM.I FOR ALL HEADER FRAME */
...
/*F0F5*     FOLLOWING CODE HAS BEEN MOVED INTO POPORCM.I
.
.           do transaction:
.
...
.            end.
.            /* transaction */
.*F0F5*     END OF CODE MOVED TO POPORCM.I   */
...
/*/*J0CV*/          {gprun.i ""poporcb.p"" "(input ship_date)"}*/              /*kevin*/
                {gprun.i ""poporcb.p"" "(input ship_date)"}            /*kevin*/ 
