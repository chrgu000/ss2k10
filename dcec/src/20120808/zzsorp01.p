...
/*
	...
	*/	
		...
		chExcelWorkbook:Worksheets(1):Cells(iLine,3) = "区域". 
		...
		chExcelWorkbook:Worksheets(1):Cells(iLine,9) = "发货日期". 
		chExcelWorkbook:Worksheets(1):Cells(iLine,10) = "数量". 
		chExcelWorkbook:Worksheets(1):Cells(iLine,11) = "金额". 
		chExcelWorkbook:Worksheets(1):Cells(iLine,12) = "发票号". 
		chExcelWorkbook:Worksheets(1):Cells(iLine,13) = "地点". 
