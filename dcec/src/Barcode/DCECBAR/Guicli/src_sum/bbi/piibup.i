      ...
      then do:
         ...
         then do:
            ...
            assign
               ...
               ld_qty_frz  = 0.
  FOR EACH b_co_mstr USE-INDEX b_co_lot WHERE b_co_part = ld_part AND b_co_lot = ld_lot AND b_co_site = ld_site AND b_co_loc = ld_loc AND (b_co_cntst = 'i' OR b_co_cntst = 'r') AND (b_co_status = 'ac' OR b_co_status = 'iss' OR b_co_status = 'issln')  EXCLUSIVE-LOCK:
      b_co_status = 'rct'.
