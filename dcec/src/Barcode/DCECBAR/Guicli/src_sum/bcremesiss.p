...
DEFINE BUTTON bc_button LABEL "输出" SIZE 8 BY 1.20.
...
DEF FRAME bc
   ...
   bc_button AT ROW 11 COL 10
    ...
    WITH SIZE 30 BY 12.5 TITLE "MES已发料导出"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
...
PROCEDURE prt:
  ...
  IF AVAILABLE code_mstr THEN DO:
   ...
   OUTPUT TO VALUE(CODE_value + 'mesiss.txt').
    ...
    END.
    OUTPUT CLOSE.
    MESSAGE '输出成功!' VIEW-AS ALERT-BOX.
  END.
   ELSE MESSAGE '请检查路径!' VIEW-AS ALERT-BOX.
    END.
/*PROCEDURE main:
   ...
   create "Excel.Application" chExcelApplication.
     ...
     chWorkSheet = chExcelApplication:Sheets:Item(1).      
       ...
       chExcelApplication:Sheets:Item(1):NAME = "ME发料单" .
