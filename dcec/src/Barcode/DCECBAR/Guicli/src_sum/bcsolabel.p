...
DO:
      bc_id = bc_id:SCREEN-VALUE.
        ...
        APPLY 'entry':u TO bc_id.
         ...
         IF b_co_status = "ia" THEN success = NO.
        ...
        output success)"} */
          IF NOT success THEN UNDO,RETRY.
            ...
            /*  ENABLE bc_split_qty WITH FRAME bc.*/
              ...
              FIND FIRST ptp_det WHERE ptp_site = b_co_site AND ptp_part = b_co_part NO-LOCK NO-ERROR.
              IF AVAILABLE ptp_det AND ptp_ord_min <> 0 THEN bc_split_qty = ptp_ord_min.
              ELSE DO: 
                   FIND FIRST pt_mstr  WHERE pt_part = b_co_part NO-LOCK NO-ERROR.
                   IF AVAILABLE pt_mstr AND pt_ord_min <> 0 THEN bc_split_qty = pt_ord_min.
         END.
              RUN main.
      END.
...
DEF VAR isld AS LOGICAL.
 ...
 b_co_status = 'ia'.
  ...
  {bclabel.i ""zpl"" ""split"" "bcoprt.b_co_code" "bcoprt.b_co_part" 
  "bcoprt.b_co_lot" "bcoprt.b_co_ref" "bcoprt.b_co_qty_cur" "bcoprt.b_co_vend" "bcoprt.b_co_desc1"}
     DELETE bcoprt.
    END.
