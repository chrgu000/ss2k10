...
DEF FRAME bc
  ...
  /*bc_po_part AT ROW 3.6 COL 2.5*/
   ...
   /* bc_ref AT ROW 9.6 COL 2.5*/
    ...
    WITH SIZE 30 BY 14 TITLE "PO收货-直供材料"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
         ...
         PUT UNFORMAT '"' bc_po_nbr '"' SKIP.
          ...
          OUTPUT CLOSE.
             ...
             END.
               ELSE DO:
                   success = NO.
                MESSAGE  '该料件或订单不存在，更新QAD失败!'  VIEW-AS ALERT-BOX.
                LEAVE.
               END.
                     ...
                     ELSE DO:
                         ...
                         ASSIGN
                             ...
                             b_po_ponbr = bc_po_nbr
                              ...
                              b_po_popart = bc_part
                              b_po_recqty =  b_co_qty_cur  + (IF issch THEN 0 ELSE (IF AVAILABLE pod_det THEN (pod_qty_rcvd - pod_qty_rtn) ELSE 0)) .
                     END.
