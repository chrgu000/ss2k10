...
IF  NOT AVAILABLE pt_mstr THEN 
    DO:
       ...
       MESSAGE chkbk_part ' 无效零件号!' VIEW-AS ALERT-BOX.
       success = NO.
       LEAVE.
   END.
   ...
   IF ERROR-STATUS:ERROR OR mdate = ? THEN DO:
                   MESSAGE chkbk_due_date ' 无效日期格式' VIEW-AS ALERT-BOX.
                 success = NO.
                 LEAVE.
                   END.
   ...
   IF NOT AVAILABLE loc_mstr THEN 
    DO:
     /*  PUT UNFORMAT chk_ln_loc ' Please check line location!' SPACE(2).
       yn3 = NO.*/
       MESSAGE chkbk_site  chkbk_ln_loc ' 无效地点或库位!' VIEW-AS ALERT-BOX.
       success = NO.
       LEAVE.
   END.
  ...
  */
   ...
   IF ERROR-STATUS:ERROR THEN DO:
       MESSAGE chkbk_qty_req ' 无效数字!' VIEW-AS ALERT-BOX.
       success = NO.
       LEAVE.
   END.
