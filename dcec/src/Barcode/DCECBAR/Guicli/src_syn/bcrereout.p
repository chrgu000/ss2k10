...
DEF VAR bc_loc AS CHAR FORMAT "x(8)" LABEL "在途库位".
DEF VAR bc_lot AS CHAR FORMAT "x(18)" LABEL "批/序号".
DEF VAR bc_site1 AS CHAR FORMAT "x(18)" LABEL "地点".
DEF VAR bc_loc1 AS CHAR FORMAT "x(8)" LABEL "外库". 
...
DEF FRAME bc
  ...
  bc_site1 AT ROW 8.4 COL 4
   bc_loc1 AT ROW 9.6 COL 4
    
    WITH SIZE 30 BY 12 TITLE "在途库至外库"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
