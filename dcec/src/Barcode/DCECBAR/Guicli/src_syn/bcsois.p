...
DEF FRAME bc
 ...
 /* bc_so_part AT ROW 3.6 COL 2.5*/
   ...
   /* bc_ref AT ROW 9.6 COL 2.5*/
    ...
    WITH SIZE 30 BY 14 TITLE "销售发运"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
            ...
            {bcsodlock.i}
              IF AVAILABLE b_co_mstr THEN DO:
                ...
                bc_so_qty = qty.
                  ...
                  bc_site = b_co_site.
                  bc_loc = b_co_loc.
                  DISP bc_part bc_lot bc_site bc_loc /*bc_pack*/ bc_so_qty bc_qty WITH FRAME bc.
          ...
          OUTPUT CLOSE.
           ...
           FIND LAST tr_hist USE-INDEX tr_date_trn WHERE tr_date = TODAY AND tr_type = 'iss-so' AND tr_program = 'sosois.p' AND tr_nbr = bc_so_nbr AND string(tr_line) = bc_so_line AND tr_site = b_co_site AND tr_loc = b_co_loc AND /*AND tr_nbr = bc_po_nbr AND string(tr_line) = bc_po_line*/ /*tr_part = b_co_part AND*/ tr_serial = ''  AND tr_qty_loc = (b_co_qty_cur * -1) AND tr_userid = g_user /*AND tr_time >= TIME - 20 AND tr_time <= TIME*/  NO-LOCK NO-ERROR.
             ...
             LEAVE.
              ...
              b_co_status = 'iss'
             b_co_ord = bc_so_nbr
           b_co_line = bc_so_line
           b_co_qty_req = bc_so_qty
               b_co_cust = so_cust
             b_co_due_date = sod_due_date .
