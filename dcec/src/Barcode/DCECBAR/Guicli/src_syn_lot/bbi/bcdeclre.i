...
DEFINE {1}  {2} SHARED variable barusr AS CHAR.
...
DEF {1} SHARED  TEMP-TABLE iss_list
   ...
   FIELD iss_loc AS CHAR
    FIELD iss_sess LIKE g_sess
    INDEX iss_sess IS PRIMARY iss_sess ASC.
DEF  {1} SHARED  TEMP-TABLE bd_merge_list
    ...
    INDEX bd_merge_id IS PRIMARY bd_merge_sess bd_merge_id ASC.
