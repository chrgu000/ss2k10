/* GUI CONVERTED from piibup.i (converter v1.78) Fri Oct 29 14:33:44 2004 */
/* piibup.i - INVENTORY BALANCE UPDATE INCLUDE FILE                           */
/* Copyright 1986-2004 QAD Inc., Carpinteria, CA, USA.                        */
/* All rights reserved worldwide.  This is an unpublished work.               */
/* $Revision: 1.7.1.17.1.4 $                                                  */
...
/* Revision: 1.7.1.17.1.2 BY: Deepak Rao        DATE: 01/20/04  ECO: *P1KB*   */
/* Revision: 1.7.1.17.1.3 BY: Veena Lad         DATE: 02/19/04  ECO: *P1PN*   */
/* $Revision: 1.7.1.17.1.4 $          BY: Somesh Jeswani    DATE: 06/11/04  ECO: *P25V*   */
...
/*GUI*/ if global-beam-me-up then undo, leave.
         ...
         display
            ...
            tag_part         format "x(24)"   
            tag_serial       format "x(24)"   
            tag_ref
            pt_um.
  ...
  FOR EACH b_co_mstr USE-INDEX b_co_lot WHERE b_co_part = ld_part AND b_co_lot = ld_lot AND b_co_site = ld_site AND b_co_loc = ld_loc AND (b_co_cntst = ('ip' + STRING(tag_nbr))  OR b_co_cntst = ('rp' + STRING(tag_nbr))) AND (b_co_status = 'ac' OR b_co_status = 'iss' OR b_co_status = 'issln')  EXCLUSIVE-LOCK:
      MESSAGE b_co_status VIEW-AS ALERT-BOX.
      b_co_status = 'rct'.
