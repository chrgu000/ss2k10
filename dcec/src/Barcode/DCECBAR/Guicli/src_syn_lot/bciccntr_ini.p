...
DEF VAR bc_site AS CHAR FORMAT "x(8)" LABEL "盘入地点".
DEF VAR bc_loc AS CHAR FORMAT "x(8)" LABEL "盘入库位".
...
DEF VAR bc_nbr AS CHAR FORMAT "x(8)" LABEL "定制码".
...
DEF FRAME bc
  ...
  /* bc_pkqty AT ROW 10 COL 4*/
    ...
    WITH SIZE 30 BY 9 TITLE "库存初始化"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
                 ...
                 bc_ref = b_co_ref.
                  ...
                  DISP bc_part bc_lot bc_site bc_loc /*bc_ref*/ bc_qty WITH FRAME bc.
                   {bccntlock.i "bc_site" "bc_loc"}
                       FIND FIRST ld_det WHERE ld_site = b_co_site AND ld_loc = b_co_loc  AND ld_part = b_co_part AND ld_lot = b_co_lot NO-LOCK NO-ERROR.
                   IF NOT AVAILABLE ld_det THEN DO:
                   DISABLE bc_id WITH FRAME bc.
                       RUN main.
                           END.
                   ELSE DO:
                       MESSAGE '该条码已扫描！' VIEW-AS ALERT-BOX ERROR.
                       bc_id = ''.
                       DISP bc_id WITH FRAME bc.
                       UNDO,RETRY.
                       END.
   ...
   /* MESSAGE '业务操作成功！' VIEW-AS ALERT-BOX INFORMATION. */
    {bcrelease.i}
      ...
      bc_qty = 0
        ...
        bc_loc = ''
        bc_loc1 = ''*/.
  DISP bc_id bc_part bc_lot bc_qty  bc_site bc_loc  WITH FRAME bc.
