...
DEF FRAME bc
  ...
  bc_site1 AT ROW 8.4 COL 1
   bc_loc1 AT ROW 9.6 COL 1
    bc_so_job1 AT ROW 10.8 COL 2.5
    bc_nbr AT ROW 12 COL 2.5
    WITH SIZE 30 BY 14 TITLE "移库"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
              ...
              IF AVAILABLE b_co_mstr THEN DO:
                 ...
                 bc_ref = b_co_ref.
                  ...
                  DISP bc_part bc_lot bc_site bc_loc /*bc_ref*/ bc_qty WITH FRAME bc.
                   FIND FIRST IN_MSTR WHERE IN_part = b_co_part AND in_site = bc_site NO-LOCK NO-ERROR.
