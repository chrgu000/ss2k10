...
DEF TEMP-TABLE bid1_tmp
    ...
    INDEX bid1_sess IS PRIMARY bid1_sess ASC.
...
DO:
     ...
     bc_loc = ''.
       ...
       FIND FIRST bid1_tmp WHERE bid1_sess = g_sess AND bid1_id = bc_id NO-LOCK  NO-ERROR.
...
END.
        ...
        FOR EACH bid1_tmp WHERE bid1_sess = g_sess AND bid1_lot = po1_lot:
