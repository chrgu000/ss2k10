...
DEFINE BUTTON bc_button LABEL "浏览" SIZE 8 BY 1.50.
...
DEF FRAME bc
   ...
   bc_button AT ROW 11 COL 10
    ...
    WITH SIZE 30 BY 12 TITLE "MES发料单打印"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
...
PROCEDURE main:
 ...
 chWorkSheet:Range("b1:b1"):VALUE = "地点".
       chWorkSheet:Range("c1:c1"):VALUE = "库位".
