...
DEF FRAME bc
   ...
   bc_button AT ROW 18 COL 10
    ...
    WITH SIZE 30 BY 19.7 TITLE "MES领料单汇总报表"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
...
chWorkSheet = chExcelApplication:Sheets:Item(mcnt).      
       ...
       chExcelApplication:Sheets:Item(mcnt):NAME = "MES汇总单" .
...
chWorkSheet:Range("a1:a1"):VALUE = '库管员'.
  ...
  chWorkSheet:Range("c1:c1"):VALUE = "日期".      
 chWorkSheet:Range("d1:d1"):VALUE = "地点".
       chWorkSheet:Range("e1:e1"):VALUE = "线边库位".
       chWorkSheet:Range("f1:f1"):VALUE = "零件号".
    
      chWorkSheet:Range("g1:g1"):VALUE = "零件描述".
     chWorkSheet:Range("h1:h1"):VALUE = "需求数".
