...
DEFINE BUTTON bc_button LABEL "查询" SIZE 8 BY 1.50.
...
DEF FRAME bc
   ...
   bc_button AT ROW 8 COL 10
    ...
    WITH SIZE 30 BY 10 TITLE "MES回冲料件查询"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
...
PROCEDURE main:
   ...
   create "Excel.Application" chExcelApplication.
     ...
     chWorkSheet = chExcelApplication:Sheets:Item(1).      
       ...
       chExcelApplication:Sheets:Item(1):NAME = "MES回冲料件清单" .
 ...
 chWorkSheet:Range("b1:b1"):VALUE = "地点".
    ...
    chWorkSheet:Range("f1:f1"):VALUE = "需回冲数".
     chWorkSheet:Range("g1:g1"):VALUE = "已回冲数".
      chWorkSheet:Range("h1:h1"):VALUE = "待回冲数".
    rowstart = 1.
