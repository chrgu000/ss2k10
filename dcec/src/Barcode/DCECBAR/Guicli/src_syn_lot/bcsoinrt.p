...
DO:
       ...
       APPLY 'entry':u TO bc_id.
           FIND FIRST b_co_mstr WHERE b_co_code = bc_id AND b_co_status = 'rct' AND SUBSTR(b_co_desc1,80,1) = 'r' EXCLUSIVE-LOCK NO-ERROR.
...
IF NOT success THEN LEAVE.
         ...
         PUT UNFORMAT STRING(b_co_qty_cur * -1) ' "' bc_site '" "' bc_loc '"' ' "' b_co_lot '"' SKIP.
         PUT '.' SKIP.
         PUT  SKIP(2).
