...
/******************************************************************************/
/* REVISION: 9.1      LAST MODIFIED: 06/24/04   BY:SunnyZhou *xw0624*      */
/* REVISION: 9.1      LAST MODIFIED: 06/24/04   BY:SunnyZhou *xw1015* migrate to SP7     */
/*xw0624*/ define input PARAMETER ordernum like po_nbr.
/*xw0624*/ define input PARAMETER rdceffdate as date.
...
{&POPORCM-P-TAG3}
/*xw0624* define variable ordernum        like po_nbr                             no-undo.*/
{&POPORCM-P-TAG4}
...
/*xw0624*/ DO ON ERROR UNDO,LEAVE: 
   ...
   do transaction:
      if porec
      then do:
/*xw0624*         {poporcm.i &frame=a1} */
/*xw0624*/         {xkpoporcm.i &frame=a1} 
      end. /* IF porec */
      else do:
/*xw0624*         {poporcm.i &frame=a2} */
/*xw0624*/         {xkpoporcm.i &frame=a2} 
      end. /* ELSE DO: */
