...
DEFINE VARIABLE employee AS CHARACTER FORMAT "x(8)" LABEL "雇员".
DEFINE VARIABLE bfsite AS CHARACTER LABEL "地点".
DEFINE VARIABLE bfdate AS DATE LABEL "回冲日期".
DEFINE VARIABLE bfop AS CHARACTER LABEL "工序".
DEFINE VARIABLE bfpart LIKE pt_part LABEL "零件".
...
DEFINE FRAME a
    ...
    WITH  SIZE 30 BY 18.5 TITLE "重复生产回冲"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
