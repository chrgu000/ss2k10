...
DEF FRAME bc
    ...
    bc_id AT ROW 2.7 COL 4
    bc_part AT ROW 4.2 COL 2.5
   
    bc_part_desc  AT ROW 5.7 COL 1
    bc_part_desc1  NO-LABEL AT ROW 6.7 COL 8.5

   bc_lot AT ROW 8.2 COL 1.6
   /* bc_pack AT ROW 6.5 COL 2.5*/
    bc_qty AT ROW 9.7 COL 4
  /* bc_pkqty AT ROW 10 COL 4*/
   /* bc_qty_std AT ROW 8 COL 1*/
  
   bc_qty_label AT ROW 11.2 COL 4
    bc_button AT ROW 12 COL 10
    WITH SIZE 30 BY 14 TITLE "条码生成-进口"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
