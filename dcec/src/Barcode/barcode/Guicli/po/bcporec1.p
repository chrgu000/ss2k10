...
DEF FRAME bc
    ...
    bc_po_nbr AT ROW 8.5 COL 2.5
    bc_po_line AT ROW 9.7 COL 4
  bc_id AT ROW 10.9 COL 4
   ...
   /* bc_pack AT ROW 9.6 COL 2.5*/
    ...
    bc_site AT ROW 15.7 COL 4

    bc_loc AT ROW 16.9 COL 4 
  
   
    bc_button AT ROW 18 COL 10
    WITH SIZE 30 BY 20 TITLE "PO收货-进口"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
