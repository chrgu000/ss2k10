...
DEF FRAME bc
  ...
  bc_po_part AT ROW 3.6 COL 2.5
   ...
   /* bc_ref AT ROW 9.6 COL 2.5*/
    bc_qty AT ROW 9.6 COL 4 'EA' AT ROW 10.8 COL 22 
   
    bc_site AT ROW 10.8 COL 4

    bc_loc AT ROW 12 COL 4 
  
   bc_qis AT ROW 13.2 COL 4
    bc_button AT ROW 14.5 COL 10
    WITH SIZE 30 BY 17 TITLE "PO收货-直供材料"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
