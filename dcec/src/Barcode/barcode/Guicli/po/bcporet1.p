...
DEF VAR bc_qis AS CHAR FORMAT "x(8)" LABEL "QIS".
...
DEF FRAME bc
  ...
  bc_po_part AT ROW 3.6 COL 2.5
   ...
   bc_pack AT ROW 10.8 COL 2.5
    bc_site AT ROW 12 COL 4

    bc_loc AT ROW 13.2 COL 4 
  
   
    bc_button AT ROW 14.5 COL 10
    WITH SIZE 30 BY 17 TITLE "PO退货"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
