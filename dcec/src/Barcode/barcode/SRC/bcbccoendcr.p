...
DEF VAR bc_prod_qty AS DECIMAL FORMAT "->>,>>>,>>9.9" LABEL "日产量".
DEF VAR bc_label_qty AS DECIMAL FORMAT "->>,>>>,>>9.9" LABEL "标签数".
DEF FRAME bc
  ...
  /* bc_pkqty AT ROW 10 COL 4*/
    ...
    WITH SIZE 30 BY 14 TITLE "成品条码批量生成"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
