...
DEF VAR bc_site AS CHAR FORMAT "x(15)" LABEL "地点".
...
DEF FRAME bc
   ...
   bc_lot AT ROW 3.9 COL 1.6
    ...
    bc_qty AT ROW 6.3 COL 4
  /* bc_pkqty AT ROW 10 COL 4*/
    bc_site AT ROW 7.5 COL 4

    bc_loc AT ROW 8.7 COL 4
  bc_so_job AT ROW 9.9 COL 4

   /*bc_dr AT ROW 10.8 COL 4*/
    bc_button AT ROW 11.5 COL 10
    WITH SIZE 30 BY 14 TITLE "计划外入库"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
...
b_co_status = 'received'.
    ...
    OUTPUT bid)"}
            ...
            {bcrun.i ""bcmgwrfl.p"" "(INPUT ""icunrc"",input bid )"
               }
