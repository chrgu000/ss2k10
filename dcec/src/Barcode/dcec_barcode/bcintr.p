...
DEF FRAME bc
    ...
    bc_part_desc  AT ROW 3.9 COL 1
    bc_part_desc1  NO-LABEL AT ROW 4.9 COL 8.5
   bc_lot AT ROW 6.1 COL 1.6
    bc_qty AT ROW 7.3 COL 4
  /* bc_pkqty AT ROW 10 COL 4*/
    bc_site AT ROW 8.5 COL 4

    bc_loc AT ROW 9.7 COL 4
  bc_site1 AT ROW 10.9 COL 4
   bc_loc1 AT ROW 12.1 COL 4
    bc_button AT ROW 13.5 COL 10
    WITH SIZE 30 BY 16.5 TITLE "移库"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
