...
DEF VAR bc_supp AS CHAR FORMAT "x(8)" LABEL "供应商".

DEFINE BUTTON bc_button LABEL "确认" SIZE 8 BY 1.50.
DEF FRAME bc
    /*bc_id AT ROW 2 COL 4*/
    bc_part AT ROW 2 COL 2.5
   
    bc_part_desc  AT ROW 3.5 COL 1
    bc_part_desc1  NO-LABEL AT ROW 4.5 COL 8.5
   bc_lot AT ROW 6 COL 1.6
    bc_qty AT ROW 7.5 COL 4
  /* bc_pkqty AT ROW 10 COL 4*/
   bc_supp AT ROW 9 COL 2.5

   
    bc_button AT ROW 10.5 COL 10
    WITH SIZE 30 BY 12.5 TITLE "原材料条码生成"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
