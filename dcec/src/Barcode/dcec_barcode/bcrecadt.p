...
DEF FRAME bc
    ...
    bc_emp AT ROW 1.5 COL 4
     bc_emp1 AT ROW 3 COL 6.9
  ...
  /* bc_pkqty AT ROW 10 COL 4*/
    ...
    WITH SIZE 30 BY 8 TITLE "明细发料单计算-领料员"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
...
ENABLE  bc_emp bc_emp1  WITH FRAME bc IN WINDOW c-win.
