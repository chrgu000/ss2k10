...
DEF VAR bc_loc AS CHAR FORMAT "x(8)" LABEL "退料库位".
...
bc_loc1 AT ROW 9 COL 1
    bc_loc AT ROW 10.5 COL 1
  
   
    bc_button AT ROW 12.5 COL 10
    WITH SIZE 30 BY 15 TITLE "生产退料"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
