...
DEF VAR bc_loc AS CHAR FORMAT "x(8)" LABEL "外库".
DEF VAR bc_loc1 AS CHAR FORMAT "x(8)" LABEL "备件库位".
...
DEF FRAME bc_pick
   ...
   /*bc_pkqty AT ROW 10 COL 4*/
    ...
    bc_loc AT ROW 9 COL 4
    bc_site1 AT ROW 10.5 COL 4
    bc_loc1 AT ROW 12 COL 1
   
    bc_button AT ROW 13.5 COL 10
    WITH SIZE 30 BY 15.5 TITLE "新包装入备件库"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
