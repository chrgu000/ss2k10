...
DEF VAR bc_loc1 AS CHAR FORMAT "x(8)" LABEL "目标库位".
...
DEF FRAME bc
  ...
  bc_so_part AT ROW 3.6 COL 2.5
   ...
   bc_lot AT ROW 8.4 COL 1.6
    ...
    bc_qty AT ROW 10.8 COL 4
   
    bc_site AT ROW 12 COL 4

    bc_loc AT ROW 13.2 COL 1
    

   
    bc_button AT ROW 14.5 COL 10
    WITH SIZE 30 BY 17 TITLE "销售发运"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
