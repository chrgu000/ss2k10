...
DEF VAR bc_loc AS CHAR FORMAT "x(8)" LABEL "备件库位".
DEF VAR bc_loc1 AS CHAR FORMAT "x(8)" LABEL "待发库位".
...
DEF FRAME bc_pick
  ...
  bc_loc1 AT ROW 10.5 COL 1
    ...
    WITH SIZE 30 BY 15 TITLE "备件库至待发库"  SIDE-LABELS  NO-UNDERLINE THREE-D AT COLUMN 1 ROW 1.
