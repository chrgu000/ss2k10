...
IF (mcnt >= 30 AND mcnt MOD 30 = 0) OR totcnt < 30 OR mcnt = totcnt  THEN DO:

hdoc:SAVE("file","\\qadtemp\srminterface\ppo" + string(grp) + ".xml").
...
DELETE OBJECT htemp.
DELETE OBJECT hroot.
mfile = "\\qadtemp\srminterface\ppo" + string(grp) + ".xml".
