/* GUI CONVERTED from poporca.p (converter v1.75) Mon Dec  4 00:42:27 2000 */
/* poporca.p - PURCHASE ORDER RECEIPT W/ SERIAL NUMBER CONTROL          */
/* COPYRIGHT qad.inc. ALL RIGHTS RESERVED. THIS IS AN UNPUBLISHED WORK. */
/*F0PN*/ /*V8:ConvertMode=Maintenance                                   */
/*J2MG*/ /*V8:RunMode=Character,Windows                                 */
...
/* REVISION: 9.0     LAST MODIFIED: 07/28/00    BY: *M0PQ* Falguni Dalal      */
/* REVISION: 9.0     LAST MODIFIED: 08/17/00    BY: *M0RJ* Kaustubh K.        */
/* REVISION: 9.0     LAST MODIFIED: 11/28/00    BY: *M0X2* Reetu Kapoor       */
...
&SCOPED-DEFINE poporca_p_1 "收货"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_2 "短缺量"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_3 "收货: "
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_4 "发货数量"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_5 "工序"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_6 "装箱单数量"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_7 "库"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_8 "订单"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_9 "多记录"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_10 "批/序号!供应商批号"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_11 "批/序"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_12 "    库位!参考"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_13 "ID"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_14 "说明"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_15 "说明"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_16 "取消欠交量"
/* MaxLen: Comment: */

&SCOPED-DEFINE poporca_p_17 "改变属性"
/* MaxLen: Comment: */

/*J2WJ*/
&SCOPED-DEFINE poporca_p_18 "供应商批号"
...
/*J2MG*/ /* VARIABLE DEFINITION FOR GL CALENDAR VALIDATION */
/*J2MG*/ {gpglefdf.i}
...
/*GC87*  define new shared variable site                like sr_site no-undo. */
/*GC87*  define new shared variable location            like sr_loc no-undo.*/
/*GC87*  define new shared variable lotref              like sr_ref no-undo.*/
 ...
 **                                                     initial "RCT-PO". **/
         ...
         define shared variable qopen       like pod_qty_rcvd label {&poporca_p_2}.
...
/*J040*  define variable chg_stat       like mfc_logical label"Change Status".*/
/*J040*/ define variable chg_attr       like mfc_logical label {&poporca_p_17} no-undo .
/*G718*/ define variable cmmt_yn        like mfc_logical
                                        label {&poporca_p_14} no-undo.
...
/*GO37*/ define variable msgnbr         as integer no-undo.
...
/*FS26*/ define variable undotran       like mfc_logical no-undo.
...
/*J041*/ define variable newlot         like pod_lot_next no-undo.
/*J041*/ define variable trans-ok       like mfc_logical no-undo.
/*J041*/ define variable alm_recno      as recid no-undo.
/*J041*/ define variable filename       as character no-undo.
/*J040*/ define variable srlot          like sr_lotser no-undo.
/*J069*/ define variable almr           like alm_pgm no-undo.
/*J069*/ define variable ii             as integer no-undo.
/*J14K*/ define variable errsite        like pod_site no-undo.
/*J14K*/ define variable errloc         like pod_loc no-undo.
/*G2M4*/ define variable use_pod_um_conv as logical no-undo.
/*J2P2*/ define variable l_getlot        like mfc_logical no-undo.
...
/*GC87*/*define shared variable msgref              as character format "x(20)".
...
/*J040*/   field assay_actv as logical
/*J040*/   field grade_actv as logical
/*J040*/   field expire_actv as logical
/*J040*/   field status_actv as logical.

/*G425*/ FORM /*GUI*/  with frame c 5 down width 80 THREE-D /*GUI*/.


/*FS54*/ FORM /*GUI*/ 
/*G0B2*/    pod_line  COLUMN-LABEL "序"           space(.3)   
/*G0B2*/    pod_part  COLUMN-LABEL "零件号"           space(.3)   
/*G0B2*/    pt_um              space(.3)   
/*G0B2*/    qopen                space(.3)   
/*G0B2*/    pod_um              space(.3)   
...
/*G0B2*/    pod_due_date  COLUMN-LABEL "到期日"       space(.3)   
/*G0B2*/    pod_type
...
/*H0SN*/ FORM /*GUI*/  with frame e down no-attr-space width 80 THREE-D /*GUI*/.
 ...
 RECT-FRAME-LABEL AT ROW 1 COLUMN 3 NO-LABEL VIEW-AS TEXT SIZE-PIXELS 1 BY 1
 SKIP(.1)  /*GUI*/
line       LABEL "序号"    colon 15
            receipt_um  LABEL "单位"   colon 36
            site      LABEL "地点"     colon 54
            location       colon 68 label {&poporca_p_7}
            lotserial_qty LABEL "数量" colon 15
            ...
            lotref   LABEL "参考"      colon 54
            cancel_bo      colon 15 label {&poporca_p_16}
/*J038*     multi_entry    colon 54                                  */
/*J2WJ** /*J038*/    vendlot        colon 54 /*J04D*/format "x(22)"  */
/*J2WJ*/    pod__qad04[1]  colon 54 label {&poporca_p_18} format "x(22)"
            pod_part   LABEL "零件号"    colon 15 /*7.0*/ no-attr-space
/*J038*/    multi_entry    colon 54
/*J038*     chg_stat       colon 54                                  */
/*J040*/    chg_attr       colon 73
            pod_vpart LABEL "供应商零件"    /*7.0 colon 54 */
/*F087*/                   colon 15
            /*7.0*/ no-attr-space
/*G718*/    cmmt_yn        colon 54 label {&poporca_p_15}
          SKIP(.4)  /*GUI*/
...
/*J2DG** find first poc_ctrl no-lock.        */
/*J2DG*/ for first poc_ctrl
/*J2DG*/    fields (poc_ln_stat) no-lock:
/*J2DG*/ end. /* FOR FIRST POC_CTRL */

/*J2DG** /*J04D*/ find first clc_ctrl no-lock no-error.              */
...
/*J2DG** /*J04D*/    find first clc_ctrl no-lock.                    */
/*J2DG*/    for first clc_ctrl
/*J2DG*/       fields(clc_lotlevel) no-lock:
/*J2DG*/    end. /* FOR FIRST CLC_CTRL */
/*J04D*/ end.

         if available poc_ctrl and poc_ln_stat = "x" then
            ln_stat = yes.
         else ln_stat = no.

/*J2DG** /*F311*/ find po_mstr where recid(po_mstr) = po_recno.              */
/*J2DG*/ for first po_mstr
/*J2DG*/    fields (po_nbr po_stat po_vend)
...
/*J2DG** /*F126*/  find si_mstr where si_site = pod_site no-lock no-error.    */
/*J2DG*/          for first si_mstr
/*J2DG*/             fields (si_db si_entity si_site)
/*J2DG*/             where si_site = pod_site no-lock:
...
/*J2DG*/                fields(pt_auto_lot pt_loc pt_lot_grp
/*J2DG*/                       pt_lot_ser pt_part pt_status pt_um)
...
/*FS54*/             if porec then do:
                        display pod_line COLUMN-LABEL "序"  
/*GM74*/       view-as fill-in size 5 by 1 space(.2)   
                        pod_part COLUMN-LABEL "零件号"
/*GM74*/      space(.2)   
...
/*GM74*/       view-as fill-in size 3 by 1 space(.2)   
                        pod_qty_chg COLUMN-LABEL "收货量"
/*GM74*/      space(.2)   
                        pod_rum
/*GM74*/       view-as fill-in size 3 by 1 space(.2)   
                        pod_project
/*GM74*/      space(.2)   
                        pod_due_date COLUMN-LABEL "到期日"
/*GM74*/      space(.2)   
                        pod_type
...
/*J2DG**  /*F126*/      find si_mstr                                         */
/*J2DG**  /*F126*/      where si_site = pod_site no-lock no-error.           */
/*J2DG*/                   for first si_mstr
/*J2DG*/                      fields (si_db si_entity si_site)
/*J2DG*/                      where si_site = pod_site no-lock:
/*J2DG*/                   end. /* FOR FIRST SI_MSTR */
...
/*J2DG*/          find pod_det where pod_nbr = po_nbr
/*J2DG**          and pod_line = line no-error.                            */
/*J2DG*/             and pod_line = line exclusive-lock no-error.
...
/*J2DG**  /*J041*/          find first sr_wkfl where sr_userid = mfguser      */
/*J2DG**  /*J041*/                  and sr_lineid = cline no-lock no-error.   */

/*J2DG*/          for first sr_wkfl
/*J2DG*/             fields(sr_lineid sr_loc sr_lotser sr_qty
/*J2DG*/                    sr_ref sr_site sr_userid sr_vend_lot)
/*J2DG*/             where sr_userid   = mfguser
/*J2DG*/             and   sr_lineid  = cline no-lock:
/*J2DG*/          end. /* FOR FIRST SR_WKFL */

/*J041*/          if available sr_wkfl then newlot = sr_lotser.
/*J041*/          pod_recno = recid (pod_det).

/*J2DG**  /*J041*/ find pt_mstr where pt_part = pod_part no-lock no-error.    */
/*J2DG*/             for first pt_mstr
/*J2DG*/                fields(pt_auto_lot pt_loc pt_lot_grp pt_lot_ser
/*J2DG*/                       pt_part pt_status pt_um)
/*J2DG*/                where pt_part = pod_part no-lock:
/*J2DG*/             end. /* FOR FIRST PT_MSTR */
...
/*J12S*/                 pt_lot_grp <> "" and porec and pod_type = "") then do:

/*J2DG** /*J041*/           find alm_mstr where alm_lot_grp = pt_lot_grp      */
/*J2DG** /*J041*/           and alm_site = pod_site no-lock no-error.         */
/*J2DG*/                for first alm_mstr
/*J2DG*/                   fields (alm_lot_grp alm_pgm alm_site)
/*J2DG*/                   where alm_lot_grp = pt_lot_grp
/*J2DG*/                   and   alm_site    = pod_site no-lock:
/*J2DG*/                end.  /* FOR FIRST ALM_MSTR */

/*J041*/                if not available alm_mstr then
/*J2DG** /*J041*/              find alm_mstr where alm_lot_grp = pt_lot_grp   */
/*J2DG** /*J041*/                  and alm_site = "" no-lock no-error.        */

/*J2DG*/                for first alm_mstr
/*J2DG*/                   fields (alm_lot_grp alm_pgm alm_site)
/*J2DG*/                   where alm_lot_grp = pt_lot_grp
/*J2DG*/                   and   alm_site    = "" no-lock:
/*J2DG*/                end. /* FOR FIRST ALM_MSTR */
...
/*J2DG**          find first sr_wkfl where sr_userid = mfguser                */
/*J2DG**          and sr_lineid = cline no-lock no-error.                     */

/*J2DG*/          for first sr_wkfl
/*J2DG*/             fields(sr_lineid sr_loc sr_lotser sr_qty sr_ref
/*J2DG*/                    sr_site sr_userid sr_vend_lot)
/*J2DG*/             where sr_userid = mfguser
/*J2DG*/             and   sr_lineid = cline no-lock:
/*J2DG*/          end. /*  FOR FIRST SR_WKFL */
...
/*G718*/             cmmt_yn = no
/*J12S*/             chg_attr = no.
/*J2DG** /*GJ42*/  find pt_mstr where pt_part = pod_part no-lock no-error. */
...
* /*G443*/             if available sr_wkfl and input site <> sr_site then do:
...
/*F0NS*/             i           = 0
/*F0NS*/             multi_entry = no.
/*F0NS*/          for each sr_wkfl
/*J2DG*/             fields(sr_lineid sr_loc sr_lotser sr_qty
/*J2DG*/                    sr_ref sr_site sr_userid sr_vend_lot)
                     where sr_userid = mfguser
/*F0NS*/             and   sr_lineid = cline no-lock:
/*F0NS*/                i = i + 1.
/*F0NS*/                if i > 1 then do:
/*F0NS*/                   multi_entry = yes.
/*F0NS*/                   leave.
/*F0NS*/                end.
/*F0NS*/          end. /*  FOR FIRST SR_WKFL */

/*J2WJ*/          if pod__qad04[1] = ? then
/*J2WJ*/             assign pod__qad04[1] = "".
...
/*J2P2*/          l_getlot = yes.
/*J2P2*/          if available pt_mstr then  do :
/*J2P2*/             if ((pt_lot_ser = "L") and
/*J2P2*/                 (pt_auto_lot)      and
/*J2P2*/                 (pt_lot_grp <> "") and
/*J2P2*/                 (pod_type = "")    and
/*J2P2*/                 (porec = yes)      and
/*J2P2*/                 (is-return = no))
...
/*G1Z8*/             lotserial
/*J2P2** /*J12S*/    when (not multi_entry) */
/*J2P2*/             when ((not multi_entry) and l_getlot)
...
/*J2DG*/             fields (si_db si_entity si_site)
/*J2MG*/             where si_site = site no-lock:
...
/*J2DG*/             for first lot_mstr
/*J2DG*/                fields (lot_line lot_nbr lot_part lot_serial)
/*J2DG*/                where lot_serial = lotserial
/*J2DG*/                and   lot_part   = pod_part
/*J2DG*/                and   lot_nbr    = pod_nbr
/*J2DG*/                and   lot_line   = cline no-lock:
/*J2DG*/             end. /*  FOR FIRST LOT_MSTR */
 ...
 *J2DG** END DELETE **/
/*J2DG*/             for first lotw_wkfl
/*J2DG*/                 fields(lotw_lotser lotw_mfguser lotw_part)
/*J2DG*/                 where lotw_lotser   = lotserial
/*J2DG*/                 and   lotw_mfguser <> mfguser
/*J2DG*/                 and   lotw_part    <> pt_part no-lock:
/*J2DG*/              end. /*  FOR FIRST LOTW_WKFL */
...
/*J22T*/          /* ICEDIT PERFORMS CHECK AGAINST RECEIPT WHICH AFFECT     */
/*J22T*/          /* INVENTORY.TO RESTRICT THE RECEIPT WHEN PO LINE IS      */
/*J22T*/          /* EITHER OF TYPE "S" (SUBCONTRACT) OR TYPE "M" (MEMO),   */
/*J22T*/          /* WHICH DOES NOT AFFECTS UPDATE INVENTORY.               */

/*J22T*/          if (pod_type = "M" or pod_type = "S") and available pt_mstr
/*J22T*/          and can-find(first isd_det where
/*J22T*/          isd_status = string(pt_status,"x(8)") + "#" and
/*J22T*/          isd_tr_type = transtype)
/*J22T*/          then do:
/*J22T*/             /* RESTRICTED TRANSACTION FOR STATUS CODE */
/*J22T*/             {mfmsg02.i 373 3 "pt_status"}
/*J22T*/             undo, retry.
/*J22T*/          end. /* IF POD_TYPE = "M" OR POD_TYPE = "S" */
...
/*J040***************REPLACED FOLLOWING LOGIC IN ITS ENTIRETY******************
* /*F087*/        if not chg_stat and available stat_wkfl then delete stat_wkfl.
* /*F087*/        stat_recno = 0.
...
**J040***************REPLACED PRECEEDING LOGIC IN ITS ENTIRETY*****************/
...
/*F0V7*/          else trans_conv = conv_to_pod_um * pod_um_conv.
...
* /*F0NS*/                   total_lotserial_qty = total_lotserial_qty - sr_qty.
* /*F0NS*/                   delete sr_wkfl.
* /*F0NS*/                end.
* /*F0NS*/             end.
* /*F0NS*/             else do:
...
/*G1R9*/             else do:
/*G1R9*/                if available sr_wkfl then do:
/*G1R9*                    IF MORE THAN ONE SR_WKFL RECORD EXISTS, THEN THE USER
...
/*J2WJ*/             if i = 0 then
/*J2WJ*/                assign vendlot = pod__qad04[1].
...
/*G1R9*/             for each sr_wkfl
/*J2DG*/                fields(sr_lineid sr_loc sr_lotser sr_qty
/*J2DG*/                       sr_ref sr_site sr_userid sr_vend_lot)
/*G1R9*/                where sr_userid = mfguser and
/*G1R9*/                sr_lineid = cline no-lock:
/*G1R9*/                   total_lotserial_qty = total_lotserial_qty + sr_qty.
/*G1R9*/             end. /*  FOR EACH SR_WKFL */
...
/*G1SL*/             /* IF MULTI-ENTRY MODE WAS USED TO PROCESS RECEIPTS FOR A
                     ...
                     */
/*J2DG** /*G1SL*/        find first sr_wkfl where sr_userid = mfguser         */
/*J2DG** /*G1SL*/        and sr_lineid = cline no-lock no-error.              */
/*J2DG*/             for first sr_wkfl
/*J2DG*/                fields(sr_lineid sr_loc sr_lotser sr_qty
/*J2DG*/                       sr_ref sr_site sr_userid sr_vend_lot)
/*J2DG*/                where sr_userid = mfguser
...
/*F0S0*/            for each sr_wkfl
/*J2DG*/            fields(sr_lineid sr_loc sr_lotser sr_qty
/*J2DG*/                   sr_ref sr_site sr_userid sr_vend_lot)
/*F0S0*/            where sr_userid = mfguser
/*F0S0*/            and sr_lineid = cline no-lock:
/*F0S0*/               i = i + 1.
/*J2WJ*/               if i = 1 then
/*J2WJ*/                  assign pod__qad04[1] = sr_vend_lot.
/*F0S0*/               if i > 1 then do:
...
* /*F087*/              /*CREATE LD_DET RECORD IF ASSAY, ETC HAS BEEN CHANGED*/
...
/*J38P*/  /* CHANGED TENTH INPUT PARAMETER STRING(POLINE) TO                */
/*J38P*/  /* IF (LOTSERIAL_QTY >=0) THEN STRING(POLINE) ELSE """"           */
...
/*J14K* /*J12S*/     if (pod_type = "" and pod_fsm_type = "RTS-RCT") then do:   */

/*J14K*/             if (pod_type = "" and pod_fsm_type <> "") then do:
/*J12S*/                if (pt_lot_ser <> "S") then do:
/*J14K*                    Changed qty parm from "lotserial_qty * trans_conv" */
...
./*F0TC*/                   /* input 0,  was  input lotserial_qty * trans_conv,*/
./*J12S*/                   /* Change 0 back to input lotserial_qty * trans_conv,*/
...
/*J038*/ /* Added input ponbr, and input string(poline), input trans_um, below*/
...
/*J2DG** /*G1SL*/      find loc_mstr where loc_site = site          */
/*J2DG** /*G1SL*/      and loc_loc = location no-lock no-error.     */
/*J2DG*/             for first loc_mstr
/*J2DG*/                fields(loc_loc loc_single loc_site loc__qad01)
/*J2DG*/                where loc_site = site
/*J2DG*/                and   loc_loc  = location no-lock:
...
/*G1SL*/                      and ld_lot = lotserial and ld_ref = lotref) then
/*G1SL*/                         error_flag = 0.
/*G1SL*/                   end. /* error_flag = 0 and loc__qad01 = yes */

/*G1SL*/                   if error_flag <> 0 then do:
/*G1SL*/                      {mfmsg.i 596 3}
/*G1SL*/                      /*TRANSACTION CONFLICTS WITH SINGLE ITEM/LOT LOC*/
...
/*J040*/             chg_line = string(pod_line) exclusive-lock no-error.
...
/*J040*/             for each sr_wkfl
/*J2DG*/             fields(sr_lineid sr_loc sr_lotser sr_qty
/*J2DG*/                    sr_ref sr_site sr_userid sr_vend_lot)
/*J040*/             where sr_userid = mfguser
...
/*G718*/             global_ref = {&poporca_p_3} + pod_nbr + "/" + string(pod_line).
...
/*FS54*/             hide frame cship.
                     hide frame d.
                     for each pod_det
/*J2DG*/                fields (pod_bo_chg pod_cmtindx pod_due_date
/*J2DG*/                        pod_fsm_type pod_line pod_lot_rcpt
/*J2DG*/                        pod_nbr pod_op pod_part pod_project
/*J2DG*/                        pod_ps_chg pod_qty_chg pod_qty_ord
/*J2DG*/                        pod_qty_rcvd pod_rma_type pod_rum
/*J2DG*/                        pod_rum_conv pod_sched pod_site
/*J2DG*/                        pod_status pod_taxable pod_taxc
/*J2DG*/                        pod_tax_env pod_tax_in pod_tax_usage
/*J2DG*/                        pod_type pod_um pod_um_conv pod_vpart
/*J2DG*/                        pod_wo_lot)
                        where pod_nbr = po_nbr and pod_status <> "c" and
                        pod_status <> "x" and pod_qty_chg <> 0 no-lock
                        use-index pod_nbrln ,
                     each sr_wkfl
/*J2DG*/                fields(sr_lineid sr_loc sr_lotser sr_qty sr_ref
/*J2DG*/                       sr_site sr_userid sr_vend_lot) no-lock
                        where sr_userid = mfguser
...
/*J038*/                   pod_part
/*J038*/                   sr_site
/*J038*/                   sr_loc column-label {&poporca_p_12}
/*J038*/                   sr_lotser column-label {&poporca_p_10}
/*J04D*/                             format "x(22)"
/*H0SN** /*J038*/          sr_qty.                                         */
...
/*J2QC*/         /* CHECK FOR RECEIPTS OF DIFFERENT ITEMS ON A   */
/*J2QC*/         /* SINGLE ITEM LOCATION                         */

/*J2QC*/           for each sr_wkfl
/*J2QC*/               fields (sr_lineid sr_loc sr_lotser sr_qty
/*J2QC*/                       sr_ref sr_site sr_userid sr_vend_lot)
/*J2QC*/               where sr_userid = mfguser no-lock:
/*J2QC*/               for first loc_mstr
/*J2QC*/                   fields(loc_loc loc_single loc_site loc__qad01)
/*J2QC*/                   where loc_site = sr_site and
/*J2QC*/                         loc_loc  = sr_loc no-lock:
/*J2QC*/               end. /* FIRST LOC_MSTR */
/*J2QC*/               if available loc_mstr and loc_single = yes then do:
/*J2QC*/                  for first pod_det
/*J2QC*/                      fields (pod_bo_chg pod_cmtindx pod_due_date
/*J2QC*/                              pod_fsm_type pod_line pod_lot_rcpt
/*J2QC*/                              pod_nbr pod_op pod_part pod_project
/*J2QC*/                              pod_ps_chg pod_qty_chg pod_qty_ord
/*J2QC*/                              pod_qty_rcvd pod_rma_type pod_rum
/*J2QC*/                              pod_rum_conv pod_sched pod_site
/*J2QC*/                              pod_status pod_taxable pod_taxc
/*J2QC*/                              pod_tax_env pod_tax_in pod_tax_usage
/*J2QC*/                              pod_type pod_um pod_um_conv pod_vpart
/*J2QC*/                              pod_wo_lot)
/*J2QC*/                      where pod_nbr = po_nbr  and
/*J2QC*/                            pod_line = integer(sr_lineid) no-lock
/*J2QC*/                      use-index pod_nbrln:
/*J2QC*/                  end. /*FIRST POD_DET */
/*J2QC*/                  if available pod_det then do:
/*J2QC*/                     /* CHECK PRIOR RECEIPT TRANSACTIONS FOR  */
/*J2QC*/                     /* DIFFERENT ITEMS HAVING SAME LOCATION  */
/*J2QC*/                     {gprun.i ""gploc01.p""
                           "(sr_site,
                             sr_loc,
                             pod_part,
                             sr_lotser,
...
/*J2QC*/                     if error_flag <> 0 then do:
/*J2QC*/                        /* SINGLE ITEM LOCATION HAS       */
/*J2QC*/                        /* EXISTING INVENTORY FOR LINE #  */
/*J2QC*/                        {mfmsg03.i 2703 3 pod_line """" """"}
/*J2QC*/                        undo edit-loop ,retry edit-loop.
/*J2QC*/                     end. /* ERROR_FLAG <> 0 */
/*J2QC*/                 end. /* AVAILABLE POD_DET */
/*J2QC*/               end. /* LOC_SINGLE = YES */
/*J2QC*/         end.  /* FOR EACH SR_WKFL */
                     proceed = yes.
                     leave.
                  end.
               end. /* do on endkey..*/
