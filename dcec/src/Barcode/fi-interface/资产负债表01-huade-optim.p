...
ELSE DO:
       ...
       FOR EACH fm_mstr WHERE fm_sums_into = a1 AND (fm_type = "B") AND (fm_dr_cr = direction) NO-LOCK:
        ...
        IF NOT st THEN DO:
         ...
         if totalfm = 110000 or totalfm = 120000 OR totalfm = 130000 OR totalfm = 140000 OR totalfm = 150000 OR totalfm = 211000 or totalfm = 212000  OR totalfm = 220000 OR  totalfm = 210000  then do:
            /* AC_SUM_begin = 0.
           ac_sum_end = 0.
            ...
            fpbalance(totalfm,NO).
             ...
             ac_sum_end = ac_sum_end + netprofit_end.
                 END.
          */
             IF totalfm = 211000 OR totalfm = 212000 THEN DO:
      ...
      IF totalfm = 100000 OR totalfrm = 200000 THEN DO:
