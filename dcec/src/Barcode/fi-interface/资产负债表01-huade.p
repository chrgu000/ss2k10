...
mwrite_begin = NO.
   ...
   IF NOT AVAILABLE fm_mstr  THEN DO:
    FOR EACH ac_mstr01 WHERE ac_mstr01.ac_fpos = a1 NO-LOCK :
               ...
               DO:
                 IF ac_mstr01.ac_code = "31310000" THEN DO:
                  AC_SUM=0.
            balance_begin = fpbalance(90000,"begin",NO).
            netprofit_begin = balance_begin.
                AC_SUM=0.
            balance_end = fpbalance(90000,"end",NO).
                netprofit_end = balance_end.     
            END.
               ELSE DO:  
                ...
                PUT SKIP.
                record = title1 + chr(09) + '"' + ac_mstr01.ac_desc + '"' + chr(09) + '"'+ STRING(mline) + '"' + chr(09) + string(balance_begin) + chr(09) + string(balance_end).
                mline = mline + 1.
                 PUT unformat record.
...
ELSE DO:
       ...
       FOR EACH fm_mstr WHERE fm_sums_into = a1 AND (fm_type = "B") AND (fm_dr_cr = direction) NO-LOCK:
          ...
          if fm_fpos = 110000 or fm_fpos = 120000 OR fm_fpos = 130000 OR fm_fpos= 140000 OR Fm_fpos = 150000 OR fm_fpos = 211000 or fm_fpos = 212000 OR fm_fpos = 213000 OR fm_fpos = 220000  then do:
          PUT SKIP.  
          ...
          isc = yes.
            ...
            AC_SUM=0.
            balance_begin = fpbalance(fm_fpos,"begin",NO).
            AC_SUM=0.
            balance_end = fpbalance(fm_fpos,"end",NO).
           ...
           PUT SKIP.  
           record = title1 + chr(09) + '"' +  fm_desc + '"' + chr(09) + '"'+ STRING(mline) + '"' + chr(09) + string(balance_begin) + chr(09) + string(balance_end).
            mline = mline + 1.
        ...
        IF NOT st THEN DO:
         ...
         if totalfm = 100000 OR totalfm = 110000 or totalfm = 120000 OR totalfm = 130000 OR totalfm = 140000 OR totalfm = 150000 OR totalfm = 211000 or totalfm = 212000  OR totalfm = 220000 OR  totalfm = 210000 OR totalfm = 200000 then do:
             AC_SUM=0.
           balance_begin = fpbalance(totalfm,"begin",NO).
            
             AC_SUM=0.
            balance_end = fpbalance(totalfm,"end",NO).
             IF totalfm = 200000 OR totalfm = 220000 THEN DO:
             balance_begin = balance_begin + netprofit_begin.
             balance_end = balance_end + netprofit_end.
                 END.
           ...
           PUT SKIP. 
           record = title1 + chr(09) + '"' +  totalfmdes + chr(09) + "total" +  '"' + chr(09) + '"'+ STRING(mline) + '"' + chr(09) + string(balance_begin) + chr(09) + string(balance_end).
