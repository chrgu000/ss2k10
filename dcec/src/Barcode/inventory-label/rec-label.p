...
DEFINE VAR receiver like  vep_receiver VIEW-AS FILL-IN SIZE 8 BY 1 LABEL "收货单号".
...
DEFINE FRAME mlabel1
 ...
 DISPLAY receiver part mline standard qty  WITH FRAME a.
...
REPEAT:
 ...
 seta1:
      do transaction on error undo, retry:
         ...
         FIND tr_hist WHERE tr_lot = receiver AND tr_userid = global_userid AND tr_type = "rct-po"  NO-LOCK.
      ...
      do transaction on error undo, retry:
        UPDATE mline WITH FRAME a.
         FIND tr_hist WHERE tr_lot = receiver AND tr_userid = global_userid AND tr_part = part AND tr_type ="rct-po" AND tr_line = mline NO-LOCK.
         IF NOT AVAILABLE tr_hist THEN DO:
