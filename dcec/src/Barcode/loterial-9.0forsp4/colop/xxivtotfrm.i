/* xxivtotfrm.i - DEFINE FORM GTM SALES ORDER TRAILER INCLUDE FILE              */
...
&ENDIF /*GUI*/
   ...
   so_curr
   line_total                     colon 100         NO-ATTR-SPACE  
...
("{&PP_FRAME_NAME}" = "A")) &THEN
 SKIP(.4)  /*GUI*/
&ENDIF /*GUI*/
with frame sotot side-labels width 132 attr-space
