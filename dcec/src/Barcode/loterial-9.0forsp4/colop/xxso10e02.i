/* xxso10e02.i - INVOICE PRINT include file                               */
/* Copyright 1986-2003 QAD Inc., Carpinteria, CA, USA.                  */
/* All rights reserved worldwide.  This is an unpublished work.         */
/* $Revision: 1.8.1.3.3.1 $                                                         */
...
/* $Revision: 1.8.1.3.3.1 $             BY: Vivek Gogte   DATE: 06/24/03  ECO: *P0W1*    */
/******************************************************************************/
...
&SCOPED-DEFINE PP_GUI_CONVERT_MODE REPORT
   ...
   /* MaxLen: Comment: */
   /* Changed Shipped to Invoiced in so10e0d_1_2 */
...
/**   qty_bo       column-label {&so10e02_i_1}  **/
   sod_taxable
   tmp_price    COLUMN-LABEL "Basic Price"   format "->>>>>>>,>>9.99<<<"
   sod_price    COLUMN-LABEL "Final Price"   format "->>>>>>>,>>9.99<<<"
   /*xx*/  surchange  LABEL "CU. Total Surcharge"  format "->>>>>>>,>>9.99<<<"
