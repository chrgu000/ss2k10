/* xxsoivtot8.i - CONSOLIDATED INVOICE TRAILER DETAIL DISPLAY FOR {txnew.i}  */
...
if not et_dc_print then
   ...
   display
      ...
      invtot_linecharge_amt      @ line_charge_total COLUMN-LABEL "Surcharge Amount"
...
/*       surchange  LABEL "Surchange Amt"  **/
   ...
   display
      ...
      ettot_trl3_amt @
      et_trl3_amt
/*xx*       surchange  LABEL "Surchange Amt"  **/
      invtot_tax_amt             @ tax_amt
      ettot_tax_amt @
      et_tax_amt
      so_curr
