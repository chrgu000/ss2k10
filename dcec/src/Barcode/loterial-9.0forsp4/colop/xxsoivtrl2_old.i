/* xxsoivtrl2.i - PENDING INVOICE TRAILER                                       */
...
&ENDIF /*GUI*/
   /**
      ...
      so_fob         colon 15
     so__dec01      COLON 48
      so_ar_acct     colon 15 so_ar_sub no-label so_ar_cc no-label
     ***xx****/
       so_cr_init       colon 15
       so_inv_nbr     colon 48
       ...
       so_cr_card     colon 15
       so_to_inv      colon 48
       so_print_so    colon 70   

         so_stat        colon 15
         so_invoiced    colon 48
         so_print_pl      colon 70   

              so_rev         colon 15
              so_prepaid     colon 48

              so_fob         colon 15
/**xx**/       so__dec01  COLON 48 LABEL "Surchange Amt"  FORMAT "->>>,>>>,>>9.9<<<<<"
              so_ar_acct     colon 15
              so_ar_sub                 no-label
              so_ar_cc                  NO-LABEL
...
/****       so_cr_init     colon 15
              ...
              so_fob         colon 15
              so__dec01  COLON 48 LABEL "Different Amt"  FORMAT "->>>,>>>,>>9.9<<<<<<"
              so_ar_acct     colon 15
              so_ar_sub                 no-label
              so_ar_cc                  no-label
***/
