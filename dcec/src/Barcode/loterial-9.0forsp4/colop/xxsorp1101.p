/* xxsorp1101.p - SALES ORDER INVOICE PRINT FOR ENGLISH PRINT CODE "1"          */
...
/*xx*/  DEFINE VARIABLE spemail2 LIKE ad_attn .
            ...
            DEFINE VARIABLE surchange LIKE tot_prepaid_amt  LABEL "Surcharge Amt" .
...
{fsconst.i}     /* FIELD SERVICE CONSTANTS */
    ...
    with STREAM-IO frame xxivtot side-labels width 132 ATTR-SPACE .
...
/*xx*/   AND SUBSTRING(so__chr01,1,1) = "F"  
   no-lock: end.
...
/**xx**/   invtot_ord_amt = invtot_line_total + invtot_tax_amt  +  invtot_trl1_amt + invtot_trl2_amt + invtot_trl3_amt  .
       ...
       WITH FRAME xxivtot SIDE-LABELS WIDTH 196 .   
