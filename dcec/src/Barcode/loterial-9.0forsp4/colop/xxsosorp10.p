/* xxsosorp10.p  -  SALES ORDER INVOICE PRINT for Variable  Copper rate         */
...
/**xx**/   DEFINE NEW  SHARED VARIABLE mytax   LIKE  ad_gst_id.
...
nbr              colon 15
   ...
   skip(1)
   inv_date         colon 25
   incinv           colon 60 skip
   inv_only         colon 25
   incmemo          colon 60 skip
   print_lotserials colon 25
   call-detail      colon 60
   print_options    colon 25 skip
   conso            colon 25 skip
   comp_addr        colon 25 skip
   form_code        colon 25 deblank skip
   disc_det         colon 25
   disc_sum         colon 25 skip
   space(1)
   msg
   skip
