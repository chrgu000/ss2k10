...
&SCOPED-DEFINE reisslst_p_1 "发放代用品"
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_2 "参考"
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_3 "短缺量"
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_4 "地点"
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_5 "库"
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_6 " 发放数据查看 "
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_7 "多记录"
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_8 "发放"
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_9 "包括领料量"
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_10 "包括备料量"
/* MaxLen: Comment: */

&SCOPED-DEFINE reisslst_p_11 "取消欠交量"
/* MaxLen: Comment: */
...
part           colon 13 LABEL "零件代码"
            ...
            lotserial      colon 58 LABEL "批/序号"
            lotserial_qty  colon 13 LABEL "数量"
            pt_um          no-label
            lotref         colon 58 LABEL "参考"
            sub_comp       colon 13
...
.*H0Q8* * * END DELETE SECTION */
         ...
         cline = "-" + string(pk_part,"x(18)")
                                      ...
                                      END.
                                      ELSE DO:
                                       MESSAGE  pk_part ' ' pk_loc ' ' "当前库位数量不足以作回冲!" view-AS ALERT-BOX  error BUTTONS OK.                                  
