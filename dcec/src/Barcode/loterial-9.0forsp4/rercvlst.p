/* GUI CONVERTED from rercvlst.p (converter v1.71) Tue May 25 23:03:30 1999 */
...
&SCOPED-DEFINE rercvlst_p_1 "总量"
/* MaxLen: Comment: */

&SCOPED-DEFINE rercvlst_p_2 "收货"
/* MaxLen: Comment: */

&SCOPED-DEFINE rercvlst_p_3 "参考"
/* MaxLen: Comment: */

&SCOPED-DEFINE rercvlst_p_4 "换算因子"
/* MaxLen: Comment: */

&SCOPED-DEFINE rercvlst_p_5 "多记录"
/* MaxLen: Comment: */

&SCOPED-DEFINE rercvlst_p_6 " 收货数据查看 "
/* MaxLen: Comment: */

&SCOPED-DEFINE rercvlst_p_7 " 收货数据输入 "
/* MaxLen: Comment: */

&SCOPED-DEFINE rercvlst_p_8 "改变属性"
/* MaxLen: Comment: */
...
/*J04T*/    label {&rercvlst_p_8} no-undo.
...
/*J39K*/ define shared variable eff_date like glt_effdate .
...
pt_desc1       colon 15
        ...
        pt_um          no-label
        location       colon 15
        lotserial      colon 15 vendlot COLON 50 LABEL "供应商批号"
        lotref         colon 15
...
/*J2K7  If the finished items are being received into a warehouse location, set
