/* GUI CONVERTED from woisrc01.p (converter v1.75) Thu Mar 15 23:32:48 2001 */
...
/* REVISION: 9.0      LAST MODIFIED: 05/19/00   BY: *L0XY* Vandna Rohira */
...
&SCOPED-DEFINE woisrc01_p_1 "发放"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_2 "回冲数量"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_3 "Op"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_4 "多记录"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_5 "取消欠交量"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_6 "包括备料量"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_7 "包括领料量"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_8 "库"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_9 " 发放数据查看 "
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_10 "参考"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_11 "短缺量"
/* MaxLen: Comment: */

&SCOPED-DEFINE woisrc01_p_12 "发放代用品"
/* MaxLen: Comment: */
...
/*F0F2*/ define new shared variable setd-action as integer.
 DEFINE VAR mtotal_qty AS INT.
         ...
         DEFINE VAR mavailable_qty AS INT.
          DEFINE NEW SHARED VAR totshort_qty LIKE sr_qty.
...
/*G2D9*  form with frame c 5 down no-attr-space width 80. */
 ...
 SKIP(.1)  /*GUI*/
part           colon 13 LABEL "零件代码"
/*G656*/    op             colon 37 LABEL "工序"
/*G656*     pt_um */
            site           colon 54 LABEL "地点"
            location       colon 68 label {&woisrc01_p_8}
            pt_desc1       colon 13 LABEL "零件描述"
            lotserial      colon 54 LABEL "批/序号"
            lotserial_qty  colon 13 LABEL "数量"
/*G656*/    pt_um          colon 37 LABEL "单位"
            lotref         colon 54 
            sub_comp       colon 13
            cancel_bo
...
/*G2D9*/ row 16 NO-BOX THREE-D /*GUI*/.
...
/*M0L8*/    lad_qty_chg format "->>>>>>9.9<<<<<<"
         with down frame e width 80 title color normal {&woisrc01_p_9} THREE-D /*GUI*/.
...
/*GUI*/ if global-beam-me-up then undo, leave.
                 ...
                 site = pt_site.
                 location = pt_loc.
                              DISPLAY multi_entry WITH FRAME d.
