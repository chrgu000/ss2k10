/* GUI CONVERTED from wowoisrc.p (converter v1.75) Thu Jan 11 21:02:13 2001 */
...
/* REVISION: 9.0      LAST MODIFIED: 02/11/00   BY: *J3P4* Sachin Shinde */
/* REVISION: 9.0      LAST MODIFIED: 02/23/00   BY: *M0JN* Kirti Desai   */
/* REVISION: 9.0      LAST MODIFIED: 03/30/00   BY: *L0TJ* Jyoti Thatte  */
/* REVISION: 9.0      LAST MODIFIED: 01/08/01   BY: *L171* Vivek Gogte   */
     {mfdtitle.i "0+ "}

/* ********** Begin Translatable Strings Definitions ********* */

&SCOPED-DEFINE wowoisrc_p_1 "多记录"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_2 "复合产品/副产品收货选项"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_3 "取消欠交量"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_4 "发放"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_5 "           收货量 = 缺缺量"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_6 "结算"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_7 "回冲"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_8 "换算因子"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_9 "发放代用品"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_10 "短缺量"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_11 "收货"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_12 "收到所有的复合产品/副产品"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_13 "设置属性"
/* MaxLen: Comment: */

&SCOPED-DEFINE wowoisrc_p_14 "总装加工单不允许加工单收货"
/* MaxLen: Comment: */
...
define NEW shared variable vendlot like tr_vend_lot.
     ...
     define variable issue like mfc_logical label {&wowoisrc_p_7} initial yes.
     define variable receive like mfc_logical label {&wowoisrc_p_11} initial yes.
...
FORM /*GUI*/ 
 ...
 SKIP(.1)  /*GUI*/
wo_nbr      colon 12 LABEL "加工单" wo_lot LABEL "标识"     eff_date LABEL "生效日期"   colon 68
/*G782      wo_part     colon 12 wo_status   issue       colon 68 */
/*G782      desc1       at 14 no-label       receive     colon 68 */
/*G782*/    wo_part LABEL "零件代码"    colon 12 wo_status LABEL "状态"   receive     colon 68
...
/*J046*/       jp = no.
        nbr = "".
        display eff_date issue receive with frame a.
