...
define SHARED variable site     like si_site      no-undo.
...
define SHARED variable part1    like pt_part      no-undo.
     ...
     DEFINE  SHARED VAR pre-freeze LIKE sct_rollup NO-UNDO.
...
define SHARED variable frz_flag like mfc_logical initial yes
                         label  "Freeze/Unfreeze"
                         format "Freeze/Unfreeze" no-undo.
define variable audit_yn like mfc_logical initial NO
