...
/*N0GV*/          getTermLabel("R_E_C_E_I_V_E_R",20)   at 33 format "x(20)"
...
/*N0GV*/          getTermLabelRtColon("PRINT_DATE",18) to 68 format "x(18)"
                  pdate
                  vendor[3]           at 11
/*N0GV*           {&porcrp_p_16}   to 68 */
/*N0GV*/          getTermLabelRtColon("PURCHASE_ORDER",18) to 68 format "x(18)"
                  prh_nbr
                  vendor[4]           at 11
