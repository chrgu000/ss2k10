...
/*GUI mainloop removed */
       ...
       /********************************************************** ***************************************************************************************/
           /*   DEFINE VARIABLE l1 AS CHAR LABEL "采购员".
              DEFINE VARIABLE l2 AS CHAR LABEL "复核".
              DEFINE VARIABLE l3 AS CHAR LABEL "核准".
              DEFINE VARIABLE maglabel AS CHAR.
              DEFINE VARIABLE magfinance AS CHAR.
              DEFINE VARIABLE magpurchase AS CHAR.
              ...
              DISPLAY 
                 ...
                 WITH FRAME k.  */
           FORM HEADER
             "核准:_____________________  复核:_______________________采购员:_________________________"
               SKIP(1)
               "白联:厂商  红联:财务   绿联:采购"  
               SKIP(1)
              "备注：禁止使用一级环境管理物质"
           ...
           WITH FRAME kk PAGE-BOTTOM STREAM-IO WIDTH 100.
           VIEW FRAME kk.
           /****************************************************************************************************************************************************/
...
/*N01B*/          {gprun.i ""xxporp0301.p"" "(input update_yn)"}                                                     /*********************************对xxporp0301.p的引用*******************************/
/*H0KS*/       end.

/*N01B**       {gprun.i  """porp03"" + run_file + "".p"""} */
/*N01B*/       {gprun.i  """xxporp03"" + run_file + "".p""" "(input update_yn)"}                               /*********************************对xxporp0301.p的引用*******************************/
