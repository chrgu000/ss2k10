...
REPEAT:
 ...
 chExcelApplication:selection:Font:Name = "楷体_gb2312".
  ...
  chExcelApplication:selection:Font:bold = TRUE.
      ...
      chWorkSheet:Range("b1:b1"):VALUE = "产品代码".
 chWorkSheet:Range("c1:c1"):VALUE = "产品名称".
    chWorkSheet:Range("d1:d1"):VALUE = "图号".
      chWorkSheet:Range("e1:e1"):VALUE =  "采购周期".
      chWorkSheet:Range("f1:f1"):VALUE = "下达号".
      chWorkSheet:Range("g1:g1"):VALUE = "应到日期".
      chWorkSheet:Range("h1:h1"):VALUE = "实交日期".
      chWorkSheet:Range("i1:i1"):VALUE = "下达数".
      chWorkSheet:Range("j1:j1"):VALUE = "准时实交数".
      chWorkSheet:Range("k1:k1"):VALUE = "滞后实交数".
      chWorkSheet:Range("l1:l1"):VALUE = "未交数".
