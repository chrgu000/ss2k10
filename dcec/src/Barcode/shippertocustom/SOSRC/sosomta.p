/* GUI CONVERTED from sosomta.p (converter v1.75) Sat May  5 08:31:09 2001 */
...
/* REVISION: 9.0      LAST MODIFIED: 04/22/01   BY: *M11Z* Jean Miller       */

          {mfdeclre.i}

         /* ********** Begin Translatable Strings Definitions ********* */

         &SCOPED-DEFINE sosomta_p_1 "退货数量"
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_2 "重新定价"
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_3 "退货量"
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_4 "承诺日期"
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_5 "说明"
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_6 "零件无库存"
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_7 "预期日期"
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_8 "折扣"
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_9 "到期日期"
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_10 "  退料核准单发放项  "
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_11 " 退料核准单收货项 "
         /* MaxLen: Comment: */

         &SCOPED-DEFINE sosomta_p_12 "     客户订单项     "
         /* MaxLen: Comment: */
...
/*M11Z*/ define            variable use-cmf          as logical no-undo.
...
/*K0G6*/          find first po_mstr where po_nbr = sod_btb_po no-lock no-error.
...
/*K004*/       end.  /* if not del-yn */
               ...
               if del-yn = yes then do:
                  ...
                  find first wo_mstr where wo_nbr =
                     (sod_nbr + "." + string(sod_line)) and
                     wo_part = sod_part no-lock no-error.
...
/*GUI*/ if global-beam-me-up then undo, leave.
                     ...
                     /* DISPLAY ERROR MESSAGE RETURN FROM SOCRAM01.P */
