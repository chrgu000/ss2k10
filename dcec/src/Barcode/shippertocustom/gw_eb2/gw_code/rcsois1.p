...
/*GUI*/ if global-beam-me-up then undo, leave.
 ...
 isstop = NO.
      FOR EACH  so_mstr WHERE   so_INV_nbr <> '' AND  so_bol <> '' NO-LOCK BY so_nbr DESC:
      
       
      
      FIND FIRST abs_mstr WHERE substr(abs_mstr.ABS_par_id,2,50) = INPUT ABS_id  AND abs_mstr.abs_order = so_nbr   NO-LOCK  NO-ERROR.
     ...
     FIND FIRST ABS_mstr WHERE substr(ABS_mstr.ABS_id,2,50) = so_bol NO-LOCK NO-ERROR.
