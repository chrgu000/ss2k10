/* GUI CONVERTED from rercvlst.p (converter v1.78) Fri Oct 29 14:34:01 2004 */
...
/*GUI*/ if global-beam-me-up then undo, leave.
  ...
  DISP multi_entry WITH FRAME a.
        ...
        next-prompt path WITH FRAME a.

             END.
         {&RERCVLST-P-TAG5}

        /* If the finished items are being received into a warehouse location,
