/* GUI CONVERTED from woisrc02.p (converter v1.78) Fri Oct 29 14:34:26 2004 */
...
/* $Revision: 1.35.1.4 $  BY: Sukhad Kulkarni      DATE: 09/06/04 ECO: *P2J6* */
/******************************************************************************/
...
/*DEF NEW SHARED VAR isenditem AS LOGICAL .*/
DEF NEW SHARED VAR path AS CHAR. FORMAT "x(20)".
DEF NEW SHARED VAR mpart LIKE wod_part.
{gpglefv.i}
