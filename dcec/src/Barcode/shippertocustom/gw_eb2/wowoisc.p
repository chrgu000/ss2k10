/* GUI CONVERTED from wowoisc.p (converter v1.78) Fri Oct 29 14:34:26 2004 */
...
/* Revision: 1.28.1.3      BY: Shoma Salgaonkar   DATE: 10/09/03  ECO: *P15S* */
/* Revision: 1.28.1.11     BY: Mike Dempsey       DATE: 11/27/03  ECO: *N2GM* */
/* $Revision: 1.28.1.12 $ BY: Max Iles         DATE: 07/08/04  ECO: *N2VQ* */
...
{&WOWOISC-P-TAG4}
FORM /*GUI*/  with frame c 5 down no-attr-space width 80 THREE-D /*GUI*/.
