/* GUI CONVERTED from woworc.p (converter v1.78) Fri Oct 29 14:34:26 2004 */
...
/* Revision: 1.26.1.3    BY: Vivek Gogte           DATE: 08/06/03 ECO: *P0Z2* */
/* Revision: 1.26.1.7    BY: Mike Dempsey          DATE: 11/27/03 ECO: *N2GM* */
/* Revision: 1.26.1.8    BY: Vandna Rohira         DATE: 01/28/04 ECO: *P1LK* */
/* $Revision: 1.26.1.9 $ BY: Robin McCarthy        DATE: 03/10/04 ECO: *P15V* */
...
DEF NEW SHARED VAR path AS CHAR FORMAT "x(20)" LABEL "½Ó¿Ú".
{&WOWORC-P-TAG1}
{&WOWORC-P-TAG5}
               ...
               if using_supplier_consignment then do:
                  {gprunmo.i &program = ""pocnsix4.p"" &module  = "ACN"
                     &param  =  """(input womstr.wo_part,
                                    ...
                                    input
                                       right-trim(substring(sr_lotser,1,18)),
                                    input sr_ref,
