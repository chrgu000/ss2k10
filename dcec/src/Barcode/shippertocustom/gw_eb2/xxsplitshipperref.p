...
DEFINE VAR split_qty LIKE ABS_qty LABEL "开票数量" INITIAL "0".
...
REPEAT:
   ...
   /* DO TRANSACTION ON ERROR UNDO,RETRY:*/
    ...
    END.
     ...
     /* DO TRANSACTION ON ERROR UNDO,RETRY:*/
        ...
        UPDATE split_qty WITH FRAME a.
        IF split_qty <= 0  THEN DO:
          MESSAGE "数量不能为零!" VIEW-AS ALERT-BOX BUTTON OK. 
          next-prompt split_qty WITH FRAME A.
          UNDO,RETRY.
  ...
  FOR EACH ABSmstr2 WHERE absmstr2.abs_par_id <> "" AND  absmstr2.ABS_par_id = absmstr1.ABS_id AND absmstr2.abs_order <> "" AND absmstr2.abs_line <> "" AND absmstr2.abs_item = part  NO-LOCK :
      tot_qty = tot_qty + absmstr2.ABS_qty.
       ...
       END.
   IF tot_qty > split_qty THEN iscontinue = YES.
   ...
   IF iscontinue THEN DO:
        ...
        BUFFER-COPY
            absmstr1
              EXCEPT ABS_mstr.ABS_id abs_mstr.abs__qad01
             TO ABS_mstr
             ASSIGN ABS_mstr.ABS_id = absmstr1.ABS_id + "-" + STRING(mrecno)
           abs_mstr.abs__qad01 =  substring(abs_mstr.abs__qad01,1,40) + STRING(substring(ABS_mstr.ABS_id,2),"x(20)") .
            DISPLAY  abs_mstr.ABS_id ABS_mstr.abs_shipto WITH FRAME b. 
        FIND ABSmstr2 WHERE absmstr2.abs_par_id <> "" AND  absmstr2.ABS_par_id = absmstr1.ABS_id AND absmstr2.abs_order <> "" AND absmstr2.abs_line <> "" AND absmstr2.abs_item = part AND absmstr2.ABS_qty >= split_qty NO-LOCK  NO-ERROR.
            ...
            IF AVAILABLE absmstr2 THEN DO:
               ...
               FIND ABS_mstr WHERE RECID(ABS_mstr) = RECID(absmstr2) EXCLUSIVE-LOCK NO-ERROR.
                IF absmstr2.ABS_qty = split_qty THEN DELETE ABS_mstr.
                  ELSE  ABS_mstr.ABS_qty = absmstr2.ABS_qty - split_qty.

                           
                
                END.
                ELSE DO:
                 remain_qty = split_qty.
                  FOR EACH ABSmstr2 WHERE absmstr2.abs_par_id <> "" AND  absmstr2.ABS_par_id = absmstr1.ABS_id AND absmstr2.abs_order <> "" AND absmstr2.abs_line <> "" AND absmstr2.abs_item = part NO-LOCK  :
                     CREATE ABS_mstr.
               BUFFER-COPY 
                   absmstr2
