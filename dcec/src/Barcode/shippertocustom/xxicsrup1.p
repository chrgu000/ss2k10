/* GUI CONVERTED from icsrup1.p (converter v1.78) Fri Oct 29 14:33:30 2004 */
...
/* $Revision: 1.5.3.2 $   BY: Dorota Hohol      DATE: 08/25/03 ECO: *P0ZL* */
/******************************************************************************/
...
DEFINE SHARED VAR part LIKE wod_part. /*peter*/
DEF VAR mavailable_qty AS DECIMAL. /*peter*/
DEF VAR mremain_qty AS DECIMAL. /*peter*/
...
/*FOR EACH sr_wkfl where sr_userid = mfguser
                                       ...
                                       sr_qty = 0.
                                       END.*/
                    /*peter*/                    FOR EACH sr_wkfl where sr_userid = mfguser
                                            and sr_lineid = cline
                                            and sr_site = base_site
                                            and sr_loc = location
                                            /*AND ( sr_lotser <> ""
