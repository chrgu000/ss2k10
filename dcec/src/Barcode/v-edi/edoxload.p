...
DEF VAR isfirst AS LOGICAL INITIAL YES.
DEF  VAR ismerge AS LOGICAL INITIAL NO.
DEF  VAR pre_vend AS CHAR.
DEF  VAR ISOUT_T AS LOGICAL INITIAL NO.
DEF  VAR XXBUFFER_LINE AS CHAR.
...
break by edxfs_dtg_name
 ...
 FIND FIRST tt_document WHERE  substring(tt_line,1,4) = '830a' NO-LOCK.
   ...
   for each tt_document exclusive-lock:
      ...
      IF SUBSTRING(TT_LINE,1,4) <> '830T' THEN put unformatted tt_line skip.
           IF SUBSTRING(TT_LINE,1,4) = '830T' THEN XXBUFFER_LINE = TT_LINE.
      ...
      ELSE DO:
          ...
          ELSE DO:
               IF ISOUT_T THEN DO:
          put unformatted XXBUFFER_line skip.
           ISOUT_T = NO.
           END.
            IF SUBSTRING(TT_LINE,1,4) <> '830T' THEN   put unformatted tt_line skip.
             IF SUBSTRING(TT_LINE,1,4) = '830T' THEN XXBUFFER_LINE = TT_LINE.
 IF substring(tt_line,1,4) = '830a' THEN PRE_VEND = SUBSTRING(tt_line,6,5).
          END.
          END.
           delete tt_document.
   end.
