...
define variable nbr1 like po_nbr format "x(8)" no-undo.
...
update po_nbr label "采购单" colon 22 skip with width 80 side-labels frame a.
 update nbr1 label "采购单" colon 22 skip with width 80 side-labels frame a.
...
{gpselout.i &printType = "printer"
 ...
 for each prh_ where prh_nbr >= po_nbr and prh_nbr <= nbr1 and prh_rcp_date
