/* GUI CONVERTED from arcsrp05.p (converter v1.77) Wed Aug 27 01:21:48 2003 */
...
&SCOPED-DEFINE arcsrp02_p_a "Formular SPP/International"
&SCOPED-DEFINE arcsrp02_p_b "Show amount in '000s"
...
define new shared variable summary_only like mfc_logical
   label {&arcsrp05_p_9} format {&arcsrp05_p_9} initial yes.
...
DEFINE NEW SHARED VARIABLE formular LIKE mfc_logical LABEL {&arcsrp02_p_a} INITIAL NO FORMAT "International/SPP".
DEFINE NEW SHARED VARIABLE DISP_unit LIKE mfc_logical LABEL {&arcsrp02_p_b} INITIAL NO FORMAT "Yes/No ".
define new shared variable ardate  LIKE ar_effdate. 
...
FORM /*GUI*/ 
 ...
 SKIP(.1)  /*GUI*/
   cust          LABEL "销往" colon 15
   cust1          label "至" colon 49 SKIP
   ardate         LABEL "生效日期" colon 15 FORMAT "99/99/99"
   effdate1       LABEL "至" colon 49 skip
   et_report_curr  LABEL "报表币种" colon 49
    formular COLON 49
    DISP_unit COLON 49
    SKIP
    SKIP
