...
REPEAT:
    UPDATE b_shp  btn_exec WITH FRAME a.
END.
/*
          ...
          DO ON ERROR UNDO, LEAVE:
                           ...
                           RUN soship (INPUT packqty, INPUT shpqty, INPUT recno).
                                              IF NOT succeed  THEN DO:
                                               ...
                                               END.
                                               ELSE DO:
                                                        RUN succeedproc (INPUT t_part, INPUT t_lot, INPUT "FINI-GOOD",  INPUT "SHIPPMENT", INPUT "SUCCEED", INPUT "",INPUT "FINI-SHIP"). 
    ...
    IF AVAILABLE b_bf_det THEN DO:
        ...
        IF AVAILABLE ABS_mstr THEN DO:
               FOR EACH absmstr WHERE absmstr.ABS_par_id = ABS_mstr.ABS_id:
                   ...
                   CREATE b_trs_det.
                   ASSIGN b_trs_shipper =bfdet.b_bf_abs_id
                       b_trs_site = bfdet.b_bf_site
                       b_trs_part = absmstr.ABS_item
                       b_trs_f_loc = bfdet.b_bf_loc
                       b_trs_t_loc = bfdet.b_bf_toloc
               ...
               END.
        END.
     {gprun.i ""soshpprt01.p"" " (INPUT bfdet.b_bf_abs_id)"}.
    END.
    /*STATUS INPUT "打印程序完成".*/
END.    
        ...
        FOR EACH b_shp_wkfl WHERE b_shp_batch = batchid AND b_shp_type = "TRANS"
            ...
            IF LAST-OF(b_shp_part) THEN DO:
                ...
                ASSIGN b_trs_shipper = shippernbr
                    ...
                    b_trs_qty = (ACCUMU SUB-TOTAL BY b_shp_part  b_shp_qty) * -1
