/* xwloiq02.p - LOCATION PART INQUIRY BY SITE       by atosorigin 05/20/04    */
/* icloiq02.p - LOCATION PART INQUIRY BY SITE                                 */
...
/* REVISION: 7.3      LAST MODIFIED: 03/15/95   BY: pxd *F0LZ**/
/* REVISION: 8.6      LAST MODIFIED: 02/17/98   BY: *K1HK* Beena Mol          */
/* REVISION: 8.6E     LAST MODIFIED: 02/23/98   BY: *L007* A. Rahane          */
/* REVISION: 8.6E     LAST MODIFIED: 10/04/98   BY: *J314* Alfred Tan         */
/* REVISION: 8.6E     LAST MODIFIED: 12/07/99   BY: *L0MH* Vivek Gogte        */
...
repeat:
   ...
   if c-application-mode <> 'web' then
      update site part loc lot stat with frame a
   editing:
   ...
   {wbrp06.i &command = update &fields = "  site part loc lot stat"
      &frm = "a"}
   ...
   loopa:
   for each in_mstr no-lock where in_site = site
         and (in_part = part or part = "")
...
/*zx*/	delete xwo_wk.
/*zx*/end.      
/*zx*/for each xwosd_det where  xwosd_bkflh  = no and xwosd_used = yes and xwosd_site = in_site and xwosd_part = in_part and (xwosd_loc = loc or loc = "") 
...
/*zx       find is_mstr where is_status  = ld_status no-lock no-error.*/
