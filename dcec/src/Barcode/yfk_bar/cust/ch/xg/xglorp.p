...
/* modified by Tracy on 01/13/05              /*zx01*/                      */
...
/*zx01*/ define variable vendpart like vp_vend_part.
...
*xw0619*/
      ...
      on endkey undo, leave loopa with frame c width 200:
/*xw0619*/ setFrameLabels(frame c:handle).

         {mfrpchk.i}

/*zx01*/ find first vp_mstr where vp_part  = ld_part no-lock no-error.
/*zx01*/if available vp_mstr then vendpart = vp_vend_part.
/*zx01*/else vendpart = "".
