...
/* Last Modified: xwh         2006.04.04                              *X01*   */
...
DEFINE VARIABLE ptprice LIKE pt_price.
...
repeat:
   ...
   break by in_site by in_part with frame b width 190:
...
**H01*********/
/*x01 add the sales price*********/
                  ptprice = 0.
                  pclist = ''.
                  FIND FIRST sod_det WHERE sod_part = t_lddet_part 
                      AND sod_consign_loc = t_lddet_loc 
                      AND sod_sched = YES NO-LOCK NO-ERROR.
                  IF AVAILABLE sod_det THEN DO:
                      FOR LAST pc_mstr WHERE pc_list = sod_pr_list 
                          AND pc_part = sod_part
                          AND pc_start <= TODAY  NO-LOCK BY pc_start:
                            ptprice = pc_amt[1].
                            pclist = pc_list.
                      END.
                  END.
...
/*H01*/              t_lddet_loc
                     ...
                     pclist LABEL "价格单"
/*x01*/              ptprice label "价格表价格"
/*H01*/              l_non_consign_qoh label "未经委托"
/*H01*/              tot_cust_consign_qty  label "客户委托"
/*H01*/              tot_supp_consign_qty  label "供应商委托"
                     WITH WIDTH 260.
                  down.
