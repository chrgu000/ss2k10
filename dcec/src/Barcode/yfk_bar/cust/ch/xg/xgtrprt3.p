...
DEFINE VAR trshipper LIKE xgtr_shipper.
...
FORM 
    SKIP(1)
    trshipper COLON 20 SKIP 
WITH FRAM a SIDE-LABEL WIDTH 80.
mainloop:
 REPEAT:
        ...
        IF AVAILABLE xgtr_det THEN DO:
            ...
            break by xgtr_shipper by xgtr_part:
                ...
                temp_cust_part = "".
                find first cp_mstr where cp_part = xgtr_part no-lock no-error.
            ...
            IF i1 < 12  and i1 <> 0 THEN DO:
                ...
                i1 = 0.
            END. 
        END. /*end for if available xgtr_det then do*/
        ELSE DO:
