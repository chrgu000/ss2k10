/* GUI CONVERTED from woworla2.p (converter v1.75) Tue Apr 10 12:09:09 2001 */
...
for each pk_det exclusive-lock where pk_user = mfguser:
   ...
   assign
      pkpart = pk_part
      pkstart = pk_start
      pkop = /*integer(pk_reference)*/ pk_reference
      pkend = pk_end
      pkqty = pk_qty
      pkbombatch = bombatch
      pkltoff = ltoff.
