...
/*xw0624* {mfdtitle.i "2+ "} */
/*xw0624*/ {mfdeclre.i}
/*xw0624*/ define input parameter pnbr like po_nbr.
/*xw0624*/ define input parameter effdate as date.
...
/*xw0624* {gprun.i ""poporcm.p""} */

/*xw0624*/ {gprun.i ""xkpoporcm.p"" "(input pnbr, input effdate)"}
