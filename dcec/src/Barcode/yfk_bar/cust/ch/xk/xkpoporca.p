...
/* LAST MODIFIED: 12/27/2005        BY: HOU                           *H01*   */
...
/*H01*/
define input parameter xlot as   char.
...
/*H01*/
define variable xxlot          as   char format "x(18)" label "批号"  no-undo.
...
/*H01*/        xxlot when ((not multi_entry) and l_getlot
/*H01*/        and not (is_wiplottrace_enabled() and pod_type = "s"))
               cmmt_yn
               /*@TO-DOEND*/
            with frame d
               editing:
