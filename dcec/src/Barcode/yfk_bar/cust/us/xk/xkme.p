...
DEFINE VARIABLE bcode AS CHARACTER.
...
MESSAGE b_co_part VIEW-AS ALERT-BOX.
    ...
    MESSAGE "确认完成扫描？" VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO UPDATE yn.
    IF yn = YES THEN DO:
    
      FOR EACH co_list NO-LOCK:
         MESSAGE "view-co-list" VIEW-AS ALERT-BOX.
