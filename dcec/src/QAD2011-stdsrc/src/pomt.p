/* GUI CONVERTED from pomt.p (converter v1.78) Fri Mar 25 06:08:38 2011 */
...
/* Revision: 1.13.2.30.1.8  BY: Sandeep Panchal DATE: 08/08/08 ECO: *Q1QT*  */
/* Revision: 1.13.2.30.1.9  BY: Chandrakant Ingle DATE: 10/28/09 ECO: *Q3KM*  */
/* Revision: 1.13.2.30.1.10  BY: Chandrakant Ingle DATE: 02/02/10 ECO: *Q3T3* */
/* $Revision: 1.13.2.30.1.11 $             BY: Priti Jha         DATE: 03/23/11 ECO: *Q4PX* */
/*-Revision end---------------------------------------------------------------*/
      ...
      editing:
         ...
         then do:
            ...
            {mfnp01.i
               ...
               po_nbr
               po_type
               " po_mstr.po_domain = global_domain and ""B"" "
               po_type}
         end. /*ELSE blanket = false*/
...
------------------------------------------------------------------------------*/
   ...
   if (c-application-mode <> "API" and p_po_nbr <> "") then
      {&POMT-P-TAG4}
      ponbr = p_po_nbr.
      {&POMT-P-TAG5}
   else
...
/*GUI*/ if global-beam-me-up then undo, leave.
      ...
      if c-application-mode = "API" and retry then
         return error.
      if (c-application-mode <> "API" and p_po_nbr = "") or
