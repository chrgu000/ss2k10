/* GUI CONVERTED from popomtb.p (converter v1.78) Tue Feb  7 05:45:36 2012 */
...
/* Revision: 1.15.3.19     BY: Rajaneesh Sarangi  DATE: 08/29/02  ECO: *M1BY* */
...
/* Revision: 1.15.3.29     BY: Nishit Vadhavkar   DATE: 08/02/03  ECO: *P0Y8* */
/* Revision: 1.15.3.30     BY: Nishit Vadhavkar   DATE: 08/02/03  ECO: *Q01Z* */
/* Revision: 1.15.3.31     BY: Ed van de Gevel    DATE: 12/24/03  ECO: *Q04S* */
/* Revision: 1.15.3.33     BY: Preeti Sattur      DATE: 01/27/04  ECO: *P1LG* */
/* Revision: 1.15.3.33.2.1 BY: Robin McCarthy     DATE: 08/11/05  ECO: *P2PJ* */
/* Revision: 1.15.3.33.2.2 BY: Robin McCarthy     DATE: 03/01/06  ECO: *P4JX* */
/* Revision: 1.15.3.33.2.3 BY: Sushant Pradhan    DATE: 03/07/06  ECO: *P3XF* */
/* Revision: 1.15.3.33.2.4 BY: Rafiq S.           DATE: 11/09/06  ECO: *P5DQ* */
/* Revision: 1.15.3.33.2.5 BY: Russ Witt          DATE: 03/19/07  ECO: *P5RF* */
/* Revision: 1.15.3.33.2.6 BY: Antony LejoS       DATE: 11/20/07  ECO: *P6CP*  */
/* Revision: 1.15.3.33.2.7 BY: Antony LejoS       DATE: 11/28/07  ECO: *P6FS* */
/* Revision: 1.15.3.33.2.8 BY: Anju Dubey         DATE: 12/12/07  ECO: *P6GV* */
/* $Revision: 1.15.3.33.2.9 $ BY: Ed van de Gevel Date: 02/07/12 ECO: *Q579* */
...
/*GUI*/ if global-beam-me-up then undo, leave.
      ...
      for first edtpparm_mstr
         fields(edtpparm_domain edtpparm_addr edtpparm_char edtpparm_char_desc
         edtpparm_int edtpparm_int_desc)
         where edtpparm_domain = global_domain
         and   edtpparm_addr   = po_vend
         and   po_site         = ""
      no-lock:
         repeat l_index = 1 to extent(edtpparm_char):
            if edtpparm_char_desc[l_index] =  "PO Doc Name"
            then
               assign
         ...
         repeat l_index = 1 to extent(edtpparm_int):
            if edtpparm_int_desc[l_index] =  "PO Doc Vers"
            then
               assign
