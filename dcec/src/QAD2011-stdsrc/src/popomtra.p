/* GUI CONVERTED from popomtra.p (converter v1.78) Thu Dec  6 01:56:55 2007 */
...
/* $Revision: 1.24 $ BY: Vivek Kamath     DATE: 12/06/07  ECO: *P6G7* */
/*-Revision end---------------------------------------------------------------*/
...
define input parameter p_tol_cost_chk like mfc_logical no-undo.
...
with frame cac side-labels
   overlay row 10 width 80 no-attr-space NO-BOX THREE-D /*GUI*/.

 DEFINE VARIABLE F-cac-title AS CHARACTER INITIAL "".
 RECT-FRAME-LABEL:SCREEN-VALUE in frame cac = F-cac-title.
 RECT-FRAME-LABEL:HIDDEN in frame cac = yes.
 RECT-FRAME:HEIGHT-PIXELS in frame cac =
  FRAME cac:HEIGHT-PIXELS - RECT-FRAME:Y in frame cac - 2.
 RECT-FRAME:WIDTH-CHARS IN FRAME cac = FRAME cac:WIDTH-CHARS - .5.  /*GUI*/
