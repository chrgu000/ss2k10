...
/*GUI*/ {mfguirpb.i &flds=" {&POPORP06-P-TAG4} rdate rdate1 vendor vendor1 part part1 site site1 pj pj1 fr_ps_nbr to_ps_nbr sel_inv sel_sub ers-only sel_mem uninv_only supplier_consign use_tot show_sub base_rpt l_inc_log sort_by "} /*Drive the Report*/
