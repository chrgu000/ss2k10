/* GUI CONVERTED from ppptmta.p (converter v1.78) Mon Sep 12 06:45:46 2011 */
...
/* Revision: 1.61.2.17   BY: Ambrose Almeida  DATE: 07/07/11   ECO: *Q4X1*    */
/* $Revision: 1.61.2.18 $  BY: Dipali Parkar  DATE: 09/12/11   ECO: *Q50Z*  */
...
define variable l_pt_user1       like pt_user1                  no-undo.
define variable l_pt_user2       like pt_user2                  no-undo.
...
/*GUI*/ if global-beam-me-up then undo, leave.
               ...
               if c-application-mode <> "API" then do:
                  ...
                  if batchrun
                     and not ({gppswd1.v  &field=""pt_um""
                                          &field1="pt_um"})
                  then do:
                        /* USER DOES NOT HAVE ACCESS TO THIS FIELD */
                        {pxmsg.i &MSGNUM=2186 &ERRORLEVEL=3}
...
/*GUI*/ if global-beam-me-up then undo, leave.
            ...
            if not regen_add
               ...
               or   l_pt_user1     <> pt_user1
               or   l_pt_user2     <> pt_user2
