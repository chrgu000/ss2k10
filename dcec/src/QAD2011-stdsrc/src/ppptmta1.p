/* GUI CONVERTED from ppptmta1.p (converter v1.78) Thu Sep 29 05:54:58 2011 */
...
/* $Revision: 1.38.2.3 $  BY: Nisha Thasale DATE: 09/28/11  ECO: *Q51Y*  */
/*-Revision end---------------------------------------------------------------*/
...
/*GUI*/ if global-beam-me-up then undo, leave.
      ...
      if l_pt_prod_line <> pt_prod_line
      then do:

         /* VALIDATE FIELD SECURITY FOR FIELD pt_prod_line */
      ...
      end. /* IF l_pt_prod_line <> pt_prod_line */
