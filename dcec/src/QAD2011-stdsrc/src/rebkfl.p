/* GUI CONVERTED from rebkfl.p (converter v1.78) Thu Oct 20 23:25:49 2011 */
...
/* Revision: 1.43     BY: Narathip W.        DATE: 04/21/03 ECO: *P0Q9*       */
...
/* Revision: 1.50.1.1 BY: Sukhad Kulkarni    DATE: 07/07/05 ECO: *P3S1*       */
/* Revision: 1.50.1.2 BY: Amit Singh         DATE: 12/20/05 ECO: *P4CM*       */
/* Revision: 1.50.1.3 BY: Jean Miller        DATE: 01/11/06 ECO: *Q0PD*       */
/* Revision: 1.50.1.5 BY: Munira Savai       DATE: 04/26/06 ECO: *P4PN*       */
/* Revision: 1.50.1.6 BY: Amit Singh         DATE: 06/23/06 ECO: *P4RH*       */
/* Revision: 1.50.1.7 BY: Ambrose Almeida    DATE: 12/11/06 ECO: *P5HY*       */
/* Revision: 1.50.1.8 BY: Ruma Bibra         DATE: 06/07/07 ECO: *P5YN*       */
/* Revision: 1.50.1.9 BY: Ambrose Almeida    DATE: 03/06/08 ECO: *P6N7*       */
/* Revision: 1.50.1.10 BY: Ambrose Almeida    DATE: 04/11/08 ECO: *P6QM*      */
/* Revision: 1.50.1.11 BY: Ambrose Almeida    DATE: 09/12/08 ECO: *Q1SZ*      */
/* Revision: 1.50.1.12 BY: Winnie Ouyang      DATE: 03/02/09 ECO: *Q2HR*      */
/* Revision: 1.50.1.13   BY: Ravi Swami     DATE: 08/25/10 ECO: *Q4BF*      */
/* Revision: 1.50.1.14   BY: Priti Jha DATE: 09/14/11  ECO: *Q50W*  */
/* $Revision: 1.50.1.15 $ BY: Nisha Thasale DATE: 10/19/11  ECO: *Q52T*  */
/*-Revision end---------------------------------------------------------------*/
...
define variable lotserials_req       as logical     no-undo.
...
/*GUI*/ if global-beam-me-up then undo, leave.
 /* FOR FIRST wr_route */
      ...
      then do:
         ...
         for first next_wr_route
            fields (wr_auto_lbr  wr_desc wr_lot  wr_mch
                    wr_milestone wr_op   wr_part wr_run
                    wr_wkctr     wr_domain)
            where  next_wr_route.wr_domain = global_domain
            and    next_wr_route.wr_lot    = cumwo_lot
            and    next_wr_route.wr_op     = l_next_op
         no-lock:
         end. /* FOR FIRST next_wr_route */
         ...
         then do:
            ...
            then do:
               ...
               {pxmsg.i &MSGNUM=6937 &ERRORLEVEL=2}

            end.  /* IF (not next_wr_route.wr_milestone) */

         end.  /* IF AVAILABLE next_wr_route */
