/* GUI CONVERTED from rspomt.p (converter v1.78) Thu Jan  6 02:54:53 2011 */
...
/* Revision: 1.11.2.23.2.1 BY: Robin McCarthy     DATE: 08/11/05  ECO: *P2PJ* */
/* Revision: 1.11.2.23.2.2 BY: Robin McCarthy     DATE: 03/01/06  ECO: *P4JX* */
/* Revision: 1.11.2.23.2.3 BY: Suyash Keny        DATE: 08/23/06  ECO: *P530* */
/* Revision: 1.11.2.23.2.4 BY: Rafiq S.           DATE: 11/09/06  ECO: *P5DQ* */
/* Revision: 1.11.2.23.2.5 BY: Prerita Joshi      DATE: 02/09/07  ECO: *P5NL* */
 /*Revision: 1.11.2.23.2.6 BY: Nancy Philip       DATE: 04/13/07  ECO: *P5TB* */
/* Revision: 1.11.2.23.2.7 BY: Antony LejoS       DATE: 11/20/07  ECO: *P6CP*  */
/* Revision: 1.11.2.23.2.8    BY: Antony LejoS     DATE: 11/28/07  ECO: *P6FS* */
/* Revision: 1.11.2.23.2.9    BY: Anju Dubey     DATE: 12/12/07  ECO: *P6GV* */
/* Revision: 1.11.2.23.2.10  BY: Ravi Swami     DATE: 05/12/09  ECO: *Q2VM* */
/* $Revision: 1.11.2.23.2.11 $  BY: Priti Jha      DATE: 01/06/11  ECO: *Q4KX* */
/*-Revision end---------------------------------------------------------------*/
...
/*GUI*/ if global-beam-me-up then undo, leave.
         ...
         for first ac_mstr
            where ac_mstr.ac_domain = global_domain and
            ac_code = po_ap_acct
         no-lock:
         end.
/*GUI*/ if global-beam-me-up then undo, leave.
