/* GUI CONVERTED from woisrc02.p (converter v1.78) Sun Nov 22 12:24:41 2009 */
...
/* Revision: 1.44.1.1 BY: Namita Patil      DATE: 09/12/07 ECO: *P64K*        */
/* Revision: 1.44.1.2 BY: Namita Patil      DATE: 07/16/08 ECO: *P6XP*        */
/* Revision: 1.44.1.3 BY: Ruma Bibra        DATE: 08/11/08 ECO: *P6YY*        */
/* Revision: 1.44.1.4 BY: Ruchita Shinde    DATE: 05/05/09 ECO: *Q2SD*        */
/* Revision: 1.44.1.7 BY: Chandrakant Ingale DATE: 07/15/09  ECO: *Q34Z*      */
/* $Revision: 1.44.1.8 $ BY: Devna Sahai           DATE: 11/17/09 ECO: *Q3M6* */
/*-Revision end---------------------------------------------------------------*/
...
/*GUI*/ if global-beam-me-up then undo, leave.
   ...
   assign
      ...
      nbr = wo_nbr.
   /* For smooth running of UI , do not send blank status*/
   if {gpiswrap.i} then
