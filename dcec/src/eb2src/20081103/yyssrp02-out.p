...
repeat:
    ...
    outpath = "\\qadtemp\QADeb2 doc\Purchase daily schedule". 
/*	outpath = "E:\Project\DCEC\Customization(6702C.08)". lb01*/
    ...
    /*lb01--*/
    /*update start with frame a. fm268*/
    if start = ? then do:
    ...
    update /*start lb01*//* mstart mend fm268*/ site site1 vend vend1 buyer buyer1 part part1 outpath with frame a.
...
/*J034*/       end.
  ...
  /* message "确认更新" view-as alert-box question buttons yes-no update up_yn.
   if not up_yn then undo,retry. fm268*/
...
/*phi     for each xxwk no-lock break by xxwk.buyer by xxwk.zzk by xxwk.vend by xxwk.part:    */
/*phi*/   for each xxwk no-lock break by xxwk.cname by xxwk.zzk by xxwk.vend by xxwk.part:
...
/*phi             chExcelWorkbook:SaveAs(outpath + "\" + string(year(start),"9999") 
     ...
     /*GUI*/ {mfguitrl.i} /*Replace mfrtrail*/
        {mfreset.i}
/*GUI*/ {mfgrptrm.i} /*Report-to-Window*/ /*fm268*/
end. /*repeat*/
