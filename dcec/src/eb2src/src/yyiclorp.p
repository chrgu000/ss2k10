...
define variable sta like ld_sta.
define variable sta1 like ld_sta.
define variable um like pt_um.
/*cj*/ DEF VAR keeper AS CHAR .
...
/*G960*/ no-lock
   ...
   each is_mstr no-lock where is_sta = ld_sta,
/*cj*/ EACH IN_mstr NO-LOCK WHERE IN_part = ld_part AND IN_site = ld_site 
