/* GUI CONVERTED from poporcb.p (converter v1.77) Wed Aug 13 23:51:28 2003 */
...
/* $Revision: 1.56.1.1 $    BY: Reena Ambavi      DATE: 08/13/03  ECO: *P0ZQ* */
/******************************************************************************/
...
{mfdeclre.i}
/*judy 05/08/12*/ /*{cxcustom.i "POPORCB.P"} */
/*judy 05/08/12*/ {cxcustom.i "yyPOPORCB.P"} 
...
{pocnpo.i}   /* Procedures and forms for consignment */
...
if use-log-acctg then do:
   ...
   for last pvo_mstr
      fields(pvo_internal_ref)
      where pvo_order_type = {&TYPE_PO}
...
/*judy 05/08/12*/   /* {gprun.i ""poporcb8.p"" */
/*judy 05/08/12*/    {gprun.i ""yypoporcb8.p""  
         "(buffer pod_det,
           input receivernbr,
           input ship_date,
           input shipnbr,
