...
/* Revision: 1.16.1.1  BY: Mamata Samant       DATE: 07/22/03  ECO: *P0X6*   */
/* Revision: 1.16.1.2  BY: Rajiv Ramaiah       DATE: 08/11/03  ECO: *P0ZK*  */
/* Revision: 1.16.1.3  BY: Dipesh Bector       DATE: 08/28/03  ECO: *P111*  */
/* Revision: 1.16.1.5  BY: Katie Hilbert       DATE: 09/02/03  ECO: *P123*  */
/* $Revision: 1.16.1.6 $        BY: Shilpa Athalye      DATE: 12/15/03  ECO: *P1DY*  */
/******************************************************************************/
...
{mfdeclre.i}
/*judy 05/08/12*/ /*{cxcustom.i "POPORCB8.P"}*/
/*judy 05/08/12*/ {cxcustom.i "yyPOPORCB8.P"}
...
if is-return = no  or  ip_is_usage = no then do:
...
if ((not using_supplier_consignment) or
   ...
   then do:
      ...
      for first sr_wkfl
         fields (sr_lineid sr_site sr_userid)
      ...
      if using_supplier_consignment and ip_is_usage then do:
         ...
         /* THE RECOVERABLE TAX AMOUNT IS CONSIDERED IN wocnppv.p         */
...
/*judy 05/08/12*/ /*{gprun.i ""poporcb6.p""*/
/*judy 05/08/12*/  {gprun.i ""yypoporcb6.p"" 
   "(input shipnbr,
     input ship_date,
     input inv_mov,
