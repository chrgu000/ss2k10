...
/*judy 07/11/05 */ /*form {ppptmta3.i} */
/*judy 07/11/05 */ form {yyptmta3.i} 
with frame b title color normal (getFrameTitle("ITEM_INVENTORY_DATA",28))
/*judy 07/11/05 */  /*   side-labels width 80 attr-space.*/
/*judy 07/11/05 */     side-labels width 80 ATTR-SPACE THREE-D.
...
/*judy 08/26/05 */  IF pt_rctpo_status = "" THEN pt_rctpo_status = "normal".
/*judy 08/26/05 */  IF pt_rctwo_status = "" THEN pt_rctwo_status = "normal".
/*judy 08/26/05 */  DISP pt_rctpo_status pt_rctwo_status WITH FRAME b.
      prompt-for
         pt_abc
         pt_lot_ser
         pt_site
...
/*judy 07/11/05*/ FIND FIRST flpw_mstr WHERE flpw_field = "pt_rctpo_status" NO-LOCK NO-ERROR.
/*judy 07/11/05*/ IF AVAIL flpw_mstr  THEN DO:
/*judy 07/11/05*/    IF flpw_field <> GLOBAL_userid THEN DO:
/*judy 07/11/05*/       MESSAGE "用户没有存取到该字段".
/*judy 07/11/05*/       next-prompt pt_rctpo_status with frame b.
/*judy 07/11/05*/       UNDO, RETRY.
/*judy 07/11/05*/    END.
/*judy 07/11/05*/ END.
/*judy 07/11/05*/ FIND FIRST Is_mstr WHERE Is_status = pt_rctpo_status NO-LOCK NO-ERROR.
/*judy 07/11/05*/ IF NOT AVAIL IS_mstr THEN DO:
/*judy 07/11/05*/    MESSAGE "采购单收货状态不存在"view-as alert-box. 
/*judy 07/11/05*/    next-prompt pt_rctpo_status with frame b.
/*judy 07/11/05*/    UNDO, RETRY.
/*judy 07/11/05*/ END.
...
/*judy 07/11/05*/ FIND FIRST flpw_mstr WHERE flpw_field = "pt_rctwo_status" NO-LOCK NO-ERROR.
/*judy 07/11/05*/ IF AVAIL flpw_mstr  THEN DO:
/*judy 07/11/05*/    IF flpw_field <> GLOBAL_userid THEN DO:
/*judy 07/11/05*/       MESSAGE "用户没有存取到该字段" view-as alert-box.
/*judy 07/11/05*/       next-prompt pt_rctwo_status with frame b.
/*judy 07/11/05*/       UNDO, RETRY.
/*judy 07/11/05*/    END.
/*judy 07/11/05*/ END.
/*judy 07/11/05*/ FIND FIRST Is_mstr WHERE Is_status = pt_rctwo_status NO-LOCK NO-ERROR.
/*judy 07/11/05*/ IF NOT AVAIL IS_mstr THEN DO:
/*judy 07/11/05*/    MESSAGE "工单收货状态不存在" view-as alert-box. 
/*judy 07/11/05*/    next-prompt pt_rctwo_status with frame b.
/*judy 07/11/05*/    UNDO, RETRY.
/*judy 07/11/05*/ END.
