...
/* $Revision: 1.18.5.1 $   BY: Gaurav Kerkar           DATE: 03/10/04  ECO: *P1SN*  */
/******************************************************************************/
...
/* tfq with frame a width 80 attr-space side-labels. */
...
&ENDIF /*GUI*/
/*tfq with frame prm width 80 attr-space side-labels. */
...
&ENDIF /*GUI*/
/*tfq with frame po width 80 attr-space side-labels. */
...
&ENDIF /*GUI*/
   ...
   pod_op                 colon 60
/*lb01*/	    pod__chr01		 colon 15 label "ÖÐ×ª¿â" /*cj*/
   subtype                colon 60
   /*V8! skip(.4) */
   &IF ("{&PP_GUI_CONVERT_MODE}" <> "REPORT") OR
(("{&PP_GUI_CONVERT_MODE}" = "REPORT") AND
