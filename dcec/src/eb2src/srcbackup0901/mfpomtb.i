/* GUI CONVERTED from mfpomtb.i (converter v1.77) Wed Apr 28 23:43:06 2004 */
...
/* Revision: 1.17       BY: Kedar Deherkar       DATE: 12/16/02  ECO: *M200*  */
/* Revision: 1.17.3.3   BY: Ashish Maheshwari    DATE: 11/24/03  ECO: *N2LQ*  */
/* Revision: 1.17.3.4   BY: Gaurav Kerkar        DATE: 03/10/04  ECO: *P1SN*  */
/* $Revision: 1.17.3.5 $         BY: Sukhad Kulkarni      DATE: 04/28/04  ECO: *P1Z8*  */
/******************************************************************************/
...
FORM /*GUI*/ 
   ...
   pod_pur_cost   label "Unit Cost" format ">>>>>>>>9.99<<<"
        space(.5)   
   pod_disc_pct
with frame c no-hide clines down width 80  /*font 18*/ THREE-D /*GUI*/.
