...
/*tfq added field bom__chr01*/
         ...
         then do:
            ...
            if bom_desc = ""
            then do:
    /*tfq added field pt_group*/           for first pt_mstr
...
/*judy 07/14/05*/   find first ps_mstr where ps_par = input ps_par no-lock no-error.
