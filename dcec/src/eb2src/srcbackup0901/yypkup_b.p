...
/*sunny*/ define new shared variable usewip like mfc_logical initial yes
					 label "使用工作中心可用库存".
/*roger*/ def new shared var ltoiss as logical label "使用最小批量发放".
/*roger*/ ltoiss = yes.
...
RECT-FRAME       AT ROW 1 COLUMN 1.25
 ...
 /*sunny  netgr          colon 30 */
   /*sunny*/    usewip	    colon 30
   detail_display colon 30
   nbr            colon 30
   delete_pklst   colon 30
 /*roger*/    ltoiss         colon 30  
...
assign
   site  = global_site
   site1 = global_site.
 /*sunny*/ part = global_part.
/*sunny*/ part1 = global_part.
/*sunny*/ netgr = no .
/*sunny*/ detail_display = yes .
...
/*sunny*/ if site1 <> hi_char then global_site = site1.
/*sunny*/ if part1 <> hi_char  then global_part = part1.
  ...
  /*tfq {gprun.i ""repkupd.p""} */
  /*roger*/  /*G0N9*/    {gprun.i ""yypkupd_b.p""}
