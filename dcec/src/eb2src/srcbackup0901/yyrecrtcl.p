...
/*J2DG*/    fields (wo_bom_code wo_lot wo_part wo_routing wo_site)
...
/*H1J5*/ /* BEGIN OF ADDED SECTION */
                  ...
                  if backflush_qty > 0 then do:
                     ...
                     for each wr_route
/*J2DG*/                 fields (wr_lot wr_milestone wr_op
...
/*H0Q8*/    if integer(pk_reference) <> op then do:
               ...
               for each ro_det
/*J2DG*/          fields (ro_end ro_op ro_routing ro_start ro_wkctr)
                  no-lock
                  where ro_routing = routecode
...
/*J2DG*/             fields (loc_loc loc_site)
/*J2DG*/             where loc_site = wo_site
...
/*H0Q8*/    end.
/*H0Q8*/    else do:
/*H0Q8*/      if can-find (loc_mstr where loc_site = wo_site and
...
/*J2DG*/       fields (pt_lot_ser pt_part pt_um)
/*J2DG*/       where pt_part = pk_part no-lock:
