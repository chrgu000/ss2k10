...
/* $Revision: 1.40.3.1 $     BY: Veena Lad       DATE: 02/03/04  ECO: *P1M6*  */
/******************************************************************************/
...
{mfdeclre.i}
/*tfq {cxcustom.i "SOSOMTCM.P"} */
/*tfq*/ {cxcustom.i "yySOSOMTCM.P"}
            ...
            then do:
               ...
               for first ad_mstr
                  fields(ad_addr ad_city ad_country ad_edi_ctrl ad_inv_mthd
                         ...
                         ad_state ad_taxable ad_taxc ad_tax_in ad_tax_usage
                         ad_zip)
                  where ad_addr = input so_cust no-lock:
                  assign
