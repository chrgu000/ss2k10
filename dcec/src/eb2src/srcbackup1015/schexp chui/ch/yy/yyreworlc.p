...
define VARIABLE oldwod_qty_req like wod_qty_req .  /*tfq*/
define variable   oldwod_qty_pick like wod_qty_pick .  /*tfq*/
define variable   oldwod_qty_all like wod_qty_all .  /*tfq*/
define variable  oldwod_qty_iss like wod_qty_iss .   /*tfq*/
define variable   oldwod_qty_chg like wod_qty_chg .   /*tfq*/
...
/***********tfq added begin*********************************/
   ...
   oldwod_qty_pick = wod_qty_pick .
   oldwod_qty_all = wod_qty_all .
   oldwod_qty_iss = wod_qty_iss .
   oldwod_qty_chg = wod_qty_chg .
   find first wod_det where  wod_part = pkpart and wod_nbr = wo_nbr and wod_lot = wo_lot 
   ...
   do:
   	 ...
   	 and wod_op = oldop
         no-error .
         if available wod_det then wod_op = pkop.
   end.  
   else do:
   wod_qty_req = wod_qty_req + oldwod_qty_req .
   wod_qty_pick = wod_qty_pick + oldwod_qty_pick .
   wod_qty_all = wod_qty_all + oldwod_qty_all .
   wod_qty_chg = wod_qty_chg + oldwod_qty_chg .
   find first wod_det WHERE  wod_part = pkpart and wod_nbr = wo_nbr and wod_lot = wo_lot 
   and wod_op = oldop no-error .
   if available wod_det then
   	assign wod_qty_req = 0
   	       wod_qty_chg = 0
   	       wod_qty_all = 0
   	       wod_qty_pick = 0.
    end.    
