...
/*tfq define  buffer ps_from for ps_mstr.*/

/*tfq*/ define new shared buffer ps_from for ps_mstr.
...
/************tfq added end*************************************/
 ...
 /*added by kevin, 10/23/2003*/
          ...
          if site1 = site2 then 
                {gprun.i ""yybmpscpm1.p""}            /*For copy in the same site*/
          else do:              
              {gprun.i ""yybmpscpm2.p""}           /*For copy between the two different site*/
          end.    
