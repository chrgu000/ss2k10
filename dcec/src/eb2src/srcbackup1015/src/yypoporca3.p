/* GUI CONVERTED from poporca3.p (converter v1.77) Wed Apr 28 04:08:18 2004 */
...
/* $Revision: 1.12.3.1 $    BY: Vandna Rohira         DATE: 04/26/04  ECO: *P1Z3*  */
/******************************************************************************/
...
for each sr_wkfl
   fields(sr_lineid sr_loc sr_lotser sr_ref
