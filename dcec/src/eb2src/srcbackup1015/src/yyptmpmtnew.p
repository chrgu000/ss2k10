 ...
 /*tfq added begin for bom validation****/
    ...
    /*tfq added end for bom validation****/
     ...
     /*tfq  added for vendor validation*/
      xxptmp_vend validate(can-find(first ad_mstr where ad_addr = input xxptmp_vend and ad_coc_reg <> "x" and (ad_type = "vendor" or ad_type = "supplier" or ad_type = "")) ,"供应商代码不存在或供应商已失效") 
