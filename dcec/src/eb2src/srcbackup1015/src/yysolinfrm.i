...
/* REVISION: eb2+sp7  retrofited by tao fengqin: 2005/06/23   *tfq*       */
/*tfq {cxcustom.i "SOLINFRM.I"} */
/*tfq*/ {cxcustom.i "zzSOLINFRM.I"} 
...
form
 ...
 SKIP(.1)  /*GUI*/
   ...
   /*V8!view-as fill-in size 9 by 1 space(.5) */
   /*ROW 3  ============================================================= */
 /*tfq  base_curr       at 4        no-label no-attr-space
