...
/* $Revision: 1.29.4.1 $ BY: Ed van de Gevel DATE: 12/02/03 ECO: *P0SV* */
/******************************************************************************/
...
/*tfq {cxcustom.i "SOSOMTC.P"} */
/*tfq*/ {cxcustom.i "yySOSOMTC.P"}
...
/*tfq*/	for each so_mstr where so_cust = sotrcust and so_fsm_type=" " and so_nbr<>sotrnbr no-lock use-index so_cust,
/*tfq*/	each sod_det where so_nbr = sod_nbr no-lock use-index sod_nbr:
...
undo_mtc3 = true.
/*tfq {gprun.i ""sosomtc3.p""} */
/*tfq*/  {gprun.i ""yysosomtc3.p""}   /*tfq calculation the credit*/
