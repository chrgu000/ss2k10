...
/* Revision: 1.25     BY: LI WEI         DATE: 10/22/04  DSS01               */
/******************************** Tokens ********************************/
...
/**dss01**************************************************
output stream errorlog to value(xslogname) append. /*dss01*/

do transaction: /*dss01*/
    {pxmsg.i &MSGNUM=4686 &ERRORLEVEL=1 &MSGBUFFER=terminate_msg}
    /**liwei************/
    {xslogger.i xslogname ""CIM-INFO"" terminate_msg} 
    ...
    /**liwei************/
    {xslogger.i xslogname ""CIM-ERROR"" procedure_err}
    /**liwei************/
    ...
    /**LIWEI****************/
    {xslogger.i xslogname ""CIM-WARN"" switching_msg}
    /**LIWEI****************/
   ...
   if go_on then do:
      ...
      repeat:
         ...
         then do:
            ...
            if not process_file then do:
               ...
               *********************************/ 
               msgtxt = getTermLabel("GROUP_ID",11) + ": " +
                        string(current_bdl_id) + " ".
               /****dss01 
               {xslogger.i xslogname ""CIM-WARN"" msgtxt}
               *****/
            end.
            else do:
               /*********************************
            ...
            /*dss01-01 {xslogger.i xslogname ""CIM-WARN"" msgtxt} */
            IF linefield[1] = (getTermLabel("WARNING",11) + ":") THEN DO :
 /*   yy            {xslogger.i transid ""CIM"" ""IMP"" ""WARN"" MSGTXT}. */
                 CREATE xxerrtb.
            xxerr = "01".
            xxmsg = msgtxt.
...
PROCEDURE get_CIM_session:
   ...
   do transaction:
      ...
      if i = 999 then do:
         ...
         **DSS01**/
         {pxmsg.i &MSGNUM=1324 &ERRORLEVEL=4 &MSGBUFFER=MSGTXT} 
         /**LIWEI****************/
         /*dss01-01 {xslogger.i xslogname ""CIM-WARN"" MSGTXT} */
/*yy         {xslogger.i transid ""CIM"" ""IMP"" ""ERROR"" MSGTXT}.*/
             CREATE xxerrtb.
...
PROCEDURE setup_input:
   ...
   if search(file_name) = ? then do:
      /* Unable to find file: # */
      /**DSS01**
      {pxmsg.i &MSGNUM=391 &ERRORLEVEL=4 &MSGARG1=file_name}
      **DSS01**/
