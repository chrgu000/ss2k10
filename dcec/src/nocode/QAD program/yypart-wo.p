...
REPEAT:
   ...
   FOR EACH tr_hist WHERE tr_part =itpart AND tr_userid ="mrp" AND tr_date >=bedate AND tr_date <= eddate BREAK BY tr_lot .
   ...
   FOR EACH xxwkpt.
    FOR EACH tr_hist WHERE tr_lot = xxwkpt.lot AND 
