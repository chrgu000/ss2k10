     ...
     isvalid = YES.
      ...
      REPEAT:    /*so input repeat*/
           ASSIGN  
                   ...
                   amount = worksheet:cells(i,15):TEXT
                   ischeck1 = worksheet:cells(i,3):TEXT
                   ischeck2 = worksheet:cells(i,12):TEXT
                   ischeck3 = worksheet:cells(i,14):TEXT
                   ischeck4 = worksheet:cells(i,15):TEXT
                   ischeck5 = worksheet:cells(i,16):TEXT
                   ischeck6 = worksheet:cells(i,17):TEXT
                   ischeck7 = worksheet:cells(i,18):TEXT
                   ischeck8 = worksheet:cells(i,19):TEXT
                   ischeck9 = worksheet:cells(i,20):TEXT
                   ischeck10 = worksheet:cells(i,21):TEXT
                   ischeck11 = worksheet:cells(i,22):TEXT
                   ischeck12 = worksheet:cells(i,23):TEXT.
           ...
           IF amount = "" THEN DO:
               isvalid = NO.
               worksheet:Range("Z" + STRING(i)):VALUE = "实际需求量不能为空！".
           END.
           CREATE soline_det.
           ASSIGN
...
IF isvalid THEN DO:
    ...
    FOR EACH soline_det WHERE soline_mfguser = mfguser NO-LOCK:
        ...
        IF AVAIL sod_det THEN DO:
            worksheet:Range("X" + STRING(soline_index)):VALUE = sod_price.
            worksheet:Range("Y" + STRING(soline_index)):VALUE = sod_price * soline_qty.
        END.
        FIND FIRST in_mstr WHERE in_part = soline_part AND in_site = "dcec-b" NO-LOCK NO-ERROR.
           IF AVAIL in_mstr THEN DO:
               worksheet:Range("P" + STRING(soline_index)):VALUE = in_qty_oh. 
           END.
           ELSE DO:
               worksheet:Range("P" + STRING(soline_index)):VALUE = "库存信息不存在！". 
           END.

           FIND FIRST in_mstr WHERE in_part = soline_part AND in_site = "dcec-c" NO-LOCK NO-ERROR.
           IF AVAIL in_mstr THEN DO:
               worksheet:Range("Q" + STRING(soline_index)):VALUE = in_qty_oh. 
           END.
           ELSE DO:
               worksheet:Range("Q" + STRING(soline_index)):VALUE = "库存信息不存在！". 
           END.
           ...
           IF AVAIL in_mstr THEN DO:
               worksheet:Range("U" + STRING(soline_index)):VALUE = in_qty_oh. 
           END.
           ELSE DO:
           ...
           IF AVAIL in_mstr THEN DO:      
              worksheet:Range("S" + STRING(soline_index)):VALUE = in_qty_ord. 
              worksheet:Range("T" + STRING(soline_index)):VALUE = in_qty_ord + in_qty_oh - in_qty_req. 
           END.
           ELSE DO:
           ...
           IF AVAIL in_mstr THEN DO:      
              worksheet:Range("V" + STRING(soline_index)):VALUE = in_qty_ord. 
              worksheet:Range("W" + STRING(soline_index)):VALUE = in_qty_ord + in_qty_oh - in_qty_req. 
           END.
           ELSE DO:
