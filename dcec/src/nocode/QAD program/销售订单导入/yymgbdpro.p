/* GUI CONVERTED from mgbdpro.p (converter v1.78) Tue Dec 14 20:59:57 2004 */
...
/* $Revision: 1.29.1.1 $  BY: Max Iles    DATE: 12/14/04  ECO: *P2ZP*         */
/******************************** Tokens ********************************/
...
/*
{mfdtitle.i "2+ "} */
{mfdeclre.i} /*Philips Li*/
{gplabel.i}  /*Philips Li*/ 
...
define input parameter xlogname  as char format "x(50)".
