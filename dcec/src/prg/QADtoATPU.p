DEFINE VAR phantom AS INT.
DEFINE VAR v_start AS CHAR.
DEFINE VAR v_end AS CHAR.
DEFINE VAR v_comp AS INT.
DEFINE VAR v_buyer LIKE ptp_buyer.
DEFINE VAR v_vend LIKE po_vend.
DEFINE VAR v_supply LIKE pod__chr01.
DEFINE VAR v_qty LIKE prh_rcvd.
DEFINE VAR v_percent LIKE qad_decfld[1].
DEFINE VAR v_date AS CHAR.
DEFINE VAR v_run1 LIKE ptp_run_seq1.
...
FOR EACH in_mstr NO-LOCK.
    FIND FIRST  CODE_mstr WHERE CODE_fldname = "Keeper-Warehouse" AND CODE_value = IN__qadc01 NO-LOCK NO-ERROR.
