...
/* xxppifiod.p - Interface between PPIF & MFG/PRO.      ITEM DELETE     */
...
*/
		...
		strinputfile	= filepath + "\" + "ppifd.tmp".
		stroutputfile	= filepath + "\" + "ppifdout.tmp".		

		output stream batchdata to value(strinputfile) no-echo.    

		put stream batchdata "~"" at 1 runuser "~" ~"" runpsw "~"".
		put stream batchdata "~"ppptmt05.p~"" at 1.
