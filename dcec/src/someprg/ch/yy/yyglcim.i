...
/* GL Header */
define {1} shared temp-table ttglt_mstr no-undo
   ...
   fields ttglt_ctrl_amt1	like glt_amt
   fields ttglt_ctrl_amt2	like glt_amt
index id is primary unique ttglt_id.

define {1} shared temp-table ttgltd_det no-undo
