		...
		for each rps_mstr no-lock where rps_due_date >= today and rps_due_date <= (today + MAX_LT):
			/*2004-9-29 11:01*/
			...
			if (bld_date > today + SCD_DAY) or bld_date < today then next. 
			old_qty = 0.
			...
			if rps_qty_req - old_qty > 0 then do:  /*MJH007 2005-01-22 16:16*/
			   ...
			   do while (integer(sQty) > 0) :
				  ...
				  assign xxppiftr_so = rps_part
				         xxppiftr_bd = rps_due_date - ptp_mfg_lead 
				         xxppiftr_flag = yes
				  ...
				  substring(string(xxppifla_un,"99999"),2,4) format "9999"  /*"0001" MJH007		*/					/* Beginning unit number	4		*/
				  substring(string(xxppifla_un,"99999"),2,4) format "9999"  /*"0001" MJH007		*/					/* End unit number	4		*/
