...
/* $Revision: 1.14.4.25.1.2 $ BY: Ed van de Gevel DATE: 12/03/03 ECO: *P1D6* */
/******************************************************************************/
...
/* $Revision: 1.14.4.25.1.2 $ BY: Tao fengqin DATE: 06/20/05 ECO: *tfq* */
/* **************************** Definitions ********************************* */
...
with frame ers side-labels
 centered row 13 overlay NO-BOX THREE-D /*GUI*/.
