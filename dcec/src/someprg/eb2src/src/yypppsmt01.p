...
/*judy 08/26/05 */  IF in_rctpo_status = "" THEN in_rctpo_status = "normal".
/*judy 08/26/05 */  IF in_rctwo_status = "" THEN in_rctwo_status = "normal".
/*judy 08/26/05 */  DISP in_rctpo_status in_rctwo_status WITH FRAME c.
