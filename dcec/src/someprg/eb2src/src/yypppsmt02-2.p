   ...
   /*tfq*/  display {yypppsmta4.i} with frame c1.
      ...
      do on error undo, retry with frame c1:
         ...
         set
            ...
            ptp_vend
            ptp_po_site
            ptp_pm_code validate(input ptp_pm_code <> "","'采/制'代码不允许为空") /*tfq*/
            cfg
            ptp_ins_rqd
            ptp_ins_lead
            ptp_cum_lead
            ...
            emt-auto
            ptp_network     
            ptp_routing validate(input ptp_pm_code <> "m" or input ptp_routing <> "" or pt_group = "M","工艺流程代码不允许为空")  /*tfq*/
            ptp_bom_code validate(input ptp_pm_code <> "m" or input ptp_bom_code <> "" or pt_group = "M","产品结构代码不允许为空") /*tfq*/
            go-on (F5 CTRL-D)
         with frame c1.
