...
/*judy 07/05/05*/   define variable ldstatus like ld_status.
/*judy 07/05/05*/	 define variable ldstatus1 like ld_status.
...
/*judy 07/05/05*/    ldstatus	   colon 15
/*judy 07/05/05*/     ldstatus1        label {t001.i} colon 49  skip(1)
   as_of_date     colon 35
...
/*judy 07/05/05*/ /*{wbrp06.i &command = update &fields = "part part1 line line1 vend vend1
/*judy 07/05/05*/        abc abc1 site site1 loc loc1 part_group part_group1 part_type part_type1
/*judy 07/05/05*/        as_of_date neg_qty  net_qty inc_zero_qty   zero_cost
/*judy 07/05/05*/        customer_consign supplier_consign"
/*judy 07/05/05*/      &frm = "a"}*/
/*judy 07/05/05*/       {wbrp06.i &command = update &fields = "part part1 line line1 vend vend1
/*judy 07/05/05*/        abc abc1 site site1 loc loc1 part_group part_group1 part_type part_type1
/*judy 07/05/05*/         ldstatus  ldstatus1 as_of_date neg_qty  net_qty inc_zero_qty   zero_cost
/*judy 07/05/05*/        customer_consign supplier_consign"
/*judy 07/05/05*/      &frm = "a"}
...
/*judy 07/05/05*/       {mfquoter.i ldstatus}
/*judy 07/05/05*/       {mfquoter.i ldstatus1}
      ...
      if as_of_date = ? then as_of_date = today.             
/*judy 07/05/05*/ IF ldstatus1 = ""  THEN ldstatus1 = hi_char.
   end.
   ...
   for each in_mstr
      ...
      no-lock
         ...
         break by in_site by in_part with frame b width 132 STREAM-IO:
...
/*judy 07/05/05*/	  and ld_status >= ldstatus and ld_status <= ldstatus1:
      ...
      if last-of(in_site) then do:
         ...
         for each t_lddet exclusive-lock
            ...
            l_non_consign_qoh = l_non_consign_qoh + t_lddet_qty -
            t_lddet_cust_consign_qty - t_lddet_supp_consign_qty.
            ...
            then do:
               ...
               if using_cust_consignment then do:
                  ...
                  then do:
                     ...
                     then
                        total_qty_oh = total_qty_oh + t_lddet_supp_consign_qty.
            ...
            then do:
               ...
               then do:
                  ...
                  for each tr_hist
                     ...
                     if net_qty = yes or not l_avail_stat
                        or (l_avail_stat and l_nettable)
                     then
                     ...
                     then do:
                        ...
                        end. /* IF customer_consign_code = EXCLUDE */
  ...
  /*judy 07/05/05*/ {mfguichk.i } /*Replace mfrpchk*/
