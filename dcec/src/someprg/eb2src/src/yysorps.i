...
/*cj*/  	chExcelWorkbook:Worksheets(1):Cells(iLine,3) = soregion + "-" + socmtype . 
			...
			chExcelWorkbook:Worksheets(1):Cells(iLine,12) = string(invnbr) . 
			chExcelWorkbook:Worksheets(1):Cells(iLine,13) = zzsite. 
			allamt = allamt + invqty * soprice. 
		end.
		iLine = iLine + 1.
		chExcelWorkbook:Worksheets(1):Cells(iLine,10) = "总计". 
		chExcelWorkbook:Worksheets(1):Cells(iLine,11) = allamt. 
	end.
