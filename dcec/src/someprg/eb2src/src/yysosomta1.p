...
/* Revision: 1.56.1.3  BY: Marcin Serwata       DATE: 09/08/03 ECO: *P12G*    */
/* Revision: 1.56.1.4  BY: Veena Lad      DATE: 02/03/04  ECO: *P1M6*    */
/* $Revision: 1.56.1.5 $  BY: Veena Lad      DATE: 04/22/04  ECO: *P1YK*    */
/******************************************************************************/
...
editing:
   ...
   if recno <> ? then do with frame b:
     ...
     /*tfq may be need be change to zzsosomtdi.i */  {sosomtdi.i}
...
do transaction on error undo, retry:
   ...
   if not available so_mstr then do:
    ...
    /*tfq*/	end.
     ...
     /*tfq* may be need change to zzsosomtdi.i    {sosomtdi.i} */
 ...
 /*tfq  {gprun.i ""sosomtcm.p""
      "(input  this-is-rma,
        input  recid(rma_mstr),
        input  new_order,
        output l_edittax)"} */
        
/*tfq*/   {gprun.i ""yysosomtcm.p""
      "(input  this-is-rma,
        input  recid(rma_mstr),
        input  new_order,
        output l_edittax)"}       
...
/*tfq* may be need change the program name*/      {gprun.i ""gpcmmt01.p"" "(input ""so_mstr"")"}
      assign
...
/*tfq may be need change the program name*/   {gprun.i ""gppiqty1.p"" "(input ""1"",
