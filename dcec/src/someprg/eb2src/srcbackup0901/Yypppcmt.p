...
/* $Revision: 1.19.4.1 $     BY: Anitha Gopal         DATE: 01/22/04  ECO: *P1KN*  */
/* $Revision: eb2+ sp7     BY: judy liu         DATE: 08/25/05  ECO: *judy*  pt_desc1-> pt_desc2 */
/******************************************************************************/
...
FORM /*GUI*/ 
 ...
 SKIP(.1)  /*GUI*/
   ...
   pc_part        colon 29   /*pt_desc1*/ pt_desc2 at 52 no-label
   pc_um          colon 29
      ...
      /* Price Table */
         ...
         do on error undo, retry:
            ...
            then do:
               ...
               delete pc_mstr.
               clear frame a.
               display base_curr @ pc_curr "" @ /*pt_desc1*/ pt_desc2.
               del-yn = no.
               next main-loop.
            end. /* then do: */
