...
/* $Revision: 1.27.3.4 $    BY: Matthew Lee DATE: 05/13/04  ECO: *N2SL*   */
/******************************************************************************/
...
/* REVISION: eb2+sp7  retrofit  BY:tao fengqin 2005/06/29 *tfq*               */
/*! FIELD USAGE:
...
RECT-FRAME       AT ROW 1 COLUMN 1.25
 ...
 SKIP(.1)  /*GUI*/
   ...
   ro_start        colon 43
   ro_end          colon 68 
   ro__chr01     colon 20 label "地点" sidesc no-label       /*kevin*/
   ro_std_op       colon 30
   ro_wkctr        colon 30
   wc_desc         no-label
   ro_mch          colon 30
...
/*GUI*/ if global-beam-me-up then undo, leave.
   ...
   prompt-for
      ...
      if {gpiswrap.i} then
         ...
         then recno = save_recno.
         else save_recno = recno.
