...
/**
 ...
 RECT-FRAME:WIDTH-CHARS IN FRAME a = FRAME a:WIDTH-CHARS - .5.  /*GUI*/            judy gui **/
...
/*/*GUI*/ RECT-FRAME:HEIGHT-PIXELS in frame a = FRAME a:HEIGHT-PIXELS - RECT-FRAME:Y in frame a - 2.judygui*/

            {mfphead.i}

        /*tfq    {gprun.i ""reschexa.p""
            "(input part, input part1, input site, input site1,
            input line, input line1, input yes)"} */
            /*roger*/    {gprun.i ""yyschexa.p""
            "(input part, input part1, input site, input site1,
            input line, input line1, input yes)"}
