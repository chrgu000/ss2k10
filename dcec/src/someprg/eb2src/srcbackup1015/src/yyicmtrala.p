...
form
 	...
 	lad_lot			colon 55 COLUMN-LABEL "批序"
 	desc1			colon 10 no-label
 	um				colon 32 no-label
 	lad__qadc01		colon 40 COLUMN-LABEL "调入库位"
 	lad_ref  		colon 55 COLUMN-LABEL "参考号"
...
/*GA32*/                create lad_det.
	            		...
	            		{gprun.i ""yygetline.p"" "(nbr,   
                          input-output lad_line)"}                 /*judy zz->yy*/
