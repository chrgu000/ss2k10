...
/* Revision: 1.49.4.9     BY: Shivaraman V.       DATE: 04/28/04  ECO: *P1Z7* */
/* Revision: 1.49.4.10    BY: Mercy Chittilapilly DATE: 05/10/04  ECO: *P20G* */
/* $Revision: 1.49.4.11 $ BY: Shivanand H         DATE: 05/13/04  ECO: *P1YS* */
...
/* DISPLAY TITLE */
{mfdeclre.i}
/*tfq {cxcustom.i "SOSOMT1.P"} */
/*tfq*/  {cxcustom.i "yySOSOMT1.P"} 
...
repeat:
   ...
   /*tfq {sosomt02.i} */ /* FORM DEFINITIONS FOR SHARED FRAMES A AND B */
   /*tfq*/ {yysosomt02.i} 
   cr_terms_changed = no.
 ...
 /*tfq  {gprun.i ""sosomta1.p""
      "(input this-is-rma,
        output return_int,
        output rma-recno)"} */
        
/*tfq*/   {gprun.i ""yysosomta1.p""
      "(input this-is-rma,
        output return_int,
        output rma-recno)"} 
 ...
 /*tfq*/ {gpcontxt.i
      &STACKFRAG = 'yysosomta,yysosomt1,fsrmamt'
      &FRAME = 'c' &CONTEXT = 'ISS'} 

  /*tfq {gprun.i ""sosomta.p""
      "(input this-is-rma,
        input rma-recno,
        input yes)"} */
        
 /*tfq*/  {gprun.i ""yysosomta.p""
      "(input this-is-rma,
        input rma-recno,
        input yes)"} 
...
/*tfq*/  {gpcontxt.i
 ...
 /*tfq  {gprun.i ""sosomtc.p"" "(input this-is-rma)"}*/
 
/*tfq*/  {gprun.i ""yysosomtc.p"" "(input this-is-rma)"}
