...
/*LB01   Validate the cost is more than 0.    */
/*LB01*/ if pod_pur_cost<=0 or pod_pur_cost=? then do:
/*LB01   	{mfmsg.i 8160 3}*/   /* COST IS INVALID */
/*LB01*/	message "采购成本必须大于0，请重新输入！" VIEW-AS ALERT-BOX ERROR BUTTONS OK.
/*LB01*/    undo, retry.
/*LB01*/ end.
