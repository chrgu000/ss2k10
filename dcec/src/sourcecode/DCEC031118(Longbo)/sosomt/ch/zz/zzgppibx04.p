/* GUI CONVERTED from gppibx04.p (converter v1.69) Wed Jul 24 13:00:26 1996 */
...
*/
	 ...
	 define            variable non_comb_found   like mfc_logical.
...
/*J0RG*/ define            variable accr_base_found  like mfc_logical.
...
/*J0RG*/ define            variable accr_comb_found  like mfc_logical.
/*J0RG*/ define            variable accr_exc_factor  as decimal.
/*J0RG*/ define            variable accr_exc_found   like mfc_logical.
/*J0RG*/ define            variable accr_non_comb_factor as decimal.
/*J0RG*/ define            variable accr_non_comb_found like mfc_logical.
...
/*J0RG*/    accr_base_noncomb = accr_base_factor + accr_non_comb_factor - 1.
	    ...
	    if manual_list = "FACTOR" then display /* Do not translate */
	       ...
	       base_comb label "基本 / 合并" colon 30 format ">>>,>>9.99<,<<<"
	       base_noncomb label "基本/非合并" colon 30 format ">>>,>>9.99<,<<<"
...
/*J0RG*/       and (accr_exc_factor < accr_base_factor)
/*J0RG*/       then assign
...
/*J0N2*/                                   (wkpi_amt / 100)).
	       ...
	       else if wkpi_amt_type = "3" then assign   /* mark up */
