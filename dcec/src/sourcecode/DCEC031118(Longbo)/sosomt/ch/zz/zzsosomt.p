/* GUI CONVERTED from sosomt.p (converter v1.69) Sat Aug  3 15:35:01 1996 */
...
/*GB31*/  format "Y/N" initial yes label "Confirmed".
...
/*F297** define variable rebook_lines like mfc_logical initial no. */
/*F297*/ define new shared variable rebook_lines like mfc_logical initial no no-undo.
...
/*G0LS*/ define variable batch_job like mfc_logical.
/*G0LS*/ define variable dev       as character.
/*G0LS*/ define variable batch_id  as character.
/*J053*  /*G0NX*/ define variable in_batch_proces like mfc_logical. */
...
/*LB01*/    {gprun.i ""zzsosomta1.p"" "(output return_int)"}
