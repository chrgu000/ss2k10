/* GUI CONVERTED from sosomtc.p (converter v1.69) Thu May 29 22:12:38 1997 */
...
/*J1P5*/ define input parameter this-is-ssm    like mfc_logical no-undo.
...
/*J053*/ {mfsotrla.i}  /* Define common variables for trailer */
...
/*G692*/    base_amt = ord_amt + other_so_amt.
...
/*H008*/ undo_mtc3 = true.
/*LB01**H008*/ {gprun.i ""zzsosomtc3.p""}
/*GUI*/ if global-beam-me-up then undo, leave.
...
/*LB01**G692*/ {gprun.i ""zzsosomtc2.p""}
/*GUI*/ if global-beam-me-up then undo, leave.
