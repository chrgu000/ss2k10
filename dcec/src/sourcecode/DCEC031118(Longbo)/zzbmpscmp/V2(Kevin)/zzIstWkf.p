...
/* REVISION: 8.5	LAST MODIFIED: 12/22/03	 BY: Kevin				   */
/*Kevin***************************************************************
Add control condition "effective date" for PS expend    
********************************************************************/
...
/*added by kevin*/	
            ...
            and (ps_end = ? or today <= ps_end) then do:
/*end added by kevin*/
...
/*added by kevin, for effective date control*/           
           end. 
         else do:
	       find next ps_mstr use-index ps_parcomp where ps_par = dComp
		no-lock no-error.
