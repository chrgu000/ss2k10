/* GUI CONVERTED from woisrc02.p (converter v1.69) Wed Aug 20 20:03:42 1997 */
...
/*       define shared variable mfguser as character.           *G247* */
         ...
         define shared variable close_wo like mfc_logical label "结算".
         ...
         define shared variable conv like um_conv label "换算因子" no-undo.
...
LB01*/
/*LB01*/       lotserial_qty = wosubqty.
/*LB01*/       total_lotserial_qty = open_ref - wosubqty.
...
/*J09C*/             if pt_lot_grp = "" then lotserial = wo_lot_next.
                     ...
                     update lotserial_qty
                        ...
                        location
/*J04D*                 lotref */
/*J04D*/                lotref when (pt_lot_grp <> "")
/*J04D*/                multi_entry when (pt_lot_grp <> "")
                        chg_attr
                        with frame a
                     editing:
...
/*J046*/          update rmks eff_date close_wo with frame a.
...
/*GO33*/       hide frame a no-pause.   
               ...
               do on endkey undo mainloop, retry mainloop:
                  yn = yes.
/*GO33*/ /*V8+*/       {mfgmsg10.i 12 1 yn } /* Is all info correct? */   
