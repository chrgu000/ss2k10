...
/*Note(kevin): change over tolerance action 
               ...
               (poporca4.p -> zzpoporca4.p*/
/* Revision:    8.5         Last Modified: 03/14/2004     By: Kevin                     */
/*Note(kevin):   change the default value of 'location' to in_user1,
            action:  change program 'poporca3.p' to 'zzpoporca3.p'                    */
 ...
 **                                                     initial "RCT-PO". **/
         ...
         define shared variable qopen       like pod_qty_rcvd label "短缺量".
...
/*/*GC87*/       {gprun.i ""poporca3.p""}*/                    /*marked by kevin,03/14/2004*/
                          {gprun.i ""zzpoporca3.p""}                           /*added by kevin,03/14/2004*/
...
/*H093*/       /* OVER-RECEIPT TOLERANCE CHECKS */
               ...
               (total_received < pod_qty_ord and pod_qty_ord < 0)) then do:
                  ...
                  /*{gprun.i ""poporca4.p"" "(output yn)"}*/                       /*marked by kevin,12/30/2003*/
                {gprun.i ""zzpoporca4.p"" "(output yn)"}                   /*added by kevin,12/30/2003*/
