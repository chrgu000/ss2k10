...
/*GUI*/ RECT-FRAME:HEIGHT-PIXELS in frame a = FRAME a:HEIGHT-PIXELS - RECT-FRAME:Y in frame a - 2.
   ...
   */
   ...
   /*james*/ FIND FIRST usrw_wkfl WHERE usrw_key1 = "xx-edi-seq" AND usrw_key2 = "GLOBAL_userid" NO-ERROR.
             IF NOT AVAILABLE usrw_wkfl THEN DO:
                 CREATE usrw_wkfl.
                 ASSIGN usrw_key1 = "xx-edi-seq" 
                        usrw_key2 = "GLOBAL_userid" .
             END.
             ASSIGN usrw_user1 = l_sequence_list.
