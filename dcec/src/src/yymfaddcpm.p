...
find first code_mstr where code_fldname = "xx-system" no-lock no-error.
...
repeat:
    ...
    do on error undo,leave on endkey undo,leave:
        ...
        { yyzzut001.i
          &file = "code_mstr"
          &where = "where (code_fldname = v_key)"
          &frame = "f-main"
          &fieldlist = "
            code_value
            code_cmmt 
...
PROCEDURE xxpro-mt-add.
    ...
    REPEAT WITH FRAME f-pop:
       ...
       find first code_mstr where code_fldname = v_key 
