...
PROCEDURE xxpro-initial:
    ...
    v_box_item = "".
    v_box_loc  = "".
    FIND FIRST CODE_mstr WHERE CODE_fldname = "xx-box-data"
...
PROCEDURE xxpro-check:
    ...
    IF NOT AVAILABLE xxwk3 THEN DO:
        ...
        NEXT.
    END.
    FIND FIRST ad_mstr WHERE ad_addr = xxwk3_soldto NO-LOCK NO-ERROR.
    IF AVAILABLE ad_mstr THEN ASSIGN xxwk3_name_soldto = ad_name.
    FIND FIRST ad_mstr WHERE ad_addr = xxwk3_shipfr NO-LOCK NO-ERROR.
    IF AVAILABLE ad_mstr THEN ASSIGN xxwk3_name_shipfr = ad_name.
    FIND FIRST ad_mstr WHERE ad_addr = xxwk3_shipto NO-LOCK NO-ERROR.
    IF AVAILABLE ad_mstr THEN ASSIGN xxwk3_name_shipto = ad_name.

    FIND FIRST so_mstr WHERE so_nbr = xxwk3_sonbr NO-LOCK NO-ERROR.
    IF AVAILABLE so_mstr THEN DO:
        xxwk3_mfg_soldto = so_cust.
        xxwk3_mfg_shipto = so_ship.
        FIND FIRST sod_det WHERE sod_nbr = xxwk3_sonbr NO-LOCK NO-ERROR.
    ...
    FOR EACH xxwk1:
        ...
        IF xxwk1_sonbr <> "" THEN DO:
            FIND FIRST sod_det WHERE sod_nbr = xxwk1_sonbr AND sod_part = xxwk1_part NO-LOCK NO-ERROR.
    ...
    IF v_box_loc = "" THEN DO:
        ...
        NEXT.
    END.
    FIND FIRST loc_mstr WHERE loc_site = xxwk3_shipfr AND loc_loc = v_box_loc NO-LOCK NO-ERROR.
    ...
    find abs_mstr where abs_mstr.abs_shipfrom = xxwk3_shipfr
