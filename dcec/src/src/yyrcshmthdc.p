...
PROCEDURE xxpro-add-1.
    ...
    i = 0.
    FIND LAST usrw_wkfl WHERE usrw_key1 = v_key1 USE-INDEX usrw_index1 NO-LOCK NO-ERROR.
...
PROCEDURE xxpro-bud-ttt:
    ...
    FIND FIRST so_mstr WHERE so_nbr = v_sonbr NO-LOCK NO-ERROR.
