...
/*F017*/ find first sac_ctrl no-lock no-error.
/*F277*/ find first rmc_ctrl no-lock no-error.
/*F277*/ find first svc_ctrl no-lock no-error.
...
/*G047*/    	{soivtot2.i}  /* Initialize variables for invoice totals. */
				...
				find first so_mstr no-lock where so_nbr = v_so_nbr no-error.
