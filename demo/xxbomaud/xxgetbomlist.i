...
PROCEDURE process_report:
   ...
   repeat while available ps_mstr with frame det2 down:
      ...
      assign
        ...
        /* SS - 110105.1 - B */
        find first t_bomlist_tmp
            where t_bomlist_par = parent
                and t_bomlist_comp = ps_comp
            no-error.
        if not(available(t_bomlist_tmp)) then do:
            create t_bomlist_tmp.
            assign
                t_bomlist_par = parent
                t_bomlist_comp = ps_comp
                .
        end.
        /* SS - 110105.1 - E */
