...
/*110106.1*/ if input wo_nbr <> "" or input wo_lot <> "" then do:
/*110106.1*/    find first wo_mstr no-lock where wo_domain = global_domain
/*110106.1*/           and (wo_lot = input wo_lot or input wo_lot = "")
