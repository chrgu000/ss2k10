...
find first brw_mstr exclusive-lock where brw_mstr.brw_name = 'ed900' no-error.
if not available brw_mstr then do:
          create brw_mstr.
          assign brw_mstr.brw_name = 'ed900'.
end.
assign brw_mstr.brw_desc = 'FILE_NAME'.
assign brw_mstr.brw_view = 'qad_wkfl'
       brw_mstr.brw_filter    = 'qad_key1 = "edvifile.p" and qad_key5 = global_userid and qad_key4 = "F"'
