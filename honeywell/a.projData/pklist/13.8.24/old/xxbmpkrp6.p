  ...
  */
  ...
  if m_count > m_error then do:
    ...
    for each tblln no-lock use-index pln_line,
      ...
      do:
          put skip(1).
  /* *SS-20130925.1  */   put "Line: " + pp_line + "   领料单: " + v_number  format "x(80)" skip.
        /*
...
{gprun.i ""xxpklnew.p"" "( input v_number,
         ...
         input pp_part,
         input pp_desc1,
         input ( accumu total by pln_part pp_qty ),
         input tmpld_loc ,
         input pp_line,
         input pp_qty_line ,
         input tmpld_qty_oh ,
  ...
  /* *SS-20130925.1  */   put "Line: " + pp_line + "   领料单: " + v_number  format "x(80)" skip.
        ...
        do:
          ...
          if not last-of( pln_line ) and type <> "P" then
            do:
 /* *SS-20130925.1  */  {gprun.i ""gpnrmgv.p"" "('XXPKLNBR',input-output v_number, output errorst ,output errornum)" }
 /* *SS-20130925.1  */  ii = 0 .
            put skip(1).
  /* *SS-20130925.1  */   put "Line: " + pp_line + "   领料单: " + v_number  format "x(80)" skip.
          end.
