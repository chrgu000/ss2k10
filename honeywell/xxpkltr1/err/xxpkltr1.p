...
with frame c width 80 no-attr-space 4 down scroll 1.

form
  tt2_part   column-label "料号"
  tt2_site   column-label "地点"
  tt2_loc    column-label "库位"
  tt2_lot    column-label "Lot/Serial"
  tt2_ref    column-label "Reference"
  tt2_stat   column-label "Status"
  tt2_qty_oh column-label "Qty Onhand"
with frame fld width 80 no-attr-space 8 down scroll 1.
