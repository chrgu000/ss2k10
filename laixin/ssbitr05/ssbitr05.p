...
/* 以下为版本历史 */                                                             
/* $Revision: 1.8.1.22 $   BY: Bill Jiang       DATE: 04/27/08 ECO: *SS - 080427.1* */
/* $Revision: 1.8.1.22 $   BY: ken chen         DATE: 04/29/08 ECO: *SS - 080429.1* */
/* $Revision: 1.8.1.22 $   BY: ken chen         DATE: 05/06/08 ECO: *SS - 080506.1* */
/* $Revision: 1.8.1.22 $   BY: Bill Jiang         DATE: 03/14/09 ECO: *SS - 090314.1* */
...
/* $Revision: 1.8.1.22 $   BY: Jordan Lin       DATE: 06/25/12 ECO: *SS - 20120625.1* 
   转为excelreport输出 */
/* $Revision: eb21sp7 $   BY: Cosesa Yang       DATE: 12/11/12 ECO: *SS - 20121212.1* 
   来兴会计日期取每个月的26日到下个月的25日 */
/* Revision: eb21sp7    BY: Cosesa Yang       DATE: 12/31/12 ECO: *SS - 20121231.1* */
/* Revision: eb21sp7    BY: Cosesa Yang       DATE: 01/05/13 ECO: *SS - 20130105.1* */
/* $Revision: eb21sp7 $BY: Cosesa Yang   $DATE: 01/10/13 $ECO: *SS - 20130110.1* */
/* SS - 130110.1 - B */
/* ssictrrp0103.p 未考虑参数 LINE, line1, vend, vend1,abc, abc1, 
                        site, site1, part_group, part_group1, part_type, part_type1,*/
/* SS - 130110.1 - E */
/*
{mfdtitle.i "1+ "}
...
define variable tr_yn like mfc_logical 
   initial yes.
define variable gl_yn like mfc_logical 
   initial yes.
...
define new shared variable et_report_curr like gltr_curr  no-undo.
...
define NEW SHARED variable as_of_date   like tr_effdate.
/* SS - 20121231.1 - B */
define NEW SHARED variable as_of_date1   like tr_effdate.
/* SS - 20121231.1 - E */
...
form
   ...
   as_of_date1    label "生效日期" colon 15
   as_of_date     label {t001.i} colon 49 skip(1)
  /* SS - 20121231.1 - E */
   neg_qty        colon 35
   net_qty        colon 35
...
repeat:
   ...
   if as_of_date1 = ? then as_of_date1 = today.
   /* SS - 20121231.1 - E */
  ...
  /* {wbrp06.i &command = update &fields = "part part1 line line1 vend
      ...
      {wbrp06.i &command = update &fields = "part part1 line line1 vend
        vend1 abc abc1  site site1  part_group part_group1 part_type part_type1
        loc loc1 as_of_date1 as_of_date neg_qty  net_qty inc_zero_qty  zero_cost
        customer_consign supplier_consign"
      &frm = "a"}
   /* SS - 20121231.1 - E */
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssppptrp0601.
   ...
   EXPORT DELIMITER ";" "pt_part" "pt_desc1" "pt_desc2" "in_site" "in_abc" "total_qty_oh" "pt_um" "std_as_of" "ext_std" "non_consign_qoh" "cust_consign_qty" "supp_consign_qty".
   FOR EACH ttssppptrp0601:
      EXPORT DELIMITER ";" ttssppptrp0601.
   END.
 ...
 /* *SS - 20120625.1* -E  */
 /* *SS - 20120625.1* -B  */
         PUT UNFORMATTED "ExcelFile;ssbitr05" SKIP.
         /* SS - 20121231.1 - B */
	 /*
	 PUT UNFORMATTED "SaveFile;存货增减存明细报表" + string(as_of_date, "99999999") SKIP.
	 */
	 PUT UNFORMATTED "SaveFile;存货增减存明细报表" + string(as_of_date1, "99999999") + "  至  " + string(as_of_date, "99999999") SKIP.
	 /* SS - 20121231.1 - E */
	 PUT UNFORMATTED "BeginRow;7" SKIP.
