...
/*define input parameter i_as_of_date1   like tr_effdate  .
  SS - 20121231.1 - E */
...
/*define variable as_of_date1   like tr_effdate   no-undo.
  SS - 20121231.1 - E */
   ...
   */
   ...
   for each pt_mstr
	 ...
	 /*
         ...
         by in_site 
	 */
	, each ld_det no-lock where ld_det.ld_domain = global_domain and  ld_part = in_part
                  and ld_site = in_site 
		  and ld_loc >= loc
		  and ld_loc <= loc1 
		  break by pt_prod_line by pt_part by ld_site 
	 /* SS - 20130104.1 - E */
	       ...
	       /* SS - 20130104.1 - E */
               ...
               */
               ...
               ASSIGN
                  ...
                  ttssppptrp0601_pl = pt_prod_line
