...
/* $Revision: 1.13.1.3 $    BY: Bill Jiang     DATE: 03/11/06  ECO: *SS - 20060311*   */
/******************************************************************************/
...
2.  QAD:
     ...
     SS:
      invoice_qty = if lgInvoice then (invoice_qty + (qty / trans_conv * 0))
                    else invoice_qty.
*/
/* SS - 20060311 - E */

/* SHIPPER CONFIRM */
/* ss - 111117.1 by: jack */ /* 删除tx2d_det 中13类型的税 sosoina.p 环境程序测试修改了 xxnrcsois1a.p*/
/*
{mfdtitle.i "b+ "}
*/
{mfdtitle.i "111117.1 "}
