...
/* Revision: 1.157.1.1 BY: Preeti Sattur          DATE: 03/15/05  ECO: *P3CL* */
/* Revision: 1.157.1.2 BY: Manish Dani            DATE: 04/07/05  ECO: *P3DM* */
/* Revision: 1.157.1.3 BY: Somesh Jeswani         DATE: 08/23/05  ECO: *P3YQ* */
/* Revision: 1.157.1.4 BY: Tejasvi Kulkarni       DATE: 11/29/05  ECO: *P49S* */
/* Revision: 1.157.1.5 BY: Shivganesh Hegde       DATE: 12/29/05 ECO: *P4DV*  */
/* Revision: 1.157.1.6 BY: Munira Savai           DATE: 03/30/06 ECO: *P4N7*  */
/* Revision: 1.157.1.7 BY: Amit Singh             DATE: 05/10/06 ECO: *P4PV*  */
/* Revision: 1.157.1.8 BY: Preeti Sattur          DATE: 10/30/06 ECO: *P5CN*  */
/* Revision: 1.157.1.9 BY: Suyash Keny            DATE: 11/03/06 ECO: *P5D5*  */
/* Revision: 1.157.1.10 BY: Suyash Keny           DATE: 11/17/06 ECO: *P5FF*  */
/* Revision: 1.157.1.11 BY: Antony LejoS          DATE: 12/11/06 ECO: *P5HT*  */
/* Revision: 1.157.1.12 BY: Tejasvi Kulkarni      DATE: 12/20/06 ECO: *P5HV*  */
/* Revision: 1.157.1.13 BY: Sumit Karunakaran     DATE: 01/15/07 ECO: *P5LS*  */
/* Revision: 1.157.1.14 BY: Sanat Paul            DATE: 05/15/07 ECO: *P4LG*  */
/* Revision: 1.157.1.15 BY: Masroor Alam          DATE: 06/06/07 ECO: *P5Q3*  */
/* Revision: 1.157.1.16 BY: Shivakumar Patil      DATE: 09/03/07 ECO: *P667*  */
/* Revision: 1.157.1.17 BY: Mochesh Chandran      DATE: 09/03/07 ECO: *P66J*  */
/* Revision: 1.157.1.18 BY: Iram Momin   DATE: 09/11/07 ECO: *Q1BJ*  */
/* $Revision: 1.157.1.19 $   BY: Iram Momin     DATE: 10/30/07  ECO: *P69Z*  */
/*-Revision end---------------------------------------------------------------*/
/******************************************************************************/
...
repeat:
   ...
   do on error undo CK-CC-HOLD, leave CK-CC-HOLD:
                  ...
                  break by work_abs_mstr.abs_order:
                     ...
                     then do:
                         ...
                         exclusive-lock:
                             ...
                             then do:
                                 create b_lacd_det. b_lacd_det.lacd_domain = global_domain.
      ...
      then
         assign
            auto_post   = no            /*120215.1*/
            use_shipper = no            /*120215.1*/
            consolidate = no            /*120215.1*/
            auto_inv    = no.
 ...
 /*120215.1  use_shipper when (not creditCardOrder                */
 /*120215.1                    and l_invprint = yes)              */
 /*120215.1  consolidate when (not creditCardOrder                */
 /*120215.1                    and l_invprint = yes)              */
         l_calc_freight
         {&RCSOIS1-P-TAG21}
      with frame b.
