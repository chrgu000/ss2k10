...
/* $Revision: 1.37 $    BY: Bill Jiang      DATE: 02/08/06   ECO: *SS - 20060208*   */
/* $Revision: 1.37 $    BY: Bill Jiang      DATE: 04/14/06   ECO: *SS - 20060414*   */
/*-Revision end---------------------------------------------------------------*/
/******************************************************************************/
...
for each ih_hist  where ih_hist.ih_domain = global_domain and (  (ih_inv_nbr >=
   ...
   */
   ...
   idh_inv_nbr = ih_inv_nbr
      ...
      */
      ...
      CREATE tta6soivrp0904.
      ASSIGN
          tta6soivrp0904_inv_nbr = ih_inv_nbr
          tta6soivrp0904_nbr = ih_nbr
          tta6soivrp0904_line = idh_line
          tta6soivrp0904_cust = ih_cust
          tta6soivrp0904_prodline = idh_prodline
          tta6soivrp0904_part = idh_part
          tta6soivrp0904_qty_inv = idh_qty_inv
          tta6soivrp0904_ext_price = ext_price
          tta6soivrp0904_ext_margin = ext_gr_margin
          tta6soivrp0904_ext_tax = tax_amt + l_tax_in
          tta6soivrp0904_base_price = base_price
          tta6soivrp0904_base_margin = base_margin
          tta6soivrp0904_base_tax = tax_amt + l_tax_in
          tta6soivrp0904_taxc = idh_taxc
          tta6soivrp0904_acct = idh_acct
          tta6soivrp0904_sub = idh_sub
          tta6soivrp0904_cc = idh_cc
          tta6soivrp0904_inv_date = ih_inv_date
          /* SS - 20060208 - B */
          tta6soivrp0904_ih_channel = ih_channel
          tta6soivrp0904_idh_site = idh_site
          /* SS - 20060208 - E */
         /* SS - 20060414 - B */
         tta6soivrp0904_ih_curr = ih_curr
         /* SS - 20060414 - E */
          .
         {gprunp.i "mcpl" "p" "mc-curr-conv"
            "(input  ih_curr,
              ...
              input  ih_ex_rate,
              input  ih_ex_rate2,
              input  tta6soivrp0904_base_tax,
              input  true,  /* ROUND */
              output tta6soivrp0904_base_tax,
              output mc-error-number)" }
      /* SS - 20050921 - E */
      detail_lines = yes.
