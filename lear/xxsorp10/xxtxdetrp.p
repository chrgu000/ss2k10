/* GUI CONVERTED from txdetrp.p (converter v1.76) Mon Jul  8 19:49:50 2002 */
...
&SCOPED-DEFINE txdetrp_p_1 "Non-Taxable!Sales"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_3 "Tax Class!Tax Usage"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_4 "Tax Amount"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_5 "Tax!Usage"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_6 "Tax!Rate"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_7 "Tax!Description"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_8 "Tax!Class"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_9 "Tax Type Description!Tax Rate Description"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_10 "Tax!Amount"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_11 "Tax Type!Description"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_12 "Taxable!Sales"
/* MaxLen: Comment: */

&SCOPED-DEFINE txdetrp_p_13 "Taxable!Non-taxable"
/* MaxLen: Comment: */
...
FORM /*GUI*/
   taxdesc column-label {&txdetrp_p_9}
   taxclass at 28 column-label {&txdetrp_p_3}
   taxtotal column-label {&txdetrp_p_4}
   taxpercnt column-label {&txdetrp_p_6}
   nontax column-label {&txdetrp_p_13} format "->>>>,>>>,>>9.99"
...
FORM /*GUI*/
   typedesc    column-label {&txdetrp_p_11}
   l-taxdesc   column-label {&txdetrp_p_7}
   l-taxclass  column-label {&txdetrp_p_8}
   taxusage    column-label {&txdetrp_p_5}
   taxtotal    column-label {&txdetrp_p_10}
   taxpercnt   column-label {&txdetrp_p_6}
   taxbase     column-label {&txdetrp_p_12} format "->>>>,>>>,>>9.99"
   l-nontax    column-label {&txdetrp_p_1}  format "->>>>,>>>,>>9.99"
...
for first txc_ctrl fields(txc_domain txc_detrp txc__qad03) no-lock
