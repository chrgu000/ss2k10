...
/* $Revision: 1.70 $       BY: Bill Jiang        DATE: 08/07/08 ECO: *SS - 080807.1* */
/*-Revision End -------------------------------------------------------------*/
...
/* SS - 080827.1 - B */
DEFINE VARIABLE ref_glt LIKE glt_det.glt_ref.
DEFINE VARIABLE user1_glt LIKE glt_det.glt_user1.
/* SS - 080827.1 - E */
...
repeat:
   ...
   do transaction:
      ...
      do on error undo, retry:
         ...
         */
         then do:
            ...
            /* Delete not allowed */
            run p-disp-msg(input 1021, input 3).
            if type_parm <> "YA"
            then
               next-prompt
                  eff_dt
      ...
      repeat:
         ...
         /* SS - 080807.1 - B */
         /*
         {gprun.i ""gltrmta.p"" "(input type_parm, input l_doc_type)"}
         */
         {gprun.i ""ssgltrm1a.p"" "(input type_parm, input l_doc_type)"}
         /* SS - 080807.1 - E */
   ...
   /* SS - 080827.1 - B */
   /* SS - 091116.1 - B
   if type_parm <> "YA" THEN DO:
      {gprun.i ""ssgltrref03.p"" "(
         INPUT INPUT FRAME a glt_ref,
         OUTPUT ref_glt,
         OUTPUT user1_glt
         )"}
      IF ref_glt <> "" THEN DO:
