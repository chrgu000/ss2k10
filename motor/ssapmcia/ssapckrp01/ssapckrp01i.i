      ...
      */
      ...
      then do:
         ...
         */
         CREATE ttssapckrp01.
         ASSIGN
            ttssapckrp01_ap_batch = ap_mstr.ap_batch

            ttssapckrp01_ck_bank = ck_bank
            ttssapckrp01_ck_nbr = ck_nbr
            ttssapckrp01_ck_ref = ck_ref
            ttssapckrp01_ap_vend = ap_mstr.ap_vend
            ttssapckrp01_name = NAME
            ttssapckrp01_ap_date = ap_mstr.ap_date
            ttssapckrp01_ap_effdate = ap_mstr.ap_effdate
            ttssapckrp01_ap_curr = ap_mstr.ap_curr

            ttssapckrp01_ap_ex_rate = ap_mstr.ap_ex_rate
            ttssapckrp01_ap_ex_rate2 = ap_mstr.ap_ex_rate2

            ttssapckrp01_ap_entity = ap_mstr.ap_entity
            ttssapckrp01_ap_acct = ap_mstr.ap_acct
            ttssapckrp01_ap_sub = ap_mstr.ap_sub
            ttssapckrp01_ap_cc = ap_mstr.ap_cc
            ttssapckrp01_ckstatus = ckstatus
            ttssapckrp01_base_disp_amt = base_disp_amt

            ttssapckrp01_ap_entity1 = apmstr.ap_entity
            ttssapckrp01_ckd_voucher = ckd_voucher
            ttssapckrp01_ckd_type = ckd_type
            ttssapckrp01_order = order
            ttssapckrp01_rmks = rmks
            ttssapckrp01_invoice = invoice
            ttssapckrp01_ckd_acct = ckd_acct
            ttssapckrp01_ckd_sub = ckd_sub
            ttssapckrp01_ckd_cc = ckd_cc
            ttssapckrp01_base_ckd_amt = base_ckd_amt
            ttssapckrp01_base_disc = base_disc

            ttssapckrp01_ap_disc_acct = ap_mstr.ap_disc_acct
            ttssapckrp01_ap_disc_sub = ap_mstr.ap_disc_sub
            ttssapckrp01_ap_disc_cc = ap_mstr.ap_disc_cc

            ttssapckrp01_ckd_amt = ckd_amt
            ttssapckrp01_ckd_disc = ckd_disc
             .

         if ap_rmk <> "" then DO:
            assign
               ttssapckrp01_ap_rmk = ap_mstr.ap_rmk
               .
         END.
         if ckstatus = "void" then DO:
            ASSIGN
               ttssapckrp01_ck_voideff  = ck_voideff
               .
         END.
         /* SS - 20070417.1 - E */
