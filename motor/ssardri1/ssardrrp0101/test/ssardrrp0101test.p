...
repeat:
   ...
   */
   ...
   EXPORT DELIMITER ";" "l_result1" "ar_nbr" "type" "ar_bill" "name" "ar_date" "ar_effdate" "ar_paid_date" "ar_slspsn[1]" "ar_slspsn[2]" "ar_slspsn[3]" "ar_slspsn[4]" "ar_curr" "ar_amt" "ar_applied" "contested".
   FOR EACH ttssardrrp0101:
      EXPORT DELIMITER ";" ttssardrrp0101.
   END.
