...
define new shared variable mixed_rpt like mfc_logical initial 
   /* SS - 20070817.1 - B */
   /*
   no
   */
...
repeat:
   ...
   {wbrp06.i
      ...
      &fields  = "  batch batch1 check_nbr check1 cust cust1 entity entity1
                   ardate ardate1 effdate effdate1 bank bank1 
      /* SS - 20070817.1 - B */
      to_entity
      stat
      /* SS - 20070817.1 - E */
   ...
   FOR EACH ttssarparp02
      ...
      AND ar_nbr = STRING(ttssarparp02_ar_bill,"x(8)") + ttssarparp02_ar_check
      :
