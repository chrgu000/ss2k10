      ...
      */
      ...
      ar_nbr no-lock
         ...
         if not summary then do with frame e:
            ...
            CREATE ttssarparp01.
            ASSIGN
               ttssarparp01_ar_batch = ar_mstr.ar_batch

               ttssarparp01_ar_check = ar_mstr.ar_check
               ttssarparp01_ar_bank = ar_mstr.ar_bank
               ttssarparp01_ar_po = ar_mstr.ar_po
               ttssarparp01_ar_type = ar_mstr.ar_type

               ttssarparp01_ar_date = ar_mstr.ar_date
               ttssarparp01_ar_entity = ar_mstr.ar_entity
               ttssarparp01_ar_acct = ar_mstr.ar_acct
               ttssarparp01_ar_sub = ar_mstr.ar_sub
               ttssarparp01_ar_cc = ar_mstr.ar_cc

               ttssarparp01_ar_bill = ar_mstr.ar_bill
               ttssarparp01_ad_name = NAME
               ttssarparp01_ex_rate_relation1 = ex_rate_relation1
               ttssarparp01_ar_effdate = ar_mstr.ar_effdate
               ttssarparp01_ar_disc_acct = ar_mstr.ar_disc_acct
               ttssarparp01_ar_disc_sub = ar_mstr.ar_disc_sub
               ttssarparp01_ar_disc_cc = ar_mstr.ar_disc_cc
               ttssarparp01_ex_rate_relation2 = ex_rate_relation2
               .
            if not (base_rpt = "" and not mixed_rpt) then 
               ASSIGN
               ttssarparp01_ar_curr = ar_mstr.ar_curr
               .
            else
               ASSIGN 
                  ttssarparp01_ar_curr = base_curr
                  .
            if base_rpt = "" and not mixed_rpt THEN do:
               ASSIGN
                  ttssarparp01_ar_amt = (- base_amt)
                  .
            end.
            ELSE do:
                ASSIGN
                    ttssarparp01_ar_amt = (- ar_mstr.ar_amt)
                    .
            end.
            /* SS - 20070817.1 - E */
            ...
            */
            IF ard_type = "N" OR ard_type = "U" THEN
                ASSIGN
                ttssarparp01_ard_ref = ard_tax
                .
            ELSE
                ASSIGN
                ttssarparp01_ard_ref = ard_ref
                .

            ASSIGN
                ttssarparp01_ard_type = ard_type
                ttssarparp01_ard_type_desc = TYPE
                ttssarparp01_ard_entity = ard_entity
                ttssarparp01_ard_acct = ard_acct
                ttssarparp01_ard_sub = ard_sub
                ttssarparp01_ard_cc = ard_cc
                .
            ...
            then do:
                ASSIGN
                    ...
                    .
                ASSIGN
                    ttssarparp01_disp_curr = DISP_curr
                    ttssarparp01_ard_amt = ard_amt
                    ttssarparp01_ard_disc = ard_disc
                    .
            end.
            else
               do:
                ASSIGN
                    ttssarparp01_disp_curr = DISP_curr
                    ttssarparp01_ard_amt = base_damt
                    ttssarparp01_ard_disc = base_disc
                    .
            end.
            /* SS - 20070817.1 - E */
            ...
            if ard_type <> "N" then do:
               ...
               then
                  ...
                  */
                  ASSIGN ttssarparp01_aramt = (ard_amt + ard_disc).
                  /* SS - 20070817.1 - E */
               else
                  /* SS - 20070817.1 - B */
                  /*
                  display aramt.
                  */
                  ASSIGN ttssarparp01_aramt = aramt.
                  /* SS - 20070817.1 - E */
            ...
            */
            ELSE ASSIGN ttssarparp01_aramt = 0.
            /* SS - 20070817.1 - E */
            ...
            then do:
               ...
               then do:
                  ...
                  then
                     ...
                     */
                     ASSIGN ttssarparp01_unamt = (ard_amt - c_appl_amt).
                     /* SS - 20070817.1 - E */
                  else
                     /* SS - 20070817.1 - B */
                     /*
                     display unamt.
                     */
                     ASSIGN ttssarparp01_unamt = unamt.
                     /* SS - 20070817.1 - E */
                  ...
                  then
                     ...
                     */
                     ASSIGN ttssarparp01_unamt = ard_amt.
                     /* SS - 20070817.1 - E */
                  else
                     /* SS - 20070817.1 - B */
                     /*
            ...
            if ard_type = "N" then do:
               ...
               if base_rpt = ""
                  ...
                  */
                  ASSIGN ttssarparp01_nonamt = ard_amt.
                  /* SS - 20070817.1 - E */
               else 
                  /* SS - 20070817.1 - B */
                  /*
                  display nonamt.
                  */
                  ASSIGN ttssarparp01_nonamt = nonamt.
                  /* SS - 20070817.1 - E */
            ...
            down 1.
            */
            else ASSIGN ttssarparp01_nonamt = 0.
            /* SS - 20070817.1 - E */
         end.
