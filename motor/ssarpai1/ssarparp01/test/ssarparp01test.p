...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssarparp01.
   
   {gprun.i ""ssarparp01.p"" "(
      INPUT BATCH,
      INPUT BATCH1,
      INPUT CHECK_nbr,
      INPUT CHECK1,
