      ...
      */
      ...
      ar_nbr no-lock
         ...
         if not summary then do with frame e:
            ...
            ASSIGN
               /* SS - 20080221.1 - B */
               ttssarparp02_ar_nbr = ar_mstr.ar_nbr
               /* SS - 20080221.1 - E */
               ttssarparp02_ar_batch = ar_mstr.ar_batch

               ttssarparp02_ar_check = ar_mstr.ar_check
               ttssarparp02_ar_bank = ar_mstr.ar_bank
               ttssarparp02_ar_po = ar_mstr.ar_po
               ttssarparp02_ar_type = ar_mstr.ar_type

               ttssarparp02_ar_date = ar_mstr.ar_date
               ttssarparp02_ar_entity = ar_mstr.ar_entity
               ttssarparp02_ar_acct = ar_mstr.ar_acct
               ttssarparp02_ar_sub = ar_mstr.ar_sub
               ttssarparp02_ar_cc = ar_mstr.ar_cc

               ttssarparp02_ar_bill = ar_mstr.ar_bill
               ttssarparp02_ad_name = NAME
               ttssarparp02_ex_rate_relation1 = ex_rate_relation1
               ttssarparp02_ar_effdate = ar_mstr.ar_effdate
               ttssarparp02_ar_disc_acct = ar_mstr.ar_disc_acct
               ttssarparp02_ar_disc_sub = ar_mstr.ar_disc_sub
               ttssarparp02_ar_disc_cc = ar_mstr.ar_disc_cc
               ttssarparp02_ex_rate_relation2 = ex_rate_relation2
               .
            if not (base_rpt = "" and not mixed_rpt) then 
               ASSIGN
               ttssarparp02_ar_curr = ar_mstr.ar_curr
               .
            else
               ASSIGN 
                  ttssarparp02_ar_curr = base_curr
                  .
            if base_rpt = "" and not mixed_rpt THEN do:
               ASSIGN
                  ttssarparp02_ar_amt = (- base_amt)
                  .
            end.
            ELSE do:
                ASSIGN
                    ttssarparp02_ar_amt = (- ar_mstr.ar_amt)
                    .
            end.
            /* SS - 20070817.1 - E */
            ...
            */
            IF ard_type = "N" OR ard_type = "U" THEN
                ASSIGN
                ttssarparp02_ard_ref = ard_tax
                .
            ELSE
                ASSIGN
                ttssarparp02_ard_ref = ard_ref
                .

            ASSIGN
                ttssarparp02_ard_type = ard_type
               /* SS - 20081007.1 - B */
               /*
                ttssarparp02_ard_type_desc = TYPE
                */
               /* SS - 20081007.1 - E */
                ttssarparp02_ard_entity = ard_entity
                ttssarparp02_ard_acct = ard_acct
                ttssarparp02_ard_sub = ard_sub
                ttssarparp02_ard_cc = ard_cc
               /* SS - 20080221.1 - B */
               ttssarparp02_ard_cur_amt = ard_cur_amt
               /* SS - 20080221.1 - E */
                .
            ...
            then do:
                ASSIGN
                    ...
                    .
                ASSIGN
                    ttssarparp02_disp_curr = DISP_curr
                    ttssarparp02_ard_amt = ard_amt
                    ttssarparp02_ard_disc = ard_disc
                    .
            end.
            else
               do:
                ASSIGN
                    ttssarparp02_disp_curr = DISP_curr
                    ttssarparp02_ard_amt = base_damt
                    ttssarparp02_ard_disc = base_disc
                    .
            end.
            /* SS - 20070817.1 - E */
            ...
            if ard_type <> "N" then do:
               ...
               then
                  ...
                  */
                  ASSIGN ttssarparp02_aramt = (ard_amt + ard_disc).
                  /* SS - 20070817.1 - E */
               else
                  /* SS - 20070817.1 - B */
                  /*
                  display aramt.
                  */
                  ASSIGN ttssarparp02_aramt = aramt.
                  /* SS - 20070817.1 - E */
            ...
            */
            ELSE ASSIGN ttssarparp02_aramt = 0.
            /* SS - 20070817.1 - E */
            ...
            then do:
               ...
               then do:
                  ...
                  then
                     ...
                     */
                     ASSIGN ttssarparp02_unamt = (ard_amt - c_appl_amt).
                     /* SS - 20070817.1 - E */
                  else
                     /* SS - 20070817.1 - B */
                     /*
                     display unamt.
                     */
                     ASSIGN ttssarparp02_unamt = unamt.
                     /* SS - 20070817.1 - E */
                  ...
                  then
                     ...
                     */
                     ASSIGN ttssarparp02_unamt = ard_amt.
                     /* SS - 20070817.1 - E */
                  else
                     /* SS - 20070817.1 - B */
                     /*
            ...
            if ard_type = "N" then do:
               ...
               if base_rpt = ""
                  ...
                  */
                  ASSIGN ttssarparp02_nonamt = ard_amt.
                  /* SS - 20070817.1 - E */
               else 
                  /* SS - 20070817.1 - B */
                  /*
                  display nonamt.
                  */
                  ASSIGN ttssarparp02_nonamt = nonamt.
                  /* SS - 20070817.1 - E */
            ...
            down 1.
            */
            else ASSIGN ttssarparp02_nonamt = 0.
            /* SS - 20070817.1 - E */
         end.
