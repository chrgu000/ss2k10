...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssarparp02.
   
   {gprun.i ""ssarparp02.p"" "(
      INPUT BATCH,
      INPUT BATCH1,
      INPUT CHECK_nbr,
      INPUT CHECK1,
   ...
   EXPORT DELIMITER ";" "ar_batch" "ar_check" "ar_bank" "ar_po" "ar_type" "ar_date" "ar_entity" "ar_acct" "ar_sub" "ar_cc" "ar_bill" "ad_name" "ex_rate_relation1" "ar_effdate" "ar_disc_acct" "ar_disc_sub" "ar_disc_cc" "ex_rate_relation2" "ar_curr" "ar_amt" "ard_ref" "ard_type" "ard_type_desc" "ard_entity" "ard_acct" "ard_sub" "ard_cc" "disp_curr" "ard_amt" "ard_disc" "aramt" "unamt" "nonamt" "ar_nbr" "ard_cur_amt".
   FOR EACH ttssarparp02:
      EXPORT DELIMITER ";" ttssarparp02.
   END.
