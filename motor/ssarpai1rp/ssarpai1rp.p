...
repeat:
   ...
   for each ar_mstr no-lock where ar_domain = global_domain
        ...
        find first ar where ar.ar_domain = global_domain and ar.ar_bill =
             ...
             (ar.ar_type = "P") and ar.ar_user2 = ar_mstr.ar_check
             no-lock no-error.
   ...
   for each tmpar where (tmpar_fbatch >= batch and tmpar_fbatch <= batch1) or
    ...
    find first ar where ar.ar_domain = global_domain and ar.ar_bill =
         ar_mstr.ar_bill and ar.ar_date = ar_mstr.ar_date  AND
        (ar.ar_type = "P") and ar_mstr.ar_user2 = ar.ar_check no-lock no-error.
    if available ar then do:
       display ar_mstr.ar_batch ar_mstr.ar_nbr ar_mstr.ar_bill ar_mstr.ar_date
            ar_mstr.ar_effdate ar_mstr.ar_entity ar_mstr.ar_type
            ar_mstr.ar_check ar_mstr.ar_amt ar.ar_batch ar_mstr.ar_nbr
            ar.ar_bill ar.ar_date ar.ar_effdate
            ar.ar_entity ar.ar_type  ar.ar_check ar.ar_amt with frame b.
    end.
    else do:
        display ar_mstr.ar_batch ar_mstr.ar_nbr ar_mstr.ar_bill ar_mstr.ar_date
            ar_mstr.ar_effdate ar_mstr.ar_entity ar_mstr.ar_type
            ar_mstr.ar_check ar_mstr.ar_amt with frame b.
    end.
   end.
   {mfrtrail.i}
end.
