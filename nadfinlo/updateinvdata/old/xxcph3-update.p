...
define var	 v_year   	like 	 cph_year   .
define var	 v_cust   	like 	 cph_cust   .
define var	v_ship   	like 	cph_ship   .
define var	v_part   	like 	cph_part   .
define var	v_type   	like 	cph_type   .
define var	v_pl     	like 	cph_pl     .
define var	v_site   	like 	cph_site   .
define var v_month as int .
define var   v_old_tot_cost like cph_tot_cost .
define var   v_new_tot_cost like cph_tot_cost .
define var   v_old_tot_sale like cph_tot_sale .
define var   v_new_tot_sale like cph_tot_sale .
define var   v_old_tot_qty like cph_tot_qty .
define var   v_new_tot_qty like cph_tot_qty .
...
update v_year label "年" colon 20  v_cust label "客户" colon 35 v_ship LABEL "销往" COLON 55 skip
       
       v_part LABEL "零件" COLON 20  v_type LABEL "类型"  v_pl LABEL "产品线" SKIP 
