	...
	if last-of(month(ar_effdate)) then do:
		find first cph_hist
			 ...
			 if  cph_qty[v_month] <> accumulate total by month(ar_effdate)  idh_qty_inv * idh_um_conv then do:
				 ...
				 */
               .
                IF cph_qty[v_month] <> 0  THEN
                    ASSIGN
                    v_std = cph_cost[v_month] / cph_qty[v_month] 
                ...
                ELSE
                    ...
                    /* 数量 */
                    ASSIGN
                        v_comp =   xx_new_qty[v_month] -  cph_qty[v_month]
                        cph_qty[v_month] = xx_new_qty[v_month]
                    ...
                    ASSIGN
                        ...
                        xx_new_cost[v_month] = cph_cost[v_month]
                    ...
                    ASSIGN
                        ...
                        xx_new_sales[v_month] = cph_sales[v_month]
