...
then do:
   ...
   /*{gprun.i ""popomtr.p""*/	/*---Remark by davild 20080624.1*/
   ...
   then do:
      ...
      /*{gprunmo.i &program="popomtr1.p"*/	/*---Remark by davild 20080624.1*/
      /*---Add by davild 20080624.1*/
      {gprunmo.i &program="xxpopom1r1.p"
         &module="GRS"
         &param="""(input no,
           input  p_frame_row,
           input  p_po_curr,
