...
/*nad001 {gprun.i "'sofmsv01.p'"  " "  "persistent set h_form_svc" }*/
/*nad001*/ {gprun.i "'xxsofmsv01.p'"  " "  "persistent set h_form_svc" }

if lookup ("sh_print",h_form_svc:INTERNAL-ENTRIES) > 0 then
   run sh_print in h_form_svc
