...
/*nadf-inv*/  DEFINE NEW SHARED VARIABLE PhoneFax AS CHARACTER FORMAT "x(16)" EXTENT 2.
...
repeat:
   ...
   if comp_addr <> "" then do:
      ...
      if available ad_mstr then do:
         ...
         assign
            /*nadf-inv*  addr[1] = ad_name  */
            /*nadf-inv*/ addr[1] = ad_name + ad_county
            addr[2] = ad_line1
            addr[3] = ad_line2
            addr[4] = ad_line3
            addr[6] = ad_country.
   ...
   /*nadf-inv*  {gprun.i " ""sorp10"" + run_file + "".p"" "}  */
   /*nadf-inv*/ {gprun.i " ""xxsorp10"" + run_file + "".p"" "}
