...
/*SS - 20111208.1 /*SFOP*/  define shared variable bisu            as integer format ">>9".*/
/*SS - 20111208.1*/  define shared variable bisu            as integer format ">>>9".
...
/*SS - 20111208.1       substr(op_user1,4,3)      = string(bisu).*/
/*SS - 20111208.1*/       substring(op_user1,4,4)      = string(bisu).
