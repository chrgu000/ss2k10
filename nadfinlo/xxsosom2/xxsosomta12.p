...
/* SS - 110121.1 - B */
define var v_type    as char format "x(3)" label "单据类别" . v_type   = "SS" .
...
/* SS - 110121.1 - B
   ...
   SS - 110121.1 - E */
/* SS - 110121.1 - B */
         consume       = if v_type = v_type_x then no else yes
/* SS - 110121.1 - E */
   ...
   do on error undo, retry with frame b:
      ...
      if new so_mstr then do:
         ...
         assign
            ...
            so_channel  = if so_site = "NKSA" then "DO" else ""   /* SS - 110121.1 */
