            ...
            i = 0.
            for each tmp_sum break by tmp_shift:   
               assign
                  v_var = 0
                  v_var_time = 0
                  rjct_rate = 0.0
               ...
               PUT "班次:" format "x(8)" ","
                  ...
                  "" ","
                  "" ","
                  tmp_std_man format ">>>>>9.9" "," 
                  tmp_act_man format "->>>>9.9" ","
                  "" ","
                  "" ","
                  "" ","
                  v_var_time ","
	            ...
	            assign
                  tot_std_man = tot_std_man + tmp_std_man
                  tot_act_man = tot_act_man + tmp_act_man
               ...
               if last(tmp_shift) then do:
                  ...
                  PUT 
                     ...
                     "机台总时间: " + string(tot_emp * 24.0,"->>>>9.9") format "x(42)" 
                     SKIP.
                  ...
                  PUT 
                     ...
                     "汇报总时间: " + string(tot_hour,"->>>>9.9") format "x(42)"
                     SKIP.
