...
usection = TRIM ( string(year(TODAY)) + string(MONTH(TODAY)) + string(DAY(TODAY)))  + trim(STRING(TIME)) + trim(string(RANDOM(1,100))) + "inv22" .
...
"""" + trim ( V1100 ) + """" + " - - " + """" +  trim( V1200 ) + """"  + " - - " + """" + trim( V1630 ) + """" +  " " + """" + trim( V1640) + """" + " " + """" + trim( V1650) + """" format "x(50)" skip
"Y" skip
"."
