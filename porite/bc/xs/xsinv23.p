...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xsinv23wtimeout"
 and can-find ( first dom_mstr where  dom_type = "SYSTEM " and dom_domain = code_domain and dom_active = yes ) 
 no-lock no-error. /*  Timeout - All Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
If 1=1 and t_v100[1]<>''then
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1305 width 150 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 width 150 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 width 150 no-box.
...
if V9120 = ? THEN
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 width 150 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 width 150 no-box.
...
If AVAILABLE ( pt_mstr )  then
   ...
   IF NOT (V9010 = "Y" AND ( decimal ( V9110 ) * decimal ( V9120 )  <> decimal ( V1600 ) ) ) THEN LEAVE V9140LMAINLOOP.
     ...
     REPEAT:
        ...
        /* --FIRST TIME SKIP -- START  */
         if sectionid = 1 then leave V9140L.
        /* --FIRST TIME SKIP -- END  */
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9140 width 150 no-box.
...
IF 1 = 1 THEN
        ...
        /* --FIRST TIME SKIP -- START  */
         if sectionid = 1 then leave V9150L.
        /* --FIRST TIME SKIP -- END  */
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9150 width 150 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* --FIRST TIME SKIP -- START  */
         if sectionid = 1 then leave V9160L.
        /* --FIRST TIME SKIP -- END  */
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9160 width 150 no-box.
