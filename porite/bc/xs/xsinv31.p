...
/* INV TRANSFER */
/* Generate date / time  2011-4-2 14:56:34 */
...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xsinv31wtimeout"
 and can-find ( first dom_mstr where  dom_type = "SYSTEM " and dom_domain = code_domain and dom_active = yes ) 
 no-lock no-error. /*  Timeout - All Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 width 150 no-box.
     ...
     REPEAT:
        ...
        Xxthdate = today.
        V1100 = "Tr" + string(year(xxthdate)) + fill("0",2 - length(string(month(xxthdate)))) + string(month(xxthdate))
           + fill("0",2 - length(string(day(xxthdate)))) + string(day(xxthdate)) + "0001".         	      
        Find first code_mstr where code_domain = V1001 and code_fldname = "BarCodeTrPar" and code_value = "AutoNum" no-error.
         	 ...
         	 Code_cmmt = substring(V1100,1,10) + fill("0",4 - length(string(int(substring(V1100,11,4))) )) + string(int(substring(V1100,11,4)) + 1).
         	 Release code_mstr.
         If 1=1 then
        leave V1100L.
        /* LOGICAL SKIP END */
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 width 150 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1290 width 150 no-box.

                /* LABEL 1 - START */ 
                L12901 = "单号" + Trim(V1100) .
...
If 1=1 and t_v100[1]<>''then
        leave V1300L.
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 width 150 no-box.
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1305 width 150 no-box.
        ...
        /* PRESS e EXIST CYCLE */
        IF V1305 = "e" THEN  LEAVE V1290LMAINLOOP.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1490 width 150 no-box.
        ...
        display skip "^" @ WMESSAGE NO-LABEL with fram F1490.
            ...
            THEN DO:
                  IF recid(loc_mstr) = ? THEN find first loc_mstr where 
                              LOC_domain = V1001 and  LOC_SITE = V1002 and (loc_loc = "001" or loc_loc = "002") AND  
                              loc_loc >=  INPUT V1490
                               no-lock no-error.
                  else do: 
                       if loc_loc =  INPUT V1490
                       then find next loc_mstr
                       WHERE LOC_domain = V1001 and  LOC_SITE = V1002 and (loc_loc = "001" or loc_loc = "002")
                        no-lock no-error.
        ...
        find first loc_mstr where LOC_domain = V1001 and  LOC_LOC = V1490 AND LOC_SITE = V1002 and (loc_loc = "001" or loc_loc = "002") no-lock no-error.
...
End.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 width 150 no-box.
...
LD_SITE = V1002 AND LD_REF = "" and (ld_loc = "001" or ld_loc = "002") AND  
                              LD_LOT >=  INPUT V1500
                               no-lock no-error.
                  else do: 
...
LD_SITE = V1002 AND LD_REF = "" and (ld_loc = "001" or ld_loc = "002")
                        no-lock no-error.
...
LD_SITE = V1002 AND LD_REF = "" and (ld_loc = "001" or ld_loc = "002") AND  
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        V1513 = "PDC". Leave V1513L.
        leave V1513L.
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1513 width 150 no-box.
...
End.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1520 width 150 no-box.
        ...
        display skip "^" @ WMESSAGE NO-LABEL with fram F1520.
            ...
            THEN DO:
                  IF recid(loc_mstr) = ? THEN find first loc_mstr where 
                              LOC_domain = V1001 and  LOC_SITE = V1513 and loc_loc <> V1490 AND  
                              loc_loc >=  INPUT V1520
                               no-lock no-error.
                  else do: 
                       if loc_loc =  INPUT V1520
                       then find next loc_mstr
                       WHERE LOC_domain = V1001 and  LOC_SITE = V1513 and loc_loc <> V1490
                        no-lock no-error.
                        else find first loc_mstr where 
                              LOC_domain = V1001 and  LOC_SITE = V1513 and loc_loc <> V1490 AND  
                              loc_loc >=  INPUT V1520
        ...
        find first loc_mstr where LOC_domain = V1001 and  LOC_LOC = V1520 AND LOC_SITE = V1513 and loc_loc <> V1490 no-lock no-error.
if not avail loc_mstr   then do:
...
End.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1530 width 150 no-box.
...
If AVAILABLE ( ld_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1550 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 width 150 no-box.
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 width 150 no-box.
     ...
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        for each mytt:
         	find first tr_hist where recid(tr_hist) = mytt_rec and tr_domain=V1001  and 
...
If 1 = 1 then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9004 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[一级转二级]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 width 150 no-box.
