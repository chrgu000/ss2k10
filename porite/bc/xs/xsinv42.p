...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xsinv42wtimeout"
 and can-find ( first dom_mstr where  dom_type = "SYSTEM " and dom_domain = code_domain and dom_active = yes ) 
 no-lock no-error. /*  Timeout - All Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 width 150 no-box.
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1200 width 150 no-box.
        ...
        /* CHECK FOR NUMBER VARIABLE START  */
        /* CHECK FOR NUMBER VARIABLE  END */
        find first LOC_MSTR where LOC_DOMAIN = V1001 AND LOC_LOC = V1200 AND LOC_SITE = V1002  no-lock no-error.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 width 150 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 width 150 no-box.
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 width 150 no-box.
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1605           as char format "x(150)".
        define variable PV1605          as char format "x(150)".
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        V1605 = "".
Find first tag_mstr where  not tag_void and not tag_posted and tag_loc = V1200 and tag_part = V1300 and tag_site = V1002 and tag_domain = V1001 and tag_serial = V1500  and tag_ref = "" no-lock no-error.
If AVAILABLE ( tag_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1605 width 150 no-box.

                /* LABEL 1 - START */ 
                L16051 = V1300 .
                display L16051          format "x(40)" skip with fram F1605 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                L16052 = V1200 .
                display L16052          format "x(40)" skip with fram F1605 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                L16053 = V1500 .
                display L16053          format "x(40)" skip with fram F1605 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L16054 = "" . 
                display L16054          format "x(40)" skip with fram F1605 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1605 width 150 no-box.
        /* DISPLAY ONLY */
     ...
     /* START  LINE :1607  BLANK TAG NO  */
     V1607L:
     REPEAT:

        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1607           as char format "x(150)".
        define variable PV1607          as char format "x(150)".
        define variable L16071          as char format "x(40)".
        define variable L16072          as char format "x(40)".
        define variable L16073          as char format "x(40)".
        define variable L16074          as char format "x(40)".
        define variable L16075          as char format "x(40)".
        define variable L16076          as char format "x(40)".
        /* --DEFINE VARIABLE -- END */


        /* --FIRST TIME DEFAULT  VALUE -- START  */
        V1607 = "".
Find first tag_mstr where tag_type = "B" and tag_part = ""  and not tag_void and not tag_posted  and V1605 = "" and  tag_domain = V1001 no-lock no-error.
If AVAILABLE ( tag_mstr ) then
        V1607 = string( tag_nbr ).
        V1607 = ENTRY(1,V1607,"@").
        /* --FIRST TIME DEFAULT  VALUE -- END  */
        ...
        /* --FIRST TIME SKIP -- START  */
         if sectionid = 1 then leave V1607L.
        /* --FIRST TIME SKIP -- END  */
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1607 width 150 no-box.

                /* LABEL 1 - START */ 
                L16071 = "BLANK TAG" .
                display L16071          format "x(40)" skip with fram F1607 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                  L16072 = "" . 
                display L16072          format "x(40)" skip with fram F1607 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                  L16073 = "" . 
                display L16073          format "x(40)" skip with fram F1607 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L16074 = "" . 
                display L16074          format "x(40)" skip with fram F1607 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1607 width 150 no-box.
        /* DISPLAY ONLY */
        define variable X1607           as char format "x(40)".
        X1607 = V1607.
        V1607 = "".
        /* DISPLAY ONLY */
        Update V1607
        WITH  fram F1607 NO-LABEL
        EDITING:
          readkey pause wtimeout.
          if lastkey = -1 Then quit.
        if LASTKEY = 404 Then Do: /* DISABLE F4 */
        ...
        /* PRESS e EXIST CYCLE */
        IF V1607 = "e" THEN  LEAVE V1300LMAINLOOP.
        display  skip WMESSAGE NO-LABEL with fram F1607.

         /*  ---- Valid Check ---- START */

        display "...PROCESSING...  " @ WMESSAGE NO-LABEL with fram F1607.
        pause 0.
        /* CHECK FOR NUMBER VARIABLE START  */
        If V1607 = "" OR V1607 = "-" OR V1607 = "." OR V1607 = ".-" OR V1607 = "-." then do:
                display skip "CAN NOT EMPTY  " @ WMESSAGE NO-LABEL with fram F1607.
                pause 0 before-hide.
                undo, retry.
        end.
        DO i = 1 to length(V1607).
                If index("0987654321.-", substring(V1607,i,1)) = 0 then do:
                display skip "Format  Error  " @ WMESSAGE NO-LABEL with fram F1607.
                pause 0 before-hide.
                undo, retry.
                end.
        end.
        ...
        display  "" @ WMESSAGE NO-LABEL with fram F1607.
        pause 0.
        leave V1607L.
     END.
     PV1607 = V1607.
     /* END    LINE :1607  BLANK TAG NO  */


     /* START  LINE :1608  是否BLANK TAG  */
     V1608L:
     REPEAT:

        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1608           as char format "x(150)".
        define variable PV1608          as char format "x(150)".
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        Find first tag_mstr where not tag_void and not tag_posted and string ( tag_nbr ) = V1605 and tag_domain = V1001 no-lock no-error.
If AVAILABLE ( tag_mstr ) then
        V1608 = tag_type.
        V1608 = ENTRY(1,V1608,"@").
        /* --FIRST TIME DEFAULT  VALUE -- END  */
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1608 width 150 no-box.

                /* LABEL 1 - START */ 
                  L16081 = "" . 
                display L16081          format "x(40)" skip with fram F1608 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                  L16082 = "" . 
                display L16082          format "x(40)" skip with fram F1608 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                  L16083 = "" . 
                display L16083          format "x(40)" skip with fram F1608 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L16084 = "" . 
                display L16084          format "x(40)" skip with fram F1608 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1608 width 150 no-box.
        /* DISPLAY ONLY */
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1620           as char format "x(150)".
        define variable PV1620          as char format "x(150)".
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1620 width 150 no-box.

                /* LABEL 1 - START */ 
                L16201 = "盘点数量?" .
                display L16201          format "x(40)" skip with fram F1620 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                L16202 = "图号:" + trim( V1300 ) .
                display L16202          format "x(40)" skip with fram F1620 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                L16203 = "批号:" + Trim(V1500) .
                display L16203          format "x(40)" skip with fram F1620 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                L16204 = "标签/库位:" + ( if V1605 = "" then V1607 else V1605 )  + "/" + trim ( V1200 ) .
                display L16204          format "x(40)" skip with fram F1620 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1620 width 150 no-box.
        Update V1620
        ...
        /* CHECK FOR NUMBER VARIABLE  END */
        IF not ( V1605 <> "" OR V1607 <> "" ) THEN DO:
                display skip "没有可使用空标签" @ WMESSAGE NO-LABEL with fram F1620.
                pause 0 before-hide.
                undo, retry.
        end.
         /*  ---- Valid Check ---- END */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 width 150 no-box.
                ...
                /* LABEL 3 - START */ 
                L17003 = "库位/数量:" + trim ( V1200 ) + "/" + trim( V1620 ) .
                display L17003          format "x(40)" skip with fram F1700 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                L17004 = "对应TAG NO: " + ( if V1605 = "" then "[B]" + TRIM( V1607 ) else TRIM ( V1605 ) ) .
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 width 150 no-box.

                /* LABEL 1 - START */ 
                find first tag_mstr where tag_domain = V1001 and ( tag_nbr = integer(V1605) or tag_nbr = integer(V1607) ) and tag_part = trim ( V1300 )  and tag_cnt_qty = decimal (V1620)  no-lock no-error.
If AVAILABLE ( tag_mstr ) then
                L90101 = "交易已提交" .
                else L90101 = "" . 
...
If AVAILABLE ( tag_mstr ) then
   ...
   IF NOT (V9010 = "Y" AND V1700 = "Y" ) THEN LEAVE V9110LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 width 150 no-box.
...
If AVAILABLE ( pt_mstr ) then
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 width 150 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[初盘(BY ITEM)]" + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 width 150 no-box.
     ...
     INPUT FROM VALUE(LabelsPath + "inv42").
