...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xspor01wtimeout"
 and can-find ( first dom_mstr where  dom_type = "SYSTEM " and dom_domain = code_domain and dom_active = yes ) 
 no-lock no-error. /*  Timeout - All Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 width 150 no-box.
...
If AVAILABLE (po_mstr) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1101 width 150 no-box.
...
If AVAILABLE (gl_ctrl) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1102 width 150 no-box.
...
If AVAILABLE (po_mstr) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1103 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1200 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1203 width 150 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first pod_det where pod_domain = V1001 and pod_nbr = V1100  and pod_site = V1002 and index("XC",pod_status) = 0 and pod_type = "" no-lock no-error.
If AVAILABLE (pod_det) and string ( pod_line ) <> V1205 then
        ...
        /* LOGICAL SKIP START */
        find last pod_det where pod_domain = V1001 and pod_nbr = V1100  and pod_site = V1002 and index("XC",pod_status) = 0 and pod_type = ""  no-lock no-error.
If AVAILABLE (pod_det) and string ( pod_line ) = V1205 then
        leave V1205L.
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1205 width 150 no-box.
        ...
        display skip "^" @ WMESSAGE NO-LABEL with fram F1205.
            ...
            THEN DO:
                  IF recid(POD_DET) = ? THEN find first POD_DET where 
                              pod_domain = V1001 and pod_nbr = V1100 and pod_site = V1002 and index( "XC",pod_status ) = 0  and pod_type = "" AND  
                              string ( POD_LINE ) >=  INPUT V1205
                               no-lock no-error.
                  else do: 
                       if string ( POD_LINE ) =  INPUT V1205
                       then find next POD_DET
                       WHERE pod_domain = V1001 and pod_nbr = V1100 and pod_site = V1002 and index( "XC",pod_status ) = 0  and pod_type = ""
                        no-lock no-error.
        ...
        /* CHECK FOR NUMBER VARIABLE START  */
        /* CHECK FOR NUMBER VARIABLE  END */
        find first POD_DET where pod_domain = V1001 and POD_NBR = V1100 AND POD_SITE = V1002 AND string( POD_LINE ) = Trim(V1205) and index ( "XC",pod_status ) = 0  and pod_type = ""  NO-ERROR NO-WAIT.
     ...
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first pod_det where pod_domain = V1001 and pod_nbr = V1100  and string ( pod_line ) = V1205 and pod_type = ""  no-lock no-error.
If AVAILABLE (pod_det) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 width 150 no-box.
...
If AVAILABLE (poc_ctrl) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1305 width 150 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1306 width 150 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1307 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1400 width 150 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 width 150 no-box.
...
IF 1 = 1 then
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 width 150 no-box.
     ...
     REPEAT:
        ...
        leave V1501L.
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1501 width 150 no-box.
...
If AVAILABLE (pod_det) and pod_um_conv = 1 then
        leave V1550L.
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1550 width 150 no-box.
...
If AVAILABLE (poc_ctrl) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1558 width 150 no-box.
...
If AVAILABLE (poc_ctrl) then
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 width 150 no-box.
...
If AVAILABLE (pod_det) and pod_um_conv = 1 then
        leave V1610L.
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1610 width 150 no-box.
...
If AVAILABLE (pt_mstr) THEN
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 width 150 no-box.
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 width 150 no-box.
...
IF 1 = 1 THEN
        leave V9005L.
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9005 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 width 150 no-box.
...
If AVAILABLE (pod_det) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 width 150 no-box.
...
If AVAILABLE (pod_det) then
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 width 150 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        leave V9130L.
        /* LOGICAL SKIP END */
                display "[采购收货(一般)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 width 150 no-box.
     ...
     INPUT FROM VALUE(LabelsPath + "por01").
