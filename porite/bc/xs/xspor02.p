...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xspor02wtimeout"
 and can-find ( first dom_mstr where  dom_type = "SYSTEM " and dom_domain = code_domain and dom_active = yes ) 
 no-lock no-error. /*  Timeout - All Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 width 150 no-box.
        ...
        display skip "^" @ WMESSAGE NO-LABEL with fram F1100.
            ...
            THEN DO:
                  IF recid(PO_MSTR) = ? THEN find first PO_MSTR where 
                              PO_DOMAIN = V1001 AND INDEX("XC",PO_STAT) = 0 AND PO_TYPE <> "B" AND (PO_SITE = "" OR PO_SITE = V1002) AND  
                              PO_NBR >=  INPUT V1100
                               no-lock no-error.
                  else do: 
                       if PO_NBR =  INPUT V1100
                       then find next PO_MSTR
                       WHERE PO_DOMAIN = V1001 AND INDEX("XC",PO_STAT) = 0 AND PO_TYPE <> "B" AND (PO_SITE = "" OR PO_SITE = V1002)
                        no-lock no-error.
        ...
        /* CHECK FOR NUMBER VARIABLE START  */
        /* CHECK FOR NUMBER VARIABLE  END */
        find first PO_MSTR where PO_DOMAIN = V1001 AND PO_NBR = V1100 AND INDEX("XC",PO_STAT) = 0 AND PO_TYPE <> "B" AND (PO_SITE = "" OR PO_SITE = V1002)  NO-ERROR NO-WAIT.
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1101           as char format "x(150)".
        define variable PV1101          as char format "x(150)".
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first po_mstr where po_domain = V1001 and po_nbr = V1100  no-lock no-error.
If AVAILABLE (po_mstr) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1101 width 150 no-box.

                /* LABEL 1 - START */ 
                  L11011 = "" . 
                display L11011          format "x(40)" skip with fram F1101 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                  L11012 = "" . 
                display L11012          format "x(40)" skip with fram F1101 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                  L11013 = "" . 
                display L11013          format "x(40)" skip with fram F1101 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L11014 = "" . 
                display L11014          format "x(40)" skip with fram F1101 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1101 width 150 no-box.
        /* DISPLAY ONLY */
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1102           as char format "x(150)".
        define variable PV1102          as char format "x(150)".
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first gl_ctrl where gl_domain = V1001 and no-lock no-error.
If AVAILABLE (gl_ctrl) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1102 width 150 no-box.

                /* LABEL 1 - START */ 
                  L11021 = "" . 
                display L11021          format "x(40)" skip with fram F1102 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                  L11022 = "" . 
                display L11022          format "x(40)" skip with fram F1102 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                  L11023 = "" . 
                display L11023          format "x(40)" skip with fram F1102 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L11024 = "" . 
                display L11024          format "x(40)" skip with fram F1102 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1102 width 150 no-box.
        /* DISPLAY ONLY */
...
If AVAILABLE (po_mstr) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1103 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1200 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1203 width 150 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first pod_det where pod_domain = V1001 and pod_nbr = V1100  and pod_site = V1002 and index("XC",pod_status) = 0 and pod_type = "S" no-lock no-error.
If AVAILABLE (pod_det) and string ( pod_line ) <> V1205 then
        ...
        /* LOGICAL SKIP START */
        find last pod_det where pod_domain = V1001 and pod_nbr = V1100  and pod_site = V1002  and index("XC",pod_status) = 0 and pod_type = "S"  no-lock no-error.
If AVAILABLE (pod_det) and string ( pod_line ) = V1205 then
        leave V1205L.
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1205 width 150 no-box.
        ...
        display skip "^" @ WMESSAGE NO-LABEL with fram F1205.
            ...
            THEN DO:
                  IF recid(POD_DET) = ? THEN find first POD_DET where 
                              pod_domain = V1001 and pod_nbr = V1100 and 
pod_site = V1002 and index( "XC",pod_status ) = 0  and pod_type = "S" AND  
                       ...
                       WHERE pod_domain = V1001 and pod_nbr = V1100 and 
...
pod_site = V1002 and index( "XC",pod_status ) = 0  and pod_type = "S" AND  
        ...
        /* CHECK FOR NUMBER VARIABLE START  */
        /* CHECK FOR NUMBER VARIABLE  END */
        find first POD_DET where POD_DOMAIN = V1001 AND POD_NBR = V1100 AND 
pod_site = V1002 AND string( POD_LINE ) = Trim(V1205) and index ( "XC",pod_status ) = 0  and pod_type = "S"  NO-ERROR NO-WAIT.
     ...
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first pod_det where pod_domain = V1001 and pod_nbr = V1100  and string ( pod_line ) = V1205 and pod_type = "S"  no-lock no-error.
If AVAILABLE (pod_det) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 width 150 no-box.

                /* LABEL 1 - START */ 
                find first pod_det where pod_domain = V1001 and pod_nbr = V1100  and string ( pod_line ) = V1205 no-lock no-error.
If AVAILABLE (pod_det) then
                L13001 = "图号:" + pod_part .
                else L13001 = "" . 
...
If AVAILABLE (pt_mstr) then
                ...
                find first pt_mstr where pt_domain = V1001 and pt_part = V1300 no-lock no-error.
If AVAILABLE (pt_mstr) then
                L13003 = "保质期:" + trim ( string ( pt_shelflife ) ) + "天" .
                else L13003 = "" . 
...
If AVAILABLE (pod_det) then
     ...
     /* START  LINE :1302  工单ID WO ID  */
     V1302L:
     REPEAT:

        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1302           as char format "x(150)".
        define variable PV1302          as char format "x(150)".
...
If AVAILABLE (pod_det) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1302 width 150 no-box.

                /* LABEL 1 - START */ 
                L13021 = "工单ID" .
                display L13021          format "x(40)" skip with fram F1302 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                  L13022 = "" . 
                display L13022          format "x(40)" skip with fram F1302 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                  L13023 = "" . 
                display L13023          format "x(40)" skip with fram F1302 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L13024 = "" . 
                display L13024          format "x(40)" skip with fram F1302 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1302 width 150 no-box.
        /* DISPLAY ONLY */
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1303           as char format "x(150)".
        define variable PV1303          as char format "x(150)".
...
If AVAILABLE (pod_det) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1303 width 150 no-box.

                /* LABEL 1 - START */ 
                L13031 = "WO OP" .
                display L13031          format "x(40)" skip with fram F1303 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                  L13032 = "" . 
                display L13032          format "x(40)" skip with fram F1303 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                  L13033 = "" . 
                display L13033          format "x(40)" skip with fram F1303 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L13034 = "" . 
                display L13034          format "x(40)" skip with fram F1303 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1303 width 150 no-box.
        /* DISPLAY ONLY */
...
If AVAILABLE (poc_ctrl) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1305 width 150 no-box.
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1306           as char format "x(150)".
        define variable PV1306          as char format "x(150)".
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1306 width 150 no-box.

                /* LABEL 1 - START */ 
                  L13061 = "" . 
                display L13061          format "x(40)" skip with fram F1306 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                  L13062 = "" . 
                display L13062          format "x(40)" skip with fram F1306 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                  L13063 = "" . 
                display L13063          format "x(40)" skip with fram F1306 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L13064 = "" . 
                display L13064          format "x(40)" skip with fram F1306 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1306 width 150 no-box.
        /* DISPLAY ONLY */
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1307           as char format "x(150)".
        define variable PV1307          as char format "x(150)".
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1307 width 150 no-box.

                /* LABEL 1 - START */ 
                L13071 = "产品线" .
                display L13071          format "x(40)" skip with fram F1307 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                  L13072 = "" . 
                display L13072          format "x(40)" skip with fram F1307 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                  L13073 = "" . 
                display L13073          format "x(40)" skip with fram F1307 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L13074 = "" . 
                display L13074          format "x(40)" skip with fram F1307 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1307 width 150 no-box.
        /* DISPLAY ONLY */
     ...
     /* START  LINE :1309  生产日期(Create LOT) CANCEL  */
     V1309L:
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1309 width 150 no-box.
     ...
     END.
     PV1309 = V1309.
     /* END    LINE :1309  生产日期(Create LOT) CANCEL  */
     ...
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first CODE_DOMAIN = V1001 AND CODE_MSTR where CODE_FLDNAME = "BARCODE" and CODE_VALUE = "PT_PROD_LINE_USEPTLOC" and trim ( CODE_CMMT ) = trim ( V1307 ) no-lock no-error.
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1400 width 150 no-box.
                ...
                /* LABEL 3 - START */ 
                find first pl_mstr where pl_domain = V1001 and pl_prod_line = V1307 no-lock no-error.
If AVAILABLE (pl_mstr) THEN
                ...
                /* LABEL 4 - START */ 
                find first CODE_MSTR where CODE_DOMAIN = V1001 AND CODE_FLDNAME = "BARCODE" and CODE_VALUE = "PT_PROD_LINE_USEPTLOC" and trim ( CODE_CMMT ) = trim ( V1307 ) no-lock no-error.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 width 150 no-box.
...
IF 1 = 1 then
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 width 150 no-box.
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1501           as char format "x(150)".
        define variable PV1501          as char format "x(150)".
        ...
        /* LOGICAL SKIP START */
        find first wo_mstr where wo_domain = V1001 and wo_lot = V1302 and wo_status = "R" and wo_site = V1002 no-lock no-error.
If AVAILABLE (wo_mstr) and V1410 = "L" AND V1306 <> "" THEN
        leave V1501L.
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1501 width 150 no-box.

                /* LABEL 1 - START */ 
                L15011 = "ERR:LOT/LOC控制" .
                display L15011          format "x(40)" skip with fram F1501 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                L15012 = "请在1.4.1进行定义" .
                display L15012          format "x(40)" skip with fram F1501 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                L15013 = "ERR:委外工单有误" .
                display L15013          format "x(40)" skip with fram F1501 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                L15014 = "工单ID:" + trim (V1302) + "查核!" .
                display L15014          format "x(40)" skip with fram F1501 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1501 width 150 no-box.
        Update V1501
...
If AVAILABLE (pod_det) and pod_um_conv = 1 then
        leave V1550L.
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1550 width 150 no-box.
...
If AVAILABLE (poc_ctrl) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1558 width 150 no-box.
...
If AVAILABLE (poc_ctrl) then
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 width 150 no-box.
...
If AVAILABLE (pod_det) then
        ...
        /* LOGICAL SKIP START */
        find first pod_det where pod_domain = V1001 pod_nbr = V1100 and string( pod_line)  = V1205  no-lock no-error.
If AVAILABLE (pod_det) and pod_um_conv = 1 then
        leave V1610L.
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1610 width 150 no-box.
...
If AVAILABLE (pt_mstr) THEN
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 width 150 no-box.
...
If AVAILABLE (pod_det) then
        ...
        /* CHECK FOR NUMBER VARIABLE START  */
        /* CHECK FOR NUMBER VARIABLE  END */
        find first po_mstr where PO_DOMAIN = V1001 AND PO_NBR = V1100 AND INDEX("XC",PO_STAT) = 0 AND PO_TYPE <> "B"  NO-ERROR NO-WAIT.
        IF NOT AVAILABLE po_mstr then do:
     ...
     REPEAT:
        ...
        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V1702           as char format "x(150)".
        define variable PV1702          as char format "x(150)".
        ...
        /* LOGICAL SKIP START */
        find first wo_mstr where wo_domain = V1001 and wo_lot = V1302 and wo_status = "R" and wo_site = V1002 NO-ERROR NO-WAIT.
If AVAILABLE (wo_mstr) and V1410 = "L" AND V1306 <> "" THEN
        leave V1702L.
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1702 width 150 no-box.

                /* LABEL 1 - START */ 
                L17021 = "ERR:LOT/LOC控制" .
                display L17021          format "x(40)" skip with fram F1702 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                L17022 = "请在1.4.1进行定义" .
                display L17022          format "x(40)" skip with fram F1702 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                L17023 = "ERR:委外工单有误" .
                display L17023          format "x(40)" skip with fram F1702 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                L17024 = "工单ID:" + trim (V1302) + "查核!" .
                display L17024          format "x(40)" skip with fram F1702 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F1702 width 150 no-box.
        Update V1702
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 width 150 no-box.
...
IF 1 = 1 THEN
        leave V9005L.
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9005 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 width 150 no-box.
...
If AVAILABLE (pod_det) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 width 150 no-box.
...
If AVAILABLE (pod_det) then
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 width 150 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        leave V9130L.
        /* LOGICAL SKIP END */
                display "[采购收货(委外)]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 width 150 no-box.
     ...
     INPUT FROM VALUE(LabelsPath + "por02").
