...
usection = TRIM ( string(year(TODAY)) + string(MONTH(TODAY)) + string(DAY(TODAY)))  + trim(STRING(TIME)) + trim(string(RANDOM(1,100))) + "rep03" .
...
trim ( V1600 ) + " " +
trim(V1002) + " " +  trim( V1420 ) format "X(70)"  if trim( V1500 ) = "" then " - " else """" + trim(V1500) + """"  format "X(50)" skip
"." skip
"Y" skip
"Y" skip
"." skip
