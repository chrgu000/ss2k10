...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xsrep09wtimeout"
 and can-find ( first dom_mstr where  dom_type = "SYSTEM " and dom_domain = code_domain and dom_active = yes ) 
 no-lock no-error. /*  Timeout - All Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1099 width 150 no-box.
...
End.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1203 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1204 width 150 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* --FIRST TIME SKIP -- START  */
         if sectionid = 1 then leave V1290L.
        /* --FIRST TIME SKIP -- END  */
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1290 width 150 no-box.
        ...
        /* DISPLAY ONLY */
        define variable X1290           as char format "x(40)".
        X1290 = V1290.
        V1290 = "".
        /* DISPLAY ONLY */
        Update V1290
...
find first pt_mstr where pt_domain=V1001 and pt_article = ENTRY(1, V1290, "@") no-lock no-error .
...
End.
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 width 150 no-box.
...
display skip "件号不存在,请查" @ WMESSAGE NO-LABEL with fram F1300.
	...
	End.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1301 width 150 no-box.
        ...
        /* PRESS e EXIST CYCLE */
        IF V1301 = "e" THEN  LEAVE V1290LMAINLOOP.
        display  skip WMESSAGE NO-LABEL with fram F1301.
        ...
        If NOT AVAILABLE pt_mstr then do:
display skip "件号不存在,请查" @ WMESSAGE NO-LABEL with fram F1301.
                pause 0 before-hide.
                Undo, retry.
	...
	End.
     ...
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first code_mstr where code_fldname="BARCODE_COLOR_TYPE" and code_domain=V1001 and code_value=substring(V1301,length(V1301) - 1) no-lock no-error.
If avail code_mstr then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1303 width 150 no-box.
        ...
        /* PRESS e EXIST CYCLE */
        IF V1303 = "e" THEN  LEAVE V1290LMAINLOOP.
...
If AVAILABLE ( ro_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1310 width 150 no-box.
...
If AVAILABLE ( ro_det ) then
        ...
        /* PRESS e EXIST CYCLE */
        IF V1310 = "e" THEN  LEAVE V1290LMAINLOOP.
        display  skip WMESSAGE NO-LABEL with fram F1310.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1320 width 150 no-box.
        ...
        /* PRESS e EXIST CYCLE */
        IF V1320 = "e" THEN  LEAVE V1290LMAINLOOP.
        display  skip WMESSAGE NO-LABEL with fram F1320.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 width 150 no-box.
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 width 150 no-box.
...
End.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 width 150 no-box.
        ...
        /* PRESS e EXIST CYCLE */
        IF V1510 = "e" THEN  LEAVE V1290LMAINLOOP.
        display  skip WMESSAGE NO-LABEL with fram F1510.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 width 150 no-box.
        ...
        /* CHECK FOR NUMBER VARIABLE  END */
        find first LD_DET where ( decimal(V1600) > 0 ) OR ( decimal(V1600) < 0 AND (ld_part  = V1300 AND ld_loc = V1510 and ld_domain = V1001 and  ld_site = V1002 AND ld_ref = "" AND  ld_lot = V1500 and
ld_site = V1002 and ld_ref = "" and  ld_QTY_oh + DECIMAL ( V1600 ) >= 0 ) )  no-lock no-error.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1601 width 150 no-box.
        ...
        /* PRESS e EXIST CYCLE */
        IF V1601 = "e" THEN  LEAVE V1290LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 width 150 no-box.

                /* LABEL 1 - START */ 
                L17001 = "件号:" + trim(V1301) .
        ...
        /* CHECK FOR NUMBER VARIABLE START  */
        /* CHECK FOR NUMBER VARIABLE  END */
        find first ld_det where decimal(V1600) > 0 OR ( decimal(V1600) < 0 AND (ld_part  = V1300 AND ld_domain = V1001 and ld_site = V1002 AND ld_ref = "" AND ld_loc = V1510 and ld_lot = V1500 and ld_domain = V1001 and ld_site = V1002 AND ld_ref = "" and  ld_QTY_oh + DECIMAL ( V1600 ) >= 0 ) )  NO-ERROR NO-WAIT.
        IF NOT AVAILABLE ld_det then do:
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 width 150 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 width 150 no-box.
 ...
 find last tr_hist where tr_trnbr = trnbr 
   ...
   END.
   pause 0 before-hide.
   /* Internal Cycle Input :9012    */
   V9012LMAINLOOP:
   REPEAT:
   /*Logical Enter Cycle9012    */
   IF NOT (V9010 = "Y" AND V1700 = "Y" ) THEN LEAVE V9012LMAINLOOP.
     /* START  LINE :9012  包装数[Packing Qty]  */
     V9012L:
     REPEAT:

        /* --DEFINE VARIABLE -- START */
        hide all.
        define variable V9012           as char format "x(150)".
        define variable PV9012          as char format "x(150)".
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first pt_mstr where pt_part=V1301 and pt_domain=V1001 no-lock no-error.
If avail pt_mstr then V9012=string(pt_net_wt).
Else V9012="1".
        V9012 = V9012.
        V9012 = ENTRY(1,V9012,"@").
        /* --FIRST TIME DEFAULT  VALUE -- END  */
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9012 width 150 no-box.

                /* LABEL 1 - START */ 
                L90121 = "包装数量?" .
                display L90121          format "x(40)" skip with fram F9012 width 150 no-box.
                /* LABEL 1 - END */ 


                /* LABEL 2 - START */ 
                  L90122 = "" . 
                display L90122          format "x(40)" skip with fram F9012 width 150 no-box.
                /* LABEL 2 - END */ 


                /* LABEL 3 - START */ 
                  L90123 = "" . 
                display L90123          format "x(40)" skip with fram F9012 width 150 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                  L90124 = "" . 
                display L90124          format "x(40)" skip with fram F9012 width 150 no-box.
                /* LABEL 4 - END */ 
                display "输入或按E退出"       format "x(40)" skip
        skip with fram F9012 width 150 no-box.
        Update V9012
        ...
        /* PRESS e EXIST CYCLE */
        IF V9012 = "e" THEN  LEAVE V9012LMAINLOOP.
        ...
        DO i = 1 to length(V9012).
                If index("0987654321.-", substring(V9012,i,1)) = 0 then do:
     ...
     REPEAT:
        ...
        leave V9015L.
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9015 width 150 no-box.
        ...
        /* PRESS e EXIST CYCLE */
        IF V9015 = "e" THEN  LEAVE V9012LMAINLOOP.
    ...
    Tmpchar="".
    DO iii = 1 TO LENGTH(STRING(DEC(V1600) / DEC(V9012))):
        IF SUBSTR(STRING(DEC(V1600) / DEC(V9012)) ,iii,1) <> "." THEN DO:
            tmpchar = tmpchar + SUBSTR(STRING(DEC(V1600) / DEC(V9012)) ,iii,1) .
        END.
        ELSE LEAVE .
    END.
    IF DEC(V1600) / DEC(V9012) > DEC(tmpchar)  THEN
    V9020 = string(DEC(tmpchar) + 1) .
    ELSE 
    V9020 = tmpchar .
        V9020 = V9020.
        V9020 = ENTRY(1,V9020,"@").
...
if V9012 = ? THEN
        leave V9020L.
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9020 width 150 no-box.
        ...
        /* PRESS e EXIST CYCLE */
        IF V9020 = "e" THEN  LEAVE V9012LMAINLOOP.
   ...
   wtm_num = V9020.
     ...
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        if DEC(V1600) mod DEC(V9012)<>0 then 
wtm_num=string(Dec(V9020) - 1).
Find first upd_det where upd_nbr = "LAP01" and upd_select = 99 no-lock no-error.
If AVAILABLE ( upd_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9030 width 150 no-box.
        ...
        /* PRESS e EXIST CYCLE */
        IF V9030 = "e" THEN  LEAVE V9012LMAINLOOP.
        display  skip WMESSAGE NO-LABEL with fram F9030.
     ...
     INPUT FROM VALUE(LabelsPath + "lap01").
...
If AVAILABLE ( pt_mstr )  then
       ...
       END.
        av9030 = if length( trim ( V1500 ) ) >= 8 then substring ( trim ( V1500 ),7,2) else "00".
...
If AVAILABLE ( pt_mstr )  then
   ...
   IF NOT (DEC(V1600) mod DEC(V9012)<>0 ) THEN LEAVE V9140LMAINLOOP.
     /* START  LINE :9140  条码上余数[QTY ON LABEL]  */
     V9140L:
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        V9140=string(DEC(V1600) mod DEC(V9012)).
        V9140 = V9140.
        V9140 = ENTRY(1,V9140,"@").
        /* --FIRST TIME DEFAULT  VALUE -- END  */
        ...
        leave V9140L.
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9140 width 150 no-box.
     ...
     END.
     PV9140 = V9140.
     /* END    LINE :9140  条码上余数[QTY ON LABEL]  */


     /* START  LINE :9150  条码个数[NO OF LABEL]  */
     V9150L:
     REPEAT:
...
if 1=1 then
        leave V9150L.
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9150 width 150 no-box.
     ...
     END.
     PV9150 = V9150.
     /* END    LINE :9150  条码个数[NO OF LABEL]  */


   wtm_num = V9150.
     /* START  LINE :9160  打印机[PRINTER]  */
     V9160L:
     REPEAT:
...
if 1=1 then
        leave V9160L.
        /* LOGICAL SKIP END */
                display "[生产回冲-无标签]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9160 width 150 no-box.
        ...
        IF NOT AVAILABLE PRD_DET then do:
                display skip "Printer Error " @ WMESSAGE NO-LABEL with fram F9160.
                pause 0 before-hide.
                undo, retry.
        end.
         /*  ---- Valid Check ---- END */
...
If AVAILABLE ( pt_mstr )  then
       ...
       END.
        av9160 = V1510.
       IF INDEX(ts9160,"$A") <> 0  THEN DO:
       TS9160 = substring(TS9160, 1, Index(TS9160 , "$A") - 1) + av9160 
       + SUBSTRING( ts9160 , index(ts9160 ,"$A") + length("$A"), LENGTH(ts9160) - ( index(ts9160 ,"$A" ) + length("$A") - 1 ) ).
       END.
        av9160 = V1303.
       IF INDEX(ts9160,"$S") <> 0  THEN DO:
       TS9160 = substring(TS9160, 1, Index(TS9160 , "$S") - 1) + av9160 
       + SUBSTRING( ts9160 , index(ts9160 ,"$S") + length("$S"), LENGTH(ts9160) - ( index(ts9160 ,"$S" ) + length("$S") - 1 ) ).
       END.
