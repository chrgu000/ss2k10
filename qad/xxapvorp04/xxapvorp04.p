...
/*add acct sub and cc fliter                                              924 */
...
/*924*/ define variable acct  like ap_acct no-undo.
/*924*/ define variable acct1 like ap_acct no-undo.
/*924*/ define variable sub   like ap_sub no-undo.
/*924*/ define variable sub1  like ap_sub no-undo.
/*924*/ define variable cc    like ap_cc no-undo.
/*924*/ define variable cc1   like ap_cc no-undo.
...
form
   ...
   lstype         colon 15
/*924*/   acct           colon 15
/*924*/   acct1          label "To" colon 49
/*924*/   sub            colon 15
/*924*/   sub1           label "To" colon 49
/*924*/   cc             colon 15
/*924*/   cc1            label "To" colon 49
   vodate1        colon 30
   age_by         colon 30
   base_rpt       colon 30
...
/*924*/     and (ap_acct >= acct and ap_acct <= acct1)
/*924*/     and (ap_sub >= sub and ap_sub <= sub1)
/*924*/     and (ap_cc >= cc and ap_cc <= cc1)
            and (ap_type = "VO")
...
/*924*/   if acct1   = hi_char then acct1   = "".
/*924*/   if sub1    = hi_char then sub1    = "".
/*924*/   if cc1     = hi_char then cc1     = "".
...
/*924*/  if acct1   = "" then acct1   = hi_char.
/*924*/  if sub1    = "" then sub1    = hi_char.
/*924*/  if cc1     = "" then cc1     = hi_char.
   {&APVORP04-P-TAG64}
