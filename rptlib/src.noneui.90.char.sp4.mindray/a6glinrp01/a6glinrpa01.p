...
/* web convert glinrpa.p (converter v1.00) Fri Oct 10 13:57:44 1997      */
/* web tag in glinrpa.p (converter v1.00) Mon Oct 06 14:18:18 1997       */
...
&SCOPED-DEFINE glinrpa_p_1 "层次"
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_2 "结束日期"
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_3 "开始日期"
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_4 "圆整至千元"
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_5 "圆整至整数单位"
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_6 "合计 "
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_7 "汇总成本中心"
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_8 "抑制有零余额的帐户"
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_9 "抑制帐户号码"
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_10 "汇总分帐户"
/* MaxLen: Comment: */

&SCOPED-DEFINE glinrpa_p_11 "使用预算金额"
/* MaxLen: Comment: */
                      ...
                      if fm_total = no or level = cur_level then do:
                         if not fmbgflag or fmbgrecid = recid(fm_mstr) then do:
                            ...
                            if totflag[cur_level] then
                               put "--------------------" to 77 "--------" at 79
                                   {&glinrpa_p_6} at min(16, cur_level * 3 - 2)
                                   fm_desc.
                            else if fm_header then put fm_desc at
                               min(16, cur_level * 3 - 2).
                            */
                            /* SS - Bill - E */
...
/*L00S*END ADD SECTION*/
             ...
             if fm_header = no and level >= cur_level then
                put fm_desc at min(16, cur_level * 3 - 2).
             */
             /* SS - Bill - E */
