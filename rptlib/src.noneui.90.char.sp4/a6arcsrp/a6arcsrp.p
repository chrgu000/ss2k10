...
define INPUT PARAMETER code like cm_addr.
define INPUT PARAMETER code1 like cm_addr.
define INPUT PARAMETER name like ad_name.
define INPUT PARAMETER name1 like ad_name.
define INPUT PARAMETER type like cm_type.
define INPUT PARAMETER type1 like cm_type.
define INPUT PARAMETER neg_only like mfc_logical.
define INPUT PARAMETER over_only like mfc_logical.
define INPUT PARAMETER inc_zero like mfc_logical.

/*L01G*/ define INPUT PARAMETER et_report_curr  like exr_curr1.
...
/*L00M*/                et_cm_balance.
                */
                CREATE tta6arcsrp.
                ASSIGN
                    tta6arcsrp_addr = ad_addr
                    tta6arcsrp_balance = cm_balance
                    .
                /* SS - 20050804 - E */
