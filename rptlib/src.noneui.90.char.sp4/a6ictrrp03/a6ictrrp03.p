...
/*F268*/       end. /*if tr_yn*/
          */
          ...
          /* SS - 20050713 - B */
    FIND FIRST tttrgl 
        WHERE tttrgl_acct = trgl_dr_acct 
        AND tttrgl_part = tr_part
        AND tttrgl_prodline = tr_prod_line 
        NO-LOCK 
        NO-ERROR
        .
    IF AVAILABLE tttrgl THEN DO:
        ASSIGN
            tttrgl_qty = tttrgl_qty + tr_qty_loc
    ...
    ELSE DO:
        ...
        ASSIGN
            ...
            tttrgl_part = tr_part
            tttrgl_prodline = tr_prod_line
            tttrgl_qty = tr_qty_loc
