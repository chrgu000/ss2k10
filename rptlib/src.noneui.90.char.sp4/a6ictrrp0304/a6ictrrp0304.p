...
/* REVISION: 9.0      LAST MODIFIED: 08/24/05   BY: *SS - 20050830* Bill Jiang       */
...
/*F268*/       end. /*if tr_yn*/
    ...
    */
    /* SS - 20050830 - B */
    FOR FIRST tta6ictrrp0304
        WHERE tta6ictrrp0304_part = tr_part
        AND tta6ictrrp0304_site = tr_site
        NO-LOCK:
    END.
    IF NOT AVAILABLE tta6ictrrp0304 THEN DO:
        CREATE tta6ictrrp0304.
        ASSIGN
            tta6ictrrp0304_part = tr_part
            tta6ictrrp0304_site = tr_site
            .
    END.      
    IF gltr_amt > 0 THEN DO:
        ASSIGN
            tta6ictrrp0304_amt_dr = tta6ictrrp0304_amt_dr + gltr_amt
            .
    END.
    ELSE DO:
        ASSIGN
            tta6ictrrp0304_amt_cr = tta6ictrrp0304_amt_cr + gltr_amt
            .
    END.
    /* SS - 20050830 - E */
    /* SS - 20050809 - E */
