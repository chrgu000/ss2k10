...
/* REVISION: 9.0      LAST MODIFIED: 08/26/05   BY: *SS - 20050826* Bill Jiang       */
...
/*F268*/       end. /*if tr_yn*/
    ...
    */
    /* SS - 20050826 - B */
    FIND wo_mstr WHERE wo_nbr = tr_nbr AND wo_lot = tr_lot NO-LOCK NO-ERROR.
    IF AVAILABLE wo_mstr THEN
        p = wo_part.
    ELSE
        p = tr_part.

    FOR FIRST tta6ictrrp0305
        WHERE tta6ictrrp0305_part = p
        AND tta6ictrrp0305_site = tr_site
        AND tta6ictrrp0305_nbr = tr_nbr
        AND tta6ictrrp0305_lot = tr_lot
        NO-LOCK:
    END.
    IF AVAILABLE tta6ictrrp0305 THEN DO:
        ASSIGN
            tta6ictrrp0305_amt = tta6ictrrp0305_amt + gltr_amt
            .
    END.
    ELSE DO:
        CREATE tta6ictrrp0305.
        ASSIGN
            tta6ictrrp0305_part = p
            tta6ictrrp0305_site = tr_site
            tta6ictrrp0305_nbr = tr_nbr
            tta6ictrrp0305_lot = tr_lot
            .
        ASSIGN
            tta6ictrrp0305_amt = tta6ictrrp0305_amt + gltr_amt
            .
