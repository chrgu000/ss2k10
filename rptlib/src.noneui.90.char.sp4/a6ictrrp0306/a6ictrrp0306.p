...
/*F268*/       end. /*if tr_yn*/
    ...
    */
    ...
    FOR FIRST tta6ictrrp0306
        WHERE tta6ictrrp0306_pl = pl
        AND tta6ictrrp0306_site = tr_site
        NO-LOCK:
    END.
    IF NOT AVAILABLE tta6ictrrp0306 THEN DO:
        CREATE tta6ictrrp0306.
        ASSIGN
            tta6ictrrp0306_pl = pl
            tta6ictrrp0306_site = tr_site
            .
    END.      
    IF gltr_amt > 0 THEN DO:
        ASSIGN
            tta6ictrrp0306_amt_dr = tta6ictrrp0306_amt_dr + gltr_amt
            .
    END.
    ELSE DO:
        ASSIGN
            tta6ictrrp0306_amt_cr = tta6ictrrp0306_amt_cr + gltr_amt
            .
    END.
    /* SS - 20050825 - E */
    /* SS - 20050809 - E */
