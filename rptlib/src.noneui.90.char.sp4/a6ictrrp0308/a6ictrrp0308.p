...
/*F268*/       end. /*if tr_yn*/
    ...
    */
    ...
    FOR FIRST tta6ictrrp0308
        WHERE tta6ictrrp0308_site = tr_site
        AND tta6ictrrp0308_pl = p
        NO-LOCK:
    END.
    IF NOT AVAILABLE tta6ictrrp0308 THEN DO:
        CREATE tta6ictrrp0308.
        ASSIGN
            tta6ictrrp0308_site = tr_site
            tta6ictrrp0308_pl = p
            .
    END.      
    IF  (trgl_dr_acct >= acc and trgl_dr_acct <= acc1) THEN DO:
        ASSIGN
            tta6ictrrp0308_dr = tta6ictrrp0308_dr + trgl_gl_amt
            .
    END.
    ELSE DO:
        ASSIGN
            tta6ictrrp0308_cr = tta6ictrrp0308_cr - trgl_gl_amt
            .
    END.
    /*
    IF gltr_amt > 0 THEN DO:
        ASSIGN
            tta6ictrrp0308_dr = tta6ictrrp0308_dr + gltr_amt
            .
    END.
    ELSE DO:
        ASSIGN
            tta6ictrrp0308_cr = tta6ictrrp0308_cr + gltr_amt
            .
    END.
    */
    /* SS - 20050901 - E */
