...
/*F268*/       end. /*if tr_yn*/
    ...
    */
    /* SS - 20050901 - B */
    CREATE tta6ictrrp0309.
    ASSIGN
        tta6ictrrp0309_site = tr_site
        tta6ictrrp0309_part = tr_part
        tta6ictrrp0309_trnbr = tr_trnbr
        tta6ictrrp0309_type = tr_type
        tta6ictrrp0309_nbr = tr_nbr
        tta6ictrrp0309_qty = tr_qty_loc
        .
    IF  (trgl_dr_acct >= acc and trgl_dr_acct <= acc1) THEN DO:
        ASSIGN
            tta6ictrrp0309_acct = trgl_dr_acct
            tta6ictrrp0309_cc = trgl_dr_cc
            tta6ictrrp0309_amt = trgl_gl_amt
            .
    END.
    ELSE DO:
        ASSIGN
            tta6ictrrp0309_acct = trgl_cr_acct
            tta6ictrrp0309_cc = trgl_cr_cc
            tta6ictrrp0309_amt = (- trgl_gl_amt)
            .
    END.
    /*
    IF gltr_amt > 0 THEN DO:
        ASSIGN
            tta6ictrrp0309_amt_dr = tta6ictrrp0309_amt_dr + gltr_amt
            .
    END.
    ELSE DO:
        ASSIGN
            tta6ictrrp0309_amt_cr = tta6ictrrp0309_amt_cr + gltr_amt
            .
    END.
    */
    /* SS - 20050901 - E */
