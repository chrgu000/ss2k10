...
/* REVISION: 7.3      LAST MODIFIED: 09/06/05   BY: Bill Jiang  /*SS - 20050906*/   */
...
/*G1T9*/ define {1} shared workfile ap_wkfl
    ...
    field apwk_base like ap_amt.       /* Value in base currency       */
               */
DEFINE {1} SHARED TEMP-TABLE tta6ictrrp0310
    FIELD tta6ictrrp0310_site LIKE tr_site
    FIELD tta6ictrrp0310_part LIKE tr_part
    FIELD tta6ictrrp0310_qty_dr LIKE tr_qty_loc
    FIELD tta6ictrrp0310_qty_cr LIKE tr_qty_loc
    FIELD tta6ictrrp0310_amt_dr LIKE gltr_amt
    FIELD tta6ictrrp0310_amt_cr LIKE gltr_amt
