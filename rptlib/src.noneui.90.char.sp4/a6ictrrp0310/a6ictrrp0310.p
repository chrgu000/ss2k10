...
/* REVISION: 9.0      LAST MODIFIED: 09/06/05   BY: *SS - 20050906* Bill Jiang       */
...
/*F268*/       end. /*if tr_yn*/
    ...
    */
    /* SS - 20050906 - B */
    FOR FIRST tta6ictrrp0310
        WHERE tta6ictrrp0310_site = tr_site
        AND tta6ictrrp0310_part = tr_part
        NO-LOCK:
    END.
    IF NOT AVAILABLE tta6ictrrp0310 THEN DO:
        CREATE tta6ictrrp0310.
        ASSIGN
            tta6ictrrp0310_site = tr_site
            tta6ictrrp0310_part = tr_part
            .
    END.      
    IF  (trgl_dr_acct >= acc and trgl_dr_acct <= acc1) THEN DO:
        ASSIGN
            tta6ictrrp0310_qty_dr = tta6ictrrp0310_qty_dr + tr_qty_loc
            tta6ictrrp0310_amt_dr = tta6ictrrp0310_amt_dr + trgl_gl_amt
            .
    END.
    ELSE DO:
        ASSIGN
            tta6ictrrp0310_qty_cr = tta6ictrrp0310_qty_cr + tr_qty_loc
            tta6ictrrp0310_amt_cr = tta6ictrrp0310_amt_cr - trgl_gl_amt
            .
    END.
    /*
    IF gltr_amt > 0 THEN DO:
        ASSIGN
            tta6ictrrp0310_dr = tta6ictrrp0310_dr + gltr_amt
            .
    END.
    ELSE DO:
        ASSIGN
            tta6ictrrp0310_cr = tta6ictrrp0310_cr + gltr_amt
            .
    END.
    */
    /* SS - 20050906 - E */
