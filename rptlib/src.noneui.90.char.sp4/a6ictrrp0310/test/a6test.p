...
/* REVISION: 9.0 LAST MODIFIED: 2005/09/06 BY: *SS - 20050906* Bill Jiang */
...
/*F268*/    end.
               */
                ...
                FOR EACH tta6ictrrp0310:
                    DELETE tta6ictrrp0310.
                END.

                {gprun.i ""a6ictrrp0310.p"" "(
                    INPUT efdate,
                    INPUT efdate1,
                    INPUT trtype,
                    INPUT dc,
                ...
                EXPORT DELIMITER ";" "site" "part" "qty_dr" "qty_cr" "amt_dr" "amt_cr".
                FOR EACH tta6ictrrp0310:
                    EXPORT DELIMITER ";" tta6ictrrp0310_site tta6ictrrp0310_part tta6ictrrp0310_qty_dr tta6ictrrp0310_qty_cr tta6ictrrp0310_amt_dr tta6ictrrp0310_amt_cr.
                END.
