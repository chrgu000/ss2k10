...
/*K0R1*/ {mfdtitle.i "0+ "} /*GI38*/
    */
/*K0R1*/ {a6mfdtitle.i "0+ "} /*GI38*/

    {a6ppptrp0601.i}

    define input parameter part    like pt_part.
    define input parameter part1   like pt_part.
    define input parameter line    like pt_prod_line.
    define input parameter line1   like pt_prod_line.
    define input parameter vend    like pt_vend.
    define input parameter vend1   like pt_vend.
    define input parameter abc     like pt_abc.
    define input parameter abc1    like pt_abc.
    define input parameter site         like in_site.
    define input parameter site1        like in_site.
    define input parameter part_group   like pt_group.
    define input parameter part_group1  like pt_group.
    define input parameter part_type    like pt_part_type.
    define input parameter part_type1   like pt_part_type.
    
    define input parameter as_of_date   like tr_effdate.
    define input parameter neg_qty like mfc_logical.
    define input parameter net_qty      like mfc_logical.
    define input parameter inc_zero_qty like mfc_logical.
    define input parameter zero_cost    like mfc_logical.
    /* SS - 20050901 - E */
...
/*F003*/                down.
*/
    FIND FIRST tta6ppptrp0601 WHERE tta6ppptrp0601_site = IN_site AND tta6ppptrp0601_pl = pl_prod_line NO-LOCK NO-ERROR.
                        IF NOT AVAILABLE tta6ppptrp0601 THEN DO:
                        ...
                        END.
                        ASSIGN
                            tta6ppptrp0601_qty = tta6ppptrp0601_qty + TOTAL_qty_oh
                            tta6ppptrp0601_ext = tta6ppptrp0601_ext + ext_std
                            .
/* SS - 20050901 - E */
