...
/* REVISION: 7.3            CREATED: 08/30/05   BY: Bill Jiang *SS - 20050830*          */
/* SS - 20050830 - B */
{a6sfacrp0103.i}
/* SS - 20050830 - E */
         {mfdeclre.i}
           ...
           if available glt_det then do:
              ...
              */
              ...
              and (
                  ...
                  FOR FIRST tta6sfacrp0103
                      WHERE tta6sfacrp0103_site = op_site
                      AND tta6sfacrp0103_part = op_part
                      AND tta6sfacrp0103_nbr = op_wo_nbr
                      AND tta6sfacrp0103_lot = op_wo_lot
                      NO-LOCK:
                  END.
                  IF NOT AVAILABLE tta6sfacrp0103 THEN DO:
                      CREATE tta6sfacrp0103.
                      ASSIGN
                          tta6sfacrp0103_site = op_site
                          tta6sfacrp0103_part = op_part
                          tta6sfacrp0103_nbr = op_wo_nbr
                          tta6sfacrp0103_lot = op_wo_lot
                          .
                  END.
                  IF glt_amt > 0 THEN DO:
                      ASSIGN 
                          tta6sfacrp0103_amt_dr = tta6sfacrp0103_amt_dr + glt_amt
                          .
                  END.
                  ELSE DO:
                      ASSIGN 
                          tta6sfacrp0103_amt_cr = tta6sfacrp0103_amt_cr + glt_amt
                          .
                  END.
              END.
              /* SS - 20050830 - E */
                 ...
                 */
                 ...
                 and (
                     ...
                     IF gltr_amt > 0 THEN DO:
                         ASSIGN 
                             tta6sfacrp0103_amt_dr = tta6sfacrp0103_amt_dr + gltr_amt
                             .
                     END.
                     ELSE DO:
                         ASSIGN 
                             tta6sfacrp0103_amt_cr = tta6sfacrp0103_amt_cr + gltr_amt
                             .
                     END.
                 END.
                 /* SS - 20050830 - E */
