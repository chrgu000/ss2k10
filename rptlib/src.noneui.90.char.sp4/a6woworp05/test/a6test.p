...
/* MaxLen: Comment: */
    ...
    /* SS - 20050804 - B */
&SCOPED-DEFINE woworp05_p_7 "只打印会计结算加工单"
    /* SS - 20050804 - E */
...
*/
         define new shared variable skpage like mfc_logical initial NO
            label {&woworp05_p_3}.
         define new shared variable stat like wo_status.

/*F003*/ define new shared variable mtlyn like mfc_logical initial NO
/*F003*/    label {&woworp05_p_2}     format {&woworp05_p_6}.
/*F003*/ define new shared variable lbryn like mfc_logical initial NO
/*F003*/    label {&woworp05_p_5}        format {&woworp05_p_6}.
/*F003*/ define new shared variable bdnyn like mfc_logical initial NO
/*F003*/    label {&woworp05_p_4}       format {&woworp05_p_6}.
/*F003*/ define new shared variable subyn like mfc_logical initial NO
/*F003*/    label {&woworp05_p_1}  format {&woworp05_p_6}.
/* SS - 20050804 - E */

/* SS - 20050804 - B */
define variable acct_close like wo_acct_close initial yes label {&woworp05_p_7}.
...
/* SS - 20050804 - E */
         ...
         form
            ...
            due         colon 15
            due1        label {t001.i} colon 49 skip (0)
             /* SS - 20050804 - B */
             acct_close      colon 30
             CLOSE_date         colon 15
             close_date1        label {t001.i} colon 49 skip 
             CLOSE_eff         colon 15
             close_eff1        label {t001.i} colon 49 skip (0)
             /* SS - 20050804 - E */
            so_job      colon 30 skip
            vend        colon 30 skip
            stat        colon 30 skip (0)
/*F003*     parts       colon 30  */
...
/*K0XV*/    {wbrp06.i &command = update &fields = "  nbr nbr1 lot lot1
             part part1 due due1 acct_close close_date close_date1 close_eff close_eff1 so_job vend stat   mtlyn lbryn bdnyn subyn
             skpage" &frm = "a"}
    /* SS - 20050804 - E */
...
/*K0XV*/    end. /* if c-application-mode */
            ...
            {gprun.i ""woworp5a.p""}
                */
            FOR EACH tta6woworp05:
                DELETE tta6woworp05.
            END.
            {gprun.i ""a6woworp05.p"" "(
                INPUT nbr,
                INPUT nbr1,
                INPUT lot,
                INPUT lot1,
            ...
            EXPORT DELIMITER ";" "part" "nbr" "lot" "qty_comp" "acctot" "wipamt".
            FOR EACH tta6woworp05:
                EXPORT DELIMITER ";" tta6woworp05_part tta6woworp05_nbr tta6woworp05_lot tta6woworp05_qty_comp tta6woworp05_acctot tta6woworp05_wipamt.
            END.
            /* SS - 20050804 - E */
