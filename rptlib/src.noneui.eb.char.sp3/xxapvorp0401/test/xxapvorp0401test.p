...
/*N0VQ*/    {&APVORP04-P-TAG26}
            ...
            EXPORT DELIMITER ";" "供应商" "供应商名称" "联系人" "电话" "分机" "凭证" "发票日期" "生效日期" "截止日期" "支付方式" "本币金额[1]" "本币金额[2]" "本币金额[3]" "本币金额[4]" "本币金额[5]" "本币金额[6]" "本币金额[7]" "本币金额[8]" "本币金额合计" "是否暂停付款" "发票" "原币单位" "本币单位" "原币" "应付账户" "应付分账户" "应付成本中心" "原币金额合计".
            EXPORT DELIMITER ";" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "扩展输出" "扩展输出" "扩展输出" "扩展输出" "标准输出" "标准输出" "标准输出" "扩展输出" "扩展输出" "扩展输出" "扩展输出" "扩展输出" "扩展输出" "扩展输出".
            EXPORT DELIMITER ";" "ap_vend" "name" "ad_attn" "ad_phone" "ad_ext" "voucherno" "invdate" "effdate" "duedate" "vo_cr_terms" "et_age_amt[1]" "et_age_amt[2]" "et_age_amt[3]" "et_age_amt[4]" "et_age_amt[5]" "et_age_amt[6]" "et_age_amt[7]" "et_age_amt[8]" "et_base_amt" "hold" "invoice" "ap_ex_rate" "ap_ex_rate2" "ap_curr" "ap_acct" "ap_sub" "ap_cc" "et_curr_amt".
            FOR EACH ttxxapvorp0401:
