...
/* Revision: 1.8.1.11.3.4   BY: Somesh Jeswani  DATE: 07/07/04  ECO: *P28R* */
/* Revision: 1.8.1.11.3.5   BY: Gaurav Kerkar   DATE: 07/22/04  ECO: *P2BY* */
/* Revision: 1.8.1.11.3.6   BY: Vandna Rohira   DATE: 10/15/04  ECO: *P2NM* */
/* Revision: 1.8.1.11.3.7   BY: Priya Idnani    DATE: 05/06/05  ECO: *P3KJ* */
/* Revision: 1.8.1.11.3.8   BY: Alok Gupta      DATE: 06/17/05  ECO: *P3PQ* */
/* Revision: 1.8.1.11.3.9   BY: Abhishek Jha    DATE: 08/29/05  ECO: *P3ZQ* */
/* $Revision: 1.8.1.11.3.10 $   BY: Bharath Kumar    DATE: 09/06/05  ECO: *P40R* */
/* $Revision: 1.8.1.11.3.10 $   BY: Bill Jiang    DATE: 07/24/06  ECO: *SS - 20060724.1* */
   ...
   for each pt_mstr
      ...
      */
         ...
         do on error undo, leave:
            ...
            for each tr_hist
               fields(tr_part    tr_site    tr_loc     tr_nbr
                      ...
                      tr_status  tr_program tr_ship_type)
               ...
               then do:
                  ...
                  no-lock:
                     ...
                     then do:
                        ...
                        /* ADDED trhist.tr_qty_loc TO non_consign SINCE IT */
                        /* WOULD HAVE BEEN DEDUCTED FOR THE RCT-TR/ISS-SO  */
                        /* TRANSACTION IN THE ELSE PART BELOW              */
                        assign
                           tot_cust_consign_qty = tot_cust_consign_qty
                                                  - l_temp_qty_loc
                           non_consign_qoh      = non_consign_qoh
            ...
            if  (inc_zero_qty or total_qty_oh <> 0)
               ...
               */
               ...
               down.
               */
               CREATE tta6ppptrp0601.
               ASSIGN 
                  tta6ppptrp0601_part = pt_part 
                  tta6ppptrp0601_desc1 = pt_desc1
                  tta6ppptrp0601_site = in_site 
                  tta6ppptrp0601_abc = in_abc
                  tta6ppptrp0601_qty = total_qty_oh 
                  tta6ppptrp0601_um = pt_um
                  tta6ppptrp0601_std_as_of = std_as_of
                  tta6ppptrp0601_ext = ext_std
                  tta6ppptrp0601_pl = pl_prod_line
                  .

               if pt_desc2 <> "" then
                  ASSIGN
                  tta6ppptrp0601_desc2 = pt_desc2
                  .
               ...
               then do with frame b:
                  ASSIGN
                      tta6ppptrp0601_qty_non_consign = non_consign_qoh
                      .
                  ...
                  then do:
                     ASSIGN
                         tta6ppptrp0601_qty_cust_consign = tot_cust_consign_qty
                         .
                  end.  /* IF tot_cust_consign_qty <> 0 */
                  ...
                  then do:
                     ASSIGN
                         tta6ppptrp0601_qty_supp_consign = tot_supp_consign_qty
                         .
                  end.  /* IF tot_supp_consign_qty <> 0 */
      ...
      if last (pt_prod_line) then do with frame b:
         ...
         display
            caps(getTermLabel("REPORT_TOTAL",15)) format "x(15)" @ std_as_of
            acc  @ ext_std.
      end.
      */
      /* SS - 20060724.1 - E */
