...
/* $Revision: 1.9.1.12.3.25 $ BY: Bill Jiang  DATE: 06/06/06  ECO: *SS - 20060606.1* */
            ...
            */
            ...
            then do:
               ...
               then do:
                  ...
                  down.
                  */
                  CREATE tta6ppptrp0701.
                  ASSIGN
                     tta6ppptrp0701_site = in_site
                     tta6ppptrp0701_loc = t_lddet_loc
                     tta6ppptrp0701_part = t_lddet_part
                     tta6ppptrp0701_desc = t_sct_desc1 + " " + t_sct_desc2
                     tta6ppptrp0701_abc = t_sct_abc
                     tta6ppptrp0701_qty = total_qty_oh
                     tta6ppptrp0701_um = t_sct_um
                     tta6ppptrp0701_sct = t_sct_std_as_of
                     tta6ppptrp0701_ext = ptloc_ext_std
                     .
                  /* SS - 20060606.1 - E */
                  ...
                  */
                  ...
                  then do:
                     ...
                     then do:
								ASSIGN
									tta6ppptrp0701_qty_non_consign = l_non_consign_qoh
									.
                     end. /* IF l_non_consign_qoh <> 0 */
                     ...
                     then do:
								ASSIGN
									tta6ppptrp0701_qty_cust_consign = tot_cust_consign_qty
									.
                     end.  /* IF tot_cust_consign_qty <> 0 */
                     ...
                     then do:
								ASSIGN
									tta6ppptrp0701_qty_supp_consign = tot_supp_consign_qty
									.
                     end.  /* IF tot_supp_consign_qty <> 0 */
                  end.  /* IF tot_cust_consign_qty <> 0 ...*/
                  /* SS - 20060606.1 - E */
