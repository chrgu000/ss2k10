...
/* Revision: 1.9.1.12.3.15 BY: Preeti Sattur    DATE: 04/05/05  ECO: *P3FP* */
/* Revision: 1.9.1.12.3.16 BY: Priya Idnani     DATE: 04/20/05  ECO: *P3HP* */
/* Revision: 1.9.1.12.3.17 BY: Priya Idnani     DATE: 05/06/05  ECO: *P3KJ* */
/* Revision: 1.9.1.12.3.20 BY: Steve Nugent     DATE: 05/10/05  ECO: *P3KV* */
/* Revision: 1.9.1.12.3.21 BY: Steve Nugent     DATE: 05/10/05  ECO: *P3LJ* */
/* Revision: 1.9.1.12.3.22 BY: Alok Gupta       DATE: 06/17/05  ECO: *P3PQ* */
/* Revision: 1.9.1.12.3.23 BY: Sushant Pradhan  DATE: 06/28/05  ECO: *P3PT* */
/* Revision: 1.9.1.12.3.24 BY: Abhishek Jha  DATE: 08/29/05  ECO: *P3ZQ* */
/* $Revision: 1.9.1.12.3.25 $ BY: Bharath Kumar  DATE: 09/06/05  ECO: *P40R* */
/* $Revision: 1.9.1.12.3.25 $ BY: Bill Jiang  DATE: 07/24/06  ECO: *SS - 20060724.1* */
   ...
   break by in_site by in_part with frame b width 132:
      ...
      */
      ...
      then do:
         ...
         for each tr_hist
            fields(tr_part tr_site tr_loc 
                   /* SS - 20060724.1 - B */
                   tr_serial
                   /* SS - 20060724.1 - E */
                   tr_status tr_ship_type
                   tr_rev tr_lot tr_ref tr_qty_loc tr_effdate
                   tr_program)
         no-lock
            ...
            then do:
               ...
               for each tr_hist
                  fields(tr_part tr_effdate tr_site tr_loc 
                         ...
                         /* SS - 20060724.1 - E */
                         tr_ship_type
                  tr_nbr tr_line tr_serial tr_ref tr_rev
               ...
               no-lock:
                  ...
                  then do:
                     ...
                     for first trhist
                        fields(tr_trnbr tr_type tr_rmks)
                        where trhist.tr_trnbr       > integer(tr_hist.tr_rmks)
                  ...
                  then do:
                     ...
                     for first trhist
                         ...
                         where trhist.tr_trnbr > tr_hist.tr_trnbr
               ...
               then do:
                  ...
                  down.
                  */
                  CREATE tta6ppptrp0702.
                  ASSIGN
                     tta6ppptrp0702_site = in_site
                     tta6ppptrp0702_loc = t_lddet_loc
                     tta6ppptrp0702_part = t_lddet_part
                     /* SS - 20060724.1 - B */
                     tta6ppptrp0702_lot = t_lddet_lot
                     /* SS - 20060724.1 - E */
                     tta6ppptrp0702_desc = t_sct_desc1 + " " + t_sct_desc2
                     tta6ppptrp0702_abc = t_sct_abc
                     tta6ppptrp0702_qty = total_qty_oh
                     tta6ppptrp0702_um = t_sct_um
                     tta6ppptrp0702_sct = t_sct_std_as_of
                     tta6ppptrp0702_ext = ptloc_ext_std
                     .
                  /* SS - 20060724.1 - E */
                  ...
                  */
                  ...
                  then do:
                     ...
                     then do:
                        ...
                        ASSIGN
                        tta6ppptrp0702_qty_non_consign = l_non_consign_qoh
                        .
                     ...
                     then do:
                        ...
                        ASSIGN
                        tta6ppptrp0702_qty_cust_consign = tot_cust_consign_qty
                        .
                     ...
                     then do:
                        ...
                        ASSIGN
                        tta6ppptrp0702_qty_supp_consign = tot_supp_consign_qty
                        .
                     end.  /* IF tot_supp_consign_qty <> 0 */
