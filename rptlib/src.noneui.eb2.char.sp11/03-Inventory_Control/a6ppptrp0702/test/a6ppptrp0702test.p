...
repeat:
   ...
   FOR EACH tta6ppptrp0702:
       DELETE tta6ppptrp0702.
   END.

   {gprun.i ""a6ppptrp0702.p"" "(
      INPUT part,
      INPUT part1,
      INPUT LINE,
      INPUT line1,
   ...
   EXPORT DELIMITER ";" "site" "loc" "part" "lot" "desc" "abc" "qty" "um" "sct" "ext" "qty_non_consign" "qty_cust_consign" "qty_supp_consign".
   FOR EACH tta6ppptrp0702:
      EXPORT DELIMITER ";" tta6ppptrp0702.
   END.
