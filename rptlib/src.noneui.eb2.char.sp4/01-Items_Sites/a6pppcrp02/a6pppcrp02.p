...
define input parameter i_eff1 like ap_effdate.
...
/* SS - 20060405 - B */
define variable eff1 like ap_effdate initial ?.
/* SS - 20060405 - E */
...
form
   ...
   eff            colon 15
   /* SS - 20060405 - B */
   eff1          label {t001.i} colon 49 skip (1)
   /* SS - 20060405 - E */
 ...
 temp_max_price @ pc_amt[07].
   ...
   IF eff <= eff1 THEN DO:
      for each pc_mstr 
         ...
         and (pc_curr >= curr and pc_curr <= curr1)
         and (pc_start <= eff or pc_start = ?) 
         and (pc_expire >= eff1 or pc_expire = ?)
         no-lock 
         :
         ...
         if pc_part <> "" then do:
            ...
            if available pt_mstr then DO: 
               ASSIGN
                  tta6pppcrp02_desc1 = pt_desc1
                  tta6pppcrp02_desc2 = pt_desc2
                  tta6pppcrp02_pt_price = pt_price
                  .
         ...
         ASSIGN
            tta6pppcrp02_list = pc_list
            tta6pppcrp02_curr = pc_curr
            tta6pppcrp02_prod_line = pc_prod_line
            tta6pppcrp02_part = pc_part
            tta6pppcrp02_um = pc_um
            tta6pppcrp02_start = pc_start
            tta6pppcrp02_expire = pc_expire
            tta6pppcrp02_amt_type = pc_amt_type
            tta6pppcrp02_glxcst = glxcst
            .

         if pc_amt_type = "L" then do:
            temp_max_price = (pc_mstr.pc_max_price[1] +  (pc_mstr.pc_max_price[2] / 100000)).
            ASSIGN
               tta6pppcrp02_amt[01] = pc_amt[01]
               tta6pppcrp02_min_price = pc_min_price
               tta6pppcrp02_max_price = temp_max_price
               .
         end.
         else do:
            ASSIGN
               tta6pppcrp02_min_qty[01] = pc_min_qty[01]
               tta6pppcrp02_min_qty[02] = pc_min_qty[02]
               tta6pppcrp02_min_qty[03] = pc_min_qty[03]
               tta6pppcrp02_min_qty[04] = pc_min_qty[04]
               tta6pppcrp02_min_qty[05] = pc_min_qty[05]
               tta6pppcrp02_min_qty[06] = pc_min_qty[06]
               tta6pppcrp02_min_qty[07] = pc_min_qty[07]
               tta6pppcrp02_min_qty[08] = pc_min_qty[08]
               tta6pppcrp02_min_qty[09] = pc_min_qty[09]
               tta6pppcrp02_min_qty[10] = pc_min_qty[10]
               tta6pppcrp02_min_qty[11] = pc_min_qty[11]
               tta6pppcrp02_min_qty[12] = pc_min_qty[12]
               tta6pppcrp02_min_qty[13] = pc_min_qty[13]
               tta6pppcrp02_min_qty[14] = pc_min_qty[14]
               tta6pppcrp02_min_qty[15] = pc_min_qty[15]
               tta6pppcrp02_amt[01] = pc_amt[01]
               tta6pppcrp02_amt[02] = pc_amt[02]
               tta6pppcrp02_amt[03] = pc_amt[03]
               tta6pppcrp02_amt[04] = pc_amt[04]
               tta6pppcrp02_amt[05] = pc_amt[05]
               tta6pppcrp02_amt[06] = pc_amt[06]
               tta6pppcrp02_amt[07] = pc_amt[07]
               tta6pppcrp02_amt[08] = pc_amt[08]
               tta6pppcrp02_amt[09] = pc_amt[09]
               tta6pppcrp02_amt[10] = pc_amt[10]
               tta6pppcrp02_amt[11] = pc_amt[11]
               tta6pppcrp02_amt[12] = pc_amt[12]
               tta6pppcrp02_amt[13] = pc_amt[13]
               tta6pppcrp02_amt[14] = pc_amt[14]
               tta6pppcrp02_amt[15] = pc_amt[15]
               .
         end.
