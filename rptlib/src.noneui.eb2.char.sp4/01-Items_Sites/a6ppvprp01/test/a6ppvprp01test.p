...
/*L00M*/    /* END ADD */
            ...
            for each vp_mstr where
               ...
               no-lock break by vp_part with frame b width 132
               no-box:
...
/*L03V*/          with frame b.
            ...
            {mfrtrail.i}
               */
               ...
               FOR EACH tta6ppvprp01:
                  DELETE tta6ppvprp01.
               END.
               
               {gprun.i ""a6ppvprp01.p"" "(
                  INPUT part,
                  INPUT part1,
                  INPUT vend,
                  INPUT vend1,
               ...
               EXPORT DELIMITER ";" "vend" "vend_part" "um" "mfgr" "mfgr_part" "vend_lead" "q_date" "q_qty" "q_price" "curr" "pr_list" "tp_use_pct" "tp_pct".
               FOR EACH tta6ppvprp01:
                  EXPORT DELIMITER ";" tta6ppvprp01.
               END.
