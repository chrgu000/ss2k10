   ...
   {mfrtrail.i}
       */
       ...
       {gprun.i ""a6ictrrp03.p"" "(
        ...
        EXPORT DELIMITER ";" "inv_nbr" "nbr" "line" "site" "pl" "part" "wo_part" "trnbr" "lot" "effdate" "date" "type" "loc" "acct" "sub" "cc" "proj" "qty_dr" "amt_dr" "qty_cr" "amt_cr".
        FOR EACH tta6ictrrp03:
            EXPORT DELIMITER ";" tta6ictrrp03.
        END.
