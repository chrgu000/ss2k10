...
repeat:
   ...
   for each tr_hist no-lock
      ...
      */
       ...
       CREATE tta6ictrrp03.
       ASSIGN
           tta6ictrrp03_inv_nbr = tr_rmks
           tta6ictrrp03_nbr = tr_nbr
           tta6ictrrp03_line = tr_line
           tta6ictrrp03_site = tr_site
           tta6ictrrp03_pl = tr_prod_line
           tta6ictrrp03_part = tr_part
           tta6ictrrp03_wo_part = tr_part
           tta6ictrrp03_trnbr = tr_trnbr
           tta6ictrrp03_lot = tr_lot
           tta6ictrrp03_effdate = tr_effdate
           tta6ictrrp03_date = tr_date
           tta6ictrrp03_type = tr_type
           tta6ictrrp03_loc = tr_loc
           .
       IF  (trgl_dr_acct >= acct and trgl_dr_acct <= acct1) THEN DO:
           ASSIGN
               tta6ictrrp03_acct = trgl_dr_acct
               tta6ictrrp03_sub = trgl_dr_sub
               tta6ictrrp03_cc = trgl_dr_cc
               tta6ictrrp03_qty_dr = tr_qty_loc
               tta6ictrrp03_amt_dr = trgl_gl_amt
               .
       END.
       ELSE DO:
           ASSIGN
               tta6ictrrp03_acct = trgl_cr_acct
               tta6ictrrp03_sub = trgl_cr_sub
               tta6ictrrp03_cc = trgl_cr_cc
               tta6ictrrp03_qty_cr = tr_qty_loc
               tta6ictrrp03_amt_cr = - trgl_gl_amt
               .
       END.
       FIND FIRST wo_mstr WHERE wo_nbr = tr_nbr AND wo_lot = tr_lot NO-LOCK NO-ERROR.
       IF AVAILABLE wo_mstr THEN DO:
           ASSIGN
               tta6ictrrp03_wo_part = wo_part
               .
       END.
       */
       /* SS - 20051013 - B */
       IF trgl_dr_acct <> trgl_cr_acct OR trgl_dr_sub <> trgl_cr_sub OR trgl_dr_cc <> trgl_cr_cc OR trgl_dr_proj <> trgl_cr_proj THEN DO:
           ...
           IF  (trgl_dr_acct >= acct and trgl_dr_acct <= acct1) THEN DO:
               ASSIGN
                   ...
                   tta6ictrrp03_cc = trgl_dr_cc
                   /* SS - 20051013 - B */
                   tta6ictrrp03_proj = trgl_dr_proj
                   /* SS - 20051013 - E */
                   tta6ictrrp03_qty_dr = tr_qty_loc
                   tta6ictrrp03_amt_dr = trgl_gl_amt
                   .
           ...
           ELSE DO:
               ASSIGN
                   ...
                   tta6ictrrp03_cc = trgl_cr_cc
                   /* SS - 20051013 - B */
                   tta6ictrrp03_proj = trgl_cr_proj
                   /* SS - 20051013 - E */
                   tta6ictrrp03_qty_cr = tr_qty_loc
                   tta6ictrrp03_amt_cr = - trgl_gl_amt
                   .
