...
/* $Revision: 1.20.1.2 $  BY: Bill Jiang    DATE: 02/20/06  ECO: *SS - 20060220*  */
   ...
   for each tr_hist no-lock
      ...
      */
       ...
       ASSIGN
           ...
           tta6ictrrp0303_wo_part = tr_part
       ...
       IF  (trgl_dr_acct >= acct and trgl_dr_acct <= acct1) THEN DO:
           ASSIGN
               tta6ictrrp0303_acct = trgl_dr_acct
               tta6ictrrp0303_sub = trgl_dr_sub
               tta6ictrrp0303_cc = trgl_dr_cc
       ...
       ELSE DO:
           ASSIGN
               tta6ictrrp0303_acct = trgl_cr_acct
               tta6ictrrp0303_sub = trgl_cr_sub
               tta6ictrrp0303_cc = trgl_cr_cc
       ...
       IF AVAILABLE wo_mstr THEN DO:
           ASSIGN
               tta6ictrrp0303_wo_part = wo_part
               .
       END.
       */
       /* SS - 20051013 - B */
       ...
       IF trgl_dr_acct <> trgl_cr_acct OR trgl_dr_sub <> trgl_cr_sub OR trgl_dr_cc <> trgl_cr_cc OR trgl_dr_proj <> trgl_cr_proj THEN DO:
           */
           ...
           IF  (trgl_dr_acct >= acct and trgl_dr_acct <= acct1) THEN DO:
               ASSIGN
                   ...
                   tta6ictrrp0303_cc = trgl_dr_cc
                   /* SS - 20051013 - B */
                   tta6ictrrp0303_proj = trgl_dr_proj
                   /* SS - 20051013 - E */
                   tta6ictrrp0303_qty_dr = tr_qty_loc
                   tta6ictrrp0303_amt_dr = trgl_gl_amt
                   .
           ...
           ELSE DO:
               ASSIGN
                   ...
                   tta6ictrrp0303_cc = trgl_cr_cc
                   /* SS - 20051013 - B */
                   tta6ictrrp0303_proj = trgl_cr_proj
                   /* SS - 20051013 - E */
                   tta6ictrrp0303_qty_cr = tr_qty_loc
                   tta6ictrrp0303_amt_cr = - trgl_gl_amt
                   .
           ...
           */
           ASSIGN
               tta6ictrrp0303_dr_acct = trgl_dr_acct
               tta6ictrrp0303_dr_sub = trgl_dr_sub
               tta6ictrrp0303_dr_cc = trgl_dr_cc
               tta6ictrrp0303_dr_proj = trgl_dr_proj
               tta6ictrrp0303_cr_acct = trgl_cr_acct
               tta6ictrrp0303_cr_sub = trgl_cr_sub
               tta6ictrrp0303_cr_cc = trgl_cr_cc
               tta6ictrrp0303_cr_proj = trgl_cr_proj
               tta6ictrrp0303_qty_dr = tr_qty_loc
               tta6ictrrp0303_amt_dr = trgl_gl_amt
               .
           /* SS - 20060220 - E */
