   ...
   {mfrtrail.i}
       */
       ...
       {gprun.i ""a6ictrrp0303.p"" "(
        ...
        EXPORT DELIMITER ";" "inv_nbr" "nbr" "line" "site" "pl" "part" "wo_part" "trnbr" "lot" "effdate" "date" "type" "loc" "dr_acct" "dr_sub" "dr_cc" "dr_proj" "cr_acct" "cr_sub" "cr_cc" "cr_proj" "qty_dr" "amt_dr" "qty_cr" "amt_cr".
        FOR EACH tta6ictrrp0303:
