...
DEFINE BUFFER pl_mstrbuffer FOR pl_mstr .
   ...
   ******************************************************************************/
   ...
   for each pt_mstr
      ...
      no-lock
         ...
         , EACH pl_mstrbuffer NO-LOCK WHERE pl_mstrbuffer.pl_prod_line = pt_prod_line 
                          AND ( ( pt__log01 = YES OR pl_mstrbuffer.pl__log01 = YES) OR ( ( TODAY - pl_mstrbuffer.pl__dte01 ) > 0 ) )
         , each in_mstr
         ...
         do on error undo, leave:
            ...
            if  (inc_zero_qty or total_qty_oh <> 0)
               ...
               for first pl_mstr
                  ...
                  where  pl_mstr.pl_prod_line = pt_prod_line no-lock:
            ...
            do with frame b:
               ...
               down.
               */
               CREATE tta6ppptrp06new.
               ASSIGN
                   tta6ppptrp06new_part = pt_part
                   tta6ppptrp06new_site = IN_site
                   tta6ppptrp06new_qty = TOTAL_qty_oh
                   tta6ppptrp06new_um = pt_um
                   tta6ppptrp06new_ext = ext_std
                   tta6ppptrp06new_pl = pl_mstr.pl_prod_line
                   .
               /* SS - 20050928 - E */
