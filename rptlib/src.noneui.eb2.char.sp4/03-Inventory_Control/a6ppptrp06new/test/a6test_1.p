...
repeat:
   ...
   ******************************************************************************/
   ...
   FOR EACH tta6ppptrp06new:
       DELETE tta6ppptrp06new.
   END.

    {gprun.i ""a6ppptrp06new.p"" "(
        INPUT part,
        INPUT part1,
        INPUT LINE,
        INPUT line1,
        ...
        EXPORT DELIMITER ";" "site" "pl" "part" "qty" "ext".
        FOR EACH tta6ppptrp06new:
            EXPORT DELIMITER ";" tta6ppptrp06new_site tta6ppptrp06new_pl tta6ppptrp06new_part tta6ppptrp06new_qty tta6ppptrp06new_ext.
        END.
