...
then do:
   ...
   */
   ...
   then
      ...
      CREATE tta6rcshrp0101.
      ASSIGN
         tta6rcshrp0101_abs_shipfrom = s_shipfrom
         tta6rcshrp0101_abs_shipto = s_shipto
         tta6rcshrp0101_abs_inv_mov = s_inv_mov
         tta6rcshrp0101_abs_id = s_id

         tta6rcshrp0101_abs_item = abs_ITEM
         tta6rcshrp0101_shipper_po = l_shipper_po
         tta6rcshrp0101_abs_site = abs_site
         tta6rcshrp0101_abs_order = ABS_order
         tta6rcshrp0101_abs_line = ABS_line
         tta6rcshrp0101_abs_qty = ABS_qty
         tta6rcshrp0101_open_qty = OPEN_qty
         tta6rcshrp0101_due_date = due_date
         tta6rcshrp0101_abs_shp_date = ABS_shp_date

         tta6rcshrp0101_slspsn[1] = slspsn[1]
         tta6rcshrp0101_cust = cust
         tta6rcshrp0101_ship = ship
         tta6rcshrp0101_po = po
         tta6rcshrp0101_abs_lotser = abs_lotser
         tta6rcshrp0101_ord_date = ord_date
         tta6rcshrp0101_so_due_date = sodue_date

         tta6rcshrp0101_trans_mode = s_TRANS_mode
         tta6rcshrp0101_veh_ref = s_veh_ref
         tta6rcshrp0101_dec02 = s_dec02
         .
      IF AVAILABLE pt_mstr THEN DO:
         ASSIGN
            tta6rcshrp0101_pt_um = pt_um
            .
      END.
      ...
      if available absc_det then do:
         ASSIGN
            tta6rcshrp0101_carrier = absc_carrier
            .
