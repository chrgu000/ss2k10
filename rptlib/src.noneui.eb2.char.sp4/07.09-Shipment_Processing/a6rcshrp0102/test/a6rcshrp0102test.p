...
repeat:
   ...
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    FOR EACH tta6rcshrp0102:
        DELETE tta6rcshrp0102.
    END.

   {gprun.i ""a6rcshrp0102.p"" "(
      INPUT shp_date,
      INPUT shp_date1,
      input shipfrom,
      input shipfrom1,
    ...
    EXPORT DELIMITER ";" "abs_shipfrom" "abs_shipto" "abs_inv_mov" "abs_id" "abs_item" "shipper_po" "abs_site" "abs_order" "abs_line" "abs_qty" "open_qty" "due_date" "abs_shp_date" "slspsn[1]" "slspsn[2]" "slspsn[3]" "slspsn[4]" "cust" "ship" "po" "abs_lotser" "ord_date" "so_due_date" "trans_mode" "veh_ref" "dec02" "pt_um" "carrier" "abs_arr_date" "abs_cmtindx".
    FOR EACH tta6rcshrp0102:
        EXPORT DELIMITER ";" tta6rcshrp0102.
    END.
