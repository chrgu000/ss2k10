...
/* $Revision: 1.13.1.6 $         BY: Bill Jiang           DATE: 05/11/07  ECO: *SS - 20070511.1*  */
...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE tta6soivrp0001.
   
   {gprun.i ""a6soivrp0001.p"" "(
      INPUT nbr,
      INPUT nbr1,
      INPUT shipdate,
      INPUT shipdate1,
   ...
   EXPORT DELIMITER ";" "so_inv_nbr" "so_bill" "bill_name" "so_cust" "name" "so_slspsn[1]" "so_slspsn[2]" "so_slspsn[3]" "so_slspsn[4]" "so_ar_acct" "so_ar_sub" "so_ar_cc" "so_tax_env" "so_tax_usage" "so_nbr" "so_ship" "ship_name" "so_ord_date" "so_po" "sod_line" "sod_part" "sod_um" "sod_acct" "sod_sub" "sod_cc" "sod_qty_inv" "sod_taxable" "sod_taxc" "net_price" "ext_price" "ext_gr_margin" "desc1" "qty_bo" "sod_tax_usage".
   FOR EACH tta6soivrp0001:
      EXPORT DELIMITER ";" tta6soivrp0001.
   END.
