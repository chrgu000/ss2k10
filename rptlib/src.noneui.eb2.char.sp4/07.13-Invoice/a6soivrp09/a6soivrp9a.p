   ...
   */
   ...
   for each idh_hist where idh_inv_nbr = ih_inv_nbr
      ...
      */
      ...
      CREATE tta6soivrp09.
      ASSIGN
          tta6soivrp09_inv_nbr = ih_inv_nbr
          tta6soivrp09_nbr = ih_nbr
          tta6soivrp09_line = idh_line
          tta6soivrp09_cust = ih_cust
          tta6soivrp09_prodline = idh_prodline
          tta6soivrp09_part = idh_part
          tta6soivrp09_qty_inv = idh_qty_inv
          tta6soivrp09_ext_price = ext_price
          tta6soivrp09_ext_margin = ext_gr_margin
          tta6soivrp09_ext_tax = tax_amt + l_tax_in
          tta6soivrp09_base_price = base_price
          tta6soivrp09_base_margin = base_margin
          tta6soivrp09_base_tax = tax_amt + l_tax_in
          tta6soivrp09_taxc = idh_taxc
          tta6soivrp09_acct = idh_acct
          tta6soivrp09_sub = idh_sub
          tta6soivrp09_cc = idh_cc
          .
      /* SS - 20050921 - E */
      detail_lines = yes.
