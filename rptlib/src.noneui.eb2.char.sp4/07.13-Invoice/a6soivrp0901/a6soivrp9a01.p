   ...
   */
   ...
   for each idh_hist where idh_inv_nbr = ih_inv_nbr
      ...
      */
      ...
      ASSIGN
          tta6soivrp0901_inv_nbr = ih_inv_nbr
          tta6soivrp0901_nbr = ih_nbr
          tta6soivrp0901_line = idh_line
          tta6soivrp0901_cust = ih_cust
          tta6soivrp0901_prodline = idh_prodline
          tta6soivrp0901_part = idh_part
          tta6soivrp0901_qty_inv = idh_qty_inv
          ...
          tta6soivrp0901_taxc = idh_taxc
          tta6soivrp0901_acct = idh_acct
          tta6soivrp0901_sub = idh_sub
          tta6soivrp0901_cc = idh_cc
          tta6soivrp0901_eff_dt = gltr_eff_dt
