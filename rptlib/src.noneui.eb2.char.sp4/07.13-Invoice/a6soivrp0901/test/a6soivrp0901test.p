...
repeat:
   ...
   */
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    FOR EACH tta6soivrp0901:
        DELETE tta6soivrp0901.
    END.

   {gprun.i ""a6soivrp0901.p"" "(
       INPUT entity,
       INPUT entity1,
       INPUT eff_dt,
       INPUT eff_dt1,
    ...
    EXPORT DELIMITER ";" "inv_nbr" "nbr" "line" "cust" "prodline" "part" "qty_inv" "ext_price" "ext_margin" "ext_tax" "base_price" "base_margin" "base_tax" "taxc" "acct" "sub" "cc" "eff_dt" "inv_date".
    FOR EACH tta6soivrp0901:
        EXPORT DELIMITER ";" tta6soivrp0901_inv_nbr tta6soivrp0901_nbr tta6soivrp0901_line tta6soivrp0901_cust tta6soivrp0901_prodline tta6soivrp0901_part tta6soivrp0901_qty_inv tta6soivrp0901_ext_price tta6soivrp0901_ext_margin tta6soivrp0901_ext_tax tta6soivrp0901_base_price tta6soivrp0901_base_margin tta6soivrp0901_base_tax tta6soivrp0901_taxc tta6soivrp0901_acct tta6soivrp0901_sub tta6soivrp0901_cc tta6soivrp0901_eff_dt tta6soivrp0901_inv_date.
    END.
