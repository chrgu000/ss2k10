...
repeat:
   ...
   */
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    FOR EACH tta6soivrp0902:
        DELETE tta6soivrp0902.
    END.

   {gprun.i ""a6soivrp0902.p"" "(
       INPUT entity,
       INPUT entity1,
       INPUT eff_dt,
       INPUT eff_dt1,
    ...
    EXPORT DELIMITER ";" "inv_nbr" "nbr" "line" "cust" "prodline" "part" "qty_inv" "ext_price" "ext_margin" "ext_tax" "base_price" "base_margin" "base_tax" "taxc" "acct" "sub" "cc" "eff_dt" "inv_date" "ih_channel" "idh_site".
    FOR EACH tta6soivrp0902:
        EXPORT DELIMITER ";" tta6soivrp0902.
    END.
