   ...
   for each idh_hist where idh_inv_nbr = ih_inv_nbr
      ...
      */
      ...
      {gprun.i ""txtotal1.p"" "(input '16',
                                ...
                                input  idh_line,
                                output l_tax_in)"}
      CREATE tta6soivrp0903.
      ASSIGN
          tta6soivrp0903_inv_nbr = ih_inv_nbr
          tta6soivrp0903_nbr = ih_nbr
          tta6soivrp0903_line = idh_line
          tta6soivrp0903_cust = ih_cust
          tta6soivrp0903_prodline = idh_prodline
          tta6soivrp0903_part = idh_part
          tta6soivrp0903_qty_inv = idh_qty_inv
          tta6soivrp0903_ext_price = ext_price
          tta6soivrp0903_ext_margin = ext_gr_margin
          tta6soivrp0903_ext_tax = tax_amt + l_tax_in
          tta6soivrp0903_base_price = base_price
          tta6soivrp0903_base_margin = base_margin
          tta6soivrp0903_base_tax = tax_amt + l_tax_in
          tta6soivrp0903_taxc = idh_taxc
          tta6soivrp0903_acct = idh_acct
          tta6soivrp0903_sub = idh_sub
          tta6soivrp0903_cc = idh_cc
          tta6soivrp0903_eff_dt = gltr_eff_dt
          tta6soivrp0903_inv_date = ih_inv_date
          /* SS - 20060208 - B */
          tta6soivrp0903_ih_channel = ih_channel
          tta6soivrp0903_idh_site = idh_site
          /* SS - 20060208 - E */
          .
      /* SS - 20050921 - E */
      detail_lines = yes.
