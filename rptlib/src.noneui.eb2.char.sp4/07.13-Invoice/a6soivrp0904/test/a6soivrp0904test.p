...
/* $Revision: 1.8.2.5 $    BY: Bill Jiang  DATE: 04/14/06 ECO: *SS - 20060414* */
/******************************************************************************/
...
repeat:
   ...
   */
   ...
   {gprun.i ""a6soivrp0904.p"" "(
    ...
    EXPORT DELIMITER ";" "inv_nbr" "nbr" "line" "cust" "prodline" "part" "qty_inv" "ext_price" "ext_margin" "ext_tax" "base_price" "base_margin" "base_tax" "taxc" "acct" "sub" "cc" "eff_dt" "inv_date" "ih_channel" "idh_site" "ih_curr".
    FOR EACH tta6soivrp0904:
        EXPORT DELIMITER ";" tta6soivrp0904.
    END.
