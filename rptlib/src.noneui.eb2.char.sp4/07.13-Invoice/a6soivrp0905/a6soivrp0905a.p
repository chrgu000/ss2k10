...
/* $Revision: 1.37 $    BY: Bill Jiang      DATE: 07/01/06   ECO: *SS - 20060701.1*   */
   ...
   for each idh_hist where idh_inv_nbr = ih_inv_nbr
      ...
      */
      ...
      {gprun.i ""txtotal1.p"" "(input '16',
                                ...
                                input  idh_line,
                                output l_tax_in)"}
      CREATE tta6soivrp0905.
      ASSIGN
          tta6soivrp0905_inv_nbr = ih_inv_nbr
          tta6soivrp0905_nbr = ih_nbr
          tta6soivrp0905_line = idh_line
          tta6soivrp0905_cust = ih_cust
          tta6soivrp0905_prodline = idh_prodline
          tta6soivrp0905_part = idh_part
          tta6soivrp0905_qty_inv = idh_qty_inv
          tta6soivrp0905_ext_price = ext_price
          tta6soivrp0905_ext_margin = ext_gr_margin
          tta6soivrp0905_ext_tax = tax_amt + l_tax_in
          tta6soivrp0905_base_price = base_price
          tta6soivrp0905_base_margin = base_margin
          tta6soivrp0905_base_tax = tax_amt + l_tax_in
          tta6soivrp0905_taxc = idh_taxc
          tta6soivrp0905_acct = idh_acct
          tta6soivrp0905_sub = idh_sub
          tta6soivrp0905_cc = idh_cc
          tta6soivrp0905_eff_dt = tr_effdate
          tta6soivrp0905_inv_date = ih_inv_date
          /* SS - 20060221 - B */
          tta6soivrp0905_ih_channel = ih_channel
          tta6soivrp0905_idh_site = idh_site
          /* SS - 20060221 - E */
         /* SS - 20060701.1 - B */
         tta6soivrp0905_idh_taxable = idh_taxable
         tta6soivrp0905_idh_tax_in = idh_tax_in
         tta6soivrp0905_ih_project = ih_project
         tta6soivrp0905_ih_curr = ih_curr
         tta6soivrp0905_ih_slspsn[1] = ih_slspsn[1]
         tta6soivrp0905_ih_slspsn[2] = ih_slspsn[2]
         tta6soivrp0905_ih_slspsn[3] = ih_slspsn[3]
         tta6soivrp0905_ih_slspsn[4] = ih_slspsn[4]
         /* SS - 20060701.1 - E */
          .
      /* SS - 20050921 - E */
      detail_lines = yes.
