...
repeat:
   ...
   */
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    FOR EACH tta6soivrp0905:
        DELETE tta6soivrp0905.
    END.

   {gprun.i ""a6soivrp0905.p"" "(
       INPUT entity,
       INPUT entity1,
       INPUT eff_dt,
       INPUT eff_dt1,
    ...
    EXPORT DELIMITER ";" "inv_nbr" "nbr" "line" "cust" "prodline" "part" "qty_inv" "ext_price" "ext_margin" "ext_tax" "base_price" "base_margin" "base_tax" "taxc" "acct" "sub" "cc" "eff_dt" "inv_date" "ih_channel" "idh_site" "idh_taxable" "idh_tax_in" "ih_project" "ih_curr" "ih_slspsn[1]" "ih_slspsn[2]" "ih_slspsn[3]" "ih_slspsn[4]".
    FOR EACH tta6soivrp0905:
        EXPORT DELIMITER ";" tta6soivrp0905.
    END.
