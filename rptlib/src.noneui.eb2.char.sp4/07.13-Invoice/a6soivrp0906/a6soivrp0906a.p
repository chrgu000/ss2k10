...
/* $Revision: 1.37 $    BY: Bill Jiang      DATE: 08/06/06   ECO: *SS - 20060806.1*   */
   ...
   for each idh_hist where idh_inv_nbr = ih_inv_nbr
      ...
      */
      ...
      {gprun.i ""txtotal1.p"" "(input '16',
                                ...
                                input  idh_line,
                                output l_tax_in)"}
      CREATE tta6soivrp0906.

      ASSIGN
         tta6soivrp0906_ih_inv_nbr = ih_inv_nbr
         tta6soivrp0906_ih_rev = ih_rev
         tta6soivrp0906_ih_cust = ih_cust
         tta6soivrp0906_name = NAME
         tta6soivrp0906_ih_po = ih_po
         tta6soivrp0906_ih_ship =ih_ship
         tta6soivrp0906_ih_ship_date = ih_ship_date
         tta6soivrp0906_inv_date = ih_inv_date
         tta6soivrp0906_ih_slspsn[1] = ih_slspsn[1]
         tta6soivrp0906_ih_slspsn[2] = ih_slspsn[2]
         tta6soivrp0906_ih_slspsn[3] = ih_slspsn[3]
         tta6soivrp0906_ih_slspsn[4] = ih_slspsn[4]
         tta6soivrp0906_ih_curr = ih_curr
         tta6soivrp0906_base_curr = base_curr
         tta6soivrp0906_ih_ex_rate = ih_ex_rate
         tta6soivrp0906_ih_ex_rate2 = ih_ex_rate2
         tta6soivrp0906_ih_exru_seq = ih_exru_seq
         tta6soivrp0906_v_disp_line1 = v_disp_line1
         tta6soivrp0906_v_disp_line2 = v_disp_line2
         tta6soivrp0906_ih_rmks = ih_rmks
          .

      ASSIGN
         tta6soivrp0906_idh_nbr = idh_nbr
         tta6soivrp0906_idh_line = idh_line
         tta6soivrp0906_idh_part = idh_part
         tta6soivrp0906_idh_um = idh_um
         .

      IF ih_fsm_type = "FSM-RO" THEN DO:
         ASSIGN
            tta6soivrp0906_idh_qty_ord = l_qty_call
            tta6soivrp0906_idh_qty_inv = l_qty_call
            .
      END.
      ELSE DO:
         ASSIGN
            tta6soivrp0906_idh_qty_ord = idh_qty_ord
            tta6soivrp0906_idh_qty_inv = idh_qty_inv
            .
         IF idh_qty_ord >= 0 THEN DO:
            ASSIGN
               tta6soivrp0906_idh_bo_chg = max(idh_qty_ord - idh_qty_ship, 0)
               .
         END.
         ELSE DO:
            ASSIGN
               tta6soivrp0906_idh_bo_chg = MIN(idh_qty_ord - idh_qty_ship, 0)
               .
         END.
      END.

      ASSIGN
         tta6soivrp0906_disp_curr = DISP_curr
         tta6soivrp0906_base_net_price = base_net_price
         tta6soivrp0906_base_price = base_price
         tta6soivrp0906_base_margin = base_margin
         tta6soivrp0906_idh_due_date = idh_due_date
         tta6soivrp0906_idh_type = idh_type
         .

      ASSIGN
         tta6soivrp0906_ih_channel = ih_channel
         tta6soivrp0906_ih_project = ih_project

         tta6soivrp0906_idh_site = idh_site
         tta6soivrp0906_idh_prodline = idh_prodline
         tta6soivrp0906_idh_taxc = idh_taxc
         tta6soivrp0906_idh_taxable = idh_taxable
         tta6soivrp0906_idh_tax_in = idh_tax_in
         tta6soivrp0906_idh_acct = idh_acct
         tta6soivrp0906_idh_sub = idh_sub
         tta6soivrp0906_idh_cc = idh_cc
         tta6soivrp0906_idh_project = idh_project
         
         tta6soivrp0906_tr_effdate = tr_effdate

         tta6soivrp0906_ext_price = ext_price
         tta6soivrp0906_ext_margin = ext_gr_margin
         tta6soivrp0906_ext_tax = tax_amt + l_tax_in
         tta6soivrp0906_base_tax = tax_amt + l_tax_in
         .
