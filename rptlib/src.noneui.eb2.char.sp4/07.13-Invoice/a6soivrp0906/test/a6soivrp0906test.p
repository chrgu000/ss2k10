...
/* $Revision: 1.8.2.5 $    BY: Bill Jiang  DATE: 09/21/05 ECO: *SS - 20060806* */
/******************************************************************************/
...
repeat:
   ...
   */
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    EMPTY TEMP-TABLE tta6soivrp0906.

   {gprun.i ""a6soivrp0906.p"" "(
       INPUT entity,
       INPUT entity1,
       INPUT eff_dt,
       INPUT eff_dt1,
    ...
    FOR EACH tta6soivrp0906:
        EXPORT DELIMITER ";" tta6soivrp0906.
    END.
