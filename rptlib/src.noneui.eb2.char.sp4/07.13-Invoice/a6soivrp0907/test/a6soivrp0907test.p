...
/* $Revision: 1.8.2.5 $    BY: Bill Jiang  DATE: 05/11/07 ECO: *SS - 20070511.1* */
/******************************************************************************/
...
repeat:
   ...
   */
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    EMPTY TEMP-TABLE tta6soivrp0907.

   {gprun.i ""a6soivrp0907.p"" "(
       INPUT entity,
       INPUT entity1,
       INPUT eff_dt,
       INPUT eff_dt1,
