...
/* $Revision: 1.8 $        BY: Bill Jiang DATE: 06/01/06  ECO: *SS - 20060601.1* */
...
define input parameter i_show_amts like mfc_logical no-undo.
define input parameter i_sort_option as integer no-undo.
/*
{mfdtitle.i "2+ "}
   */
   {a6mfdtitle.i "2+ "}
...
ASSIGN
   ...
   date_to = i_date_to
   show_amts = i_show_amts
   sort_option = i_sort_option
   .
/* SS - 20060601.1 - E */
