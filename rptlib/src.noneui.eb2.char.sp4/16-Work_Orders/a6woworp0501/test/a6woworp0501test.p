...
repeat on error undo, retry:
   ...
   FOR EACH tta6woworp0501:
       DELETE tta6woworp0501.
   END.

    {gprun.i ""a6woworp0501.p"" "(
        INPUT nbr,
        INPUT nbr1,
        INPUT lot,
        INPUT lot1,
    ...
    EXPORT DELIMITER ";" "wo_part" "wo_nbr" "wo_lot" "wo_qty_comp" "wod_part" "wod_qty_iss" "wod_tot_std".
    FOR EACH tta6woworp0501:
        EXPORT DELIMITER ";" tta6woworp0501.
    END.
