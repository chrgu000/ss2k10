   ...
   for each wod_det where wod_lot = wo_lot no-lock break by wod_lot
      ...
      */
      ...
      IF wod_qty_iss <> 0 OR wod_tot_std <> 0 THEN DO:
         CREATE tta6woworp0502.
         ASSIGN
             tta6woworp0502_wo_part = wo_part
             tta6woworp0502_wo_nbr = wo_nbr
             tta6woworp0502_wo_lot = wo_lot
             tta6woworp0502_wo_qty_comp = wo_qty_comp
             tta6woworp0502_wod_part = wod_part
             tta6woworp0502_wod_qty_iss = wod_qty_iss
             tta6woworp0502_wod_tot_std = wod_tot_std
             .
      END.
      /* SS - 20051025 - E */
      ...
      */
      ...
      if glx_mthd = "AVG" and wo_joint_type = "" then do:
         if display_det then do:
            ...
            */
             ASSIGN
                 tta6woworp0502_wipamt = wo_wip_tot
                 .
            /* SS - 20051005 - E */
         end.
         else do:
      ...
      /* REGULAR PRODUCTS (STD) AND JOINT PRODUCTS (AVG & STD) */
         ...
         */
         /* SS - 20051005 - E */
            ...
            */
             ASSIGN
                 tta6woworp0502_wipamt = (wo_mtl_tot + wo_lbr_tot + wo_bdn_tot + wo_sub_tot - wo_rjct_tot - wo_wip_tot - wo_mthd_var)
                 .
            /* SS - 20051005 - E */
         end.
