...
repeat on error undo, retry:
   ...
   FOR EACH tta6woworp0504:
       DELETE tta6woworp0504.
   END.

    {gprun.i ""a6woworp0504.p"" "(
        INPUT nbr,
        INPUT nbr1,
        INPUT lot,
        INPUT lot1,
    ...
    EXPORT DELIMITER ";" "part" "nbr" "lot" "qty_comp" "acctot" "wipamt" "lbrtot" "bdntot" "subtot".
    FOR EACH tta6woworp0504:
        EXPORT DELIMITER ";" tta6woworp0504.
    END.
