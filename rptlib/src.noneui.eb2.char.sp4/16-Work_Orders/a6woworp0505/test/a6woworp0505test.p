...
form
   /* SS - 20060526.1 - B */
   effdate         colon 15
   effdate1        label {t001.i} colon 49 skip (0)
   /* SS - 20060526.1 - E */
   nbr         colon 15
...
repeat on error undo, retry:
   ...
   {wbrp06.i &command = update &fields = "  nbr nbr1 lot lot1 site site1
             ...
             skpage" &frm = "a"}
       */
   {wbrp06.i &command = update &fields = "  effdate effdate1 nbr nbr1 lot lot1 site site1
             LINE line1 part part1 due due1 acct_close close_date close_date1 close_eff close_eff1 so_job vend stat   mtlyn lbryn bdnyn subyn
             skpage" &frm = "a"}
       /* SS - 20051005 - E */
   ...
   FOR EACH tta6woworp0505:
       DELETE tta6woworp0505.
   END.

    {gprun.i ""a6woworp0505.p"" "(
       INPUT effdate,
       INPUT effdate1,
    ...
    EXPORT DELIMITER ";" "part" "nbr" "lot" "qty_comp" "qty_loc" "qty_ord" "acctot" "wipamt".
    FOR EACH tta6woworp0505:
        EXPORT DELIMITER ";" tta6woworp0505.
    END.
