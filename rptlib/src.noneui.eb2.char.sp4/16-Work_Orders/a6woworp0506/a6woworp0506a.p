...
/* $Revision: 1.20 $ BY: Bill Jiang            DATE: 07/01/07 ECO: *SS - 20070701.1*    */
...
define input parameter ord_date   like wo_stat_close_date.
define input parameter ord_date1  like wo_stat_close_date.
define input parameter stat_close_date   like wo_stat_close_date.
define input parameter stat_close_date1  like wo_stat_close_date.
...
for each wo_mstr
      ...
      /* SS - 20070701.1 - B */
      and (wo_ord_date >= ord_date or ord_date = ?)
      and (wo_ord_date <= ord_date1 or ord_date1 = ?)
      and (wo_stat_close_date >= stat_close_date or stat_close_date = ?)
      and (wo_stat_close_date <= stat_close_date1 or stat_close_date1 = ?)
      AND (
         acct_close = NO
         OR (
            acct_close = YES
   ...
   */
   ...
   for each wod_det where wod_lot = wo_lot no-lock break by wod_lot
      ...
      */
      CREATE tta6woworp0506.
      ASSIGN
         tta6woworp0506_wo_nbr = wo_nbr
         tta6woworp0506_wo_lot = wo_lot
         tta6woworp0506_wo_batch = wo_batch
         tta6woworp0506_wo_qty_ord = wo_qty_ord
         tta6woworp0506_wo_ord_date = wo_ord_date
         tta6woworp0506_glx_mthd = glx_mthd
         tta6woworp0506_wo_part = wo_part
         tta6woworp0506_desc1 = desc1
         tta6woworp0506_wo_qty_comp = wo_qty_comp
         tta6woworp0506_wo_rel_date = wo_rel_date
         tta6woworp0506_premsg = premsg
         tta6woworp0506_wo_so_job = wo_so_job
         tta6woworp0506_wo_qty_rjct = wo_qty_rjct
         tta6woworp0506_wo_due_date = wo_due_date
         tta6woworp0506_wo_vend = wo_vend
         tta6woworp0506_wo_rmks = wo_rmks
         tta6woworp0506_wod_part = wod_part
         tta6woworp0506_accqty = accqty
         tta6woworp0506_expcst = expcst
         tta6woworp0506_acrvar = acrvar
         tta6woworp0506_acccst = acccst
         tta6woworp0506_rtevar = rtevar
         tta6woworp0506_usevar = usevar
         tta6woworp0506_wowipx = wowipx
         tta6woworp0506_wipamt = wipamt
         .
      if wo_fsm_type = "FSM-RO" or wo_fsm_type = "PRM" then DO:
         ASSIGN tta6woworp0506_wo_status = status-type.
      END.
      else DO:
         ASSIGN tta6woworp0506_wo_status = wo_status.
      END.
      /* SS - 20070701.1 - E */
