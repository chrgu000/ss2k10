...
repeat on error undo, retry:
   ...
   */
   {wbrp06.i &command = update &fields = "  nbr nbr1 lot lot1 site site1
             ...
             close_date close_date1 
             close_eff close_eff1 
             so_job vend stat   mtlyn lbryn bdnyn subyn
             skpage" &frm = "a"}
   /* SS - 20051025 - E */
   ...
   */
   ...
   EMPTY TEMP-TABLE tta6woworp0506.

   {gprun.i ""a6woworp0506.p"" "(
      INPUT nbr,
      INPUT nbr1,
      INPUT lot,
      INPUT lot1,
    ...
    FOR EACH tta6woworp0506:
        EXPORT DELIMITER ";" tta6woworp0506.
    END.
