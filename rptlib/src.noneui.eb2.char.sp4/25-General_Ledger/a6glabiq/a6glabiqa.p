...
/* $Revision: 1.26 $    BY: Bill Jiang             DATE: 09/29/05  ECO: *SS - 20050929*  */
/******************************************************************************/
...
perloop:
for each cal
   fields (cal.glc_end cal.glc_per cal.glc_start cal.glc_year)
   where cal.glc_year = yr
   no-lock
