/* GUI CONVERTED from glcbsrp.p (converter v1.75) Thu Sep 28 05:40:53 2000 */
...
/* REVISION: 9.1      LAST MODIFIED: 07/20/06   BY: *SS - 20060720.1* Bill Jiang       */
...
/*N02V*/    "------------------" to 79    "------------------" to 100 skip(1)
         with STREAM-IO /*GUI*/  frame phead2 page-top width 132.
...
/*
            ...
            EXPORT DELIMITER ";" "fpos" "code" "desc" "et_balance1" "et_balance2".
            FOR EACH tta6glcbsrp:
                EXPORT DELIMITER ";" tta6glcbsrp_fpos tta6glcbsrp_code tta6glcbsrp_desc tta6glcbsrp_et_balance1 tta6glcbsrp_et_balance2.
            END.
