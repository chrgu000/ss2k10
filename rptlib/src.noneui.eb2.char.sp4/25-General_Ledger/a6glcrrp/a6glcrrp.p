...
/******************************************************************************/
/* SS - 20050914 - B */
define input parameter i_code like glr_code.
define input parameter i_entity like en_entity.
define input parameter i_entity1 like en_entity.
define input parameter i_begdt01 as date.
define input parameter i_enddt01 as date.
define input parameter i_budget01 like mfc_logical.
define input parameter i_budgetcode01 like bg_code.
define input parameter i_begdt02 as date.
define input parameter i_enddt02 as date.
define input parameter i_budget02 like mfc_logical.
define input parameter i_budgetcode02 like bg_code.
...
*/
define new shared variable level as integer
   format ">9" initial 1 label {&glcrrp_p_9}.
define new shared variable varflag like mfc_logical
   initial NO label {&glcrrp_p_4}.
define new shared variable ccflag like mfc_logical
   INITIAL YES label {&glcrrp_p_12}.
/* SS - 20050914 - E */
...
enddt[1] = i_enddt01.
budget[1] = i_budget01.
budgetcode[1] = i_budgetcode01.
begdt[2] = i_begdt02.
enddt[2] = i_enddt02.
budget[2] = i_budget02.
budgetcode[2] = i_budgetcode02.
