...
repeat:
   ...
   */
   ...
   FOR EACH gltr_hist NO-LOCK
      ...
      :
      CREATE tta6gldabrp01.
      ASSIGN
         tta6gldabrp01_ref = gltr_ref
         tta6gldabrp01_eff_dt = gltr_eff_dt
         tta6gldabrp01_ent_dt = gltr_ent_dt
         tta6gldabrp01_user = gltr_user
         tta6gldabrp01_batch = gltr_batch
         tta6gldabrp01_line = gltr_line
         tta6gldabrp01_acc = gltr_acc
         tta6gldabrp01_sub = gltr_sub
         tta6gldabrp01_ctr = gltr_ctr
         tta6gldabrp01_project = gltr_project
         tta6gldabrp01_entity = gltr_entity
         tta6gldabrp01_desc = gltr_desc
         tta6gldabrp01_amt = gltr_amt
         tta6gldabrp01_curramt = gltr_curramt
         tta6gldabrp01_curr = gltr_curr
         tta6gldabrp01_addr = gltr_addr
         tta6gldabrp01_doc_typ = gltr_doc_typ
         tta6gldabrp01_doc = gltr_doc
         .
      {mfrpchk.i}
   END.
   /* SS - 20060327 - E */
