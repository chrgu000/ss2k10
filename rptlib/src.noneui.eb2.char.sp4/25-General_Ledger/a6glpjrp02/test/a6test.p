...
/*L00M*  END ADD SECTION */
         ...
         /* SS - 20051212 - B */
         DEFINE NEW SHARED VARIABLE tr_type LIKE gltr_tr_type.
         DEFINE NEW SHARED VARIABLE tr_type1 LIKE gltr_tr_type.
         /* SS - 20051212 - E */
...
/*L092*/ {gprunpdf.i "mcui" "p"}
         ...
         form
            ...
            /* SS - 20051212 - B */
            tr_type        colon 33
            tr_type1       colon 50 label {t001.i}
            /* SS - 20051212 - E */
            subflag    colon 33
            ccflag     colon 33
            prtcents   colon 33
...
/*L092*/ assign
         ...
         repeat:
            ...
            /* SS - 20051212 - B */
            if tr_type1    = hi_char then tr_type1    = "".
            /* SS - 20051212 - E */
...
/*L01W* /*L00M*/ et_report_rate */
           ...
           {wbrp06.i &command = update &fields = " entity entity1 cname proj
              proj1 acc acc1 sub when (use_sub) sub1 when (use_sub) ctr
              when (use_cc)
              ctr1 when (use_cc) begdt enddt tr_type tr_type1 subflag when (use_sub)
              ccflag when (use_cc) prtcents zeroflag page_break show_cmmts
/*L00M*/       et_report_curr
/*L01W* /*L00M*/ et_report_rate */
              "  &frm = "a"}
            ...
            if (c-application-mode <> 'web') or
               ...
               /* SS - 20051212 - B */
               if tr_type1    = "" then tr_type1    = hi_char.
               /* SS - 20051212 - E */
...
/*L00M*     END ADD SECTION*/
            ...
            {mfrtrail.i}
                */
                ...
                FOR EACH tta6glpjrp02:
                    DELETE tta6glpjrp02.
                END.
        
               {gprun.i ""a6glpjrp02.p"" "(
                   INPUT entity,
                   INPUT entity1,
                   INPUT acc,
                   INPUT acc1,
                ...
                EXPORT DELIMITER ";" "project" "ctr" "desc" "type" "amt".
                FOR EACH tta6glpjrp02:
                    EXPORT DELIMITER ";" tta6glpjrp02.
                END.
