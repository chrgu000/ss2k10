...
/* $Revision: 1.18 $    BY: Bill Jiang    DATE: 01/07/06 ECO: *SS - 20060107*   */
/******************************************************************************/
...
define variable et_end_bal like end_bal.
   ...
   /* CALCULATE BALANCE FOR STANDARD ACCOUNT */
      ...
      for each asc_mstr
            ...
            no-lock where asc_acc >= "" and asc_sub >= "" and asc_cc >= ""
         ...
         for first ac_mstr fields (ac_type ac_curr ac_active
                                   ac_desc ac_code)
