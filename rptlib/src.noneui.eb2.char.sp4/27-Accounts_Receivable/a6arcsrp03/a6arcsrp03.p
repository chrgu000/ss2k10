         ...
         if available ct_mstr and ct_dating = yes then do:
            ...
            break by ctd_code:
               ...
               if available ct_mstr then do:
                  ...
                  */
                  CREATE tta6arcsrp03.
                  ASSIGN
                      tta6arcsrp03_cust = ar_cust
                      tta6arcsrp03_date = ar_date
                      tta6arcsrp03_nbr = ar_nbr
                      tta6arcsrp03_ar_type = ar_type
                      tta6arcsrp03_type = TYPE
                      tta6arcsrp03_due_date = due-date
                      tta6arcsrp03_effdate = ar_effdate
                      tta6arcsrp03_amt_due = amt-due
                      tta6arcsrp03_amt_open = amt-open
                      tta6arcsrp03_contested = contested
                      tta6arcsrp03_curr = ar_curr
                      /* SS - 20050920 - B */
                      tta6arcsrp03_acct = ar_acct
                      /* SS - 20050920 - E */
                      .
                  /* SS - 20050827 - E */
            ...
            */
             ...
             if ar_type <> "P" then
                 ...
                 tta6arcsrp03_nbr = ar_nbr
                 tta6arcsrp03_type = TYPE
                 tta6arcsrp03_due_date = ar_due_date
                 /* SS - 20050920 - B */
                 tta6arcsrp03_acct = ar_acct
                 /* SS - 20050920 - E */
                 .
             ELSE DO:
                 ...
                 IF AVAILABLE ard_det THEN
                     ASSIGN
                         tta6arcsrp03_acct = ard_acct
                     .
                 /* SS - 20050920 - E */
             END.
             ASSIGN
                 tta6arcsrp03_amt_due = base_amt
                 tta6arcsrp03_amt_open = base_open
                 tta6arcsrp03_contested = contested
                 tta6arcsrp03_curr = ar_curr
                 .
            /* SS - 20050827 - E */
