...
/* $Revision: 1.11.1.11 $  BY: Bill Jiang     DATE: 03/14/06  ECO: *SS - 20060314*  */
/******************************************************************************/
...
repeat:
   ...
   */
   ...
   FOR EACH tta6arcsrp0301:
       DELETE tta6arcsrp0301.
   END.
   {gprun.i ""a6arcsrp0301.p"" "(
       INPUT cust,
       INPUT cust1,
       INPUT effdate,
       INPUT effdate1,
   ...
   EXPORT DELIMITER ";" "cust" "date" "nbr" "ar_type" "type" "due_date" "effdate" "amt_due" "amt_open" "contested" "curr" "acct" "sub" "cc" "ex_rate" "ex_rate2".
   FOR EACH tta6arcsrp0301:
       EXPORT DELIMITER ";" tta6arcsrp0301.
   END.
