               ...
               {&ARCSRP5A-P-TAG69}
                  ...
                  then do with frame c:
                     /* SS - 20051004 - B */
                      CREATE tta6arcsrp05.
                      ASSIGN
                          tta6arcsrp05_bill = ar_bill
                          /*
                          tta6arcsrp05_acct = t_acct
                          tta6arcsrp05_sub = t_sub
                          tta6arcsrp05_cc = t_cc
                          */
                          .
                      ...
                      then
                          ASSIGN
                          tta6arcsrp05_nbr = ar_nbr
                          tta6arcsrp05_type = ar_type
                          .
                      else
                          ASSIGN
                          tta6arcsrp05_nbr = ar_check
                          tta6arcsrp05_type = "U"
                          .

                      IF ar_type <> "P" THEN DO:
                          ASSIGN
                              tta6arcsrp05_acct = ar_acct
                              tta6arcsrp05_sub = ar_sub
                              tta6arcsrp05_cc = ar_cc
                              .
                      END.
                      ELSE DO:
                          FIND FIRST bard
                          ...
                          IF AVAILABLE bard THEN DO:
                              ASSIGN
                                  tta6arcsrp05_acct = bard.ard_acct
                                  tta6arcsrp05_sub = bard.ard_sub
                                  tta6arcsrp05_cc = bard.ard_cc
                                  .
                          END.
                          ELSE DO:
                              ASSIGN
                      ...
                      then
                          ASSIGN
                          tta6arcsrp05_effdate = ar_effdate
                          tta6arcsrp05_due_date = ar_due_date
                          tta6arcsrp05_date = ar_date
                          .
                      else
                          ASSIGN
                              tta6arcsrp05_effdate = ar_effdate
                      ...
                      then do:
                          ASSIGN
                              tta6arcsrp05_et_age_amt[1] = et_age_amt[1]
                              tta6arcsrp05_et_age_amt[2] = et_age_amt[2]
                              tta6arcsrp05_et_age_amt[3] = et_age_amt[3]
                              tta6arcsrp05_et_age_amt[4] = et_age_amt[4]
                              tta6arcsrp05_et_age_amt[5] = et_age_amt[5]
                              tta6arcsrp05_et_age_amt[6] = et_age_amt[6]
                              tta6arcsrp05_amt = (et_base_amt - et_base_applied)
                              .
