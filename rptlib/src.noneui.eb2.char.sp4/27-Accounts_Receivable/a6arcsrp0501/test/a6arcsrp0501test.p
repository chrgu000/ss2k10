...
/*N0ZX*/    {&ARCSRP05-P-TAG11}
   ...
   {mfrtrail.i}
       */
       ...
       EXPORT DELIMITER ";" "bill" "acct" "sub" "cc" "nbr" "type" "ar_nbr" "ar_type" "effdate" "due_date" "date" "et_age_amt[1]" "et_age_amt[2]" "et_age_amt[3]" "et_age_amt[4]" "et_age_amt[5]" "et_age_amt[6]" "et_amt" "ar_curr" "ar_ex_rate" "ar_ex_rate2".
       FOR EACH tta6arcsrp0501:
