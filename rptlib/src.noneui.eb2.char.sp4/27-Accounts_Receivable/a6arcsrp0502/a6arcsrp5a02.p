               ...
               */
               ...
               {&ARCSRP5A-P-TAG69}
                  ...
                  then do with frame c:
                     /* SS - 20051004 - B */
                      CREATE tta6arcsrp0502.
                      ASSIGN
                          tta6arcsrp0502_bill = ar_bill
                          /*
                          tta6arcsrp0502_acct = t_acct
                          tta6arcsrp0502_sub = t_sub
                          tta6arcsrp0502_cc = t_cc
                          */
                          .

                      /* SS - 20051216 - B */
                      ASSIGN
                          tta6arcsrp0502_ar_nbr = ar_nbr
                          tta6arcsrp0502_ar_type = ar_type
                          .
                      /* SS - 20051216 - E */
                      ...
                      then
                          ASSIGN
                          tta6arcsrp0502_nbr = ar_nbr
                          tta6arcsrp0502_type = ar_type
                          .
                      else
                          ASSIGN
                          tta6arcsrp0502_nbr = ar_check
                          tta6arcsrp0502_type = "U"
                          .

                      IF ar_type <> "P" THEN DO:
                          ASSIGN
                              tta6arcsrp0502_acct = ar_acct
                              tta6arcsrp0502_sub = ar_sub
                              tta6arcsrp0502_cc = ar_cc
                              .
                      END.
                      ELSE DO:
                          FIND FIRST bard
                          ...
                          IF AVAILABLE bard THEN DO:
                              ASSIGN
                                  tta6arcsrp0502_acct = bard.ard_acct
                                  tta6arcsrp0502_sub = bard.ard_sub
                                  tta6arcsrp0502_cc = bard.ard_cc
                                  .
                          END.
                          ELSE DO:
                              ASSIGN
                      ...
                      then
                          ASSIGN
                          tta6arcsrp0502_effdate = ar_effdate
                          tta6arcsrp0502_due_date = ar_due_date
                          tta6arcsrp0502_date = ar_date
                          .
                      else
                          ASSIGN
                              tta6arcsrp0502_effdate = ar_effdate
                      ...
                      then do:
                          ASSIGN
                              tta6arcsrp0502_et_age_amt[1] = et_age_amt[1]
                              tta6arcsrp0502_et_age_amt[2] = et_age_amt[2]
                              tta6arcsrp0502_et_age_amt[3] = et_age_amt[3]
                              tta6arcsrp0502_et_age_amt[4] = et_age_amt[4]
                              tta6arcsrp0502_et_age_amt[5] = et_age_amt[5]
                              tta6arcsrp0502_et_age_amt[6] = et_age_amt[6]
                              tta6arcsrp0502_amt = (et_base_amt - et_base_applied)
                              /* SS - 20051228 - B */
                              tta6arcsrp0502_ar_curr = ar_curr
                              /* SS - 20051228 - E */
                              .
