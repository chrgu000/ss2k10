...
/*N0ZX*/    {&ARCSRP05-P-TAG11}
   ...
   {mfrtrail.i}
       */
       ...
       FOR EACH tta6arcsrp0502:
           DELETE tta6arcsrp0502.
       END.
       {gprun.i ""a6arcsrp0502.p"" "(
           INPUT cust,
           INPUT cust1,
           INPUT cust_type,
           INPUT cust_type1,
       ...
       EXPORT DELIMITER ";" "bill" "acct" "sub" "cc" "nbr" "type" "ar_nbr" "ar_type" "effdate" "due_date" "date" "et_age_amt[1]" "et_age_amt[2]" "et_age_amt[3]" "et_age_amt[4]" "et_age_amt[5]" "et_age_amt[6]" "amt" "ar_curr".
       FOR EACH tta6arcsrp0502:
           EXPORT DELIMITER ";" tta6arcsrp0502.
       END.
