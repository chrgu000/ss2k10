...
/* Revision: 1.22.1.19.1.1   BY: tippawan Ua   Date: 07/23/03 ECO: *P0Y4* */
/* $Revision: 1.22.1.19.1.2 $   BY: Dorota Hohol      DATE: 08/27/03 ECO: *P116* */
/* $Revision: 1.22.1.19.1.2 $   BY: Bill Jiang      DATE: 10/04/05 ECO: *SS - 20051004* */
/* $Revision: 1.22.1.19.1.2 $   BY: Bill Jiang      DATE: 10/13/05 ECO: *SS - 20051013* */
/* $Revision: 1.22.1.19.1.2 $   BY: Bill Jiang      DATE: 12/16/05 ECO: *SS - 20051216* */
/* $Revision: 1.22.1.19.1.2 $   BY: Bill Jiang      DATE: 12/28/05 ECO: *SS - 20051228* */
/* $Revision: 1.22.1.19.1.2 $   BY: Bill Jiang      DATE: 07/14/06 ECO: *SS - 20060714.1* */
...
define variable name           like ad_name               no-undo.
define variable balance        like cm_balance            no-undo.
define variable age_paid       like ar_amt extent 6       no-undo.
define variable sum_amt        like ar_amt extent 6       no-undo.
*/
...
/*
{&ARCSRP5A-P-TAG33}
define variable et_age_amt          like age_amt extent 6 no-undo.
{&ARCSRP5A-P-TAG34}
define variable et_age_paid         like ar_amt extent 6  no-undo.
define variable et_sum_amt          like ar_amt extent 6  no-undo.
define variable et_base_amt         like ar_amt           no-undo.
define variable et_base_applied     like ar_amt           no-undo.
define variable et_curr_amt         like ar_amt           no-undo.
define variable et_inv_tot          like ar_amt           no-undo.
...
define variable et_paid_tot         like ar_amt           no-undo.
define variable et_drft_tot         like ar_amt           no-undo.
define variable et_org_sum_amt      like ar_amt extent 6 no-undo.
*/
{&ARCSRP5A-P-TAG33}
               ...
               do for armstr:
                  ...
                  then do:
                     ...
                     then do:
                         /* SS - 20051013 - B */
                         /*
                         t_acct = ar_mstr.ar_acct.
                         t_sub = ar_mstr.ar_sub.
                         t_cc = ar_mstr.ar_cc.
                         */
                         /* SS - 20051013 - E */
                  ...
                  /* OTHERWISE AR_MSTR IS A PAYMENT RECORD */
                     ...
                     for each armstr
                        ...
                        for each arddet
                           where arddet.ard_nbr = armstr.ar_nbr
                           no-lock:
               ...
               */
               ...
               {&ARCSRP5A-P-TAG69}
                  ...
                  then do with frame c:
                     /* SS - 20051004 - B */
                      CREATE tta6arcsrp0503.
                      ASSIGN
                          tta6arcsrp0503_bill = ar_bill
                          /*
                          tta6arcsrp0503_acct = t_acct
                          tta6arcsrp0503_sub = t_sub
                          tta6arcsrp0503_cc = t_cc
                          */
                          .

                      /* SS - 20051216 - B */
                      ASSIGN
                          tta6arcsrp0503_ar_nbr = ar_nbr
                          tta6arcsrp0503_ar_type = ar_type
                          .
                      /* SS - 20051216 - E */
                      ...
                      then
                          ASSIGN
                          tta6arcsrp0503_nbr = ar_nbr
                          tta6arcsrp0503_type = ar_type
                          .
                      else
                          ASSIGN
                          tta6arcsrp0503_nbr = ar_check
                          tta6arcsrp0503_type = "U"
                          .

                      IF ar_type <> "P" THEN DO:
                          ASSIGN
                              tta6arcsrp0503_acct = ar_acct
                              tta6arcsrp0503_sub = ar_sub
                              tta6arcsrp0503_cc = ar_cc
                              .
                      END.
                      ELSE DO:
                          FIND FIRST bard
                          ...
                          IF AVAILABLE bard THEN DO:
                              ASSIGN
                                  tta6arcsrp0503_acct = bard.ard_acct
                                  tta6arcsrp0503_sub = bard.ard_sub
                                  tta6arcsrp0503_cc = bard.ard_cc
                                  .
                          END.
                          ELSE DO:
                              ASSIGN
                      ...
                      then
                          ASSIGN
                          tta6arcsrp0503_effdate = ar_effdate
                          tta6arcsrp0503_due_date = ar_due_date
                          tta6arcsrp0503_date = ar_date
                          .
                      else
                          ASSIGN
                              tta6arcsrp0503_effdate = ar_effdate
                      ...
                      then do:
                          ASSIGN
                              tta6arcsrp0503_et_age_amt[1] = et_age_amt[1]
                              tta6arcsrp0503_et_age_amt[2] = et_age_amt[2]
                              tta6arcsrp0503_et_age_amt[3] = et_age_amt[3]
                              tta6arcsrp0503_et_age_amt[4] = et_age_amt[4]
                              tta6arcsrp0503_et_age_amt[5] = et_age_amt[5]
                              tta6arcsrp0503_et_age_amt[6] = et_age_amt[6]
                             /* SS - 20060714.1 - B */
                             tta6arcsrp0503_et_age_amt[7] = et_age_amt[7]
                             tta6arcsrp0503_et_age_amt[8] = et_age_amt[8]
                             tta6arcsrp0503_et_age_amt[9] = et_age_amt[9]
                             /* SS - 20060714.1 - E */
                              tta6arcsrp0503_amt = (et_base_amt - et_base_applied)
                              /* SS - 20051228 - B */
                              tta6arcsrp0503_ar_curr = ar_curr
                              /* SS - 20051228 - E */
                              .
