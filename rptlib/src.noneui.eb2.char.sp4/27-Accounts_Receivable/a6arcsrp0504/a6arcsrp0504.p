...
/* $Revision: 1.13.1.12.1.1 $   BY: Bill Jiang      DATE: 07/14/06 ECO: *SS - 20060714.1* */
...
define input parameter i_cust_type like cm_type.
define input parameter i_cust_type1 like cm_type.
...
define input parameter i_slspsn1 like i_slspsn.
define input parameter i_acct like ar_acct.
define input parameter i_acct1 like ar_acct.
...
define input parameter i_lstype like ls_type.
...
define input parameter i_age_days8 as integer.
define input parameter i_age_days9 as integer.
/* SS - 20060714.1 - E */
/*
{mfdtitle.i "2+ "}
    */
...
cust = i_cust.
cust1 = i_cust1.
cust_type = i_cust_type.
cust_type1 = i_cust_type1.
nbr = i_nbr.
nbr1 = i_nbr1.
slspsn = i_slspsn.
slspsn1 = i_slspsn1.
...
age_days[8] = i_age_days8.
age_days[9] = i_age_days9.
/* SS - 20060714.1 - E */
/* SS - 20051004 - E */
...
/*N0ZX*/    {&ARCSRP05-P-TAG11}
   ...
   */
   ...
   /* SS - 20060714.1 - B */
   /*
   {gprun.i ""a6arcsrp5a02.p""}
      */
   {gprun.i ""a6arcsrp0504a.p""}
      /* SS - 20060714.1 - E */
   /* SS - 20051004 - E */
