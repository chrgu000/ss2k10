...
/* $Revision: 1.19.1.29 $  BY: Bill Jiang        DATE: 09/24/05 ECO: *SS - 20050924*  */
      ...
      */
      ...
      for each ard_det where ard_nbr = ar_nbr no-lock
         ...
         if not summary then do with frame e:
             ...
             CREATE tta6arparp.
             ASSIGN
                 tta6arparp_ar_check = ar_mstr.ar_check
                 tta6arparp_ar_bank = ar_mstr.ar_bank
                 tta6arparp_ar_po = ar_mstr.ar_po
                 tta6arparp_ar_type = ar_mstr.ar_type
                 tta6arparp_ar_date = ar_mstr.ar_date
                 tta6arparp_ar_entity = ar_mstr.ar_entity
                 tta6arparp_ar_acct = ar_mstr.ar_acct
                 tta6arparp_ar_sub = ar_mstr.ar_sub
                 tta6arparp_ar_cc = ar_mstr.ar_cc
                 tta6arparp_ar_bill = ar_mstr.ar_bill
                 tta6arparp_ad_name = NAME
                 tta6arparp_ex_rate_relation1 = ex_rate_relation1
                 tta6arparp_ar_effdate = ar_mstr.ar_effdate
                 tta6arparp_ar_disc_acct = ar_mstr.ar_disc_acct
                 tta6arparp_ar_disc_sub = ar_mstr.ar_disc_sub
                 tta6arparp_ar_disc_cc = ar_mstr.ar_disc_cc
                 tta6arparp_ex_rate_relation2 = ex_rate_relation2
                 .
             if not (base_rpt = "" and not mixed_rpt) then 
                 ASSIGN
                    tta6arparp_ar_curr = ar_mstr.ar_curr
                    .
            else
                ASSIGN 
                    tta6arparp_ar_curr = base_curr
                    .
            if base_rpt = "" and not mixed_rpt THEN do:
                ASSIGN
                    tta6arparp_ar_amt = (- base_amt)
                    .
            end.
            ELSE do:
                ASSIGN
                    tta6arparp_ar_amt = (- ar_mstr.ar_amt)
                    .
            end.
             /*
            {&ARPARPA-P-TAG45}
            ...
            */
            ...
            IF ard_type = "N" OR ard_type = "U" THEN
                ASSIGN
                tta6arparp_ard_ref = ard_tax
                .
            ELSE
                ASSIGN
                tta6arparp_ard_ref = ard_ref
                .
            ASSIGN
                tta6arparp_ard_type = ard_type
                tta6arparp_ard_type_desc = TYPE
                tta6arparp_ard_entity = ard_entity
                tta6arparp_ard_acct = ard_acct
                tta6arparp_ard_sub = ard_sub
                tta6arparp_ard_cc = ard_cc
                .
            if (base_rpt = ""
                and mixed_rpt
                and disp_curr = getTermLabel("YES",1))
            ...
            then do:
                ASSIGN
                    ...
                    .
                ASSIGN
                    tta6arparp_disp_curr = DISP_curr
                    tta6arparp_ard_amt = ard_amt
                    tta6arparp_ard_disc = ard_disc
                    .
            end.
            else
               do:
                ASSIGN
                    tta6arparp_disp_curr = DISP_curr
                    tta6arparp_ard_amt = base_damt
                    tta6arparp_ard_disc = base_disc
                    .
            end.
            /* SS - 20050924 - E */
            ...
            if ard_type <> "N" then do:
               ...
               and basepayforeign = false
               then
                   ASSIGN tta6arparp_aramt = (ard_amt + ard_disc).
               else
                   ASSIGN tta6arparp_aramt = aramt.
                  /* SS - 20050924 - E */
            ...
            if ard_type = "U" then do:
               ...
               if base_rpt = "" and mixed_rpt then
                  ...
                  */
                  if base_rpt = "" and mixed_rpt then
                      ASSIGN tta6arparp_unamt = (ard_amt - c_appl_amt).
                  else
                      ASSIGN tta6arparp_unamt = unamt.
                  /* SS - 20050924 - E */
            ...
            */
            ...
            if ard_type = "N" then do:
               ...
               */
               if base_rpt = ""
                  and mixed_rpt THEN
                   ASSIGN tta6arparp_nonamt = ard_amt.
               else 
                   ASSIGN tta6arparp_nonamt = nonamt.
               /* SS - 20050924 - E */
