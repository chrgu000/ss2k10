...
/* $Revision: 1.10.1.18 $  BY: Bill Jiang   DATE: 12/12/05 ECO: *SS - 20051212*      */
   ...
   do with frame d down:
      ...
      for each ar_mstr where ar_batch >= batch and
         ...
         */
         CREATE tta6arparp01.
         ASSIGN
            tta6arparp01_batch = ar_batch
            tta6arparp01_nbr = ar_nbr
            tta6arparp01_bill = ar_bill
            tta6arparp01_name = NAME
            tta6arparp01_type = ar_type
            tta6arparp01_check = ar_check
            tta6arparp01_base_amt = base_amt
            tta6arparp01_date = ar_date
            tta6arparp01_effdate = ar_effdate
            tta6arparp01_entity = ar_entity
            tta6arparp01_acct = ar_acct
            tta6arparp01_sub = ar_sub
            tta6arparp01_cc = ar_cc
            tta6arparp01_po = ar_po
            .
         /* SS - 20051212 - E */
         ...
         if last (ar_mstr.ar_nbr) then do:  /* report totals */
            ...
            if summary then do with frame d:
               ...
               assign
                  c-base-rpt-lbl1 = getTermLabel("BASE_REPRT",10)
