...
/* $Revision: 1.10.1.18 $  BY: Bill Jiang   DATE: 12/13/05 ECO: *SS - 20051213*      */
...
repeat:
   ...
   */
   ...
   FOR EACH tta6arparp01:
      DELETE tta6arparp01.
   END.
   
   {gprun.i ""a6arparp01.p"" "(
      INPUT BATCH,
      INPUT BATCH1,
      INPUT CHECK_nbr,
      INPUT CHECK1,
   ...
   EXPORT DELIMITER ";" "batch" "nbr" "bill" "name" "type" "check" "base_amt" "date" "effdate" "entity" "acct" "sub" "cc" "po".
   FOR EACH tta6arparp01:
      EXPORT DELIMITER ";" tta6arparp01.
   END.
