...
repeat:
    ...
    */
    ...
    EXPORT DELIMITER ";" " ck_bank " " bk_dftap_acct "	" bk_dftap_sub " " bk_dftap_cc " " bk_dftap_desc " " ck_nbr " " ck_type " " ap_vend " " name " 
                         " base_amt " " ap_acct " " ap_sub " " ap_date " " ap_effdate " " ap_due_date " " ck_clr_date " " ck_voideff " " ckstatus "  .
