...
4.如果超时,更新状态"
*/
DEF INPUT PARAMETER i_base_rpt LIKE ap_curr .
DEF INPUT PARAMETER i_bank LIKE ap_bank .
DEF INPUT PARAMETER i_ckfrm LIKE ap_ckfrm .
DEF INPUT PARAMETER i_bk_acct_type LIKE ad_addr .
DEF INPUT PARAMETER i_print_rmk LIKE mfc_logical .
DEF INPUT PARAMETER i_sort_by_amount like mfc_logical  .
DEF INPUT PARAMETER i_print_date like ap_date .
/* SS - 200600824.1 E */
...
bank = i_bank .
ckfrm = i_ckfrm.
bk_acct_type = i_bk_acct_type .
print_rmk = i_print_rmk. 
SORT_by_amount = i_sort_by_amount .
print_date = i_print_date .
  /* SS - 200600824.1 E */
...
/*   message "a6apparpa.p begin" view-as alert-box.*/

   /* SS - 200600824.1 B */
   {gprun.i ""a6apparp01a.p""}

/*   message "a6apparpa.p end " view-as alert-box.*/
