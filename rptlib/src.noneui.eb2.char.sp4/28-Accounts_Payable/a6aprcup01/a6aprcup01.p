...
/* SS - 20060108 - B */
define input parameter i_receive       like prh_receiver.
define input parameter i_receive1      like prh_receiver.
define input parameter i_rdate         like prh_rcp_date.
define input parameter i_rdate1        like prh_rcp_date.
define input parameter i_vendor        like prh_vend.
define input parameter i_vendor1       like prh_vend.
define input parameter i_order         like prh_nbr.
define input parameter i_order1        like prh_nbr.
   ...
   for each prh_hist
      ...
      if not available po_mstr
         ...
         */
         CREATE tta6aprcup01.
         ASSIGN
            tta6aprcup01_prh_vend = prh_vend
            tta6aprcup01_prh_nbr = prh_nbr
            tta6aprcup01_prh_line = prh_line
            tta6aprcup01_prh_part = prh_part
            tta6aprcup01_prh_rev = prh_rev
            tta6aprcup01_prh_receiver = prh_receiver
            tta6aprcup01_prh_rcp_date = prh_rcp_date
            tta6aprcup01_rcvd = rcvd
            tta6aprcup01_prh_pur_cost = prh_pur_cost
            tta6aprcup01_std_ext = std_ext
            tta6aprcup01_prh_type = prh_type
            tta6aprcup01_prh_curr = prh_curr
            tta6aprcup01_prh_ex_rate = prh_ex_rate
            tta6aprcup01_prh_ex_rate2 = prh_ex_rate2
            tta6aprcup01_prh_curr_amt = prh_curr_amt
            .
         /* SS - 20060108 - E */
