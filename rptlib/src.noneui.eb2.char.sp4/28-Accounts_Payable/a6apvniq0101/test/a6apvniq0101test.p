...
/* MaxLen: Comment: */
*/
&SCOPED-DEFINE apvorp01_p_9 "Prepay Only"
/* SS - 20060107 - E */
...
/* SS - 20060107 - B */
define variable prepay_only like mfc_logical label {&apvorp01_p_9}
   initial YES.
/* SS - 20060107 - E */
...
repeat:
   ...
   for each vd_mstr where (vd_addr >= vend)
      ...
      do with frame b:
         ...
         if available ct_mstr and ct_dating then do:
            ...
            if prepay_only = yes then adj_amt = base_hold_amt.
            else adj_amt = 0.
            assign
   ...
   */
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    FOR EACH tta6apvniq0101:
        DELETE tta6apvniq0101.
    END.
    {gprun.i ""a6apvniq0101.p"" "(
        INPUT vend,
        INPUT vend1,
        INPUT prepay_only,
        INPUT base_rpt
        )"}
    EXPORT DELIMITER ";" "ap_ref" "vo_invoice" "base_prepay" "ap_date" "vo_cr_terms" "base_amt" "ap_effdate" "ap_entity" "base_applied" "ap_ex_rate" "ap_ex_rate2" "ap_curr" "disp_curr" "ap_acct" "ap_sub" "ap_cc" "ap_vend" "vopo" "ap_batch" "vo_confirmed" "vo_conf_by" "vo_type" "ap_ckfrm" "base_hold_amt".
    FOR EACH tta6apvniq0101:
        EXPORT DELIMITER ";" tta6apvniq0101.
    END.
