...
/* $Revision: 1.36.1.1 $     BY: Bill Jiang           DATE: 10/25/05  ECO: *SS - 20051025*  */
/* $Revision: 1.36.1.1 $     BY: Bill Jiang           DATE: 12/16/05  ECO: *SS - 20051216*  */
...
for each ap_mstr where (ap_batch >= batch)
   ...
   */
   ...
   then do:
      disp_curr = "".
      ASSIGN
          tta6apvorp01_disp_curr = DISP_curr
          tta6apvorp01_ap_amt = ap_amt
          tta6apvorp01_vo_ndisc_amt = vo_ndisc_amt
          tta6apvorp01_vo_applied = vo_applied
          tta6apvorp01_vo_hold_amt = vo_hold_amt
          .
   end.
   /*If base is selected, then amounts shown will be in base. */
   else
       ASSIGN
           tta6apvorp01_disp_curr = DISP_curr
           tta6apvorp01_ap_amt = base_amt
           tta6apvorp01_vo_ndisc_amt = base_ndamt
           tta6apvorp01_vo_applied = base_applied
           tta6apvorp01_vo_hold_amt = base_hold_amt
           .

   ASSIGN
       tta6apvorp01_vo_ref = vo_ref
       tta6apvorp01_ap_date = ap_date
       tta6apvorp01_vd_remit = vd_remit
       tta6apvorp01_ap_curr = ap_curr
       tta6apvorp01_curr_disp_line1 = curr_disp_line1
       tta6apvorp01_curr_disp_line2 = curr_disp_line2
       tta6apvorp01_ap_vend = ap_vend
       tta6apvorp01_ap_effdate = ap_effdate
       tta6apvorp01_vo_ship = vo_ship
       tta6apvorp01_ap_bank = ap_bank
       tta6apvorp01_vopo = vopo
       tta6apvorp01_vo_due_date = vo_due_date
       tta6apvorp01_vo_invoice = vo_invoice
       tta6apvorp01_name = name
       tta6apvorp01_ap_acct = ap_acct
       tta6apvorp01_ap_sub = ap_sub
       tta6apvorp01_ap_cc = ap_cc
       tta6apvorp01_ap_disc_acct = ap_disc_acct
       tta6apvorp01_ap_disc_sub = ap_disc_sub
       tta6apvorp01_ap_disc_cc = ap_disc_cc
       tta6apvorp01_vo_disc_date = vo_disc_date
       tta6apvorp01_ap_entity = ap_entity
       tta6apvorp01_ap_rmk = ap_rmk 
       tta6apvorp01_flag = flag
       tta6apvorp01_vo_confirmed = vo_confirmed
       tta6apvorp01_vo_conf_by = vo_conf_by
       tta6apvorp01_vo_is_ers = vo_is_ers
       tta6apvorp01_remit_label = remit_label 
       tta6apvorp01_remit_name = remit_name
       tta6apvorp01_ap_ckfrm = ap_ckfrm
       tta6apvorp01_vo_type = vo_type
       tta6apvorp01_ap_batch = ap_batch
       .
   /* SS - 20051216 - E */
      ...
      for each vph_hist where vph_ref = ap_ref no-lock
         ...
         if available prh_hist then do:
            ...
            */
            CREATE tta6apvorp.
            ASSIGN 
                tta6apvorp_vo_ref = vo_ref
                tta6apvorp_ap_date = ap_date
                tta6apvorp_vd_remit = vd_remit
                tta6apvorp_ap_curr = ap_curr
                tta6apvorp_curr_disp_line1 = curr_disp_line1
                tta6apvorp_curr_disp_line2 = curr_disp_line2
                tta6apvorp_ap_vend = ap_vend
                tta6apvorp_ap_effdate = ap_effdate
                tta6apvorp_vo_ship = vo_ship
                tta6apvorp_ap_bank = ap_bank
                tta6apvorp_vopo = vopo
                tta6apvorp_vo_due_date = vo_due_date
                tta6apvorp_vo_invoice = vo_invoice
                tta6apvorp_name = NAME
                tta6apvorp_ap_acct = ap_acct
                tta6apvorp_ap_sub = ap_sub
                tta6apvorp_ap_cc = ap_cc
                tta6apvorp_vo_disc_date = vo_disc_date
                tta6apvorp_ap_entity = ap_entity
                tta6apvorp_ap_rmk = ap_rmk
                tta6apvorp_flag = flag
                tta6apvorp_vo_confirmed = vo_confirmed
                tta6apvorp_vo_conf_by = vo_conf_by
                tta6apvorp_vo_is_ers = vo_is_ers
                tta6apvorp_remit_label = remit_label
                tta6apvorp_remit_name = remit_name
                tta6apvorp_ap_ckfrm = ap_ckfrm
                tta6apvorp_vo_type = vo_type
                tta6apvorp_ap_batch = ap_batch

                tta6apvorp_prh_receiver = prh_receiver
                tta6apvorp_prh_line = prh_line
                tta6apvorp_prh_nbr = prh_nbr
                tta6apvorp_prh_part = prh_part
                tta6apvorp_prh_um = prh_um
                tta6apvorp_prh_type = prh_type
                tta6apvorp_prh_rcvd = prh_rcvd
                tta6apvorp_inv_qty = vph_inv_qty
                tta6apvorp_pur_amt = pur_amt
                tta6apvorp_prh_curr = prh_curr
                tta6apvorp_inv_amt = inv_amt
                tta6apvorp_vo_curr = vo_curr
                .
            /* SS - 20051025 - E */
