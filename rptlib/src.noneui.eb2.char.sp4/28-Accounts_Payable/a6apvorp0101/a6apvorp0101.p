      ...
      do with frame b:
         ...
         */
         ...
         if summary_only = no then do:
            ...
            */
            CREATE tta6apvorp0101.
            ASSIGN
                tta6apvorp0101_ap_vend = ap_vend
                tta6apvorp0101_name = NAME
                tta6apvorp0101_ad_attn = ad_attn
                tta6apvorp0101_ad_phone = ad_phone
                tta6apvorp0101_ad_ext = ad_ext
                tta6apvorp0101_ap_ref = ap_ref
                tta6apvorp0101_vo_invoice = vo_invoice
                tta6apvorp0101_vo_cr_terms = vo_cr_terms
                .
            if multi-due = no THEN DO:
                ASSIGN
                    tta6apvorp0101_vo_due_date = vo_due_date
                    .
            END.
            /*
            ELSE DO:
                ASSIGN
                    tta6apvorp0101_vo_due_date = getTermLabel("MULTIPLE",8)
                    .
            END.
            */
            /* SS - 20051228 - E */
         ...
         if summary_only = no then do:
            ...
            */
             ASSIGN
                 tta6apvorp0101_et_age_amt[1] = et_age_amt[1]
                 tta6apvorp0101_et_age_amt[2] = et_age_amt[2]
                 tta6apvorp0101_et_age_amt[3] = et_age_amt[3]
                 tta6apvorp0101_et_age_amt[4] = et_age_amt[4]
                 tta6apvorp0101_et_vo_tot = et_vo_tot
                 tta6apvorp0101_hold = hold
                 tta6apvorp0101_ap_ex_rate = ap_ex_rate
                 tta6apvorp0101_ap_ex_rate2 = ap_ex_rate2
                 tta6apvorp0101_ap_curr = ap_curr
                 tta6apvorp0101_ap_acct = ap_acct
                 tta6apvorp0101_ap_sub = ap_sub
                 tta6apvorp0101_ap_cc = ap_cc
                 tta6apvorp0101_ap_disc_acct = ap_disc_acct
                 tta6apvorp0101_ap_disc_sub = ap_disc_sub
                 tta6apvorp0101_ap_disc_cc = ap_disc_cc
                 .
            /* SS - 20051228 - E */
         end.
