...
/* $Revision: 1.31 $       BY: Bill Jiang              DATE: 12/28/05  ECO: *SS - 20051228*  */
/* $Revision: 1.31 $       BY: Bill Jiang              DATE: 01/09/06  ECO: *SS - 20060109*  */
      ...
      do with frame b:
         ...
         */
         ...
         if summary_only = no then do:
            ...
            */
            CREATE tta6apvorp0102.
            ASSIGN
                tta6apvorp0102_ap_vend = ap_vend
                tta6apvorp0102_name = NAME
                tta6apvorp0102_ad_attn = ad_attn
                tta6apvorp0102_ad_phone = ad_phone
                tta6apvorp0102_ad_ext = ad_ext
                tta6apvorp0102_ap_ref = ap_ref
                tta6apvorp0102_vo_invoice = vo_invoice
                tta6apvorp0102_vo_cr_terms = vo_cr_terms
                .
            if multi-due = no THEN DO:
                ASSIGN
                    tta6apvorp0102_vo_due_date = vo_due_date
                    .
            END.
            /*
            ELSE DO:
                ASSIGN
                    tta6apvorp0102_vo_due_date = getTermLabel("MULTIPLE",8)
                    .
            END.
            */
            /* SS - 20051228 - E */
         ...
         */
         ...
         if summary_only = no then do:
            ...
            */
             ASSIGN
                 tta6apvorp0102_et_age_amt[1] = et_age_amt[1]
                 tta6apvorp0102_et_age_amt[2] = et_age_amt[2]
                 tta6apvorp0102_et_age_amt[3] = et_age_amt[3]
                 tta6apvorp0102_et_age_amt[4] = et_age_amt[4]
                 tta6apvorp0102_et_vo_tot = et_vo_tot
                 tta6apvorp0102_hold = hold
                 tta6apvorp0102_ap_ex_rate = ap_ex_rate
                 tta6apvorp0102_ap_ex_rate2 = ap_ex_rate2
                 tta6apvorp0102_ap_curr = ap_curr
                 tta6apvorp0102_ap_acct = ap_acct
                 tta6apvorp0102_ap_sub = ap_sub
                 tta6apvorp0102_ap_cc = ap_cc
                 tta6apvorp0102_ap_disc_acct = ap_disc_acct
                 tta6apvorp0102_ap_disc_sub = ap_disc_sub
                 tta6apvorp0102_ap_disc_cc = ap_disc_cc
                 .
            /* SS - 20051228 - E */
         end.
