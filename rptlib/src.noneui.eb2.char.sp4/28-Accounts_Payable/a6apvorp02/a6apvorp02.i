...
/* $Revision: 1.36.1.1 $     BY: Bill Jiang           DATE: 02/20/06  ECO: *SS - 20060220*  */
      ...
      for each vph_hist where vph_ref = ap_ref no-lock
         ...
         if available prh_hist then do:
            ...
            */
            CREATE tta6apvorp02.
            ASSIGN 
                tta6apvorp02_vo_ref = vo_ref
                tta6apvorp02_ap_date = ap_date
                tta6apvorp02_vd_remit = vd_remit
                tta6apvorp02_ap_curr = ap_curr
                tta6apvorp02_curr_disp_line1 = curr_disp_line1
                tta6apvorp02_curr_disp_line2 = curr_disp_line2
                tta6apvorp02_ap_vend = ap_vend
                tta6apvorp02_ap_effdate = ap_effdate
                tta6apvorp02_vo_ship = vo_ship
                tta6apvorp02_ap_bank = ap_bank
                tta6apvorp02_vopo = vopo
                tta6apvorp02_vo_due_date = vo_due_date
                tta6apvorp02_vo_invoice = vo_invoice
                tta6apvorp02_name = NAME
                tta6apvorp02_ap_acct = ap_acct
                tta6apvorp02_ap_sub = ap_sub
                tta6apvorp02_ap_cc = ap_cc
                tta6apvorp02_vo_disc_date = vo_disc_date
                tta6apvorp02_ap_entity = ap_entity
                tta6apvorp02_ap_rmk = ap_rmk
                tta6apvorp02_flag = flag
                tta6apvorp02_vo_confirmed = vo_confirmed
                tta6apvorp02_vo_conf_by = vo_conf_by
                tta6apvorp02_vo_is_ers = vo_is_ers
                tta6apvorp02_remit_label = remit_label
                tta6apvorp02_remit_name = remit_name
                tta6apvorp02_ap_ckfrm = ap_ckfrm
                tta6apvorp02_vo_type = vo_type
                tta6apvorp02_ap_batch = ap_batch

                tta6apvorp02_prh_receiver = prh_receiver
                tta6apvorp02_prh_line = prh_line
                tta6apvorp02_prh_nbr = prh_nbr
                tta6apvorp02_prh_part = prh_part
                tta6apvorp02_prh_um = prh_um
                tta6apvorp02_prh_type = prh_type
                tta6apvorp02_prh_rcvd = prh_rcvd
                tta6apvorp02_inv_qty = vph_inv_qty
                tta6apvorp02_pur_amt = pur_amt
                tta6apvorp02_prh_curr = prh_curr
                tta6apvorp02_inv_amt = inv_amt
                tta6apvorp02_vo_curr = vo_curr
                /* SS - 20060220 - B */
                tta6apvorp02_prh_rcp_date = prh_rcp_date
                /* SS - 20060220 - E */
                .
            /* SS - 20051025 - E */
