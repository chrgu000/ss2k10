...
repeat:
   ...
   */
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    FOR EACH tta6apvorp0401:
        DELETE tta6apvorp0401.
    END.
    {gprun.i ""a6apvorp0401.p"" "(
        INPUT vend,
        INPUT vend1,
        INPUT vdtype,
        INPUT vdtype1,
    ...
    EXPORT DELIMITER ";" "ap_vend" "name" "ad_attn" "ad_phone" "ad_ext" "voucherno" "invdate" "effdate" "duedate" "vo_cr_terms" "et_age_amt[1]" "et_age_amt[2]" "et_age_amt[3]" "et_age_amt[4]" "et_base_amt" "hold" "ap_ex_rate" "ap_ex_rate2" "ap_curr".
    FOR EACH tta6apvorp0401:
        EXPORT DELIMITER ";" tta6apvorp0401.
    END.
