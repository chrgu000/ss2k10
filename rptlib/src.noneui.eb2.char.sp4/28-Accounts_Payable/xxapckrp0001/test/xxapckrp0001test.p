...
repeat:
   ...
   EXPORT DELIMITER ";" "ap_batch" "ck_bank" "ck_nbr" "ck_ref" "ap_vend" "name" "ap_date" "ap_effdate" "ap_curr" "ap_ex_rate" "ap_ex_rate2" "ap_entity" "ap_acct" "ap_sub" "ap_cc" "ckstatus" "base_disp_amt" "ap_entity1" "ckd_voucher" "ckd_type" "order" "rmks" "invoice" "ckd_acct" "ckd_sub" "ckd_cc" "base_ckd_amt" "base_disc" "ap_disc_acct" "ap_disc_sub" "ap_disc_cc" "ap_rmk" "ck_voideff" "ckd_amt" "ckd_disc" "disp_amt".
   FOR EACH ttxxapckrp0001:
      EXPORT DELIMITER ";" ttxxapckrp0001.
   END.

   PUT UNFORMATTED "ttxxapckrp0001a: " SKIP.
   EXPORT DELIMITER ";" "entity" "acct" "sub" "cc" "project" "ref" "date" "effdate" "ap_batch" "ap_type" "ap_ref" "ckd_type" "ckd_voucher" "ap_vend" "amt" "rmks".
