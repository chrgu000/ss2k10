...
repeat:
   ...
   {mfrtrail.i}
       */
       ...
       EXPORT DELIMITER ";" "vo_ref" "ap_date" "vd_remit" "ap_curr" "curr_disp_line1" "curr_disp_line2" "ap_vend" "ap_effdate" "vo_ship" "ap_bank" "vopo" "vo_due_date" "vo_invoice" "name" "ap_acct" "ap_sub" "ap_cc" "vo_disc_date" "ap_entity" "ap_rmk" "flag" "vo_confirmed" "vo_conf_by" "vo_is_ers" "remit_label" "remit_name" "ap_ckfrm" "vo_type" "ap_batch" "prh_receiver" "prh_line" "prh_nbr" "prh_part" "prh_um" "prh_type" "prh_rcvd" "inv_qty" "pur_amt" "prh_curr" "inv_amt" "vo_curr".
       FOR EACH ttxxapvorp0001:
