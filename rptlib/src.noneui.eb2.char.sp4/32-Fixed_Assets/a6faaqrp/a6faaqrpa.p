...
/* $Revision: 1.13.1.13 $    BY: Bill Jiang    DATE: 02/17/06  ECO: *SS - 20060217*  */
/* $Revision: 1.13.1.13 $    BY: Bill Jiang    DATE: 02/20/06  ECO: *SS - 20060220*  */
/******************************************************************************/
...
for each fa_mstr
   ...
   then do:
      ...
      */
      CREATE tta6faaqrp.
      ASSIGN
         tta6faaqrp_fa_facls_id = fa_facls_id
         tta6faaqrp_fa_id = fa_mstr.fa_id
         tta6faaqrp_fa_desc1 = fa_mstr.fa_desc1
         tta6faaqrp_fa_faloc_id = fa_mstr.fa_faloc_id
         tta6faaqrp_fa_entity = fa_mstr.fa_entity
         tta6faaqrp_costAmt = costAmt
         tta6faaqrp_fa_puramt = fa_mstr.fa_puramt
         tta6faaqrp_fa_startdt = fa_mstr.fa_startdt
         .
      /* SS - 20060217 - E */
      {mfrpchk.i}
