...
/* Revision: $    BY: Bill Jiang            DATE: 02/20/06  ECO: *SS - 20060220*  */
/******************************************************************************/
...
repeat:
   ...
   */
   ...
   EXPORT DELIMITER ";" "fa_facls_id" "fa_id" "fa_desc1" "fa_faloc_id" "fa_entity" "costAmt" "fa_puramt" "fa_startdt".
   FOR EACH tta6faaqrp:
      EXPORT DELIMITER ";" tta6faaqrp.
   END.
