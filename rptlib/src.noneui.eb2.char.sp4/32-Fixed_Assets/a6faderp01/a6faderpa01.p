   ...
   then do:
      ...
      then do with frame f-2:
         ...
         */
         CREATE tta6faderp01.
         ASSIGN
            tta6faderp01_fabd_entity = fabd_entity
            tta6faderp01_fabd_fabk_id = fabd_fabk_id
            tta6faderp01_fabd_facls_id = fabd_facls_id
            tta6faderp01_fabd_fa_id = fabd_det.fabd_fa_id
            tta6faderp01_fa_desc1 = fa_mstr.fa_desc1
            tta6faderp01_costAmt = costAmt
            tta6faderp01_accDepr = accDepr
            tta6faderp01_expAmt = expAmt
            tta6faderp01_netBook = netBook
            tta6faderp01_annDepr = annDepr
            .
         /* SS - 20060323 - B */
         IF STRING(YEAR(fa_mstr.fa_startdt)) + SUBSTRING(STRING(100 + MONTH(fa_mstr.fa_startdt)),2,2) <= l-yrper1 THEN DO:
            ASSIGN
               tta6faderp01_fa_puramt = fa_mstr.fa_puramt
               .
         END.
         ...
         IF AVAILABLE bfa1 THEN DO:
            FOR EACH fab_det NO-LOCK
               ...
               :
               ASSIGN
                  tta6faderp01_accDepr_adj = tta6faderp01_accDepr_adj + fab_ovramt
                  .
            END.
            FOR EACH fab_det NO-LOCK
               WHERE fab_fa_id = fabd_det.fabd_fa_id 
               ...
               :
               ASSIGN
                  tta6faderp01_expAmt_adj = tta6faderp01_expAmt_adj + fab_ovramt
                  .
            END.
            FOR EACH fab_det NO-LOCK
               WHERE fab_fa_id = fabd_det.fabd_fa_id 
               ...
               :
               ASSIGN
                  tta6faderp01_annDepr_adj = tta6faderp01_annDepr_adj + fab_ovramt
                  .
            END.
         END.
         /* SS - 20060323 - E */
