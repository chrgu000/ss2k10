...
/* $Revision: 1.10.1.17 $      BY: Bill Jiang      DATE: 04/29/06  ECO: *SS - 20060429.1* */
   ...
   then do:
      ...
      then do with frame f-2:
         ...
         */
         CREATE tta6faderp03.
         ASSIGN
            tta6faderp03_fabd_entity = fabd_entity
            tta6faderp03_fabd_fabk_id = fabd_fabk_id
            tta6faderp03_fabd_facls_id = fabd_facls_id
            tta6faderp03_fabd_fa_id = fabd_det.fabd_fa_id
            tta6faderp03_fa_desc1 = fa_mstr.fa_desc1
            tta6faderp03_costAmt = costAmt
            tta6faderp03_accDepr = accDepr
            tta6faderp03_expAmt = expAmt
            tta6faderp03_netBook = netBook
            tta6faderp03_annDepr = annDepr
            tta6faderp03_fa_puramt = fa_mstr.fa_puramt
            .
         /* SS - 20060429.1 - E */
