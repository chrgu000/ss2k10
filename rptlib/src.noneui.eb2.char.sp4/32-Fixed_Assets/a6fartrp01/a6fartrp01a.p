...
/* $Revision: 1.10.1.13 $    BY: Bill Jiang           DATE: 04/25/06  ECO: *SS - 20060425.1*  */
/******************************************************************************/
...
*/
FOR EACH T_bkAsset NO-LOCK:
   CREATE tta6fartrp01.
   ASSIGN
      tta6fartrp01_fabk_id = bookId
      tta6fartrp01_fa_id = assetId
      tta6fartrp01_fa_faloc_id = locat
      tta6fartrp01_fa_facls_id = classId
      tta6fartrp01_fa_entity = entityId
      tta6fartrp01_fabd_peramt = costAmt
      tta6fartrp01_fabd_accamt = accDepr
      tta6fartrp01_fa_dispamt = dispAmt
      tta6fartrp01_fabd_gainamt = gainLoss
      tta6fartrp01_fa_disp_rsn = dispRsn
      tta6fartrp01_fa_disp_dt = dispDt
      .
END.
/* SS - 20060425.1 - E */
