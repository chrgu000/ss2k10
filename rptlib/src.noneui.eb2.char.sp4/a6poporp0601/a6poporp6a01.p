...
/* $Revision: 1.34 $     BY: Bill Jiang          DATE: 01/08/06  ECO: *SS - 20060108*   */
/* $Revision: 1.34 $     BY: Bill Jiang          DATE: 01/09/06  ECO: *SS - 20060109*   */
/******************************************************************************/
...
for each prh_hist
   ...
   do:
      ...
      display tax_amt @ pur_ext with frame b.
      {&POPORP6A-P-TAG5}
      */
...
display
   ...
   format "x(18)"   to 84
   accum total std_ext format "->>>>>>>>>>9.99<<<<"  to 103
   accum total pur_ext format "->>>>>>>>>>9.99<<<<"  to 119
   accum total std_var format "->>>>>>>>9.99<<<<"    to 132
   accum total tax_amt format "->>>>>>>>>>9.99<<<<"  to 119
      "=============== =============== ============" to 132
