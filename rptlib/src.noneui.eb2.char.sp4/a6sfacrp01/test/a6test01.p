...
/* $Revision: 1.11.1.7 $        BY: Bill Jiang  DATE: 09/27/05 ECO: *M1DM*      */
/******************************************************************************/
...
repeat:
   ...
   {mfrtrail.i}
       */
       ...
       FOR EACH tta6sfacrp01:
            DELETE tta6sfacrp01.
        END.
    
        {gprun.i ""a6sfacrp01.p"" "(
            INPUT part,
            INPUT part1,
            INPUT wonbr,
            INPUT wonbr1,
        ...
        EXPORT DELIMITER ";" "acct" "sub" "cc" "proj" "dr_amt" "cr_amt" "gl_ref" "tran_date" "date" "wo_nbr" "wo_lot" "wo_op" "site" "part" "type" "trnbr".
        FOR EACH tta6sfacrp01:
            EXPORT DELIMITER ";" tta6sfacrp01_acct tta6sfacrp01_sub tta6sfacrp01_cc tta6sfacrp01_proj tta6sfacrp01_dr_amt tta6sfacrp01_cr_amt tta6sfacrp01_gl_ref tta6sfacrp01_tran_date tta6sfacrp01_date tta6sfacrp01_wo_nbr tta6sfacrp01_wo_lot tta6sfacrp01_wo_op tta6sfacrp01_site tta6sfacrp01_part tta6sfacrp01_type tta6sfacrp01_trnbr.
        END.
...
for each op_hist
   fields (op_date   op_part   op_tran_date op_trnbr op_type
           op_wo_lot op_wo_nbr op_wo_op)
   where (op_date      >= efdate
   and    op_date      <= efdate1)
   and   (op_wo_nbr    >= wonbr
   ...
   use-index op_date,
   each opgl_det
      fields (opgl_cr_acct opgl_cr_cc  opgl_cr_line opgl_cr_proj opgl_cr_sub
