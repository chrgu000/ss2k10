...
/* $Revision: 1.32.1.1 $   BY: Mamata Samant   DATE: 10/27/03 ECO: *P17F*  */
/* $Revision: 1.32 $   BY: Bill Jiang       DATE: 02/15/06 ECO: *SS - 20060215*  */
      ...
      */
      ...
      then do:
         ...
         */
         CREATE tta6apckrp.
         ASSIGN
             tta6apckrp_ap_batch = ap_mstr.ap_batch
             tta6apckrp_ck_bank = ck_bank
             tta6apckrp_ck_nbr = ck_nbr
             tta6apckrp_ap_vend = ap_mstr.ap_vend
             tta6apckrp_name = NAME
             tta6apckrp_ap_date = ap_mstr.ap_date
             tta6apckrp_ap_effdate = ap_mstr.ap_effdate
             tta6apckrp_ap_curr = ap_mstr.ap_curr
             tta6apckrp_ap_ex_rate = ap_mstr.ap_ex_rate
             tta6apckrp_ap_ex_rate2 = ap_mstr.ap_ex_rate2
             tta6apckrp_ap_entity = ap_mstr.ap_entity
             tta6apckrp_ap_acct = ap_mstr.ap_acct
             tta6apckrp_ap_sub = ap_mstr.ap_sub
             tta6apckrp_ap_cc = ap_mstr.ap_cc
             tta6apckrp_ckstatus = ckstatus
             tta6apckrp_base_disp_amt = base_disp_amt
             tta6apckrp_ap_entity1 = apmstr.ap_entity
             tta6apckrp_ckd_voucher = ckd_voucher
             tta6apckrp_ckd_type = ckd_type
             tta6apckrp_order = order
             tta6apckrp_rmks = rmks
             tta6apckrp_invoice = invoice
             tta6apckrp_ckd_acct = ckd_acct
             tta6apckrp_ckd_sub = ckd_sub
             tta6apckrp_ckd_cc = ckd_cc
             tta6apckrp_base_ckd_amt = base_ckd_amt
             tta6apckrp_base_disc = base_disc
             .
         /* SS - 20060215 - E */
