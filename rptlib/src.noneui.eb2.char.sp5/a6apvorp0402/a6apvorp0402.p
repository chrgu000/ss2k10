...
/* $Revision: 1.37 $        BY: Bill Jiang             DATE: 03/01/06  ECO: *SS - 20060301* */
/* $Revision: 1.37 $        BY: Bill Jiang             DATE: 11/10/06  ECO: *SS - 20061110.1* */
...
form
   ...
   l_msg)
   base_rpt       colon 30
   et_report_curr colon 30 skip(0)
   space(1)
   age_days[1]
   age_days[2]    label "[2]"
         ...
         */
         ...
         for each vo_mstr
            ...
            for each ckd_det
               ...
               if not available apmaster or apmaster.ap_effdate <= vodate1
                  then
                  run ip-set-ap.
   ...
   if net <> 0 then do:
      ...
      */
      ...
      put
         ...
         ap_mstr.ap_curr.
      */
      CREATE tta6apvorp0402.
      ASSIGN
         tta6apvorp0402_ap_vend = ap_mstr.ap_vend
         tta6apvorp0402_name = NAME
         tta6apvorp0402_ad_attn = ad_mstr.ad_attn
         tta6apvorp0402_ad_phone = ad_phone
         tta6apvorp0402_ad_ext = ad_ext
         tta6apvorp0402_voucherno = voucherno
         tta6apvorp0402_invdate = invdate
         tta6apvorp0402_effdate = effdate
         tta6apvorp0402_vo_cr_terms = vo_mstr.vo_cr_terms
         tta6apvorp0402_et_age_amt[1] = et_age_amt[1]
         tta6apvorp0402_et_age_amt[2] = et_age_amt[2]
         tta6apvorp0402_et_age_amt[3] = et_age_amt[3]
         tta6apvorp0402_et_age_amt[4] = et_age_amt[4]
         tta6apvorp0402_et_base_amt = et_base_amt
         tta6apvorp0402_hold = hold
         tta6apvorp0402_ap_ex_rate = ap_mstr.ap_ex_rate
         tta6apvorp0402_ap_ex_rate2 = ap_mstr.ap_ex_rate2
         tta6apvorp0402_ap_curr = ap_mstr.ap_curr
         /* SS - 20061110.1 - B */
         tta6apvorp0402_ap_acct = ap_mstr.ap_acct
         tta6apvorp0402_ap_sub = ap_mstr.ap_sub
         tta6apvorp0402_ap_cc = ap_mstr.ap_cc
         /* SS - 20061110.1 - E */
         .
      IF NOT multi-due THEN DO:
         ASSIGN
            tta6apvorp0402_duedate = duedate
            .
      END.
