...
repeat:
   ...
   */
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    EXPORT DELIMITER ";" "ap_vend" "name" "ad_attn" "ad_phone" "ad_ext" "voucherno" "invdate" "effdate" "duedate" "vo_cr_terms" "et_age_amt[1]" "et_age_amt[2]" "et_age_amt[3]" "et_age_amt[4]" "et_base_amt" "hold" "ap_ex_rate" "ap_ex_rate2" "ap_curr" "ap_acct" "ap_sub" "ap_cc".
    FOR EACH tta6apvorp0402:
        EXPORT DELIMITER ";" tta6apvorp0402.
    END.
