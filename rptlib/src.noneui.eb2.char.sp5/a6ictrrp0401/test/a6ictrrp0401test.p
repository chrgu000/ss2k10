...
repeat:
   ...
   */
   ...
   FOR EACH tta6ictrrp0401:
       DELETE tta6ictrrp0401.
   END.

   {gprun.i ""a6ictrrp0401.p"" "(
      INPUT part,
      INPUT part1,
      INPUT site,
      INPUT site1,
   ...
   EXPORT DELIMITER ";" "pt_part" "tr_site" "tr_type" "tr_trnbr" "trgl_gl_ref" "trgl_cr_acct" "tr_begin_qoh" "beg_cost" "beg_inv" "tr_qty_loc" "tr_price" "trgl_gl_amt" "end_qty" "end_cost" "end_inv".
   FOR EACH tta6ictrrp0401:
       EXPORT DELIMITER ";" tta6ictrrp0401.
   END.
