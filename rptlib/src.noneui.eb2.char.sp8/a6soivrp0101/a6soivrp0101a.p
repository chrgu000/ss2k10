...
for each so_mstr where (so_nbr >= nbr) and (so_nbr <= nbr1)
   ...
   */
   ...
   ASSIGN
      tta6soivrp0101_so_inv_nbr = so_inv_nbr
      tta6soivrp0101_so_bill = so_bill
      tta6soivrp0101_bill_name = bill_name
      tta6soivrp0101_so_cust = so_cust
      tta6soivrp0101_name = name
      tta6soivrp0101_so_slspsn[1] = so_slspsn[1]
      tta6soivrp0101_so_ar_acct = so_ar_acct
      tta6soivrp0101_so_ar_sub = so_ar_sub
      tta6soivrp0101_so_ar_cc = so_ar_cc
      tta6soivrp0101_so_tax_env = so_tax_env
      tta6soivrp0101_so_tax_usage = so_tax_usage
      .
   rec1 = RECID(tta6soivrp0101).
   /* SS - 20060602.1 - E */
   ...
   if available tx2d_det then do:
      ...
      {gprun.i ""soivtrl2.p"" "(input so_inv_nbr,
                     ...
                     input l_consolidate)"}
         */
      {gprun.i ""a6soivtrl20101.p"" "(input so_inv_nbr,
                     input so_nbr,
                     input col-80 /* REPORT WIDTH */,
                     input '16'   /* TRANSACTION TYPE */,
                     input cont_charges,
      ...
      {gprun.i ""txdetrp1.p"" "(input '16',
                      ...
                      input l_accumonly)"}
                      */
         {gprun.i ""a6txdetrp10101.p"" "(input '16',
                         input so_inv_nbr,
                         input so_nbr,
                         input col-80,
                         input 0,
      ...
      then do:
         ...
         {gprun.i ""soivtrl2.p"" "(input so_nbr,
                         ...
                         input l_consolidate)"}
            */
         {gprun.i ""a6soivtrl20101.p"" "(input so_nbr,
                         ' ',
                         input col-80 /* REPORT WIDTH */,
                         input '13'   /* TRANSACTION TYPE */,
                         input cont_charges,
         ...
         {gprun.i ""txdetrp1.p"" "(input '13',
                         ...
                         input l_accumonly)"}
            */
            {gprun.i ""a6txdetrp10101.p"" "(input '13',
                            input so_nbr,
                            input '',
                            input col-80,
                            input 0,
   ...
   */
   ...
   {gprun.i ""txdetrp1.p"" "(input '',
                      ...
                      input l_printonly)"}
                      */
   {gprun.i ""a6txdetrp10101.p"" "(input '',
                      input '',
                      input '',
                      input col-80,
                      input 0,
