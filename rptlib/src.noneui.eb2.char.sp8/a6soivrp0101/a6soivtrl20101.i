         ...
         then do:
            ...
            */
            ...
            ASSIGN
               ...
               tta6soivrp0101_line_total = line_total
               tta6soivrp0101_so_disc_pct = so_disc_pct 
               tta6soivrp0101_disc_amt = disc_amt 
               tta6soivrp0101_tax_date = tax_date 
               tta6soivrp0101_user_desc[1] = user_desc[1] 
               tta6soivrp0101_so_trl1_cd = so_trl1_cd
               tta6soivrp0101_so_trl1_amt = so_trl1_amt 
               tta6soivrp0101_user_desc[2] = user_desc[2] 
               tta6soivrp0101_so_trl2_cd = so_trl2_cd 
               tta6soivrp0101_so_trl2_amt = so_trl2_amt
               tta6soivrp0101_user_desc[3] = user_desc[3] 
               tta6soivrp0101_so_trl3_cd = so_trl3_cd 
               tta6soivrp0101_so_trl3_amt = so_trl3_amt 
               tta6soivrp0101_tax_amt = tax_amt 
               tta6soivrp0101_ord_amt = ord_amt
               tta6soivrp0101_container_charge = container_charge_total
               tta6soivrp0101_line_charge_total = line_charge_total
   ...
   for first somstr
      ...
      */
      ...
      ASSIGN
         ...
         tta6soivrp0101_line_charge_total = line_charge_total
         tta6soivrp0101_invcrdt = invcrdt
         tta6soivrp0101_et_line_total = et_line_total
         tta6soivrp0101_et_disc_amt = et_disc_amt
         tta6soivrp0101_et_trl1_amt = et_trl1_amt
         tta6soivrp0101_et_trl2_amt = et_trl2_amt
         tta6soivrp0101_et_trl3_amt = et_trl3_amt
         tta6soivrp0101_et_tax_amt = et_tax_amt
         tta6soivrp0101_et_ord_amt = et_ord_amt
         .
      /* SS - 20060602.1 - E */
