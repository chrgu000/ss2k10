...
if not et_dc_print then
   ...
   */
   ...
   if txc__qad03 then
      ASSIGN
         ...
         .
   ASSIGN
      tta6soivrp0102_invtot_line_total = invtot_line_total
      tta6soivrp0102_invtot_container = invtot_container_amt
      tta6soivrp0102_invtot_linecharge = invtot_linecharge_amt
      tta6soivrp0102_invtot_disc_amt = invtot_disc_amt
      ...
      tta6soivrp0102_invtot_trl1_amt = invtot_trl1_amt
      tta6soivrp0102_so_trl2_cd = so_trl2_cd 
      tta6soivrp0102_invtot_trl2_amt = invtot_trl2_amt
      tta6soivrp0102_so_trl3_cd = so_trl3_cd 
      tta6soivrp0102_invtot_trl3_amt = invtot_trl3_amt
      tta6soivrp0102_invtot_tax_amt = invtot_tax_amt
      tta6soivrp0102_so_curr = so_curr
      tta6soivrp0102_invcrdt = invcrdt
      tta6soivrp0102_invtot_ord_amt = invtot_ord_amt
      tta6soivrp0102_tax_date = tax_date
      .
   if invtot_line_total <> 0 and l_consolidate THEN DO:
      ASSIGN
         tta6soivrp0102_so_disc_pct = (round(invtot_disc_amt / invtot_line_total * -100, 2))
         .
   END.
   ELSE DO:
      ASSIGN
   ...
   */
   ...
   ASSIGN
      tta6soivrp0102_invtot_line_total = invtot_line_total
      tta6soivrp0102_ettot_line_total = ettot_line_total
      tta6soivrp0102_invtot_disc_amt = invtot_disc_amt
      tta6soivrp0102_ettot_disc_amt = ettot_disc_amt
      tta6soivrp0102_user_desc[1] = user_desc[1]
      tta6soivrp0102_user_desc[2] = user_desc[2]
      tta6soivrp0102_user_desc[3] = user_desc[3]
      tta6soivrp0102_so_trl1_cd = so_trl1_cd 
      tta6soivrp0102_invtot_trl1_amt = invtot_trl1_amt
      tta6soivrp0102_ettot_trl1_amt = ettot_trl1_amt
      tta6soivrp0102_so_trl2_cd = so_trl2_cd 
      tta6soivrp0102_invtot_trl2_amt = invtot_trl2_amt
      tta6soivrp0102_ettot_trl2_amt = ettot_trl2_amt
      tta6soivrp0102_so_trl3_cd = so_trl3_cd 
      tta6soivrp0102_invtot_trl3_amt = invtot_trl3_amt
      tta6soivrp0102_ettot_trl3_amt = ettot_trl3_amt
      tta6soivrp0102_invtot_tax_amt = invtot_tax_amt
      tta6soivrp0102_ettot_tax_amt = ettot_tax_amt
      tta6soivrp0102_so_curr = so_curr
      tta6soivrp0102_invcrdt = invcrdt
      tta6soivrp0102_invtot_ord_amt = invtot_ord_amt
      tta6soivrp0102_ettot_ord_amt = ettot_ord_amt
      tta6soivrp0102_tax_date = tax_date
      .
   if invtot_line_total <> 0 and l_consolidate THEN DO:
      ASSIGN
