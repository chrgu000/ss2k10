...
repeat:
   ...
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    FOR EACH tta6soivrp0102:
        DELETE tta6soivrp0102.
    END.

   {gprun.i ""a6soivrp0102.p"" "(
      input nbr,
      input nbr1,
      input shipdate,
      input shipdate1,
    ...
    EXPORT DELIMITER ";" "so_inv_nbr" "so_bill" "bill_name" "so_cust" "name" "so_slspsn[1]" "so_slspsn[2]" "so_slspsn[3]" "so_slspsn[4]" "so_ar_acct" "so_ar_sub" "so_ar_cc" "so_tax_env" "so_tax_usage" "so_nbr" "so_ship" "ship_name" "so_ord_date" "so_po" "nontaxable_amt" "taxable_amt" "so_curr" "line_total" "so_disc_pct" "disc_amt" "tax_date" "user_desc[1]" "user_desc[2]" "user_desc[3]" "so_trl1_cd" "so_trl1_amt" "so_trl2_cd" "so_trl2_amt" "so_trl3_cd" "so_trl3_amt" "tax_amt" "ord_amt" "container_charge" "line_charge_total" "invcrdt" "et_line_total" "et_disc_amt" "et_trl1_amt" "et_trl2_amt" "et_trl3_amt" "et_tax_amt" "et_ord_amt" "invtot_line_total" "invtot_container" "invtot_linecharge" "invtot_disc_amt" "invtot_trl1_amt" "invtot_trl2_amt" "invtot_trl3_amt" "invtot_tax_amt" "invtot_ord_amt" "ettot_line_total" "ettot_disc_amt" "ettot_trl1_amt" "ettot_trl2_amt" "ettot_trl3_amt" "ettot_tax_amt" "ettot_ord_amt".
    FOR EACH tta6soivrp0102:
        EXPORT DELIMITER ";" tta6soivrp0102.
    END.
