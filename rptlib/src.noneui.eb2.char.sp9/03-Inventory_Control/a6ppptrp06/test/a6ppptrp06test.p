...
/* $Revision: 1.8.1.11.3.6 $ BY: Bill Jiang   DATE: 06/06/06  ECO: *SS - 20060606.1* */
...
repeat:
   ...
   */
   ...
   FOR EACH tta6ppptrp06:
       DELETE tta6ppptrp06.
   END.

   {gprun.i ""a6ppptrp06.p"" "(
      INPUT part,
      INPUT part1,
      INPUT LINE,
      INPUT line1,
   ...
   EXPORT DELIMITER ";" "site" "pl" "part" "um" "qty" "ext" "qty_non_consign" "qty_cust_consign" "qty_supp_consign".
   FOR EACH tta6ppptrp06:
      EXPORT DELIMITER ";" tta6ppptrp06.
   END.
