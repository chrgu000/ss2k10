...
/* $Revision: 1.10.1.17 $      BY: Bill Jiang      DATE: 05/05/06  ECO: *SS - 20060505.1* */
/* $Revision: 1.10.1.17 $      BY: Bill Jiang      DATE: 05/11/06  ECO: *SS - 20060511.1* */
/* $Revision: 1.10.1.17 $      BY: Bill Jiang      DATE: 05/11/06  ECO: *SS - 20060511.2* */
/* $Revision: 1.10.1.17 $      BY: Bill Jiang      DATE: 05/11/06  ECO: *SS - 20060511.3* */
/* $Revision: 1.10.1.17 $      BY: Bill Jiang      DATE: 05/23/06  ECO: *SS - 20060523.1* */
...
for each fabd_det
   ...
   */
   ...
   /* SS - 20060523.1 - B */
   /*
      fields(fa_id fa_desc1 fa_dep fa_puramt)
   */
   /* SS - 20060523.1 - E */
   ...
   then do:
      ...
      then do with frame f-2:
         ...
         */
         CREATE tta6faderp11.
         ASSIGN
            tta6faderp11_fabd_entity = fabd_entity
            tta6faderp11_fabd_fabk_id = fabd_fabk_id
            tta6faderp11_fabd_facls_id = fabd_facls_id
            tta6faderp11_fabd_fa_id = fabd_det.fabd_fa_id
            tta6faderp11_fa_desc1 = fa_mstr.fa_desc1
            tta6faderp11_costAmt = costAmt
            tta6faderp11_accDepr = accDepr
            tta6faderp11_expAmt = expAmt
            tta6faderp11_netBook = netBook
            tta6faderp11_annDepr = annDepr
            /* SS - 20060511.1 - B */
            tta6faderp11_fa_puramt = fa_mstr.fa_puramt
            /* SS - 20060511.1 - E */
            .
         /* SS - 20060505.1 - E */
