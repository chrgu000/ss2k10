   ...
   then do:
         ...
         then do:
            ...
            */
            ...
            {gprunp.i "fapl" "p" "fa-get-cost"
               "(input  fab_fa_id,
                 input  fab_fabk_id,
                 output tta6fartrp01_fabd_peramt)"}

            {gprunp.i "fapl" "p" "fa-get-accdep"
               "(input  fab_fa_id,
                 input  fab_fabk_id,
                 input  yrPeriod,
                 output tta6fartrp01_fabd_accamt)"}

            ASSIGN
               tta6fartrp01_fabk_id = fab_fabk_id
               tta6fartrp01_fa_id = fab_fa_id
               tta6fartrp01_fa_faloc_id = fa_faloc_id
               tta6fartrp01_fa_facls_id = fa_facls_id
               tta6fartrp01_fa_entity = fa_entity
               tta6fartrp01_fa_dispamt = fa_dispamt
               tta6fartrp01_fabd_gainamt = (tta6fartrp01_fabd_peramt - tta6fartrp01_fabd_accamt) - fa_dispamt
               tta6fartrp01_fa_disp_rsn = fa_disp_rsn
               tta6fartrp01_fa_disp_dt = fa_disp_dt
               .
            /* SS - 20060505.1 - E */
      ...
      then do:
         ...
         */
         CREATE tta6fartrp01.
         ASSIGN
            tta6fartrp01_fa_id = fa_id
            tta6fartrp01_fa_faloc_id = fa_faloc_id
            tta6fartrp01_fa_facls_id = fa_facls_id
            tta6fartrp01_fa_entity = fa_entity
            tta6fartrp01_fabd_peramt = fa_puramt
            tta6fartrp01_fabd_accamt = 0
            tta6fartrp01_fa_dispamt = fa_dispamt
            tta6fartrp01_fabd_gainamt = (fa_puramt - 0) - fa_dispamt
            tta6fartrp01_fa_disp_rsn = fa_disp_rsn
            tta6fartrp01_fa_disp_dt = fa_disp_dt
            .
         /* SS - 20060505.1 - E */
