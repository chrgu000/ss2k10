...
/* $Revision: 1.11.1.13 $ BY: Bill Jiang DATE: 04/16/07 ECO: *SS - 20070416.1* */
/*-Revision end---------------------------------------------------------------*/
         ...
         if available ct_mstr and ct_dating = yes then do:
            ...
            break by ctd_code:
               ...
               if available ct_mstr then do:
                  ...
                  */
                  ...
                  ASSIGN
                     tta6arcsrp0301_ar_bill = ar_bill
                     tta6arcsrp0301_ar_cust = ar_cust
                     tta6arcsrp0301_ar_date = ar_date
                     tta6arcsrp0301_ar_nbr = ar_nbr
                     tta6arcsrp0301_ar_type = ar_type
                     tta6arcsrp0301_type = TYPE
                     tta6arcsrp0301_ar_due_date = due-date
                     tta6arcsrp0301_ar_effdate = ar_effdate
                     tta6arcsrp0301_amt_due = amt-due
                     tta6arcsrp0301_amt_open = amt-open
                     tta6arcsrp0301_contested = contested
                     tta6arcsrp0301_ar_curr = ar_curr
                     tta6arcsrp0301_acct = ar_acct
                     tta6arcsrp0301_sub = ar_sub
                     tta6arcsrp0301_cc = ar_cc
                     tta6arcsrp0301_ar_ex_rate = ar_ex_rate
                     tta6arcsrp0301_ar_ex_rate2 = ar_ex_rate2
                     .
            ...
            */
            ...
            if ar_type <> "P" then
               ...
               tta6arcsrp0301_ar_nbr = ar_nbr
               tta6arcsrp0301_type = TYPE
               tta6arcsrp0301_ar_due_date = ar_due_date
               tta6arcsrp0301_acct = ar_acct
               tta6arcsrp0301_sub = ar_sub
               tta6arcsrp0301_cc = ar_cc
               tta6arcsrp0301_ar_ex_rate = ar_ex_rate
            ...
            ELSE DO:
               ASSIGN
                  tta6arcsrp0301_ar_nbr = ar_nbr
                  tta6arcsrp0301_ar_check = ar_check
                  tta6arcsrp0301_type = TYPE
                  .
