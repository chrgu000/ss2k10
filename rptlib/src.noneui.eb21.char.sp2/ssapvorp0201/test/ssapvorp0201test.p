...
/* $Revision: 1.32 $ BY: Bill Jiang DATE: 06/14/08 ECO: *SS - 20080614.1* */
/*-Revision end---------------------------------------------------------------*/
...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssapvorp0201.

    {gprun.i ""ssapvorp0201.p"" "(
       INPUT vend,
       INPUT vend1,
       INPUT vdtype,
       INPUT vdtype1,
    ...
    EXPORT DELIMITER ";" "ap_vend" "name" "ad_attn" "ad_phone" "ad_ext" "ap_ref" "vo_invoice" "vo_cr_terms" "ap_date" "et_age_amt1" "et_age_amt2" "et_age_amt3" "et_age_amt4"  "et_age_amt5"  "et_age_amt6" "et_age_amt7" "et_age_amt8" "ap_amt" "hold" "ap_ex_rate" "ap_ex_rate2" "vo_curr" "ap_acct" "ap_sub" "ap_cc" "ap_disc_acct" "ap_disc_acct" "ap_disc_cc".
    FOR EACH ttssapvorp0201:
        EXPORT DELIMITER ";" ttssapvorp0201.
    END.
