      ...
      do with frame b:
         ...
         */
         if summary_only = no THEN DO:
            CREATE ttssapvorp0202.
            ASSIGN
               ttssapvorp0202_ap_vend = ap_vend
               ttssapvorp0202_name = NAME
               ttssapvorp0202_ad_attn = ad_attn
               ttssapvorp0202_ad_phone = ad_phone
               ttssapvorp0202_ad_ext = ad_ext

               ttssapvorp0202_ap_ref = ap_ref
               ttssapvorp0202_vo_invoice = vo_invoice
               ttssapvorp0202_ap_date = ap_date
               ttssapvorp0202_vo_cr_terms = vo_cr_terms
               .
         END.
         /* SS - 20080613.1 - E */
         ...
         */
         ASSIGN
            ttssapvorp0202_et_age_amt[1] = et_age_amt[1]
            ttssapvorp0202_et_age_amt[2] = et_age_amt[2]
            ttssapvorp0202_et_age_amt[3] = et_age_amt[3]
            ttssapvorp0202_et_age_amt[4] = et_age_amt[4]
            ttssapvorp0202_et_age_amt[5] = et_age_amt[5]
            ttssapvorp0202_et_age_amt[6] = et_age_amt[6]
            ttssapvorp0202_et_age_amt[7] = et_age_amt[7]
            ttssapvorp0202_et_age_amt[8] = et_age_amt[8]
            ttssapvorp0202_ap_amt = (et_base_amt - et_base_applied - et_adj_amt)
            ttssapvorp0202_hold = hold

            ttssapvorp0202_ap_ex_rate = ap_ex_rate
            ttssapvorp0202_ap_ex_rate2 = ap_ex_rate2
            ttssapvorp0202_vo_curr = vo_curr

            ttssapvorp0202_ap_acct = ap_acct
            ttssapvorp0202_ap_sub = ap_sub
            ttssapvorp0202_ap_cc = ap_cc
            ttssapvorp0202_ap_disc_acct = ap_disc_acct
            ttssapvorp0202_ap_disc_sub = ap_disc_sub
            ttssapvorp0202_ap_disc_cc = ap_disc_cc
            .
         /* SS - 20080613.1 - E */
         {&APVORP02-P-TAG7}
