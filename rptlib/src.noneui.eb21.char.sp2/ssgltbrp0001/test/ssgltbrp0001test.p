...
/* $Revision: 1.22 $ BY: Bill Jiang DATE: 08/08/08 ECO: *SS - 20080808.1* */
/*-Revision end---------------------------------------------------------------*/
...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssgltbrp0001.

    {gprun.i ""ssgltbrp0001.p"" "(
        INPUT entity,
        INPUT entity1,
        INPUT begdt,
        INPUT enddt
    ...
    EXPORT DELIMITER ";" "acc" "sub" "cc" "beg_bal_dr_amt" "beg_bal_cr_amt" "per_act_dr_amt" "per_act_cr_amt" "end_bal_dr_amt" "end_bal_cr_amt" "beg_bal_dr_camt" "beg_bal_cr_camt" "per_act_dr_camt" "per_act_cr_camt" "end_bal_dr_camt" "end_bal_cr_camt" "beg_bal_dr_eamt" "beg_bal_cr_eamt" "per_act_dr_eamt" "per_act_cr_eamt" "end_bal_dr_eamt" "end_bal_cr_eamt".
    FOR EACH ttssgltbrp0001:
        EXPORT DELIMITER ";" ttssgltbrp0001.
    END.
