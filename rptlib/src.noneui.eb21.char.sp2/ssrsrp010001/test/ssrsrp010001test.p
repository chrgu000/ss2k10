...
date_from date_to 
   /* SS - 20080807.1 - B */
   /*
   schtype current_ind sortoption 
   */
   current_ind 
   /* SS - 20080807.1 - E */
   " &frm = "a"}
...
/*K1QY*/ run run_report_procedure.
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssrsrp010001.

    {gprun.i ""ssrsrp010001.p"" "(
        INPUT po_from,
        INPUT po_to,
        INPUT part_from,
        INPUT part_to,
    ...
    EXPORT DELIMITER ";" "scx_po" "scx_line" "scx_part" "pod_vpart" "pod_um" "scx_shipfrom" "ad_name" "scx_shipto" "sch_rlse_id" "cmmts" "sch_cr_date" "sch_cr_time" "prior_disp_qty" "sch_eff_start" "sch_pcs_date" "sch_eff_end" "schd_date" "schd_time" "schd_interval" "schd_reference" "disp_qty" "schd_fc_qual" "scx_order" "po_buyer".
    FOR EACH ttssrsrp010001:
        EXPORT DELIMITER ";" ttssrsrp010001.
    END.
