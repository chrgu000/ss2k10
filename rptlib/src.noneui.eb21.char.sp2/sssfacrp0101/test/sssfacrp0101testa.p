...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttsssfacrp0101.
   
   {gprun.i ""sssfacrp0101.p"" "(
      INPUT part,
      INPUT part1,
      INPUT wonbr,
      INPUT wonbr1,
   ...
   EXPORT DELIMITER ";" "acct" "sub" "cc" "proj" "dr_amt" "cr_amt" "entity" "gl_ref" "tran_date" "date" "wo_nbr" "wo_lot" "wo_op" "site" "part" "type" "trnbr" "wkctr" "mch" "dr_qty_wip" "dr_qty_comp" "dr_qty_rjct" "dr_qty_rwrk" "dr_qty_scrap" "dr_qty_adjust" "cr_qty_wip" "cr_qty_comp" "cr_qty_rjct" "cr_qty_rwrk" "cr_qty_scrap" "cr_qty_adjust".
   FOR EACH ttsssfacrp0101:
      EXPORT DELIMITER ";" ttsssfacrp0101.
   END.
