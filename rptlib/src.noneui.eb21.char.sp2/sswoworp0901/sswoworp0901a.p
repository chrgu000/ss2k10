...
/* $Revision: 1.20 $ BY: Bill Jiang DATE: 05/06/08 ECO: *SS - 20080506.1* */
/*-Revision end---------------------------------------------------------------*/
...
for each wo_mstr
 ...
 where wo_mstr.wo_domain = global_domain and (
   ...
   then do:
      ...
      */
      DO:
            CREATE ttsswoworp0901.
            ASSIGN
               ttsswoworp0901_acct = wo_acct
               ttsswoworp0901_sub = wo_sub
               ttsswoworp0901_cc = wo_cc
               ttsswoworp0901_project = wo_project

               ttsswoworp0901_nbr = wo_nbr
               ttsswoworp0901_lot = wo_lot
               ttsswoworp0901_part = wo_part
               ttsswoworp0901_mtl_tot = wo_mtl_tot
               ttsswoworp0901_bdn_tot = wo_bdn_tot
               ttsswoworp0901_qty_comp = qty_comp
               ttsswoworp0901_avg_cost = avg_cost
               ttsswoworp0901_total_std = total_std

               ttsswoworp0901_desc1 = desc1
               ttsswoworp0901_lbr_tot = wo_lbr_tot
               ttsswoworp0901_sub_tot = wo_sub_tot
               ttsswoworp0901_qty_open = qty_open
               ttsswoworp0901_wip_tot = wo_wip_tot

               ttsswoworp0901_site = wo_site
               ttsswoworp0901_qty_ord = wo_qty_ord
      ...
      */
      DO:
          ...
          ASSIGN
             ...
             ttsswoworp0901_qty_open = qty_open
             /* 3.1 */
             ttsswoworp0901_wip_tot = base_wip_tot
