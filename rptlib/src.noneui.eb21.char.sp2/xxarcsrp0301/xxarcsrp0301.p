         ...
         if available ct_mstr and ct_dating = yes then do:
            ...
            break by ctd_code:
               ...
               if available ct_mstr then do:
                  ...
                  down 1 with frame c.
                  */
                  CREATE ttxxarcsrp0301.
                  ASSIGN
                     ttxxarcsrp0301_ar_bill = ar_bill
                     ttxxarcsrp0301_ar_cust = ar_cust
                     ttxxarcsrp0301_ar_date = ar_date
                     ttxxarcsrp0301_ar_nbr = ar_nbr
                     ttxxarcsrp0301_ar_type = ar_type
                     ttxxarcsrp0301_type = TYPE
                     ttxxarcsrp0301_ar_due_date = due-date
                     ttxxarcsrp0301_ar_effdate = ar_effdate
                     ttxxarcsrp0301_amt_due = amt-due
                     ttxxarcsrp0301_amt_open = amt-open
                     ttxxarcsrp0301_contested = contested
                     ttxxarcsrp0301_ar_curr = ar_curr
                     ttxxarcsrp0301_acct = ar_acct
                     ttxxarcsrp0301_sub = ar_sub
                     ttxxarcsrp0301_cc = ar_cc
                     ttxxarcsrp0301_ar_ex_rate = ar_ex_rate
                     ttxxarcsrp0301_ar_ex_rate2 = ar_ex_rate2
                     .
                  IF ar_type = getTermLabel("MEMO",8) THEN DO:
                     ASSIGN
                        ttxxarcsrp0301_ar_type = "M"
                        ttxxarcsrp0301_type = ar_type
                        .
                  END.
                  ELSE IF ar_type = getTermLabel("INVOICE",8) THEN DO:
                     ASSIGN
                        ttxxarcsrp0301_ar_type = "I"
                        ttxxarcsrp0301_type = ar_type
                        .
                  END.
                  ELSE IF ar_type = getTermLabel("FIN_CHG",8) THEN DO:
                     ASSIGN
                        ttxxarcsrp0301_ar_type = "F"
                        ttxxarcsrp0301_type = ar_type
                        .
                  END.
                  ELSE IF ar_type = getTermLabel("PAYMENT",8) THEN DO:
                     ASSIGN
                        ttxxarcsrp0301_ar_type = "P"
                        ttxxarcsrp0301_type = ar_type
                        .
                  END.
                  ELSE IF ar_type = getTermLabel("DRAFT",8) THEN DO:
                     ASSIGN
                        ttxxarcsrp0301_ar_type = "D"
                        ttxxarcsrp0301_type = ar_type
                        .
                  END.
                  /* SS - 20081007.1 - E */
            ...
            */
            ...
            if ar_type <> "P" then
               ...
               ttxxarcsrp0301_ar_nbr = ar_nbr
               ttxxarcsrp0301_type = TYPE
               ttxxarcsrp0301_ar_due_date = ar_due_date
               ttxxarcsrp0301_acct = ar_acct
               ttxxarcsrp0301_sub = ar_sub
               ttxxarcsrp0301_cc = ar_cc
               ttxxarcsrp0301_ar_ex_rate = ar_ex_rate
            ...
            ELSE DO:
               ASSIGN
                  ttxxarcsrp0301_ar_nbr = ar_nbr
                  ttxxarcsrp0301_ar_check = ar_check
                  ttxxarcsrp0301_type = TYPE
                  .
               ...
               IF AVAILABLE ard_det THEN DO:
                  ASSIGN
                     ttxxarcsrp0301_acct = ard_acct
                     ttxxarcsrp0301_sub = ard_sub
                     ttxxarcsrp0301_cc = ard_cc
                     ttxxarcsrp0301_ar_ex_rate = ar_ex_rate
                     ttxxarcsrp0301_ar_ex_rate2 = ar_ex_rate2
                     .
               END.
            END.
            ASSIGN
               ttxxarcsrp0301_amt_due = base_amt
               ttxxarcsrp0301_amt_open = base_open
               ttxxarcsrp0301_contested = contested
               ttxxarcsrp0301_ar_curr = ar_curr
               .
            IF ar_type = getTermLabel("MEMO",8) THEN DO:
