...
DEFINE VARIABLE ref_gltr LIKE gltr_ref.
/* SS - 20081007.1 - E */
...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttxxarcsrp0302.
   {gprun.i ""xxarcsrp0302.p"" "(
      INPUT cust,
      INPUT cust1,
      INPUT entity,
      INPUT entity1,
   ...
   EXPORT DELIMITER ";" 
      "ar_bill" "ar_cust" "ar_date" "ar_nbr" "ar_check" "ar_type" "type" "due_date" "ar_effdate" "amt_due" "amt_open" "contested" "ar_curr" "acct" "sub" "cc" "ar_ex_rate" "ar_ex_rate2"
      "gltr_entity-ref"
      .
   FOR EACH ttxxarcsrp0302
      :
      ref_gltr = "".
      FOR EACH gltr_hist NO-LOCK
         WHERE gltr_domain = GLOBAL_domain
         AND gltr_doc_typ = ttxxarcsrp0302_ar_type
         AND gltr_eff_dt = ttxxarcsrp0302_ar_effdate
         AND gltr_doc = ttxxarcsrp0302_ar_nbr
         AND gltr_acc = ttxxarcsrp0302_acct
         USE-INDEX gltr_doctype
         BREAK BY gltr_ref
         :
         IF LAST-OF(gltr_ref) THEN DO:
            IF ref_gltr = "" THEN DO:
               ref_gltr = gltr_entity + "-" + gltr_ref.
            END.
            ELSE DO:
               ref_gltr = ref_gltr + "," + gltr_entity + "-" + gltr_ref.
            END.
         END.
      END.

      EXPORT DELIMITER ";" 
         ttxxarcsrp0302_ar_bill      
         ttxxarcsrp0302_ar_cust      
         ttxxarcsrp0302_ar_date      
         ttxxarcsrp0302_ar_nbr       
         ttxxarcsrp0302_ar_check     
         ttxxarcsrp0302_ar_type      
         ttxxarcsrp0302_type         
         ttxxarcsrp0302_ar_due_date  
         ttxxarcsrp0302_ar_effdate   
         ttxxarcsrp0302_amt_due      
         ttxxarcsrp0302_amt_open     
         ttxxarcsrp0302_contested    
         ttxxarcsrp0302_ar_curr      
         ttxxarcsrp0302_acct         
         ttxxarcsrp0302_sub          
         ttxxarcsrp0302_cc           
         ttxxarcsrp0302_ar_ex_rate   
         ttxxarcsrp0302_ar_ex_rate2  
         ref_gltr
         .
   END.
