...
define input parameter i_part       like fcs_part no-undo.
define input parameter i_part1      like fcs_part no-undo.
define input parameter i_site       like fcs_site no-undo.
define input parameter i_site1      like fcs_site no-undo.
define input parameter i_prod_line  like pl_prod_line no-undo.
define input parameter i_fcsdate    as   date no-undo.
define input parameter i_fcsdate1   as   date no-undo.
/* SS - 100811.1 - E */
...
SS - 100811.1 - E */
   ...
   {wbrp06.i &command = set &fields = "  part part1  site site1 prod_line
         fcsdate fcsdate1 det_sum  fcst_only" &frm = "a"}
   SS - 100811.1 - E */
   ...
   for each pt_mstr no-lock
      ...
      repeat i = if fcs_year = fcsyear
         ...
         then do:
            ...
            SS - 100811.1 - E */
            /* SS - 100811.1 - B */
            CREATE ttxxfcfsrp0001.
            ASSIGN
               ttxxfcfsrp0001_part = fcs_part
               ttxxfcfsrp0001_desc1 = pt_desc1
               ttxxfcfsrp0001_desc2 = pt_desc2

               ttxxfcfsrp0001_site = fcs_site

               ttxxfcfsrp0001_week = weeks[i]
               ttxxfcfsrp0001_start = START[i]
               ttxxfcfsrp0001_fcst_qty = fcs_fcst_qty[i]
               ttxxfcfsrp0001_sold_qty = fcs_sold_qty[i]
               ttxxfcfsrp0001_abnormal = fcs_abnormal[i]
               ttxxfcfsrp0001_prod_fcst = prod_fcst[i]
               ttxxfcfsrp0001_net = net[i]
               .
            /* SS - 100811.1 - E */
