...
define input parameter i_site            like wo_site      no-undo.
define input parameter i_site1           like wo_site      no-undo.
define input parameter i_prline          like rps_line     no-undo.
define input parameter i_prline1         like rps_line     no-undo.
define input parameter i_release_date    like wr_start     no-undo.
define input parameter i_release_date1   like ro_end       no-undo.
/* SS - 100818.1 - E */
...
/* INTERNAL PROCEDURES TO HANDLE CALLS TO xxrelsrp0001a.i */
...
PROCEDURE sort_run_seq_desc_desc:
   ...
   { xxrelsrp0001a.i descending descending }
...
SS - 100818.1 - E */
   ...
   /* LOGIC TO CALL xxrelsrp0001a.i WITH REQUIRED ORDER OF SORTING */
   if primary_sort
   then do:
