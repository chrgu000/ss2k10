...
for each wo_mstr
   ...
   */
   ...
   wo_lot no-lock break by wod_lot
      ...
      SS - 090318.1 - E */
      /* SS - 090318.1 - B */
      CREATE ttxxwoworp0501.
      ASSIGN
         ttxxwoworp0501_wo_nbr = wo_nbr
         ttxxwoworp0501_wo_lot = wo_lot
         ttxxwoworp0501_wo_batch = wo_batch
         ttxxwoworp0501_wo_qty_ord = wo_qty_ord
         ttxxwoworp0501_wo_ord_date = wo_ord_date
         ttxxwoworp0501_glx_mthd = glx_mthd
         ttxxwoworp0501_wo_part = wo_part
         ttxxwoworp0501_desc1 = desc1
         ttxxwoworp0501_wo_qty_comp = wo_qty_comp
         ttxxwoworp0501_wo_rel_date = wo_rel_date
         ttxxwoworp0501_premsg = premsg
         ttxxwoworp0501_wo_so_job = wo_so_job
         ttxxwoworp0501_wo_qty_rjct = wo_qty_rjct
         ttxxwoworp0501_wo_due_date = wo_due_date
         ttxxwoworp0501_wo_vend = wo_vend
         ttxxwoworp0501_wo_status = wo_status
         ttxxwoworp0501_wo_rmks = wo_rmks

         ttxxwoworp0501_wod_part = wod_part
         ttxxwoworp0501_accqty = accqty
         ttxxwoworp0501_expcst = expcst
         ttxxwoworp0501_acrvar = acrvar
         ttxxwoworp0501_acccst = acccst
         ttxxwoworp0501_rtevar = rtevar
         ttxxwoworp0501_usevar = usevar
         ttxxwoworp0501_wowipx = wowipx
         ttxxwoworp0501_wipamt = wipamt
         .
      if wo_fsm_type = "FSM-RO" or wo_fsm_type = "PRM" then DO:
         ASSIGN 
            ttxxwoworp0501_wo_status = status-type
            .
      END.
      /* SS - 090318.1 - E */
