...
/* $Revision: 1.8 $  BY: Bill Jiang   DATE: 05/06/08 ECO: *SS - 090411.1*      */
/******************************************************************************/
...
repeat:
    ...
    */
    ...
    EMPTY TEMP-TABLE ttxxwoworp0901.

     {gprun.i ""xxwoworp0901.p"" "(
         INPUT acct,
         INPUT acct1,
         INPUT sub,
         INPUT sub1,
     ...
     FOR EACH ttxxwoworp0901:
         EXPORT DELIMITER ";" ttxxwoworp0901.
     END.
