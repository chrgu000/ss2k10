...
repeat:
  ...
  */
   ...
   */
   ...
   EMPTY TEMP-TABLE tta6apckrp0001.

   {gprun.i ""a6apckrp0001.p"" "(
      input batch        ,
      input batch1       ,
      input nbr          ,
      input nbr1         ,
   ...
   EXPORT DELIMITER ";" "ap_batch" "ck_bank" "ck_nbr" "ck_ref" "ap_vend" "name" "ap_date" "ap_effdate" "ap_curr" "ap_ex_rate" "ap_ex_rate2" "ap_entity" "ap_acct" "ap_sub" "ap_cc" "ckstatus" "base_disp_amt" "ap_entity1" "ckd_voucher" "ckd_type" "order" "rmks" "invoice" "ckd_acct" "ckd_sub" "ckd_cc" "base_ckd_amt" "base_disc".
   FOR EACH tta6apckrp0001:
      EXPORT DELIMITER ";" tta6apckrp0001.
   END.
