...
define new shared variable effdate like ar_effdate initial today.
...
form
   ...
   */
   ...
   summary_only    colon 26  
   show_comments      colon 60
   base_rpt        colon 26  
   show_mstr_comments colon 60
   et_report_curr  colon 26
   mstr_type colon 60
   mstr_lang colon 60
   skip
...
/* Code below to be wrapped in a 'do' code block for correct GUI conversion */
   ...
   */
   ...
   EXPORT DELIMITER ";" "ar_entity" "ar_bill" "ar_batch" "ar_nbr" "ar_check" "ar_type" "ar_date" "ar_effdate" "ar_due_date" "ar_po" "ar_curr" "ar_acct" "ar_sub" "ar_cc" "disp_curr" "ar_amt" "et_base_amt" "amt_open" "days_open" "ar_ex_rate" "ar_ex_rate2".
