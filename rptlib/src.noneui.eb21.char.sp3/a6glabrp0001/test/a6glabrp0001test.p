...
/* $Revision: 1.22 $ BY: Bill Jiang DATE: 12/17/07 ECO: *SS - 20071217.1* */
/*-Revision end---------------------------------------------------------------*/
...
/*J240*/   then do:
           ...
           */
           PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
             ...
             EMPTY TEMP-TABLE tta6glabrp0001.

            {gprun.i ""a6glabrp0001.p"" "(
                INPUT entity,
                INPUT entity1,
                INPUT acc,
                INPUT acc1,
             ...
             EXPORT DELIMITER ";" "acc" "sub" "cc" "et_beg_bal" "et_end_bal".
             FOR EACH tta6glabrp0001:
                 EXPORT DELIMITER ";" tta6glabrp0001.
             END.
