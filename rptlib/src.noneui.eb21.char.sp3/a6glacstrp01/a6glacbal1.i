...
/* $Revision: 1.9 $ BY: Bill Jiang DATE: 04/10/07 ECO: *SS - 20070410.1* */
/*-Revision end---------------------------------------------------------------*/
...
/*N0VY*/ {cxcustom.i "GLACBAL1.I"}
          assign {&balance} = 0.
         /* SS - 20070410.1 - B */
         assign {&currbalance} = 0.
         assign {&basebalance} = 0.
         /* SS - 20070410.1 - E */
...
/* SS - 20070410.1 - B */
ASSIGN
   {&basebalance} = {&basebalance} + gltr_amt
   {&currbalance} = {&currbalance} + gltr_curramt
   .
/* SS - 20070410.1 - E */
/*J23W**              end. **/
                   end.
...
/* SS - 20070410.1 - B */
ASSIGN
   {&basebalance} = {&basebalance} + acd_amt
   {&currbalance} = {&currbalance} + acd_curr_amt
   .
/* SS - 20070410.1 - E */
end.
...
/*J23W**        end.**/
                      /* SS - 20070410.1 - B */
                      if gltr_tr_type = "YR" or gltr_tr_type = "RA" then
                         assign {&basebalance} = {&basebalance} - gltr_amt.
                      /* SS - 20070410.1 - E */
                end.
             end.
