   ...
   for each tr_hist no-lock
      ...
      */
      ...
      ASSIGN
         ...
         tta6ictrrp0301_trgl_dr_proj = trgl_dr_proj
         tta6ictrrp0301_trgl_dr_amt = trgl_gl_amt
         tta6ictrrp0301_trgl_cr_acct = trgl_cr_acct
         tta6ictrrp0301_trgl_cr_sub = trgl_cr_sub
         tta6ictrrp0301_trgl_cr_cc = trgl_cr_cc
         tta6ictrrp0301_trgl_cr_proj = trgl_cr_proj
         tta6ictrrp0301_trgl_cr_amt = (- trgl_gl_amt)
         tta6ictrrp0301_tr_part = tr_part
         .
      IF AVAILABLE si_mstr THEN DO:
         ASSIGN
            tta6ictrrp0301_si_entity = si_entity
            .
      END.
      ASSIGN
         tta6ictrrp0301_tr_rmks = tr_rmks
         tta6ictrrp0301_tr_line = tr_line
         tta6ictrrp0301_tr_site = tr_site
         tta6ictrrp0301_tr_prod_line = tr_prod_line
         tta6ictrrp0301_tr_lot = tr_lot
         tta6ictrrp0301_tr_date = tr_date
         tta6ictrrp0301_tr_type = tr_type
         tta6ictrrp0301_tr_loc = tr_loc
         tta6ictrrp0301_tr_qty_loc = tr_qty_loc
         .
      FIND FIRST wo_mstr 
      ...
      IF AVAILABLE wo_mstr THEN DO:
         ASSIGN
            tta6ictrrp0301_wo_part = wo_part
            .
      END.
      /* SS - 20070415.1 - E */
   end. /*for each*/
