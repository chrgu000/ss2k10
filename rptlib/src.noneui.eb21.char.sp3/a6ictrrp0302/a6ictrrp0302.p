   ...
   */
   ...
   for each tr_hist no-lock
      ...
      */
      ...
      ASSIGN
         tta6ictrrp0302_tr_effdate = tr_effdate
         tta6ictrrp0302_tr_trnbr = tr_trnbr
         tta6ictrrp0302_trgl_type = trgl_type
         tta6ictrrp0302_tr_nbr = tr_nbr
         tta6ictrrp0302_trgl_gl_ref = trgl_gl_ref
         tta6ictrrp0302_trgl_dr_acct = trgl_dr_acct
         tta6ictrrp0302_trgl_dr_sub = trgl_dr_sub
         tta6ictrrp0302_trgl_dr_cc = trgl_dr_cc
         tta6ictrrp0302_trgl_dr_proj = trgl_dr_proj
         tta6ictrrp0302_trgl_dr_amt = trgl_gl_amt
         tta6ictrrp0302_trgl_cr_acct = trgl_cr_acct
         tta6ictrrp0302_trgl_cr_sub = trgl_cr_sub
         tta6ictrrp0302_trgl_cr_cc = trgl_cr_cc
         tta6ictrrp0302_trgl_cr_proj = trgl_cr_proj
         tta6ictrrp0302_trgl_cr_amt = (- trgl_gl_amt)
         tta6ictrrp0302_tr_part = tr_part
         .
      IF AVAILABLE si_mstr THEN DO:
         ASSIGN
            tta6ictrrp0302_si_entity = si_entity
            .
      END.
      ASSIGN
         tta6ictrrp0302_tr_rmks = tr_rmks
         tta6ictrrp0302_tr_line = tr_line
         tta6ictrrp0302_tr_site = tr_site
         tta6ictrrp0302_tr_prod_line = tr_prod_line
         tta6ictrrp0302_tr_lot = tr_lot
         tta6ictrrp0302_tr_date = tr_date
         tta6ictrrp0302_tr_type = tr_type
         tta6ictrrp0302_tr_loc = tr_loc
         tta6ictrrp0302_tr_qty_loc = tr_qty_loc
         .
      FIND FIRST wo_mstr 
