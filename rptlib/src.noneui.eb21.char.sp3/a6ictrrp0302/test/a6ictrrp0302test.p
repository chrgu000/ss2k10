...
repeat:
  ...
  */
   {wbrp06.i &command = update
       &fields = "  part part1 efdate efdate1 glref glref1
    entity entity1
        acct acct1 sub sub1 cc cc1 proj proj1 trdate trdate1 trtype
        " &frm = "a"}
   /* SS - 20070416.1 - E */
   ...
   */
   ...
   EMPTY TEMP-TABLE tta6ictrrp0302.

    {gprun.i ""a6ictrrp0302.p"" "(
       INPUT part,
       INPUT part1,
        INPUT efdate,
        INPUT efdate1,
     ...
     FOR EACH tta6ictrrp0302:
         EXPORT DELIMITER ";" tta6ictrrp0302.
     END.
