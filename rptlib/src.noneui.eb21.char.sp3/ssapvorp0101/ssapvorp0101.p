      ...
      do with frame b:
         ...
         */
         ...
         if summary_only = no then do:
            ...
            */
            CREATE ttssapvorp0101.
            ASSIGN
               ttssapvorp0101_ap_vend = ap_vend
               ttssapvorp0101_name = NAME
               ttssapvorp0101_ad_attn = ad_attn
               ttssapvorp0101_ad_phone = ad_phone
               ttssapvorp0101_ad_ext = ad_ext

               ttssapvorp0101_ap_ref = ap_ref
               ttssapvorp0101_vo_invoice = vo_invoice

               ttssapvorp0101_vo_cr_terms = vo_cr_terms
               .
            if multi-due = no THEN DO:
                ASSIGN
                    ttssapvorp0101_vo_due_date = vo_due_date
                    .
            END.
            /* SS - 20080421.1 - E */
         end.
         ...
         */
         ...
         if summary_only = no then do:
            ...
            */
            ASSIGN
               ttssapvorp0101_et_age_amt[1] = et_age_amt[1]
               ttssapvorp0101_et_age_amt[2] = et_age_amt[2]
               ttssapvorp0101_et_age_amt[3] = et_age_amt[3]
               ttssapvorp0101_et_age_amt[4] = et_age_amt[4]
               ttssapvorp0101_et_age_amt[5] = et_age_amt[5]
               ttssapvorp0101_et_age_amt[6] = et_age_amt[6]
               ttssapvorp0101_et_vo_tot = et_vo_tot

               ttssapvorp0101_hold = hold

               ttssapvorp0101_ap_ex_rate = ap_ex_rate
               ttssapvorp0101_ap_ex_rate2 = ap_ex_rate2
               ttssapvorp0101_ap_curr = ap_curr

               ttssapvorp0101_ap_acct = ap_acct
               ttssapvorp0101_ap_sub = ap_sub
               ttssapvorp0101_ap_cc = ap_cc
               ttssapvorp0101_ap_disc_acct = ap_disc_acct
               ttssapvorp0101_ap_disc_sub = ap_disc_sub
               ttssapvorp0101_ap_disc_cc = ap_disc_cc
               .
            /* SS - 20080421.1 - E */
         end.
