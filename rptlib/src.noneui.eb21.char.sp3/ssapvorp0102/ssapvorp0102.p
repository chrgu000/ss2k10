...
/* Revision: 1.33  BY: Paul Donnelly (SB) DATE: 06/26/03 ECO: *Q00B* */
/* $Revision: 1.34 $ BY: Robert Jensen      DATE: 01/28/05 ECO: *P35X* */
/* $Revision: 1.34 $ BY: Bill Jiang      DATE: 04/21/08 ECO: *SS - 20080421.1* */
/*-Revision end---------------------------------------------------------------*/
...
*/
define variable age_days as integer extent 6 label {&apvorp01_p_17}.
define variable age_range as character extent 5 format "x(17)".
define variable i as integer.
define variable age_amt like ap_amt extent 6.
/* SS - 20080421.1 - E */
...
*/
define variable et_age_amt       like ap_amt extent 6.
/* SS - 20080421.1 - E */
...
*/
define variable et_org_age_amt   like ap_amt extent 6.
/* SS - 20080421.1 - E */
      ...
      do with frame b:
         ...
         */
         ...
         if summary_only = no then do:
            ...
            */
            CREATE ttssapvorp0102.
            ASSIGN
               ttssapvorp0102_ap_vend = ap_vend
               ttssapvorp0102_name = NAME
               ttssapvorp0102_ad_attn = ad_attn
               ttssapvorp0102_ad_phone = ad_phone
               ttssapvorp0102_ad_ext = ad_ext

               ttssapvorp0102_ap_ref = ap_ref
               ttssapvorp0102_vo_invoice = vo_invoice

               ttssapvorp0102_vo_cr_terms = vo_cr_terms
               .
            if multi-due = no THEN DO:
                ASSIGN
                    ttssapvorp0102_vo_due_date = vo_due_date
                    .
            END.
            /* SS - 20080421.1 - E */
         end.
         ...
         */
         ...
         if summary_only = no then do:
            ...
            */
            ASSIGN
               ttssapvorp0102_et_age_amt[1] = et_age_amt[1]
               ttssapvorp0102_et_age_amt[2] = et_age_amt[2]
               ttssapvorp0102_et_age_amt[3] = et_age_amt[3]
               ttssapvorp0102_et_age_amt[4] = et_age_amt[4]
               ttssapvorp0102_et_age_amt[5] = et_age_amt[5]
               ttssapvorp0102_et_age_amt[6] = et_age_amt[6]
               ttssapvorp0102_et_vo_tot = et_vo_tot

               ttssapvorp0102_hold = hold

               ttssapvorp0102_ap_ex_rate = ap_ex_rate
               ttssapvorp0102_ap_ex_rate2 = ap_ex_rate2
               ttssapvorp0102_ap_curr = ap_curr

               ttssapvorp0102_ap_acct = ap_acct
               ttssapvorp0102_ap_sub = ap_sub
               ttssapvorp0102_ap_cc = ap_cc
               ttssapvorp0102_ap_disc_acct = ap_disc_acct
               ttssapvorp0102_ap_disc_sub = ap_disc_sub
               ttssapvorp0102_ap_disc_cc = ap_disc_cc
               .
            /* SS - 20080421.1 - E */
         end.
