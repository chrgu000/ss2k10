...
/* Revision: 1.35  BY: Geeta Kotian       DATE: 08/30/05 ECO: *P3ZX* */
/* $Revision: 1.36 $    BY: Swati Sharma       DATE: 12/28/05 ECO: *P4D7* */
/* $Revision: 1.36 $    BY: Bill Jiang       DATE: 04/21/08 ECO: *SS - 20080421.1* */
/*-Revision end---------------------------------------------------------------*/
...
form
   ...
   base_rpt       colon 24
   et_report_curr colon 24
   /* SS - 20080421.1 - B */
   /*
   l_show_zero    colon 40 skip(1)
   */
   l_show_zero    colon 40 skip(0)
   /* SS - 20080421.1 - E */
...
repeat:
   ...
   */
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    EMPTY TEMP-TABLE ttssapvorp0102.

    {gprun.i ""ssapvorp0102.p"" "(
       INPUT vend,
       INPUT vend1,
       INPUT vdtype,
       INPUT vdtype1,
    ...
    EXPORT DELIMITER ";" "ap_vend" "name" "ad_attn" "ad_phone" "ad_ext" "ap_ref" "vo_invoice" "vo_cr_terms" "vo_due_date" "et_age_amt1" "et_age_amt2" "et_age_amt3" "et_age_amt4"  "et_age_amt5"  "et_age_amt6" "et_vo_tot" "hold" "ap_ex_rate" "ap_ex_rate2" "ap_curr" "ap_acct" "ap_sub" "ap_cc" "ap_disc_acct" "ap_disc_acct" "ap_disc_cc".
    FOR EACH ttssapvorp0102:
        EXPORT DELIMITER ";" ttssapvorp0102.
    END.
