...
/* $Revision: 1.10.1.21 $  BY: Bill Jiang DATE: 04/23/08 ECO: *SS - 20080423.1*   */
/*-Revision end---------------------------------------------------------------*/
   ...
   do with frame d down:
      ...
      >= batch and
         ...
         */
         ...
         down 1 with frame d.
         */
         CREATE ttssarparp0101.
         ASSIGN
            ttssarparp0101_batch = ar_batch
            ttssarparp0101_nbr = ar_nbr
            ttssarparp0101_bill = ar_bill
            ttssarparp0101_name = NAME
            ttssarparp0101_type = ar_type
            ttssarparp0101_check = ar_check
            ttssarparp0101_base_amt = base_amt
            ttssarparp0101_date = ar_date
            ttssarparp0101_effdate = ar_effdate
            ttssarparp0101_entity = ar_entity
            ttssarparp0101_acct = ar_acct
            ttssarparp0101_sub = ar_sub
            ttssarparp0101_cc = ar_cc
            ttssarparp0101_po = ar_po
            .
         /* SS - 20080423.1 - E */
