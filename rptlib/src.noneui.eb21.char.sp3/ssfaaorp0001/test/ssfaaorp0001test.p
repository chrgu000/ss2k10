...
/* $Revision: 1.10.1.8 $    BY: Bill Jiang          DATE: 04/23/08  ECO: *SS - 20080423.1*  */
/******************************************************************************/
...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssfaaorp0001.
   
   {gprun.i ""ssfaaorp0001.p""
      "(input l-loc,
        input l-loc1,
        input l-asset,
        input l-asset1,
   ...
   EXPORT DELIMITER ";" "fa_faloc_id" "fa_id" "fa_desc1" "fa_facls_id" "fabk_id" "costAmt" "accDepr" "netBook" "annDepr"
      "fa_puramt"
      .
   FOR EACH ttssfaaorp0001:
      EXPORT DELIMITER ";" ttssfaaorp0001.
   END.
