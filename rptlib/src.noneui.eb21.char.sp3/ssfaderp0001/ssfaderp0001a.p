...
/* $Revision: 1.10.1.19 $ BY: Bill Jiang DATE: 04/23/08 ECO: *SS - 20080423.1* */
/*-Revision end---------------------------------------------------------------*/
...
for each fabd_det
   ...
   */
   ...
   first fa_mstr
      /* SS - 20080423.1 - B */
      /*
      fields( fa_domain fa_id fa_desc1 fa_dep fa_puramt)
      */
      /* SS - 20080423.1 - E */
   ...
   */
   ...
   then do:
      ...
      then do with frame f-2:
         ...
         */
         CREATE ttssfaderp0001.
         ASSIGN
            ttssfaderp0001_fabd_entity = fabd_entity
            ttssfaderp0001_fabd_fabk_id = fabd_fabk_id
            ttssfaderp0001_fabd_facls_id = fabd_facls_id
            ttssfaderp0001_fabd_fa_id = fabd_det.fabd_fa_id
            ttssfaderp0001_fa_desc1 = fa_mstr.fa_desc1
            ttssfaderp0001_costAmt = costAmt
            ttssfaderp0001_accDepr = accDepr
            ttssfaderp0001_expAmt = expAmt
            ttssfaderp0001_netBook = netBook
            ttssfaderp0001_annDepr = annDepr
            ttssfaderp0001_fa_puramt = fa_mstr.fa_puramt
            .
         /* SS - 20080423.1 - E */
