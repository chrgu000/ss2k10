...
/* $Revision: 1.9.1.8 $    BY: Bill Jiang          DATE: 04/23/08  ECO: *SS - 20080423.1*  */
/******************************************************************************/
...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssfaderp0001.

   {gprun.i ""ssfaderp0001.p""
      "(input l-entity,
        input l-entity1,
        input l-book,
        input l-book1,
   ...
   EXPORT DELIMITER ";" "fabd_entity" "fabd_fabk_id" "fabd_facls_id" "fabd_fa_id" "fa_desc1" "costAmt" "accDepr" "expAmt" "netBook" "annDepr"
   	"fa_puramt"
   	.
   FOR EACH ttssfaderp0001:
       EXPORT DELIMITER ";" ttssfaderp0001.
   END.
