...
/* $Revision: 1.9.1.38 $ BY: Bill Jiang    DATE: 04/25/08 ECO: *SS - 20080425.1*    */
/*-Revision end---------------------------------------------------------------*/
            ...
            */
            ...
            then do:
               ...
               then do:
                  ...
                  down.
                  */
                  CREATE ttssppptrp0701.
                  ASSIGN
                     ttssppptrp0701_site = in_site
                     ttssppptrp0701_loc = t_lddet_loc

                     ttssppptrp0701_part = t_lddet_part
                     ttssppptrp0701_lot = t_lddet_lot
                     ttssppptrp0701_desc = t_sct_desc1 + " " + t_sct_desc2
                     ttssppptrp0701_abc = t_sct_abc
                     ttssppptrp0701_qty = total_qty_oh
                     ttssppptrp0701_um = t_sct_um
                     ttssppptrp0701_sct = t_sct_std_as_of
                     ttssppptrp0701_ext = ptloc_ext_std
                     .
                  /* SS - 20080425.1 - E */
                  ...
                  */
                  ...
                  then do:
                     ...
                     then do:
                        ASSIGN
                           ttssppptrp0701_qty_non_consign = l_non_consign_qoh
                           .
                     end. /* IF l_non_consign_qoh <> 0 */
                     ...
                     then do:
                        ASSIGN
                        ttssppptrp0701_qty_cust_consign = tot_cust_consign_qty
                        .
                     end.  /* IF tot_cust_consign_qty <> 0 */
                     ...
                     then do:
                        ASSIGN
                        ttssppptrp0701_qty_supp_consign = tot_supp_consign_qty
                        .
                     end.  /* IF tot_supp_consign_qty <> 0 */
                  end. /* IF tot_cust_consign_qty <> 0 ...*/
                  /* SS - 20080425.1 - E */
