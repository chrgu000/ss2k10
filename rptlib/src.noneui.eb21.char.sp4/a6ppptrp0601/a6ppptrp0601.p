...
/* $Revision: 1.8.1.24 $   BY: Bill Jiang      DATE: 04/15/07 ECO: *SS - 20070415.1* */
         ...
         do on error undo, leave:
            ...
            if  (inc_zero_qty or total_qty_oh <> 0)
               ...
               */
               ...
               ASSIGN
                  tta6ppptrp0601_pt_part = pt_part
                  tta6ppptrp0601_pt_desc1 = pt_desc1
                  tta6ppptrp0601_in_site = IN_site
                  tta6ppptrp0601_in_abc = IN_abc
                  tta6ppptrp0601_total_qty_oh = TOTAL_qty_oh
                  tta6ppptrp0601_pt_um = pt_um
                  tta6ppptrp0601_std_as_of = std_as_of
                  tta6ppptrp0601_ext_std = ext_std
                  .

               if pt_desc2 <> "" then
                  ASSIGN tta6ppptrp0601_pt_desc2 = pt_desc2.
               ...
               then do with frame b:
                  ASSIGN
                     tta6ppptrp0601_non_consign_qoh = non_consign_qoh
                     .
                  ...
                  then do:
                     ASSIGN
                        tta6ppptrp0601_cust_consign_qty = tot_cust_consign_qty
                        .
                  end.  /* IF tot_cust_consign_qty <> 0 */
                  ...
                  then do:
                     ASSIGN
                        tta6ppptrp0601_supp_consign_qty = tot_supp_consign_qty
                        .
                  end.  /* IF tot_supp_consign_qty <> 0 */
