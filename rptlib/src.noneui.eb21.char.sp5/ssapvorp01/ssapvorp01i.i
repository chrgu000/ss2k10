...
/* $Revision: 1.41.1.1 $ BY:Bill Jiang            DATE: 08/26/07     ECO: *SS - 20070826.1* */
/* $Revision: 1.41.1.1 $ BY:Bill Jiang            DATE: 07/17/08     ECO: *SS - 20080717.1* */
/*-Revision end---------------------------------------------------------------*/
...
纳税类型                 纳税                     纳税  税                 纳税      税            应纳税         非应纳税
说明                     说明                     类别  用途               金额      率              销售         销售金额
------------------------ ------------------------ ----- -------- -------------- -------- ---------------- ----------------
增值税                   国内采购17%增值税发票    G01   P17           23,608.75   17.00%       138,875.00             0.00
*/
/* SS - 20080717.1 - E */
      ...
      */
      ...
      if summary = no then do:
         ...
         */
         ...
         ASSIGN
            /* Line 1 */
            ttssapvorp01_vo_ref = vo_ref
            ttssapvorp01_ap_date = ap_date
            ttssapvorp01_vd_remit = vd_remit
            ttssapvorp01_ap_curr = ap_curr
            /* Line 2 */
            ttssapvorp01_vopo = vopo
            ttssapvorp01_ap_effdate = ap_effdate
            ttssapvorp01_vo_ship = vo_ship
            ttssapvorp01_curr_disp_line1 = curr_disp_line1
            ttssapvorp01_ap_acct = ap_acct
            ttssapvorp01_ap_sub = ap_sub
            ttssapvorp01_ap_cc = ap_cc
            /* Line 2a if needed */
            ttssapvorp01_curr_disp_line2 = curr_disp_line2
            /* CURR_DISP_LINE2 LINES-UP WITH CURR_DISP_LINE1 */
            /* Line 3 */
            ttssapvorp01_ap_vend = ap_vend
            ttssapvorp01_vo_due_date = vo_due_date
            ttssapvorp01_vo_invoice = vo_invoice
            ttssapvorp01_ap_bank = ap_bank
            /* Line 4 */
            ttssapvorp01_name = name
            ttssapvorp01_vo_disc_date = vo_disc_date
            ttssapvorp01_ap_entity = ap_entity
            ttssapvorp01_vo_type = vo_type
            ttssapvorp01_flag = flag
            /* Line 5 */
            ttssapvorp01_ap_rmk = ap_rmk 
            ttssapvorp01_ap_ckfrm = ap_ckfrm
            ttssapvorp01_vo_confirmed = vo_confirmed
            ttssapvorp01_vo_conf_by = vo_conf_by
            /* Line 6 */
            ttssapvorp01_vo_is_ers = vo_is_ers
            ttssapvorp01_remit_label = remit_label
            ttssapvorp01_remit_name = remit_name
            ttssapvorp01_ap_batch = ap_batch
            .
         ...
         then do:
            disp_curr = "".
            ASSIGN
               ttssapvorp01_disp_curr = DISP_curr
               ttssapvorp01_ap_amt = ap_amt
               ttssapvorp01_vo_ndisc_amt = vo_ndisc_amt
               ttssapvorp01_vo_applied = vo_applied
               ttssapvorp01_vo_hold_amt = vo_hold_amt
               .
         end.
         /*If base is selected, then amounts shown will be in base. */
         else DO:
            ASSIGN
               ttssapvorp01_disp_curr = DISP_curr
               ttssapvorp01_ap_amt = base_amt
               ttssapvorp01_vo_ndisc_amt = base_ndamt
               ttssapvorp01_vo_applied = base_applied
               ttssapvorp01_vo_hold_amt = base_hold_amt
               .
         END.

         ASSIGN
            ttssapvorp01_vod_ln = vod_ln
            ttssapvorp01_vod_acc = vod_acct
            ttssapvorp01_vod_sub = vod_sub
            ttssapvorp01_vod_cc = vod_cc
            ttssapvorp01_vod_project = vod_project
            ttssapvorp01_vod_entity = vod_entity
            ttssapvorp01_vod_desc = vod_desc
            .
         if base_rpt = "" and mixed_rpt then DO:
            ASSIGN 
               ttssapvorp01_vod_amt = vod_amt
               .
         END.
         else DO:
            assign
               ttssapvorp01_vod_amt = base_damt
               .
         END.
      /* SS - 20070826.1 - E */
      end.
