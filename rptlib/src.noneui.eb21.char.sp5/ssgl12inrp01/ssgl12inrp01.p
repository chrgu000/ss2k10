...
/* $Revision: 1.25 $ BY: Bill Jiang DATE: 08/16/07 ECO: *SS - 20070816.1* */
/*-Revision end---------------------------------------------------------------*/
...
define input parameter begdt05 as date.
define input parameter begdt06 as date.
define input parameter begdt07 as date.
define input parameter begdt08 as date.
define input parameter begdt09 as date.
define input parameter begdt10 as date.
define input parameter begdt11 as date.
define input parameter begdt12 as date.
...
define input parameter enddt05 as date.
define input parameter enddt06 as date.
define input parameter enddt07 as date.
define input parameter enddt08 as date.
define input parameter enddt09 as date.
define input parameter enddt10 as date.
define input parameter enddt11 as date.
define input parameter enddt12 as date.
...
define new shared variable incpct   like mfc_logical extent 12 no-undo
                                    /*V8! view-as fill-in size 3.5 by 1 */ .
define new shared variable zeroflag like mfc_logical initial 
   /* SS - 20070816.1 - B */
   /*
   no
   */
...
/* SS - 20070816.1 - E */
  ...
  */
   ...
   */
   /* CALCULATE TOTAL AMOUNT OF INCOME FOR COLUMNS */
   {gprun.i ""ssgl12inrp01a.p""}

   /* CALL SUBPROGRAM TO CALCULATE AND PRINT REPORT */
   {gprun.i ""ssgl12inrp01b.p""}
   /* SS - 20070816.1 - E */
