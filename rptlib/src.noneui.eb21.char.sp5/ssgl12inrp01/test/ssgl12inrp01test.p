...
year1 = YEAR(TODAY).
DO i1 = 1 TO 12:
   begdt[i1] = DATE(i1,1,year1).
   IF i1 <> 12 THEN DO:
      enddt[i1] = DATE(i1 + 1,1,year1) - 1.
   END.
   ELSE DO:
      enddt[i1] = DATE(1,1,year1 + 1) - 1.
   END.
END.
/* SS - 20070816.1 - E */
...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttssgl12inrp01.

   {gprun.i ""ssgl12inrp01.p"" "(
      INPUT entity,
      INPUT entity1,
      input begdt[1],
      input begdt[2],
   ...
   EXPORT DELIMITER ";" "ac_code" "amt[1]" "amt[2]" "amt[3]" "amt[4]" "amt[5]" "amt[6]" "amt[7]" "amt[8]" "amt[9]" "amt[10]" "amt[11]" "amt[12]".
   FOR EACH ttssgl12inrp01:
       EXPORT DELIMITER ";" ttssgl12inrp01.
   END.
