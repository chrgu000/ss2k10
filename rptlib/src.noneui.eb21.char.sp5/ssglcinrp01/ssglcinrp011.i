...
/* REVISION: 9.1      LAST MODIFIED: 08/16/07   BY: *SS - 20070816.1* Bill Jiang       */
/***************************************************************************/
/*!
...
/*L0B6*/           put string(et_variance, vprtfmt) format "x(20)" at 112.
          ...
          */
          /* DISPLAY ACCOUNT AND AMOUNTS */
          CREATE ttssglcinrp01.
          ASSIGN ttssglcinrp01_ac_code = xacc.
...
/*J3P3*/           not fmbgflag[1]
/*J3P3*/        then
   ASSIGN ttssglcinrp01_et_balance[1] = et_balance1[1].

/*J3P3**        if not budget[2] or not fmbgflag then       */
/*J3P3*/        if not budget[2]   or
/*J3P3*/           not fmbgflag[2]
/*J3P3*/        then
   ASSIGN ttssglcinrp01_et_balance[2] = et_balance1[2].
...
/*J3P3*/           not fmbgflag[1]
/*J3P3*/        then
   ASSIGN ttssglcinrp01_et_balance[1] = et_balance[1].

/*J3P3**        if not budget[2] or not fmbgflag then  */
/*J3P3*/        if not budget[2]   or
/*J3P3*/           not fmbgflag[2]
/*J3P3*/        then
   ASSIGN ttssglcinrp01_et_balance[2] = et_balance[2].
             end.  /* else do */
          end.  /* else do */
          /* SS - 20070816.1 - E */
