...
define input parameter i_ref               like glt_ref     .
define input parameter i_ref1              like glt_ref     .
define input parameter i_dt                like glt_date    .
define input parameter i_dt1               like glt_date    .
define input parameter i_effdt             like glt_effdate .
define input parameter i_effdt1            like glt_effdate .
define input parameter i_btch              like glt_batch   .
define input parameter i_type              like glt_tr_type .
define input parameter i_unb               like glt_unb  .
...
/* SS - 20070830.1 - E */
   ...
   */
   ...
   for each glt_det  where glt_det.glt_domain = global_domain and (
      ...
      */
      CREATE ttssglutrrp01.
      ASSIGN
         ttssglutrrp01_glt_ref =  glt_det.glt_ref
         ttssglutrrp01_glt_date = glt_det.glt_date
         ttssglutrrp01_glt_effdate = glt_det.glt_effdate
         ttssglutrrp01_glt_userid = glt_det.glt_userid

         ttssglutrrp01_glt_line = glt_det.glt_line
         ttssglutrrp01_glt_acct = glt_det.glt_acc
         ttssglutrrp01_glt_sub = glt_det.glt_sub
         ttssglutrrp01_glt_cc = glt_det.glt_cc
         ttssglutrrp01_glt_project = glt_det.glt_project
         ttssglutrrp01_glt_entity = glt_det.glt_entity
         ttssglutrrp01_glt_desc = glt_det.glt_desc
         ttssglutrrp01_glt_curr = glt_det.glt_curr
         ttssglutrrp01_glt_dy_code = glt_det.glt_dy_code

         ttssglutrrp01_glt_dy_num = glt_det.glt_dy_num

         ttssglutrrp01_glt_error = glt_det.glt_error

         ttssglutrrp01_glt_unb = glt_det.glt_unb

         ttssglutrrp01_glt_correction = glt_det.glt_correction
         ttssglutrrp01_glt_ex_rate = glt_det.glt_ex_rate 
         ttssglutrrp01_glt_ex_rate2 = glt_det.glt_ex_rate2 
         .

      if glt_det.glt_curr <> base_curr then DO:
         ASSIGN
            ttssglutrrp01_glt_curr_amt = glt_det.glt_curr_amt
            .
      END.
      ELSE DO:
         ASSIGN
            ttssglutrrp01_glt_curr_amt = glt_det.glt_amt
            .
      END.
      /* SS - 20070830.1 - E */
