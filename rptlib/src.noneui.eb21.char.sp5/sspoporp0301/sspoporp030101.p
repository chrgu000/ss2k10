...
/* $Revision: 1.11.2.14 $   BY: Bill Jiang      DATE: 04/11/08 ECO: *SS - 20080411.1* */
/*-Revision end---------------------------------------------------------------*/
...
nbr) and (po_nbr <= nbr1)
   ...
   do transaction on error undo, leave on endkey undo, leave:
      ...
      */
      if sort_by_site then do:
         {gprun.i ""sspoporp0301a01.p"" "(input update_yn)"}
      end.
      else do:
         {gprun.i ""sspoporp0301b01.p"" "(input update_yn)"}
      end.
      /* SS - 20080411.1 - E */
