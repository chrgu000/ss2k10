...
/* $Revision: 1.16 $     BY: Bill Jiang       DATE: 03/07/08  ECO: *SS - 20070307.1*   */
      ...
      */
      ...
      if pc_part <> "" then do:
         ...
         if available pt_mstr then DO: 
            ASSIGN
               ttsspppcrp0001_desc1 = pt_desc1
               ttsspppcrp0001_desc2 = pt_desc2
               ttsspppcrp0001_pt_price = pt_price
               .
         END.
      ...
      ASSIGN
         ttsspppcrp0001_list = pc_list
         ttsspppcrp0001_curr = pc_curr
         ttsspppcrp0001_prod_line = pc_prod_line
         ttsspppcrp0001_part = pc_part
         ttsspppcrp0001_um = pc_um
         ttsspppcrp0001_start = pc_start
         ttsspppcrp0001_expire = pc_expire
         ttsspppcrp0001_amt_type = pc_amt_type
         ttsspppcrp0001_glxcst = glxcst
         .
      ...
      if pc_amt_type = "L" then do:
         ...
         ASSIGN
            ttsspppcrp0001_amt[01] = pc_amt[01]
            ttsspppcrp0001_min_price = pc_min_price
            ttsspppcrp0001_max_price = temp_max_price
            .
      end.
      else do:
         ASSIGN
            ttsspppcrp0001_min_qty[01] = pc_min_qty[01]
            ttsspppcrp0001_min_qty[02] = pc_min_qty[02]
            ttsspppcrp0001_min_qty[03] = pc_min_qty[03]
            ttsspppcrp0001_min_qty[04] = pc_min_qty[04]
            ttsspppcrp0001_min_qty[05] = pc_min_qty[05]
            ttsspppcrp0001_min_qty[06] = pc_min_qty[06]
            ttsspppcrp0001_min_qty[07] = pc_min_qty[07]
            ttsspppcrp0001_min_qty[08] = pc_min_qty[08]
            ttsspppcrp0001_min_qty[09] = pc_min_qty[09]
            ttsspppcrp0001_min_qty[10] = pc_min_qty[10]
            ttsspppcrp0001_min_qty[11] = pc_min_qty[11]
            ttsspppcrp0001_min_qty[12] = pc_min_qty[12]
            ttsspppcrp0001_min_qty[13] = pc_min_qty[13]
            ttsspppcrp0001_min_qty[14] = pc_min_qty[14]
            ttsspppcrp0001_min_qty[15] = pc_min_qty[15]
            ttsspppcrp0001_amt[01] = pc_amt[01]
            ttsspppcrp0001_amt[02] = pc_amt[02]
            ttsspppcrp0001_amt[03] = pc_amt[03]
            ttsspppcrp0001_amt[04] = pc_amt[04]
            ttsspppcrp0001_amt[05] = pc_amt[05]
            ttsspppcrp0001_amt[06] = pc_amt[06]
            ttsspppcrp0001_amt[07] = pc_amt[07]
            ttsspppcrp0001_amt[08] = pc_amt[08]
            ttsspppcrp0001_amt[09] = pc_amt[09]
            ttsspppcrp0001_amt[10] = pc_amt[10]
            ttsspppcrp0001_amt[11] = pc_amt[11]
            ttsspppcrp0001_amt[12] = pc_amt[12]
            ttsspppcrp0001_amt[13] = pc_amt[13]
            ttsspppcrp0001_amt[14] = pc_amt[14]
            ttsspppcrp0001_amt[15] = pc_amt[15]
            .
      end.
