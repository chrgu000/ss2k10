...
/* $Revision: 1.47.1.5 $       BY: Bill Jiang              DATE: 03/10/08   ECO: *SS - 20080310.1*  */
/*-Revision end---------------------------------------------------------------*/
/******************************************************************************/
   ...
   */
   ...
   idh_inv_nbr = ih_inv_nbr
      ...
      */
      ...
      /* SS - 20080310.1 - B */
      CREATE ttsssoivrp0901.

      ASSIGN
         ttsssoivrp0901_ih_inv_nbr = ih_inv_nbr
         ttsssoivrp0901_ih_rev = ih_rev
         ttsssoivrp0901_ih_cust = ih_cust
         ttsssoivrp0901_name = NAME
         ttsssoivrp0901_ih_po = ih_po
         ttsssoivrp0901_ih_ship =ih_ship
         ttsssoivrp0901_ih_ship_date = ih_ship_date
         ttsssoivrp0901_inv_date = ih_inv_date
         ttsssoivrp0901_ih_slspsn[1] = ih_slspsn[1]
         ttsssoivrp0901_ih_slspsn[2] = ih_slspsn[2]
         ttsssoivrp0901_ih_slspsn[3] = ih_slspsn[3]
         ttsssoivrp0901_ih_slspsn[4] = ih_slspsn[4]
         ttsssoivrp0901_ih_curr = ih_curr
         ttsssoivrp0901_base_curr = base_curr
         ttsssoivrp0901_ih_ex_rate = ih_ex_rate
         ttsssoivrp0901_ih_ex_rate2 = ih_ex_rate2
         ttsssoivrp0901_ih_exru_seq = ih_exru_seq
         ttsssoivrp0901_v_disp_line1 = v_disp_line1
         ttsssoivrp0901_v_disp_line2 = v_disp_line2
         ttsssoivrp0901_ih_rmks = ih_rmks
         .

      ASSIGN
         ttsssoivrp0901_idh_nbr = idh_nbr
         ttsssoivrp0901_idh_line = idh_line
         ttsssoivrp0901_idh_part = idh_part
         ttsssoivrp0901_idh_um = idh_um
         .

      IF ih_fsm_type = "FSM-RO" THEN DO:
         ASSIGN
            ttsssoivrp0901_idh_qty_ord = l_qty_call
            ttsssoivrp0901_idh_qty_inv = l_qty_call
            .
      END.
      ELSE DO:
         ASSIGN
            ttsssoivrp0901_idh_qty_ord = idh_qty_ord
            ttsssoivrp0901_idh_qty_inv = idh_qty_inv
            .
      END.
      ...
      then do:
         IF ih_fsm_type <> "FSM-RO" THEN DO:
            IF idh_qty_ord >= 0 THEN DO:
               ASSIGN
                  ttsssoivrp0901_idh_bo_chg = max(idh_qty_ord - idh_qty_ship, 0)
                  .
            END.
            ELSE DO:
               ASSIGN
                  ttsssoivrp0901_idh_bo_chg = MIN(idh_qty_ord - idh_qty_ship, 0)
                  .
            END.
         END.
         ELSE DO:
            ASSIGN
               ttsssoivrp0901_idh_bo_chg = ttsssoivrp0901_idh_bo_chg
               .
         END.
      END.
      ELSE DO:
         ASSIGN
            ttsssoivrp0901_idh_bo_chg = l_idh_bo_chg
            .
      END.

      ASSIGN
         ttsssoivrp0901_disp_curr = DISP_curr
         ttsssoivrp0901_base_net_price = base_net_price
         ttsssoivrp0901_base_price = base_price
         ttsssoivrp0901_base_margin = base_margin
         ttsssoivrp0901_idh_due_date = idh_due_date
         ttsssoivrp0901_idh_type = idh_type
         .

      ASSIGN
         ttsssoivrp0901_ih_channel = ih_channel
         ttsssoivrp0901_ih_project = ih_project

         ttsssoivrp0901_idh_site = idh_site
         ttsssoivrp0901_idh_prodline = idh_prodline
         ttsssoivrp0901_idh_taxc = idh_taxc
         ttsssoivrp0901_idh_taxable = idh_taxable
         ttsssoivrp0901_idh_tax_in = idh_tax_in
         ttsssoivrp0901_idh_acct = idh_acct
         ttsssoivrp0901_idh_sub = idh_sub
         ttsssoivrp0901_idh_cc = idh_cc
         ttsssoivrp0901_idh_project = idh_project
         
         ttsssoivrp0901_ar_effdate = ar_effdate

         ttsssoivrp0901_ext_price = ext_price
         ttsssoivrp0901_ext_margin = ext_gr_margin
         ttsssoivrp0901_ext_tax = tax_amt + l_tax_in
         ttsssoivrp0901_base_tax = tax_amt + l_tax_in
         .
      /* SS - 20080310.1 - E */
