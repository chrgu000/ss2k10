...
define input parameter i_ord             like so_ord_date                         .
define input parameter i_ord1            like so_ord_date                         .
define input parameter i_spsn            like sp_addr                             .
define input parameter i_spsn1           like sp_addr                                .
define input parameter i_base_rpt        like so_curr                             .
define input parameter i_mixed_rpt       like mfc_logical.
define input parameter i_include_shipped like mfc_logical.
define input parameter i_include_unconf  like mfc_logical.
/* SS - 20070813.1 - E */
...
include_shipped = i_include_shipped.
include_unconf = i_include_unconf.
/* SS - 20070813.1 - E */
            ...
            */
            ...
            with frame c width 132:
               ...
               then do:
                  ...
                  */
                  CREATE ttsssosorp0801.
                  ASSIGN
                     ttsssosorp0801_so_nbr = so_nbr
                     ttsssosorp0801_so_cust = so_cust
                     ttsssosorp0801_name = NAME
                     ttsssosorp0801_so_ship = so_ship
                     ttsssosorp0801_so_ord_date = so_ord_date
                     ttsssosorp0801_so_stat = so_stat
                     ttsssosorp0801_so_slspsn[1] = so_slspsn[1]
                     ttsssosorp0801_so_slspsn[2] = so_slspsn[2]
                     ttsssosorp0801_so_slspsn[3] = so_slspsn[3]
                     ttsssosorp0801_so_slspsn[4] = so_slspsn[4]
                     ttsssosorp0801_so_curr = so_curr
                     ttsssosorp0801_v_disp_line1 = v_disp_line1
                     ttsssosorp0801_v_disp_line2 = v_disp_line2
                     ttsssosorp0801_so_rmks = so_rmks
                     .

                  ASSIGN
                     ttsssosorp0801_sod_line = sod_line
                     ttsssosorp0801_sod_part = sod_part
                     ttsssosorp0801_sod_um = sod_um
                     ttsssosorp0801_sod_qty_ord = sod_qty_ord
                     ttsssosorp0801_sod_qty_ship = sod_qty_ship
                     ttsssosorp0801_qty_open = qty_open
                     ttsssosorp0801_sod_confirm = sod_confirm
                     ttsssosorp0801_prt_curr = prt_curr
                     ttsssosorp0801_base_price = base_price
                     ttsssosorp0801_ext_price = ext_price
                     ttsssosorp0801_ext_gr_margin = ext_gr_margin
                     ttsssosorp0801_sod_due_date = sod_due_date
                     ttsssosorp0801_sod_type = sod_type
                     .

                  ASSIGN
                     ttsssosorp0801_so_ex_rate = so_ex_rate
                     ttsssosorp0801_so_ex_rate2 = so_ex_rate2
                     ttsssosorp0801_so_exru_seq = so_exru_seq
                     .
                  /* SS - 20070813.1 - E */
