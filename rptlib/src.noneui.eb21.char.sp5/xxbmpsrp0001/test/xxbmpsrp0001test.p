...
repeat:
   ...
   FOR EACH ttxxbmpsrp0001:
      DELETE ttxxbmpsrp0001.
   END.
   
   {gprun.i ""xxbmpsrp0001.p"" "(
      INPUT parent1,
      INPUT parent2,
      INPUT op,
      INPUT op1,
   ...
   EXPORT DELIMITER ";" "par" "lvl" "level" "comp" "ref" "desc1" "desc2" "qty_per" "um" "op" "phantom" "ps_code" "iss_pol" "start" "end" "lt_off" "scrp_pct" "rev" "rmks".
   FOR EACH ttxxbmpsrp0001:
      EXPORT DELIMITER ";" ttxxbmpsrp0001.
   END.
