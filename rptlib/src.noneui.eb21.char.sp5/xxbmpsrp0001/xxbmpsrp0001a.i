...
PROCEDURE process_report:
   ...
   repeat while available ps_mstr with frame det2 down:
      ...
      assign
         ...
         SS - 100517.1 - E */
         /* SS - 100517.1 - B */
         CREATE ttxxbmpsrp0001.
         ASSIGN
             ttxxbmpsrp0001_par = parent01
             ttxxbmpsrp0001_level = level

             ttxxbmpsrp0001_lvl = lvl
             ttxxbmpsrp0001_comp = ps_comp
             ttxxbmpsrp0001_ref = ps_ref
             ttxxbmpsrp0001_desc1 = desc1
             ttxxbmpsrp0001_qty_per = ps_qty_per
             ttxxbmpsrp0001_um = um
             ttxxbmpsrp0001_op = ps_op
             ttxxbmpsrp0001_phantom = phantom
             ttxxbmpsrp0001_ps_code = ps_ps_code
             ttxxbmpsrp0001_iss_pol = iss_pol
             ttxxbmpsrp0001_start = ps_start
             ttxxbmpsrp0001_end = ps_end
             ttxxbmpsrp0001_lt_off = ps_lt_off
             ttxxbmpsrp0001_scrp_pct = ps_scrp_pct
             .
         if available pt_mstr and pt_desc2 > "" then do :
             ASSIGN
                 ttxxbmpsrp0001_desc2 = pt_desc2
                 .
         end.  /* IF AVAILABLE pt_mstr ... */
         if available pt_mstr and pt_rev <> "" then do :
             ASSIGN
                 ttxxbmpsrp0001_rev = pt_rev
                 .
         end. /* IF AVAILABLE pt_mstr ... */
         if length(ps_rmks) <> 0 then do :
             ASSIGN
                 ttxxbmpsrp0001_rmks = ps_rmks
                 .
         end. /* IF LENGTH(ps_rmks) <> 0 */
         /* SS - 100517.1 - E */
