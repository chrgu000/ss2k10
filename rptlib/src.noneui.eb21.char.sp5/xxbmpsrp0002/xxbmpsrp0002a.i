...
PROCEDURE process_report:
   ...
   repeat while available ps_mstr with frame det2 down:
      ...
      assign
         ...
         SS - 100811.1 - E */
         /* SS - 100811.1 - B */
         CREATE ttxxbmpsrp0002.
         ASSIGN
             ttxxbmpsrp0002_par = parent01
             ttxxbmpsrp0002_level = level

             ttxxbmpsrp0002_lvl = lvl
             ttxxbmpsrp0002_comp = ps_comp
             ttxxbmpsrp0002_ref = ps_ref
             ttxxbmpsrp0002_desc1 = desc1
             ttxxbmpsrp0002_qty_per = ps_qty_per
             ttxxbmpsrp0002_um = um
             ttxxbmpsrp0002_op = ps_op
             ttxxbmpsrp0002_phantom = phantom
             ttxxbmpsrp0002_ps_code = ps_ps_code
             ttxxbmpsrp0002_iss_pol = iss_pol
             ttxxbmpsrp0002_start = ps_start
             ttxxbmpsrp0002_end = ps_end
             ttxxbmpsrp0002_lt_off = ps_lt_off
             ttxxbmpsrp0002_scrp_pct = ps_scrp_pct
             .
         if available pt_mstr and pt_desc2 > "" then do :
             ASSIGN
                 ttxxbmpsrp0002_desc2 = pt_desc2
                 .
         end.  /* IF AVAILABLE pt_mstr ... */
         if available pt_mstr and pt_rev <> "" then do :
             ASSIGN
                 ttxxbmpsrp0002_rev = pt_rev
                 .
         end. /* IF AVAILABLE pt_mstr ... */
         if length(ps_rmks) <> 0 then do :
             ASSIGN
                 ttxxbmpsrp0002_rmks = ps_rmks
                 .
         end. /* IF LENGTH(ps_rmks) <> 0 */
         /* SS - 100811.1 - E */
