...
PROCEDURE process_report:
   ...
   /* SS - 100812.1 - B */
   define input parameter qty_per      like mfc_decimal no-undo.
   /* SS - 100812.1 - E */
   ...
   repeat while available ps_mstr with frame det2 down:
      ...
      assign
         ...
         SS - 100812.1 - E */
         /* SS - 100812.1 - B */
         CREATE ttxxbmpsrp0003.
         ASSIGN
             ttxxbmpsrp0003_par = parent01
             ttxxbmpsrp0003_level = level

             ttxxbmpsrp0003_lvl = lvl
             ttxxbmpsrp0003_comp = ps_comp
             ttxxbmpsrp0003_ref = ps_ref
             ttxxbmpsrp0003_desc1 = desc1
             ttxxbmpsrp0003_qty_per = ps_qty_per
            /* SS - 100812.1 - B */
            * qty_per
            /* SS - 100812.1 - E */
             ttxxbmpsrp0003_um = um
             ttxxbmpsrp0003_op = ps_op
             ttxxbmpsrp0003_phantom = phantom
             ttxxbmpsrp0003_ps_code = ps_ps_code
             ttxxbmpsrp0003_iss_pol = iss_pol
             ttxxbmpsrp0003_start = ps_start
             ttxxbmpsrp0003_end = ps_end
             ttxxbmpsrp0003_lt_off = ps_lt_off
             ttxxbmpsrp0003_scrp_pct = ps_scrp_pct
             .
         if available pt_mstr and pt_desc2 > "" then do :
             ASSIGN
                 ttxxbmpsrp0003_desc2 = pt_desc2
                 .
         end.  /* IF AVAILABLE pt_mstr ... */
         if available pt_mstr and pt_rev <> "" then do :
             ASSIGN
                 ttxxbmpsrp0003_rev = pt_rev
                 .
         end. /* IF AVAILABLE pt_mstr ... */
         if length(ps_rmks) <> 0 then do :
             ASSIGN
                 ttxxbmpsrp0003_rmks = ps_rmks
                 .
         end. /* IF LENGTH(ps_rmks) <> 0 */
         /* SS - 100812.1 - E */
