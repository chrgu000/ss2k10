...
顺序输出了以下字段:
  - 标准输出: 单位[fabd_entity]
  - 标准输出: 帐目[fabd_fabk_id]
  - 标准输出: 类[fabd_facls_id]
  - 标准输出: 资产[fabd_fa_id]
  - 标准输出: 说明[fa_desc1]
  - 标准输出: 成本[costAmt]
  - 标准输出: 以前累计折旧金额[accDepr]
  - 标准输出: 费用额[expAmt]
  - 标准输出: 净帐目值[netBook]
  - 标准输出: 年度折旧额[annDepr]
  - 扩展输出: 采购成本[fa_puramt]
...
repeat:
   ...
   EMPTY TEMP-TABLE ttxxfaderp0001.

   {gprun.i ""xxfaderp0001.p"" "(
      input l-entity,
      input l-entity1,
      input l-book,
      input l-book1,
   ...
   EXPORT DELIMITER ";" "单位" "帐目" "类" "资产" "说明" "成本" "以前累计折旧金额" "费用额" "净帐目值" "年度折旧额" "采购成本".
   EXPORT DELIMITER ";" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "扩展输出".
   EXPORT DELIMITER ";" "fabd_entity" "fabd_fabk_id" "fabd_facls_id" "fabd_fa_id" "fa_desc1" "costAmt" "accDepr" "expAmt" "netBook" "annDepr" "fa_puramt".
   FOR EACH ttxxfaderp0001:
       EXPORT DELIMITER ";" ttxxfaderp0001.
   END.
