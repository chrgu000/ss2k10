...
/* $Revision: 1.22 $ BY: Bill Jiang DATE: 03/28/07 ECO: *SS - 20070328.1* */
/*-Revision end---------------------------------------------------------------*/
           ...
           */
           PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
            ...
            {gprun.i ""xxglabrp0001.p"" "(
             ...
             EXPORT DELIMITER ";" "code" "desc" "et_beg_bal" "et_end_bal".
             FOR EACH ttxxglabrp0001:
                 EXPORT DELIMITER ";" ttxxglabrp0001_code ttxxglabrp0001_desc ttxxglabrp0001_et_beg_bal ttxxglabrp0001_et_end_bal.
             END.
