...
顺序输出了以下字段:
  - 标准输出: 总账参考号[glt_ref]
  - 标准输出: 输入日期[glt_date]
  - 标准输出: 用户ID[glt_userid]
  - 标准输出: 生效日期[glt_effdate]
  - 标准输出: 行[glt_line]
  - 标准输出: 账户[glt_acc]
  - 标准输出: 分账户[glt_sub]
  - 标准输出: 成本中心[glt_cc]
  - 标准输出: 项目[glt_project]
  - 标准输出: 会计单位[glt_entity]
  - 标准输出: 说明[glt_desc]
  - 标准输出: 金额[glt_amt]
  - 标准输出: 货币[glt_curr]
  - 标准输出: 日记账[glt_dy_code]
  - 标准输出: 错误[glt_error]
  - 标准输出: 日记账序号[glt_dy_num]
  - 标准输出: 不平衡[glt_unb]
...
repeat:
   ...
   FOR EACH ttxxglutrrp001:
       DELETE ttxxglutrrp001.
   END.
   ...
   EXPORT DELIMITER ";" "总账参考号" "输入日期" "用户ID" "生效日期" "行" "账户" "分账户" "成本中心" "项目" "会计单位" "说明" "金额" "货币" "日记账" "错误" "日记账序号" "不平衡".
   EXPORT DELIMITER ";" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出".
   EXPORT DELIMITER ";" "glt_ref" "glt_date" "glt_userid" "glt_effdate" "glt_line" "glt_acc" "glt_sub" "glt_cc" "glt_project" "glt_entity" "glt_desc" "glt_amt" "glt_curr" "glt_dy_code" "glt_error" "glt_dy_num" "glt_unb".
   FOR EACH ttxxglutrrp001:
      EXPORT DELIMITER ";" ttxxglutrrp001.
   END.
