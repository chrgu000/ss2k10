...
with frame {&frame1} width 132 no-attr-space no-box:
   ...
   if first-of(po_nbr) then do for ship-to:
      ...
      /*  SS - 090225.1 - B  */
      {gprun.i ""xxpoporp0001b.p"" "(input po_nbr)"}.
      /*  SS - 090225.1 - E */
  ...
  /* SS - 090225.1 - B
   ...
   if last(po_nbr) then do:
     ...
     SS - 090225.1 - E */
      ...
      /* 写入临时表 */
      /*
      CREATE ttxxpoporp0001.
      */
   FIND FIRST ttxxpoporp0001a NO-LOCK NO-ERROR.
   IF AVAILABLE ttxxpoporp0001a THEN DO:
       CREATE ttxxpoporp0001.
       BUFFER-COPY ttxxpoporp0001a TO ttxxpoporp0001.
       ASSIGN
     ttxxpoporp0001.ttxxpoporp0001_pod_line = pod_line
     ttxxpoporp0001.ttxxpoporp0001_pod_req_nbr = pod_req_nbr
     ttxxpoporp0001.ttxxpoporp0001_pod_part = pod_part
     ttxxpoporp0001.ttxxpoporp0001_desc1 = desc1
     ttxxpoporp0001.ttxxpoporp0001_desc2 = desc2
     ttxxpoporp0001.ttxxpoporp0001_pod_um = pod_um
     ttxxpoporp0001.ttxxpoporp0001_pod_rev = pod_rev
     ttxxpoporp0001.ttxxpoporp0001_pod_ers_opt = pod_ers_opt
     ttxxpoporp0001.ttxxpoporp0001_pod_pr_lst_tp = pod_pr_lst_tp
     ttxxpoporp0001.ttxxpoporp0001_pod_vpart = pod_vpart
     ttxxpoporp0001.ttxxpoporp0001_pod_qty_ord = pod_qty_ord
     ttxxpoporp0001.ttxxpoporp0001_qty_open = qty_open
     ttxxpoporp0001.ttxxpoporp0001_base_cost = base_cost
     ttxxpoporp0001.ttxxpoporp0001_pod_disc_pct = pod_disc_pct
     ttxxpoporp0001.ttxxpoporp0001_ext_cost = ext_cost
     ttxxpoporp0001.ttxxpoporp0001_pod_due_date = pod_due_date
     ttxxpoporp0001.ttxxpoporp0001_pod_wo_lot = pod_wo_lot
     ttxxpoporp0001.ttxxpoporp0001_pod_so_job = pod_so_job
     ttxxpoporp0001.ttxxpoporp0001_pod_status = pod_status
     .
   END.
      /* SS - 090225.1 - E */
   ...
   ASSIGN 
        ttxxpoporp0001.ttxxpoporp0001_base_cost = pod_pur_cost.
