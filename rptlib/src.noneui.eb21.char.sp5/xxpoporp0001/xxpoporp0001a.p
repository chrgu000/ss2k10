...
/* $Revision: 1.10.1.5 $ BY: Paul Donnelly (SB) DATE: 06/28/03 ECO: *Q00J* */
/*-Revision end---------------------------------------------------------------*/
...
{gppopp.i}
      ...
      /* SS - 090225.1 - B 
         if sortby = no then do:
            {poporp.i &sort1 = "po_nbr" &sort2 = "pod_line" &sort3 = "pod_line"
                      &frame1 = "b" &frame2 = "c"}
         end. /* if not sorted by buyer */

         if sortby = yes then do:
            {poporp.i &sort1 = "po_buyer" &sort2 = "po_nbr" &sort3 = "pod_line"
                            &frame1 = "d" &frame2 = "e"}
     ...
     /* SS - 090225.1 - B */
         if sortby = no then do:
            {xxpoporp0001a.i &sort1 = "po_nbr" &sort2 = "pod_line" &sort3 = "pod_line"
                      &frame1 = "b" &frame2 = "c"}
         end. /* if not sorted by buyer */

         if sortby = yes then do:
            {xxpoporp0001a.i &sort1 = "po_buyer" &sort2 = "po_nbr" &sort3 = "pod_line"
                            &frame1 = "d" &frame2 = "e"}
         end. /* if sorted by buyer */
   /*  SS - 090225.1 - E */
