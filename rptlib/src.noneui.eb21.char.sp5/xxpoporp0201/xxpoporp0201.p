...
/* 定义输入参数 */
define input parameter i_part            like pod_part     no-undo.
define input parameter i_part1           like pod_part     no-undo.
define input parameter i_nbr             like po_nbr       no-undo.
define input parameter i_nbr1            like po_nbr       no-undo.
define input parameter i_so_job          like pod_so_job   no-undo.
define input parameter i_so_job1         like pod_so_job   no-undo.
define input parameter i_due             like pod_due_date no-undo.
define input parameter i_due1            like pod_due_date no-undo.
define input parameter i_perform         like pod_per_date no-undo.
define input parameter i_perform1        like pod_per_date no-undo.
