...
repeat:
   ...
   PUT UNFORMATTED "BEGIN: " + STRING(TIME, "HH:MM:SS") SKIP.
    ...
    EXPORT DELIMITER ";" "供应商代码" "供应商名称" "联系人" "电话" "分机" "凭证" "发票日期" "生效日期" "截止日期" "支付方式" "本币账龄1" "本币账龄2" "本币账龄3" "本币账龄4" "本币账龄5" "本币账龄6" "本币账龄7" "本币账龄8" "本币账龄合计" "资信暂留" "兑换率1" "兑换率2" "货币" "账户" "分账户" "成本中心" "原币账龄合计".
    EXPORT DELIMITER ";" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "扩展输出" "扩展输出" "扩展输出" "扩展输出".
