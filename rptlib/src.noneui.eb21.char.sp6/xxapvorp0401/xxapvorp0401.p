...
SS - 090415.1 - E */
/* SS - 090415.1 - B */
define variable age_days as integer extent 9 label "Column Days".
define variable age_range as character extent 9 format "x(17)".
define variable i as integer.
define variable age_amt like ap_amt extent 9 format "->>>>,>>>,>>>.99".
/* SS - 090415.1 - E */
...
SS - 090415.1 - E */
/* SS - 090415.1 - B */
define variable et_age_amt       like ap_amt extent 9.
define variable et_base_amt      like ap_amt.
define variable et_curr_amt      like ap_amt.
define variable et_org_age_amt   like ap_amt extent 9.
/* SS - 090415.1 - E */
...
PROCEDURE ip-disp-voucher:
   ...
   if net <> 0 then do:
      ...
      /* SS - 090415.1 - B */
      CREATE ttxxapvorp0401.
      ASSIGN
         ttxxapvorp0401_ap_vend = ap_mstr.ap_vend
         ttxxapvorp0401_name = NAME
         ttxxapvorp0401_ad_attn = ad_mstr.ad_attn
         ttxxapvorp0401_ad_phone = ad_phone
         ttxxapvorp0401_ad_ext = ad_ext

         ttxxapvorp0401_voucherno = voucherno
         ttxxapvorp0401_invdate = invdate
         ttxxapvorp0401_effdate = effdate
         ttxxapvorp0401_vo_cr_terms = vo_mstr.vo_cr_terms
         ttxxapvorp0401_et_age_amt[1] = et_age_amt[1]
         ttxxapvorp0401_et_age_amt[2] = et_age_amt[2]
         ttxxapvorp0401_et_age_amt[3] = et_age_amt[3]
         ttxxapvorp0401_et_age_amt[4] = et_age_amt[4]
         ttxxapvorp0401_et_age_amt[5] = et_age_amt[5]
         ttxxapvorp0401_et_age_amt[6] = et_age_amt[6]
         ttxxapvorp0401_et_age_amt[7] = et_age_amt[7]
         ttxxapvorp0401_et_age_amt[8] = et_age_amt[8]
         ttxxapvorp0401_et_base_amt = et_base_amt
         ttxxapvorp0401_hold = hold

         ttxxapvorp0401_ap_ex_rate = ap_mstr.ap_ex_rate
         ttxxapvorp0401_ap_ex_rate2 = ap_mstr.ap_ex_rate2
         ttxxapvorp0401_ap_curr = ap_mstr.ap_curr

         ttxxapvorp0401_ap_acct = ap_mstr.ap_acct
         ttxxapvorp0401_ap_sub = ap_mstr.ap_sub
         ttxxapvorp0401_ap_cc = ap_mstr.ap_cc

         ttxxapvorp0401_et_curr_amt = net
         .
      IF NOT multi-due THEN DO:
         ASSIGN
            ttxxapvorp0401_duedate = duedate
            .
      END.
      /* SS - 090415.1 - E */
   end.
