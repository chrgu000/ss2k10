...
顺序输出了以下字段:
  ...
  - 扩展输出: 本币账龄5[et_age_amt[5]]
  - 扩展输出: 本币账龄6[et_age_amt[6]]
  - 扩展输出: 本币账龄7[et_age_amt[7]]
  - 扩展输出: 本币账龄8[et_age_amt[8]]
  - 扩展输出: 本币账龄9[et_age_amt[9]]
  - 标准输出: 本币账龄合计[amt]
  - 扩展输出: 原币[ar_curr]
  - 标准输出: 支付方式[cr_terms]
  - 标准输出: 催款信级别[dun_levels]
  - 标准输出: 备注[ar_po]
  - 扩展输出: 原币账龄合计[curr_amt]
...
/* Code below to be wrapped in a 'do' code block for correct GUI conversion */
   ...
   EMPTY TEMP-TABLE ttxxarcsrp0501.
   ...
   EXPORT DELIMITER ";" "客户代码" "客户名称" "省" "上次付款" "联系人" "电话" "分机" "账户" "分账户" "成本中心" "参考或支票" "参考类型" "事务参考" "事务类型" "生效日期" "截止日期" "发票日期" "本币账龄1" "本币账龄2" "本币账龄3" "本币账龄4" "本币账龄5" "本币账龄6" "本币账龄7" "本币账龄8" "本币账龄9" "本币账龄合计" "原币" "支付方式" "催款信级别" "备注" "原币账龄合计".
   EXPORT DELIMITER ";" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "扩展输出" "扩展输出" "扩展输出" "标准输出" "标准输出" "扩展输出" "扩展输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "扩展输出" "扩展输出" "扩展输出" "扩展输出" "扩展输出" "标准输出" "扩展输出" "标准输出" "标准输出" "标准输出" "扩展输出".
   EXPORT DELIMITER ";" "bill" "name" "ad_state" "cm_pay_date" "ad_attn" "ad_phone" "ad_ext" "acct" "sub" "cc" "nbr" "type" "ar_nbr" "ar_type" "effdate" "due_date" "date" "et_age_amt[1]" "et_age_amt[2]" "et_age_amt[3]" "et_age_amt[4]" "et_age_amt[5]" "et_age_amt[6]" "et_age_amt[7]" "et_age_amt[8]" "et_age_amt[9]" "amt" "ar_curr" "cr_terms" "dun_levels" "ar_po" "curr_amt".
    FOR EACH ttxxarcsrp0501:
        EXPORT DELIMITER ";" ttxxarcsrp0501.
    END.
