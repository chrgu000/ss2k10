...
/* Revision: 1.22.1.31.1.3  BY: Abhishek Jha       DATE: 08/11/05 ECO: *P3XN* */
/* Revision: 1.22.1.31.1.4 BY: Shivaraman V.    DATE: 10/12/06 ECO: *P59J* */
/* $Revision: 1.22.1.31.1.5 $             BY: Praveen Sequeira   DATE: 11/17/06 ECO: *Q0ZX* */
/* Revision end---------------------------------------------------------------*/
/******************************************************************************/
            ...
            if use_rec
               ...
               {&ARCSRP5A-P-TAG69}
                  ...
                  then do with frame c:
                     /* SS - 090414.1 - B */
                     CREATE ttxxarcsrp0501.
                     ASSIGN
                        ttxxarcsrp0501_bill = ar_bill
                        .
                     ...
                     for first ad_mstr
                        ...
                        no-lock:
                        ASSIGN
                           ttxxarcsrp0501_name = ad_NAME
                           ttxxarcsrp0501_ad_state = ad_state
                           ttxxarcsrp0501_cm_pay_date = cm_pay_date
                           ttxxarcsrp0501_ad_attn = ad_attn
                           ttxxarcsrp0501_ad_phone = ad_phone
                           ttxxarcsrp0501_ad_ext = ad_ext
                           .
                     END.

                     ASSIGN
                        ttxxarcsrp0501_ar_nbr = ar_nbr
                        ttxxarcsrp0501_ar_type = ar_type
                        .

                     IF ar_type <> "P" THEN DO:
                        ASSIGN
                           ttxxarcsrp0501_acct = ar_acct
                           ttxxarcsrp0501_sub = ar_sub
                           ttxxarcsrp0501_cc = ar_cc
                           .
                     END.
                     ELSE DO:
                        FIND FIRST bard
                           WHERE bard.ard_domain = GLOBAL_domain
                           AND bard.ard_nbr = ar_nbr 
                           AND bard.ard_ref = "" 
                           AND bard.ard_type = "U" 
                        ...
                        IF AVAILABLE bard THEN DO:
                           ASSIGN
                              ttxxarcsrp0501_acct = bard.ard_acct
                              ttxxarcsrp0501_sub = bard.ard_sub
                              ttxxarcsrp0501_cc = bard.ard_cc
                              .
                        END.
                        ELSE DO:
                           ASSIGN
                     ...
                     THEN DO:
                        ASSIGN
                           ttxxarcsrp0501_nbr = ar_nbr
                           ttxxarcsrp0501_type = ar_type
                           .
                     END.
                     ELSE DO:
                        ASSIGN
                           ttxxarcsrp0501_nbr = ar_check
                           ttxxarcsrp0501_type = "U"
                           .
                     END.
                     {&ARCSRP5A-P-TAG12}
                     ...
                     THEN DO:
                        ASSIGN
                           ttxxarcsrp0501_effdate = ar_effdate
                           ttxxarcsrp0501_due_date = ar_due_date
                           ttxxarcsrp0501_date = ar_date
                           ttxxarcsrp0501_cr_terms = ar_cr_terms
                           ttxxarcsrp0501_dun_level = ar_dun_level
                           .
                     END.
                     ELSE DO:
                        ASSIGN
                     ...
                     ASSIGN
                        ttxxarcsrp0501_et_age_amt[1] = et_age_amt[1]
                        ttxxarcsrp0501_et_age_amt[2] = et_age_amt[2]
                        ttxxarcsrp0501_et_age_amt[3] = et_age_amt[3]
                        ttxxarcsrp0501_et_age_amt[4] = et_age_amt[4]
                        ttxxarcsrp0501_et_age_amt[5] = et_age_amt[5]
                        ttxxarcsrp0501_et_age_amt[6] = et_age_amt[6]
                        ttxxarcsrp0501_et_age_amt[7] = et_age_amt[7]
                        ttxxarcsrp0501_et_age_amt[8] = et_age_amt[8]
                        ttxxarcsrp0501_et_age_amt[9] = et_age_amt[9]
                        ttxxarcsrp0501_amt = (et_base_amt - et_base_applied)
                        ttxxarcsrp0501_curr_amt = (amt_base - applied_base)
                        ttxxarcsrp0501_ar_curr = ar_curr
                        ttxxarcsrp0501_ar_po = ar_po
                        .
                     /* SS - 090414.1 - E */
