...
repeat:
   ...
   FOR EACH ttxxfaaqrp0001:
      DELETE ttxxfaaqrp0001.
   END.
   
   {gprun.i ""xxfaaqrp0001.p""
      "(input l-class,
        input l-class1,
        input l-loc,
        input l-loc1,
   ...
   EXPORT DELIMITER ";" "类型" "资产" "说明" "库位" "单位" "成本" "服务日期".
   EXPORT DELIMITER ";" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出".
   EXPORT DELIMITER ";" "fa_facls_id" "fa_id" "fa_desc1" "fa_faloc_id" "fa_entity" "costAmt" "fa_startdt".
   FOR EACH ttxxfaaqrp0001:
      EXPORT DELIMITER ";" ttxxfaaqrp0001.
   END.
