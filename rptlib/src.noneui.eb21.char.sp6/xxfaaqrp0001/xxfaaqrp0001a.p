...
/* $Revision: 1.13.1.15 $ BY: Paul Donnelly (SB) DATE: 06/26/03 ECO: *Q00C* */
/*-Revision end---------------------------------------------------------------*/
...
for each fa_mstr
   fields( fa_domain fa_facls_id fa_id fa_faloc_id fa_entity
   ...
   then do:
      ...
      SS - 091106.1 - E */
      /* SS - 091106.1 - B */
      CREATE ttxxfaaqrp0001.
      ASSIGN
         ttxxfaaqrp0001_fa_facls_id = fa_facls_id
         ttxxfaaqrp0001_fa_id = fa_mstr.fa_id
         ttxxfaaqrp0001_fa_desc1 = fa_mstr.fa_desc1
         ttxxfaaqrp0001_fa_faloc_id = fa_mstr.fa_faloc_id
         ttxxfaaqrp0001_fa_entity = fa_mstr.fa_entity
         ttxxfaaqrp0001_costAmt = costAmt
         ttxxfaaqrp0001_fa_startdt = fa_mstr.fa_startdt
         .
      /* SS - 091106.1 - E */
      {mfrpchk.i}
