...
repeat:
   ...
   EXPORT DELIMITER ";" "发票号" "版本" "客户代码" "客户名称" "采购订单" "发货-至" "发货日期" "发票日期" "推销员1" "推销员2" "推销员3" "推销员4" "货币" "本币" "兑换率1" "兑换率2" "兑换率序号" "兑换率1" "兑换率2" "备注" "销售订单" "行" "物料号" "计量单位" "已订购量" "发票数量" "欠交量" "显示货币" "本币单价" "本币金额" "本币毛利" "截止日期" "类型" "渠道" "项目" "地点" "产品类" "纳税类别" "是否纳税" "是否含税" "账户" "分账户" "成本中心" "项目" "生效日期" "原币金额" "原币毛利" "原币税额" "本币税额".
