...
repeat:
   ...
   */
   ...
   EXPORT DELIMITER ";" "vo_ref" "ap_date" "vd_remit" "ap_curr" "disp_curr" "ap_base_amt" "vopo" "ap_effdate" "vo_ship" "curr_disp_line1" "ap_acct" "ap_sub" "ap_cc" "curr_disp_line2" "ap_vend" "vo_due_date" "vo_invoice" "ap_bank" "vo_ndisc_amt" "name" "vo_disc_date" "ap_entity" "vo_type" "vo_applied" "flag" "ap_rmk" "ap_ckfrm" "vo_confirmed" "vo_conf_by" "vo_hold_amt" "vo_is_ers" "remit_label" "remit_name" "ap_batch" "vod_ln" "vod_acc" "vod_sub" "vod_cc" "vod_project" "vod_entity" "vod_amt" "vod_desc" "ap_amt" "ap_ex_rate" "ap_ex_rate2" "vod_amt".
