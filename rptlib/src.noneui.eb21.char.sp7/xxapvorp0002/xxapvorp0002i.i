...
batch)
   ...
   ap_ref no-lock
      ...
      if summary = no then do:
         ...
         SS - 100706.1 - E */
         /* SS - 100706.1 - B */
         CREATE ttxxapvorp0002.
         ASSIGN
            /* Line 1 */
            ttxxapvorp0002_vo_ref = vo_ref
            ttxxapvorp0002_ap_date = ap_date
            ttxxapvorp0002_vd_remit = vd_remit
            ttxxapvorp0002_ap_curr = ap_curr
            /* Line 2 */
            ttxxapvorp0002_vopo = vopo
            ttxxapvorp0002_ap_effdate = ap_effdate
            ttxxapvorp0002_vo_ship = vo_ship
            ttxxapvorp0002_curr_disp_line1 = curr_disp_line1
            ttxxapvorp0002_ap_acct = ap_acct
            ttxxapvorp0002_ap_sub = ap_sub
            ttxxapvorp0002_ap_cc = ap_cc
            /* Line 2a if needed */
            ttxxapvorp0002_curr_disp_line2 = curr_disp_line2
            /* CURR_DISP_LINE2 LINES-UP WITH CURR_DISP_LINE1 */
            /* Line 3 */
            ttxxapvorp0002_ap_vend = ap_vend
            ttxxapvorp0002_vo_due_date = vo_due_date
            ttxxapvorp0002_vo_invoice = vo_invoice
            ttxxapvorp0002_ap_bank = ap_bank
            /* Line 4 */
            ttxxapvorp0002_name = name
            ttxxapvorp0002_vo_disc_date = vo_disc_date
            ttxxapvorp0002_ap_entity = ap_entity
            ttxxapvorp0002_vo_type = vo_type
            ttxxapvorp0002_flag = flag
            /* Line 5 */
            ttxxapvorp0002_ap_rmk = ap_rmk 
            ttxxapvorp0002_ap_ckfrm = ap_ckfrm
            ttxxapvorp0002_vo_confirmed = vo_confirmed
            ttxxapvorp0002_vo_conf_by = vo_conf_by
            /* Line 6 */
            ttxxapvorp0002_vo_is_ers = vo_is_ers
            ttxxapvorp0002_remit_label = remit_label
            ttxxapvorp0002_remit_name = remit_name
            ttxxapvorp0002_ap_batch = ap_batch
            .
         ...
         then do:
            disp_curr = "".
            ASSIGN
               ttxxapvorp0002_disp_curr = DISP_curr
               ttxxapvorp0002_ap_base_amt = ap_amt
               ttxxapvorp0002_vo_ndisc_amt = vo_ndisc_amt
               ttxxapvorp0002_vo_applied = vo_applied
               ttxxapvorp0002_vo_hold_amt = vo_hold_amt
               .
         end.
         /*If base is selected, then amounts shown will be in base. */
         else DO:
            ASSIGN
               ttxxapvorp0002_disp_curr = DISP_curr
               ttxxapvorp0002_ap_base_amt = base_amt
               ttxxapvorp0002_vo_ndisc_amt = base_ndamt
               ttxxapvorp0002_vo_applied = base_applied
               ttxxapvorp0002_vo_hold_amt = base_hold_amt
               .
         END.
         ASSIGN
            ttxxapvorp0002_ap_amt = ap_amt
            ttxxapvorp0002_ap_ex_rate = ap_ex_rate
            ttxxapvorp0002_ap_ex_rate2 = ap_ex_rate2
            .

         ASSIGN
            ttxxapvorp0002_vod_ln = vod_ln
            ttxxapvorp0002_vod_acc = vod_acct
            ttxxapvorp0002_vod_sub = vod_sub
            ttxxapvorp0002_vod_cc = vod_cc
            ttxxapvorp0002_vod_project = vod_project
            ttxxapvorp0002_vod_entity = vod_entity
            ttxxapvorp0002_vod_desc = vod_desc
            .
         if base_rpt = "" and mixed_rpt then DO:
            ASSIGN 
               ttxxapvorp0002_vod_base_amt = vod_amt
               .
         END.
         else DO:
            assign
               ttxxapvorp0002_vod_base_amt = base_damt
               .
         END.
         ASSIGN 
            ttxxapvorp0002_vod_amt = vod_amt
            .
         /* SS - 100706.1 - E */
      end.
      /* SS - 100706.1 - B
