...
repeat:
   ...
   */
   ...
   EXPORT DELIMITER ";" "batch" "nbr" "bill" "name" "type" "check" "base_amt" "date" "effdate" "entity" "acct" "sub" "cc" "po" "ard_ref" "ard_type" "ard_entity" "ard_acct" "ard_sub" "ard_cc" "disp_curr" "base_damt".
