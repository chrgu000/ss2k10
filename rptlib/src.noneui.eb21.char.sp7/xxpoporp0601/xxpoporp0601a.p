      ...
      for each tt_pvoddet no-lock:
         ...
         if qty_open <> 0 or prh_ps_qty <> 0 then do:
            ...
            ASSIGN 
               ...
               ttxxpoporp0601_tax_amt = tax_amt
            ...
            if prh_curr <> base_curr then do:
               ...
               ASSIGN 
                  ttxxpoporp0601_ex_rate = ex_rate
                  ttxxpoporp0601_ex_rate2 = ex_rate2
                  ttxxpoporp0601_pvoddet_exru_seq = pvoddet_exru_seq
                  .
            end.
            ELSE DO:
               ASSIGN 
                  ttxxpoporp0601_ex_rate = prh_ex_rate
                  ttxxpoporp0601_ex_rate2 = prh_ex_rate
                  ttxxpoporp0601_pvoddet_exru_seq = prh_exru_seq
                  .
            END.
