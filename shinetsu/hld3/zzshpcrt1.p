/*zzshpcrt1.p   Ship Weight Preparation For "Exceed" */
/*Last Modify by Leo Zhou   11/18/2011 */
/*Last Modify by Leo Zhou   03/08/2012   *CLZ1*/
...
if v_len_rate = 0 then do:
   if v_def_class = 1 then do:
	...
	if usrw_charfld[4] = "1" then do:
            {gprun.i ""zzshlog1.p"" "(v_open_wt1, v_ship_qty - i)"}
	end.
	else do:
