...
/* ------- Barcode 95 70 的复制 EPS 替换 EMG  ZZ调拨到EMG库位的 (从库位固定为ZZ 至库位固定为EMG)     */
/* 需求 请将条码70菜单复制一个出来，将里面指定的转入库位设置成EMG，谢谢。 */
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
 ...
 /*       end.                                              */
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
/*  Sam Song 20100319 End */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1305 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 no-box.
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
...
If AVAILABLE ( poc_ctrl ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
...
*/
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1520 no-box.
...
If NOT AVAILABLE ld_det THEN
        leave V1525L.
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1525 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 no-box.
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
...
If NOT AVAILABLE ( tr_hist ) then
   ...
   pause 0 before-hide.
     ...
     REPEAT:
        ...
        leave V9015L.
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9015 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
...
if V9120 = ? THEN
        leave V9120L.
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        leave V9130L.
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
...
If AVAILABLE ( pt_mstr )  then
   ...
   */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9140 no-box.
...
IF 1 = 1 THEN
        leave V9150L.
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9150 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        leave V9160L.
        /* LOGICAL SKIP END */
                display "[ZZ调到EMG]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9160 no-box.
