...
/* 生产标签补打 */
/* Generate date / time  2006-10-31 16:37:57 */
...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xslap02wtimeout" no-lock no-error. /*  Timeout - Program Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[生产标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If available pt_mstr then
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[生产标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9020 no-box.
   ...
   wtm_num = V9020.
     ...
     REPEAT:
        ...
        /* --FIRST TIME DEFAULT  VALUE -- START  */
        find first upd_det where upd_nbr = "LAP02" and upd_select = 99 no-lock no-error.
If AVAILABLE ( upd_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产标签补打]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9030 no-box.
     ...
     INPUT FROM VALUE(LabelsPath + "lap02").
