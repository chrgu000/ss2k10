...
/* Generate date / time  2007-2-14 9:57:28 */
...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xsrep03wtimeout" no-lock no-error. /*  Timeout - Program Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
...
If AVAILABLE ( lad_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1105 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 no-box.
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
...
ld_ref  = ""     and
ld_loc <> V1105  and 
ld_loc = "P-ALL" and ld_qty_oh <> 0 use-index ld_part_lot no-lock no-error.
If AVAILABLE ( ld_det ) then
...
LD_LOC = "P-ALL" AND  
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 no-box.
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
...
If NOT AVAILABLE ( tr_hist ) then
   ...
   IF NOT (V9010 = "Y" AND V1700 = "Y" ) THEN LEAVE V9110LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
...
If AVAILABLE ( pt_mstr ) then
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* --FIRST TIME SKIP -- START  */
       /*  if sectionid = 1 then leave V9130L. SamSong 20110315*/
        /* --FIRST TIME SKIP -- END  */
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[备料转车间]"       + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
