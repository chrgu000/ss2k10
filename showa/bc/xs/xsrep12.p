...
/* Rep Backflush with Scrap */
/* Generate date / time  2007-6-8 11:11:17 */
...
find first code_mstr where code_fldname = "BARCODE" AND CODE_value ="xsrep12wtimeout" no-lock no-error. /*  Timeout - Program Level */
if AVAILABLE(code_mstr) Then wtimeout = 60 * decimal(code_cmmt).
...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
...
If AVAILABLE ( code_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1203 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If AVAILABLE ( ro_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1310 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 no-box.
...
{xsglotr.i}
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 no-box.
...
ld_site = V1002 and ld_ref = "" and  ld_QTY_oh + DECIMAL ( V1600 ) >= 0 ) )  no-lock no-error.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1601 no-box.
                ...
                /* LABEL 3 - START */ 
                L16013 = "生产线/批号:" + Trim(V1100) + "/" + Trim(V1500) .
                display L16013          format "x(40)" skip with fram F1601 no-box.
                /* LABEL 3 - END */ 


                /* LABEL 4 - START */ 
                L16014 = "库位:" + trim( V1510 ) .
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 no-box.
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
...
If NOT AVAILABLE ( tr_hist ) then
   ...
   IF NOT (V9010 = "Y" AND V1700 = "Y" ) THEN LEAVE V9110LMAINLOOP.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
...
If AVAILABLE ( pt_mstr ) then
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        leave V9130L.
        /* LOGICAL SKIP END */
                display "[生产回冲-废品]"     + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
