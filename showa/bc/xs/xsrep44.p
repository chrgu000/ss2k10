...
define variable vbarcode as character format "x(30)".
define variable i as integer .
define variable vshift as character.
...
/*        assign v1005 = "M6A309-134-8@1309211s00004-30". */
        Update V1005
        ...
        /* CHECK FOR NUMBER VARIABLE  END */
        find first code_mstr where code_fldname = "BARCODEDEFLINE" and code_value = userid(sdbname('qaddb'))   no-lock no-error.
        IF NOT ( AVAILABLE code_mstr AND INDEX(CODE_cmmt, v_line) <> 0 ) then do:
        ...
        leave V1005L.
     END.
     assign vbarcode = v1005.
     assign vshift = substring(vbarcode,index(vbarcode,"@") + 7 , 2).
     /*PV1005 ： 生产线*/
     PV1005 = V1005.
...
/*        V1100 = ENTRY(1,V1100,"@").   */
        ...
        ss - 110929.1 -e */
         ...
         /* ss - 110929.1 -b */
        find first code_mstr where code_fldname = "BARCODEDEFLINE" and code_value = userid(sdbname('qaddb')) 
             no-lock no-error.
        IF NOT ( AVAILABLE code_MSTR and (  INDEX(CODE_cmmt, V1100 ) <> 0 or code_cmmt = "*" ) ) then do:
                display skip "该用户没有权限!" @ WMESSAGE NO-LABEL with fram F1100.
                pause 0 before-hide.
                Undo, retry.
        End.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        recid(PT_MSTR) = ?.
        assign v1300 = substring(vbarcode,1,index(vbarcode,"@") + 6).
        Update V1300
...
{xsglotr.i}
        ...
        assign V1500 = entry(2,vbarcode,"@").
        assign v1500 = substring(vbarcode,1,6).
        Update V1500
     ...
     REPEAT:
        ...
        assign v1600 = entry(2,vbarcode,"@").
        assign v1600 = entry(2,v1600,"-").
        Update V1600
