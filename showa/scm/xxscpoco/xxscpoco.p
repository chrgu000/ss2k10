/* xxscpoco.p - 05.16.01.13.03 - 采购订单确认 [xxscpoco]                   */
...
/*L020*/ {gprunpdf.i "mcpl" "p"}
         ...
         /* SS - 090917.1 - B */
         define new shared variable update-yn like mfc_logical initial no.
         /* SS - 090917.1 - E */
...
open_only  incl_b2b_po sortby base_rpt  mixed_rpt
            /* SS - 090917.1 - B */
            update-yn
            /* SS - 090917.1 - E */
            " &frm = "a"}
