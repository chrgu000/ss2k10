...
/*L020*/ define variable mc-error-number like msg_nbr no-undo.
         ...
         /* SS - 090917.1 - B */
         define shared variable update-yn like mfc_logical.
         /* SS - 090917.1 - E */
...
{gppopp.i}
         ...
         /* SS - 090917.1 - B */
         if sortby = no then do:
            {xxscpoco.i &sort1 = "po_nbr" &sort2 = "pod_line" &sort3 = "pod_line"
                      &frame1 = "b" &frame2 = "c"}
         end. /* if not sorted by buyer */

         if sortby = yes then do:
            {xxscpoco.i &sort1 = "po_buyer" &sort2 = "po_nbr" &sort3 = "pod_line"
                            &frame1 = "d" &frame2 = "e"}
         end. /* if sorted by buyer */
         /* SS - 090917.1 - E */
         {wbrp04.i}
