...
define variable ttime1 as char.
define variable ttime2 as char.
...
/* SS 090723.1 - B */
					...
					if tdate1 <> tdate2 then do:
						...
						if avail sod_det then do:
							...
							put "-" skip.
							put unformat string(min(sod_qty_ord - xxsod_qty_ord,0)) skip.
							put "-" skip.
							put "-" skip.
        			...
        			OUTPUT CLOSE .
						...
						if avail so_mstr then do:
							...
							if avail sod_det then do:
								...
								put unformat substring(xxsod_due_date1,3,2) + substring(xxsod_due_date1,6,2) + substring(xxsod_due_date1,9,2) skip.
							end.
