...
/* SS - 100715.1 - B */
define variable due_req_per as date .
/* SS - 100715.1 - E */
...
/* SS - 100715.1 - B */
                                                                due_req_per = today.
                                                                {gprun.i ""xxch03getdt.p""
                                                                 "(input tnbr1, output due_req_per)"}

                                                                for each sod_det where sod_nbr = tnbr1  :
								    sod_due_date = due_req_per.
                                                                    sod_req_date = due_req_per .
                                                                    sod_per_date = due_req_per .
...
/* SS - 100715.1 - B */
                                                                due_req_per = today.
                                                                {gprun.i ""xxch03getdt.p""
                                                                 "(input tnbr2, output due_req_per)"}

                                                                for each sod_det where sod_nbr = tnbr2  :
								    sod_due_date = due_req_per.
                                                                    sod_req_date = due_req_per .
                                                                    sod_per_date = due_req_per .
