...
/* ss - 090825.1 by: JACK */ /* 将eb21版本转为eb2 */
...
DEFINE VARIABLE qty_loc_tr LIKE tr_qty_loc.
DEFINE VARIABLE dec1 LIKE usrw_decfld.
/* SS - 20070726.1 - E */
   ...
   */
   ...
   FOR EACH ttxxsoivrp0901
      ...
      IF tr_um <> idh_um THEN DO:
         ...
         qty_loc_tr = - tr_qty_loc / dec1[5].
      END.
      ELSE DO:
         qty_loc_tr = - tr_qty_loc.
      END.
      ...
      EXPORT DELIMITER ";" 
         ...
         (qty_loc_tr * ttxxsoivrp0901_base_net_price)
         .
   END.
