...
repeat:
   ...
   */
   ...
   FOR EACH ttxxsoivrp0901
      ...
      BY idh_line
      :
      ACCUMULATE usrw_decfld[4] (TOTAL BY idh_inv_nbr BY idh_nbr BY idh_line).
      IF LAST-OF(idh_line) THEN DO:
         EXPORT DELIMITER ";" 
            ...
            (ACCUMULATE TOTAL BY idh_line usrw_decfld[4])
            ttxxsoivrp0901_base_net_price
            ((ACCUMULATE TOTAL BY idh_line usrw_decfld[4]) * ttxxsoivrp0901_base_net_price)
            .
