...
/* $Revision: 1.14 $    BY: Micho Yang         DATE: 08/05/08  ECO: *SS - 20080805.1* */
/******************************************************************************/
...
define variable fieldname like code_fldname INIT "pt_promo" no-undo.
...
repeat with frame a:
   ...
   editing:
     ...
     */
   find code_mstr where code_fldname = "pt_promo"
                       and code_value = input code_value
   no-lock no-error.
   if available code_mstr then
      recno = recid(code_mstr).
