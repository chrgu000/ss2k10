...
/*GUI*/ RECT-FRAME:HEIGHT-PIXELS in frame a = FRAME a:HEIGHT-PIXELS - RECT-FRAME:Y in frame a - 2.
   ...
   v_qty = 0 .
   PUT "xxpk_det: " SKIP.
   PUT UNFORMATTED "Lot" ";" "Site" ";" "Part" ";" "Desc" ";" "Article" ";" "Date" ";" "Line" ";"  "Begin" ";" "End" ";" "Ord_Qty" ";" "Qty" skip .
   FOR EACH tt1 NO-LOCK WHERE tt1.tt1_bg = "合" AND tt1.tt1_ed = "计" AND DELETE_pklst = NO :
       v_qty = 0.
       ...
       /*MESSAGE "v_qty: " + STRING(v_qty) VIEW-AS ALERT-BOX. */

       IF v_qty = tt1.tt1_qty THEN DO:
          FOR EACH buftt1 NO-LOCK WHERE buftt1.tt1_lot = tt1.tt1_lot                                    
                                    AND buftt1.tt1_site = tt1.tt1_site
                                    AND buftt1.tt1_line = tt1.tt1_line
                                    AND buftt1.tt1_part = tt1.tt1_part
                                    AND buftt1.tt1_bg <> "合" 
                                    BREAK BY buftt1.tt1_bg :  
              IF FIRST(buftt1.tt1_bg) THEN DO:
                  IF (v_qty - buftt1.tt1_qty) >= 0 THEN DO:
                      IF buftt1.tt1_ord_qty <> 0 AND (buftt1.tt1_qty MOD buftt1.tt1_ord_qty) > 0 THEN DO:
                          v_ord_qty = (int(TRUNCATE(buftt1.tt1_qty / buftt1.tt1_ord_qty,0)) + 1) * buftt1.tt1_ord_qty .
                      END.
                      ELSE DO:
                          v_ord_qty = buftt1.tt1_qty .
                      END.
                  END.
                  ELSE DO:
                      v_ord_qty = 0.
                  END.
                  v_fg_qty = v_ord_qty - buftt1.tt1_qty .
                  IF v_ord_qty > v_qty THEN DO:
                      v_ord_qty = v_qty .
                      v_flag = YES.
                  END.
                  v_ord_qty_tot = v_ord_qty + v_ord_qty_tot .
              END.
              ELSE DO:
                  IF ( v_fg_qty - buftt1.tt1_qty) < 0 THEN DO:
                          IF buftt1.tt1_ord_qty <> 0 AND (buftt1.tt1_qty MOD buftt1.tt1_ord_qty) > 0 THEN DO:
                              v_ord_qty = (int(TRUNCATE(buftt1.tt1_qty / buftt1.tt1_ord_qty,0)) + 1) * buftt1.tt1_ord_qty .
                          END.
                          ELSE DO:
                  ...
                  ELSE DO:
                      v_ord_qty = 0.
                  END.
                  v_fg_qty = v_fg_qty + v_ord_qty - buftt1.tt1_qty .
                  v_ord_qty_tot = v_ord_qty + v_ord_qty_tot .
                  IF v_ord_qty_tot > v_qty AND v_flag = NO THEN DO:
                     v_ord_qty = v_qty - (v_ord_qty_tot - v_ord_qty) .
                     v_flag = YES .
                  END.
              END.
              ...
              PUT UNFORMATTED buftt1.tt1_lot ";" buftt1.tt1_site ";" buftt1.tt1_part ";" buftt1.tt1_part_desc  ";" buftt1.tt1_article ";" TODAY ";" buftt1.tt1_line ";" 
                              buftt1.tt1_bg ";" buftt1.tt1_ed ";" buftt1.tt1_ord_qty ";" v_ord_qty SKIP.
          END.
          v_qty = 0.
       ...
       ELSE IF v_qty > tt1.tt1_qty THEN DO:
          FOR EACH buftt1 NO-LOCK WHERE buftt1.tt1_lot = tt1.tt1_lot 
                  ...
                  ELSE DO:
                      ...
                      PUT UNFORMATTED buftt1.tt1_lot ";" buftt1.tt1_site ";" buftt1.tt1_part ";" buftt1.tt1_part_desc  ";" buftt1.tt1_article ";" TODAY ";" buftt1.tt1_line ";" 
                                      buftt1.tt1_bg ";" buftt1.tt1_ed ";" buftt1.tt1_ord_qty ";" v_ord_qty SKIP.
                      v_qty = v_qty - v_ord_qty  .
                  END.
          END. /* FOR EACH buftt1 NO-LOCK BY buftt1.tt1_bg DESCENDING : */
          v_qty = 0.
          ...
          FOR EACH buftt1 NO-LOCK WHERE buftt1.tt1_lot = tt1.tt1_lot 
              ...
              IF (v_qty - buftt1.tt1_qty) >= 0 THEN DO:
                  ...
                  ASSIGN
                     ...
                     .
                  v_qty = v_qty - buftt1.tt1_qty .
                  /* MESSAGE "1.v_qty: " + string(v_qty) + "tt1_qty: " + STRING(buftt1.tt1_qty) +  "bg: " + STRING(buftt1.tt1_bg) + " ed: " + STRING(buftt1.tt1_ed) VIEW-AS ALERT-BOX. */
              END.
              ELSE DO:
                  /*MESSAGE "bg: " + STRING(buftt1.tt1_bg) + " ed: " + STRING(buftt1.tt1_ed) VIEW-AS ALERT-BOX. */
                  CREATE xxpk_det .
                  ASSIGN
                     xxpk_lot = buftt1.tt1_lot
                     xxpk_site = buftt1.tt1_site
                     ...
                     .      
                  v_qty = 0.
                  /* MESSAGE "2.v_qty: " + string(v_qty) + "bg: " + STRING(buftt1.tt1_bg) + " ed: " + STRING(buftt1.tt1_ed) VIEW-AS ALERT-BOX. */
              END.
          END. /* FOR EACH buftt1 NO-LOCK BY buftt1.tt1_bg DESCENDING : */

          v_qty = v_qty1 .
          FOR EACH xxpk_det EXCLUSIVE-LOCK WHERE xxpk_lot = tt1.tt1_lot
                                             AND xxpk_site = tt1.tt1_site
                                             AND xxpk_line = tt1.tt1_line
                                             AND xxpk_part = tt1.tt1_part
                                             BREAK BY xxpk_bg :
              IF LAST(xxpk_bg) THEN DO:
                 IF v_qty > 0 THEN DO:
                     ASSIGN
                         xxpk_qty = v_qty .
                 END.
                 ...
                 PUT UNFORMATTED xxpk_lot ";" xxpk_site ";" xxpk_part ";" xxpk_part_desc  ";" xxpk_article ";"  TODAY ";" xxpk_line ";" 
                                  xxpk_bg ";" xxpk_ed ";" xxpk_ord_qty ";" xxpk_qty SKIP.
              END.
              ELSE DO:
                 IF (v_qty - xxpk_qty) >= 0 THEN DO:
                     IF xxpk_ord_qty <> 0 AND (xxpk_qty MOD xxpk_ord_qty) > 0 THEN DO:
                         ASSIGN
                             xxpk_qty = (INT(TRUNCATE(xxpk_qty / xxpk_ord_qty,0)) + 1) * xxpk_ord_qty .
                     END.
                     ELSE DO:
                         ASSIGN
                             xxpk_qty = xxpk_qty .
                 ...
                 ELSE DO:
                     ASSIGN
                         xxpk_qty = 0 .
                 END.
                 v_qty = v_qty - xxpk_qty .
                 PUT UNFORMATTED xxpk_lot ";" xxpk_site ";" xxpk_part ";" xxpk_part_desc  ";" xxpk_article ";"  TODAY ";" xxpk_line ";" 
                                  xxpk_bg ";" xxpk_ed ";" xxpk_ord_qty ";" xxpk_qty SKIP.
              END.
          END.  /* for each xxpk_det */
          v_qty = 0.
       END.
   END.           
   /******************** SS - 20060915.1 - E ********************/
