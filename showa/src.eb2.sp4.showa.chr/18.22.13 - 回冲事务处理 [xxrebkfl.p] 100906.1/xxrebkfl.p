/* GUI CONVERTED from rebkfl.p (converter v1.76) Fri May  9 04:30:26 2003 */
...
/* $Revision: 1.43 $  BY: Mage.  DATE: 06/27/04 ECO: *zh001* */
/* SS - 100906.1  By: Roger Xiao */ /*cancel the pasue of message 161 */
...
message "this is one !!!" view-as alert-box.
...
message "this is two !!!" view-as alert-box.
pause.
   SS - 100906.1 - E */
/*zh001 add  end *******************************/
...
/* /*GUI*/ if global-beam-me-up then undo, leave.  */
         ...
         then do:
            ...
            for first op_hist
               fields(op_trnbr op_wo_lot op_wo_op)
