...
/*      skip(.1)     */
        ...
        skip(1)
	"★如果供应商备注未维护,则默认为周一到周五都为可送货日.请相关担当注意!★" colon 5
        skip(1)
	skip(.1)
...
MESSAGE "提示信息：已筛选" + STRING(n) +  "条记录 . . . . . .|| 正在汇总运算请等候 . . . . . . ."  .
...
/*&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& 修改时间: 07/12/13&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&*/                                                                                        
                          CREATE empty2.                               /*=====================================*/                                                     
	                          ...
	                          empty2_qty = empty1_qty               /* 记录中;如果不存在,就在表2中创建一条 */
                                  empty2_duedate = empty1_duedate.      /* 记录中;如果不存在,就在表2中创建一条 */ 
		          end.                                          /* 新的记录.                           */
		      else                                              /* 修改日期:   2007/12/10              */
		           empty2_qty = empty2_qty + empty1_qty.        /*=====================================*/
