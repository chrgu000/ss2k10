...
{mfdtitle.i "2+ "}
*/
{a6mfdtitle.i "091120.1"}
{cxcustom.i "APVORP.P"}

/* SS - 091120.1 - B */
{ssapvorp0002.i}

define input parameter i_batch like ap_batch.
define input parameter i_batch1 like ap_batch.
...
define input parameter i_apdate like ap_date.
define input parameter i_apdate1 like ap_date.
define input parameter i_effdate like ap_effdate.
define input parameter i_effdate1 like ap_effdate.
define input parameter i_open_only like ap_open.
define input parameter i_only_ers like mfc_logical.
define input parameter i_show_conf like mfc_logical.
define input parameter i_show_unconf like mfc_logical.
/*
define input parameter i_show_vph like mfc_logical.
define input parameter i_summary like mfc_logical.
define input parameter i_sort_by_vend like mfc_logical.
define input parameter i_gltrans like mfc_logical.
*/
...
only_ers = i_only_ers.
show_conf = i_show_conf.
show_unconf = i_show_unconf.
...
SS - 091120.1 - E */
   ...
   /* SS - 091120.1 - B */
   if sort_by_vend then do:
      {gprun.i ""ssapvorp0002a.p""}
   end.
   else do:
      {gprun.i ""ssapvorp0002b.p""}
   end.
   /* SS - 091120.1 - E */
