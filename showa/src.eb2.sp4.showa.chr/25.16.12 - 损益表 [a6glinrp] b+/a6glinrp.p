...
/*J23W**           end. **/
                ...
                {mfrtrail.i}
                    */
                    ...
                    PUT UNFORMATTED "Year" ";" YEAR(begdt[1]) SKIP.
                    PUT UNFORMATTED "Month" ";" MONTH(begdt[1]) SKIP.
                      */

                    PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glinrp" SKIP.
                    PUT UNFORMATTED "#def :end" SKIP.

                    EMPTY TEMP-TABLE tta6gl4inrp.
                    ...
                    {gprun.i ""a6gl4inrp.p"" "(
                      ...
                      /*
                    EXPORT DELIMITER ";" "格式位置" "账户" "说明" "余额一" "比率一" "余额二" "比率二" "余额三" "比率三" "余额四" "比率四".
                    */
                    FOR EACH tta6gl4inrp:
                        EXPORT DELIMITER ";" YEAR(begdt[1]) MONTH(begdt[1]) tta6gl4inrp_fpos tta6gl4inrp_code tta6gl4inrp_desc tta6gl4inrp_balance[1] tta6gl4inrp_pct[1] tta6gl4inrp_balance[2] tta6gl4inrp_pct[2] tta6gl4inrp_balance[3] tta6gl4inrp_pct[3] tta6gl4inrp_balance[4] tta6gl4inrp_pct[4].
                    END.
