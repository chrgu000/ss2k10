...
FOR EACH tt4 NO-LOCK BREAK BY tt4_drcr DESCENDING BY tt4_name :
  IF tt4_drcr = "借方" OR caps(tt4_drcr) = "DR" THEN DO:
     IF LAST-OF(tt4_name) THEN DO:
        v_amt1 = 0.
        FOR EACH tt NO-LOCK WHERE tt.tt_name = tt4.tt4_name AND tt.tt_drcr = tt4.tt4_drcr :
            v_amt1 = v_amt1 + tt.tt_amt .
        END.
        v_tot_amt1 = v_tot_amt1 + v_amt1 .
        CREATE tt3 .
...
FOR EACH tt4 NO-LOCK BREAK BY tt4_drcr DESCENDING BY tt4_name :
  IF tt4_drcr = "借方" OR caps(tt4_drcr) = "DR" THEN DO:
     IF LAST-OF(tt4_name) THEN DO:
        v_amt1 = 0.
        FOR EACH tt1 NO-LOCK WHERE tt1.tt1_name = tt4.tt4_name AND tt1.tt1_drcr = tt4.tt4_drcr :
