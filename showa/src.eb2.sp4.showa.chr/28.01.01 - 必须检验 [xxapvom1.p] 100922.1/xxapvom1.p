...
define new shared temp-table t_pvomstr no-undo
...
repeat with frame a:
   ...
   /* INITIALIZE THE TEMP TABLE t_pvomstr */
   empty temp-table t_pvomstr no-error.
...
PROCEDURE  p_create_vod_det:
   ...
   then
      ...
      for last vod_det
         fields (vod_acct   vod_amt vod_base_amt vod_cc  vod_desc   vod_dy_code
                 vod_entity vod_ln  vod_ref      vod_sub vod_tax_at vod_type)
         where vod_ref = apmstr.ap_ref
      no-lock:
         l_vchr_ln = vod_ln.
