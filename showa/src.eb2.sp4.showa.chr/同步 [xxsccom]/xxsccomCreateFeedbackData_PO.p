...
/* SS 091105.1 - B */
/*
修正了pod_user1的错误筛选条件 pod_user1 = "" 不考虑
超时同步的条件为pod_user2 <> "" and pod_user2 <> "90"
*/
/* SS 091105.1 - E */
