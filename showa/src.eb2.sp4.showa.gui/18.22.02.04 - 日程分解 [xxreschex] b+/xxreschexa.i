/* GUI CONVERTED from reschexa.i (converter v1.76) Tue Feb 18 21:01:13 2003 */
/* reschexa.i - REPETITIVE SELECTIVELY EXPLODE THE REPETITIVE SCHEDULE        */
/* Copyright 1986-2003 QAD Inc., Carpinteria, CA, USA.                        */
/* All rights reserved worldwide.  This is an unpublished work.               */
/* $Revision: 1.3 $                                                               */
/*V8:ConvertMode=Report                                                       */
/* $Revision: 1.3 $    BY: Sandeep Parab  DATE: 04/29/02  ECO: *N1HM*         */
/* $Revision: 1.3 $        BY: Vivek Gogte    DATE: 02/17/03  ECO: *N27D*         */
/* $Revision: 1.3 $        BY: Mage    DATE: 07/06/04 ECO: *N27D*             */
/******************************************************************************/
...
FORM /*GUI*/ 
         ...
         rps_qty_comp
         qty_open  
         with frame j  STREAM-IO /*GUI*/.
     setFrameLabels(frame j:handle).
/*zhxxx       end add *******************/
...
for each rps_mstr
   ...
   then do:
      ...
      then do:
         pause 0.
         {pxmsg.i
            &MSGTEXT="getTermLabel(""ITEM"",8) + "":"" + rps_part + "" "" +
                      getTermLabel(""SITE"",8) + "":"" + rps_site"}.
      end. /* IF report_yn ... */
   ...
   then do:
      ...
      then
         display
            ...
            pt_desc1
            rps_site
            rps_line WITH frame j STREAM-IO /*GUI*/ .
      ...
      display
         ...
         rps_qty_req
         rps_qty_comp
         qty_open WITH frame j STREAM-IO /*GUI*/ .
