...
find first brw_mstr exclusive-lock where brw_mstr.brw_name = 'xx001' no-error.
...
find first brwt_det exclusive-lock where brwt_det.brw_name = 'xx001' no-error.
...
find first brwf_det exclusive-lock where brwf_det.brw_name = 'xx001' and
