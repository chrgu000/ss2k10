/* ss - 110325.1 -b */  /* 修改-明细档*/
/* ss - 110421.1 by: jack */  /*   分割不修改 sod__chr01 */
/* ss - 111027.1 by: jack */  /* 分割差异 更新后清空 sod__dec01 = 0 */ 
...
/*                   SKIP                                                             */
        ...
        OUTPUT CLOSE .
         ...
         FIND FIRST sod_det WHERE sod_nbr = v_sonbr AND sod_line = v_i EXCLUSIVE-LOCK NO-ERROR .
          IF AVAILABLE sod_det  THEN DO: 
             IF t1_type = "y" THEN
             sod__chr01 = "1" .
             ELSE IF t1_type = "m" THEN
                 sod__chr01 = "2" .
             ELSE IF t1_type = "w"  THEN 
                 sod__chr01 = "3" .
         END.
       ss - 110421.1 -e */
         j = j + 1.
     ...
     /* ss - 110422.1 -b */
         ...
         ss - 111027.1 -e */
         /* ss - 111027.1 -b */
         FIND FIRST sod_det WHERE sod_nbr = v_sonbr AND sod_line = v_i AND sod_part = t1_part  NO-ERROR .
