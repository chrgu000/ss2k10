/* xxtpoadjmt.p - T type po order qty adjuestment maintenance                */
...
form
   usrw_key1 colon 25 format "x(32)" skip(2)
   usrw_key2 colon 25 format "x(18)"
   v_ptdesc1 no-label
   usrw_decfld[1] colon 25 format "->,>>>,>>>,>>9.9<"
   ...
   do on error undo, retry:
      ...
      editing:
         ...
         if recno <> ? then do:
            ...
            display usrw_key1 usrw_key2 v_ptdesc1 usrw_decfld[1].
         end.
      end. /* editing: */
