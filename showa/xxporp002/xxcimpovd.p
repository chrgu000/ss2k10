/* xxcimpovd.p - TAX TYPE MASTER MAINTENANCE                                    */
...
本程序兼容以下浏览:
  gp072 - 标准的通用代码主记录
  gp972 - 兼容的通用代码主记录,字段"code_cmmt"的值根据字段"code_cmmt"的值自动更新
...
*/
define variable fldname  like code_fldname initial "xxporp002.vdlist".
/* SS - 090910.1 - E */
