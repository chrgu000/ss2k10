/* xxppvpmt.p - VENDOR PART MAINTENANCE                                  */
...
form
   ...
   vp_curr        colon 25
   vp_q_price     colon 25   vp__dec01 colon 60
   vp_q_date      colon 25
   vp_q_qty       colon 25
   ...
   editing:
      ...
      if recno <> ? then do:
         ...
         display desc1 name
            ...
            vp_curr vp_q_price vp__dec01 vp_q_date vp_q_qty vp_pr_list
