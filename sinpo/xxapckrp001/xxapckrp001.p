...
repeat:
  ...
  */
   ...
   */
   ...
   PUT UNFORMATTED "ttxxapckrp0001: " SKIP.
   EXPORT DELIMITER ";" "ap_batch" "ck_bank" "ck_nbr" "ck_ref" "ap_vend"
                        "name" "ap_date" "ap_effdate" "ap_curr" "ap_ex_rate"
                        "ap_ex_rate2" "ap_entity" "ap_acct" "ap_sub"
                        "ap_cc" "ckstatus" "base_disp_amt" "ap_entity1"
                        "ckd_voucher" "ckd_type" "order" "rmks" "invoice"
                        "ckd_acct" "ckd_sub" "ckd_cc" "base_ckd_amt"
                        "base_disc" "ap_disc_acct" "ap_disc_sub" "ap_disc_cc"
                        "ap_rmk" "ck_voideff" "ckd_amt" "ckd_disc" "disp_amt".

   EXPORT DELIMITER ";" getTermLabel("BATCH",12)
                         getTermLabel("BANK",12)
                         getTermLabel("CHECK",12)
                         ...
                         getTermLabel("CASH_AMOUNT",12)
                         getTermLabel("ENTITY",12)
                         getTermLabel("VOUCHER",12)
                         getTermLabel("TYPE",12)
                         getTermLabel("ORDER",12)
                         getTermLabel("REMARKS",12)
                         getTermLabel("INVOICE_NUMBER",12)
                         getTermLabel("ACCOUNT",12)
                         getTermLabel("SUB-ACCOUNT",12)
                         getTermLabel("COST_CENTER",12)
                         getTermLabel("AP_AMOUNT",12)
                         getTermLabel("DISCOUNT_AMOUNT",12)
                         getTermLabel("DISCOUNT_ACCOUNT",12)
                         getTermLabel("DISC_SUB-ACCOUNT",12)
                         getTermLabel("DISC_COST_CTR",12)
                         getTermLabel("REMARK",12)
                         getTermLabel("VOID_EFF",12)
                         getTermLabel("AMOUNT",12)
                         getTermLabel("DISCOUNT_AMOUNT",12)
                         getTermLabel("AMOUNT",12).

   FOR EACH ttxxapckrp0001:
      EXPORT DELIMITER ";" ttxxapckrp0001.
   END.

   PUT UNFORMATTED "ttxxapckrp0001a: " SKIP.
   EXPORT DELIMITER ";" "entity" "acct" "sub" "cc" "project" "ref" "date"
                         "effdate" "ap_batch" "ap_type" "ap_ref" "ckd_type"
                         "ckd_voucher" "ap_vend" "amt" "rmks".
   EXPORT DELIMITER ";" getTermLabel("ENTITY",12)
                         getTermLabel("ACCOUNT",12)
                         getTermLabel("SUB-ACCOUNT",12)
                         getTermLabel("COST_CENTER",12)
                         getTermLabel("PROJECT",12)
                         getTermLabel("GL_REFERENCE",12)
                         getTermLabel("DATE",12)
                         getTermLabel("EFFECTIVE_DATE",12)
                         ...
                         getTermLabel("AMOUNT",12)
                         getTermLabel("REMARK",12).
   FOR EACH ttxxapckrp0001a:
      EXPORT DELIMITER ";" ttxxapckrp0001a.
   END.
