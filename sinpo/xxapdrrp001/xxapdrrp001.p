...
repeat:
    ...
    */
    ...
    EXPORT DELIMITER ";" "ck_bank" "bk_dftap_acct"	"bk_dftap_sub" 
    										  "bk_dftap_cc" "bk_dftap_desc" "ck_nbr" 
    										  "ck_type" "ap_vend" "name" 
                          "base_amt" "ap_acct" "ap_sub" "ap_date" 
                          "ap_effdate" "ap_due_date" "ck_clr_date" 
                          "ck_voideff" "ckstatus".
    EXPORT DELIMITER ";" getTermLabel("BANK",12) 
                          getTermLabel("DRAFTS_PAYABLE_ACCT",12)	
                          getTermLabel("DRAFTS_PAYABLE_SUB",12) 
    										  getTermLabel("COST_CENTER",12) 
    										  getTermLabel("DESCRIPTION",12) 
    										  getTermLabel("CHECK",12) 
    										  getTermLabel("CHECK_TYPE",12) 
                          ...
                          getTermLabel("CLEAR_DATE",12) 
                          getTermLabel("VOID_EFF",12) 
                          getTermLabel("STATUS",12).
    FOR EACH tta6apdrrp05:
        EXPORT DELIMITER ";" tta6apdrrp05.
    END.
