...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttxxapvorp0001.
   ...
   EXPORT DELIMITER ";" "vo_ref" "ap_date" "vd_remit" "ap_curr" "disp_curr"
                         "ap_amt" "vopo" "ap_effdate" "vo_ship"
                         "curr_disp_line1" "ap_acct" "ap_sub" "ap_cc"
                         "curr_disp_line2" "ap_vend" "vo_due_date"
                         "vo_invoice" "ap_bank" "vo_ndisc_amt" "name"
                         "vo_disc_date" "ap_entity" "vo_type" "vo_applied"
                         "flag" "ap_rmk" "ap_ckfrm" "vo_confirmed"
                         "vo_conf_by" "vo_hold_amt" "vo_is_ers" "remit_label"
                         "remit_name" "ap_batch" "vod_ln" "vod_acc" "vod_sub"
                         "vod_cc" "vod_project" "vod_entity" "vod_amt"
                         "vod_desc" "prh_receiver" "prh_line" "prh_nbr"
                         "prh_part" "prh_um" "prh_type" "prh_rcvd"
                         "inv_qty" "pur_amt" "prh_curr" "inv_amt" "vo_curr"
                         "pvod_trans_qty".
   EXPORT DELIMITER ";" getTermLabel("VOUCHER",12)
                         getTermLabel("DATE",12)
                         getTermLabel("REMIT-TO",12)
                         getTermLabel("CURRENCY",12)
                         getTermLabel("CURRENCY",12)
                         getTermLabel("AMOUNT",12)
                         getTermLabel("PO_NUMBER",12)
                         getTermLabel("EFFECTIVE_DATE",12)
                         getTermLabel("SHIP-TO",12)
                         getTermLabel("EXCHANGE_RATE",12)
                         ...
                         getTermLabel("INVOICE",12)
                         getTermLabel("BANK",12)
                         getTermLabel("NON-DISC_AMT",12)
                         getTermLabel("NAME",12)
                         getTermLabel("DISCOUNT_DATE",12)
                         getTermLabel("ENTITY",12)
                         getTermLabel("TYPE",12)
                         getTermLabel("AMOUNT_APPLIED",12)
                         getTermLabel("TOKEN",12)
                         getTermLabel("REMARK",12)
                         getTermLabel("CHECK_FORM",12)
                         getTermLabel("CONFIRMED",12)
                         getTermLabel("CONFIRMED_BY",12)
                         getTermLabel("HOLD_AMOUNT",12)
                         getTermLabel("ERS_VOUCHER",12)
                         getTermLabel("REMIT-TO",12)
                         getTermLabel("REMIT-TO_ADDRESS",12)
                         getTermLabel("BATCH",12)
                         getTermLabel("LINE",12)
                         getTermLabel("ACCOUNT",12)
                         getTermLabel("SUB-ACCOUNT",12)
                         getTermLabel("COST_CENTER",12)
                         getTermLabel("PROJECT",12)
                         getTermLabel("ENTITY",12)
                         getTermLabel("AMOUNT",12)
                         getTermLabel("DESCRIPTION",12)
                         getTermLabel("RECEIVER",12)
                         getTermLabel("LINE",12)
                         getTermLabel("PURCHASE_ORDER",12)
                         getTermLabel("ITEM_NUMBER",12)
                         getTermLabel("UNIT_OF_MEASURE",12)
                         getTermLabel("PURCHASE_TYPE",12)
                         getTermLabel("RECEIPT_QUANTITY",12)
                         getTermLabel("INVOICE_QUANTITY",12)
                         getTermLabel("PO_COST",12)
                         getTermLabel("CURRENCY",12)
                         getTermLabel("INVOICE_COST",12)
                         getTermLabel("CURRENCY",12)
                         getTermLabel("QUANTITY",12).
   FOR EACH ttxxapvorp0001:
      EXPORT DELIMITER ";" ttxxapvorp0001.
   END.
