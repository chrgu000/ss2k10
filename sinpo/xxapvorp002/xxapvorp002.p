...
repeat:
   ...
   */
   ...
   EMPTY TEMP-TABLE ttxxapvorp0002.

   {gprun.i ""xxapvorp0002.p"" "(
      input batch,
      input batch1,
      input ref,
      input ref1,
   ...
   EXPORT DELIMITER ";" "vo_ref" "ap_date" "vd_remit" "ap_curr" "disp_curr"
                         "ap_base_amt" "vopo" "ap_effdate" "vo_ship"
                         ...
                         "vo_conf_by" "vo_hold_amt" "vo_is_ers"
                         "remit_label" "remit_name" "ap_batch" "vod_ln"
                         "vod_acc" "vod_sub" "vod_cc" "vod_project"
                         "vod_entity" "vod_amt" "vod_desc" "ap_amt"
                         "ap_ex_rate" "ap_ex_rate2" "vod_amt".
   ...
   FOR EACH ttxxapvorp0002:
      EXPORT DELIMITER ";" ttxxapvorp0002.
   END.
