...
repeat:
   ...
   update batch batch1 nbr nbr1 addr addr1 cust cust1 entity entity1 cc cc1
   ...
   */
   ...
   EXPORT DELIMITER ";" "ar_batch" "ar_type" "ar_nbr" "type" "ar_bill" "name"
                         "ar_date" "ar_contested" "ar_entity" "ar_cr_terms"
                         "ar_curr" "ar_base_amt" "ar_amt" "ar_ex_rate"
                         "ar_ex_rate2" "ex_rate_relation1" "ar_effdate"
                         "ar_cust" "ar_tax_date" "ar_acct" "ar_sub"
                         "ar_cc" "ar_dun_level" "disp_curr" "disp_applied"
                         "ex_rate_relation2" "ar_po" "ar_due_date"
                         "ard_entity" "ard_acct" "ard_sub" "ard_cc"
                         "ard_project" "ard_base_amt" "ard_desc" "ard_amt".
   EXPORT DELIMITER ";" getTermLabel("BATCH",12)
                         ...
                         getTermLabel("CONTESTED",12)
                         getTermLabel("ENTITY",12)
                         getTermLabel("CREDIT_TERMS",12)
                         getTermLabel("CURRENCY",12)
                         getTermLabel("BASE_AMOUNT",12)
                         ...
                         getTermLabel("AMOUNT",12).
   FOR EACH ttssardrrp0001 where ttssardrrp0001_ar_cust >= addr and
           (ttssardrrp0001_ar_cust <= addr1 or addr1 = "") and
            ttssardrrp0001_ar_cc >= cc and
           (ttssardrrp0001_ar_cc <= cc1 or cc1 = ""):
      EXPORT DELIMITER ";" ttssardrrp0001.
   END.
