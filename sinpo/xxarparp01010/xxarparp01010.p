...
repeat:
   ...
   */
   {wbrp06.i &command = update &fields = "  batch batch1 check_nbr check1
          cust cust1 entity entity1 ardate ardate1 effdate effdate1
          base_rpt" &frm = "a"}
   /* SS - 100705.1 - E */
   ...
   */
   ...
   EMPTY TEMP-TABLE ttxxarparp0101.

   {gprun.i ""xxarparp0101.p"" "(
      INPUT BATCH,
      INPUT BATCH1,
      INPUT CHECK_nbr,
      INPUT CHECK1,
   ...
   EXPORT DELIMITER ";" "batch" "nbr" "bill" "name" "type" "check" "base_amt"
                         "date" "effdate" "entity" "acct" "sub" "cc" "po"
                         "ard_ref" "ard_type" "ard_entity" "ard_acct" "ard_sub"
                         "ard_cc" "disp_curr" "base_damt".
   EXPORT DELIMITER ";" getTermLabel("BATCH",12)
                         ...
                         getTermLabel("AMOUNT",12).
   FOR EACH ttxxarparp0101:
      EXPORT DELIMITER ";" ttxxarparp0101.
   END.
