...
$DLC/bin/_progres -b -rereadnolock -c 30 -d mdy -yy 1990 -Bt 350 -D 100 -mmax 3000 -nb 200 -s 128 -noshvarfix -pf /app/mfgpro/eb21/Demonstration.pf -p xxbmpsrp11au.p
