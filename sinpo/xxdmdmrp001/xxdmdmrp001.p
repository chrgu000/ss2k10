...
repeat:
/*dis   display disp_char1 with frame a.  */
   {&DMDMRP-P-TAG14}
   assign
      oldcurr  = ""
      old_curr = "".
...
/*dis   view frame a1.                         */
   ...
   empty temp-table xxdm_det no-error.
...
/*dis         with frame base_det.                  */
         ...
         create xxdm_det.
         assign xxdm_ar_entity         = v_ar_entity
                xxdm_ar_bank           = v_ar_bank
                xxdm_ar_batch          = v_ar_batch
                xxdm_ar_bill           = v_ar_bill
                xxdm_name              = v_name
                xxdm_ar_nbr            = v_ar_nbr
                xxdm_ar_acct           = v_ar_acct
                xxdm_ar_sub            = v_ar_sub
                xxdm_ar_cc             = v_ar_cc
                xxdm_ar_date           = v_ar_date
                xxdm_ar_effdate        = v_ar_effdate
                xxdm_ar_curr           = v_ar_curr
                xxdm_disp_curr         = v_disp_curr
                xxdm_base_amt          = v_base_amt
                xxdm_ex_rate_relation1 = v_ex_rate_relation1
                xxdm_ex_rate_relation2 = ex_rate_relation2
                xxem_statl             = v_statl
                xxdm_ar_due_date       = v_ar_due_date
                xxdm_ard_nbr           = ard_nbr
                xxdm_ard_acct          = v_ard_acct
                xxdm_ard_sub           = v_ard_sub
                xxdm_ard_cc            = v_ard_cc
                xxdm_base_open         = base_open
                xxdm_base_damt         = base_damt
                xxdm_base_disc         = base_disc
                xxdm_base_curr         = base_curr
                xxdm_artotal           = artotal.
         if     base_rpt = base_curr
            and ar_curr <> base_curr
         then do:
/*dis              display base_curr @ det_curr with frame base_det.   */
            assign xxdm_det_curr          = base_curr.
         end.
         else do:
/*dis            display ar_curr @ det_curr with frame base_det.     */
            assign xxdm_det_curr = ar_curr.
          end.
         {&DMDMRP-P-TAG12}
...
for each xxdm_det no-lock where 
				 xxdm_ard_cc >= cc and (xxdm_ard_cc <= cc1 or cc1 = ""):
         export delimiter ";" xxdm_det.
end.
