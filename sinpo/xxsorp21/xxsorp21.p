/* xxsorp21.p modify from xxsorp20.p remove some field from report    -- */
...
repeat on endkey undo, leave:
    ...
    put
        ...
        SS - 100913.1 - E */
        /* SS - 100913.1 - B  
        "销售订单;订单日期;客户编码;客户名称;公司代码;公司名称;推销员;物料编码;物料名称/规格;计量单位;订单数量;含税单价;含税金额;项次说明"
          SS - 100913.1 - E */
        /* SS - 100913.1 - B*/ 
        "销售订单;订单日期;录入人ID;录入人;公司代码;公司名称;推销员;物料编码;物料名称/规格;计量单位;订单数量;项次说明"
         /*SS - 100913.1 - E */
        at 1
        .
    for each so_mstr
