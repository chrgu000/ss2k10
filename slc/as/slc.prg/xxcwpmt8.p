...
/* SS 091020.1 - E */
      ...
      with frame a.
/* SS 091020.1 - B */
				if glc_user2 <> "" then disp yes @ ifcl with frame a.
...
/* SS 091020.1 - E */	 
   ...
   do:
   		if glc_user1 = "" then do:
   			message "挂账表没有关闭,不能修改" .
   		end.
   		else if ifcl then do:
   			message "已经关帐,不能修改".
   		end.
/* SS 091020.1 - B */
   		else do on error undo,retry:
   			update ifcl with frame a.
   			if ifcl then glc_user2 = "Y".
   		end.
/* SS 091020.1 - E */
   end. /* loopa */
end. /* mainloop */
