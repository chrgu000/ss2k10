...
/* ss 20080227 - e */
	...
	define variable xxqty34 like xxqty1.        /*换件入库*/
	define variable xxqty35 like xxqty1.         /*换件出库*/
	define variable xxqty36 like xxqty1.        /*换件入库（计划外入库）*/
	define variable xxqty37 like xxqty1.         /*换件其他出库*/
...
form
  ...
  xxqty34 column-label "换件入库"
  xxqty35 column-label "换件退货"
  xxqty37 column-label "其他出库"
...
/*      if (tr_type = "RCT-TR" and tr_program = "xxlotr04.p") then xxqty14 = xxqty14 + tr_qty_loc.  */
        ...
        if (tr_type = "ISS-WO" and tr_program = "xxhuanjn.p") then xxqty34 = xxqty34 + tr_qty_loc.
        if (tr_type = "ISS-UNP" and tr_program = "xxicunis1.p") then xxqty35 = xxqty35 - tr_qty_loc.  
        if (tr_type = "RCT-UNP" and tr_program = "xxicunrc.p" and tr_rmks begins "换件") then xxqty36 = xxqty36 + tr_qty_loc.  
        if (tr_type = "ISS-UNP" and tr_program = "xxicunis.p" and tr_rmks begins "品") then xxqty37 = xxqty37 - tr_qty_loc.
/************************end***************************************************/				
			end.
...
/*				  
				...
				xxqty4 = xxqty8.
*/
				xxqty5 = xxqty8 - xxqty9 + xxqty10 + xxqty4.
				
				/*送货数小计*/
				xxqty24 = xxqty11 - xxqty23.
				/*小领料小计*/
				xxqty29 = xxqty25 + xxqty26 + xxqty27 + xxqty28 + xxqty33.
				/*领用小计*/
				xxqty31 = xxqty29 + xxqty16 + xxqty19 + xxqty30 + xxqty32.
				
				xxqty1 = xxqty5 + xxqty35 + xxqty37 - xxqty34 - xxqty36.
