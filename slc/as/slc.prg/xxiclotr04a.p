...
/* By: Neil Gao Date: 07/04/17 ECO: * ss 20070417 * */
/*-Revision end---------------------------------------------------------------*/
/*****************************************************************************/
...
/* ss 20070417.1 - b */
		...
		editing:
			{mfnp.i usrw_wkfl lcsn
							"usrw_domain = global_domain and usrw_key1 = 'lcsnLz'  and usrw_key2"
...
/*SS 20081210 - B*/
			if recno <> ? then 
			{gprun.i ""xxdpcmmt.p"" "(input pt_part)"}
/*SS 20081210 - B*/
   end.
   status input.
