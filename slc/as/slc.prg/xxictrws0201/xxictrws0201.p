...
/* $Revision: 1.32 $      BY: ken    chen        DATE: 08/06/08 ECO: *SS - 20080806.1*    */
/*-Revision end---------------------------------------------------------------*/
...
repeat:
   ...
   display site site1 eff_date  with frame a.
   ...
   /* Check LOC Security */
   {gprun.i ""xxgploca.p""
            "(site,loc_from,recid(si_mstr), output return_int)"}
   if return_int = 0 then do:
