...
/*SS 20080807 - B*/
		...
		if not avail tt_tb then leave.
		else if tt_f1 = "@@end" then do:
			find first tt_tb where tt_sel = 1 no-error.
			delete tt_tb.
			leave.
		end.
/*SS 20080807 - E*/
...
/*SS 20080805 - B*/
					find first tt_tb where tt_sel = 4 no-error.
					if not avail tt_tb then return.
					input through echo value(entry(2,tt_f1)) no-echo.
/*SS 20080805 - E*/
...
/*SS 20080804 - B*/
			...
			for each xtsod_det where recid(xtsod_det) = tt_recid:
				delete xtsod_det.
			end.
			delete tt_tb.
			leave.
