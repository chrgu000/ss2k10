...
*/
											wonbrs[dwn - mindwn + 1] = entry(1,wo_so_job,"&").
/*SS 20080925 - E*/
...
/*SS 20080926 - B*/
                   	find wo_mstr exclusive-lock where recid(wo_mstr) = worecno[dwn] no-error.
                    if available wo_mstr then do:
                    	nbr = entry(1,wonbrs[dwn],"&").
