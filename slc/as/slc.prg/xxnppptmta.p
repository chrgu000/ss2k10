...
/*SS 20081217 - B*/
					...
					hide frame a1 no-pause.
					{gprun.i ""xxgpcmmt.p"" "(input pt_part,input 'CH',input 'SC')"}
					if pt_desc1 <> "" or pt_desc2 <> "" then do:
						...
						if avail cd_det then do:
							pt_desc1 = substring(cd_cmmt[1],1,12).
							pt_desc2 = substring(cd_cmmt[2],1,12).
						end.
					end.
/*SS 20081217 - E*/
