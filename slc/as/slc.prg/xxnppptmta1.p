...
/*SS 20080912 - B*/
if new_part then do:
	disp "DEF" @ pt_prod_line "AC" @ pt_status	with frame a1.
end.
if new_part and pt_draw = ""  and pt_part < "9zzz" then do:
	disp substring(pt_part,1,9) @ pt_draw with frame a1.
end.
/*SS 20080912 - E*/
