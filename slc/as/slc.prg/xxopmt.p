...
define variable fldname  like xxcode_fldname initial "xxop".
define variable codedesc  like code_cmmt.

/* DISPLAY SELECTION FORM */
form
	 xxcode_nbr   label "工艺" colon 25
	 skip(1)
   xxcode_value label "工序" colon 25 format "x(16)"
...
/*SS 20080905 - B*/
		find first code_mstr where code_domain = global_domain and code_fldname = "xxgx" and code_value = input xxcode_value no-lock no-error.
		if avail code_mstr then disp code_cmmt @ xxcode_cmmt with frame a.
		else do:
			message "工序不存在".
			undo,retry.
		end.
