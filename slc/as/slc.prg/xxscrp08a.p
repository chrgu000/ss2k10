...
define variable v_yn            as integer label "周期" column-label "周期"        no-undo.
...
define shared var leave_rmks as logical no-undo.
...
/* GET NEXT GRS REQUISITION NBR IF RELEASE_ALL = YES */
      ...
      /*V8-*/
         ...
         &exit-flag = true
         &record-id = tt_recid
         &cursorup =  "  {xxscrp0801.i}
         							"
         &cursordown = " {xxscrp0801.i}
         							 "
       	}
       	...
       	if keyfunction(lastkey) = "return" then do:
       		...
       		{gprun.i ""xxmgpcmmt.p"" "(input tt-nbr , input tt-line)"}
					{gprun.i ""xxmbomrp.p"" "(input tt-nbr , input tt-line)"}
					*/
					view frame bb.
       		{xxscrp0801.i}
