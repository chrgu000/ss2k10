...
define variable wonbrs          as character extent 9 no-undo.
define variable wolots          as character extent 9 no-undo.
...
define variable approve         like mfc_logical extent 9    no-undo.
...
define variable v_date like sod_req_date no-undo.
define variable v_desc as character format "x(48)".

define variable v_mes  as character format "x(40)".
...
define  shared temp-table tt-rqm-mstr no-undo
    field tt-dwn    as integer
    field tt-nbr    like sod_nbr
    field tt-line   like sod_line
    field tt-cffw-nbr as characte
    field tt-req-date like sod_req_date
    field tt-due-date like sod_due_date
    field tt-pur-lt   as integer
    field tt-wo-lt   as integer
    field tt-part   like sod_part
    field tt-status    like pt_status
    field tt-yn     like mfc_logical
    field tt-rt     as character
    field tt-desc   as character format "x(48)"
...
remarks_text = getTermLabel("MRP_PLANNED_ORDER",23).
      ...
      /*V8-*/
         ...
         &exit-flag = true
         &record-id = tt_recid
         &cursorup =  "  {xxscrp0901.i}
         							"
         &cursordown = " {xxscrp0901.i}
         							 "
       	}
