...
FORM  HEADER
  "隆鑫工业公司四轮车本部" at 40
	"计划外出库单" at 44 skip(1)
	"领用部门:" at 1 tr_rmks
	"制单日期:" at 35 today string(time,"hh:mm am")                             
	"单据号:" at 75 usrw_key2 format "x(11)"
...
/*	find first cp_mstr where cp_domain = global_domain and cp_cust = "c0001" and cp_part = tr_part no-lock no-error.    */
	...
	xxtemp = tr_qty_loc * (-1).
					...
					disp 	
					    tr_part label "物料编号" 
					    vp_vend_part label "旧号" format "x(16)" when avail vp_mstr
					    tpt_mstr.pt_desc1 format "x(12)" label "旧机型" when avail tpt_mstr 
					    begin_qty label "期初" 
							xxtemp  label "出库数量" 
							after_qty label "结存数"  
							tr_loc column-label "库位" format "x(4)"
							tr_serial label "批序号" format "x(15)"
      ...
      do:
      	put "-------------" at 65 skip.
      	put "合计:" at 65 string(totalnum)  skip.
			  put "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" skip.
				put "领用人:" at 1.
	      put "帐务员:" at 45 trim(usr_name).
	      put "配料员:" at 80 skip.
	      put "[白联：存根 红联：财务 黄联：配料员]".
