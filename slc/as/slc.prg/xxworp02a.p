...
for each usrw_wkfl where usrw_domain = global_domain and usrw_key1 = sntype and
  ...
  find first xxsob_det where xxsob_domain = global_domain and xxsob_nbr = wo_so_job and xxsob_parent = wo_part and xxsob_part = tr_part and xxsob_line = int(substring(wo_nbr,9)) no-lock no-error.
...
FORM  HEADER
    "隆鑫工业有限公司四轮车本部" at 40 skip
		"零部件发料清单" at 44 skip(1)
		"加工单号:"   at 1  tr_nbr format "x(11)"
		"ID:"         at 25 trim(tr_lot)
		"发料库位:"   at 40 tr_loc
		"客户:" at 61 xxcust                         
		"制单日期:" at 85  today string(time,"hh:mm am") skip          
