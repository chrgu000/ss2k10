...
/* ss 20071128 - b */
			disp iptlot @ wrlot with frame a.
/* ss 20071128 - e */
...
*/		
			do transaction :
		  	{gprun.i ""xxwoworl1.p""}
		  	find first wo_mstr where wo_domain = global_domain and wo_lot = iptlot 
					and wo_status = "R" no-error.
				if avail wo_mstr then do:
					find first xxseq_mstr where xxseq_domain = global_domain and xxseq_priority = iptpriority no-error.
