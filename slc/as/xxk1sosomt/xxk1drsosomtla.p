...
/*By: Neil Gao 08/08/07 ECO: *SS 20080807* */
/*By: Neil Gao 08/11/05 ECO: *SS 20081105* */
...
/*SS 20080807 - B*/
{xxdrsomt.i}
find first tt_tb where tt_sel = 4 no-error.
if not avail tt_tb then return.
/*SS 20080807 - E*/
...
/*SS 20080805 - B*/
								input through echo value(entry(3,tt_f1)) no-echo.
/*SS 20080805 - E*/
               set
...
SS - 100620.1 - E */
/* SS - 100620.1 - B */
            input through echo value(entry(4,tt_f1)) no-echo.
            update
               sod_list_pr
            with frame c.
            input close.
...
/*SS 20081105 - B*/
				/*if xxglobal_site = "SLC" then do:*/
					...
					if avail pt_mstr and pt_pm_code = "M" then do:
						{gprun.i ""xxsosomtlbx01.p"" "(input sod_det.sod_nbr ,input sod_det.sod_line,input so_cust)"}
					end.
				/*end.*/
/*SS 20081105 - E*/
