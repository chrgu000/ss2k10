...
define buffer xxcffwmstr for xxcffw_mstr.
	...
	for each xxcffw_mstr where xxcffw_key1 = iptf1 and xxcffw_key_nbr = iptnbr and xxcffw_nbr = iptbz :
    ...
    assign 	xxcffwh_key1 = xxcffw_key1
		...
		if iptyn then do:	
				...
				for each xxcff_mstr where xxcff_key1 = iptf1 and xxcff_key_nbr = iptnbr and xxcff_nbr = iptbz 
					and xxcff_key_line = xxcffw_mstr.xxcffw_key_line:
					delete xxcff_mstr.
				end.
				do i = 1 to num-entries(xxentry) :
					find first xxcffwmstr where xxcffwmstr.xxcffw_key1 = iptf1 and xxcffwmstr.xxcffw_key_nbr = xxcffw_mstr.xxcffw_key_nbr 
			...
			if iptrt = "0" then do:
				for each xxcff_mstr where xxcff_key1 = iptf1 and xxcff_key_nbr = xxcffw_mstr.xxcffw_key_nbr
					and xxcff_key_line = xxcffw_mstr.xxcffw_key_line :
						delete xxcff_mstr.
				end.
			end.
