...
/* DEFINE RNDMTHD FOR CALL TO xxSOMTLA03.P */
...
repeat on endkey undo, leave:
   ...
   repeat with frame c down on endkey undo, next linefmt:
      ...
      if not del-yn then do:
         ...
         /* VARIABLE TO THE CALL TO xxsomtla03.p.                    */
         {gprun.i ""xxsomtla03.p""
            "(input this-is-rma,
              input rma-recno,
      ...
      if del-yn = yes then do:
         ...
         /* save_parent_list DETERMINED IN xxsomtla03.p */
...
/* ------------------------------------------------------------------
 * Purpose:     Check return key from xxsomtla03.p call.
