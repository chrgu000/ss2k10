/* xxsomtla03.p - SALES ORDER MAINTENANCE LINE PRICE/QTY SUBROUTINE           */
/* REVISION:101026.1 LAST MODIFIED: 10/26/10 BY: zy              *aq*         */
/*-Revision end---------------------------------------------------------------*/
...
/*aq*/   0 @ sod_price
   ...
   if del-yn then hide frame rsn.
      ...
      if new sod_det and available pt_mstr then
         assign
/*aq*/ /*  sod_price = sod_price * sod_um_conv      */
/*aq*/ /*  sod_list_pr = sod_list_pr * sod_um_conv. */
/*aq*/     sod_price = 0
/*aq*/     sod_list_pr = 0.
...
/*aq*/ /*   sod_pr_list    when (rma-issue-line)  */
         with frame line_pop.
         {&SOSOMTLA-P-TAG9}
      ...
      if rma-issue-line and (line_pricing or reprice_dtl) then do:
         ...
         assign
/*aq*/ /*   sod_list_pr = best_list_price   */
/*aq*/ /*   sod_price   = best_list_price.  */
/*aq*/      sod_list_pr = 0
/*aq*/      sod_price   = 0.
         ...
         then do:
            ...
            assign
/*aq*/ /*      sod_list_pr     = (100 + sod_crt_int) / 100 * sod_list_pr */
/*aq*/ /*      sod_price       = sod_list_pr                             */
/*aq*/ /*      best_list_price = sod_list_pr.                            */
/*aq*/         sod_list_pr     = 0
/*aq*/         sod_price       = 0
/*aq*/         best_list_price = 0.
      ...
      then do:
         ...
         assign
/*aq*/ /*   sod_price    = best_net_price                            */
/*aq*/ /*   sod_list_pr  = best_list_price                           */
/*aq*/ /*   sod_disc_pct = if sod_list_pr <> 0 then                  */
/*aq*/ /*                     (1 - (sod_price / sod_list_pr)) * 100  */
/*aq*/ /*                  else                                      */
/*aq*/ /*                     0.                                     */
            sod_price    = 0
            sod_list_pr  = 0
            ...
            if pic_disc_comb = "1" then do:
               ...
               if sys_disc_fact = 1 then
                  ...
                  if sys_disc_fact <> 0 then
                     assign
/*aq*/  /*              discount      = (100 - new_disc_pct) / 100           */
/*aq*/                  discount      = 0
...
/*aq*/ /*      sod_price = sod_list_pr * (1 - (new_disc_pct / 100)). */
               sod_price = 0.
         ...
         if disc_min_max then
            assign
/*aq*/ /*       sod_disc_pct = if pic_so_fact then                      */
/*aq*/ /*                         (1 - discount) * 100                  */
/*aq*/ /*                      else                                     */
/*aq*/ /*                         discount                              */
/*aq*/ /*       sod_price = sod_list_pr * (1 - (sod_disc_pct / 100)).   */
/*aq*/          sod_disc_pct = 0
/*aq*/          sod_price    = 0.
...
/*aq*/ /* if new_order or reprice_dtl then                                    */
/*aq*/ /*    update                                                           */
/*aq*/ /*       sod_list_pr                                                   */
/*aq*/ /*       discount                                                      */
/*aq*/ /*          /* RMA-ISSUE-LINE APPLIES TO BOTH RMAs AND SOs HERE */     */
/*aq*/ /*          when (rma-issue-line or restock-pct = 0 or                 */
/*aq*/ /*                rmd_sv_code <> rma_ctype)                            */
/*aq*/ /*          validate({gppswd1.v &field=""sod_disc_pct""                */
/*aq*/ /*                              &field1="discount"}, l_err_msg)        */
/*aq*/ /*    with frame c.                                                    */
...
/*aq*/               sod_price = 0.
                  ...
                  assign
/*aq*/ /*            discount = if sod_list_pr <> 0 then                  */
/*aq*/ /*                          100 * (sod_list_pr - sod_price)        */
/*aq*/ /*                          / sod_list_pr                          */
/*aq*/ /*                       else 0                                    */
                     discount = 0
