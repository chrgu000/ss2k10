/* xxsomt113.p - SALES ORDER MAINTENANCE                                      */
...
/*ar*/ /* {sosomt02.i}  /* FORM DEFINITIONS FOR SHARED FRAMES A AND B */ */
/*ar*/ {xxsomt0213.i}
...
/*ar*/ /*  {gprun.i ""sosomta1.p""     */
/*ar*/ /*     "(input this-is-rma,     */
/*ar*/ /*       output return_int,     */
/*ar*/ /*        output rma-recno)"}   */

/*ar*/     {gprun.i ""xxsomta113.p""    
/*ar*/        "(input this-is-rma,    
/*ar*/          output return_int,    
/*ar*/           output rma-recno)"}  
   ...
   for first so_mstr
      fields(so_domain so_ar_acct so_ar_cc so_ar_sub so_bill so_bol
             ...
             so_print_so so_project so_pr_list so_pst_pct so__dte01
