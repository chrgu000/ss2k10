...
form
   ...
   /* ss - 091013.1 -b */
    ...
    ss - 110106.1 -e */
    /* ss - 110106.1 -b */
    v_check LABEL "检验输出"   COLON 16 "1 查询检验合格 2 不合格 3 未检验 空为全部" 
   /* ss - 110106.1 -e */
    "备注：报表包括退货" COLON 16
 /* ss - 091013.1 -e */
          ...
          ELSE DO:
             ...
             /* ss - 110106.1 -e */
               ...
               /* ss - 110106.1 -b */
                  ...
                  ELSE DO:
                       FIND FIRST xxmqp_det WHERE  xxmqp_receiver = tr_lot AND xxmqp_line = tr_Line AND  xxmqp_rcp_date = tr_effdate AND xxmqp_vend = tr_addr AND xxmqp_part = tr_part AND
                        xxmqp_serial = tr_serial /* ss - 110113.1 -b AND xxmqp_status = "" ss - 110113.1 -e */ NO-LOCK NO-ERROR .
                      IF AVAILABLE xxmqp_det /* ss - 110113.1 -b */ AND xxmqp_status = "" /* ss - 110113.1 -e */  THEN do:
                          ...
                          /* ss - 091110.1 -e */
                       END.
                       ELSE /* ss - 110113.1 -b */ IF NOT AVAILABLE xxmqp_det THEN /* ss - 110113.1 -e */ DO:
                         create tt .
            		      assign
            		             tt_addr = tr_addr
            			     tt_receiver = tr_lot
