...
/* $Revision: 1.11 $ BY: Bill Jiang DATE: 08/13/07 ECO: *SS - 081218.1* */
/*-Revision end---------------------------------------------------------------*/
...
*/
define variable fldname  like code_fldname initial "SoftspeedBarcode_displayLine6.".
fldname = fldname + GLOBAL_user_lang.
/* SS - 081218.1 - E */
