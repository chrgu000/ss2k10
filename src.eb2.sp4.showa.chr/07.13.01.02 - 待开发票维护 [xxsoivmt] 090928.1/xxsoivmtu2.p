/* soivmtu2.p - SALES ORDER MAINTENANCE INVENTORY UPDATE SUBROUTINE     */
...
do on error undo, retry:
   ...
   if change_db then do:
      {gprun.i ""sohddb01.p""}  /* Set db pointer to SO db */
   end.
   ad_mod_del = "DELETE".
   {gprun.i ""sosotr01.p""}
   ...
   if change_db then do:
      {gprun.i ""sohddb02.p""}  /* Reset the db pointer to inv db */
   end.
