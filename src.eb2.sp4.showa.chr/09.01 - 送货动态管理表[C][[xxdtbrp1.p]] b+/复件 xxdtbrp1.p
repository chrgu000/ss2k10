...
REPEAT:
   ...
   /* 显示数据 */
   v_pcs = 0.
   FOR EACH tsod BREAK BY tsod_date1 BY tsod_time1 BY tsod_memo :
      ...
      ACCUMULATE tsod_qty (TOTAL BY tsod_date1 BY tsod_time1 BY tsod_memo) .
      ACCUMULATE INT(tsod_qty / tsod_pkg + 0.9999) (TOTAL BY tsod_date1 BY tsod_time1 BY tsod_memo) .
      v_pcs = v_pcs + 1.
