...
define variable onlyopen      as logical no-undo.
define variable onlyover      as logical no-undo.
define variable overdate      as date   no-undo.
...
/*minth*/   part1           colon 44 label {t001.i}
   ...
   release_date1     colon 44 label {t001.i}
    /*minth*/   onlyopen            colon 24 label "仅限未完成计划"
      /*minth*/   onlyover            colon 24 label "仅限超计划"
      /*minth*/   overdate            colon 24 label "超计划开始日期"
...
/*mage*/    { xxrelsrp92.i descending descending }
