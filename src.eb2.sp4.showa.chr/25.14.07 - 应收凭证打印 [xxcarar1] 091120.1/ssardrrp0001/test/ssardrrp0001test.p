...
/* $Revision: 1.11.1.21.1.1 $    BY: Manish Dani     DATE: 06/24/03  ECO: *P0VZ* */
...
repeat:
   ...
   for each ar_mstr where (ar_batch >= batch) and
      ...
      then do:
         ...
         for first cu_mstr
            fields (cu_curr cu_ex_rnd_acct cu_ex_rnd_cc
                    cu_ex_rnd_sub)
   ...
   EXPORT DELIMITER ";" "ar_batch" "ar_type" "ar_nbr" "type" "ar_bill" "name" "ar_date" "ar_contested" "ar_entity" "ar_cr_terms" "ar_curr" "ar_base_amt" "ar_amt" "ar_ex_rate" "ar_ex_rate2" "ex_rate_relation1" "ar_effdate" "ar_cust" "ar_tax_date" "ar_acct" "ar_sub" "ar_cc" "ar_dun_level" "disp_curr" "disp_applied" "ex_rate_relation2" "ar_po" "ar_due_date" "ard_entity" "ard_acct" "ard_sub" "ard_cc" "ard_project" "ard_base_amt" "ard_desc" "ard_amt".
