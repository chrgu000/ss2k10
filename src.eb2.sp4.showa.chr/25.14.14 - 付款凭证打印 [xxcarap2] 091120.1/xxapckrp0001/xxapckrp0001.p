...
define input parameter i_bank         like ck_bank.
define input parameter i_bank1        like ck_bank.
define input parameter i_ckfrm        like ap_ckfrm.
define input parameter i_ckfrm1       like ap_ckfrm.
...
define input parameter i_duedate      like vo_due_date.
define input parameter i_duedate1     like vo_due_date.
...
SS - 091120.1 - E */
   ...
   /* SS - 091120.1 - B */
   if sort_by_vend then do:
      {gprun.i ""xxapckrp0001b.p""}
   end.
   else do:
      {gprun.i ""xxapckrp0001a.p""}
   end.
   /* SS - 091120.1 - E */
