...
/*J3LF*/ define variable l_rep_total like mfc_logical no-undo.
     ...
     /*CHECK FOR VAT TAXES */
/*H0CH*/ find first gl_ctrl no-lock no-error.
...
/*FR77*/        ),
/*FR77*/    each vd_mstr where vd_addr = ap_vend and
/*FR77*/    (vd_type >= vdtype and vd_type <= vdtype1)
/*FR77*/    no-lock break by vd_sort by ap_ref
...
SS - 091120.1 - E */
/* SS - 091120.1 - B */
/*H0H8*/    {xxapckrp0001i.i &sort1="vd_sort"}
/* SS - 091120.1 - E */
