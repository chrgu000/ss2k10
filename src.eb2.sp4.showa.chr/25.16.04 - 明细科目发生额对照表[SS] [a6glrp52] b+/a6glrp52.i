...
DEF VAR v_ac_beg_amt LIKE gltr_amt.
DEF VAR v_ac_beg_curramt LIKE gltr_amt.
...
v_disptitle = "明细科目发生额对照表" + "(" + v_curr_desc1 + ")" .
...
IF subflag = NO AND ccflag = NO THEN DO:
    IF v_curr = YES THEN DO:
       ...
       PUT UNFORMATTED "编号" ";" "名称" ";" "编号" ";" "名称" ";"
                       ...
                       */
        /* 输出到BI */
        PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glrp521" SKIP.
    ...
    ELSE DO:
       ...
       PUT UNFORMATTED "编号" ";" "名称" ";" "编号" ";" "名称" ";"
                       ...
                       */
        /* 输出到BI */
        PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glrp522" SKIP.
        PUT UNFORMATTED "#def :end" SKIP.
    END.
   ...
   FOR EACH tt :
       ...
       */
       ...
       END.
       PUT UNFORMATTED v_disptitle ";" v_dispdate ";" tt_acc ";" tt_ac_desc ";"  tt_sub ";" tt_sb_desc ";"  tt_ctr ";"
                       tt_cc_desc ";" .
...
IF subflag = YES AND ccflag = NO THEN DO:
    IF v_curr = YES THEN DO:
       ...
       PUT UNFORMATTED "编号" ";" "名称" ";" 
                       ...
                       */
        /* 输出到BI */
        PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glrp523" SKIP.
        PUT UNFORMATTED "#def :end" SKIP.
    END.
    ELSE DO:
        /*
       ...
       PUT UNFORMATTED "编号" ";" "名称" ";" 
                       ...
                       */
        /* 输出到BI */
        PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glrp524" SKIP.
        PUT UNFORMATTED "#def :end" SKIP.
    END.
   ...
   FOR EACH tt BREAK BY tt_acc BY tt_ctr :
       ...
       IF LAST-OF(tt_ctr) THEN DO:
           ...
           END.
           PUT UNFORMATTED v_disptitle ";" v_dispdate ";"  tt_acc ";" tt_ac_desc ";"  tt_ctr ";" tt_cc_desc ";" .
           PUT UNFORMATTED tt_curr ";" .
           IF v_curr = YES THEN DO:
               IF v_beg_curramt >= 0 THEN PUT UNFORMATTED v_beg_curramt ";" ";" .
                                     ELSE PUT UNFORMATTED ";" ABS(v_beg_curramt) ";" .
...
IF subflag = NO AND ccflag = YES THEN DO:
   IF v_curr = YES THEN DO:
       ...
       PUT UNFORMATTED "编号" ";" "名称" ";" "编号" ";" "名称" ";" ";"
                          ...
                          */
        /* 输出到BI */
        PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glrp525" SKIP.
        PUT UNFORMATTED "#def :end" SKIP.
   END.
   ELSE DO:
       /*
       ...
       PUT UNFORMATTED "编号" ";" "名称" ";" "编号" ";" "名称" ";" ";"
                          ...
                          */
        /* 输出到BI */
        PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glrp526" SKIP.
        PUT UNFORMATTED "#def :end" SKIP.
   END.
   ...
   FOR EACH tt BREAK BY tt_acc BY tt_sub :
       ...
       IF LAST-OF(tt_sub) THEN DO:
           FOR EACH tt1 WHERE tt1_acc = tt_acc AND tt1_sub = tt_sub NO-LOCK :
               ...
               v_beg_curramt = v_beg_curramt + tt1_curramt .
           END.
           PUT UNFORMATTED v_disptitle ";" v_dispdate ";"  tt_acc ";" tt_ac_desc ";"  tt_sub ";" tt_sb_desc ";" .
           PUT UNFORMATTED tt_curr ";" .
...
IF subflag = YES AND ccflag = YES THEN DO:
   IF v_curr = YES THEN DO:
       ...
       PUT UNFORMATTED "编号" ";" "名称" ";" ";"                   
                       ...
                       */
        /* 输出到BI */
        PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glrp527" SKIP.
        PUT UNFORMATTED "#def :end" SKIP.
   END.
   ELSE DO:
       /*
      ...
      PUT UNFORMATTED "编号" ";" "名称" ";" ";"                   
              ...
              */
        /* 输出到BI */
        PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glrp528" SKIP.
        PUT UNFORMATTED "#def :end" SKIP.
   END.
   ...
   FOR EACH tt BREAK BY tt_acc  :
       ...
       IF LAST-OF(tt_acc) THEN DO:
           FOR EACH tt1 WHERE tt1_acc = tt_acc NO-LOCK :
               ...
               v_beg_curramt = v_beg_curramt + tt1_curramt .
           END.
           PUT UNFORMATTED v_disptitle ";" v_dispdate ";"  tt_acc ";" tt_ac_desc ";"  .
           PUT UNFORMATTED tt_curr ";" .
