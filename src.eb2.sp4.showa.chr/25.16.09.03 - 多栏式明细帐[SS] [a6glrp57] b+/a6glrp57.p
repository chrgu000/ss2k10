...
/* ********** End Translatable Strings Definitions ********* */
          ...
          define new shared variable acc1 like ac_code NO-UNDO INIT "55029999".
...
/*L00M * END ADD*/
          ...
          form
              ...
              SKIP(1)                          
              inclpost      COLON 30 LABEL "Ä£ÄâÕÊ²¾Êä³ö"
              SKIP(1)
...
/*J241*/  for first co_ctrl fields (co_ret co_use_sub) no-lock: end.
          ...
          repeat:
            ...
            if c-application-mode <> 'web' then
               update entity entity1 cname  acc 
                      sub when (use_sub)
                      sub1 when (use_sub)
                      ctr 
                      ctr1
            ...
            {wbrp06.i &command = update &fields = "  entity entity1 cname
               acc  sub when (use_sub)  sub1 when (use_sub)   ctr ctr1
             effdate effdate1 inclpost
             " &frm = "a"}
               /* SS - 20060210 - E */
