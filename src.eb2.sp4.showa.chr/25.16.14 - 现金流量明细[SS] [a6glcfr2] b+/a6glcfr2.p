...
DEFINE VARIABLE inclpost AS LOGICAL INIT NO .
...
/* REPORT BLOCK */
         ...
         repeat:
            display entity begdt
               enddt
               inclpost LABEL "模拟帐簿输出"
            with frame a.

            if c-application-mode <> 'web':u then
               set entity begdt enddt inclpost
                with frame a.

            {wbrp06.i &command = set &fields = "  entity begdt enddt inclpost
             " &frm = "a"}
           ...
           /* 输出到BI */
           PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glcfr2" SKIP.
           PUT UNFORMATTED "#def :end" SKIP.

           PUT UNFORMATTED "Year" ";" string(YEAR(begdt)) ";" ";" ";" ";" ";" ";" ";" SKIP.
           PUT UNFORMATTED "Month" ";" string(MONTH(begdt)) ";" ";" ";" ";" ";" ";" ";" SKIP.
          ...
          */
          ...
          FOR EACH wt1 NO-LOCK BY wt1_acc BY wt1_acct BY wt1_sub
              BY wt1_d_acct BY wt1_d_sub BY wt1_ref :
                EXPORT DELIMITER ";" wt1_acc wt1_acct wt1_sub wt1_d_acct wt1_d_sub wt1_amt 
                    wt1_ref wt1_line wt1_desc  . 
          END.
