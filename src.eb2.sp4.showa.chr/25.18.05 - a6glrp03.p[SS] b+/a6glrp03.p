...
/* ********** End Translatable Strings Definitions ********* */
          ...
          define new shared variable acc like ac_code NO-UNDO INIT "4105".
          define new shared variable acc1 like ac_code NO-UNDO INIT "41059999".
...
/*J241*/  for first co_ctrl fields (co_ret co_use_sub) no-lock: end.
          ...
          IF MONTH(TODAY) = 1 THEN DO:
             begdt[1] = DATE(12,1,YEAR(TODAY) - 1).
          END.
          ELSE DO:
             begdt[1] = DATE(MONTH(TODAY) - 1,1,YEAR(TODAY)).
          END.
          enddt[1] = DATE(MONTH(TODAY),1,YEAR(TODAY)) - 1.
          begdt[2] = DATE(1,1,YEAR(TODAY)).
          enddt[2] = DATE(MONTH(TODAY),1,YEAR(TODAY)) - 1.
          /* SS - 20060210 - E */
