...
DEF VAR fn_me AS CHAR FORMAT "x(30)" INIT "/tmp/test/cim.txt" .
DEF VAR fn_error AS CHAR FORMAT "x(30)" INIT "/tmp/test/ap_err.txt" .
...
FORM
    ...
    "项次，发票数量，发票成本，已结项, 编辑税明细，暂留金额， 已确认，承办人"
    SKIP(1)
...
v_entity = gl_entity .
  ...
  repeat:
      ...
      import delimiter "," tt_batch tt_ref tt_po tt_vend tt_effdate tt_invoice tt_date tt_cr_terms tt_receiver tt_line tt_inv_qty tt_curr_amt 
             tt_close_pvo tt_tax_edit tt_hold_amt tt_confirmed tt_qad01 .
