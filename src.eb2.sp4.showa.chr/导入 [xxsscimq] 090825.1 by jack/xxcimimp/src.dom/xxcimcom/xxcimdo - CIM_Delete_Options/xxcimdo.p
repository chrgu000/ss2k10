...
/* $Revision: 1.11 $ BY: Bill Jiang DATE: 08/13/07 ECO: *SS - 081222.1* */
/* ss - 090825.1 by: jack */
/*-Revision end---------------------------------------------------------------*/
...
*/
define variable fldname  like code_fldname initial "CIM_Delete_Options".
/* SS - 081222.1 - E */
...
repeat with frame a:
   ...
   */
   ...
   do on error undo, retry:
      ...
      /* SS - 081222.1 - B */
      IF INDEX("AYN",CODE_desc) = 0 THEN DO:
         /* Invalid entry */
