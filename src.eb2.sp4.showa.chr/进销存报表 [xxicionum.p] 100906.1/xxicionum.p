...
/* SS - 100906.1  By: Roger Xiao */  /*frame pfloot 显示不正常*/
/*-Revision end---------------------------------------------------------------*/
...
FOR EACH ld_det 
    ...
    FORM HEADER
        "地点:"  at 5  ld_site   
        "库位:"  at 25  ld_loc   
        "期始日期:"  at 45 effdate   format "9999/99/99"   
        "期未日期:"  at 75  effdate1    format "9999/99/99"
...
/* SS - 100906.1 - B 
   ...
   SS - 100906.1 - E */
/* SS - 100906.1 - B */
    WITH  FRAME pfloot  WIDTH 200 SIDE-LABEL .
