...
OUTPUT TO VALUE("/home/mfg/micho/xxpo.txt").
...
PUT UNFORMATTED "1. npod_det begin" SKIP.
FOR EACH npod_det :
   EXPORT DELIMITER ";" npod_det .
END.
PUT UNFORMATTED "1. npod_det end" SKIP.
...
PUT UNFORMATTED "2. empty1 begin" SKIP.
FOR EACH empty1 :
   EXPORT DELIMITER ";" empty1 .
END.
PUT UNFORMATTED "2. empty1 end" SKIP.
...
FOR EACH empty1 break by empty1_part:                   /*FOR 2*/
    ...
    IF NOT AVAILABLE empty2 THEN do:   /*do a*/
...
PUT UNFORMATTED "3. empty1 begin" SKIP.
FOR EACH empty1 :
   EXPORT DELIMITER ";" empty1 .
END.
PUT UNFORMATTED "3. empty1 end" SKIP.

PUT UNFORMATTED "4. empty2 begin" SKIP.
FOR EACH empty2 :
   EXPORT DELIMITER ";" empty2 .
END.
PUT UNFORMATTED "4. empty2 end" SKIP.
...
PUT UNFORMATTED "5. npod_det begin" SKIP.
FOR EACH npod_det :
   EXPORT DELIMITER ";" npod_det .
END.
PUT UNFORMATTED "5. npod_det end" SKIP.
