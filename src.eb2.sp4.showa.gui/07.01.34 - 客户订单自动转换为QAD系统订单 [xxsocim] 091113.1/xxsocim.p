...
/* ss - 090909.1 by: jack */
/* ss - 090914.1 by: jack */ /* cim格式修改 ，客户化价格不输入*/
/* ss - 090916.1 by: jack */
/* ss - 091008.1 by: jack */ /* 增加外币导入格式*/  /* 价格单控制设为警告*/
/* ss - 091010.1 by: jack */  /* 修改是否含税字段*/
/* ss - 091113.1 by: jack */  /* 取消税信息,自动按  pt_taxable关联是否含税*/
/*
{mfdtitle.i "2+ "}
*/
/* 
...
DEF VAR fn_me AS CHAR FORMAT "x(30)" INIT "d:\管理部\仓库\so_err.txt" .
DEF VAR fn_ok AS CHAR FORMAT "x(30)" INIT "d:\管理部\仓库\so_ok.txt" .
...
FORM
    ...
    */
    ...
    vv_ord_date COLON 20 LABEL "订单日期"     vv_ord_date1 COLON 50 LABEL {t001.i}
     ...
     /* ss - 090909.1 -b */ /* 价格单控制 */
	  ...
	  CREATE tte .
          ASSIGN 
              ...
              tte_cust = tt_cust
              tte_part = tt_part
              tte_desc = "客户零件未找到税用途信息，请在(1.4.9.2)菜单进行维护。"
              .
          ss - 090916.1 -e */
      /* ss - 091113.1 -b
	  /* ss - 090916.1 -b */
