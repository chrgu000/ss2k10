...
put unformat getTermLabel("ID",12) "~t"
             getTermLabel("RECID",12) "~t"
             getTermLabel("TYPE",12) "~t"
             getTermLabel("TABLE",12) "~t"
             getTermLabel("FIELDS",12) "~t"
             getTermLabel("AFTER",12) "~t"
             getTermLabel("BEFORE",12) "~t"
             getTermLabel("DOMAIN",12) "~t"
             getTermLabel("ITEM_NUMBER",12) "~t"
             getTermLabel("SITE",12) "~t"
             getTermLabel("NUMBER",12) "~t"
             getTermLabel("DEVICE",12) "~t"
             getTermLabel("HOST",12) "~t"
             getTermLabel("ENFORCE_OS_USER_ID",12) "~t"
             getTermLabel("USER",12) "~t"
             getTermLabel("DATE",12) "~t"
             getTermLabel("TIME",12) "~t"
             qad_charfld1[10] "~t"
             qad_charfld1[1] "~t"
             qad_charfld1[2] "~t"
             qad_charfld1[3] "~t"
             ...
             qad_charfld1[8] "~t"
             qad_charfld1[9] "~t"
             getTermLabel("INTERFACE_TYPE",12) "~t"
             getTermLabel("LOGIN_DATE",12) "~t"
             getTermLabel("LOGIN_TIME",12) "~t"
             getTermLabel("BEGINNING_DATE",12) "~t"
             getTermLabel("PROGRAM",12) "~t"
             getTermLabel("PROGRAM_STACK",12) "~t"skip.
