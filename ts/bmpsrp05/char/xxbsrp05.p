   ...
   then
      ...
      for first pt_mstr
         fields( pt_domain pt_bom_code pt_buyer   pt_desc1     pt_desc2
                pt_part  pt_vend   pt_pm_code pt_prod_line pt_um)
      ...
      repeat with frame b:
         ...
         then do:
            ...
            for first ptp_det
               fields( ptp_domain ptp_vend ptp_bom_code ptp_buyer ptp_part ptp_pm_code ptp_phantom
               ptp_site)
            ...
            then
               for each pk_det
                  ...
                  then do:
                     ...
                     for first ptp_det
                        fields( ptp_domain ptp_vend ptp_bom_code ptp_buyer ptp_part ptp_phantom
