...
repeat:
   ...
   */
   ...
   EXPORT DELIMITER ";" "地点" "库位" "物料号" "批/序号" "参考号" "说明" "ABC" "库存量" "UM" "总账成本" "总账成本合计" "非寄售" "客户寄售" "供应商寄售".
   EXPORT DELIMITER ";" "标准输出" "标准输出" "标准输出" "扩展输出" "扩展输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "标准输出" "扩展输出" "扩展输出" "扩展输出".
   EXPORT DELIMITER ";" "site" "loc" "part" "lot" "ref" "desc" "abc" "qty" "um" "sct" "ext" "qty_non_consign" "qty_cust_consign" "qty_supp_consign".
   FOR EACH ttxxppptrp0701:
      EXPORT DELIMITER ";" ttxxppptrp0701.
   END.
