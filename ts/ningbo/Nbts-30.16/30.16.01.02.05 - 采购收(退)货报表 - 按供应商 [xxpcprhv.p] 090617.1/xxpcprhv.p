...
repeat:
   ...
   FOR EACH en_mstr NO-LOCK
      ...
      BY xxpcprh_vend
      :
      ACCUMULATE xxpcprh_qty (TOTAL BY xxpcprh_site BY xxpcprh_year BY xxpcprh_per BY xxpcprh_part BY xxpcprh_vend).
      ACCUMULATE xxpcprh_mtl_tot (TOTAL BY xxpcprh_site BY xxpcprh_year BY xxpcprh_per BY xxpcprh_part BY xxpcprh_vend).
      IF LAST-OF(xxpcprh_vend) THEN DO:
         EXPORT DELIMITER ";"
            xxpcprh_year
            xxpcprh_per
            si_site
            ...
            ad_addr
            ad_name
            (ACCUMULATE TOTAL BY xxpcprh_vend xxpcprh_qty)
            (ACCUMULATE TOTAL BY xxpcprh_vend xxpcprh_mtl_tot)
            ((ACCUMULATE TOTAL BY xxpcprh_vend xxpcprh_mtl_tot) / (ACCUMULATE TOTAL BY xxpcprh_vend xxpcprh_qty))
            .
