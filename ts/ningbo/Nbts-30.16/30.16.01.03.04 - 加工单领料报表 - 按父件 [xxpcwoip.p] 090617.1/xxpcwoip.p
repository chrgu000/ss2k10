...
repeat:
   ...
   FOR EACH en_mstr NO-LOCK
      ...
      BY xxpcwoi_comp
      :
      ACCUMULATE xxpcwoi_qty (TOTAL BY xxpcwoi_site BY xxpcwoi_year BY xxpcwoi_per BY xxpcwoi_par BY xxpcwoi_comp).

      IF LAST-OF(xxpcwoi_comp) THEN DO:
         EXPORT DELIMITER ";"
            xxpcwoi_year
            xxpcwoi_per
            si_site
            ...
            (ACCUMULATE TOTAL BY xxpcwoi_comp xxpcwoi_qty)
            .
      END.
   END.
