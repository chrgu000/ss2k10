...
/* SS - 090608.1 - B */
/* TODO: 字段名 */
define variable fldname  like code_fldname initial "SoftspeedPC_element".
...
repeat with frame a:
   ...
   editing:
      ...
      {mfnp01.i code_mstr code_value code_value
         ...
         code_fldval}
      if recno <> ? then
         display code_value code_desc CODE_user1.
   end.
   ...
   do on error undo, retry:
      ...
      set code_desc code_user1 go-on (F5 CTRL-D).

      /* SS - 090608.1 - B */
      /* TODO: 验证 */
      IF INDEX("12345",CODE_user1) = 0 THEN DO:
         /* Invalid entry */
         {pxmsg.i &MSGNUM=4509 &ERRORLEVEL=3}
         UNDO,RETRY.
      END.
