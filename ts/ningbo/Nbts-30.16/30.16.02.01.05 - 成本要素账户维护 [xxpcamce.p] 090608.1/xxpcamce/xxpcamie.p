...
注意,本程序因程序名而异:
  - xxpcamce.p: 成本要素账户维护
  - xxpcamin.p: 在库品间接成本账户维护
  - xxpcamwo.p: 在制品间接成本账户维护
  - xxpcamie.p: 间接费用账户维护
...
form
   ...
   glrd_acct      colon 25   glrd_acct1 colon 40 label "To"
...
IF execname = "xxpcamie.p" THEN DO:
   FIELD_mfc = "SoftspeedIC_glr_code_ie".
END.
ELSE IF execname = "xxpcamin.p" THEN DO:
   FIELD_mfc = "SoftspeedIC_glr_code_in".
END.
ELSE IF execname = "xxpcamwo.p" THEN DO:
   FIELD_mfc = "SoftspeedIC_glr_code_wo".
END.
ELSE IF execname = "xxpcamce.p" THEN DO:
   ...
   repeat with frame b:
      ...
      editing:
         ...
         {mfnp05.i glrd_det glrd_code " glrd_det.glrd_domain = global_domain
              ...
              glrd_fpos = 0" glrd_line glrd_line}
         ...
         then do:
            ...
            IF execname = "xxpcfmce.p" THEN DO:
               FIND FIRST CODE_mstr
                  ...
                  AND CODE_value = STRING(glrd_det.glrd_sums)
                  NO-LOCK NO-ERROR.
