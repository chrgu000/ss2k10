...
注意,本程序因程序名而异:
  - xxicarpt.p: 零件分配范围报表
  - xxicarpl.p: 产品线分配范围报表
  - xxicarcc.p: 适用于标准加工单的在制品成本中心分配范围报表
  - xxicarln.p: 适用于累计加工单的生产线分配范围报表
...
/*GN36*/  space(1)
      ...
      IF execname = "xxicarpt.p" THEN DO:
         FIELD_mfc = "SoftspeedIC_to_pt".
      END.
      ELSE IF execname = "xxicarpl.p" THEN DO:
         FIELD_mfc = "SoftspeedIC_to_pl".
      END.
      ELSE IF execname = "xxicarcc.p" THEN DO:
         FIELD_mfc = "SoftspeedIC_to_cc".
      END.
      ELSE IF execname = "xxicarln.p" THEN DO:
