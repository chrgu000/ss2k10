...
FOR EACH tt1
   ...
   REPEAT:
      ...
      */
      ...
      FIND FIRST glrd_det
         ...
         AND glrd_fpos = INTEGER(tt1_c1[5])
         AND glrd_fpos <> 0
         NO-LOCK NO-ERROR.
   ...
   FIND FIRST xxpcinc_det 
      ...
      AND xxpcinc_site = tt1_c1[1]
      AND xxpcinc_year = INTEGER(tt1_c1[2])
      AND xxpcinc_per = INTEGER(tt1_c1[3])
      AND xxpcinc_part = tt1_c1[4]
      AND xxpcinc_element = INTEGER(tt1_c1[5])
      NO-ERROR.
   IF NOT AVAILABLE xxpcinc_det THEN DO:
      CREATE xxpcinc_det.
      ASSIGN
         xxpcinc_domain = GLOBAL_domain
         xxpcinc_site = tt1_c1[1]
         xxpcinc_year = INTEGER(tt1_c1[2])
         xxpcinc_per = INTEGER(tt1_c1[3])
         xxpcinc_part = tt1_c1[4]
         xxpcinc_element = INTEGER(tt1_c1[5])
         .
   END.
   IF tt1_c1[6] <> "-" THEN DO:
      ASSIGN
         xxpcinc_beg = DECIMAL(tt1_c1[6])
         .
   END.
