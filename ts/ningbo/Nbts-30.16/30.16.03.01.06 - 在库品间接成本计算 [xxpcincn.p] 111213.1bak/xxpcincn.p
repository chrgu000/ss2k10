...
/* SS - 101217.1 By: Bill Jiang */
/* SS - 111213.1 By: Bill Jiang */

/* SS - 111213.1 - RNB
[111213.1]

包括移动项为"Yes"时, 可能存在如下 Bug:
1) 地点间库存转移合计不为0
2) 所有地点库存转移合计为0
            ...
            IF NOT AVAILABLE xxpctr_hist THEN DO:
               ...
               STOP.
					...
					ASSIGN
						...
						xxpctr_site = ttpt_site
						xxpctr_year = yr
						xxpctr_per = per
						xxpctr_part = ttpt_part
						xxpctr_type = ttpt_type
						.
					/* SS - 111213.1 - E */
            END.
            ASSIGN
