...
/* SS - 091013.1 By: Bill Jiang */

/* SS - 090906.1 - RNB
[090906.1]

1.自<在制品成本计算明细文件>(上期期末)复制,不含零记录
...
DEFINE BUFFER xxpcwocdet FOR xxpcwoc_det.
...
repeat:
   ...
   DO TRANSACTION ON STOP UNDO:
      ...
      FOR EACH en_mstr NO-LOCK
         ...
         WHERE xxpcwoc_domain = GLOBAL_domain
         AND xxpcwoc_site = si_site
         AND xxpcwoc_year = yr1
         AND xxpcwoc_per = per1
         :
         IF xxpcwoc_end <> 0 THEN DO:
            FIND FIRST xxpcwocdet
               WHERE xxpcwocdet.xxpcwoc_domain = xxpcwoc_det.xxpcwoc_domain
               AND xxpcwocdet.xxpcwoc_site = xxpcwoc_det.xxpcwoc_site
               AND xxpcwocdet.xxpcwoc_year = yr
               AND xxpcwocdet.xxpcwoc_per = per
               AND xxpcwocdet.xxpcwoc_part = xxpcwoc_det.xxpcwoc_part
               AND xxpcwocdet.xxpcwoc_lot = xxpcwoc_det.xxpcwoc_lot
               AND xxpcwocdet.xxpcwoc_element = xxpcwoc_det.xxpcwoc_element
               EXCLUSIVE-LOCK NO-ERROR.
            IF NOT AVAILABLE xxpcwocdet THEN DO:
               CREATE xxpcwocdet.
               ASSIGN
                  xxpcwocdet.xxpcwoc_domain = xxpcwoc_det.xxpcwoc_domain
                  xxpcwocdet.xxpcwoc_site = xxpcwoc_det.xxpcwoc_site
                  xxpcwocdet.xxpcwoc_year = yr
                  xxpcwocdet.xxpcwoc_per = per
                  xxpcwocdet.xxpcwoc_part = xxpcwoc_det.xxpcwoc_part
                  xxpcwocdet.xxpcwoc_lot = xxpcwoc_det.xxpcwoc_lot
                  xxpcwocdet.xxpcwoc_element = xxpcwoc_det.xxpcwoc_element
                  .
            END.
            ASSIGN
               xxpcwocdet.xxpcwoc_beg = xxpcwoc_det.xxpcwoc_end
               .
         END.
      END.
