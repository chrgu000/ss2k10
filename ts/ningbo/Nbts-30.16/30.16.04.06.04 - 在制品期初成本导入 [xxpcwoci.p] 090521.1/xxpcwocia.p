...
FOR EACH tt1
   ...
   REPEAT:
      ...
      */
      ...
      FIND FIRST glrd_det
         ...
         AND glrd_fpos = INTEGER(tt1_c1[6])
         AND glrd_fpos <> 0
         NO-LOCK NO-ERROR.
   ...
   FIND FIRST xxpcwoc_det 
      ...
      AND xxpcwoc_site = tt1_c1[1]
      AND xxpcwoc_year = INTEGER(tt1_c1[2])
      AND xxpcwoc_per = INTEGER(tt1_c1[3])
      AND xxpcwoc_part = tt1_c1[4]
      AND xxpcwoc_lot = tt1_c1[5]
      AND xxpcwoc_element = INTEGER(tt1_c1[6])
      NO-ERROR.
   IF NOT AVAILABLE xxpcwoc_det THEN DO:
      CREATE xxpcwoc_det.
      ASSIGN
         xxpcwoc_domain = GLOBAL_domain
         xxpcwoc_site = tt1_c1[1]
         xxpcwoc_year = INTEGER(tt1_c1[2])
         xxpcwoc_per = INTEGER(tt1_c1[3])
         xxpcwoc_part = tt1_c1[4]
         xxpcwoc_lot = tt1_c1[5]
         xxpcwoc_element = INTEGER(tt1_c1[6])
         .
   END.
   IF tt1_c1[7] <> "-" THEN DO:
      ASSIGN
         xxpcwoc_beg = DECIMAL(tt1_c1[7])
         .
   END.
