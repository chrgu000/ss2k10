/* GUI CONVERTED from rssmt.p (converter v1.78) Fri Oct 29 14:37:57 2004 */
...
DEFINE NEW SHARED VARIABLE  v_batch_p AS LOGICAL.
DEFINE NEW SHARED VARIABLE  v_batch_date AS LOGICAL.
define new shared variable  v_batch_eff as date.
/*SS - 111020.1 E*/
...
/*GUI*/ if global-beam-me-up then undo, leave.
   ...
   /*SS - 111020.1 B*/
   {gprun.i ""xxrssmt101.p"" "(input recid(sch_mstr) )"}

       if c-application-mode <> "API" then
          hide frame sched_data.

   IF v_batch_date = YES THEN
      {gprun.i ""xxrssmt102.p"" "(input recid(sch_mstr) )"}
   /*SS - 111020.1 E*/
