...
&SCOPED-DEFINE scptup_p_3 "舊PO价" 
/* MaxLen: Comment: */ 

&SCOPED-DEFINE scptup_p_4 "新PO价"
/* MaxLen: Comment: */

&SCOPED-DEFINE scptup_p_5 "PO日期"
/* MaxLen: Comment: */

&SCOPED-DEFINE scptup_p_6 "采購單位"
/* MaxLen: Comment: */
...
&SCOPED-DEFINE scptup_p_13 "采購單"
/* MaxLen: Comment: */

&SCOPED-DEFINE scptup_p_14 "成本要素"
/* MaxLen: Comment: */

&SCOPED-DEFINE scptup_p_15 "采購數量"
/* MaxLen: Comment: */
...
v_from            colon 30  label "更新方法"       /*A0304*/ 
                        "1.標准成本" colon 35 skip /*A0304*/ 
                        "2.价格表"   colon 35 skip /*A0304*/ 
                        "3.采購單"   colon 35 skip /*A0304*/ 
                        "4.傳票"     colon 35 skip /*A0304*/ 
...
then do:
    ...
    if v_from = 2 then do:
            ...
            for each temp1 break by t1_amt :
