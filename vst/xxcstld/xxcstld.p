...
repeat:
   ...
   */
   ...
   for each xxsptdet exclusive-lock: delete xxsptdet. end.
   {gprun.i ""xxcstld0.p""}

     if not can-find(first xxsptdet) then do:
          {mfmsg.i 1310 1}
     end.
     else do:
             {gprun.i ""xxcstld1.p""}
     end.
     for each xxsptdet exclusive-lock with width 320 frame c:
      /* SET EXTERNAL LABELS */
