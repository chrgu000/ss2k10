...
define variable v_print as logical format "Y/N" init Yes.  
    ...
    /*rtitle1 = "xxiclot1.p A0710                                    威斯达电器（中山）制造有限公司" .*/
		rtitle1 = "xxiclot1.p A0710                                    吹笷筿竟い籹硑Τそ" . /* ss 20130329 */
    ...
    define stream s1. 
    v_filename = "TMP" + execname + trim(p_part) + trim(p_toloc) + string(today,"999999") + string(time,"hh:mm:ss") + "." + trim(p_userid) + ".prn".
    output stream s1 to value(v_filename).
         ...
         for each prttbl no-lock:        
            ...
            if v_ipd_tol <> "" then do:
                ...
                if 33 - line-counter >= 6 then
                   put skip(33 - line-count - 6).
                else if 66 - line-counter >= 6  then
                   put skip(66 - line-count - 6). 

               /* ss - 20130329 - b */
                display 
               /* "_____________________________________________________________________________________________________________________" at 1
                " PMC:                采购部:                  领导批准:                  仓库:                  领料部门签收:" at 1
                "" at 1
                "日期:                  日期:                      日期:                  日期:                          日期:" at 1
                 "" at 1
                "车牌号码:                       门卫:" at 1*/
								 "_____________________________________________________________________________________________________________________" at 1
                " PMC:                蹦潦场:                  烩旧у:                  畐:                  烩场帽Μ:" at 1
                "" at 1
                " ら戳:                  ら戳:                      ら戳:                  ら戳:                          ら戳:" at 1
                 "" at 1
                " ó礟腹絏:                       矫:" at 1
               with frame fboot width 120 no-label no-box.
               view stream s1 frame fboot.  
							 /* ss - 20130329 - e */
