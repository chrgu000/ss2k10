...
/* ****************************** Definitions ******************************* */
/*============================================================================*/
/*ss20130111  BY : Sandler ebsp4 */
/* DISPLAY TITLE */

/*ADM*/ {mfdtitle.i "201301118.1 "}
...
{gpaud.i &uniq_num1 = 01  &uniq_num2 = 02
 &db_file = po_mstr &db_field = po_nbr}
/*ADM1 end*/
...
/*N13P*/ do:
            ...
            {gpaud2xx.i &uniq_num1 = 01  &uniq_num2 = 02
               &db_file = po_mstr &db_field = po_nbr &db_field1 = """"}
            end.
            /*ADM1 end*/
            if del-yn then
               next mainloop.
...
/*N13P*/    end.
      ...
      /* LINE ITEMS */
/*ADM1      {gprun.i ""popomta.p""} */
      {gprun.i ""popomtaxxxx.p""} /*ADM1*/
