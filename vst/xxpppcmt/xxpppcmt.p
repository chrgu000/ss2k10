...
/*ss20120919 b*/
/*{mfdtitle.i "20120918.1 "}  ss-20130411.1 */
{mfdtitle.i "20130411.1 "}
/*ss20120919 e*/
...
/*N0Y0*/ pc_start      colon 29   batchdelete at 52 no-label
         pc_expire      colon 29   /*ss20120919 b*/ pc_user1 format "x(12)" label "½s¸¹" /*ss20120919 e*/
        ...
        editing:
           ...
           if recno <> ? then do:
               ...
               display pc_list pc_curr pc_prod_line pc_part
                   pc_um pc_start pc_expire
                   /*ss20120919 b*/ pc_user1 /*ss20120919 e*/
                   pc_amt_type with frame a.
...
/*L020*/          {mfmsg.i mc-error-number 3}  /* INVALID CURRENCY CODE */
        ...
        do on error undo, retry with frame a no-validate:
           ...
           update pc_expire /*ss20120919 b*/ pc_user1 /*ss20120919 */ pc_amt_type go-on ("F5" "CTRL-D").
