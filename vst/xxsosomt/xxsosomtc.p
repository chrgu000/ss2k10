...
/* REVISION: 9.1      LAST MODIFIED: 06/19/01   BY: *M1BP* Nikita Joshi     */
/* REVISION: 9.1      LAST MODIFIED: 03/04/02   BY: *N1BT* B. Gates         */
...
/*N0F4*
 *       &SCOPED-DEFINE sosomtc_p_1 "**C R E D I T**"
 *       /* MaxLen: Comment: */
 *N0F4*/
...
/*N0CG** find cm_mstr where recid(cm_mstr) = cm_recno no-lock. */
/*N0CG*/ for first cm_mstr
/*N0CG*/    fields(cm_balance cm_cr_limit)
/*N0CG*/    where recid(cm_mstr) = cm_recno no-lock:
/*N0CG*/ end.  /* FOR FIRST CM_MSTR */

/*N0CG** find first soc_ctrl no-lock. */
/*N0CG*/ for first soc_ctrl
/*N0CG*/    fields(soc_cr_hold) no-lock:
...
/*F358*/    so_rev
            so_print_so so_print_pl so_partial so_prepaid
            so_ar_acct
/*N014*/    so_ar_sub
            so_ar_cc
...
/*N0F4* /*G0YX*/  if invcrdt = {&sosomtc_p_1} then do: */
/*N0F4*/  if invcrdt = "**":U + getTermLabel("C_R_E_D_I_T",11) + "**":U then do:
/*G0YX*/  totalorder = 0.
...
/*N1BT /*J042*/          if not batchrun then */
/*N1BT /*J042*/             pause. */
/*N1BT*/          if not (batchrun or {gpiswrap.i}) then pause.
/*J042*/       end.
/*J042*/    end.
/*J042*/ end.

/*N1BT*/ if {gpiswrap.i} then pause 0 before-hide.
...
/*N1BT /*FQ08*/          if not batchrun then pause. */
/*N1BT*/          if not (batchrun or {gpiswrap.i}) then pause.
/*H049*/       end.
