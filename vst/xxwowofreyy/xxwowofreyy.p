...
/*ss - 131023.1 by zy  在倒冲时可任意修改库位     1887252                   */
/* {mfdtitle.i "A0729"} */
...
define new shared variable v_timestr as char format "x(11)".
     ...
     form
        v_time      colon 18 label "痁" /*"Time range"*/
        "(1--フ痁,2--痁)" /*"(1- 7:30am--3:00pm, 2- 3:00pm--11:00pm, 3- 11:00pm--7:30am"*/ colon 18
 /*       " 4- 7:00am--8:00pm, 5- 8:00pm--5:00am)" colon 18 skip */
        v_effdate   colon 18  label "ネら戳" 
     ...
     repeat on error undo, retry with frame a1:
         ...
         if v_time > 2 or v_time < 1 then do: 
            {mfmsg03.i 2685 3 """痁ゲ斗琌 1 ┪ 2""" """" """"}
            undo,retry.
         end. 
         case v_time:
            when  1 then v_timestr = "フ痁"  /*"7:30am-3pm"*/ .
            when  2 then v_timestr = "痁" /* "3pm-11pm"*/ .
