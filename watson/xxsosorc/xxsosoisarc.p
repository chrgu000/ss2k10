...
by sod_line:
   ...
   do for soddet transaction:
      ...
      then do:
         ...
         /* SS - 20081114.1 - B */
         {gprun.i ""xxsoise03rc.p"" "(input sod_nbr, input sod_line)"}
         {gprun.i ""xxsoise04rc.p"" "(input sod_nbr, input sod_line)"}
         /* SS - 20081114.1 - E */
      ...
      sod__dec02 = sod__dec02 + sod__qadd01.
