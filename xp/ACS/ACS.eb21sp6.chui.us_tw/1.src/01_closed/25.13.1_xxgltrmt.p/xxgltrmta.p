...
/* Revision: 1.46     BY: Deepak Rao         DATE: 05/26/03  ECO: *N2G3*   */
/* Revision: 1.48     BY: Paul Donnelly (SB) DATE: 06/26/03 ECO:  *Q00D*   */
/* Revision: 1.49     BY: Ed van de Gevel    DATE: 08/05/03 ECO:  *Q00R*   */
/* Revision: 1.50     BY: Ed van de Gevel    DATE: 08/18/03 ECO:  *Q01Y*   */
/* Revision: 1.51     BY: Rajaneesh S.       DATE: 08/27/03 ECO:  *P0W0*   */
/* Revision: 1.52     BY: K Paneesh          DATE: 08/08/03 ECO:  *N2JT*   */
/* Revision: 1.53     BY: Rob DiMeola        DATE: 08/17/04  ECO: *P2F2*   */
/* Revision: 1.54     BY: Tejasvi Kulkarni   DATE: 10/20/04  ECO: *P2QC*   */
/* Revision: 1.55     BY: Matthew Lee        DATE: 12/07/04  ECO: *P2YH*   */
/* $Revision: 1.56 $   BY: Sarita Gonsalves   DATE: 07/27/06  ECO: *P4YR*   */
/*-Revision end--------------------------------------------------------------*/
...
define        variable l_entity        like glt_entity       no-undo.

/* THE FOLLOWING TWO VARIABLES SHOULD NOT HAVE THE no-undo OPTION TO MAKE    */
/* SURE THAT AFTER AN UNDO OF THE FIRST LINE THE USER CAN RE-ENTER THE ENTITY*/
/* WHEN NOT IN CASHBOOK MODE. WITH NO-UNDO RE-ENTERING WILL BE DISALLOWED    */
/* WHEN THE ENTITY ORIGINALLY ENTERED IS A CONSOLIDATION ENTITY              */
...
/* SS - 101221.1 - E */
         ...
         then do:
            /* CHECK ENTITY SECURITY */
            {glenchk.i &entity=l_entity &entity_ok=entity_ok}
            if not entity_ok
            then do:
            next-prompt
               glt_entity
