   ...
   repeat with frame vohdr1:
        ...
        /* SS - 110114.1 - B */
            {xxgpdescm3.i 
                ...
                &desc=ap_rmk 
                &gltdoc=ap_ref
                &gltacct="ap_acct or glt_acct = ap_disc_acct"
            }
            {xxgpdescm3.i 
                &table=vod_det
                &desc=vod_desc
                &gltdoc=vod_ref
                &gltacct="vod_acct or glt_acct = vod_exp_acct"
            }
        /* SS - 110114.1 - E */
      ...
      do for apc_ctrl transaction:
         ...
         ****************************************************************************/
         ...
         do while true:
                  ...
                  then do:
                     ...
                     run backoutPendingVoucherAmount
                        (input  vph_pvo_id,
                         ...
                         input (vph_curr_amt / (vo_ex_rate / vo_ex_rate2))).
            ...
            {&APVOMT-P-TAG31}
            {gprun.i ""xxapvomtm.p""}  /* SS - 110114.1 */
            {&APVOMT-P-TAG32}
            ...
            {gprun.i ""xxapvomtb.p"" "(input 0)"}    /* SS - 110114.1 */
