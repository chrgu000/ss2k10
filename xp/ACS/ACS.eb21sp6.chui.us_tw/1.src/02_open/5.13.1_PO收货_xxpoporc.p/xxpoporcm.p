...
/* SS - 110112.1  By: Roger Xiao */  /* auto cimload woworc.p */ /* if failed ,no ok msg */ /*wo_stat must be changed by cimload*/
/*-Revision end---------------------------------------------------------------*/
...
/*SS-20100904 add***********/
define new shared variable recgp         as character.
define new shared variable rcv_type2        like poc_rcv_type.
/*SS-20100904 end *********/
...
/*SS-20100904*   receivernbr    colon 15       label {&poporcm_p_9}*/
/*SS-20100904**/   recgp    colon 15       label "Group Code"
...
/*SS-20100904**/   recgp    colon 27       label "Group Code"
...
/*SS-20100904 end******************************/
   ...
   do transaction:
      if porec
      then do:
/*SS-20100904*         {poporcm.i &frame=a1}*/
/*SS-20100904*/         {xxpoporcm.i &frame=a1}
      end. /* IF porec */
      else do:
/*SS-20100904*         {poporcm.i &frame=a2}*/
/*SS-20100904*/         {xxpoporcm.i &frame=a2}
      end. /* ELSE DO: */
...
/*SS-20100904*         {gprun.i ""poporca.p""*/
/*SS-20100904*/         {gprun.i ""xxpoporca.p""
    ...
    /* SS - 110112.1 - B */
        ...
        define var v_wo_close as char no-undo .
        ...
        for each tt:
            ...
            if avail tr_hist and tr_ship_type = "S" then do:
                    ...
                    v_file_i =    string(year(TODAY),'9999') 
                                ...
                                + mfguser 
                                + ".txt" .
                    v_file_o = "RCT-PO-WO-O-" + v_file_i  .
                    v_file_i = "RCT-PO-WO-I-" + v_file_i  .
                    ...
                    output to value(v_file_i).
                        ...
                        put unformatted tr_qty_loc "  " 
                                        ...
                                        " N N "
                                        skip.
                        put unformatted '"' tr_lot + "," + string(tr_line) '"' .
                        ...
                        for each wo_mstr 
                            ...
                            if tr_qty_loc + wo_qty_comp + wo_qty_rjct >= wo_qty_ord then do:
                                v_wo_close = " Y " .
                            end.  
                        end.

                        put unformatted v_wo_close skip.
                    ...
                    repeat:
                        ...
                        then do:
                            output to  value ( "RCT-PO-WO-error-log.txt") append.
                                put  unformatted 
                    ...
                    for each wo_mstr 
                        ...
                        if wo_qty_comp + wo_qty_rjct >= wo_qty_ord then do:
                            assign 
                            wo_status            = "C"
                            wo_stat_close_date   = today 
                            wo_stat_close_userid = global_userid .
                        end.  
                    end.
                       SS - 110112.1 - E */
...
/*SS-20100904*      {pxrun.i &PROC='commitReceipt' &PROGRAM='porcxr.p'*/
/*SS-20100904*/      {pxrun.i &PROC='commitReceipt' &PROGRAM='xxporcxr.p'
               &PARAM="(input shipnbr,
                        input ship_date,
                        input inv_mov,
                        input ip_usage,
