...
results.name= "voucher print"
results.view-as= browse
results.table[1]= "qaddb.glt_det" "53968" "" "/*CHARACTER,qaddb.glt_det.glt_domain,=,:域*/ TRUE and /*CHARACTER,qaddb.glt_det.glt_doc,RANGE,:输入发票或事务编号*/ TRUE " no ""
...
results.field[5]= "qaddb.glt_det.glt_amt" "Amount" "->>,>>>,>>>,>>9.99" "t1" "decimal" "" "1" ",,,,,,,,"
results.field[6]= "qaddb.glt_det.glt_ref" "GL Reference" "x(14)" "" "character" "" "1" ",,,,,,,,"
results.field[7]= "qaddb.glt_det.glt_batch" "Batch" "x(8)" "" "character" "" "1" ",,,,,,,,"
