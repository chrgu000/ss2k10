...
results.name= "中国格式凭证打印"
results.view-as= report
results.table[1]= "qaddb.glt_det" "53968" "" "/*CHARACTER,qaddb.glt_det.glt_domain,=,:域*/ TRUE      
    and /*CHARACTER,qaddb.glt_det.glt_doc,RANGE,:参考号*/ TRUE" no ""
results.table[2]= "qaddb.ac_mstr" "9634" "WHERE qaddb.glt_det.glt_domain = qaddb.ac_mstr.ac_domain and qaddb.glt_det.glt_acct = qaddb.ac_mstr.ac_code" "" no ""
results.table[3]= "qaddb.fm_mstr" "22094" "WHERE qaddb.ac_mstr.ac_domain = qaddb.fm_mstr.fm_domain and qaddb.fm_mstr.fm_fpos = qaddb.ac_mstr.ac_fpos" "" no ""
