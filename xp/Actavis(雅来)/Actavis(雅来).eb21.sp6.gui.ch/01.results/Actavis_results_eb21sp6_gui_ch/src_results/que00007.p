...
results.name= "中国格式凭证打印-借贷同列"
results.view-as= report
results.table[1]= "qaddb.glt_det" "53968" "" "/*CHARACTER,qaddb.glt_det.glt_domain,=,:域*/ TRUE     
    and /*CHARACTER,qaddb.glt_det.glt_doc,RANGE,:原始凭证号码*/ TRUE
    AND qaddb.glt_det.glt_entity = ""2510"" " no ""
...
results.field[7]= "DRCR,(IF ((qaddb.fm_mstr.fm_dr_cr AND (qaddb.glt_det.glt_amt >= 0))) THEN (""借"") ELSE ((IF ((qaddb.fm_mstr.fm_dr_cr AND (qaddb.glt_det.glt_amt < 0))) THEN (""贷"") ELSE ((IF (qaddb.glt_det.glt_amt >= 0) THEN (""借"") ELSE (""贷""))))))" "借/贷" "x(15)" "" "character" "s,qaddb.fm_mstr.fm_dr_cr,qaddb.glt_det.glt_amt" "1" ",,,,,,,,"
results.field[8]= "drcr-amount,IF ((qaddb.fm_mstr.fm_dr_cr AND (qaddb.glt_det.glt_amt >= 0))) THEN (qaddb.glt_det.glt_amt) ELSE ((IF ((qaddb.fm_mstr.fm_dr_cr AND (qaddb.glt_det.glt_amt < 0))) THEN ((ABSOLUTE(qaddb.glt_det.glt_amt))) ELSE ((IF (qaddb.glt_det.glt_amt >= 0) THEN (qaddb.glt_det.glt_amt) ELSE ((ABSOLUTE(qaddb.glt_det.glt_amt)))))))" "金额" "->>>>>>>9.99" "" "decimal" "n,qaddb.fm_mstr.fm_dr_cr,qaddb.glt_det.glt_amt" "1" ",,,,,,,,"
results.order[1]= "qaddb.glt_det.glt_ref" "ascending"
results.order[2]= "DRCR" "descending"
results.order[3]= "qaddb.glt_det.glt_acct" "ascending"
