...
report.top-center[2]= "-----------"
report.bottom-left[1]= "|           制单： {VALUE qaddb.glt_det.glt_userid;x(8)}                  审核："
report.bottom-right[1]= "批准：　　　　　　　　　　　　　　｜"
*/
