...
/* SS - 091230.1  By: Roger Xiao */ /*add part rev */
...
/* SS - 091230.1 - B */
            find first sod_det where sod_nbr = wo_so_job and sod_part = wo_part no-lock no-error .
            if avail sod_det then do:
                if sod__chr09 <> input wo__chr05 then do:
                    message "Warning:Part Rev not equal SO Part Rev:" sod__chr09 .
                    /*
                    next-prompt wo__chr05 .
                    undo,retry. 
                    */
                end.
            end.
