...
/* REVISION: 9.1      LAST MODIFIED: 04/07/03 BY: *EAS015*  Apple Tam     */
...
/*eas001a*/ define shared variable print_header like mfc_logical.
...
/*eas001a efine shared variable sort_by_site like poc_sort_by.*/
/*EAS001A*/  define shared variable sort_by_site as logical format "Line/Site"
...
/*eas001a*/            format "x(30)" extent 6.
/*eas001a            format "x(38)" extent 6.*/
...
/*eas001a         define new shared variable addr as character format "x(38)" extent 6.*/
/*eas001a*/         define new shared variable addr as character format "x(30)" extent 6.
...
/*eas001a            format "(z,zzz,zzz,zz9.99)".*/
/*eas001a*/            format "$->,>>>,>>9.999".
...
/*eas001a*/ define new shared variable title1# as character format "x(70)" extent 3.
/*eas001a*/ define new shared variable title2# as character format "x(30)" .
/*eas001a*/ define new shared variable vend_fax like ad_fax.
/*eas001a*/ define new shared variable vend_city like ad_city.
/*eas001a*/ define new shared variable rev# as character format "x(3)".
/*eas001a*/ define new shared variable curr2# like po_curr.
/*eas001a*/ define new shared variable cmmt1# as character format "x(75)".
/*eas001a*/ define new shared variable um# as character format "x(5)".
/*eas001a*/ define new shared variable amount# like pod_pur_cost format "->,>>>,>>9.99".
/*eas001a*/ define new shared variable page_yn as logical init yes.
/*eas001a*/ define new shared variable buyer# as character format "x(20)".
/*eas001a*/ define new shared variable due_date as character format "x(9)".
/*eas001a*/ define new shared variable rev_date as character format "x(9)".
/*eas001a*/ define new shared variable ord_date# as character format "x(9)".
/*eas001a*/ define new shared variable date1# as character format "x(9)".
/*eas001a*/ define new shared variable date2# as character format "x(9)".
/*eas001a*/ define variable cont# as character format "x(12)".
/*eas001a*/ cont# = "*** Cont ***".
/*eas001a*/ define new shared variable line_yn as logical init no.
/*eas001a*/ define variable months as character format "X(3)" extent 12
         ...
         form
           ...
           signatureline to 78
           signature-lbl to 78
         with frame potrail2 no-labels no-box width 80.
...
/*eas001a         {po03d01.i}   /* DEFINE FRAME C*/*/
/*eas001a*/         {xxpo03d01.i}   /* DEFINE FRAME C*/
...
/*L020*/       end.
               ...
               {gprun.i ""gpcurfmt.p"" "(input-output ext_cost_fmt,
                                         input rndmthd)"}
/*eas001a               ext_cost:format = ext_cost_fmt.*/
               {pocurfmt.i}
               oldcurr = po_curr.
            end.
...
/*eas001a add*************************************************************/
            buyer# = "".
	    find first code_mstr where code_fldname = "po_buyer" and code_value = po_buyer no-lock no-error.
	    if available code_mstr then buyer# = code_cmmt.
/*eas001a add*************************************************************/
...
/*eas001a*/ vend_city = "".
            ...
            if available ad_mstr then do:
               ...
               addr[6] = ad_country.
               vend_phone = ad_phone.
/*eas001a*/    vend_fax = ad_fax.
/*eas001a*/    vend_city = ad_city.
               {mfcsz.i   addr[5] ad_city ad_state ad_zip}
               {gprun.i ""gpaddr.p"" }
               vendor[1] = addr[1].
               vendor[2] = addr[2].
...
/*eas001a* add*****************/
            title1# = "".
	    title2# = "".
	    if print_header then do:
	       title1#[1] = "E A S T A R (HONG KONG) L I M I T E D ".
	       title1#[2] = "UNIT G, 19/F.,WORLD TECH CENTRE, 95 HOW MING STREET,KWUN TONG,".
	       title1#[3] = "HONG KONG,   TEL:(852)2342-7688 FAX:(852)2343-8078,2763-7223".
	       title2# = "P U R C H A S E  O R D E R".
	    end.
	    rev# = "".
	    if po_rev > 0 then rev# = ".R" + substring("0" + string(po_rev),length(string(po_rev)),2).
/*eas001a  end*****************/
...
/*eas001a /*N01B*/       {gprun.i ""porp3a01.p"" "(input update_yn)"}*/
/*eas001a*/       {gprun.i ""xxporp3b01.p"" "(input update_yn)"}
            end.
            else do:
/*N01B**       {gprun.i ""porp3b01.p""} */
/*eas001a /*N01B*/       {gprun.i ""porp3b01.p"" "(input update_yn)"}*/
/*eas001a*/       {gprun.i ""xxporp3b01.p"" "(input update_yn)"}
            end.
	    ...
	    /* TRAILER */
            if {txnew.i} then do:
                maint = no.
                undo_trl2 = true.
/*eas001a                {gprun.i ""pomttrl2.p""}*/
/*eas001a*/                {gprun.i ""xxpomttrl2.p""}
               ...
               if gl_vat then display with frame povttrl no-box.
               else if gl_can then display with frame pocttrl  no-box.
               else
               display with frame potrail column 3 no-box.
               if gl_vat then do:
                  {povttrl.i}
                  {po03e01.i}
               end.
