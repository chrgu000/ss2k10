...
/*EAS002A*/ define shared variable print_header like mfc_logical.
/*EAS002A*/  define shared variable print_header2 as logical format "T/C"
...
/*eas002a         define shared variable sort_by_site like poc_sort_by.*/
/*EAS002A*/  define shared variable sort_by_site as logical format "Line/Site"
            initial true no-undo.
...
/*EAS002A*/            format "x(30)" extent 6.
/*EAS002A            format "x(38)" extent 6.*/
...
/*EAS002A         define new shared variable addr as character format "x(38)" extent 6.*/
/*EAS002A*/         define new shared variable addr as character format "x(30)" extent 6.
...
/*EAS002A            format "(z,zzz,zzz,zz9.99)".*/
/*EAS002A*/            format "$->,>>>,>>9.999".
...
/*EAS002A*/ define new shared variable title1# as character format "x(50)" extent 4.
/*EAS002A*/ define new shared variable title2# as character format "x(30)" .
/*EAS002A*/ define new shared variable vend_fax like ad_fax.
/*EAS002A*/ define new shared variable vend_city like ad_city.
/*EAS002A*/ define new shared variable rev# as character format "x(3)".
/*EAS002A*/ define new shared variable curr2# like po_curr.
/*EAS002A*/ define new shared variable cmmt1# as character format "x(75)".
/*EAS002A*/ define new shared variable um# as character format "x(5)".
/*EAS002A*/ define new shared variable amount# like pod_pur_cost format "->,>>>,>>9.99".
/*EAS002A*/ define new shared variable page_yn as logical init yes.
/*EAS002A*/ define new shared variable buyer# as character format "x(20)".
/*EAS002A*/ define new shared variable due_date as character format "x(9)".
/*EAS002A*/ define new shared variable rev_date as character format "x(9)".
/*EAS002A*/ define new shared variable ord_date# as character format "x(9)".
/*EAS002A*/ define new shared variable date1# as character format "x(9)".
/*EAS002A*/ define new shared variable date2# as character format "x(9)".
/*EAS002A*/ define variable cont# as character format "x(12)".
/*EAS002A*/ cont# = "*** Cont ***".
/*EAS002A*/ define new shared variable line_yn as logical init no.
...
/*EAS002A         {po03d01.i}   /* DEFINE FRAME C*/*/
/*EAS002A*/         {xxpo03d01.i}   /* DEFINE FRAME C*/
...
/*L020*/       end.
               ...
               {gprun.i ""gpcurfmt.p"" "(input-output ext_cost_fmt,
                                         input rndmthd)"}
/*EAS002A               ext_cost:format = ext_cost_fmt.*/
               {pocurfmt.i}
               oldcurr = po_curr.
            end.
...
/*EAS002A*/ vend_city = "".
            ...
            if available ad_mstr then do:
               ...
               addr[6] = ad_country.
               vend_phone = ad_phone.
/*EAS002A*/    vend_fax = ad_fax.
/*EAS002A*/    vend_city = ad_city.
               {mfcsz.i   addr[5] ad_city ad_state ad_zip}
               {gprun.i ""gpaddr.p"" }
               vendor[1] = addr[1].
               vendor[2] = addr[2].
...
/*EAS002A* add*****************/
	    ...
	    if print_header then do:
	       if print_header2 then do:
	          title1#[1] = "E A S T A R (HONG KONG) L I M I T E D".
	          title1#[2] = "東星電子公司".
	          title1#[3] = "    廣東省東莞市茶山鎮橫江第二工業區A座".
	          title1#[4] = "    TEL:(0769)6643874 FAX:(0769)6644135".
		  title2# = "采 購 訂 單".
	       end.
	       else do:
	          title1#[1] = "  東 莞 依 時 得 電 子 有 限 公 司".
	          title1#[2] = "".
	          title1#[3] = "廣東省東莞茶山鎮石大公路橫江第二工業區 A 座".
	          title1#[4] = "TEL: (0769) 6643874       FAX: (0769) 6644135".
		  title2# = "采 購 訂 單".
	       end.
	    end.
...
/*EAS002A /*N01B*/       {gprun.i ""porp3a01.p"" "(input update_yn)"}*/
/*EAS002A*/       {gprun.i ""xxporp3b01.p"" "(input update_yn)"}
            end.
            else do:
/*N01B**       {gprun.i ""porp3b01.p""} */
/*EAS002A /*N01B*/       {gprun.i ""porp3b01.p"" "(input update_yn)"}*/
/*EAS002A*/       {gprun.i ""xxporp3b01.p"" "(input update_yn)"}
            end.
            ...
            if {txnew.i} then do:
                maint = no.
                undo_trl2 = true.
/*EAS002A                {gprun.i ""pomttrl2.p""}*/
/*EAS002A*/                {gprun.i ""xxpomttrl2.p""}
