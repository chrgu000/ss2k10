...
/*EAS021*  form {ppptmtaa.i}*/
/*EAS021*/ form {xxppptmtaa.i}
...
/*EAS021*                 text(pt_desc1 pt_desc2)*/
/*EAS021*/        text(pt_desc1 pt_desc2 pt__chr01 pt__chr02)
            with frame a
            editing:
...
/*EAS021*        {gprun.i ""ppptmtb.p""}*/
/*EAS021*/       {gprun.i ""xxppptmtb.p""}
