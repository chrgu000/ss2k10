...
/*N01B*/ &SCOPED-DEFINE poporp03_p_9 "Update"
...
/*eas001a         define new shared variable sort_by_site like poc_sort_by.*/
/*EAS001A*/  define new shared variable sort_by_site as logical format "Line/Site"
...
/*eas001a*/ define new shared variable print_header like mfc_logical initial yes.
/*eas001a*/ define variable yn like mfc_logical initial no.
...
/*L0SH*/    update_yn      colon 60 /*eas001a* skip(1)*/
/*eas001a*/ print_header   colon 25 label "Print Header"
...
/*eas001a*/ {mfquoter.i print_header}
            {mfquoter.i msg    }
...
/*eas001a /*N01B*/       {gprun.i  """porp03"" + run_file + "".p""" "(input update_yn)"}*/
/*eas001a*/       {gprun.i  """xxporp03"" + run_file + "".p""" "(input update_yn)"}
