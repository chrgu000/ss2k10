...
DEFINE VARIABLE vchr_pod_vpart LIKE pod_vpart.
...
/*Leemy*/ 			vchr_pod_vpart = pod_vpart.
...
/*Leemy*/ 			batchrun = NO.
					...
					IF AVAIL pod_det THEN DO:
						...
						v_linecopy = pod_line.
/*Leemy*/ 				pod_vpart = vchr_pod_vpart.
						NEXT.
					END.
					ELSE DO:
...
/*leemy*  /*eas023a */          {gprun.i ""xxpopomtd.p""}  */
/*Leemy*/      IF batchrun THEN DO:
/*Leemy*/ 			{gprun.i ""popomtd.p""}  
/*Leemy*/ 		END.
/*Leemy*/ 		ELSE DO:
/*Leemy*/ 			{gprun.i ""xxpopomtd.p""}
/*Leemy*/ 		END.
               if c-application-mode <> "API" and continue = no then
                  undo mainloop, next mainloop.
               else if c-application-mode = "API" and continue = no then
