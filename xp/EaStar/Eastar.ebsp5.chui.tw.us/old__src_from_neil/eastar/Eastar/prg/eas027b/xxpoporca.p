...
/* REVISION: eB(SP5)     LAST MODIFIED: 06/24/03    BY: Kaine      *EAS027B*   */
      ...
      do on error undo, retry:
         ...
         if available pt_mstr
            ...
            then l_getlot = no.
			 ...
			 /*****Kaine27b****start**To check whether lotserial_qty<0?***
			 or remove these Kaine27b statements to block Set xxx*****/ 
				SET lotserial_qty WITH FRAME d.
				IF lotserial_qty < 0 THEN lotserial:SCREEN-VALUE = "".
			/*****Kaine27b****end***/
			/*Kaine27b   set lotserial_qty	*/
/*Kaine27b*/ SET
             packing_qty
             cancel_bo
             receipt_um
...
*                        and not (is_wiplottrace_enabled() and pod_type = "s"))
* Kaine*/
			 lotserial	WHEN (input lotserial_qty < 0)  /*Kaine27b*/ 
