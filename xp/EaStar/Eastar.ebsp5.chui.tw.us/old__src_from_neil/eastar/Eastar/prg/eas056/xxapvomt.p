...
/* REVISION: 9.1      LAST MODIFIED: 06/19/02   BY: *N1K9* Mamata Samant    */
...
/*eas056                     {gprun.i ""apvomtm.p""}*/
/*eas056*/                     {gprun.i ""xxapvomtm.p""}
...
/*N1K9** /*L0VW*/       fields (vod_ref vod_base_amt)       */
/*N1K9*/                fields (vod_acct vod_amt vod_base_amt vod_desc
/*N1K9*/                        vod_dy_code vod_entity vod_ln vod_ref
/*N1K9*/                        vod_tax_at vod_type)
...
/*N1K9*/             if ap_curr <> base_curr
/*N1K9*/             then do:
/*N1K9*/                {gprunp.i "mcpl" "p" "mc-curr-conv"
                           "(input ap_curr,
                             input base_curr,
                             input ap_ex_rate,
                             input ap_ex_rate2,
...
/*N1K9*/                if mc-error-number <> 0
/*N1K9*/                then do:
/*N1K9*/                   {mfmsg.i mc-error-number 2}
/*N1K9*/                end. /* IF mc-error-number <> 0 */

/*N1K9*/                if ap_base_amt <> l_ap_base_amt
/*N1K9*/                then do:
/*N1K9*/                   run p_create_vod_det (buffer ap_mstr,
                                                 input  vo_confirmed).
/*N1K9*/                end. /* IF ap_base_amt <> l_ap_base_amt */
/*N1K9*/             end. /* IF ap_curr <> base_curr */
...
/*N1K9*/  /* WHEN ROUNDING VARIANCE EXISTS FOR A VOUCHER, A SYSTEM GENERATED */
/*N1K9*/  /* vod_det RECORD WILL BE CREATED, WITH TRANSACTION TYPE "x". THE  */
/*N1K9*/  /* BASE VALUE WILL BE UPDATED WITH VARIANCE AMT AND THE AMOUNT IN  */
/*N1K9*/  /* FOREIGN CURRENCY WILL BE UPDATED WITH ZERO VALUE.               */
