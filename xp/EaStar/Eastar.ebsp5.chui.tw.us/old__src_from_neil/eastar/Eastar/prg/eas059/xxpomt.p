...
IF grp# = "OTHER" THEN DO:
     if avail po_mstr then do:
         if (substr(po_nbr,1,2) = "NC") or (substr(po_nbr,1,2) = "NT") then do:
          if global_user_lang = "tw" then do:
         ...
         if ((substr(input po_nbr,1,2) = "NT" ) or (substr(input po_nbr,1,2) = "NC" ))
