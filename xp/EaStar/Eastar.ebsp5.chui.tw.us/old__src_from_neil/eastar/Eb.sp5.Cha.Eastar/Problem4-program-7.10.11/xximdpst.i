 /*neil060711*/ define var overinv like sod_qty_inv.
        ...
        EXCLUSIVE-LOCK break by shad_ii_nbr by shad_part:
            ...
            shad_inv_qty = 0.
            if /*last-of(shad_ii_nbr)*/ yes then do:
     ...
     /***********************neil-060711-b*****************************/          
                ...
                for each sod_det where sod_nbr = shad_so_nbr and sod_part =  shad_part exclusive-lock
                   ...
                   if last-of(sod_line) then do:
                	    ...
                	    assign sod__chr10 = "east" 
                	           sod__dec02 = sod_qty_inv
                	           sod_qty_inv = min( sod_qty_inv , overinv )
                	           sod__dec01 = sod_qty_inv .              
                      overinv = overinv - min( sod_qty_inv , overinv ).
                   end.
                end.	
    /************************neil-060711-e*****************************/            
...
/*                       xcim_sod_qty_ship_old
        ...
        /*********************************neil-060711b*******************************/
                ...
                for each sod_det where sod_nbr = shad_so_nbr and sod_part = shad_part and sod__chr10 = "east" exclusive-lock:
                	assign sod__chr10 = ""
                	       sod_qty_inv = sod__dec02 - sod__dec01
                	       sod__dec01 = 0 
                	       sod__dec02 = 0.
                end.
