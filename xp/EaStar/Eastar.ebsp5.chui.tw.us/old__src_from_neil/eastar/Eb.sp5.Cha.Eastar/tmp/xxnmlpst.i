        ...
        and shad_inv_qty <> 0 and shad_ni_nbr <> ""
        EXCLUSIVE-LOCK break by shad_ni_nbr by shad_part:
        message "xxnmlpst.i " + shad_part + " " + shad_ni_nbr view-as alert-box .
            inv_post = yes.
            to_inv_qty = shad_inv_qty.
            shad_qty_inv = shad_qty_inv + shad_inv_qty.
            shad_inv_qty = 0.
            if /*last-of(shad_ni_nbr)*/ yes then do:
                ...
                assign so_inv_nbr = shad_ni_nbr so_invoiced = yes so_to_inv = no.
                find first shah_hdr where shah_sanbr = shad_sanbr no-lock no-error .  /*davild20051214*/
                create xcim_sod_det.
                assign xcim_sod_nbr		    = so_nbr
                       /*xcim_sod_inv_date    = today*/
                       xcim_sod_inv_date    = if shah_dte01 = ? then today else shah_dte01  /*add-by-davild20051128*/
                       /*xcim_sod_line	    = 
