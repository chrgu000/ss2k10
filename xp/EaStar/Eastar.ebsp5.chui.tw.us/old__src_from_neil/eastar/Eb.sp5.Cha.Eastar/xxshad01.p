...
/* MaxLen: Comment: */
    ...
    define variable sold-to       as character format "x(30)" extent 6.  /* micho */
    define variable etdate        as character format "x(11)".
    define variable ship-to       as character format "X(30)" extent 6.  /* micho */
