...
define new shared variable fm_eff_date as date  .  /*add-by-davild20051128*/
...
form
   ...
   skip
   fm_eff_date label "Eff Date"   /*add-davild20051128*/

with frame a attr-space side-labels width 80.
 assign fm_eff_date = today .
/* SET EXTERNAL LABELS */
setFrameLabels(frame a:handle).

form with frame b 6 down width 80 .
...
setFrameLabels(frame c:handle).
    ...
    repeat on error undo, retry:  
       ...
       update 
        ...
        update fm_site fm_loc to_site to_loc select_all
         fm_eff_date /*add-by-davild20051128*/
        with frame a.
