...
/*********************************************************/
	       ...
	       for each sod_det where sod_nbr = snh_so_order and sod_part = snh_part no-lock:
	           /*open-qty = open-qty + sod_qty_ord - sod_qty_ship .*/
...
/****************************************************************************************************************/	
	...
	find first snd_ctn_det where snd_sn_nbr = snnbr2 and snd_sq_nbr = sqnbr 
	 ...
	 find first snp_totals where snp_sn_nbr = snnbr2 and snp_nbr = pltnbr
	                         and snp_shipto = shipto2 exclusive-lock no-error.
