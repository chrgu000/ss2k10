...
/* SS - 101013.1  By: Roger Xiao */ /*error: ** No ard_det record is available. (91) */
/*-Revision end---------------------------------------------------------------*/
...
PROCEDURE p-acct-disp:
   ...
   */
   ...
   ASSIGN
      ...
      ttssardrrp0001_ard_entity = ar_entity
      ttssardrrp0001_ard_acct = round_acct
      ttssardrrp0001_ard_sub = round_sub
      ttssardrrp0001_ard_cc = round_cc
      ttssardrrp0001_ard_project = ''
      .
   /* SS - 20080717.1 - E */
   ...
   then do:
      ...
      */
      ASSIGN
         ttssardrrp0001_ard_base_amt = 0
         ttssardrrp0001_ard_desc = ROUND_desc
         .
      /* SS - 20080717.1 - E */
      ...
      */
      ASSIGN
         ttssardrrp0001_ard_base_amt = (ar_base_amt - l_tot_base_damt)
         ttssardrrp0001_ard_desc = round_desc
         .
      /* SS - 20080717.1 - E */
