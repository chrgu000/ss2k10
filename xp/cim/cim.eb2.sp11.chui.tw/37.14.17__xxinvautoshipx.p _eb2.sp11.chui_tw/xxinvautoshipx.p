...
/* SS - 090630.1 - B
1.lad_det of other invoice lost when shipping , rebuild them here 
2.check success or not error .
SS - 090630.1 - E */
...
/* SS - 090630.1 - B */
define var v_last_trnbr like tr_trnbr . 

define  temp-table old_det
    field  old_site        like lad_site     
    field  old_dataset     like lad_dataset  
    field  old_nbr         like lad_nbr      
    field  old_line        like lad_line 
    field  old_loc         like lad_loc 
    field  old_lot         like lad_lot     
    field  old_part        like lad_part     
    field  old_ref         like lad_ref      
    field  old_qty_all     like lad_qty_all  
    FIELD  old_qty_pick    LIKE lad_qty_pick .
/* SS - 090630.1 - E */ 
...
/* SS - 090630.1 - B */
for each tm1mstr  : delete tm1mstr . end.
for each xlad_det : delete xlad_det. end.
for each old_det  : delete old_det . end.
/* SS - 090630.1 - E */
        ...
        for each xxshd_det where xxshm_inv_no = xxshd_inv_no use-index xxshd_inv_so:
	        totladqty = 0.
                ...
                for each lad_det 
                    ...
                    and   lad_nbr = xxshd_so_nbr 
                    and   lad_ref <> xxshd_inv_no 
                    and   (lad_qty_all > 0 ) no-lock:

                        find first old_det 
                            where old_dataset    = lad_dataset
                            and   old_nbr        = lad_nbr    
                            and   old_line       = lad_line   
                            and   old_part       = lad_part
                            and   old_site       = lad_site   
                            and   old_loc        = lad_loc    
                            and   old_lot        = lad_lot    
                            and   old_ref        = lad_ref 
                        no-error .
                        if not avail old_Det then do:
                                create old_det .
                                assign 
                                    old_dataset    = lad_dataset   
                                    old_nbr        = lad_nbr       
                                    old_line       = lad_line      
                                    old_part       = lad_part      
                                    old_site       = lad_site      
                                    ...
                                    old_lot        = lad_lot       
                                    old_ref        = lad_ref       
                                    old_qty_all    = lad_qty_all
                                    old_qty_pick   = lad_qty_pick
                                  .
                        end.
        ...
        if trtotal_qty > 0 then do:
            ...
            if   available tm1mstr   then do :
                ...
                if yn then do:
                    ...
                    /* SS - 090630.1 - B */
                    v_last_trnbr = CURRENT-VALUE(tr_sq01) .
                    /* SS - 090630.1 - E */
                    tranlp:
...
/*mage add****************************************************************************************/			    
                    ...
                    for each old_det :
                        find first lad_det 
                            where lad_dataset  =  old_dataset  
                            and   lad_nbr      =  old_nbr      
                            and   lad_line     =  old_line     
                            and   lad_part     =  old_part     
                            and   lad_site     =  old_site     
                            and   lad_loc      =  old_loc      
                            and   lad_lot      =  old_lot      
                            and   lad_ref      =  old_ref      
                        no-error .
                        if not avail lad_det then do:
                                ...
                                assign 
                                    ...
                                    lad_lot        =  old_lot       
                                    lad_ref        =  old_ref       
                                    lad_qty_all    =  old_qty_all
                                    lad_qty_pick   =  old_qty_pick
                                  .
                        end.
                        else do:
                            assign 
