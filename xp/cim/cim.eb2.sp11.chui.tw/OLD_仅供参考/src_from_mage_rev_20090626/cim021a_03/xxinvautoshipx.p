...
/*mage add****************************************************************************************/			    
			  ...
			  for each lad_det where lad_dataset = "sod_det" and lad_nbr = xxshd_so_nbr and lad_line = string(xxshd_so_line)
...
/*mage add****************************************************************************************/
        ...
        FOR EACH tm1mstr:
	        ...
	        and tm1_lot = ld_lot  and tm1_all = ld_qty_all:
            END.
...
/*mage add****************************************************************************************/			    
		...
		for each lad_det where lad_dataset = "sod_det" and lad_nbr = xxshd_so_nbr and lad_line = string(xxshd_so_line)
			      ...
			      and lad_ref = xxshd_inv_no and lad_qty_all > 0 no-lock:
                              xxshipqty = min(xxshd_so_qty, lad_qty_all / decUmConv ).
                              xxshdsoqty = xxshdsoqty -  lad_qty_all .
