 ...
 * ********************Kaine E Del*******************/
    ...
    for each tm1mstr no-lock :
		...
		PUT
		    ...
		    if trim(tm1_loc) = "" then """""" else ("""" + trim(tm1_loc) + """") format "x(12)"
		    if trim(tm1_lot) = "" then """""" else ("""" + trim(tm1_lot) + """") format "x(12)"
		    if trim(tm1_ref) = "" then """""" else ("""" + trim(tm1_ref) + """") format "x(12)"
