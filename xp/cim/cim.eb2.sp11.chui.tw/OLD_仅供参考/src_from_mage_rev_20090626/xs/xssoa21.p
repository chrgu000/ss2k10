...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[銷售備料查詢]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[銷售備料查詢]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
...
If AVAILABLE (sod_det) and string ( sod_line ) = V1205 then
        leave V1205L.
        /* LOGICAL SKIP END */
                display "[銷售備料查詢]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1205 no-box.
        ...
        IF NOT AVAILABLE SOD_DET then do:
                display skip "無效或被鎖!" @ WMESSAGE NO-LABEL with fram F1205.
                pause 0 before-hide.
                undo, retry.
        end.
         /*  ---- Valid Check ---- END */
...
If AVAILABLE (sod_det) THEN
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[銷售備料查詢]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If AVAILABLE (sod_det) THEN
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[銷售備料查詢]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
                ...
                /* LABEL 2 - START */ 
                L15102 = "訂單/項:" + trim ( V1100 ) + "/" + trim (V1205) .
                ...
                find first sod_det where sod_nbr = V1100 and sod_line = integer ( V1205 ) no-lock no-error.
If AVAILABLE (sod_det) THEN
                L15103 = "已備/撿:" + string ( sod_qty_all ) + "/" + string ( sod_qty_pick ) .
                else L15103 = "" . 
...
AND LAD_REF  = V1100  
            ...
            LAD_LOT @ V1510 "備/撿量:" + trim(string(LAD_QTY_ALL))  + "/" + trim(string(LAD_QTY_PICK)) + "/" + trim (LAD_LOC) @ WMESSAGE NO-LABEL with fram F1510.
