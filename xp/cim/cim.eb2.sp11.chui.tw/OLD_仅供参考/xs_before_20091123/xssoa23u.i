...
usection = TRIM ( string(year(TODAY)) + string(MONTH(TODAY)) + string(DAY(TODAY)))  + trim(STRING(TIME)) + trim(string(RANDOM(1,100))) + "soa23" .
...
trim(V1002) + " " +  trim( V1505 ) format "X(50)"  if trim( V1500 ) = "" then " - " else """" + trim(V1500) + """"   format "X(40)" skip
trim(V1002) + " " +  trim( V1505 ) format "X(50)"  if trim( V1500 ) = "" then " - " else """" + trim(V1500) + """"   format "X(40)" """" + trim ( V1100) + """" format "x(20)" skip
"Y" skip
"." skip
"."
