...
/* Revision: 1.46    BY: Satish Chavan       DATE: 05/16/00   ECO: *N0B9*     */
/* REVISION: 9.1      LAST MODIFIED: 08/17/00   BY: *N0LJ* Mark Brown         */
/* Revision: 1.46   BY: Paul Donnelly (SB) DATE: 06/28/03 ECO: *Q00K*         */
/* $Revision: 1.47 $ BY: Ken Casey DATE: 02/22/05 ECO: *P38T*                  */
/*----rev history-------------------------------------------------------------------------------------*/
...
/* SS - 101208.1 - B */
   define var old_loc like pt_loc .
   old_loc  = pt_loc .
/* SS - 101208.1 - E */
   ...
   do on error undo, retry with frame b:
      ...
      assign
        ...
        /* SS - 101208.1 - B */
        if old_loc  <> pt_loc then do:
            find first code_mstr
                where code_domain = global_domain 
                and code_fldname  = "ss-type-loc" 
                and code_value    = pt_loc 
            no-lock no-error.
            ...
            else assign pt__chr03 = "" pt__log01 = No .
        end.
        /* SS - 101208.1 - E */
