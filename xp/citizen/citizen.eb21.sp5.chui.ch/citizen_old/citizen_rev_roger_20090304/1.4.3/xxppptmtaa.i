...
{&PPPTMTAA-I-TAG1}
pt_part        colon 18   /*V8! view-as fill-in size 18 by 1 */
	space(0)
batchdelete       at 39 space(0)
pt_um          colon 18
pt_desc1       colon 18  format "X(50)"  /*V8! view-as fill-in size 26 by 1 */
pt_desc2          at 20 no-label  format "X(50)"  /*V8! view-as fill-in size 26 by 1 */
{&PPPTMTAA-I-TAG2}
