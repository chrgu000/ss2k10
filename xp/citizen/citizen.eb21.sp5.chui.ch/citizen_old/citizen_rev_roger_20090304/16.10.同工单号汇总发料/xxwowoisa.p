...
for each wo_mstr exclusive-lock
   ...
   each wod_det exclusive-lock
      ...
      and   can-find (first sr_wkfl
		  ...
		  and   sr_lineid = string(wod_part,"x(18)") + string(wod_lot,"x(8)") /*xp001*/ + string(wod_op)):
   ...
   no-lock:
         ...
         if site <> wo_site then do:
            ...
            {gprun.i ""icxfer.p""
                     "(input l_wo_lot,
                       ...
                       input-output assay,
                       input-output grade,
                       input-output expire)"} /*xp002*/ /*tr_rmks由空改为:自编单号wod__chr01 ,这里改无效,要在下面改ictrans.i*/
      ...
      {ictrans.i
         ...
         &transtype=""ISS-WO""
         &msg=0
         &ref_site=tr_site}   /*xp002*/ /*wo_so_job下的参数: tr_rmks由空改为:自编单号wod__chr01*/
