...
do transaction with frame a:
   ...
   /* Adding new record 
   {pxmsg.i &MSGNUM=1 &ERRORLEVEL=1} */ /*xp001*/
   ...
   do on error undo, retry:
      ...
      then do:
		...
		assign wo_part = caps(v_part)
			   wo_type = caps(v_wo_type)
			   wo_site = caps(v_site).  /*xp001*/
      ...
      if screen_used then do:
         ...
         assign
            ...
            wo_joint_type = "" /*pt_joint_type  */  /*xp001*/.
         ...
         assign
            ...
            wo_joint_type = "" /*ptp_joint_type */  /*xp001*/
