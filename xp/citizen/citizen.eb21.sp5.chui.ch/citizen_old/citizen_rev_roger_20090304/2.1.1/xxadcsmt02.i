...
/* Revision: 1.25     BY: Narathip W.           DATE: 04/17/03 ECO: *P0Q4*   */
/* $Revision: 1.26 $       BY: Priya Idnani          DATE: 08/18/05 ECO: *P3YH*   */
...
form
   ...
   ad_name        colon 10  format "x(60)" /*xp001*/ 
							/*V8! view-as fill-in size 35 by 1 */
