...
/* $Revision: 1.10.2.12.2.1 $ BY: Russ Witt   DATE: 02/23/05  ECO: *P37P*  */
...
define variable vd_carrier_id as character no-undo label "Carrier".
define variable vd_kanban_supplier like mfc_logical no-undo
                                           label "Kanban Supplier".
...
form
   ...
   ad_name        colon 10 format "x(60)" /*xp001*/ 
   ad_line1       colon 10 
   ad_line2       colon 10  
   ad_line3       colon 10  
   ad_city        colon 10
...
form
   ...
   vd_carrier_id       colon 66 label "Carrier"
   vd_promo            colon 22
   vd_kanban_supplier  colon 66 label "Kanban Supplier"
