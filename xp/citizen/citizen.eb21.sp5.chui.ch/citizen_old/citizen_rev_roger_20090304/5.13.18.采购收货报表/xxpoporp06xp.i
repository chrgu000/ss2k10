...
/* $Revision: 1.13 $    BY: Manisha Sawant        DATE: 04/26/04  ECO: *P1YV*  */
...
define {1} shared variable fr_ps_nbr       like prh_ps_nbr label "装箱单".
define {1} shared variable to_ps_nbr       like prh_ps_nbr .
define {1} shared variable last_rcp        like prh_rcp_date.
define {1} shared var      v_shipto        as char label "交运地".
define {1} shared var      v_shipto1       as char .
define {1} shared var      v_shipfrom        as char label "发货自".
define {1} shared var      v_shipfrom1       as char .