...
/* $MODIFIED BY: softspeed Roger Xiao         DATE: 2008/01/12  ECO: *xp002*  */  /*记录PO历史记录,so_job*/
/*-Revision end---------------------------------------------------------------*/
...
setFrameLabels(frame getnbr:handle).    /*xp001*/
