...
/* $MODIFIED BY: softspeed Roger Xiao         DATE: 2008/01/23  ECO: *xp001*  */ /*modified in : xxsosomta001.p*/
/*-Revision end---------------------------------------------------------------*/
...
/*xp001*/
   {gprun.i ""xxsosomta001.p"" "(input this-is-rma, input rma-recno, input yes)"} 
/*run /home/mfg/test/xxsosomta001.p (input this-is-rma, input rma-recno, input yes) .*/
