...
repeat:
   ...
   repeat with frame k:
      ...
      display
         ...
         ship_line.abs__chr01 /*xp001*/
         ship_line.abs__chr02 /*xp002*/
      with frame sample.
      ...
      if not batchrun then do:
         ...
         set
            ...
            cancel_bo when
               (v_editall and ship_line.abs_id begins "i")
            ship_line.abs__chr01 when ( ship_line.abs_id begins "i" ) /*xp001*/
            ship_line.abs__chr02 when ( ship_line.abs_id begins "i" ) /*xp002*/
         with frame sample
            editing:
         ...
         then do:
           ...
           run p-pxmsgconfirm (input 6396,
            ...
            if l_confirm_comp then do:
               ...
               for each sob_det
                  fields (sob_domain sob_line sob_nbr sob_part)
                  where   sob_domain = global_domain
                  and     sob_nbr    = sod_nbr
                  and     sob_line   = sod_line
               no-lock
         ...
         then do:
            ...
            if l_order_change then do:
               ...
               then do:
                  ...
                  if ship_line.abs_qty <> l_abs_pick_qty
                     and     ship_line.abs_qty > 0
                     and not undotran
                  then do:
                     {gprun.i ""soitalla.p""
                              "(input ship_line.abs_order,
                                ...
                                output adj_qty,
                                output undotran)"}
                  end. /* IF SHIP_LINE.ABS_QTY <> L_ABS_PICK_QTY */
