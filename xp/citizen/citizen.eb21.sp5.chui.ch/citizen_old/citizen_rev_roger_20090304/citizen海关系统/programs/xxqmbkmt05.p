...
define var v_form_type  like xxexp_type initial "6" .
...
repeat:
    ...
    if avail xxexp_mstr then do:
        if xxexp_type <> v_form_type then do:
            message "错误:已存在,且非'进口料退港'出口报关单,请重新输入" .
            undo,retry .
        end.
        ...
        do on error undo,retry :
            ...
            if not avail xxexpd_det  then do:
                ...
                do on error undo, retry:
                    ...
                    /*if xxexpd_cu_qty > (xxcbkd_qty_ord + xxcbkd_qty_tsf - xxcbkd_qty_sl - xxcbkd_qty_io  + xxcbkd_qty_rjct )  then do:
                    ...
                    find first xxcbkd_det 
                            ...
                            and xxcbkd_cu_ln    = xxexpd_cu_ln 
                    no-error .
                    if avail xxcbkd_det then xxcbkd_qty_rjct = xxcbkd_qty_rjct + xxexpd_cu_qty .
                end. /*loope*/
