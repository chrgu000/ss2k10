...
/* REVISION: 1.0      Create : 02/25/2008   BY: Softspeed tommy xie         */
         ...
         with frame b three-d overlay 8 down row 9 title color normal "出口成品" scroll 1 width 80.

         line = 0.
         find last xxcbkd_det where xxcbkd_domain = global_domain
               and xxcbkd_bk_nbr = l-key and xxcbkd_bk_type = "out" no-lock no-error.
         ...
         repeat on endkey undo, leave:
            ...
            editing:
               {mfnp01.i xxcbkd_det line xxcbkd_bk_ln l-key "xxcbkd_domain = global_domain and xxcbkd_bk_type = 'out' and xxcbkd_bk_nbr" xxcbkd_bk_nbr}
            ...
            do on error undo, retry with frame b:            
               ...
               then do:
                  ...
                  if del-yn then do:
                     ...
                     if available xxcbk_mstr then xxcbk_exp_amt = xxcbk_exp_amt - ext_cost.

                     delete xxcbkd_det.
/*
                      display xxcbk_exp_amt with frame f-1.
*/
            ...
            find first xxcbk_mstr where xxcbk_domain = global_domain and xxcbk_bk_nbr = l-key no-error .
            if available xxcbk_mstr then xxcbk_exp_amt = ext_cost.
/*
            display xxcbk_exp_amt with frame f-1.
*/
         end.
