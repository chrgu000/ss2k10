...
repeat:
    ...
    if par_ln1 = 99999        then par_ln1 = 0 .
    if comp_ln1 = 99999        then comp_ln1 = 0 .


    update par_ln par_ln1 cu_par cu_par1  comp_ln comp_ln1 cu_comp cu_comp1 with frame a.

    if cu_par1 = "" then cu_par1 = hi_char.
    if cu_comp1 = "" then cu_comp1 = hi_char.
    if par1 = "" then par1 = hi_char.
    if comp1 = "" then comp1 = hi_char.
    if par_ln1   = 0  then par_ln1 = 999999.
    if comp_ln1   = 0  then comp_ln1 = 999999.
...
for each xxcps_mstr 
        ...
        and xxcps_par_ln >= par_ln and xxcps_par_ln <= par_ln1
        and xxcps_comp_ln >= comp_ln and xxcps_comp_ln <= comp_ln1 
