...
repeat:
    ...
    update nbr nbr1 cu_ln cu_ln1 cu_part cu_part1 v_yn   with frame a.
...
for each xxcpld_det 
        ...
        and xxcpld_cu_ln   >= cu_ln and xxcpld_cu_ln <= cu_ln1
        and xxcpld_cu_comp >= cu_part      and xxcpld_cu_comp <= cu_part1 
