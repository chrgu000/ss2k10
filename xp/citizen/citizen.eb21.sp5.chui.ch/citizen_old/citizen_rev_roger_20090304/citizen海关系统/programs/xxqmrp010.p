...
PUT UNFORMATTED "#def REPORTPATH=$/Citizen/xxqmrp010" SKIP.
...
for each xxcbkd_det 
        ...
        for each xxexp_mstr
            ...
            each xxexpd_det 
                ...
                no-lock :
                v_qty_sl = v_qty_sl + xxexpd_cu_qty .
        end.
        ...
        for each xxexp_mstr
            ...
            each xxexpd_det 
                ...
                and xxexpd_cu_ln = xxcbkd_cu_ln
                no-lock :
                v_qty_io = v_qty_io + xxexpd_cu_qty .
        end.
        for each xxepr_mstr 
            ...
            each xxeprd_Det 
                ...
                and xxeprd_cu_ln = xxcbkd_cu_ln
                no-lock :
            v_qty_io = v_qty_io + xxeprd_cu_qty .
        end. 

        v_qty_oh  = ( v_qty_sl + v_qty_io ) .
        v_qty_oh1 = xxcbkd_qty_ord - v_qty_oh .
        v_qty_oh2 = round(v_qty_oh1 / xxcbkd_qty_ord * 100 ,2) . 
