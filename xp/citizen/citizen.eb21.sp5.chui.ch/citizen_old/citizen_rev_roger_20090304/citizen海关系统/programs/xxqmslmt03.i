...
define {1} shared var v_sl_type like xxsl_type format "1-转厂转入/2-转厂转出" initial no  .
...
form
    space(1)
    v_nbr                  label "报关单号"  
    xxexp_sl_nbr           label "关封号"
    xxexp_iss_date         label "进口日期" colon 58     
...
form
    ...
    xxexpd_amt       label "金额"         colon 13 xxexpd_used      label "已转厂数"   colon 45     
