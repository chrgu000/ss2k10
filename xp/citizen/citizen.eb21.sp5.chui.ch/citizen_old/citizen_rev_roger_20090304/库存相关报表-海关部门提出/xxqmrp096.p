...
/*小计*/
define var xx_qty_start like ld_qty_oh .
define var xx_amt_start like trgl_gl_amt  .
define var xx_qty_end like ld_qty_oh  .
define var xx_amt_end like trgl_gl_amt .
define var xx_qty like ld_qty_oh extent 60.
define var xx_amt like trgl_gl_amt  extent 60.
/*总计*/
define var xxx_qty_start like ld_qty_oh .
define var xxx_amt_start like trgl_gl_amt  .
define var xxx_qty_end like ld_qty_oh  .
define var xxx_amt_end like trgl_gl_amt .
define var xxx_qty like ld_qty_oh  extent 60.
define var xxx_amt like trgl_gl_amt  extent 60.
...
maxii = ii - 1 .
	...
	FOR EACH xxptstkrp02 break by xxptstkrp02_site by xxptstkrp02_loc  by xxptstkrp02_part :
		...
		for each tta6ictrrp0303 FIELD(tta6ictrrp0303_part tta6ictrrp0303_type tta6ictrrp0303_loc tta6ictrrp0303_nbr
			...
			/*判断是否在库位分组里--END*/
    			...
    			if not avail tt then do:
                    find first tt where tt_trtype = "RCT-other" no-error.
                    if avail tt then do:
                        if first-of(tta6ictrrp0303_trnbr) then
                            assign xxptstkrp02_rctiss_qty[tt_integer] = xxptstkrp02_rctiss_qty[tt_integer] + tta6ictrrp0303_qty_dr .
                            assign xxptstkrp02_rctiss_amt[tt_integer] = xxptstkrp02_rctiss_amt[tt_integer] + tta6ictrrp0303_amt_dr .
		...
		for each tta6ictrrp0303 FIELD(tta6ictrrp0303_part tta6ictrrp0303_type tta6ictrrp0303_loc tta6ictrrp0303_nbr
			...
			/*判断是否在库位分组里--END*/
    			...
    			find first tt where tt_trtype = tta6ictrrp0303_type no-error.
    			if not avail tt then do:
                    find first tt where tt_trtype = "ISS-other" no-error.
                    if avail tt then do:
                        if first-of(tta6ictrrp0303_trnbr) then
                            assign xxptstkrp02_rctiss_qty[tt_integer] = xxptstkrp02_rctiss_qty[tt_integer] + tta6ictrrp0303_qty_dr .
                            assign xxptstkrp02_rctiss_amt[tt_integer] = xxptstkrp02_rctiss_amt[tt_integer] + tta6ictrrp0303_amt_dr .
	...
	PUT UNFORMATTED "#def REPORTPATH=$/Citizen/xxqmrp096" SKIP.
	PUT UNFORMATTED "#def :end" SKIP.   
	define variable max_BI_Field_pcs as inte init 51 .
	max_BI_Field_pcs = 51 .
    PUT UNFORMATTED "#define column1 as char[18]" SKIP.
    PUT UNFORMATTED		"#日期起;日期至;产线代码;"	.
    PUT UNFORMATTED		"产线名称;"	.
	PUT UNFORMATTED		"零件编号;"	.
    PUT UNFORMATTED		"名称;"	.
	PUT UNFORMATTED		"规格;"	.
	PUT UNFORMATTED		"计量单位;"	.
    PUT UNFORMATTED		"地点;"	.
    PUT UNFORMATTED		"地点名称;"	.
    PUT UNFORMATTED		"库位;"	.
    PUT UNFORMATTED		"库位名称;"	.
...
*/
	...
	FOR EACH xxptstkrp02 ,
        ...
        break by xxptstkrp02_line by xxptstkrp02_part by xxptstkrp02_site by xxptstkrp02_loc 
        :   

        if first-of(xxptstkrp02_line) then do:
            xx_qty_start = 0 .
            xx_qty_end = 0 .
            xx_amt_start = 0 .
            xx_amt_end  = 0 .
        ...
        xx_qty_start = xx_qty_start +  xxptstkrp02_start_qty_oh .
        xx_qty_end = xx_qty_end + xxptstkrp02_end_qty_oh.
        xx_amt_start = xx_amt_start + xxptstkrp02_start_amt.
        xx_amt_end  = xx_amt_end + xxptstkrp02_end_amt .
        IF maxii >= 1 THEN DO:
            DO ii = 1 TO maxii :
                xx_qty[ii] = xx_qty[ii] + xxptstkrp02_rctiss_qty[ii]  .
                xx_amt[ii] = xx_amt[ii] + xxptstkrp02_rctiss_amt[ii].
            END.
        END.

        xxx_qty_start = xxx_qty_start +  xxptstkrp02_start_qty_oh .
        xxx_qty_end = xxx_qty_end + xxptstkrp02_end_qty_oh.
        xxx_amt_start = xxx_amt_start + xxptstkrp02_start_amt.
        xxx_amt_end  = xxx_amt_end + xxptstkrp02_end_amt .
        IF maxii >= 1 THEN DO:
            DO ii = 1 TO maxii :
                xxx_qty[ii] = xxx_qty[ii] + xxptstkrp02_rctiss_qty[ii]  .
                xxx_amt[ii] = xxx_amt[ii] + xxptstkrp02_rctiss_amt[ii].
            END.
        END.
        ...
        find first loc_mstr 
            ...
            and   loc_site = xxptstkrp02_site
            and   loc_loc = xxptstkrp02_loc
        no-lock no-error.
        v_locname = if avail loc_mstr then loc_desc else "".
        ...
        IF maxii >= 1 THEN DO:
            DO ii = 1 TO maxii :
                IF xxptstkrp02_rctiss_qty[ii] <> 0 OR
                   xxptstkrp02_rctiss_amt[ii] <> 0 THEN v_log2 = YES.
            END.
        END.
        ...
        IF v_log1 = YES OR v_log2 = YES THEN DO:
            ...
            PUT UNFORMATTED xxptstkrp02_line			  ";" .
        ...
        if last-of(xxptstkrp02_line) then do:
            if idate = ? then put  UNFORMATTED  ";". 
            else             put UNFORMATTED  year(idate) "/" month(idate) "/" day(idate) ";". 
            if idate1 = ? then put  UNFORMATTED  ";". 
            else             put UNFORMATTED  year(idate1) "/" month(idate1) "/" day(idate1) ";" . 
            ...
            PUT UNFORMATTED ";" .
            PUT UNFORMATTED ";" .
    	    PUT UNFORMATTED xx_qty_start		  ";" .
            PUT UNFORMATTED xx_amt_start		  ";" .
            if maxii >= 1 THEN do:
                DO ii = 1 to maxii:
                     PUT UNFORMATTED  xx_qty[ii]	";" .
                     PUT UNFORMATTED  xx_amt[ii]    ";" .
                END.   
            end.
    	    PUT UNFORMATTED xx_qty_end	";"	.
            PUT UNFORMATTED xx_amt_end		 . 
    		put skip .  
            
        end. /*if last-of(xxptstkrp02_line)*/
    ...
    END.
            ...
            PUT UNFORMATTED ";" .
            PUT UNFORMATTED ";" .
    	    PUT UNFORMATTED xxx_qty_start		  ";" .
            PUT UNFORMATTED xxx_amt_start		  ";" .
            if maxii >= 1 THEN do:
                DO ii = 1 to maxii:
                     PUT UNFORMATTED  xxx_qty[ii]	";" .
                     PUT UNFORMATTED  xxx_amt[ii]    ";" .
                END.   
            end.
    	    PUT UNFORMATTED xxx_qty_end	";"	.
            PUT UNFORMATTED xxx_amt_end		 . 
    		put skip .  
