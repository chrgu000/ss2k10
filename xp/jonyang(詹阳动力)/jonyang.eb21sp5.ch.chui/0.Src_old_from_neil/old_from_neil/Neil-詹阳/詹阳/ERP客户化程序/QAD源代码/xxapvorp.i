...
*/
   ap_curr         colon  10
   curr_disp_line1 colon  39 label "Exch Rate"
   skip(1)
/* SS 090526.1 - E */
/* SS 090526.1 - B */
/*
...
*/
   ...
   skip(1)
   ap_amt          colon  10
   vo_ndisc_amt    colon 	41
   vo_confirmed		 colon  68
   vo_applied      colon  10 label "已用金额"
   vo_hold_amt		 colon  41
   vo_conf_by      colon  68 label "确认人"
/* SS 090617.1 - B */
	 vo_prepay 			 colon 10 label "本次预付"
/* SS 090617.1 - E */
/* SS 090526.1 - E */
/* SS 090630.1 - B */
	 vd_prepay   		 colon 41 label "预付余额"
/* SS 090630.1 - E */
...
*/
   if page-size - line-counter < 4 then do:
     put "" at 2 .
     put ""  at 2 .
     put  "制单：______________________   审批：____________________ " at 6.
     page.  
   end.
/* SS 090617.1 - E */
...
*/
      display ap_amt vo_ndisc_amt vo_applied vo_hold_amt
/* SS 090526.1 - E */
...
*/
   display base_amt @ ap_amt base_ndamt @ vo_ndisc_amt
/* SS 090526.1 - E */
...
/* SS 090630.1 - B */
		if base_rpt = "" then 
			disp vo_prepay / ap_ex_rate * ap_ex_rate2 @ vo_prepay	"RMB" @ ap_curr with frame {&frame1}.
		else 
			disp vd_prepay * ap_ex_rate / ap_ex_rate2 @ vd_prepay with frame {&frame1}.
/* SS 090630.1 - E */
...
/* SS 091030.1 - B */
						find first sb_mstr where sb_domain = global_domain and sb_sub = vod_sub no-lock no-error.
						if avail sb_mstr then disp sb_desc @ vod_desc.
/* SS 091030.1 - E */
