...
/*L02Q*/  {gprunpdf.i "mcui" "p"}
          ...
          define new shared variable age_days as integer extent 8
             label {&arcsrp02_p_6}.
...
/* SS 090824.1 - B */
					define new shared var sub like sb_sub.
					define new shared var sub1 like sb_sub.
/* SS 090824.1 - E */
 ...
 *            show_mstr_comments mstr_type mstr_lang age_days [ 1 for 7 ]"
 *            &frm = "a"}
 */
