...
/* SS 090923.1 - B */
					define variable et_age_totamt          like ar_amt extent 5.
					et_age_totamt[1] = 0.
					et_age_totamt[2] = 0.
					et_age_totamt[3] = 0.
					et_age_totamt[4] = 0.
...
/*L02Q*                  display "    " + et_disp_curr @ ar_nbr */
/*L02Q*/                 display "    " + et_report_curr @ ar_nbr
/*L059*                    "Customer" @ ar_date "Totals:" @ ar_cr_terms */
...
/*L02Q*              display "    " + et_disp_curr @ ar_nbr */
/*L02Q*/             display "    " + et_report_curr @ ar_nbr
/*L059*               "Report" @ ar_date "Totals:" @ ar_cr_terms */
...
/* SS 090923.1 - B */
						et_age_totamt[5] = et_age_totamt[1] + et_age_totamt[2] + et_age_totamt[3] + et_age_totamt[4].

						put   	"合计" at 1
						        et_age_totamt[1] at 66 " " 
										et_age_totamt[2] " "
								    et_age_totamt[3] " "
										et_age_totamt[4] " "
										et_age_totamt[5] 
