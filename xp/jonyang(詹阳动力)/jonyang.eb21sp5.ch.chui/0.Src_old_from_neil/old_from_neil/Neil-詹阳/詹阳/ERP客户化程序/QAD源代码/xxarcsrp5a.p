/* xxarcsrp5a.p - AR AGING REPORT FROM AR EFF DATE SUBROUTINE               */
...
/*L00S*END ADDED SECTION*/
          ...
          /*BEGIN PROGRAM*/
          find first gl_ctrl where gl_domain = global_domain no-lock. /*for rounding after currency conversion*/
...
/*L02Q*                                               input gl_rnd_mthd)"} */
                         ...
                         if base_amt - base_applied <> 0 then do:
                             ...
                             if available ct_mstr and ct_dating = yes then do:
                                ...
                                total-amt = 0.
                                for each ctd_det where ctd_domain = global_domain and ctd_code = ar_cr_terms
...
/*JY003*/                      pacct = ar_acct.
/*JY003*/                      if pacct <> "2612" or substring(pacct,1,4) <> "1141" then 
                               find first ard_det where ard_domain = global_domain and ard_nbr = ar_nbr and ard_acct = "2162" no-lock no-error.
