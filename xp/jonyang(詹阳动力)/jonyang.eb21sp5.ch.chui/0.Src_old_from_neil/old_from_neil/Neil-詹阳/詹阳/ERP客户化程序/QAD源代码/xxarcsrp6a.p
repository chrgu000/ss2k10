/* xxarcsrp6a.p - AR AGING REPORT FROM AR EFF DATE SUBROUTINE               */
/* GUI CONVERTED from arcsrp5a.p (converter v1.71) Thu Oct  1 14:20:04 1998 */
...
/* REVISION: 8.6E     LAST MODIFIED: 10/18/2000   BY: *JY003* **Frankie Xu*/
...
&SCOPED-DEFINE arcsrp5a_p_1 "差异-"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_2 "以基本货币计算的帐龄金额合计:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_3 "S-汇总/D-明细"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_4 "电话"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_5 "未指定用途的付款:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_6 "打印客户采购单"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_7 "打印主说明"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_8 "打印付款明细"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_9 "打印发票说明"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_10 "参考    "
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_11 "基本货币客户合计:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_12 "       合计金额"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_13 "支付方式"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_14 "帐龄日为 "
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_15 " 帐龄:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_16 "催帐"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_17 "基本货币报表合计:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_18 "-相对于基本货币:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_19 "客户类型"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_20 "按日期(DUE,EFF,INV)算帐龄"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_21 "      天   "
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_22 "借/贷项通知单:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_23 "联系人"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_24 " 客户合计:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_25 "汇票:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_26 "栏目天数"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_27 "    小于  "
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_28 "到期日期"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_29 "财务费用:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_30 "    超过"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_31 "生效日期"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_32 "级"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_33 " 兑换率的合计:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_34 "发票:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_35 " 合计 "
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_36 "发票日期"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_37 " 报表合计:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_38 "多个"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_39 "客户"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_40 "  合计:"
/* MaxLen: Comment: */

&SCOPED-DEFINE arcsrp5a_p_41 "报表"
/* MaxLen: Comment: */
...
/*JY003*/ define variable pacct like ar_acct.
/*jy003*/ define buffer   myar  for ar_mstr.
/*jy003*/ define variable pi as integer.
/*jy003*/ define variable ni as integer.
...
/*L00S*END ADDED SECTION*/
          ...
          /*BEGIN PROGRAM*/
          find first gl_ctrl no-lock where gl_domain = global_domain . /*for rounding after currency conversion*/
...
****jy003**/             
             ...
             "---------------"
             "----------------" skip
/*JY003**  with STREAM-IO /*GUI*/  frame phead1 width 132 page-top.   **/
/*JY003*/  with STREAM-IO /*GUI*/  frame phead1 width 150 page-top.
          view frame phead1.

          do with frame c down no-box
/*L00S*/     on endkey undo, leave:
             for each cm_mstr
                where cm_domain = global_domain and (cm_addr >= cust and cm_addr <= cust1)
                and (cm_type >= cust_type and cm_type <= cust_type1)
                no-lock by cm_sort:

                high_dun_level = 0.

                for each ar_mstr where ar_domain = global_domain and ar_bill = cm_addr
...
/*JY003**          with frame c width 132 no-labels:        **/
/*JY003*/          with frame c width 150 no-labels:
                   setFrameLabels(frame c:handle).
                   do for myar:       /* SEE IF PAID PRIOR TO EFFDATE */
                      pi = 0.
                      ni = 0.
/*jy003*/             find first myar where myar.ar_domain = global_domain and myar.ar_bill = ar_mstr.ar_bill 
                      and myar.ar_amt <> myar.ar_applied  and myar.ar_amt > 0 no-lock no-error .
                      if available myar then pi = 1 .

/*jy003*/             find first myar where myar.ar_domain = global_domain and myar.ar_bill = ar_mstr.ar_bill 
                      and myar.ar_amt <> myar.ar_applied  and myar.ar_amt < 0 no-lock no-error .
                      if available myar then ni = 1 .

                   end. /*do fro myar */

/*jy003*/         if ni = 1 and pi = 1 then do:

                   if (oldcurr <> ar_mstr.ar_curr) or (oldcurr = "") then do:
/*L02Q*               {gpcurmth.i */
/*L02Q*                   "ar_curr" */
/*L02Q*                   "4" */
/*L02Q*                   "next" */
...
/*L02Q*/              end.
                   ...
                   where ls_domain = global_domain and ls_type = lstype and ls_addr = cm_addr)) then do:
                      ...
                      if ar_mstr.ar_type <> "P" then do:
                         ...
                         for each ard_det where ard_domain = global_domain and ard_nbr = ar_mstr.ar_nbr no-lock:
                            if ard_typ <> "n" then
...
/*jy0003****  /*L00S*/                    et_age_amt[ 1 for 4]     *****/
                            ar_amt
/*JY003**                with STREAM-IO /*GUI*/  frame c width 132.   **/
/*JY003*/                with STREAM-IO /*GUI*/  frame c width 150.
...
/*L00S*/                    et_sum_amt[i]  = 0.
                         ...
                         if age_by = "EFF" then age_by_date = ar_mstr.ar_effdate.
                         else if age_by = "INV" then age_by_date = ar_mstr.ar_date.
                         else do:
                            if ar_mstr.ar_type <> "P" then age_by_date = ar_mstr.ar_due_date.
                            else age_by_date = ar_mstr.ar_date.
                         end.
                         age_period = 4.
                         do i = 1 to 4:
                         ...
                         do for armstr: /* SEE IF PAID PRIOR TO EFFDATE */
                            ...
                            if ar_mstr.ar_type <> "P" then do:
                               ...
                               if ar_mstr.ar_entity >= entity     and
                                  ...
                                  /* THIS INVOICE/MEMO                */
                                  for each ard_det where ard_domain = global_domain and 
 ...
 *H1KH** END DELETE */
                            ...
                            /* OTHERWISE AR_MSTR IS A PAYMENT RECORD */
                               ...
                               /* EFFECTIVE DATE                          */
                               for each ard_det where ard_domain = global_domain and ard_nbr = ar_mstr.ar_nbr
                               no-lock:

                                  /*SEE IF OPEN ITEM EXISTED PRIOR TO EFF DATE*/
                                  if ard_type <> "U" then do:
                                     find armstr where armstr.ar_domain = global_domain and armstr.ar_nbr = ard_ref
                                        no-lock no-error.
                               ...
                               for each armstr
                                  where armstr.ar_domain = global_domain and armstr.ar_check = ar_mstr.ar_check
                                  ...
                                  for each arddet where arddet.ard_domain = global_domain and 
                                     arddet.ard_nbr = armstr.ar_nbr
                                     no-lock:

                                     find armstr1
                                        where armstr1.ar_domain = global_domain and armstr1.ar_nbr = arddet.ard_ref
                                        no-lock no-error.
...
/*L02Q*                                               input gl_rnd_mthd)"} */
                         ...
                         if base_amt - base_applied <> 0 then do:
                             ...
                             find ct_mstr where ct_domain = global_domain and ct_code = ar_cr_terms
                             ...
                             if available ct_mstr and ct_dating = yes then do:
                                ...
                                for each ctd_det where ctd_code = ar_cr_terms
                                   ...
                                   find ct_mstr where ct_domain = global_domain and ct_code = ctd_date_cd
                                   no-lock no-error.
...
/*L00S*END ADDED SECTION*/
                            ...
                            if new_cust and age_amt[age_period] <> 0 then do:
                               ...
                               rec_printed = true.
                               name = "".
                               find ad_mstr where ad_domain = global_domain and ad_addr = ar_bill
...
/*JY003**                      display ar_bill no-label      **/
/*JY003*/                      display 
                                       name no-label
                                       ad_state
                                       cm_pay_date
                                       ...
                                       ad_ext no-label
/*JY003**                      with frame b side-labels width 132 STREAM-IO /*GUI*/ .        **/
/*JY003*/                      with frame b side-labels width 150 STREAM-IO /*GUI*/ .
...
/*JY003*/                      pacct = ar_acct.
/*JY003*/                      if pacct <> "2162" or substring(pacct,1,4) <> "1141" then 
                               find first ard_det where ard_domain = global_domain and ard_nbr = ar_nbr and (
                                    ard_acct = "2162" or ard_acct = "2171") no-lock no-error.
/*JY003*/                      if available ard_det then pacct = ard_acct.
                               else do:
                                  find first ard_det where ard_domain = global_domain and ard_nbr = ar_nbr and 
                                  substring(ard_acct,1,4) = "1141" no-lock no-error.
                                  if available ard_det then pacct = ard_acct.
/*JY003*/                         else pacct = ar_acct .
                               end.
                               
/*JY003*/                      if ar_type <> "P" then display ar_bill ar_nbr ar_type pacct @ ar_acct WITH STREAM-IO /*GUI*/ .
/*JY003*/                      else display ar_bill ar_check @ ar_nbr "U" @ ar_type pacct @ ar_acct WITH STREAM-IO /*GUI*/ .

/*JY003**                      if ar_type <> "P" then display ar_nbr  ar_type ar_acct WITH STREAM-IO /*GUI*/ .     **/
/*JY003**                      else display ar_check @ ar_nbr "U" @ ar_type WITH STREAM-IO /*GUI*/ .               **/
...
*************/
/*L00S*/                                et_base_applied * (-1) @ ar_amt WITH STREAM-IO /*GUI*/ .
                                     down 1.
                                     /* SHOW PAYMENT DETAIL */
                                     for each ard_det where ard_domain = global_domain and ard_ref = ar_nbr
                                        ...
                                        if available armstr then do:
                                           ...
                                           then do:
                                              ...
                                              display armstr.ar_type
                                                 ...
                                                 @ ar_mstr.ar_effdate
                                                 armstr.ar_check
                                                 @ ar_mstr.ar_cr_terms WITH STREAM-IO /*GUI*/ .
                                              down 1.
...
/****jy003*** /*L00S*/                    underline et_age_amt ar_amt.        ***/
/****jy003**/               underline ar_amt. 
                         end.
...
/*L00S*BEGIN ADD */
                ...
                accum total (et_base_amt - et_base_applied) @ ar_amt WITH STREAM-IO /*GUI*/ .
             down 1.
*********jy003***/
...
/*JY003**    with frame d width 132 no-labels STREAM-IO /*GUI*/ .  **/
/*JY003*/    with frame d width 150 no-labels STREAM-IO /*GUI*/ .
