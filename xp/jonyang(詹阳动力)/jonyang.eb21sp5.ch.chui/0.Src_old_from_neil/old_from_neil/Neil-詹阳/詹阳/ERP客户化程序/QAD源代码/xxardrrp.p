...
form
   ...
   ar_date column-label "Date!Eff_Date!Tax_Date"
/*SS 20090207 - B*/
/*
...
/*SS 20090207 - E*/
/* SS 090923.1 - B */
		ar_sub column-label "entity!sub!Contest"
/* SS 090923.1 - E */
   ar_acct column-label "ENTY!ACCOUNT!LEVEL"
/* SS 090923.1 - B */
/*
   ar_sub
   ar_cc
*/
/* SS 090923.1 - E */
   ar_cr_terms column-label "CR_TERMS!CUR!C"
/* SS 090923.1 - B */
/*
...
/* SS 090923.1 - B */
		find first sb_mstr where sb_domain = global_domain and sb_sub = l_sub no-lock no-error.
		if avail sb_mstr then disp sb_desc with frame d.
/* SS 090923.1 - E */
...
/* SS 090923.1 - B */
			disp ar_tax_date @ ar_date 
					 ar_contested @ ar_sub
					 string(ar_dun_level) @ ar_acct
					 disp_curr @ ar_cr_terms 
			with frame c.
/* SS 090923.1 - E */
...
*/
				 put skip(1).
				 put "制表：__________________审核：_________________日期:__________________  " at 11 skip.
				 if not last(ar_nbr) then page.
/* SS 090923.1 - E */
      end.
