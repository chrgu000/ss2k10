...
/*K001*/     gltr_user1 label "凭证号"
             with STREAM-IO /*GUI*/  frame b 1 down width 80 no-attr-space.
                 ...
                 if batch = "" then do:
                    for each gltr_hist where gltr_domain = global_domain and  gltr_ref >= ref and gltr_user1 >= vounbr
...
/*K0BN** /*K001*/               display corr-flag with frame b. **/
                    ...
                    for each gltr_hist where gltr_domain = global_domain and gltr_batch = batch and gltr_user1 >= vounbr and 
