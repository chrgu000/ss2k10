...
*/
define new shared variable numlines    as integer initial 100.
/*SS 20090318 - E*/
...
*/
define new shared variable worecno as recid extent 100 no-undo.
/*SS 20090318 - E*/
...
/*SS 20090318 - B*/
define variable vlot  like wo_lot  label "ID".
define variable vlot2 like wo_lot.
define variable vNBR  like wo_nbr label "¼Ó¹¤µ¥".
define variable vnbr2 like wo_nbr.
/*SS 20090318 - E*/
...
/*SS 20090318 - B*/
   vnbr                     colon 15
   vnbr2 label {t001.i}     colon 45
   vlot                     colon 15
   vlot2 label {t001.i}     colon 45
/*SS 20090318 - E*/
   part                     colon 15
...
repeat:
   ...
   then
      rel_date2 = ?.
/*SS 20090318 - B*/
   if vlot2 = hi_char then vlot2 = "".
   if vnbr2 = hi_char then vnbr2 = "".
/*SS 20090318 - E*/
...
/*SS 20090318 - B*/
/*
      show_phantom show_line_mfg show_purchased
*/
/*SS 20090318 - E*/
      with frame a
   editing:
   ...
   then
      bom2 = hi_char.
/*SS 20090318 - B*/
   if vlot2 = "" then vlot2 = hi_char.
   if vnbr2 = "" then vnbr2 = hi_char.
/*SS 20090318 - E*/
   ...
   for each pt_mstr
      fields (pt_buyer pt_domain pt_part pt_phantom pt_pm_code) no-lock
      ...
      then do:
         ...
         for each wo_mstr
            ...
            where wo_mstr.wo_domain = global_domain
              ...
              and wo_status         = "P"
/*SS 20090318 - B*/
              and (wo_lot >= vlot and wo_lot <= vlot2)
              and (wo_nbr >= vnbr and wo_nbr <= vnbr2)
/*SS 20090318 - E*/
