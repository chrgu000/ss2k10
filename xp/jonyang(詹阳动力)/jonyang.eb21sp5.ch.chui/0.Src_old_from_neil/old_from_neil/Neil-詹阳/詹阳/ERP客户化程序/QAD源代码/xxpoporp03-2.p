...
define variable prodline like pt_prod.
define variable um like pt_um.
define variable amt_1 like sct_mtl_tl format "->>>>>9.99".
...
repeat:
    ...
    if podpart1 =hi_char then podpart1="".
		...
		update nbr nbr1 vend vend1 ord_date ord_date1 line line1 buyer buyer1 open_only new_only podpart podpart1 getall with frame a.
    ...
    do on error undo, return error on endkey undo, return error:
        ...
        each pod_det where 
            ...
            IF podqtyord <> 0 and getall = yes THEN DO:
                ...
                put  "┌───┬──-───----┬───--─┬─────────┬─────┬─────────────┐" at 2.
                put  "│采购单│" at 2 trim(po_NBR) at 12
                "│采购单序号│" AT 27  pod_line "│采  购  员│" at 59  po_buyer "│" at 99.
                put  "├───┼────-─--─┼─--------┼────--------─┴──--──┴┬─------─┬──────┤" at 2.
                put  "│供应商│" at 2 po_vend at 12 "│ 名    称 │" at 27 adname at 41 "│采购单数量│" at 73 trim(string(podqtyord,"->>>,>>>,>>9.99<<<")) "│" at 99.
                put  "├───┴─--------┬-─┴──--──┴----──────--------------─┴----------┴----------─┤" at 2.
                put  "│    零件号        │                  描     述                                                │" at 2 .
                put  "├──-----------─-┼───────--──-──────--------─────────────-──-─┤" at 2 .
                ...
                put  "├───┼──--─--┼─-─┼────-┬-────-┼─-─┴--─-------──┬─-─---┬----──-─┤" at 2.
                PUT "│单  位│" at 2 pod_UM  at 12 "│类别│" at 16 proline " │到货数量  │                      │到货日期│           │" at 39.
                PUT "├───┴──┴──┴-──┴---------┴----───┴─----──┬───-─┬---------┬----──-─┤" at 2 .
...
/* SS 090925.1 - E */
            ...
            END.
            find cc_mstr where 
                /* *ss_20090224* */  cc_domain = global_domain and
                cc_ctr = pod_cc no-lock no-error.
            find Ac_mstr where 
                /* *ss_20090224* */  ac_domain = global_domain and
                Ac_CODE = pod_AccT no-lock no-error .
