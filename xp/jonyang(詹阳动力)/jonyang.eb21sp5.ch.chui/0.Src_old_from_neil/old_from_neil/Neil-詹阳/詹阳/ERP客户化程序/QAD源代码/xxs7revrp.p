/*########################################################################
    ...
    All rights reserved worldwide.
      ...
      Program ID  : s7revrp.p    (for China plant)
           Author : Niranjan Sangapur
   Service Req. No: mfg/ni/0264
               On : 11-Jun-06
       Description: Revenue Analysis of Completed Jobs
...
/*SS 20090207 - E*/
   ...
   if can-find(first pod_det where pod_domain = global_domain and pod_so_job <> "" and 
