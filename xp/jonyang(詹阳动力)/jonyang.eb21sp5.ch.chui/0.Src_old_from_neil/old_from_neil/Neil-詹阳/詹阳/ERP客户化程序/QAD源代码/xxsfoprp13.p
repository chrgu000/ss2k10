...
/*K0Y9*/ update gup gup1 emp emp1 opdate opdate1 nbr nbr1
lot lot1 wkctr wkctr1 with frame  a.
...
/*B560*/ if op_type begins "down" then next.  */
   ...
   wo_lot = op_wo_lot no-lock no-error.
   find pt_mstr where 
