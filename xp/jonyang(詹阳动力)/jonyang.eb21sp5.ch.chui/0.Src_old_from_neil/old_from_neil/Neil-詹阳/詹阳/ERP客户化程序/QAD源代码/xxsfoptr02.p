...
/* Revision: 1.21      BY: A.R. Jayaram         DATE: 08/25/03 ECO: *P10N* */
/* $Revision: 1.22 $   BY: Michael Hansen       DATE: 07/15/04 ECO: *Q06H* */
      ...
      editing:
         ...
         then do:
            ...
            {mfnp01.i wr_route wr_op wr_op
               "input wr_lot"  " wr_route.wr_domain = global_domain and wr_lot
               "  wr_lot}
