...
define buffer wrroute for wr_route.
    ...
    define variable mpart like wod_part label "子零件".
    define variable mpart1 like wod_part.
    ...
    rel_date       colon 15
    rel_date1      label {t001.i} colon 49
...
repeat:
        ...
        if rel_date1 = hi_date then rel_date1 = ?.
				   ...
				   update nbr nbr1 lot lot1 part part1 mpart mpart1 so_job so_job1
                vend vend1 wkctr wkctr1 mch mch1 op op1 start start1 due due1 rel_date rel_date1 sort_op with frame a.
                    ...
                    if not sort_op then do:
                        ...
                        for each wo_mstr where 
                            ...
                            if available pt_mstr and pt_desc1 <> "" then do:
                                put wo_lot at 9 pt_desc1 at 22 desc1 at 78 .
                            end.
                            else do:
