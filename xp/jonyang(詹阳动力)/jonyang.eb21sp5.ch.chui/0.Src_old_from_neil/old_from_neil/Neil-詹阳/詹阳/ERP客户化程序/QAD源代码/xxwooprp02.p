        ...
        if due1 = hi_date then due1 = ?.
            ...
            if due1 = ? then due1 = hi_date.
                    ...
                    for each wr_route where 
                        ...
                        printline[11] = "├──┬┴──┬┴─┬─┴───┬──┬─────┼────┼──┬──────┬───┤".
                        printline[12] = "│准时│23.123│单时│123.123456│合计│12345.1234│实际准时│    │实际加工工时│      │".
                        printline[13] = "├──┼───┴──┴──┬──┴──┼─────┼────┴┬─┴───┬──┴───┤".

                        printline[14] = "│首检│工步: 1           │2         │3         │4         │5         │6           │".
                        printline[15] = "├──┴───┬───┬─┴┬──┬─┴┬──┬─┴┬──┬─┴─┬───┴─┬────┤".
                        printline[16] = "│分厂验收合格│      │可用│    │工废│    │料废│    │检查员│          │完成工时│".
                        printline[17] = "├──────┼───┼──┼──┼──┼──┼──┼──┼───┼─────┼────┤".
                        printline[18] = "│总厂验收合格│      │可用│    │工废│    │料废│    │检查员│          │        │".
                        printline[19] = "├──────┴───┴──┴──┴──┴──┴──┴──┴───┴─────┴────┤".
