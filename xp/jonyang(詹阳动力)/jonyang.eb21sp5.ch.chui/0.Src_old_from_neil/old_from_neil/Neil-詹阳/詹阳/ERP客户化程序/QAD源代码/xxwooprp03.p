        ...
        if due1 = hi_date then due1 = ?.
            ...
            if due1 = ? then due1 = hi_date.
                    ...
                    for each wr_route where 
                        ...
                        printline[13] = "├──┼───┼──┴─┬───┴─┬┴───┬─┴───┬┴─┬┴──┬──┬┴───┤".
                        printline[14] = "│材质│      │来料规格│          │代用规格│          │件重│      │总重│        │".
                        printline[15] = "├──┴─┬─┴┬───┴──┬──┴─┬──┼───┬─┴┬─┴─┬─┴─┬┴────┤".
                        printline[16] = "│来料日期│    │来料验收合格│        │可用│      │废品│      │检查员│          │".
                        printline[17] = "├────┼──┴┬──┬──┴┬──┬┴──┼──┬┴──┼──┬┴───┴┬────┤".
                        printline[18] = "│成品件重│      │总重│      │技术│      │计调│      │首检│1         │2       │".
                        printline[19] = "├────┴─┬─┴─┬┴─┬─┴┬─┴┬──┼──┼──┬┴──┼─────┼────┤".
                        printline[20] = "│分厂验收合格│      │可用│    │工废│    │料废│    │检查员│          │完成工时│".
                        printline[21] = "├──────┼───┼──┼──┼──┼──┼──┼──┼───┼─────┼────┤".
                        printline[22] = "│总厂验收合格│      │可用│    │工废│    │料废│    │检查员│          │        │".
                        printline[23] = "├──────┴───┴──┴──┴──┴──┴──┴──┴───┴─────┴────┤".
