/* GUI CONVERTED from woworp01.p (converter v1.71) Tue Oct  6 14:59:06 1998 */
/* woworp01.p - WORK ORDER REPORT BY PART                               */
/* COPYRIGHT qad.inc. ALL RIGHTS RESERVED. THIS IS AN UNPUBLISHED WORK. */
/* web convert woworp01.p (converter v1.00) Fri Oct 10 13:58:11 1997 */
/* web tag in woworp01.p (converter v1.00) Mon Oct 06 14:18:54 1997 */
/*F0PN*/ /*K0WJ*/ /*V8#ConvertMode=WebReport                            */
...
/* REVISION: 6.0     LAST MODIFIED: 02/13/91    BY: emb *B893*          */
/* REVISION: 7.3     LAST MODIFIED: 04/23/93    BY: ram *GA24*          */
/* REVISION: 7.2     LAST MODIFIED: 08/30/94    BY: ais *FQ61*          */
/* REVISION: 7.3     LAST MODIFIED: 09/23/94    BY: cpp *FQ88*          */
/* REVISION: 7.5     LAST MODIFIED: 10/07/94    BY: TAF *J035*          */
/* REVISION: 8.6     LAST MODIFIED: 10/13/97    by: ays *K0WJ*          */
...
&SCOPED-DEFINE woworp01_p_1 "短缺量"
/* MaxLen: Comment: */

&SCOPED-DEFINE woworp01_p_2 "加工单!批处理"
/* MaxLen: Comment: */

&SCOPED-DEFINE woworp01_p_3 "订单日期!发放日期"
/* MaxLen: Comment: */
...
/*FQ61*/ define variable site1 like wo_site.
...
/*J035*/ define variable wobatch1 like wo_batch.
     ...
     define variable qty_open like wo_qty_ord label {&woworp01_p_1}.
...
/*FQ61*/    site        colon 15
/*FQ61*/    site1       label {t001.i} colon 49 skip
...
/*FQ61*/    if site1 = hi_char then site1 = "".
/*J035*/    if wobatch1 = hi_char then wobatch1 = "".
        if nbr1 = hi_char then nbr1 = "".


/*K0WJ*/     if c-application-mode <> 'web':u then
            update
           nbr      nbr1
           lot      lot1
           part     part1
...
/*K0WJ*/ {wbrp06.i &command = update &fields = "  nbr nbr1 lot lot1 part part1  site site1
wobatch wobatch1 rel rel1 due due1 so_job so_job1 vend stat" &frm = "a"}

/*K0WJ*/ if (c-application-mode <> 'web':u) or
/*K0WJ*/ (c-application-mode = 'web':u and
/*K0WJ*/ (c-web-request begins 'data':u)) then do:
...
/*J035*/    {mfquoter.i wobatch1}
        ...
        if lot1 ="" then lot1 ="".
/*FQ61*/    if site1 = "" then site1 = hi_char.
...
/*K0WJ*/     if c-application-mode = 'web':u then return.
...
/*K0WJ*/ end.
        ...
        /* FIND AND DISPLAY */
        for each wo_mstr use-index wo_part
        where 
			wo_domain = global_domain and /*---Add by davild 20090205.1*/
			(wo_part >= part and wo_part <= part1)
/*FQ61*/    and (wo_site >= site and wo_site <= site1)
...
/*J035*/    and (wo_batch >= wobatch and wo_batch <= wobatch1)
        ...
        no-lock by wo_part by wo_nbr with frame c width 160 no-attr-space STREAM-IO :
...
/*FQ88*/       then next.
          ...
          wo_part     format "x(24)"
/*J035*       wo_nbr                                          */
/*J035*/      wo_nbr column-label {&woworp01_p_2}
          wo_lot
          wo_qty_ord
          wo_qty_comp
          wo_qty_rjct
          qty_open
          wo_ord_date column-label {&woworp01_p_3}
          wo_due_date
          wo_so_job
          wo_vend
          wo_status
...
/*J035*        display wo_rel_date @ wo_ord_date.                */
/*J035*/       display wo_batch @ wo_nbr wo_rel_date @ wo_ord_date WITH frame c .

           if available pt_mstr and pt_desc2 <> "" and pt_desc1 <> ""
           then down 1.

           if available pt_mstr and pt_desc2 <> ""
           then display pt_desc2 @ wo_part WITH frame c.
