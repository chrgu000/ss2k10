...
/*J23W* BEGIN ADD */
          for first fm_mstr
             fields( fm_domain fm_cc_sort fm_desc fm_dr_cr fm_fpos
             fm_header fm_page_brk fm_skip fm_sub_sort
             fm_sums_into fm_total fm_type fm_underln )
             use-index fm_fpos no-lock  where fm_mstr.fm_domain = global_domain
             and  fm_type = "I"
...
*/
              {gprun.i ""xxgl4inrb0.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
           END.
                /*sort type=1=sac*/
...
*/
              {gprun.i ""xxgl4inrb1.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
           END.
                /*sort type=2=cas*/
...
*/
              {gprun.i ""xxgl4inrb2.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
           END.
                /*sort type=3=sca*/
...
*/
              {gprun.i ""xxgl4inrb3.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
           END.
                /*sort type=4=acs*/
           ELSE DO:
...
*/
              {gprun.i ""xxgl4inrb4.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
           END.
...
/*J23W* BEGIN ADD */
             do i = 1 to 4:
                if budget[i] and
                   can-find (first bg_mstr  where bg_mstr.bg_domain =
                   global_domain and  bg_code = budgetcode[i] and
                                       bg_entity >= entity and
