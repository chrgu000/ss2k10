/* gl12inre.p - GENERAL LEDGER 12 COLUMN INCOME STATEMENT REPORT (PART VI) */
/* Copyright 1986-2004 QAD Inc., Carpinteria, CA, USA.                     */
/* All rights reserved worldwide.  This is an unpublished work.            */
/*F0PN*/ /*K1DS*/
/*V8:ConvertMode=Report                                           */
/*                  (Summarize cost centers)                               */
...
/*G2F9*   *F396* find ac_mstr where recid(ac_mstr) = ac_recno no-lock. */
/*J23W** /*F396*/  find fm_mstr where recid(fm_mstr) = fm_recno no-lock.**/
...
/*G2F9*/   where asc_mstr.asc_domain = global_domain and  asc_fpos = fm_fpos and
...
/*J23W*/         fields( ac_domain ac_active ac_type ac_desc ac_curr ac_code)
/*J23W*/          where ac_mstr.ac_domain = global_domain and  ac_code =
asc_acc no-lock: end.

/*G2F9*/     if first-of(asc_acc) then do:
/*G2F9*/        assign xacc = asc_acc.
