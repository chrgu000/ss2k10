...
/*J241*/  for first en_mstr fields( en_domain en_name en_entity)
...
/*J241*/  for first co_ctrl fields( co_domain co_ret co_use_sub)  where
co_ctrl.co_domain = global_domain no-lock: end.
...
/*L01W*/          et_report_curr = rpt_curr.
               ...
               do i = 1 to 2:
                  ...
                  and  glc_year = fiscal_yr[i] no-lock
                  no-error.
...
/*J241*/             fields( glc_domain glc_end glc_per glc_start glc_year)
/*J241*/             no-lock  where glc_cal.glc_domain = global_domain and
