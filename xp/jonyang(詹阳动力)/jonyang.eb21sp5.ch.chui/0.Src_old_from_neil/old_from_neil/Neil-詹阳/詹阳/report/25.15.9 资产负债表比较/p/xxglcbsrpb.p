...
*/
        {gprun.i ""xxglcbsrb0.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
        END.
        ELSE DO:
/* SS 090715.1 - B */
...
*/
        {gprun.i ""xxglcbsrb5.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
        END.
                                /*sort type=1=sac*/
...
*/
            {gprun.i ""xxglcbsrb1.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
        END.
                                /*sort type=2=cas*/
...
*/
                {gprun.i ""xxglcbsrb2.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
        END.
                                /*sort type=3=sca*/
...
*/
            {gprun.i ""xxglcbsrb3.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
        END.
                                /*sort type=4=acs*/
        ELSE DO:
...
*/
            {gprun.i ""xxglcbsrb4.p"" "(sum_lev, sort_type)"}
/* SS 090715.1 - E */
        END.
/*K0TV*/ {wbrp04.i}
