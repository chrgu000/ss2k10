...
/*J196*/ FORM /*GUI*/ wo_part desc1 buyer2 wo_nbr wo_lot wo_status wo_qty_ord wo_qty_comp wo_qty_rjct  wod_part label {&wowsrp_p_1}  desc2  WOD_QTY_REQ wod_qty_iss wod_bom_qty 
/*J196*/         
...
/*K0YQ*/ {wbrp06.i &command = update &fields = "  nbr nbr1 lot lot1 rel_date rel_date1 due_date due_date1 buyer buyer1 " &frm = "a"}
...
define buffer wod_det1 for wod_det.
    ...
    part1 = wod_part. 
    find pt_mstr where pt_part = wo_part and ((pt_buyer >= buyer and pt_buyer <= buyer1) or buyer = "")no-lock no-error.
...
/*GUI*/ {mfguirpb.i &flds=" nbr nbr1 lot lot1 rel_date rel_date1 due_date due_date1 buyer buyer1  "} /*Drive the Report*/
