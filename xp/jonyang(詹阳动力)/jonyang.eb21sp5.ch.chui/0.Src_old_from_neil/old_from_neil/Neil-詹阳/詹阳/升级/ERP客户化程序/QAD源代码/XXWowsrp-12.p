...
/*K0YQ*/ {wbrp06.i &command = update &fields = "  nbr nbr1 lot lot1 rel_date rel_date1 due_date due_date1 buyer buyer1 bz1 bz2 bz3 bz4" &frm = "a"}
...
define buffer wod_det1 for wod_det.
    ...
    FIND POD_DET WHERE POD_WO_LOT = WO_LOT NO-LOCK NO-ERROR.
...
/*GUI*/ {mfguirpb.i &flds=" nbr nbr1 lot lot1 rel_date rel_date1 due_date due_date1 buyer buyer1 bz1 bz2 bz3 bz4"} /*Drive the Report*/
