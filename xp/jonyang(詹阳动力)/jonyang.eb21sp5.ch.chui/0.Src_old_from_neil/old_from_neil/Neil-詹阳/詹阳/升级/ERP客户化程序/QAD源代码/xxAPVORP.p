/* GUI CONVERTED from apvorp.p (converter v1.71) Fri Aug 14 09:15:20 1998 */
/* apvorp.p - AP DETAIL VOUCHER REGISTER REPORT                               */
/* COPYRIGHT qad.inc. ALL RIGHTS RESERVED. THIS IS AN UNPUBLISHED WORK.       */
/* web convert apvorp.p (converter v1.00) Mon Oct 06 14:21:21 1997 */
/* web tag in apvorp.p (converter v1.00) Mon Oct 06 14:17:22 1997 */
...
&SCOPED-DEFINE apvorp_p_1 "供应商类型"
/* MaxLen: Comment: */

&SCOPED-DEFINE apvorp_p_2 "S-汇总/D-明细"
/* MaxLen: Comment: */

&SCOPED-DEFINE apvorp_p_3 "按供应商排序"
/* MaxLen: Comment: */

&SCOPED-DEFINE apvorp_p_4 "仅为未结"
/* MaxLen: Comment: */

&SCOPED-DEFINE apvorp_p_5 "打印总帐明细"
/* MaxLen: Comment: */

&SCOPED-DEFINE apvorp_p_6 "打印未确认的"
/* MaxLen: Comment: */

&SCOPED-DEFINE apvorp_p_7 "打印采购收货"
/* MaxLen: Comment: */

&SCOPED-DEFINE apvorp_p_8 "打印已确认的凭证"
/* MaxLen: Comment: */

&SCOPED-DEFINE apvorp_p_9 "仅评收据估价结算(ERS)"
/* MaxLen: Comment: */
...
/* ********** End Translatable Strings Definitions ********* */
         ...
         define new shared variable only_ers like mfc_logical label {&apvorp_p_9}.
         ...
         define new shared variable gltrans like mfc_logical initial no label
            {&apvorp_p_5}.
...
/*GUI*/ end procedure. /*p-report*/
 /*GUI*/ {mfguirpb.i &flds=" batch batch1 ref ref1 votype votype1 entity entity1 vend vend1 vdtype vdtype1 apdate apdate1 effdate effdate1 open_only only_ers show_conf show_unconf show_vph summary sort_by_vend gltrans base_rpt mixed_rpt "} /*Drive the Report*/ 
