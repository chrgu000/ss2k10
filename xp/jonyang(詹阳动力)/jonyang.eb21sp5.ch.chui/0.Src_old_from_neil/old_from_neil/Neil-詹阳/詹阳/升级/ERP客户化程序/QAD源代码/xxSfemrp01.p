...
/*K0YC*/        if c-application-mode <> 'web':u then
...
/*K0YC*/ {wbrp06.i &command = update &fields = "  emp emp1 opdate opdate1 wkctr
        wkctr1 mch mch1 part part1 nbr nbr1 lot lot1 op op1 setup_ans run_ans" &frm = "a"}
...
/*GN40*     end. */
        ...
        where (op_wkctr >= wkctr and op_wkctr <= wkctr1)
...
/*GUI*/ {mfguirpb.i &flds=" emp emp1 opdate opdate1 wkctr wkctr1 mch mch1 part part1 nbr nbr1 lot lot1 op op1 USR USR1 setup_ans run_ans "} /*Drive the Report*/
