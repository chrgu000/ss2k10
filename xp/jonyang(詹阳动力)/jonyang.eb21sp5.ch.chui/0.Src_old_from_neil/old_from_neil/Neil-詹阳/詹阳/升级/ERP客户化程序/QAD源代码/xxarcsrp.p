/* GUI CONVERTED from arcsrp.p (converter v1.71) Thu Oct  1 14:19:55 1998 */
...
/*L02Q*/        mc-exch-line2 at 23 skip(1)
             with STREAM-IO /*GUI*/  frame p1 page-top
             width 132.
             view frame p1.
             ...
             for each cm_mstr where cm_addr >= code and cm_addr <= code1 and
                                    ...
                                    over_only = no)
             no-lock break by cm_addr by cm_sort with frame b
             width 132 no-box:
...
/*L00M*/                et_cm_balance WITH STREAM-IO /*GUI*/ .
...
/*L00M*/           accum total(et_cm_balance)    @ et_cm_balance WITH STREAM-IO /*GUI*/ .
/*L00M*/           down 2.
...
/*GUI*/ {mfguirpb.i &flds=" code code1 name name1 type type1 neg_only over_only inc_zero  et_report_curr  "} /*Drive the Report*/
