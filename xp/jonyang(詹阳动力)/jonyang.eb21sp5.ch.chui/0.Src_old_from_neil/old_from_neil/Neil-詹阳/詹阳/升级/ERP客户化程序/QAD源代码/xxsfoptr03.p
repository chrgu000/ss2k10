/* xxsfoptr03.p - LABOR FEEDBACK BY WORK CENTER TRANSACTION               */
/* GUI CONVERTED from sfoptr03.p (converter v1.71) Sat May 23 00:00:03 1998 */
...
/* REVISION: 8.6      LAST MODIFIED: 05/19/00   BY: *JY006* Frankie Xu* */
...
/*GUI*/ if global-beam-me-up then undo, leave.
               ...
               prompt-for op_wkctr op_mch emp wr_nbr wr_lot wr_op
                  project dept shift
                  earn time_ind
               editing:

                  if frame-field = "op_wkctr" then do:
                    ...
                    wkctr = input op_wkctr.
                  ...
                  else if frame-field = "emp" then do:
                     ...
                     if recno <> ? then do:
                        ...
                        if input dept = "" then display emp_dept @ dept.
                     end.
                  end.
                  else if frame-field = "wr_nbr" then do:
                     /* FIND NEXT/PREVIOUS RECORD */
                     ...
                     if recno <> ? then do:
                        ...
                        if wkctr = "" then do:
                           display wr_wkctr @ op_wkctr wr_mch @ op_mch.
                           find first wc_mstr where wc_wkctr = wr_wkctr
                     ...
                     /* FIND NEXT/PREVIOUS RECORD */
                    {mfnp01.i wr_route wr_op wr_op "input wr_lot" wr_lot wr_lot}
...
/*GUI*/ RECT-FRAME-LABEL:SCREEN-VALUE in frame b = F-b-title.
               ...
               display wc_wkctr @ op_wkctr wc_desc wc_mch @ op_mch.
...
/*JY006**   {gprun.i ""sfoptra.p""}     **/
/*JY006*/   {gprun.i ""xxsfoptra.p""}     
