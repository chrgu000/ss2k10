...
/*GUI*/ RECT-FRAME:HEIGHT-PIXELS in frame a = FRAME a:HEIGHT-PIXELS - RECT-FRAME:Y in frame a - 2.
   ...
   if part <> "" then
      for each sod_det where sod_part = part
...
/*     down 1.*/
   ...
   loopd:
   for each so_mstr where (so_cust = cust)
/*B024*/ and (so_po = po or po = "")
...
/*     down 1.*/
   ...
   loope:
   for each so_mstr where so_po = po
...
/*D002* Section Start */
   ...
   loopf:
      for each sod_det where sod_site = site no-lock by sod_nbr by sod_line
...
/*H0PF*/    where sod_nbr >= "" and sod_line >= 0
