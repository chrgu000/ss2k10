...
/*wl*/define variable desc2 like pt_desc2.
...
/*wl*/  define variable mpart like wod_part label "子零件".
/*wl*/  define variable mpart1 like wod_part.
/* DISPLAY TITLE */
...
/*wl*/  mpart     colon 15
/*wl*/  Mpart1    label {t001.i} colon 49
   so_job         colon 15
...
/*IFP*/ rel_date1      label {t001.i} colon 49
...
/*wl*/  if mpart1 = hi_char then mpart = "".
...
/*IFP*/ {mfquoter.i mpart }
/*IFP*/ {mfquoter.i mpart1}
...
/*wl*/  if mpart1 = "" then mpart1 = hi_char.
...
if not sort_op then do: /*IFP*/
   ...
   for each wo_mstr where (wo_nbr >= nbr and wo_nbr <= nbr1)
       ...
       and wo_status = "r",
     first wod_det where wod_lot = wo_lot
       and (wod_part >= mpart ) and (wod_par <= mpart1 or mpart1 ="") exclusive-lock :
       
       assign wod_user2 = SUBSTRING(wod_PART,7,8).                   
   ...
   and wo_status = "r",
   first wod_det where wod_lot = wo_lot
      and (wod_part >= mpart ) and (wod_par <= mpart1 or mpart1 ="")     
   no-lock by wod_user2 by wod_part by wo_nbr by wo_part with frame b width 132 no-attr-space:
...
/*D248  {mffloat.i wo_qty_ord " " s_ordered 11}         */
      ...
      put wo_nbr at 1 wo_part at 20 wo_qty_ord format ">>>>>9.9<" to 53 wo_qty_comp format ">>>>>9.9<" to 63 wo_status  at 65  "子零件：" at 69 wod_part at 78.   
/*wl*/ find pt_mstr where pt_part = wod_part no-lock no-error.
...
/*wl*/put wo_lot at 9 pt_desc1 at 22 desc1 at 78 .
 /*wl*/ end.
      else do:
...
/*IFP*/   and wr_due >= due and wr_due <= due1
           no-lock  by wr_lot by wr_op with frame b:
...
/*GUI*/ {mfguirpb.i &flds=" nbr nbr1 lot lot1 part part1 mpart mpart1 so_job so_job1 
vend vend1 wkctr wkctr1 mch mch1 op op1 start start1 due due1 rel_date rel_date1 sort_op "} /*Drive the Report*/
