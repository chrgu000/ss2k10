...
/*IFP*/     addprint[1]   = "  员工号码：_____________    姓名：________________________    班组：_______    单位：    ".
/*IFP*/     printline[1]  = "┌───┬────┬────┬─────┬──┬────┬──┬────────────┐".
/*IFP*/     printline[2]  = "│部 门 │        │工作中心│          │设备│        │描述│                        │".
/*IFP*/     printline[3]  = "├───┼────┼────┼─────┼──┴─┬──┴──┴┬───┬───────┤".
/*IFP*/     printline[4]  = "│加工单│        │ 标  志 │          │开始日期│            │到期日│              │".
/*IFP*/     printline[5]  = "├───┼────┴────┼──┬──┴────┴──────┴───┴───────┤".
...
/*IFP*/     printline[13] = "├──┴┬──┴──┴─────┴──┴─────┴────┴──┼────┬─┴───┤".
/*IFP*/     printline[14] = "│子零件│12345678901234567890123456789012345678901234567890123456│父件用量│12345678  │".
/*IFP*/     printline[15] = "├──┬┴──┬────┬───┬──┬───┬───┬─────┴────┴─────┤".
/*                           567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234*/
/*IFP*/     printline[16] = "│硬度│      │成品件重│      │总重│      │操作者│                                │".
/*IFP*/     printline[17] = "├──┴───┼───┬┴─┬─┴┬─┴┬──┼──┬┴─┬───┬─────┬────┤".
/*IFP*/     printline[18] = "│分厂验收合格│      │可用│    │工废│    │料废│    │检查员│          │完成工时│".
/*IFP*/     printline[19] = "├──────┼───┼──┼──┼──┼──┼──┼──┼───┼─────┼────┤".
/*IFP*/     printline[20] = "│总厂验收合格│      │可用│    │工废│    │料废│    │检查员│          │        │".
/*IFP*/     printline[21] = "├────┬─┴───┼──┴──┴┬─┴──┼──┴──┼───┴┬────┼────┤".
/*ifp*/     printline[22] = "│废品总重│          │废品单件工时│        │废品总工时│        │完成日期│        │".
/*IFP*/     printline[23] = "├────┴─────┴──────┴────┴─────┴────┴────┴────┤".
