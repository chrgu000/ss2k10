...
if not sort_op then do: /*IFP*/
   {mfphead.i}
      ...
      put "   工序 / 标准工序        零   件   号       订 货 量 已完成量  短缺量    工作中心  设  备  ST  准  时   单   时  短缺量工时 下达时间 完成时间" at 1.
      put "------------------ ------------------------ --------- --------- --------- -------- -------- -- -------- --------- ---------- -------- --------" at 1.
...
/*IFP*/     printline[21] = "├───────────────────────────────────────────┤".
/*IFP*/     printline[22] = "│子零件:                                                          父件用量:            │".
/*IFP*/     printline[23] = "│下料尺寸:_________________ 单件重量:___________ 总重量:___________                    │".
/*IFP*/     printline[24] = "│                                                                                      │".
/*IFP*/     printline[25] = "│代用材料:_________________ 单件重量:___________ 总重量:___________                    │".
/*IFP*/     printline[26] = "└───────────────────────────────────────────┘".
/*                           567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234*/     
             ...
             display "│子零件:" at 5 trim(mpart) + " " + desc1-c format "x(43)" at 14 "父件用量:" at 72 mmmmm format ">>>>9.9<" at 81 um at 91 "│" at 93 .
             display printline[23] at 5.
             display printline[24] at 5.
             display printline[25] at 5.             
             display printline[26] at 5 skip(1).
             display "--------------------------------------------------------------------------------------------------" at 2 skip(2).
...
vend vend1 wkctr wkctr1 mch mch1 op op1 start start1 due due1 sort_op"} /*Drive the Report*/
