...
plj*/
            ...
            break by wr_wkctr by wr_part by wr_nbr by wr_lot by wr_op with frame b1 down width 132:
               ...
               find first pt_mstr where pt_part = wo_part use-index pt_part no-lock no-error.
                 if available pt_mstr then assign ptloc = pt_loc
                    desc1 = trim(pt_desc1) + " " + pt_desc2 
                    um = pt_um
                    usrname = "".
                 else assign  ptloc = pt_loc
                    desc1 = ""
                    um = ""   
                    usrname = "".
               ...
               find first ps_mstr where ps_par = wo_part use-index  ps_par no-lock no-error.
                 if available ps_mstr then do:
                    ...
                    find first pt_mstr where pt_part = mpart use-index pt_part no-lock no-error.
                      if available pt_mstr then assign desc1-c = trim(pt_desc1) + " " + pt_desc2. 
                      else assign desc1-c = "".
                 end.
                 else assign mpart = "".
                 ...
                 if first-of(wr_nbr) and first-of(wr_lot) then do:
                   if page-size - line-count < 9 then page.
                    put "工艺流程单(2)"  at 4 "雇员：____________________________________________________________________________" at 25  "下达日期：_________ " at 111. 
                    pline =  "│加工单│" + string(wo_nbr,"x(12)" ) + "│标志│" + string(wo_lot,"x(8)") + "│零号件│" + string(wo_part,"x(18)") + "│单位│" + pt_um + "│描述│" + string(desc1,"x(46)") + "│" .
                    put "┌───┬──────┬──┬────┬───┬─────────┬──┬─┬──┬───────────────────────┐" at 2 skip.
                    put pline at 2  skip.
                    put "├───┴──┬───┴┬─┴─┬──┴─┬─┴─┬────┬──┴──┴─┴──┴───────────────────────┤" at 2.
                    put "│加工单需求量│" at 2 wo_qty_ord format ">>>>9.9<" to 25 "│完成量│" at 26  wo_qty_comp format ">>>>9.9<" to 43 "│短缺量│" at 44 wo_qty_ord - wo_qty_comp - wo_qty_rjct format ">>>>9.9<" to 61 "│子零件:" at 62 mpart at 71 desc1-c format "x(42)" at 90 "│" at 132.    
                    put "├───┬──┴────┴───┴┬───┼───┴┬───┼───┬───┬──────┬──┬──┬──┬──┬──┬────┤" at 2.
                 ...
                 if page-size - line-count <= 2 then do:
                       ...
                       put pline at 2  skip.
                       put "├───┴──┬───┴┬─┴─┬──┴─┬─┴─┬────┬──┴──┴─┴──┴───────────────────────┤" at 2.
                       put "│加工单需求量│" at 2 wo_qty_ord format ">>>>9.9<" to 25 "│完成量│" at 26  wo_qty_comp format ">>>>9.9<" to 43 "│短缺量│" at 44 wo_qty_ord - wo_qty_comp - wo_qty_rjct format ">>>>9.9<" to 61 "│子零件:" at 64 mpart at 71 desc1-c format "x(42)" at 90 .    
                       put "├───┬──┴────┴───┴┬───┼───┴┬───┼───┬───┬──────┬──┬──┬──┬──┬──┬────┤" at 2.
                       put "│ 工 序│     描          述     │ 准 备│单件工时│需求量│短缺量│加工量│实准备  单件│首检│合格│报废│终检│日期│工作中心│" at 2.
                       put "├───┼────────────┼───┼────┼───┼───┼───┼───┬──┼──┼──┼──┼──┼──┼────┤" at 2.
                 end.
