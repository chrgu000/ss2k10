...
define variable mmmm like wo_lot.
...
/*IFP***********
   ...
   "├───┴──┬───┴┬─┴─┬──┴─┬─┴─┬────┬──┴──┴─┴──┴───────────────────────┤".
   "│加工单需求量│123456.9│完成量│123456.9│短缺量│123456.9│子零件                                                              │".
   "├───┬──┴────┴───┴┬───┼───┴┬───┼───┬───┬──────┬──┬──┬──┬──┬──┬────┤".
   "│ 工 序│     描          述     │ 准 备│单件工时│需求量│短缺量│加工量│实准备  单件│首检│合格│报废│终检│日期│工作中心│".
   "├───┼────────────┼───┼────┼───┼───┼───┼───┬──┼──┼──┼──┼──┼──┼────┤".
 ...
 请查看相对应的字段 
   ...
   短 缺 量 = max(wr_qty_ord - wr_qty_comp , 0 ).
...
plj*/
            mmmm = " ".
            for each wr_route where ( wr_wkctr >= wkctr and wr_wkctr <= wkctr1 or wkctr1 = "" )
             and (wr_nbr >= nbr and wr_nbr <= nbr1)
             and (wr_lot >= lot and wr_lot <= lot1),
            each wo_mstr where wo_status = "R" and wo_lot = wr_lot
             and (wo_part >= part) and (wo_part <= part1 or part1 = "")
             and (wo_so_job >= job) and (wo_so_job <= job1 or job1 = "")
             and (wo_site >= site) and (wo_site <= site1 or site1 = "")
            break  by wr_nbr by wr_lot by wr_part by wr_op with frame b1 down width 132:
               ...
               find first pt_mstr where pt_part = wo_part use-index pt_part no-lock no-error.
                 if available pt_mstr then 
                    assign ptloc = pt_loc
                    desc1 = trim(pt_desc1) + " " + pt_desc2 
                    um = pt_um
                    usrname = "".
               find first ps_mstr where ps_par = wo_part use-index  ps_par no-lock no-error.
                 if available ps_mstr then 
                    assign mpart = ps_comp.
                    find first pt_mstr where pt_part = mpart use-index pt_part no-lock no-error.
                      if available pt_mstr then 
                         desc1-c = trim(pt_desc1) + " " + pt_desc2. 
                                   
                 if first-of(wr_nbr) or first-of(wr_lot) then do:
                    pline =  "│加工单│" + string(wo_nbr,"x(12)" ) + "│标志│" + string(wo_lot,"x(8)") + "│零号件│" + string(wo_part,"x(18)") + "│单位│" + pt_um + "│描述│" + string(desc1,"x(46)") + "│" .
                    if page-size - line-count < 9 then do:
                       page.
                       put "工艺流程单(2)"  at 4  "下达日期：_________ " at 111. 
                       put "┌───┬──────┬──┬────┬───┬─────────┬──┬─┬──┬───────────────────────┐" at 2 skip.
                       put pline at 2  skip.
                       put "├───┴──┬───┴┬─┴─┬──┴─┬─┴─┬────┬──┴──┴─┴──┴───────────────────────┤" at 2.
                       put "│加工单需求量│" at 2 wo_qty_ord format ">>>>9.9<" to 25 "│完成量│" at 26  wo_qty_comp format ">>>>9.9<" to 43 "│短缺量│" at 44 wo_qty_ord - wo_qty_comp format ">>>>9.9<" to 61 "│子零件:" at 62 mpart at 71 desc1-c format "x(42)" at 90 "│" at 132.    
                       put "├───┬──┴────┴───┴┬───┼───┴┬───┼───┬───┬──────┬──┬──┬──┬──┬──┬────┤" at 2.
                       put "│ 工 序│     描          述     │ 准 备│单件工时│需求量│短缺量│加工量│实准备  单件│首检│合格│报废│终检│日期│工作中心│" at 2.
                       put "├───┼────────────┼───┼────┼───┼───┼───┼───┬──┼──┼──┼──┼──┼──┼────┤" at 2.
                    end.
                    if mmmm = "AAA"  then do:
                       put "工艺流程单(2)"  at 4  "下达日期：_________ " at 111. 
                 ...
                 pline1 = "│" + string(wr_op,">>>>>>") + "│" + string(wr_desc,"x(24)") + "│" + string(wr_setup, ">9.999") 
                   + "│" + string(wr_run,">>9.9999") + "│" + string(wr_qty_ord,">>>9.9") + "│" + string(open_ref,">>>9.9") + "│      │      │    │    │    │    │    │    │" +  string(wr_wkctr,"x(8)") + "│".
         
                 if page-size - line-count <= 2 then do:
                       put "└───┴────────────┴───┴────┴───┴───┴───┴───┴──┴──┴──┴──┴──┴──┴────┘" at 2 skip.
                       page.
                       put "工艺流程单(2)"  at 4  "下达日期：_________ " at 111. 
                       pline =  "│加工单│" + string(wo_nbr,"x(12)" ) + "│标志│" + string(wo_lot,"x(8)") + "│零号件│" + string(wo_part,"x(18)") + "│单位│" + pt_um + "│描述│" + string(desc1,"x(46)") + "│" .
                       ...
                       put pline at 2  skip.
                       put "├───┴──┬───┴┬─┴─┬──┴─┬─┴─┬────┬──┴──┴─┴──┴───────────────────────┤" at 2.
                       put "│加工单需求量│" at 2 wo_qty_ord format ">>>>9.9<" to 25 "│完成量│" at 26  wo_qty_comp format ">>>>9.9<" to 43 "│短缺量│" at 44 wo_qty_ord - wo_qty_comp format ">>>>9.9<" to 61 "│子零件:" at 64 mpart at 71 desc1-c format "x(42)" at 90 .    
                       put "├───┬──┴────┴───┴┬───┼───┴┬───┼───┬───┬──────┬──┬──┬──┬──┬──┬────┤" at 2.
                       put "│ 工 序│     描          述     │ 准 备│单件工时│需求量│短缺量│加工量│实准备  单件│首检│合格│报废│终检│日期│工作中心│" at 2.
                       put "├───┼────────────┼───┼────┼───┼───┼───┼───┬──┼──┼──┼──┼──┼──┼────┤" at 2.
                 end.
