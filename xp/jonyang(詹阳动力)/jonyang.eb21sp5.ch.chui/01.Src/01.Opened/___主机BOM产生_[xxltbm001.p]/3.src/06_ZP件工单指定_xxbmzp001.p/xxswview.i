/* xxswview.i - 滚动浏览窗口子程式*/
/*此为公用子程式,不可随意修改*/  
/*----rev history-------------------------------------------------------------------------------------*/
/* SS - 090707.1 By: Roger Xiao */ /*内文无ECO标志,可与标准swview.i比对查询*/
/*-Revision end---------------------------------------------------------------*/
...
/*********************************************************************************************************/
      ...
      if keyfunction(lastkey) = "go"  /*F1*/
         or keyfunction(lastkey) = "return" /*enter*/
         or keyfunction(lastkey) = " "  /*space*/
         or keyfunction(lastkey) = "insert-mode"  /*f3*/
         or lastkey = keycode("F3")       /*f3*/
         or lastkey = keycode("F5")       /*delete*/
         or lastkey = keycode("CTRL-D")   /*delete*/
      then do:
/*********************************************************************************************************/
