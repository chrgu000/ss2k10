...
/* SS - 100520.1  By: Roger Xiao */  /*中止折旧的考虑,改变标准程式名为"xxfaderp.p" 和 "xxfaaorp.p" 和 begins "xxfarp" */
...
PROCEDURE fa-get-accdep:
   ...
   if execname = "xxfaderp.p"
      or execname = "xxfaaorp.p"
      or execname begins "xxfarp"
   then do:
      for each fabd_det
