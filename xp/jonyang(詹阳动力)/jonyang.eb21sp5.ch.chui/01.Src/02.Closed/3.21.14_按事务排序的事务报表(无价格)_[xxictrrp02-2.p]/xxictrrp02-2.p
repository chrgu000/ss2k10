...
/*----rev history-------------------------------------------------------------------------------------*/
/*升级后版本*/
/* SS - 100601.1  By: Roger Xiao */ /*add tr__chr01*/
/* SS - 100902.1  By: Roger Xiao */ /*change trgl_*_acct to _sub */
...
part1 site site1 so_job so_job1 LOC LOC1  type with frame a.
...
/*G028*/ and (tr_type <> "ORD-PO" or type = "ORD-PO"),
    EACH TRGL_DET WHERE 
		...
		TRGL_TRNBR = TR_TRNBR AND TRGL_GL_AMT <> 0 
...
/* SS - 100902.1 - B 
   ...
   SS - 100902.1 - E */
/* SS - 100902.1 - B */
             TRGL_DR_sub WHEN AVAILABLE TRGL_DET  column-label "借方账户"
             TRGL_DR_CC WHEN AVAILABLE TRGL_DET  
             TRGL_CR_sub WHEN AVAILABLE TRGL_DET  column-label "贷方账户"
             TRGL_CR_CC WHEN AVAILABLE TRGL_DET  
/* SS - 100902.1 - E */
             ...
             TR_USERID
/* SS - 100601.1 - B */
                tr__chr01 format "x(8)" label "领料单"
/* SS - 100601.1 - E */
