...
do on error undo, return error on endkey undo, return error:                    
    ...
    PUT UNFORMATTED "#def REPORTPATH=$/FA/xxfarp018" SKIP.
...
for each fa_mstr 
    ...
    if avail xfa_hist then do:
        ...
        if avail faba_det then assign  v_acct2 = faba_acct v_sub2 = faba_sub v_cc2 = faba_cc .
    end.
