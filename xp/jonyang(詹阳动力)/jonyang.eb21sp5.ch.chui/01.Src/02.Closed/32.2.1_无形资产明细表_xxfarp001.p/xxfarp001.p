...
define var v_all       as logical format "Y)包含已报废 /N)不包含已报废" initial No.
...
do on error undo, return error on endkey undo, return error:                    
    ...
    PUT UNFORMATTED "#def REPORTPATH=$/FA/xxfarp001" SKIP.
