...
/* SS - 110318.1  By: Roger Xiao */  /* 生产建筑累计折旧 改为 "150201**" "机器设备累计折旧" 改为 "150203**" */
...
/*不同于xxfarp006.p以费用明细账户区分列,
  辅组材料的费用账户固定为"41030301",

  所以xxfarp007.p是以资产明细账户区分列:
  "15020102" - "生产建筑累计折旧"
  "15020302" - "机器设备累计折旧" 
  */
...
PUT UNFORMATTED "#def REPORTPATH=$/FA/xxfarp007" SKIP.
...
/*辅组材料-折旧***************************************************/
assign
    i-sub[01] = "150201"     /*所有150201开头的账户*/
    i-sub[02] = "xxxxxxxx"
    i-sub[03] = "150203"     /*所有150203开头的账户*/
    i-sub[04] = "xxxxxxxx"
    i-sub[05] = "xxxxxxxx"
    i-sub[06] = "xxxxxxxx"
    i-sub[07] = "xxxxxxxx"
