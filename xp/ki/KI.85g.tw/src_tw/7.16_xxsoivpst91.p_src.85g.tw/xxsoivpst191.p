...
/* SS - 090707.1 By: Roger Xiao */  /*順便刪除了標准程式的舊ECO,整理了格式.*/
...
form
   gltw_entity format "X(4)" label "個体"
   gltw_acct
   gltw_cc
   gltw_date
   dr_amt label "借方匯總"
        ...
        do transaction on error undo , leave:
            ...
            break by so_inv_nbr:
                ...
                if first-of(so_inv_nbr) then do:
                    ...
                    so_slspsn[1] label "業務員" so_slspsn[2] no-label
