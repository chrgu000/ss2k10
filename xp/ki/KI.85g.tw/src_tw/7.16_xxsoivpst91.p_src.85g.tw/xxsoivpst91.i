...
/* SS - 090707.1 By: Roger Xiao */
	 ...
	 define {1} variable ext_price        as decimal label "總价"
...
/*FR54*/ define {1} variable inv              like so_inv_nbr label "發票".
/*FR54*/ define {1} variable inv1             like so_inv_nbr label {t001.i}.
	 ...
	 define {1} variable gr_margin        like sod_price label "單位毛利"
					      format "->>>>,>>9.99".
	 define {1} variable ext_gr_margin    like gr_margin label "毛利合計".
...
/* SS - 090707.1 - B */
    define {1} var v_inv_date       as date  label "發票日期".
    define {1} var v_inv_date1      as date  label "至".
    define {1} var v_slspsn         as char  label "推銷員"  .
    define {1} var v_slspsn1        as char  label "至"  .
    define {1} var v_group          like pt_group label "組別".
    define {1} var v_group1         like pt_group label "至".
    define {1} var v_all_ok         as logical format "Yes/No" .

    define {1} var v_manager        as char . /*應始終設值為global_userid*/
