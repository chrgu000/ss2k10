...
/* Revision: 1.16.1.18.1.1  BY: Robin McCarthy    DATE: 12/01/05  ECO: *P470* */
/* $Revision: 1.16.1.18.1.2 $ BY: Sanat Paul    DATE: 05/09/06  ECO: *P4QZ* */
/*SS - 100307.1 by ken*/
/*-Revision end---------------------------------------------------------------*/
...
for first sod_det
   fields (sod_domain sod_nbr sod_qty_chg)
...
for first mfc_ctrl
   fields (mfc_domain mfc_decimal mfc_field mfc_module mfc_seq)
   where   mfc_domain = global_domain
...
then do:
   ...
   for first sr_wkfl
      fields (sr_domain sr_site sr_userid)
