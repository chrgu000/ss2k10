...
/* REVISION: eB2.1SP5      LAST EDIT: 08/19/09      MODIFIED BY: Apple Tam *SS-20090819**/
/*                    1. Extent pt_desc to format x(49)                */
/*                    2. Hard code wo_vend                             */
/*                    3. Add Last Modified User ID (wo_user1)          */
/*                           & WO Close Date (wo_close_date)           */
/*                    4. Display Scrap(wo__dec01)&Defect(wo__dec02) Qty*/
/*                    5. Update Site is allowed for New PO only        */
/*                    6. Add PC Date (wo__dte01)                       */
/*                    7. Restrict ord_qty must greater than comp_qty   */ 
/*                    8. Remove PC Date (wo__dte01)                    */
/*                    9. Add spare field wo__chr03 for 脱期原因        */
/*                    10. Modify xxwowomta.p to calculate release date  */
/*                    11. Default Item Number as global_part            */
/*                    12. Default wo_vend as ptp_vend & cannot be blank */
/*                    13. Disable Delete Function                       */
/*                    14. Add MKT Confirm Date(wo__dte01), input by PMC */
...
/*ss-20090819** /*ss-20090819*/define new shared variable prev_pc_date like wo__dte01.  **/
/*ss-20090819*/define new shared variable prev_so_job  like wo_so_job.
/*ss-20090819*/define new shared variable prev_vend like ptp_vend.
/*ss-20090819*/define new shared variable prev_chr03 like wo__chr03.
/*ss-20090819*/ define new shared variable prev_dte01 like wo__dte01.
...
/*ss-20090819*/  wo__dte01      colon 55 label "MKT货期"
   wo_status      colon 25
   wo_site        colon 55
   wo_so_job      colon 25
   wo_routing     colon 55
      ...
      editing:
         ...
         if recno <> ? then do:
            ...
            display
               ...
               wo_qty_comp
               wo_qty_rjct
/*ss-20090819*/                      wo__dec01 wo__dec02 wo__chr03
/*ss-20090819*/                      wo__dte01
               ...
               wo_vend
               wo_yield_pct
/*ss-20090819*/                       wo_user1 wo_close_date 
               wo_site
               wo_routing
               wo_bom_code
               wo_rmks
   ...
   do transaction:
      ...
      if not available wo_mstr then do with frame a:
         ...
         assign
            wo_recno = ?
/*ss-20090819**        wopart = ""  **/
/*ss-20090819*/        wopart = global_part
            wopart = ""
            screen_used = yes
            undoleavemain = no.

         /* CREATE WO_MSTR, SET PART TYPE & SITE, AND TAKE DEFAULTS */
/*ss-20090819**        {gprun.i ""wowomtc.p""}**/
/*ss-20090819*/         {gprun.i ""xxwowomtc.p""}
...
/*ss-20090819*/              wo_user1 wo_close_date
      ...
      /* UPDATE FRAME B */
/*ss-20090819**      {gprun.i ""wowomtj.p""}   **/
/*ss-20090819*/      {gprun.i ""xxwowomtj.p""}
...
/*ss-20090819*/                   wo__chr03 = prev_chr03
/*ss-20090819*/                   wo__dte01 = prev_dte01
/*ss-20090819*/                    wo_so_job = prev_so_job
      ...
      if wo_joint_type <> "" and wo_status <> "C" then do:
         wo_recno = recid(wo_mstr).
/*ss-20090819**         {gprun.i ""wowomth.p""}   **/
/*ss-20090819*/         {gprun.i ""xxwowomth.p""}
      end.
...
/*ss-20090819**       {gprun.i ""wowomta.p""}  **/
/*ss-20090819*/     {gprun.i ""xxwowomta.p""}
