/* xxpopohrc.p  -  PURCHASE ORDER RECEIPT W/ SERIAL NUMBER CONTROL      */
...
/* 1.Add variable to control if xxicindate.p should be executed*/
/* SSIVAN 07122702 BY:Ivan Yang Date:12/27/07				*/
...
/*SSIVAN 07122701 add*/ define new shared variable check-eff   like mfc_logical
/*SSIVAN 07122701 add*/                                       no-undo.
{&POPORC-P-TAG1}
...
assign
   ...
   porec     = yes
   is-return = no
/*SSIVAN 07122701 add*/ check-eff    = yes   
   .

do on error undo, return error return-value:
/*SSIVAN 07122701 rmk*/  /* {gprun.i ""poporcm.p""} */
/*SSIVAN 07122701 rmk*/ /* /*SSIVAN 07122701 add*/ {gprun.i ""xxpoporcm.p""}  */
/*SSIVAN 07122701 add*/ {gprun.i ""xxpopohrcm.p""}
end.
