/* xxpopohrcm.p - PURCHASE ORDER RECEIPT W/ SERIAL NUMBER CONTROL       */
/* xxpoporcm.p - PURCHASE ORDER RECEIPT W/ SERIAL NUMBER CONTROL        */
...
/*                   1. Check the effective date(xxicindate.p)          */
/*                   2. Display Vendor Chinese Name(vd_rmks) for TW Ver.*/
/*                   3. Bug Fix for pod_type = "A"                      */
/*		     4. Add variable to control if xxicindate.p should be executed        */
/* SSIVAN 08021701 BY:Ivan Yang Date:02/17/08				*/
/*			1. Default L/S value for Audit Trail format "yyyymmdd-H999"          */
/*			Calling Program: xxpopohrca.p for HK               =              */
...
/*SSIVAN 07122701 add*/ define shared variable check-eff like mfc_logical no-undo.

/*SSIVAN 07122701 add*/ define new shared variable dummy as logical.
/*SSIVAN 07122701 add*/ define temp-table podtype_wk
/*SSIVAN 07122701 add*/        field p_line like pod_line
/*SSIVAN 07122701 add*/        field p_type like pod_type.
...
/* DELETE qad_wkfl RECORDS */
   ...
   do transaction:
      if porec
      then do:
/*SSIVAN 07122701 rmk*/     /*    {poporcm.i &frame=a1}	  */
/*SSIVAN 07122701 add*/ {xxpoporcm.i &frame=a1}
      end. /* IF porec */
      else do:
 /*SSIVAN 07122701 rmk*/     /*   {poporcm.i &frame=a2}	     */
 /*SSIVAN 07122701 add*/     {xxpoporcm.i &frame=a2}
      end. /* ELSE DO: */
...
/*SSIVAN 08021701 rmk begin*/ /*
/*SSIVAN 07122701 add begin*/
	{gprun.i ""xxpoporca.p""
		"(output table tt_po_tax)"}
/*SSIVAN 07122701 add end*/
*/  /*SSIVAN 08021701 rmk end*/
/*SSIVAN 08021701 add begin*/
	{gprun.i ""xxpopohrca.p""
		"(output table tt_po_tax)"}
/*SSIVAN 08021701 add end*/
      ...
      run create_update_trans
          (input proceed,
           ...
           input 0,
           input """",
/*SSIVAN 07122701 add*/	   input po_nbr,
/*SSIVAN 07122701 add*/	   input table podtype_wk	   
	   ).
...
/*SSIVAN 07122701 add*/   define input parameter inpar_nbr like po_nbr no-undo.
/*SSIVAN 07122701 add*/   define input parameter table for podtype_wk. 

   /* RUN poporcb.p TO CREATE RECEIPTS & UPDATE TRANSACTIONS */
   if proceed = yes then do:

/*SSIVAN 07122701 add*/         for each podtype_wk:
/*SSIVAN 07122701 add*/             delete podtype_wk.
/*SSIVAN 07122701 add*/         end.
/*SSIVAN 07122701 add*/         for each pod_det where pod_det.pod_domain = global_domain 
/*SSIVAN 07122701 add*/		and pod_nbr = inpar_nbr
/*SSIVAN 07122701 add*/         and pod_type = "A":
/*SSIVAN 07122701 add*/           create podtype_wk.
/*SSIVAN 07122701 add*/           p_line = pod_line.
/*SSIVAN 07122701 add*/           p_type = pod_type.
/*SSIVAN 07122701 add*/           pod_type = " ".
/*SSIVAN 07122701 add*/         end.
...
/*SSIVAN 07122701 add*/         for each podtype_wk no-lock:
/*SSIVAN 07122701 add*/         find pod_det where  pod_det.pod_domain = global_domain 
/*SSIVAN 07122701 add*/			and pod_nbr = inpar_nbr 
/*SSIVAN 07122701 add*/                 and pod_line = p_line no-error.
/*SSIVAN 07122701 add*/         if available pod_det then
/*SSIVAN 07122701 add*/            pod_type = p_type.
/*SSIVAN 07122701 add*/         end.
...
PROCEDURE p_validateTransaction:
   ...
   then do:
      ...
      then do:
         ...
         for first si_mstr
            fields (si_site si_status si_entity si_domain)
