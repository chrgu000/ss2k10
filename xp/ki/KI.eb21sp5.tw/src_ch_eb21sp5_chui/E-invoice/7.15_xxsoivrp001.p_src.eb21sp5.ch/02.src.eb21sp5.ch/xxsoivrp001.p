...
repeat:
	...
	do on error undo, return error on endkey undo, return error:   
            ...
            for each ih_hist 
                    where ih_domain = global_domain and ih_inv_nbr >= inv and ih_inv_nbr <= inv1
                    ...
                    no-lock ,
                each idh_hist 
                    where idh_domain = global_domain and idh_inv_nbr = ih_inv_nbr 
                    and idh_nbr = ih_nbr 
                    and idh_qty_inv <> 0 
                    no-lock,
                each pt_mstr 
