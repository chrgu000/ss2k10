/* xxkbmtzc.p    mfg zreo kb batch create                                   */
...
repeat:
    ...
    do on error undo, return error on endkey undo, return error:                    
        ...
        if not ( v_buyer2 >= v_buyer and ( v_buyer2 <= v_buyer1 or v_buyer1 = "" )) then next .
            ...
            if not avail xkb_mstr then next . /*没有生产管理看板,则不能产生对应的管理尾数看板*/

            find xkb_mstr where xkb_domain = global_domain and xkb_site = xmpt_site and xkb_part = xmpt_part and xkb_type = "M" 
            ...
            if avail xkb_mstr then do:
                if xkb_status = "D" or (xkb_status = "U" and xkb_kb_Raim_qty = 0 ) then do : 
                    ...
                    {xxkbhist.i &type="xkb_type"      &part="xkb_part"      &site="xkb_site"
                                &kb_id="xkb_kb_id"    &effdate=today        &program="'xxkbmtzc.p'"
