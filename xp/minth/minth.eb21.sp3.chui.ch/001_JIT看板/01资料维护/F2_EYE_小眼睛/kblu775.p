/* kblu775.p - aaa Lookup UI                                                */
/* Copyright 1986-2007 QAD Inc., Carpinteria, CA, USA.                      */
/* All rights reserved worldwide.  This is an unpublished work.             */
/* $Revision: 1.80 $    */
/*V8:ConvertMode=NoConvert                                                  */
/********************************** History *********************************
 * $Revision: 1. $    Default User             DATE: 07/07/05  ECO: *XXXX*
 ****************************************************************************/
...
&SCOPED-DEFINE WHERE-CLAUSE code_domain = global_domain and code_fldname = 'xppt_box_type'   
