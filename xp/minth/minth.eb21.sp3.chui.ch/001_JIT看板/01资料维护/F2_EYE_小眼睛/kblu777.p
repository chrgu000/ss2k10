/* kbbr777.p - aaa Browse UI                                                */
/* Copyright 1986-2007 QAD Inc., Carpinteria, CA, USA.                      */
/* All rights reserved worldwide.  This is an unpublished work.             */
/* $Revision: 1.80 $    */
/*V8:ConvertMode=NoConvert                                                  */
/********************************** History *********************************
 * $Revision: 1.2 $    Default User             DATE: 07/06/28  ECO: *XXXX*
 * $Revision: 1.2 $    Default User             DATE: 07/06/28  ECO: *XXXX*
 ****************************************************************************/

{mfdeclre.i}

&SCOPED-DEFINE BR-TITLE "aaa"

&SCOPED-DEFINE BR-NAME kb777
...
&SCOPED-DEFINE BR-COLUMN-LABEL-1 "Öµ"
...
&SCOPED-DEFINE BR-COLUMN-LABEL-2 "ËµÃ÷"
...
&SCOPED-DEFINE WHERE-CLAUSE code_domain = global_domain and code_fldname = 'xmpt_box_type'
