...
form
   ...
   v_yn                       colon 20 column-label "仅限未打印"
...
/*    if effdate1 = effdate  then effdate1 = ? . */
   ...
   if c-application-mode <> 'WEB' then update  linne linne1 nbrr nbrr1 effdate effdate1 v_yn with frame a .
   {wbrp06.i &command = update &fields = " linne linne1 nbrr nbrr1 effdate effdate1 v_yn  " &frm = "a" }
