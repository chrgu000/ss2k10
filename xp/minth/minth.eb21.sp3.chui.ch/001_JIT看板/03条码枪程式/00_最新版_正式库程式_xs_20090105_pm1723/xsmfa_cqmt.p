...
/*tx01*/ find first ls_mstr where ls_type = "company" and ls_domain = "117"
...
/*tx01*/ find first ad_mstr where ad_domain = "117"
/*tx01*/    and substring(ad_addr,2,7) = "reports" no-lock no-error.
   ...
   /* Register Clicense Code  Start*/	 
    find first usrw_wkfl where usrw_key1 = "BARCODE" and usrw_key2 = "LICENSEKEY" 
               ...
               and usrw_domain = "117" no-lock no-error.
...
/*			    
    ...
    for each code_mstr where code_fldname = "BARCODEUSERID"  and code_domain = "117" no-lock :
