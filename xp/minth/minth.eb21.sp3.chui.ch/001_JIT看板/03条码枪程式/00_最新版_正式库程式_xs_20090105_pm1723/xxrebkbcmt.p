...
/*tx01*/ define output parameter o_upt_loc like loc_loc.
{&REBKFL-P-TAG4}
      ...
      then do:
         ...
         then do:
            ...
            then do:
               ...
               /*NON-MILESTONE                               */
/*tx01*/       next-prompt p_bc with frame a.
               undo, retry.
...
/*apple*/   {gprun.i ""xxrebkfli1bcmt.p""
            "(input cumwo_lot,
              input op,
              output undo_stat)"}
/*tx01*
...
if pt_part > "1" and pt_part < "1x"  then do:
   o_upt_loc = (if wo_loc > "" then wo_loc  else line1).
...
{gprun.i ""icedit2.p""
                     "(input ""RCT-WO"",
                      ...
                      o_upt_loc = (if wo_loc > "" then wo_loc  else pt_loc).
