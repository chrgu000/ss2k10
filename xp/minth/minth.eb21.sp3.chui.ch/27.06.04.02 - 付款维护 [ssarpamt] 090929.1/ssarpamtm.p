...
/* Revision: 1.71.1.13 BY: Orawan S.          DATE: 05/17/04 ECO: *P21R*     */ /* Revision: 1.71.1.14  BY: Ed van de Gevel DATE: 10/13/04 ECO: *P207*    */
      ...
      do transaction:
         ...
         do while true:
                     ...
                     do on error undo, retry:
                        ...
                        /* WILL BE USED */
                           ...
                           for first cb_mstr
                            ...
                            then
                               assign
                                  ar_ex_rate  = cb_ex_rate
                                  ar_ex_rate2 = cb_ex_rate2.
            ...
            assign
               ...
               /* SS - 080830.1 - B */
               /* SS - 090929.1 - B
               nbr_ar = INPUT ar_mstr.ar_bill.
               nbr_ar = nbr_ar + FILL(" ", 8 - LENGTH(nbr_ar)).
               nbr_ar = nbr_ar + INPUT ar_mstr.ar_check.
