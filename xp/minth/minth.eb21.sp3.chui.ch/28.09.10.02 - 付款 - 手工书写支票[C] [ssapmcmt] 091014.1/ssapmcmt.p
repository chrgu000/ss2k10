...
DEFINE NEW SHARED VARIABLE user1_glt LIKE glt_user1.
/* SS - 20080829.1 - E */
{cxcustom.i "APMCMT.P"}
...
/* SS - 091014.1 - B */
DEFINE VARIABLE SUM_lvl_apc LIKE apc_sum_lvl.
/* SS - 091014.1 - E */
      ...
      do transaction:
         ...
         do on error undo, retry:
            ...
            then do:
               ...
               /* SS - 20080829.1 - B */
               /* SS - 091014.1 - B
               {gprun.i ""ssgltrrefdocq.p"" "(
                  INPUT 'AP',
                  INPUT 'CK',
                  INPUT (INPUT ck_mstr.ck_bank + STRING(INTEGER(INPUT ck_mstr.ck_nbr))),
                  OUTPUT ref_glt,
                  OUTPUT user1_glt
                  )"}
