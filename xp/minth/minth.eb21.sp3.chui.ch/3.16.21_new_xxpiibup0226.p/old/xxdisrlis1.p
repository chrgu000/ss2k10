...
/*ss - 090514.1 -b */
define input parameter ss_part like pt_part.
define input parameter ss_qty  as decimal.
define input parameter ss_loc  like pt_loc .
/*ss - 090514.1 -e */
...
/*minth*/ define    shared  variable xtitrnbr          as integer .   
...
*ss - 090514.1 -b */
   ...
   if ss_qty <> 0 then do:
      ...
      do transaction:
         {gpsct01.i &set=component_cost_set &site=wo_site &part=ss_part}
...
/* ss - 090514.1 - b *
      ...
      assign
         lvar_lineid = "-" + string(pk_part,"x(18)") + ss_reference.
      for first sr_wkfl
...
/* ss - 090514.1 *b 
            if is_wiplottrace_enabled()
               ...
               and is_wocomp_wiplot_traced(wod_lot, ss_part)
            then do:
               ...
               run add_trace_record in h_wiplottrace_procs
                  (input OPERATION_HISTORY,
                   ...
                   input ss_part,
                   input srlotser,
                   input if is_wocomp_reference_traced(wo_lot, ss_part) then
                            srref
                         else '',
                   input srqty).
...
/* ss - 090514.1 *b 
            ...
            assign
               lvar_lineid = "-" + string(ss_part,"x(18)") + ss_reference.
