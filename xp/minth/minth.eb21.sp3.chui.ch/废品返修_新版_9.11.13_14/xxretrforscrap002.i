...
define {1} shared variable v_part2 like pt_part .
define {1} shared variable desc1  like pt_desc1.
define {1} shared variable desc2  like pt_desc2.
define {1} shared variable desc3  like pt_desc1.
define {1} shared variable desc4  like pt_desc2.
...
form
	v_part			colon 20 label "不良品零件号"
	desc1			colon 20 label "品名"   
	desc2			colon 20 label "规格" 
	v_loc           colon 20  loc_Desc	no-label	/*colon 50  label "库位名"*/  	
	v_qty_a			colon 20
skip(1)

	v_part2			colon 20 label "良品零件号"    
	desc3			colon 20 label "品名"   
	desc4			colon 20 label "规格"
	pdln			colon 20  ln_desc 		no-label	/*	colon 50  label "产线名"*/	
	
	v_qty_s			colon 20				 
	v_qty_g		    colon 20 				
	eff_date        colon 20  label "生效日期"  
	v_hrs           colon 20
