...
/*tx01* {gprun.i ""icedit2.p"" "(input ""ISS-WO"", */
/*tx01*/ {gprun.i ""xxicedit2bcmt.p"" "(input ""ISS-WO"", 
                               input wosite,
                               input pk_loc,
...
repeat:
   do transaction on error undo, retry :
      ...
      repeat:
            ...
            then do:
                ...
                exclusive-lock:
					find first wod_det 
						...
						and wod_lot = cumwo_lot 
						and wod_part = pk_part 
						and wod_op = integer(pk_reference)
					no-lock no-error.
					pk_user1 = if avail wod_Det then string(wod_bom_qty,"->,>>>,>>9.9<<<") else "" .
				end. /*xp001*/
               ...
               {windowxt.i
                  ...
                  &window-down = 5
                  &where1 = " where pk_det.pk_domain = global_domain and  pk_user = mfguser"
                  &where2 = " where pk_det.pk_domain = global_domain and  true"
                  &and = "(pk_user = mfguser)"
                  &time-out = 0
                  }				
				***xp001*/
               {windowxt.i
                  &file = pk_det
                  &display = "pk_part pk_reference label '¹¤Ðò' pk_user1 format 'x(20)' label 'µ¥ºÄ'  pk_qty"
                  &index-fld1 = pk_part
                  &use-index1 = "use-index pk_det"
                  &index-fld2 = pk_part
                  &use-index2 = "use-index pk_det"
         ...
         do on endkey undo seta ,  retry seta: /*xp001*/
            yn = yes.
            /*V8-*/
