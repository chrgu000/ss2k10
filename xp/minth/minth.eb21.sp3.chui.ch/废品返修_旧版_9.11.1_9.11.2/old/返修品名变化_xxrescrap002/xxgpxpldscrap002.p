...
/* LAST MODIFIED: 03/12/2008   BY: Softspeed roger xiao      ECO:*xp001*      */ /*主料(ps__log01 = yes)不写入pk_det(这里pk_qty=0,外边有地方会删除) */
...
for first ps_mstr
   ...
   ps_ref ps_start  ps__log01 /*xp001*/)
      ...
      then do:
         ...
         if level < maxlevel or maxlevel = 0 then do:
            ...
            * (100 / ( 100 - ps_scrp_pct)).
            ...
            for first ps_mstr
               ...
               ps_qty_type ps_ref ps_scrp_pct ps_start  ps__log01 /*xp001*/)
         ...
         then do:
            ...
            * 100 / (100 - ps_scrp_pct).
			...
			/*pk_qty = pk_qty + tempqty.***************xp001*/
            pk_qty = if ps__log01 = yes then 0 else pk_qty + tempqty. /*xp001*/
