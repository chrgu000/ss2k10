...
/* ss 20070611 - b */
				find first ad_mstr where ad_domain = global_domain and ad_addr = global_domain no-lock no-error.
				if avail ad_mstr then put UNFORMATTED   ad_name ";" .
				else put UNFORMATTED   " " ";".
/*hubo 20090610*/	        if absmstr.abs_arr_date = ? then put  UNFORMATTED "". else put UNFORMATTED string(absmstr.abs_arr_date,"9999-99-99") .
