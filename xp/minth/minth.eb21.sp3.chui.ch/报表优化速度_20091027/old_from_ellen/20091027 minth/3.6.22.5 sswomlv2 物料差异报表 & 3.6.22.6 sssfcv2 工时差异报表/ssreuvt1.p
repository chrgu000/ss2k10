...
{gprun.i ""ssreuvps2.p"" "(input        cumwo_lot,
                         input        eff_date,
...
{gprun.i ""ssreuv3.p"" "(input        cumwo_lot,
                         input        eff_date,
                         input-output wo_cum_var_amt,
                         input-output wo_var_to_post,
                         input        zero_unposted_var,
...
{gprun.i ""ssreuv4.p"" "(input        cumwo_lot,
                         input        eff_date,
                         input-output wo_cum_var_amt,
                         input-output wo_var_to_post,
                         input        zero_unposted_var,
...
{gprun.i ""ssreuv5.p"" "(input        cumwo_lot,
                         input        eff_date,
                         input-output wo_cum_var_amt,
                         input-output wo_var_to_post,
                         input        zero_unposted_var,
...
{gprun.i ""ssreuv6.p"" "(input        cumwo_lot,
                         input        eff_date,
                         input-output wo_cum_var_amt,
                         input-output wo_var_to_post,
                         input        zero_unposted_var,
...
{gprun.i ""ssreuv7.p"" "(input        cumwo_lot,
                         input        eff_date,
                         input-output wo_cum_var_amt,
                         input-output wo_var_to_post,
                         input        zero_unposted_var,
