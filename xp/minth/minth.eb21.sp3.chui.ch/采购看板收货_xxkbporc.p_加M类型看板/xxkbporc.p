...
/* REVISION: 1.1      Create : 11/20/2007   BY: Softspeed Roger_Xiao     ECO: *xp001* */
...
/*                 and tr_type = "rct-po" */
	...
	find first xkb_mstr where xkb_domain = global_domain 
	       ...
	       and /*xkb_type = "P" */  /*xp001*/ 
		       (xkb_type = "P"  or xkb_type = "M" ) /*xp001*/
		   and xkb_status = "R" no-error.
...
/*        
	run /app/mfgpro/eb21/ch/xx/xxpoporc.r.
*/
        run /app/mfgpro/eb21/ch/po/poporc.r.
