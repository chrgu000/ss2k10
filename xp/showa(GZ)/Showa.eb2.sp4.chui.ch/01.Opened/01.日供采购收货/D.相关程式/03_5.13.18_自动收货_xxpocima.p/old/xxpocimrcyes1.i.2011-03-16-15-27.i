     ...
     usection = TRIM ( string(year(TODAY)) + string(MONTH(TODAY)) + string(DAY(TODAY)))  + trim(STRING(TIME)) + trim(string(RANDOM(1,100))) + "porc1" .
	...
	If AVAILABLE ( tr_hist ) then do:
        ...
        */
        assign 
            ...
            xx_ship_rcvd_effdate = rcvddate /* SS - 110307.1 */ 
            xx_ship_rcvd_date = v_rctdate  /* SS - 110307.1 */ 
            .
