...
/* SS - 100602.1  By: Roger Xiao */ /*change GUI to CHUI ,from rev : b+ */
	...
	do on error undo, return error on endkey undo, return error:                    
           ...
           {mfphead.i}
            ...
            FOR EACH xxsod_det NO-LOCK WHERE xxsod_cust >= v_cust
                ...
                IF v_active = YES THEN xxsod__chr01 = "YES".
                                  ELSE xxsod__chr01 = "NO" .
            END.
