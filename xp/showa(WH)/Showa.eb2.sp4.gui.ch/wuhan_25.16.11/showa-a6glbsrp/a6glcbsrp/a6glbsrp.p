...
/* SS - 091214.1  By: Roger Xiao */  /*add percentage format for a6glcbsrp1.i & a6glcbsrpa.p   ,b+ --> 091214.1 */
...
/*
            ...
            PUT UNFORMATTED "Year" ";" YEAR(rptdt[2]) SKIP.
            PUT UNFORMATTED "Month" ";" MONTH(rptdt[2]) SKIP.
               */

            PUT UNFORMATTED "#def REPORTPATH=$/财务/BI报表/a6glbsrp" SKIP.
            PUT UNFORMATTED "#def :end" SKIP.


            EMPTY TEMP-TABLE tta6glcbsrp.

            run assign-values2
               (output l-assigned).
            if not l-assigned then return.

            FOR EACH tta6glcbsrp:
                EXPORT DELIMITER ";" YEAR(rptdt[2]) MONTH(rptdt[2]) tta6glcbsrp_fpos tta6glcbsrp_code tta6glcbsrp_desc tta6glcbsrp_et_balance1 tta6glcbsrp_et_balance2.
            END.
...
/*J241*/          if can-find ( first glt_det where
                  ...
                  then do:
                     ...
                     {mfmsg.i 3151 2} /* UNPOSTED TRANSACTIONS EXIST FOR RANGES
                                         ON THIS REPORT */
                                         */
                     PUT UNFORMATTED YEAR(rptdt[2]) ";" MONTH(rptdt[2]) ";" "在本报表中指定的范围内有未过帐的会计帐务." ";" ";" ";" ";" SKIP.
                     leave.
                  end.
               end.
            end.
