...
/* Revision: 1.29  BY: Paul Donnelly (SB) DATE: 06/28/03 ECO: *Q00M* */
/* Revision: 1.30  BY: Manish Dani        DATE: 09/01/03 ECO: *P0VZ* */
/* $Revision: 1.30.2.1 $ BY: Karel Groos DATE: 04/01/05 ECO: *P2BV*        */
/*----rev history-------------------------------------------------------------------------------------*/
...
for first txc_ctrl
   fields( txc_domain txc_detrp txc__qad03)  where txc_ctrl.txc_domain =
