...
batchrun = no . /*cimload,有些会改成yes,这里改回来*/
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[材料标签列印-无库存]"  + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[材料标签列印-无库存]"  + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
If available pt_mstr then
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[材料标签列印-无库存]"  + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[材料标签列印-无库存]"  + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1510 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[材料标签列印-无库存]"  + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[材料标签列印-无库存]"  + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[材料标签列印-无库存]"  + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9125 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[材料标签列印-无库存]"  + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
   ...
   /* Additional Labels Format */
     ...
     PROCEDURE lap039130l.
        ...
        vv_label1 = (LabelsPath + "lap03" + trim ( wtm_fm ) ). /*xp001*/
...
If AVAILABLE ( pt_mstr )  then
     ...
     END PROCEDURE.
     run lap039130l  (output vv_part2 , output vv_lot2 ,output vv_qtyp2 ,output vv_label2 ,output vv_filename2 ,output vv_oneword2 ) .  /*xp001*/
