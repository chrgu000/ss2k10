/* FG LABLE PRINT [non-Serial] */
/* Generate date / time  2009-4-28 9:45:19 */
{mfdeclre.i}
...
batchrun = no . /*cimload,有些会改成yes,这里改回来*/
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[成品标签-无序列]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签-无序列]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签-无序列]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V1305L.
        /* LOGICAL SKIP END */
                display "[成品标签-无序列]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1305 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        leave V1306L.
        /* LOGICAL SKIP END */
                display "[成品标签-无序列]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1306 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签-无序列]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签-无序列]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签-无序列]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[成品标签-无序列]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
   ...
   /* Additional Labels Format */
     ...
     PROCEDURE lap079130l.
        ...
        vv_label1 = (LabelsPath + "lap07" + trim ( wtm_fm ) ). /*xp001*/
...
If AVAILABLE ( pt_mstr )  then
     ...
     END PROCEDURE.
     run lap079130l  (output vv_part2 , output vv_lot2 ,output vv_qtyp2 ,output vv_label2 ,output vv_filename2 ,output vv_oneword2 ) .  /*xp001*/
