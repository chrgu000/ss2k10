...
batchrun = no . /*cimload,有些会改成yes,这里改回来*/
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[QC专用标签打印]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[QC专用标签打印]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1100 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[QC专用标签打印]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[QC专用标签打印]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
     ...
     REPEAT:
        ...
        if v9110 = "" then do:
            if v1100 <> "" then do:
                find first wo_mstr  where wo_lot = v1100 and wo_site = v1002 no-lock no-error .
                if avail wo_mstr then do:
                    v9110 = string(integer(wo_qty_ord) + 1) .
                end.
            end.
            else V9110 = "1".
        end.
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[QC专用标签打印]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
   ...
   /* Additional Labels Format */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[QC专用标签打印]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[QC专用标签打印]"    + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
   ...
   /* Additional Labels Format */
     ...
     PROCEDURE lap089130l.
        ...
        vv_label1 = (LabelsPath + "lap08" + trim ( wtm_fm ) ). /*xp001*/
...
If AVAILABLE ( pt_mstr )  then
     ...
     END PROCEDURE.
     run lap089130l  (output vv_part2 , output vv_lot2 ,output vv_qtyp2 ,output vv_label2 ,output vv_filename2 ,output vv_oneword2 ) .  /*xp001*/
