...
REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[更新默认地点]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.

                /* LABEL 1 - START */ 
                display "更新後的地点?"       format "x(40)" skip with fram F1002 no-box.
                /* LABEL 1 - END */ 
                ...
                /* LABEL 3 - START */
                display "1.确保有访问权限"     format "x(40)" skip with fram F1002 no-box.
                /* LABEL 3  - END */
        ...
        IF NOT AVAILABLE si_mstr then do:
                display skip "错误,重试!" @ WMESSAGE NO-LABEL with fram F1002.
                pause 0 before-hide.
                undo, retry.
        end.
...
ELSE do:
 if  index ( trim(code_cmmt) , V1002 ) = 0 then kPASS = "N".
        ...
        IF not kPASS = "Y" THEN DO:
                display skip "访问权限有误" @ WMESSAGE NO-LABEL with fram F1002.
                pause 0 before-hide.
                undo, retry.
        end.
         /*  ---- Valid Check ---- END */
     ...
     /* START  LINE :1004  更新默认地点[UPDATE Default Site]  */
     V1004L:
     REPEAT:
...
IF 1 = 1 THEN
        leave V1004L.
        /* LOGICAL SKIP END */
                display "[更新默认地点]"      + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1004 no-box.

                /* LABEL 1 - START */ 
                display "更新默认地点"        format "x(40)" skip with fram F1004 no-box.
                /* LABEL 1 - END */ 
     ...
     END.
     PV1004 = V1004.
     /* END    LINE :1004  更新默认地点[UPDATE Default Site]  */
