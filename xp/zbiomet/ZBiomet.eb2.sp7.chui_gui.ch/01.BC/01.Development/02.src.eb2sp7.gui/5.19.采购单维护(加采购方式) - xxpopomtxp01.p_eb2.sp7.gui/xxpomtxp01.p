/* GUI CONVERTED from pomt.p (converter v1.77) Wed Mar 24 04:01:27 2004 */
...
/* REVISION: 1.0         Last Modified: 2008/10/14   By: Roger   ECO:*xp001*  */
/*-Revision end------------------------------------------------------------*/
...
/*GUI*/ if global-beam-me-up then undo, leave.
      ...
      /*{gprun.i ""popomtb.p"" "(input using_supplier_consignment)"} */  /*xp001*/  
      {gprun.i ""xxpopomtbxp01.p"" "(input using_supplier_consignment)"} /*xp001*/  
/*GUI*/ if global-beam-me-up then undo, leave.
...
/*GUI*/ if global-beam-me-up then undo, leave.
   ...
   /* LINE ITEMS */
   /*{gprun.i ""popomta.p""} */  /*xp001*/  
        {gprun.i ""xxpopomtaxp01.p""} /*xp001*/  
/*GUI*/ if global-beam-me-up then undo, leave.
