/* GUI CONVERTED from popomtd.p (converter v1.77) Wed Dec  3 04:14:15 2003 */
...
/*xp001*********begin*/
         if not {gpcode.v pod_so_job}
         then do:
            {pxmsg.i &MSGNUM=716 &ERRORLEVEL=2
                     &MSGARG1=pod_so_job}
            next-prompt pod_so_job with frame d .
            undo setd, retry setd.
         end.
/*xp001***********end*/ 
