...
repeat :
    ...
    do  on error undo,retry: /*update_loop*/
        ...
        /*检查xxwrd_det锁定情况,并锁定表,报废会调整所有后续工序的订购量,所以后续所有工序都要做锁定*/
...
do  :  /*xxfb*/
    ...
    if  v_prev = yes then do:
        ...
        for each xxwrd_det  
            ...
            and (xxwrd_status = "" or xxwrd_status  = "N" or xxwrd_status = "J" ) /*正常的-空,工序被删除-D,新增的工序-N,终止的工序-J */
