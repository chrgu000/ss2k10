...
repeat with frame a:
    ...
    update nbr nbr1 lot lot1 part part1 v_yn[01] v_yn[02] v_yn[03] v_yn[04] v_yn[05] v_yn[06] v_yn[07] v_yn[08] v_yn[09] with frame a . 
    ...
    if v_yn[02] = yes then do on error undo ,retry :
        ...
        for each wr_route 
            where wr_nbr >= nbr and wr_nbr <= nbr1 
            and   wr_lot >= lot and wr_lot <= lot1
            and   wr_part >= part and wr_part <= part1
            no-lock:
