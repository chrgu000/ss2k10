/* gplu973.p - 代码主文件 Lookup UI                                         */
/* Copyright 1986-2007 QAD Inc., Carpinteria, CA, USA.                      */
/* All rights reserved worldwide.  This is an unpublished work.             */
/* $Revision: 1.71.1.2 $    */
/*V8:ConvertMode=NoConvert                                                  */
/********************************** History *********************************
 * $Revision: 1.2 $    Default User             DATE: 03/18/07  ECO: *XXXX*
 ****************************************************************************/

{mfdeclre.i}

&SCOPED-DEFINE BR-TITLE "代码主文件"

&SCOPED-DEFINE BR-NAME gp973
&SCOPED-DEFINE Q-DRAG-BACK-COL 1

&SCOPED-DEFINE Q-FIRST-TABLE code_mstr
&SCOPED-DEFINE Q-FIRST-FIELD-LIST (code_value code_desc)
...
&SCOPED-DEFINE Q-BROWSE-DISP-EXPR-2 b-1.code_desc
&SCOPED-DEFINE Q-BROWSE-DEF-EXPR-2 code_mstr.code_desc
&SCOPED-DEFINE TT-Q-BROWSE-DEF-EXPR-2 tt-code_desc
...
&SCOPED-DEFINE WHERE-CLAUSE code_fldname = global_addr
