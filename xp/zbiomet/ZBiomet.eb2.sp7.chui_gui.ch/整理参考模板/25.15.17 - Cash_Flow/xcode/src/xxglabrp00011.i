...
if print_acct = yes then do:
   ...
   if first_acct then do:
      ...
      with frame pdetail.
      */
      FIND FIRST ttxxglabrp0001 WHERE ttxxglabrp0001_code = d_acct NO-LOCK NO-ERROR.
      IF NOT AVAILABLE ttxxglabrp0001 THEN DO:
          CREATE ttxxglabrp0001.
          ASSIGN
              ttxxglabrp0001_code = d_acct
              ttxxglabrp0001_desc = d_desc
              .
      END.
     /* SS - 20061117.1 - E */
   ...
   IF AVAILABLE ttxxglabrp0001 THEN DO:
       ASSIGN ttxxglabrp0001_et_beg_bal = ttxxglabrp0001_et_beg_bal + et_beg_bal.
   END.
/* SS - 20061117.1 - E */
...
if last(cal.glc_per) then do:
   ...
   FIND FIRST ttxxglabrp0001 WHERE ttxxglabrp0001_code = d_acct NO-LOCK NO-ERROR.
   IF AVAILABLE ttxxglabrp0001 THEN DO:
       ASSIGN ttxxglabrp0001_et_end_bal = ttxxglabrp0001_et_end_bal + et_end_bal.
   END.
   /* SS - 20061117.1 - E */
