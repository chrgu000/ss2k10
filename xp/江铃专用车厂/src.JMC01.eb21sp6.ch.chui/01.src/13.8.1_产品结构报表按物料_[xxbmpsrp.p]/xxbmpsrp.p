...
{bmpsrp.i}
   SS - 101124.1 - E */
/* SS - 101124.1 - B */
    define var v_qty_bc  as decimal format "->>,>>9.99<<<<" label "板材重量".
    define var v_qty_xc  as decimal format "->>,>>9.99<<<<" label "型材重量".
    define var v_tot_bc  as decimal format "->>,>>9.99<<<<" label "板材总重".
    define var v_tot_xc  as decimal format "->>,>>9.99<<<<" label "型材总重".
    define var v_qty_tot as decimal format "->>,>>9.99<<<<" label "合计总重".
...
/* SS - 101124.1 - B */
v_qty_tot = v_tot_bc + v_tot_xc .
put space(84) "=====================" skip.
put space(84) "合计总重:" v_qty_tot skip.
put skip(1).
