...
/* $Revision: 1.42 $ BY: Bill Jiang       DATE: 03/20/07 ECO: *SS - 20070320.1* */
...
/* SS - 20070228.1 - E */
   ...
   for each vd_mstr fields(   vd_addr vd_sort vd_type)
      ...
      for each ap_mstr
         ...
         */
         ...
         for each vo_mstr
               fields(   vo_applied  vo_confirmed vo_cr_terms
               vo_due_date
   ...
   */
   ...
   assign
      ...
      et_org_age_amt[6] = accum total (age_amt[7])
   ...
   if net <> 0 then do:
      ...
      */
      ...
      ASSIGN
         ...
         /* SS - 20070320.1 - B */
         tta6apvorp0402_et_age_amt[5] = et_age_amt[5]
         tta6apvorp0402_et_age_amt[6] = et_age_amt[6]
         tta6apvorp0402_et_age_amt[7] = et_age_amt[7]
         tta6apvorp0402_et_age_amt[8] = et_age_amt[8]
         /* SS - 20070320.1 - E */
         ...
         tta6apvorp0402_et_curr_amt = net
         .
