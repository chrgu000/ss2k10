...
/* SS - 100701.1 - B */
PUT UNFORMATTED "#def REPORTPATH=$/csqad/xxtrrp098" SKIP.
...
/* SS - 100701.1 - B 
		display
			/* SS - 100412.1 - B */
			tmp_type														column-label "物料类型" format "x(5)"
			cmmt															column-label "类型说明" format "x(12)"
			/* SS - 100412.1 - E */
			tmp_loc															column-label "库位" format "x(4)"
			/* SS - 100412.1 - B */
...
/* SS - 100625.1 - B 
   ...
   SS - 100625.1 - E */
/* SS - 100625.1 - B */
			tmp_qty91														column-label "盘点盘盈"
			tmp_qty92														column-label "盘点盘亏"
/* SS - 100625.1 - E */
