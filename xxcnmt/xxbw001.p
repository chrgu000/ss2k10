...
find first brwf_det no-lock where brwf_det.brw_name = 'xx001'
       and brwf_det.brwf_seq = 2 no-error.
if not available brwf_det then do:
          create brwf_det.
          assign brwf_det.brw_name        = 'xx001'
                 brwf_det.brwf_seq        = 2.
end.
assign brwf_det.brwf_field      = 'code_desc'
       brwf_det.brwf_datatype   = 'character'
       brwf_det.brwf_format     = ''
