...
REPEAT:
     ...
     REPEAT:
        ...
        leave V1002L.
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1002 no-box.
 ...
 /*       end.                                              */
   ...
   REPEAT:
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1300 no-box.
...
/*  Sam Song 20100319 End */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1305 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1410 no-box.
     ...
     REPEAT:
        ...
        leave V1500L.
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1500 no-box.
...
/*                else L15102 = vv_loc_from.                     */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1600 no-box.
                ...
                /* LABEL 4 - START */
                L16004 = "从:" + trim( V1510 ) + "/" + string(vv_qty) .
        ...
        /* CHECK FOR NUMBER VARIABLE  END */
          find first ld_det no-lock where ld_site = v1002 and ld_loc = V1510 and ld_part = V1300 and ld_lot = V1500 and ld_qty_oh >= decimal(V1600) no-error.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1520 no-box.
                ...
                L15204 = "".
                assign i = 0.
                run getItemTrLoc(input V1300,input V1600,output vv_locList).
                assign L15202 = VV_Loclist.
...
If NOT AVAILABLE ld_det THEN
        leave V1525L.
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1525 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F1700 no-box.
...
If AVAILABLE ( tr_hist ) then
        ...
        /* --CYCLE TIME SKIP -- END  */
                ...
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9000 no-box.
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9010 no-box.
...
If NOT AVAILABLE ( tr_hist ) then
   ...
   pause 0 before-hide.
     ...
     REPEAT:
        ...
        leave V9015L.
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9015 no-box.
...
If AVAILABLE ( pt_mstr ) then
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9110 no-box.
...
if V9120 = ? THEN
        leave V9120L.
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9120 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        leave V9130L.
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9130 no-box.
...
If AVAILABLE ( pt_mstr )  then
   ...
   */
     ...
     REPEAT:
        ...
        /* LOGICAL SKIP START */
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9140 no-box.
...
IF 1 = 1 THEN
        leave V9150L.
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9150 no-box.
...
If AVAILABLE ( upd_det ) then
        ...
        leave V9160L.
        /* LOGICAL SKIP END */
                display "[库存转移]"        + "*" + TRIM ( V1002 )  format "x(40)" skip with fram F9160 no-box.
