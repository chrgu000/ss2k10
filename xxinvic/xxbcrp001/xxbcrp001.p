...
define var v_shpart  like vp_vend_part no-undo .
define var v_shpart1 like vp_vend_part no-undo .
...
FORM
    ...
    v_shpart  colon 20 label "图号" format "x(22)"
    v_shpart1 colon 49 label {t001.i}     format "x(22)"
    skip(1)
