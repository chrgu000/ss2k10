...
form
    line             colon 10
    xxship_part      colon 35 format "x(26)"

    xxship_case      colon 10
    xxship_qty       colon 35
    xxship_type      colon 65
                      skip(1)
    xxship_qty_unit  colon 10
    xxship_pkg       colon 35
    xxship_status    colon 65

    xxship_curr      colon 10
    xxship_rate      colon 35
    xxship_rcvd_date colon 65

    xxship_price     colon 10
    xxship_value     colon 35
    xxship_site      colon 65

    xxship__chr01    colon 35 format "x(18)"
    xxship__chr02    colon 65
