                ...
                /*  MESSAGE "bbb" + "---" + v_sonbr VIEW-AS ALERT-BOX. */
                 ...
                 /* ss - 110325.1 -b
                  DO i = 1 TO 11 :
                      PUT " - " .
                  END.
                  PUT """" + TRIM(t2_ptype) + "P" + """" FORMAT "x(11)"  .
                  DO i = 1 TO 9:
                      PUT " - " .
                  END.
                  PUT SKIP.
...
/*                   SKIP                                                             */
        ...
        OUTPUT CLOSE .
         ...
         /* ss - 110422.1 -b */
         FIND FIRST sod_det WHERE sod_nbr = v_sonbr AND sod_line = v_i AND sod_part = t2_part NO-LOCK NO-ERROR .
