find first brw_mstr no-lock where brw_mstr.brw_name = 'xx100' no-error.
...
find first brwt_det no-lock where brwt_det.brw_name = 'xx100' no-error.
...
find first brwf_det no-lock where brwf_det.brw_name = 'xx100' and brwf_det.brwf_seq = 1 no-error.
...
find first brwf_det no-lock where brwf_det.brw_name = 'xx100' and brwf_det.brwf_seq = 2 no-error.
if not available brwf_det then do:
          create brwf_det.
          assign brwf_det.brw_name        = 'xx100'
                 brwf_det.brwf_seq        = 2.
