...
do on error undo, return error on endkey undo, return error:
 ...
 /*
 usrw_key1 = "XXMRPPORP0.P-SHORTAGELIST"
                   ...
                   usrw_intfld[1] = wr_op
                   usrw_intfle[2] = starttime
                   usrw_datefld[1] = wo_due_date
                   usrw_datefld[2] = wr_start.
 */
 
  for each usrw_wkfl no-lock where usrw_key1 = "XXMRPPORP0.P-SHORTAGELIST"
  		 and usrw_key3 >= site and usrw_key3 <= site1
  		 and usrw_key4 >= line and usrw_key4 <= line1
  		 and usrw_key6 >= part and usrw_key6 <= part1
  		 and usrw_datefld[1] >= issue and usrw_datefld[1] <= issue1
  		 break by usrw_datefld[1] by usrw_key4 by usrw_intfld[2]:
  	 assign vdesc1 = "".
