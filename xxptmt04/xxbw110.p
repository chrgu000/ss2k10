...
find first brw_mstr exclusive-lock where brw_mstr.brw_name = 'xx110' no-error.
if not available brw_mstr then do:
          create brw_mstr.
          assign brw_mstr.brw_name = 'xx110'.
end.
