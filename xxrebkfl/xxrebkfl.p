...
/* SS - 100913.1  By: Roger Xiao */ /*cancel the message 161 and 1119 */
/* ss - 110602.1 by: jack */  /* 当库存为负数时显示为0,不能回冲，取消限制*/
/* ss - 110613.1 by: jack */  /* 速度慢将0限制*/
/* ss - 110623.1 by: jack */  /* 当N开头的零件库存不足时不提示*/
/* ss - 120325.1 by: jack */  /* 合并功能，当材料不够时以0回冲 */
/*-Revision end---------------------------------------------------------------*/
